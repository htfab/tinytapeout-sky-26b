module tt_um_basic_na (clk,
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_137 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _281_ (.A(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _282_ (.A(net17),
    ...
    .VPWR(VPWR),
    .Y(_274_));
 sky130_fd_sc_hd__inv_2 _283_ (.A(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_275_));
 sky130_fd_sc_hd__inv_2 _284_ (.A(\tone_cnt[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_276_));
 sky130_fd_sc_hd__or4b_2 _285_ (.A(\prescaler[6] ),
    .B(\prescaler[7] ),
    .C(\prescaler[8] ),
    .D_N(net1),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_277_));
 sky130_fd_sc_hd__or4_2 _286_ (.A(\prescaler[2] ),
    .B(\prescaler[3] ),
    .C(\prescaler[4] ),
    .D(\prescaler[5] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_278_));
 sky130_fd_sc_hd__or4_2 _287_ (.A(\prescaler[0] ),
    .B(\prescaler[1] ),
    .C(_277_),
    .D(_278_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_279_));
 sky130_fd_sc_hd__inv_2 _288_ (.A(_279_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_280_));
 sky130_fd_sc_hd__nor2_2 _289_ (.A(net16),
    .B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_044_));
 sky130_fd_sc_hd__nor2_2 _290_ (.A(net16),
    .B(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_045_));
 sky130_fd_sc_hd__or3_2 _291_ (.A(net17),
    .B(net24),
    .C(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_046_));
 sky130_fd_sc_hd__o21ai_2 _292_ (.A1(net21),
    .A2(net19),
    .B1(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_047_));
 sky130_fd_sc_hd__nor2_2 _293_ (.A(net13),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_048_));
 sky130_fd_sc_hd__nand3_2 _294_ (.A(_046_),
    .B(_047_),
    .C(_048_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_049_));
 sky130_fd_sc_hd__and2b_2 _295_ (.A_N(net16),
    .B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_050_));
 sky130_fd_sc_hd__and2b_2 _296_ (.A_N(net18),
    .B(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_051_));
 sky130_fd_sc_hd__o21bai_2 _297_ (.A1(net25),
    .A2(net23),
    .B1_N(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_052_));
 sky130_fd_sc_hd__nand2b_2 _298_ (.A_N(net19),
    .B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2b_2 _299_ (.A_N(net22),
    ...
    .VPWR(VPWR),
    .X(_054_));
 sky130_fd_sc_hd__nand2b_2 _300_ (.A_N(net21),
    .B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_055_));
 sky130_fd_sc_hd__or3b_2 _301_ (.A(net24),
    .B(net21),
    .C_N(net19),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_056_));
 sky130_fd_sc_hd__and3_2 _302_ (.A(_052_),
    .B(_053_),
    .C(_056_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_057_));
 sky130_fd_sc_hd__a21oi_2 _303_ (.A1(_053_),
    .A2(_056_),
    .B1(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_058_));
 sky130_fd_sc_hd__or2_2 _304_ (.A(net13),
    .B(_273_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_059_));
 sky130_fd_sc_hd__o31a_2 _305_ (.A1(_057_),
    .A2(_058_),
    .A3(_059_),
    .B1(_049_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_060_));
 sky130_fd_sc_hd__o31a_2 _306_ (.A1(net25),
    .A2(net23),
    .A3(net20),
    .B1(net18),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_061_));
 sky130_fd_sc_hd__and2_2 _307_ (.A(net21),
    .B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_062_));
 sky130_fd_sc_hd__nand2_2 _308_ (.A(net22),
    .B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_063_));
 sky130_fd_sc_hd__and2_2 _309_ (.A(net24),
    .B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_064_));
 sky130_fd_sc_hd__a221o_2 _310_ (.A1(_061_),
    .A2(_063_),
    .B1(_064_),
    .B2(_274_),
    .C1(_050_),
    ...
    .VPWR(VPWR),
    .X(_065_));
 sky130_fd_sc_hd__xnor2_2 _311_ (.A(net23),
    .B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_066_));
 sky130_fd_sc_hd__nand2b_2 _312_ (.A_N(net22),
    .B(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_067_));
 sky130_fd_sc_hd__o211a_2 _313_ (.A1(_044_),
    .A2(_066_),
    .B1(_067_),
    .C1(net13),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_068_));
 sky130_fd_sc_hd__and3_2 _314_ (.A(net11),
    .B(net25),
    .C(_054_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_069_));
 sky130_fd_sc_hd__o21ai_2 _315_ (.A1(_068_),
    .A2(_069_),
    .B1(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_070_));
 sky130_fd_sc_hd__nand2_2 _316_ (.A(net13),
    .B(_273_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_071_));
 sky130_fd_sc_hd__inv_2 _317_ (.A(_071_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_072_));
 sky130_fd_sc_hd__nand2b_2 _318_ (.A_N(_066_),
    .B(_051_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_073_));
 sky130_fd_sc_hd__nand2_2 _319_ (.A(net18),
    .B(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_074_));
 sky130_fd_sc_hd__a21o_2 _320_ (.A1(_073_),
    .A2(_074_),
    .B1(_071_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_075_));
 sky130_fd_sc_hd__a21o_2 _321_ (.A1(net15),
    .A2(_061_),
    .B1(net14),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_2 _322_ (.A(net11),
    ...
    .VPWR(VPWR),
    .Y(_077_));
 sky130_fd_sc_hd__o2111ai_2 _323_ (.A1(net12),
    .A2(_060_),
    .B1(_070_),
    .C1(_075_),
    .D1(_077_),
    ...
    .VPWR(VPWR),
    .Y(_078_));
 sky130_fd_sc_hd__a31oi_2 _324_ (.A1(net11),
    .A2(_273_),
    .A3(_065_),
    .B1(_078_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _325_ (.A(net7),
    ...
    .VPWR(VPWR),
    .Y(_080_));
 sky130_fd_sc_hd__and2_2 _326_ (.A(net14),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_081_));
 sky130_fd_sc_hd__nand2_2 _327_ (.A(net13),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_082_));
 sky130_fd_sc_hd__and2_2 _328_ (.A(net25),
    .B(_275_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_083_));
 sky130_fd_sc_hd__nand2b_2 _329_ (.A_N(net19),
    .B(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_084_));
 sky130_fd_sc_hd__xor2_2 _330_ (.A(net24),
    .B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_085_));
 sky130_fd_sc_hd__nand2_2 _331_ (.A(net24),
    .B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_086_));
 sky130_fd_sc_hd__nand2_2 _332_ (.A(_085_),
    .B(_086_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_087_));
 sky130_fd_sc_hd__nor3b_2 _333_ (.A(net24),
    .B(net19),
    .C_N(net21),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_088_));
 sky130_fd_sc_hd__nor2_2 _334_ (.A(net17),
    .B(_088_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_089_));
 sky130_fd_sc_hd__a22o_2 _335_ (.A1(net17),
    .A2(_087_),
    .B1(_089_),
    .B2(_056_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_090_));
 sky130_fd_sc_hd__o211a_2 _336_ (.A1(net25),
    .A2(_066_),
    .B1(_067_),
    .C1(_274_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_091_));
 sky130_fd_sc_hd__and2b_2 _337_ (.A_N(net24),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_092_));
 sky130_fd_sc_hd__inv_2 _338_ (.A(_092_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_093_));
 sky130_fd_sc_hd__xor2_2 _339_ (.A(net24),
    .B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_094_));
 sky130_fd_sc_hd__a211o_2 _340_ (.A1(_274_),
    .A2(_056_),
    .B1(_083_),
    .C1(_094_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_095_));
 sky130_fd_sc_hd__nand2_2 _341_ (.A(_274_),
    .B(_094_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_096_));
 sky130_fd_sc_hd__nand2_2 _342_ (.A(net17),
    .B(_275_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_097_));
 sky130_fd_sc_hd__a32o_2 _343_ (.A1(_072_),
    .A2(_095_),
    .A3(_096_),
    .B1(_081_),
    .B2(_090_),
    ...
    .VPWR(VPWR),
    .X(_098_));
 sky130_fd_sc_hd__a221o_2 _344_ (.A1(_050_),
    .A2(_085_),
    .B1(net10),
    .B2(net16),
    .C1(net15),
    ...
    .VPWR(VPWR),
    .X(_099_));
 sky130_fd_sc_hd__a211o_2 _345_ (.A1(_053_),
    .A2(_092_),
    .B1(_091_),
    .C1(_273_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_100_));
 sky130_fd_sc_hd__a21oi_2 _346_ (.A1(_099_),
    .A2(_100_),
    .B1(net13),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_101_));
 sky130_fd_sc_hd__nand2b_2 _347_ (.A_N(net13),
    .B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_102_));
 sky130_fd_sc_hd__nand2_2 _348_ (.A(net11),
    .B(_048_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_103_));
 sky130_fd_sc_hd__and2_2 _349_ (.A(_050_),
    .B(_064_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_104_));
 sky130_fd_sc_hd__nand2_2 _350_ (.A(_050_),
    .B(_064_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_2 _351_ (.A1(net22),
    ...
    .VPWR(VPWR),
    .Y(_106_));
 sky130_fd_sc_hd__or4_2 _352_ (.A(_273_),
    .B(net17),
    .C(_275_),
    .D(_094_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_107_));
 sky130_fd_sc_hd__o22a_2 _353_ (.A1(_103_),
    .A2(_106_),
    .B1(_107_),
    .B2(_102_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_108_));
 sky130_fd_sc_hd__o31ai_2 _354_ (.A1(net11),
    .A2(_098_),
    .A3(_101_),
    .B1(_108_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_109_));
 sky130_fd_sc_hd__inv_2 _355_ (.A(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_110_));
 sky130_fd_sc_hd__or4_2 _356_ (.A(_273_),
    .B(_054_),
    .C(_064_),
    .D(net10),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_111_));
 sky130_fd_sc_hd__a21oi_2 _357_ (.A1(_053_),
    .A2(_092_),
    .B1(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_112_));
 sky130_fd_sc_hd__o2bb2a_2 _358_ (.A1_N(_073_),
    .A2_N(_112_),
    .B1(_111_),
    .B2(_061_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_113_));
 sky130_fd_sc_hd__a32oi_2 _359_ (.A1(_053_),
    .A2(_056_),
    .A3(_086_),
    .B1(_085_),
    .B2(_050_),
    ...
    .VPWR(VPWR),
    .Y(_114_));
 sky130_fd_sc_hd__a211oi_2 _360_ (.A1(_045_),
    .A2(_062_),
    .B1(_114_),
    .C1(_059_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_115_));
 sky130_fd_sc_hd__a31oi_2 _361_ (.A1(_073_),
    .A2(_093_),
    .A3(_097_),
    .B1(_071_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_116_));
 sky130_fd_sc_hd__a22o_2 _362_ (.A1(_044_),
    .A2(_085_),
    .B1(_092_),
    .B2(_055_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_117_));
 sky130_fd_sc_hd__nand2_2 _363_ (.A(net16),
    .B(_055_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_118_));
 sky130_fd_sc_hd__o211a_2 _364_ (.A1(net16),
    .A2(_087_),
    .B1(_118_),
    .C1(_081_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_119_));
 sky130_fd_sc_hd__a21o_2 _365_ (.A1(_048_),
    .A2(_117_),
    .B1(net11),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_120_));
 sky130_fd_sc_hd__or4_2 _366_ (.A(_115_),
    .B(_116_),
    .C(_119_),
    .D(_120_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_121_));
 sky130_fd_sc_hd__o21a_2 _367_ (.A1(_102_),
    .A2(_113_),
    .B1(_121_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_122_));
 sky130_fd_sc_hd__o21ai_2 _368_ (.A1(_102_),
    .A2(_113_),
    .B1(_121_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_123_));
 sky130_fd_sc_hd__mux2_1 _369_ (.A0(_056_),
    .A1(_063_),
    .S(_274_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_124_));
 sky130_fd_sc_hd__o21a_2 _370_ (.A1(net19),
    .A2(_086_),
    .B1(_124_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_125_));
 sky130_fd_sc_hd__a32o_2 _371_ (.A1(net16),
    .A2(_055_),
    .A3(_084_),
    .B1(_045_),
    .B2(_053_),
    ...
    .VPWR(VPWR),
    .X(_126_));
 sky130_fd_sc_hd__a2111o_2 _372_ (.A1(net16),
    .A2(_087_),
    .B1(_044_),
    .C1(net13),
    .D1(net15),
    ...
    .VPWR(VPWR),
    .X(_127_));
 sky130_fd_sc_hd__o32a_2 _373_ (.A1(net17),
    .A2(_062_),
    .A3(_085_),
    .B1(_094_),
    .B2(_047_),
    ...
    .VPWR(VPWR),
    .X(_128_));
 sky130_fd_sc_hd__o2bb2a_2 _374_ (.A1_N(_081_),
    .A2_N(_126_),
    .B1(_128_),
    .B2(_071_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_129_));
 sky130_fd_sc_hd__o211a_2 _375_ (.A1(_059_),
    .A2(_125_),
    .B1(_127_),
    .C1(_129_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_130_));
 sky130_fd_sc_hd__nand2_2 _376_ (.A(_050_),
    .B(_084_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_131_));
 sky130_fd_sc_hd__a21o_2 _377_ (.A1(net20),
    .A2(_067_),
    .B1(_047_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_132_));
 sky130_fd_sc_hd__a21o_2 _378_ (.A1(_131_),
    .A2(_132_),
    .B1(_103_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_133_));
 sky130_fd_sc_hd__or4_2 _379_ (.A(_273_),
    .B(net16),
    .C(_054_),
    .D(_085_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_134_));
 sky130_fd_sc_hd__o221a_2 _380_ (.A1(net11),
    .A2(_130_),
    .B1(_134_),
    .B2(_102_),
    .C1(_133_),
    ...
    .VPWR(VPWR),
    .X(_135_));
 sky130_fd_sc_hd__a21oi_2 _381_ (.A1(_110_),
    .A2(_135_),
    .B1(_122_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_136_));
 sky130_fd_sc_hd__a21o_2 _382_ (.A1(_080_),
    .A2(_110_),
    .B1(_136_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_137_));
 sky130_fd_sc_hd__nand2_2 _383_ (.A(_122_),
    .B(_135_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_138_));
 sky130_fd_sc_hd__a21oi_2 _384_ (.A1(_122_),
    .A2(_135_),
    .B1(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_139_));
 sky130_fd_sc_hd__nand2_2 _385_ (.A(_080_),
    .B(_138_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_140_));
 sky130_fd_sc_hd__or2_2 _386_ (.A(\tone_cnt[7] ),
    .B(_140_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_141_));
 sky130_fd_sc_hd__nor2_2 _387_ (.A(net6),
    .B(_135_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_142_));
 sky130_fd_sc_hd__a21oi_2 _388_ (.A1(_122_),
    .A2(_142_),
    .B1(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_143_));
 sky130_fd_sc_hd__a21o_2 _389_ (.A1(_122_),
    .A2(_142_),
    .B1(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_144_));
 sky130_fd_sc_hd__o221a_2 _390_ (.A1(\tone_cnt[5] ),
    .A2(_137_),
    .B1(_143_),
    .B2(\tone_cnt[6] ),
    .C1(_141_),
    ...
    .VPWR(VPWR),
    .X(_145_));
 sky130_fd_sc_hd__and3_2 _391_ (.A(net7),
    .B(_123_),
    .C(_135_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_146_));
 sky130_fd_sc_hd__a21o_2 _392_ (.A1(_080_),
    .A2(_122_),
    .B1(net6),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_147_));
 sky130_fd_sc_hd__mux2_1 _393_ (.A0(_147_),
    .A1(_110_),
    .S(_146_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_148_));
 sky130_fd_sc_hd__a22o_2 _394_ (.A1(\tone_cnt[5] ),
    .A2(_137_),
    .B1(_148_),
    .B2(\tone_cnt[4] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_149_));
 sky130_fd_sc_hd__a21oi_2 _395_ (.A1(_109_),
    .A2(_135_),
    .B1(_123_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_150_));
 sky130_fd_sc_hd__nor2_2 _396_ (.A(_139_),
    .B(_142_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_151_));
 sky130_fd_sc_hd__or3b_2 _397_ (.A(_139_),
    .B(_142_),
    .C_N(_150_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_152_));
 sky130_fd_sc_hd__o21bai_2 _398_ (.A1(_139_),
    .A2(_142_),
    .B1_N(_150_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_153_));
 sky130_fd_sc_hd__a21boi_2 _399_ (.A1(_152_),
    .A2(_153_),
    .B1_N(\tone_cnt[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_154_));
 sky130_fd_sc_hd__nor2_2 _400_ (.A(_142_),
    .B(_150_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_155_));
 sky130_fd_sc_hd__mux2_1 _401_ (.A0(_150_),
    .A1(_123_),
    .S(_142_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_156_));
 sky130_fd_sc_hd__o221ai_2 _402_ (.A1(_144_),
    .A2(_155_),
    .B1(_156_),
    .B2(_135_),
    .C1(_276_),
    ...
    .VPWR(VPWR),
    .Y(_157_));
 sky130_fd_sc_hd__nand3b_2 _403_ (.A_N(\tone_cnt[1] ),
    .B(_152_),
    .C(_153_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_158_));
 sky130_fd_sc_hd__o21a_2 _404_ (.A1(_080_),
    .A2(_138_),
    .B1(_151_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_159_));
 sky130_fd_sc_hd__o221a_2 _405_ (.A1(_154_),
    .A2(_157_),
    .B1(_159_),
    .B2(\tone_cnt[2] ),
    .C1(_158_),
    ...
    .VPWR(VPWR),
    .X(_160_));
 sky130_fd_sc_hd__mux2_1 _406_ (.A0(_135_),
    .A1(_142_),
    .S(_122_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_161_));
 sky130_fd_sc_hd__or2_2 _407_ (.A(net13),
    .B(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_162_));
 sky130_fd_sc_hd__mux2_1 _408_ (.A0(_080_),
    .A1(_162_),
    .S(_161_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_163_));
 sky130_fd_sc_hd__a22o_2 _409_ (.A1(\tone_cnt[2] ),
    .A2(_159_),
    .B1(_163_),
    .B2(\tone_cnt[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_164_));
 sky130_fd_sc_hd__a22oi_2 _410_ (.A1(\tone_cnt[7] ),
    .A2(_140_),
    .B1(_143_),
    .B2(\tone_cnt[6] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_165_));
 sky130_fd_sc_hd__o221a_2 _411_ (.A1(\tone_cnt[4] ),
    .A2(_148_),
    .B1(_163_),
    .B2(\tone_cnt[3] ),
    .C1(_165_),
    ...
    .VPWR(VPWR),
    .X(_166_));
 sky130_fd_sc_hd__o21a_2 _412_ (.A1(_160_),
    .A2(_164_),
    .B1(_166_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_167_));
 sky130_fd_sc_hd__o21ai_2 _413_ (.A1(_149_),
    .A2(_167_),
    .B1(_145_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_168_));
 sky130_fd_sc_hd__o21a_2 _414_ (.A1(_079_),
    .A2(_138_),
    .B1(playing),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_169_));
 sky130_fd_sc_hd__o21bai_2 _415_ (.A1(\tone_cnt[7] ),
    .A2(_140_),
    .B1_N(_165_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_170_));
 sky130_fd_sc_hd__a31oi_4 _416_ (.A1(_168_),
    .A2(_169_),
    .A3(_170_),
    .B1(_279_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_171_));
 sky130_fd_sc_hd__or2_2 _417_ (.A(_276_),
    .B(_279_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_172_));
 sky130_fd_sc_hd__or4_2 _418_ (.A(\prescaler[0] ),
    .B(\prescaler[1] ),
    .C(\prescaler[2] ),
    .D(\prescaler[5] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_173_));
 sky130_fd_sc_hd__nor4_4 _419_ (.A(\prescaler[3] ),
    .B(\prescaler[4] ),
    .C(_277_),
    .D(_173_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_174_));
 sky130_fd_sc_hd__o21ai_2 _420_ (.A1(\tone_cnt[0] ),
    .A2(net8),
    .B1(_172_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_175_));
 sky130_fd_sc_hd__nor2_2 _421_ (.A(net5),
    .B(_175_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_000_));
 sky130_fd_sc_hd__and3_2 _422_ (.A(\tone_cnt[1] ),
    .B(\tone_cnt[0] ),
    .C(_280_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_176_));
 sky130_fd_sc_hd__a21oi_2 _423_ (.A1(\tone_cnt[0] ),
    .A2(net8),
    .B1(net80),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_177_));
 sky130_fd_sc_hd__nor3_2 _424_ (.A(net5),
    .B(_176_),
    .C(_177_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_001_));
 sky130_fd_sc_hd__and2_2 _425_ (.A(\tone_cnt[2] ),
    .B(_176_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_178_));
 sky130_fd_sc_hd__nor2_2 _426_ (.A(\tone_cnt[2] ),
    .B(_176_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_179_));
 sky130_fd_sc_hd__nor3_2 _427_ (.A(net5),
    .B(_178_),
    .C(_179_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_002_));
 sky130_fd_sc_hd__and3_2 _428_ (.A(\tone_cnt[3] ),
    .B(\tone_cnt[2] ),
    .C(_176_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_180_));
 sky130_fd_sc_hd__nor2_2 _429_ (.A(net84),
    .B(_178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_181_));
 sky130_fd_sc_hd__nor3_2 _430_ (.A(net5),
    .B(_180_),
    .C(_181_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_003_));
 sky130_fd_sc_hd__and2_2 _431_ (.A(\tone_cnt[4] ),
    .B(_180_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_182_));
 sky130_fd_sc_hd__nor2_2 _432_ (.A(\tone_cnt[4] ),
    .B(_180_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_183_));
 sky130_fd_sc_hd__nor3_2 _433_ (.A(net5),
    .B(_182_),
    .C(_183_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_004_));
 sky130_fd_sc_hd__and3_2 _434_ (.A(\tone_cnt[5] ),
    .B(\tone_cnt[4] ),
    .C(_180_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_184_));
 sky130_fd_sc_hd__nor2_2 _435_ (.A(\tone_cnt[5] ),
    .B(_182_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_185_));
 sky130_fd_sc_hd__nor3_2 _436_ (.A(net5),
    .B(_184_),
    .C(_185_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_005_));
 sky130_fd_sc_hd__and3_2 _437_ (.A(\tone_cnt[6] ),
    .B(\tone_cnt[5] ),
    .C(_182_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_186_));
 sky130_fd_sc_hd__nor2_2 _438_ (.A(\tone_cnt[6] ),
    .B(_184_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_187_));
 sky130_fd_sc_hd__nor3_2 _439_ (.A(_171_),
    .B(_186_),
    .C(_187_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_006_));
 sky130_fd_sc_hd__xnor2_2 _440_ (.A(\tone_cnt[7] ),
    .B(_186_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_188_));
 sky130_fd_sc_hd__nor2_2 _441_ (.A(_171_),
    .B(_188_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_007_));
 sky130_fd_sc_hd__and2b_2 _442_ (.A_N(tone_out),
    .B(_169_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__mux2_1 _443_ (.A0(net55),
    ...
    .VPWR(VPWR),
    .X(_008_));
 sky130_fd_sc_hd__o211a_2 _444_ (.A1(net23),
    .A2(net20),
    .B1(\note_addr[4] ),
    .C1(net18),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_190_));
 sky130_fd_sc_hd__o21a_2 _445_ (.A1(net14),
    .A2(_190_),
    .B1(net12),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_191_));
 sky130_fd_sc_hd__and2b_2 _446_ (.A_N(btn_prev),
    .B(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_192_));
 sky130_fd_sc_hd__nor2_2 _447_ (.A(_191_),
    .B(_192_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_193_));
 sky130_fd_sc_hd__or2_2 _448_ (.A(_191_),
    .B(_192_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_194_));
 sky130_fd_sc_hd__and3b_2 _449_ (.A_N(btn_prev),
    .B(net1),
    .C(net3),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_195_));
 sky130_fd_sc_hd__or4_2 _450_ (.A(\tempo_cnt[2] ),
    .B(\tempo_cnt[3] ),
    .C(\tempo_cnt[4] ),
    .D(\tempo_cnt[5] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_196_));
 sky130_fd_sc_hd__or4_2 _451_ (.A(\tempo_cnt[6] ),
    .B(\tempo_cnt[7] ),
    .C(\tempo_cnt[8] ),
    .D(\tempo_cnt[9] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_197_));
 sky130_fd_sc_hd__or4b_2 _452_ (.A(\tempo_cnt[10] ),
    .B(\tempo_cnt[11] ),
    .C(\tempo_cnt[12] ),
    .D_N(playing),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_198_));
 sky130_fd_sc_hd__or4_2 _453_ (.A(\tempo_cnt[0] ),
    .B(\tempo_cnt[1] ),
    .C(_196_),
    .D(_198_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_199_));
 sky130_fd_sc_hd__nor2_2 _454_ (.A(_197_),
    .B(_199_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_200_));
 sky130_fd_sc_hd__a21o_2 _455_ (.A1(_280_),
    .A2(_200_),
    .B1(_195_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_201_));
 sky130_fd_sc_hd__or3b_2 _456_ (.A(net4),
    .B(_192_),
    .C_N(_191_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_202_));
 sky130_fd_sc_hd__or3b_2 _457_ (.A(_059_),
    .B(_061_),
    .C_N(_056_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_203_));
 sky130_fd_sc_hd__o21a_2 _458_ (.A1(_053_),
    .A2(_092_),
    .B1(_048_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_204_));
 sky130_fd_sc_hd__nand2_2 _459_ (.A(net11),
    .B(_203_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_205_));
 sky130_fd_sc_hd__o21a_2 _460_ (.A1(net20),
    .A2(_046_),
    .B1(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_206_));
 sky130_fd_sc_hd__or2_2 _461_ (.A(_067_),
    .B(_097_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_207_));
 sky130_fd_sc_hd__a221o_2 _462_ (.A1(_048_),
    .A2(_105_),
    .B1(_207_),
    .B2(net13),
    .C1(_206_),
    ...
    .VPWR(VPWR),
    .X(_208_));
 sky130_fd_sc_hd__o22a_2 _463_ (.A1(_204_),
    .A2(_205_),
    .B1(_208_),
    .B2(net11),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_209_));
 sky130_fd_sc_hd__nor2_2 _464_ (.A(_051_),
    .B(_092_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_210_));
 sky130_fd_sc_hd__o21ba_2 _465_ (.A1(net23),
    .A2(net20),
    .B1_N(net12),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_211_));
 sky130_fd_sc_hd__o21bai_2 _466_ (.A1(_210_),
    .A2(_211_),
    .B1_N(net14),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_212_));
 sky130_fd_sc_hd__o22a_2 _467_ (.A1(_274_),
    .A2(_059_),
    .B1(_082_),
    .B2(_104_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_213_));
 sky130_fd_sc_hd__a21o_2 _468_ (.A1(net18),
    .A2(net10),
    .B1(_071_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_214_));
 sky130_fd_sc_hd__o21ai_2 _469_ (.A1(net14),
    .A2(_055_),
    .B1(net12),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_215_));
 sky130_fd_sc_hd__a41o_2 _470_ (.A1(_212_),
    .A2(_213_),
    .A3(_214_),
    .A4(_215_),
    .B1(\dur_cnt[0] ),
    ...
    .VPWR(VPWR),
    .X(_216_));
 sky130_fd_sc_hd__nand2_2 _471_ (.A(\dur_cnt[1] ),
    .B(_216_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_217_));
 sky130_fd_sc_hd__a31o_2 _472_ (.A1(_062_),
    .A2(_081_),
    .A3(_210_),
    .B1(net12),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_218_));
 sky130_fd_sc_hd__o221a_2 _473_ (.A1(_047_),
    .A2(_064_),
    .B1(_088_),
    .B2(net17),
    .C1(_072_),
    ...
    .VPWR(VPWR),
    .X(_219_));
 sky130_fd_sc_hd__a211o_2 _474_ (.A1(net18),
    .A2(_056_),
    .B1(_083_),
    .C1(_094_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_220_));
 sky130_fd_sc_hd__a21oi_2 _475_ (.A1(_273_),
    .A2(_220_),
    .B1(_076_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_221_));
 sky130_fd_sc_hd__or3_2 _476_ (.A(_218_),
    .B(_219_),
    .C(_221_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_222_));
 sky130_fd_sc_hd__nor2_2 _477_ (.A(_094_),
    .B(_097_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_223_));
 sky130_fd_sc_hd__o311a_2 _478_ (.A1(_058_),
    .A2(_103_),
    .A3(_223_),
    .B1(_222_),
    .C1(_217_),
    ...
    .VPWR(VPWR),
    .X(_224_));
 sky130_fd_sc_hd__o21ai_2 _479_ (.A1(_052_),
    .A2(_059_),
    .B1(_224_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_225_));
 sky130_fd_sc_hd__o22a_2 _480_ (.A1(\dur_cnt[3] ),
    .A2(_077_),
    .B1(_209_),
    .B2(\dur_cnt[2] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_226_));
 sky130_fd_sc_hd__o211a_2 _481_ (.A1(\dur_cnt[1] ),
    .A2(_216_),
    .B1(_225_),
    .C1(_226_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_227_));
 sky130_fd_sc_hd__a221o_2 _482_ (.A1(\dur_cnt[3] ),
    .A2(_077_),
    .B1(_209_),
    .B2(\dur_cnt[2] ),
    .C1(_194_),
    ...
    .VPWR(VPWR),
    .X(_228_));
 sky130_fd_sc_hd__o211ai_2 _483_ (.A1(_227_),
    .A2(_228_),
    .B1(_201_),
    .C1(_202_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_229_));
 sky130_fd_sc_hd__inv_2 _484_ (.A(_229_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_230_));
 sky130_fd_sc_hd__nor2_2 _485_ (.A(_194_),
    .B(_229_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_231_));
 sky130_fd_sc_hd__mux2_1 _486_ (.A0(_231_),
    .A1(_229_),
    .S(net25),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_009_));
 sky130_fd_sc_hd__a22o_2 _487_ (.A1(net23),
    .A2(_229_),
    .B1(_231_),
    .B2(_094_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_010_));
 sky130_fd_sc_hd__a21o_2 _488_ (.A1(_086_),
    .A2(_193_),
    .B1(_229_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_232_));
 sky130_fd_sc_hd__a32o_2 _489_ (.A1(net23),
    .A2(_083_),
    .A3(_231_),
    .B1(_232_),
    .B2(net53),
    ...
    .VPWR(VPWR),
    .X(_011_));
 sky130_fd_sc_hd__and3_2 _490_ (.A(net18),
    .B(net25),
    .C(_062_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_233_));
 sky130_fd_sc_hd__o21ai_2 _491_ (.A1(_194_),
    .A2(_233_),
    .B1(_230_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_234_));
 sky130_fd_sc_hd__and3_2 _492_ (.A(\note_addr[0] ),
    .B(_062_),
    .C(_230_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_235_));
 sky130_fd_sc_hd__o21a_2 _493_ (.A1(net83),
    .A2(_235_),
    .B1(_234_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_012_));
 sky130_fd_sc_hd__and3_2 _494_ (.A(_273_),
    .B(_231_),
    .C(_233_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_236_));
 sky130_fd_sc_hd__a21o_2 _495_ (.A1(net82),
    .A2(_234_),
    .B1(_236_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_013_));
 sky130_fd_sc_hd__and2_2 _496_ (.A(_081_),
    .B(_233_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_237_));
 sky130_fd_sc_hd__o21ai_2 _497_ (.A1(_194_),
    .A2(_237_),
    .B1(_230_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_238_));
 sky130_fd_sc_hd__a31o_2 _498_ (.A1(\note_addr[4] ),
    .A2(\note_addr[3] ),
    .A3(_235_),
    .B1(net14),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_239_));
 sky130_fd_sc_hd__and2_2 _499_ (.A(_238_),
    .B(_239_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_014_));
 sky130_fd_sc_hd__nor2_2 _500_ (.A(net12),
    .B(_192_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_240_));
 sky130_fd_sc_hd__a32o_2 _501_ (.A1(_230_),
    .A2(_237_),
    .A3(_240_),
    .B1(_238_),
    .B2(net12),
    ...
    .VPWR(VPWR),
    .X(_015_));
 sky130_fd_sc_hd__nand2b_2 _502_ (.A_N(_202_),
    .B(_201_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_241_));
 sky130_fd_sc_hd__a21o_2 _503_ (.A1(playing),
    .A2(_241_),
    .B1(_195_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_016_));
 sky130_fd_sc_hd__and3_2 _504_ (.A(\dur_cnt[0] ),
    .B(_201_),
    .C(_202_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_242_));
 sky130_fd_sc_hd__a21oi_2 _505_ (.A1(_201_),
    .A2(_202_),
    .B1(net81),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_243_));
 sky130_fd_sc_hd__nor3_2 _506_ (.A(_230_),
    .B(_242_),
    .C(_243_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_017_));
 sky130_fd_sc_hd__and2_2 _507_ (.A(\dur_cnt[1] ),
    .B(_242_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_244_));
 sky130_fd_sc_hd__o21ai_2 _508_ (.A1(net86),
    .A2(_242_),
    .B1(_229_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_245_));
 sky130_fd_sc_hd__nor2_2 _509_ (.A(_244_),
    .B(_245_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_018_));
 sky130_fd_sc_hd__nand2_2 _510_ (.A(\dur_cnt[2] ),
    .B(_244_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_246_));
 sky130_fd_sc_hd__or2_2 _511_ (.A(\dur_cnt[2] ),
    .B(_244_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_247_));
 sky130_fd_sc_hd__and3_2 _512_ (.A(_229_),
    .B(_246_),
    .C(_247_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_019_));
 sky130_fd_sc_hd__xor2_2 _513_ (.A(\dur_cnt[3] ),
    .B(_246_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_248_));
 sky130_fd_sc_hd__nor2_2 _514_ (.A(_230_),
    .B(_248_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_020_));
 sky130_fd_sc_hd__xor2_2 _515_ (.A(net61),
    .B(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_021_));
 sky130_fd_sc_hd__a21oi_2 _516_ (.A1(\tempo_cnt[0] ),
    .A2(net9),
    .B1(net68),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_249_));
 sky130_fd_sc_hd__and3_2 _517_ (.A(\tempo_cnt[0] ),
    .B(\tempo_cnt[1] ),
    .C(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_250_));
 sky130_fd_sc_hd__nor2_2 _518_ (.A(net69),
    .B(_250_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_022_));
 sky130_fd_sc_hd__nor2_2 _519_ (.A(net75),
    .B(_250_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_251_));
 sky130_fd_sc_hd__and2_2 _520_ (.A(\tempo_cnt[2] ),
    .B(_250_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_252_));
 sky130_fd_sc_hd__nor2_2 _521_ (.A(_251_),
    .B(_252_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_023_));
 sky130_fd_sc_hd__xor2_2 _522_ (.A(net62),
    .B(_252_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_024_));
 sky130_fd_sc_hd__a21oi_2 _523_ (.A1(\tempo_cnt[3] ),
    .A2(_252_),
    .B1(net70),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_253_));
 sky130_fd_sc_hd__and3_2 _524_ (.A(\tempo_cnt[3] ),
    .B(\tempo_cnt[4] ),
    .C(_252_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_254_));
 sky130_fd_sc_hd__nor2_2 _525_ (.A(net71),
    .B(_254_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_025_));
 sky130_fd_sc_hd__xor2_2 _526_ (.A(net57),
    .B(_254_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_026_));
 sky130_fd_sc_hd__a21oi_2 _527_ (.A1(\tempo_cnt[5] ),
    .A2(_254_),
    .B1(net66),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_255_));
 sky130_fd_sc_hd__and3_2 _528_ (.A(\tempo_cnt[5] ),
    .B(\tempo_cnt[6] ),
    .C(_254_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_256_));
 sky130_fd_sc_hd__nor2_2 _529_ (.A(net67),
    .B(_256_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_027_));
 sky130_fd_sc_hd__xor2_2 _530_ (.A(net60),
    .B(_256_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_028_));
 sky130_fd_sc_hd__a21oi_2 _531_ (.A1(\tempo_cnt[7] ),
    .A2(_256_),
    .B1(net73),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_257_));
 sky130_fd_sc_hd__and3_2 _532_ (.A(\tempo_cnt[7] ),
    .B(\tempo_cnt[8] ),
    .C(_256_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_258_));
 sky130_fd_sc_hd__nor2_2 _533_ (.A(net74),
    .B(_258_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_029_));
 sky130_fd_sc_hd__nor2_2 _534_ (.A(net78),
    .B(_258_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_259_));
 sky130_fd_sc_hd__and2_2 _535_ (.A(\tempo_cnt[9] ),
    .B(_258_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_260_));
 sky130_fd_sc_hd__nor2_2 _536_ (.A(_259_),
    .B(_260_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_030_));
 sky130_fd_sc_hd__xor2_2 _537_ (.A(net56),
    .B(_260_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_031_));
 sky130_fd_sc_hd__a21oi_2 _538_ (.A1(\tempo_cnt[10] ),
    .A2(_260_),
    .B1(net63),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_261_));
 sky130_fd_sc_hd__and3_2 _539_ (.A(\tempo_cnt[10] ),
    .B(\tempo_cnt[11] ),
    .C(_260_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_262_));
 sky130_fd_sc_hd__nor2_2 _540_ (.A(net64),
    .B(_262_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_032_));
 sky130_fd_sc_hd__xor2_2 _541_ (.A(net51),
    .B(_262_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_033_));
 sky130_fd_sc_hd__xor2_2 _542_ (.A(net72),
    .B(net1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_034_));
 sky130_fd_sc_hd__a21oi_2 _543_ (.A1(\prescaler[0] ),
    .A2(net1),
    .B1(net76),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_263_));
 sky130_fd_sc_hd__and3_2 _544_ (.A(\prescaler[0] ),
    .B(\prescaler[1] ),
    .C(net1),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_264_));
 sky130_fd_sc_hd__nor2_2 _545_ (.A(net77),
    .B(_264_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_035_));
 sky130_fd_sc_hd__and2_2 _546_ (.A(\prescaler[2] ),
    .B(_264_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_265_));
 sky130_fd_sc_hd__nor2_2 _547_ (.A(net59),
    .B(_264_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_266_));
 sky130_fd_sc_hd__nor2_2 _548_ (.A(_265_),
    .B(_266_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_036_));
 sky130_fd_sc_hd__xor2_2 _549_ (.A(net85),
    .B(_265_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_037_));
 sky130_fd_sc_hd__and3_2 _550_ (.A(\prescaler[3] ),
    .B(\prescaler[4] ),
    .C(_265_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_267_));
 sky130_fd_sc_hd__a21oi_2 _551_ (.A1(\prescaler[3] ),
    .A2(_265_),
    .B1(net79),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_268_));
 sky130_fd_sc_hd__nor2_2 _552_ (.A(_267_),
    .B(_268_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_038_));
 sky130_fd_sc_hd__and2_2 _553_ (.A(\prescaler[5] ),
    .B(_267_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_269_));
 sky130_fd_sc_hd__nor2_2 _554_ (.A(net65),
    .B(_267_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_270_));
 sky130_fd_sc_hd__nor2_2 _555_ (.A(_269_),
    .B(_270_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_039_));
 sky130_fd_sc_hd__xor2_2 _556_ (.A(net58),
    .B(_269_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_040_));
 sky130_fd_sc_hd__and3_2 _557_ (.A(\prescaler[6] ),
    .B(\prescaler[7] ),
    .C(_269_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_271_));
 sky130_fd_sc_hd__a21oi_2 _558_ (.A1(net87),
    .A2(_269_),
    .B1(net54),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_272_));
 sky130_fd_sc_hd__nor2_2 _559_ (.A(_271_),
    .B(_272_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_041_));
 sky130_fd_sc_hd__xor2_2 _560_ (.A(net50),
    .B(_271_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_042_));
 sky130_fd_sc_hd__mux2_1 _561_ (.A0(net52),
    .A1(net3),
    .S(net1),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_043_));
 sky130_fd_sc_hd__dfrtp_2 _562_ (.CLK(clknet_3_3__leaf_clk),
    .D(_000_),
    .RESET_B(net27),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\tone_cnt[0] ));
 sky130_fd_sc_hd__dfrtp_2 _563_ (.CLK(clknet_3_0__leaf_clk),
    .D(_001_),
    .RESET_B(net27),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\tone_cnt[1] ));
 sky130_fd_sc_hd__dfrtp_2 _564_ (.CLK(clknet_3_0__leaf_clk),
    .D(_002_),
    .RESET_B(net27),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\tone_cnt[2] ));
 sky130_fd_sc_hd__dfrtp_2 _565_ (.CLK(clknet_3_0__leaf_clk),
    .D(_003_),
    .RESET_B(net27),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\tone_cnt[3] ));
 sky130_fd_sc_hd__dfrtp_2 _566_ (.CLK(clknet_3_1__leaf_clk),
    .D(_004_),
    .RESET_B(net27),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\tone_cnt[4] ));
 sky130_fd_sc_hd__dfrtp_2 _567_ (.CLK(clknet_3_0__leaf_clk),
    .D(_005_),
    .RESET_B(net27),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\tone_cnt[5] ));
 sky130_fd_sc_hd__dfrtp_2 _568_ (.CLK(clknet_3_0__leaf_clk),
    .D(_006_),
    .RESET_B(net27),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\tone_cnt[6] ));
 sky130_fd_sc_hd__dfrtp_2 _569_ (.CLK(clknet_3_0__leaf_clk),
    .D(_007_),
    .RESET_B(net27),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _571_ (.CLK(clknet_3_2__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\note_addr[0] ));
 sky130_fd_sc_hd__dfrtp_2 _572_ (.CLK(clknet_3_2__leaf_clk),
    .D(_010_),
    .RESET_B(net28),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _573_ (.CLK(clknet_3_2__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\note_addr[2] ));
 sky130_fd_sc_hd__dfrtp_2 _574_ (.CLK(clknet_3_2__leaf_clk),
    .D(_012_),
    .RESET_B(net28),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\note_addr[3] ));
 sky130_fd_sc_hd__dfrtp_2 _575_ (.CLK(clknet_3_2__leaf_clk),
    .D(_013_),
    .RESET_B(net28),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _576_ (.CLK(clknet_3_3__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\note_addr[5] ));
 sky130_fd_sc_hd__dfrtp_2 _577_ (.CLK(clknet_3_3__leaf_clk),
    .D(_015_),
    .RESET_B(net28),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\note_addr[6] ));
 sky130_fd_sc_hd__dfstp_2 _578_ (.CLK(clknet_3_6__leaf_clk),
    .D(_016_),
    .SET_B(net33),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(playing));
 sky130_fd_sc_hd__dfrtp_2 _579_ (.CLK(clknet_3_6__leaf_clk),
    .D(_017_),
    .RESET_B(net33),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\dur_cnt[0] ));
 sky130_fd_sc_hd__dfrtp_2 _580_ (.CLK(clknet_3_6__leaf_clk),
    .D(_018_),
    .RESET_B(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\dur_cnt[1] ));
 sky130_fd_sc_hd__dfrtp_2 _581_ (.CLK(clknet_3_6__leaf_clk),
    .D(_019_),
    .RESET_B(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\dur_cnt[2] ));
 sky130_fd_sc_hd__dfrtp_2 _582_ (.CLK(clknet_3_6__leaf_clk),
    .D(_020_),
    .RESET_B(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\dur_cnt[3] ));
 sky130_fd_sc_hd__dfrtp_2 _583_ (.CLK(clknet_3_4__leaf_clk),
    .D(_021_),
    .RESET_B(net30),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\tempo_cnt[0] ));
 sky130_fd_sc_hd__dfrtp_2 _584_ (.CLK(clknet_3_1__leaf_clk),
    .D(_022_),
    .RESET_B(net30),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _585_ (.CLK(clknet_3_1__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\tempo_cnt[2] ));
 sky130_fd_sc_hd__dfrtp_2 _586_ (.CLK(clknet_3_1__leaf_clk),
    .D(_024_),
    .RESET_B(net30),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _588_ (.CLK(clknet_3_4__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\tempo_cnt[5] ));
 sky130_fd_sc_hd__dfrtp_2 _589_ (.CLK(clknet_3_4__leaf_clk),
    .D(_027_),
    .RESET_B(net29),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\tempo_cnt[6] ));
 sky130_fd_sc_hd__dfrtp_2 _590_ (.CLK(clknet_3_4__leaf_clk),
    .D(_028_),
    .RESET_B(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\tempo_cnt[7] ));
 sky130_fd_sc_hd__dfrtp_2 _591_ (.CLK(clknet_3_5__leaf_clk),
    .D(_029_),
    .RESET_B(net31),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _593_ (.CLK(clknet_3_4__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\tempo_cnt[10] ));
 sky130_fd_sc_hd__dfrtp_2 _594_ (.CLK(clknet_3_3__leaf_clk),
    .D(_032_),
    .RESET_B(net30),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\tempo_cnt[11] ));
 sky130_fd_sc_hd__dfrtp_2 _595_ (.CLK(clknet_3_3__leaf_clk),
    .D(_033_),
    .RESET_B(net30),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\tempo_cnt[12] ));
 sky130_fd_sc_hd__dfrtp_2 _596_ (.CLK(clknet_3_7__leaf_clk),
    .D(_034_),
    .RESET_B(net33),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\prescaler[0] ));
 sky130_fd_sc_hd__dfrtp_2 _597_ (.CLK(clknet_3_5__leaf_clk),
    .D(_035_),
    .RESET_B(net33),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\prescaler[1] ));
 sky130_fd_sc_hd__dfrtp_2 _598_ (.CLK(clknet_3_5__leaf_clk),
    .D(_036_),
    .RESET_B(net33),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\prescaler[2] ));
 sky130_fd_sc_hd__dfrtp_2 _599_ (.CLK(clknet_3_5__leaf_clk),
    .D(_037_),
    .RESET_B(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\prescaler[3] ));
 sky130_fd_sc_hd__dfrtp_2 _600_ (.CLK(clknet_3_5__leaf_clk),
    .D(_038_),
    .RESET_B(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\prescaler[4] ));
 sky130_fd_sc_hd__dfrtp_2 _601_ (.CLK(clknet_3_7__leaf_clk),
    .D(_039_),
    .RESET_B(net33),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\prescaler[5] ));
 sky130_fd_sc_hd__dfrtp_2 _602_ (.CLK(clknet_3_7__leaf_clk),
    .D(_040_),
    .RESET_B(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\prescaler[6] ));
 sky130_fd_sc_hd__dfrtp_2 _603_ (.CLK(clknet_3_7__leaf_clk),
    .D(_041_),
    .RESET_B(net34),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\prescaler[7] ));
 sky130_fd_sc_hd__dfrtp_2 _604_ (.CLK(clknet_3_7__leaf_clk),
    .D(_042_),
    .RESET_B(net34),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\prescaler[8] ));
 sky130_fd_sc_hd__dfrtp_2 _605_ (.CLK(clknet_3_6__leaf_clk),
    .D(_043_),
    .RESET_B(net34),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(btn_prev));
 sky130_fd_sc_hd__buf_2 _622_ (.A(tone_out),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[0]));
 sky130_fd_sc_hd__buf_2 _623_ (.A(playing),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[1]));
 sky130_fd_sc_hd__buf_2 _624_ (.A(\note_addr[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[2]));
 sky130_fd_sc_hd__buf_2 _625_ (.A(\note_addr[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[3]));
 sky130_fd_sc_hd__buf_2 _626_ (.A(\note_addr[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[4]));
 sky130_fd_sc_hd__buf_2 _627_ (.A(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[5]));
 sky130_fd_sc_hd__buf_2 _628_ (.A(\note_addr[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[6]));
 sky130_fd_sc_hd__buf_2 _629_ (.A(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 clkload6 (.A(clknet_3_7__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout11 (.A(\note_addr[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net11));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout12 (.A(\note_addr[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net12));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout13 (.A(\note_addr[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net13));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout14 (.A(\note_addr[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net14));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout15 (.A(\note_addr[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout16 (.A(net17),
    ...
    .VPWR(VPWR),
    .X(net16));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout17 (.A(\note_addr[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout19 (.A(net20),
    ...
    .VPWR(VPWR),
    .X(net19));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout20 (.A(\note_addr[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout22 (.A(net23),
    ...
    .VPWR(VPWR),
    .X(net22));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout23 (.A(\note_addr[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout24 (.A(net25),
    ...
    .VPWR(VPWR),
    .X(net24));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout25 (.A(\note_addr[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout28 (.A(net2),
    ...
    .VPWR(VPWR),
    .X(net28));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout29 (.A(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout32 (.A(net34),
    ...
    .VPWR(VPWR),
    .X(net32));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout34 (.A(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net34));
 sky130_fd_sc_hd__dlygate4sd3_1 hold50 (.A(\prescaler[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net50));
 sky130_fd_sc_hd__dlygate4sd3_1 hold51 (.A(\tempo_cnt[12] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net51));
 sky130_fd_sc_hd__dlygate4sd3_1 hold52 (.A(btn_prev),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold53 (.A(\note_addr[2] ),
    ...
    .VPWR(VPWR),
    .X(net53));
 sky130_fd_sc_hd__dlygate4sd3_1 hold54 (.A(\prescaler[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net54));
 sky130_fd_sc_hd__dlygate4sd3_1 hold55 (.A(tone_out),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net55));
 sky130_fd_sc_hd__dlygate4sd3_1 hold56 (.A(\tempo_cnt[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net56));
 sky130_fd_sc_hd__dlygate4sd3_1 hold57 (.A(\tempo_cnt[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold58 (.A(\prescaler[6] ),
    ...
    .VPWR(VPWR),
    .X(net58));
 sky130_fd_sc_hd__dlygate4sd3_1 hold59 (.A(\prescaler[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net59));
 sky130_fd_sc_hd__dlygate4sd3_1 hold60 (.A(\tempo_cnt[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net60));
 sky130_fd_sc_hd__dlygate4sd3_1 hold61 (.A(\tempo_cnt[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net61));
 sky130_fd_sc_hd__dlygate4sd3_1 hold62 (.A(\tempo_cnt[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net62));
 sky130_fd_sc_hd__dlygate4sd3_1 hold63 (.A(\tempo_cnt[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net63));
 sky130_fd_sc_hd__dlygate4sd3_1 hold64 (.A(_261_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net64));
 sky130_fd_sc_hd__dlygate4sd3_1 hold65 (.A(\prescaler[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net65));
 sky130_fd_sc_hd__dlygate4sd3_1 hold66 (.A(\tempo_cnt[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net66));
 sky130_fd_sc_hd__dlygate4sd3_1 hold67 (.A(_255_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net67));
 sky130_fd_sc_hd__dlygate4sd3_1 hold68 (.A(\tempo_cnt[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net68));
 sky130_fd_sc_hd__dlygate4sd3_1 hold69 (.A(_249_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net69));
 sky130_fd_sc_hd__dlygate4sd3_1 hold70 (.A(\tempo_cnt[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net70));
 sky130_fd_sc_hd__dlygate4sd3_1 hold71 (.A(_253_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net71));
 sky130_fd_sc_hd__dlygate4sd3_1 hold72 (.A(\prescaler[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net72));
 sky130_fd_sc_hd__dlygate4sd3_1 hold73 (.A(\tempo_cnt[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net73));
 sky130_fd_sc_hd__dlygate4sd3_1 hold74 (.A(_257_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net74));
 sky130_fd_sc_hd__dlygate4sd3_1 hold75 (.A(\tempo_cnt[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net75));
 sky130_fd_sc_hd__dlygate4sd3_1 hold76 (.A(\prescaler[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net76));
 sky130_fd_sc_hd__dlygate4sd3_1 hold77 (.A(_263_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net77));
 sky130_fd_sc_hd__dlygate4sd3_1 hold78 (.A(\tempo_cnt[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net78));
 sky130_fd_sc_hd__dlygate4sd3_1 hold79 (.A(\prescaler[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net79));
 sky130_fd_sc_hd__dlygate4sd3_1 hold80 (.A(\tone_cnt[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net80));
 sky130_fd_sc_hd__dlygate4sd3_1 hold81 (.A(\dur_cnt[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold83 (.A(\note_addr[3] ),
    ...
    .VPWR(VPWR),
    .X(net83));
 sky130_fd_sc_hd__dlygate4sd3_1 hold84 (.A(\tone_cnt[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net84));
 sky130_fd_sc_hd__dlygate4sd3_1 hold85 (.A(\prescaler[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net85));
 sky130_fd_sc_hd__dlygate4sd3_1 hold86 (.A(\dur_cnt[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net86));
 sky130_fd_sc_hd__dlygate4sd3_1 hold87 (.A(\prescaler[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 input4 (.A(ui_in[1]),
    ...
    .VPWR(VPWR),
    .X(net4));
 sky130_fd_sc_hd__buf_2 load_slew30 (.A(net29),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 load_slew33 (.A(net32),
    ...
    .VPWR(VPWR),
    .X(net33));
 sky130_fd_sc_hd__clkbuf_2 max_cap10 (.A(_088_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net10));
 sky130_fd_sc_hd__buf_4 max_cap5 (.A(_171_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net5));
 sky130_fd_sc_hd__clkbuf_2 max_cap6 (.A(_109_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net6));
 sky130_fd_sc_hd__clkbuf_2 max_cap7 (.A(_079_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 max_cap8 (.A(net9),
    ...
    .VPWR(VPWR),
    .X(net8));
 sky130_fd_sc_hd__conb_1 tt_um_basic_na (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 tt_um_basic_na_35 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net35));
 sky130_fd_sc_hd__conb_1 tt_um_basic_na_36 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net36));
 sky130_fd_sc_hd__conb_1 tt_um_basic_na_37 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net37));
 sky130_fd_sc_hd__conb_1 tt_um_basic_na_38 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net38));
 sky130_fd_sc_hd__conb_1 tt_um_basic_na_39 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net39));
 sky130_fd_sc_hd__conb_1 tt_um_basic_na_40 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net40));
 sky130_fd_sc_hd__conb_1 tt_um_basic_na_41 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net41));
 sky130_fd_sc_hd__conb_1 tt_um_basic_na_42 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net42));
 sky130_fd_sc_hd__conb_1 tt_um_basic_na_43 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net43));
 sky130_fd_sc_hd__conb_1 tt_um_basic_na_44 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net44));
 sky130_fd_sc_hd__conb_1 tt_um_basic_na_45 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net45));
 sky130_fd_sc_hd__conb_1 tt_um_basic_na_46 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net46));
 sky130_fd_sc_hd__conb_1 tt_um_basic_na_47 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net47));
 sky130_fd_sc_hd__conb_1 tt_um_basic_na_48 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net48));
 sky130_fd_sc_hd__conb_1 tt_um_basic_na_49 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net49));
 sky130_fd_sc_hd__clkbuf_4 wire27 (.A(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net27));
 sky130_fd_sc_hd__clkbuf_2 wire9 (.A(_174_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
