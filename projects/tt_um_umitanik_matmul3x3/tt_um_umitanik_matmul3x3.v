module tt_um_umitanik_matmul3x3 (clk,
    ena,
    rst_n,
    VPWR,
    VGND,
 ...
 wire \core.k_idx[1] ;
 wire \core.load_en_d ;
 wire \core.load_idx[0] ;
 wire \core.load_idx[1] ;
 wire \core.load_idx[2] ;
 wire \core.load_idx[3] ;
 wire \core.out_valid ;
 wire \core.read_en_d ;
 wire \core.result_latch[0] ;
 wire \core.result_latch[1] ;
 wire \core.result_latch[2] ;
 wire \core.result_latch[3] ;
 wire \core.result_latch[4] ;
 wire \core.result_latch[5] ;
 wire \core.result_latch[6] ;
 wire \core.result_latch[7] ;
 wire \core.result_latch[8] ;
 wire \core.result_latch[9] ;
 wire \core.start_d ;
 wire \core.state[0] ;
 wire \core.state[2] ;
 wire \core.state[3] ;
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA_1 (.DIODE(\core.b_mem[8][1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__inv_2 _379_ (.A(net18),
    ...
    .VPWR(VPWR),
    .Y(_109_));
 sky130_fd_sc_hd__inv_2 _380_ (.A(\core.out_valid ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_110_));
 sky130_fd_sc_hd__inv_2 _381_ (.A(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_111_));
 sky130_fd_sc_hd__inv_2 _382_ (.A(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_112_));
 sky130_fd_sc_hd__inv_2 _383_ (.A(\core.state[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_113_));
 sky130_fd_sc_hd__inv_2 _384_ (.A(\core.start_d ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_114_));
 sky130_fd_sc_hd__inv_2 _385_ (.A(\core.load_idx[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_115_));
 sky130_fd_sc_hd__inv_2 _386_ (.A(\core.a_mem[6][0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_116_));
 sky130_fd_sc_hd__inv_2 _387_ (.A(\core.a_mem[6][1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_117_));
 sky130_fd_sc_hd__inv_2 _388_ (.A(\core.a_mem[6][2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_118_));
 sky130_fd_sc_hd__inv_2 _389_ (.A(\core.acc[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_119_));
 sky130_fd_sc_hd__nand2b_2 _390_ (.A_N(\core.read_en_d ),
    .B(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_120_));
 sky130_fd_sc_hd__and4b_2 _391_ (.A_N(\core.read_en_d ),
    .B(net8),
    .C(net16),
    .D(\core.out_valid ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_121_));
 sky130_fd_sc_hd__and2b_2 _392_ (.A_N(\core.j_idx[0] ),
    .B(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_122_));
 sky130_fd_sc_hd__or3b_2 _393_ (.A(_111_),
    .B(net25),
    .C_N(_122_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_123_));
 sky130_fd_sc_hd__and3_2 _394_ (.A(\core.state[2] ),
    .B(net7),
    .C(_114_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_124_));
 sky130_fd_sc_hd__nand2_2 _395_ (.A(net20),
    .B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_125_));
 sky130_fd_sc_hd__and2_2 _396_ (.A(\core.state[5] ),
    .B(_125_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_126_));
 sky130_fd_sc_hd__a211o_2 _397_ (.A1(_121_),
    .A2(_123_),
    .B1(_124_),
    .C1(_126_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_005_));
 sky130_fd_sc_hd__a41o_2 _398_ (.A1(net24),
    .A2(_112_),
    .A3(_121_),
    .A4(_122_),
    .B1(net73),
    ...
    .VPWR(VPWR),
    .X(_004_));
 sky130_fd_sc_hd__nor2_2 _399_ (.A(net27),
    .B(net28),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_127_));
 sky130_fd_sc_hd__or3b_2 _400_ (.A(\core.load_idx[2] ),
    .B(_115_),
    .C_N(_127_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_128_));
 sky130_fd_sc_hd__nand2b_2 _401_ (.A_N(\core.load_en_d ),
    .B(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_129_));
 sky130_fd_sc_hd__nor2_2 _402_ (.A(_128_),
    .B(_129_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_130_));
 sky130_fd_sc_hd__or2_2 _403_ (.A(_128_),
    .B(_129_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_131_));
 sky130_fd_sc_hd__and2_2 _404_ (.A(net15),
    .B(_130_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_132_));
 sky130_fd_sc_hd__a21o_2 _405_ (.A1(net14),
    .A2(_131_),
    .B1(_132_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_003_));
 sky130_fd_sc_hd__a21o_2 _406_ (.A1(net7),
    .A2(_114_),
    .B1(_113_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_133_));
 sky130_fd_sc_hd__and2_2 _407_ (.A(net14),
    .B(_130_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_134_));
 sky130_fd_sc_hd__a21bo_2 _408_ (.A1(net14),
    .A2(_130_),
    .B1_N(_133_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_002_));
 sky130_fd_sc_hd__and3_2 _409_ (.A(net20),
    .B(net17),
    .C(\core.state[5] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_135_));
 sky130_fd_sc_hd__nor2_2 _410_ (.A(_110_),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_136_));
 sky130_fd_sc_hd__a21oi_2 _411_ (.A1(\core.out_valid ),
    .A2(_120_),
    .B1(_136_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_137_));
 sky130_fd_sc_hd__nand2b_2 _412_ (.A_N(net13),
    .B(_137_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_001_));
 sky130_fd_sc_hd__and2_2 _413_ (.A(net15),
    .B(_131_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_000_));
 sky130_fd_sc_hd__nor2_2 _414_ (.A(net15),
    .B(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_138_));
 sky130_fd_sc_hd__or3_2 _415_ (.A(\core.state[5] ),
    .B(\core.state[0] ),
    .C(\core.state[3] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(busy));
 sky130_fd_sc_hd__mux2_1 _416_ (.A0(\core.result_latch[8] ),
    .A1(\core.result_latch[0] ),
    .S(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[0]));
 sky130_fd_sc_hd__mux2_1 _417_ (.A0(\core.result_latch[9] ),
    .A1(\core.result_latch[1] ),
    .S(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_2 _418_ (.A(net16),
    .B(\core.result_latch[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[2]));
 sky130_fd_sc_hd__and2_2 _419_ (.A(net16),
    .B(\core.result_latch[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[3]));
 sky130_fd_sc_hd__and2_2 _420_ (.A(net16),
    .B(\core.result_latch[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[4]));
 sky130_fd_sc_hd__and2_2 _421_ (.A(net16),
    .B(\core.result_latch[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[5]));
 sky130_fd_sc_hd__and2_2 _422_ (.A(net16),
    .B(\core.result_latch[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[6]));
 sky130_fd_sc_hd__and2_2 _423_ (.A(net16),
    .B(\core.result_latch[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[7]));
 sky130_fd_sc_hd__nor2_2 _424_ (.A(_129_),
    .B(_138_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_139_));
 sky130_fd_sc_hd__and2_2 _425_ (.A(net28),
    .B(_139_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_140_));
 sky130_fd_sc_hd__inv_2 _426_ (.A(_140_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_141_));
 sky130_fd_sc_hd__o211a_2 _427_ (.A1(net28),
    .A2(_139_),
    .B1(_141_),
    .C1(_128_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_006_));
 sky130_fd_sc_hd__xor2_2 _428_ (.A(net27),
    .B(_140_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_007_));
 sky130_fd_sc_hd__and3_2 _429_ (.A(net27),
    .B(\core.load_idx[2] ),
    .C(_140_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_142_));
 sky130_fd_sc_hd__a21oi_2 _430_ (.A1(\core.load_idx[1] ),
    .A2(_140_),
    .B1(net168),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_143_));
 sky130_fd_sc_hd__nor2_2 _431_ (.A(_142_),
    .B(net169),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_008_));
 sky130_fd_sc_hd__o21a_2 _432_ (.A1(_131_),
    .A2(_138_),
    .B1(\core.load_idx[3] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_144_));
 sky130_fd_sc_hd__mux2_1 _433_ (.A0(_144_),
    .A1(_115_),
    .S(_142_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_009_));
 sky130_fd_sc_hd__nand2_2 _434_ (.A(\core.out_valid ),
    .B(_113_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_145_));
 sky130_fd_sc_hd__nand2b_2 _435_ (.A_N(_124_),
    .B(_145_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_146_));
 sky130_fd_sc_hd__nand2_2 _436_ (.A(_137_),
    .B(_146_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_147_));
 sky130_fd_sc_hd__inv_2 _437_ (.A(_147_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_148_));
 sky130_fd_sc_hd__o211ai_2 _438_ (.A1(_110_),
    .A2(_122_),
    .B1(_148_),
    .C1(net25),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_149_));
 sky130_fd_sc_hd__a41o_2 _439_ (.A1(_111_),
    .A2(_121_),
    .A3(_122_),
    .A4(_146_),
    .B1(net25),
    ...
    .VPWR(VPWR),
    .X(_150_));
 sky130_fd_sc_hd__and2_2 _440_ (.A(_149_),
    .B(_150_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_010_));
 sky130_fd_sc_hd__and2_2 _441_ (.A(net24),
    .B(_149_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_151_));
 sky130_fd_sc_hd__nor2_2 _442_ (.A(net24),
    .B(_149_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_152_));
 sky130_fd_sc_hd__o22a_2 _443_ (.A1(\core.out_valid ),
    .A2(_147_),
    .B1(_151_),
    .B2(_152_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_011_));
 sky130_fd_sc_hd__and3b_2 _444_ (.A_N(\core.j_idx[1] ),
    .B(_121_),
    .C(_146_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _445_ (.A0(_153_),
    ...
    .VPWR(VPWR),
    .X(_012_));
 sky130_fd_sc_hd__a22o_2 _446_ (.A1(net163),
    .A2(_147_),
    .B1(_153_),
    .B2(\core.j_idx[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_013_));
 sky130_fd_sc_hd__and2_2 _447_ (.A(\core.state[5] ),
    .B(_133_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_154_));
 sky130_fd_sc_hd__a21oi_2 _448_ (.A1(\core.state[5] ),
    .A2(_113_),
    .B1(_124_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_155_));
 sky130_fd_sc_hd__mux2_1 _449_ (.A0(_154_),
    .A1(net9),
    .S(net21),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_014_));
 sky130_fd_sc_hd__nor2_2 _450_ (.A(net21),
    .B(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_156_));
 sky130_fd_sc_hd__xor2_2 _451_ (.A(net21),
    .B(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_157_));
 sky130_fd_sc_hd__and2_2 _452_ (.A(_126_),
    .B(_133_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_158_));
 sky130_fd_sc_hd__a22o_2 _453_ (.A1(net18),
    .A2(_155_),
    .B1(_157_),
    .B2(_154_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_015_));
 sky130_fd_sc_hd__a221o_2 _454_ (.A1(\core.out_valid ),
    .A2(_120_),
    .B1(_145_),
    .B2(_155_),
    .C1(_126_),
    ...
    .VPWR(VPWR),
    .X(_159_));
 sky130_fd_sc_hd__mux2_1 _455_ (.A0(_136_),
    .A1(net133),
    .S(_159_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_016_));
 sky130_fd_sc_hd__or2_2 _456_ (.A(net17),
    .B(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_160_));
 sky130_fd_sc_hd__o21ba_2 _457_ (.A1(net17),
    .A2(net26),
    .B1_N(net24),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_161_));
 sky130_fd_sc_hd__or2_2 _458_ (.A(net20),
    .B(\core.i_idx[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_162_));
 sky130_fd_sc_hd__or2_2 _459_ (.A(net20),
    .B(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_163_));
 sky130_fd_sc_hd__a31o_2 _460_ (.A1(_112_),
    .A2(_125_),
    .A3(_162_),
    .B1(_161_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_164_));
 sky130_fd_sc_hd__nand2_2 _461_ (.A(net20),
    .B(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_165_));
 sky130_fd_sc_hd__o21ai_2 _462_ (.A1(net21),
    .A2(net17),
    .B1(net26),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_166_));
 sky130_fd_sc_hd__xor2_2 _463_ (.A(net19),
    .B(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_167_));
 sky130_fd_sc_hd__xnor2_2 _464_ (.A(\core.i_idx[1] ),
    .B(_167_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_168_));
 sky130_fd_sc_hd__mux2_1 _465_ (.A0(_163_),
    .A1(_165_),
    .S(_168_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_169_));
 sky130_fd_sc_hd__and4b_2 _466_ (.A_N(net21),
    .B(net19),
    .C(_111_),
    .D(_112_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_170_));
 sky130_fd_sc_hd__nand2_2 _467_ (.A(\core.a_mem[2][0] ),
    .B(_170_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_171_));
 sky130_fd_sc_hd__and4_2 _468_ (.A(_111_),
    .B(_163_),
    .C(_166_),
    .D(_167_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_172_));
 sky130_fd_sc_hd__nand2_2 _469_ (.A(\core.a_mem[3][0] ),
    .B(_172_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_173_));
 sky130_fd_sc_hd__and4bb_2 _470_ (.A_N(net20),
    .B_N(net25),
    .C(net24),
    .D(net17),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_174_));
 sky130_fd_sc_hd__and4bb_2 _471_ (.A_N(net17),
    .B_N(net25),
    .C(net24),
    .D(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_175_));
 sky130_fd_sc_hd__nor4b_2 _472_ (.A(net17),
    .B(net24),
    .C(net25),
    .D_N(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_176_));
 sky130_fd_sc_hd__a22o_2 _473_ (.A1(\core.a_mem[8][0] ),
    .A2(_174_),
    .B1(net12),
    .B2(\core.a_mem[1][0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_177_));
 sky130_fd_sc_hd__a21oi_2 _474_ (.A1(\core.a_mem[7][0] ),
    .A2(_175_),
    .B1(_177_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_178_));
 sky130_fd_sc_hd__and4bb_2 _475_ (.A_N(net17),
    .B_N(net24),
    .C(net25),
    .D(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_179_));
 sky130_fd_sc_hd__and4bb_2 _476_ (.A_N(net20),
    .B_N(net24),
    .C(net25),
    .D(net17),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_180_));
 sky130_fd_sc_hd__a22o_2 _477_ (.A1(\core.a_mem[4][0] ),
    .A2(_179_),
    .B1(_180_),
    .B2(\core.a_mem[5][0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_181_));
 sky130_fd_sc_hd__and4b_2 _478_ (.A_N(_181_),
    .B(_173_),
    .C(_164_),
    .D(_178_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_182_));
 sky130_fd_sc_hd__mux2_1 _479_ (.A0(_160_),
    .A1(_166_),
    .S(_111_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_183_));
 sky130_fd_sc_hd__nor2_2 _480_ (.A(_169_),
    .B(_183_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_184_));
 sky130_fd_sc_hd__o31a_2 _481_ (.A1(_116_),
    .A2(_169_),
    .A3(_183_),
    .B1(_171_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_185_));
 sky130_fd_sc_hd__o2bb2a_2 _482_ (.A1_N(_182_),
    .A2_N(_185_),
    .B1(\core.a_mem[0][0] ),
    .B2(_164_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_186_));
 sky130_fd_sc_hd__or2_2 _483_ (.A(net18),
    .B(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_187_));
 sky130_fd_sc_hd__a21oi_2 _484_ (.A1(net21),
    .A2(net22),
    .B1(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_188_));
 sky130_fd_sc_hd__xor2_2 _485_ (.A(net21),
    .B(\core.j_idx[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_189_));
 sky130_fd_sc_hd__or2_2 _486_ (.A(net22),
    .B(_157_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_190_));
 sky130_fd_sc_hd__nand2_2 _487_ (.A(net22),
    .B(_157_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_191_));
 sky130_fd_sc_hd__and4_2 _488_ (.A(_188_),
    .B(_189_),
    .C(_190_),
    .D(_191_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_192_));
 sky130_fd_sc_hd__nand2_2 _489_ (.A(net18),
    .B(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_193_));
 sky130_fd_sc_hd__and4bb_2 _490_ (.A_N(net21),
    .B_N(net22),
    .C(\core.j_idx[0] ),
    .D(net18),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_194_));
 sky130_fd_sc_hd__a22o_2 _491_ (.A1(\core.b_mem[3][0] ),
    .A2(_192_),
    .B1(_194_),
    .B2(\core.b_mem[7][0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_195_));
 sky130_fd_sc_hd__and4_2 _492_ (.A(_109_),
    .B(net22),
    .C(_157_),
    .D(_189_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_196_));
 sky130_fd_sc_hd__and4b_2 _493_ (.A_N(_189_),
    .B(_157_),
    .C(_187_),
    .D(_193_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_197_));
 sky130_fd_sc_hd__and2_2 _494_ (.A(_122_),
    .B(_156_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_198_));
 sky130_fd_sc_hd__and4bb_2 _495_ (.A_N(net18),
    .B_N(net23),
    .C(\core.j_idx[0] ),
    .D(net21),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_199_));
 sky130_fd_sc_hd__and4bb_2 _496_ (.A_N(\core.k_idx[0] ),
    .B_N(\core.j_idx[0] ),
    .C(net23),
    .D(net18),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_200_));
 sky130_fd_sc_hd__a22o_2 _497_ (.A1(\core.b_mem[4][0] ),
    .A2(_199_),
    .B1(_200_),
    .B2(\core.b_mem[8][0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_201_));
 sky130_fd_sc_hd__a221o_2 _498_ (.A1(\core.b_mem[6][0] ),
    .A2(_197_),
    .B1(_198_),
    .B2(\core.b_mem[2][0] ),
    .C1(_201_),
    ...
    .VPWR(VPWR),
    .X(_202_));
 sky130_fd_sc_hd__a21o_2 _499_ (.A1(\core.b_mem[5][0] ),
    .A2(_196_),
    .B1(_202_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_203_));
 sky130_fd_sc_hd__nor4b_2 _500_ (.A(\core.k_idx[0] ),
    .B(net19),
    .C(net22),
    .D_N(\core.j_idx[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_204_));
 sky130_fd_sc_hd__nand2_2 _501_ (.A(net22),
    .B(\core.j_idx[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_205_));
 sky130_fd_sc_hd__a221oi_2 _502_ (.A1(_109_),
    .A2(net22),
    .B1(_157_),
    .B2(_205_),
    .C1(net11),
    ...
    .VPWR(VPWR),
    .Y(_206_));
 sky130_fd_sc_hd__a221o_2 _503_ (.A1(_109_),
    .A2(net22),
    .B1(_157_),
    .B2(_205_),
    .C1(net11),
    ...
    .VPWR(VPWR),
    .X(_207_));
 sky130_fd_sc_hd__a22o_2 _504_ (.A1(\core.b_mem[1][0] ),
    .A2(net10),
    .B1(_206_),
    .B2(\core.b_mem[0][0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_208_));
 sky130_fd_sc_hd__or3_2 _505_ (.A(_195_),
    .B(_203_),
    .C(_208_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_209_));
 sky130_fd_sc_hd__and2_2 _506_ (.A(_186_),
    .B(_209_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_210_));
 sky130_fd_sc_hd__or2_2 _507_ (.A(\core.acc[0] ),
    .B(_210_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_211_));
 sky130_fd_sc_hd__nand2_2 _508_ (.A(\core.acc[0] ),
    .B(_210_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_212_));
 sky130_fd_sc_hd__a32o_2 _509_ (.A1(_158_),
    .A2(_211_),
    .A3(_212_),
    .B1(net9),
    .B2(net166),
    ...
    .VPWR(VPWR),
    .X(_017_));
 sky130_fd_sc_hd__a22o_2 _510_ (.A1(\core.b_mem[4][1] ),
    .A2(_199_),
    .B1(_200_),
    .B2(\core.b_mem[8][1] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_213_));
 sky130_fd_sc_hd__a21o_2 _511_ (.A1(\core.b_mem[2][1] ),
    .A2(_198_),
    .B1(_213_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_214_));
 sky130_fd_sc_hd__a221o_2 _512_ (.A1(\core.b_mem[3][1] ),
    .A2(_192_),
    .B1(_197_),
    .B2(\core.b_mem[6][1] ),
    .C1(_214_),
    ...
    .VPWR(VPWR),
    .X(_215_));
 sky130_fd_sc_hd__a22o_2 _513_ (.A1(\core.b_mem[7][1] ),
    .A2(_194_),
    .B1(_196_),
    .B2(\core.b_mem[5][1] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_216_));
 sky130_fd_sc_hd__a22o_2 _514_ (.A1(\core.b_mem[1][1] ),
    .A2(net10),
    .B1(_206_),
    .B2(\core.b_mem[0][1] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_217_));
 sky130_fd_sc_hd__nor3_2 _515_ (.A(_215_),
    .B(_216_),
    .C(_217_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_218_));
 sky130_fd_sc_hd__nand2_2 _516_ (.A(\core.a_mem[2][1] ),
    .B(_170_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_219_));
 sky130_fd_sc_hd__nand2_2 _517_ (.A(\core.a_mem[3][1] ),
    .B(_172_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_220_));
 sky130_fd_sc_hd__a22o_2 _518_ (.A1(\core.a_mem[8][1] ),
    .A2(_174_),
    .B1(net12),
    .B2(\core.a_mem[1][1] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_221_));
 sky130_fd_sc_hd__a21oi_2 _519_ (.A1(\core.a_mem[7][1] ),
    .A2(_175_),
    .B1(_221_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_222_));
 sky130_fd_sc_hd__a22o_2 _520_ (.A1(\core.a_mem[4][1] ),
    .A2(_179_),
    .B1(_180_),
    .B2(\core.a_mem[5][1] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_223_));
 sky130_fd_sc_hd__and4b_2 _521_ (.A_N(_223_),
    .B(_220_),
    .C(_164_),
    .D(_222_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_224_));
 sky130_fd_sc_hd__o31a_2 _522_ (.A1(_117_),
    .A2(_169_),
    .A3(_183_),
    .B1(_219_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_225_));
 sky130_fd_sc_hd__o2bb2a_2 _523_ (.A1_N(_224_),
    .A2_N(_225_),
    .B1(\core.a_mem[0][1] ),
    .B2(_164_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_226_));
 sky130_fd_sc_hd__a2bb2o_2 _524_ (.A1_N(\core.a_mem[0][1] ),
    .A2_N(_164_),
    .B1(_224_),
    .B2(_225_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_227_));
 sky130_fd_sc_hd__and2b_2 _525_ (.A_N(_218_),
    .B(_186_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_228_));
 sky130_fd_sc_hd__and2_2 _526_ (.A(_209_),
    .B(_226_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_229_));
 sky130_fd_sc_hd__and2_2 _527_ (.A(_228_),
    .B(_229_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_230_));
 sky130_fd_sc_hd__nor2_2 _528_ (.A(_228_),
    .B(_229_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_231_));
 sky130_fd_sc_hd__nor2_2 _529_ (.A(_230_),
    .B(_231_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_232_));
 sky130_fd_sc_hd__nand2_2 _530_ (.A(\core.acc[1] ),
    .B(_232_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_233_));
 sky130_fd_sc_hd__or2_2 _531_ (.A(\core.acc[1] ),
    .B(_232_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_234_));
 sky130_fd_sc_hd__nand2_2 _532_ (.A(_233_),
    .B(_234_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_235_));
 sky130_fd_sc_hd__nand2_2 _533_ (.A(_212_),
    .B(_235_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_236_));
 sky130_fd_sc_hd__or2_2 _534_ (.A(_212_),
    .B(_235_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_237_));
 sky130_fd_sc_hd__a32o_2 _535_ (.A1(_158_),
    .A2(_236_),
    .A3(_237_),
    .B1(net9),
    .B2(net170),
    ...
    .VPWR(VPWR),
    .X(_018_));
 sky130_fd_sc_hd__a22o_2 _536_ (.A1(\core.b_mem[4][2] ),
    .A2(_199_),
    .B1(_200_),
    .B2(\core.b_mem[8][2] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_238_));
 sky130_fd_sc_hd__a221o_2 _537_ (.A1(\core.b_mem[6][2] ),
    .A2(_197_),
    .B1(_198_),
    .B2(\core.b_mem[2][2] ),
    .C1(_238_),
    ...
    .VPWR(VPWR),
    .X(_239_));
 sky130_fd_sc_hd__a221o_2 _538_ (.A1(\core.b_mem[3][2] ),
    .A2(_192_),
    .B1(_194_),
    .B2(\core.b_mem[7][2] ),
    .C1(_206_),
    ...
    .VPWR(VPWR),
    .X(_240_));
 sky130_fd_sc_hd__a22o_2 _539_ (.A1(\core.b_mem[5][2] ),
    .A2(_196_),
    .B1(net10),
    .B2(\core.b_mem[1][2] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_241_));
 sky130_fd_sc_hd__or2_2 _540_ (.A(\core.b_mem[0][2] ),
    .B(_207_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_242_));
 sky130_fd_sc_hd__o31a_2 _541_ (.A1(_239_),
    .A2(_240_),
    .A3(_241_),
    .B1(_242_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_243_));
 sky130_fd_sc_hd__or4bb_2 _542_ (.A(_218_),
    .B(_227_),
    .C_N(_243_),
    .D_N(_186_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_244_));
 sky130_fd_sc_hd__a2bb2o_2 _543_ (.A1_N(_218_),
    .A2_N(_227_),
    .B1(_243_),
    .B2(_186_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_245_));
 sky130_fd_sc_hd__nor3_2 _544_ (.A(_118_),
    .B(_169_),
    .C(_183_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_246_));
 sky130_fd_sc_hd__nand2_2 _545_ (.A(\core.a_mem[1][2] ),
    .B(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_247_));
 sky130_fd_sc_hd__a22o_2 _546_ (.A1(\core.a_mem[8][2] ),
    .A2(_174_),
    .B1(_175_),
    .B2(\core.a_mem[7][2] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_248_));
 sky130_fd_sc_hd__a22o_2 _547_ (.A1(\core.a_mem[4][2] ),
    .A2(_179_),
    .B1(_180_),
    .B2(\core.a_mem[5][2] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_249_));
 sky130_fd_sc_hd__or4bb_2 _548_ (.A(_248_),
    .B(_249_),
    .C_N(_164_),
    .D_N(_247_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_250_));
 sky130_fd_sc_hd__a221o_2 _549_ (.A1(\core.a_mem[2][2] ),
    .A2(_170_),
    .B1(_172_),
    .B2(\core.a_mem[3][2] ),
    .C1(_250_),
    ...
    .VPWR(VPWR),
    .X(_251_));
 sky130_fd_sc_hd__o22a_2 _550_ (.A1(\core.a_mem[0][2] ),
    .A2(_164_),
    .B1(_246_),
    .B2(_251_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_252_));
 sky130_fd_sc_hd__and2_2 _551_ (.A(_209_),
    .B(_252_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_253_));
 sky130_fd_sc_hd__and3_2 _552_ (.A(_244_),
    .B(_245_),
    .C(_253_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_254_));
 sky130_fd_sc_hd__a21o_2 _553_ (.A1(_244_),
    .A2(_245_),
    .B1(_253_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_255_));
 sky130_fd_sc_hd__nand2b_2 _554_ (.A_N(_254_),
    .B(_255_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_256_));
 sky130_fd_sc_hd__and3b_2 _555_ (.A_N(_254_),
    .B(_255_),
    .C(_230_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_257_));
 sky130_fd_sc_hd__xnor2_2 _556_ (.A(_230_),
    .B(_256_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_258_));
 sky130_fd_sc_hd__xnor2_2 _557_ (.A(\core.acc[2] ),
    .B(_258_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_259_));
 sky130_fd_sc_hd__xnor2_2 _558_ (.A(_233_),
    .B(_259_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_260_));
 sky130_fd_sc_hd__xor2_2 _559_ (.A(_237_),
    .B(_260_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_261_));
 sky130_fd_sc_hd__a22o_2 _560_ (.A1(\core.acc[2] ),
    .A2(_155_),
    .B1(_158_),
    .B2(_261_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_019_));
 sky130_fd_sc_hd__o32ai_2 _561_ (.A1(_212_),
    .A2(_235_),
    .A3(_260_),
    .B1(_259_),
    .B2(_233_),
    ...
    .VPWR(VPWR),
    .Y(_262_));
 sky130_fd_sc_hd__nand2_2 _562_ (.A(\core.a_mem[3][3] ),
    .B(_172_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_263_));
 sky130_fd_sc_hd__a22o_2 _563_ (.A1(\core.a_mem[8][3] ),
    .A2(_174_),
    .B1(_176_),
    .B2(\core.a_mem[1][3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_264_));
 sky130_fd_sc_hd__a21oi_2 _564_ (.A1(\core.a_mem[7][3] ),
    .A2(_175_),
    .B1(_264_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_265_));
 sky130_fd_sc_hd__a22o_2 _565_ (.A1(\core.a_mem[4][3] ),
    .A2(_179_),
    .B1(_180_),
    .B2(\core.a_mem[5][3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_266_));
 sky130_fd_sc_hd__and4b_2 _566_ (.A_N(_266_),
    .B(_263_),
    .C(_164_),
    .D(_265_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_267_));
 sky130_fd_sc_hd__a22oi_2 _567_ (.A1(\core.a_mem[2][3] ),
    .A2(_170_),
    .B1(_184_),
    .B2(\core.a_mem[6][3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_268_));
 sky130_fd_sc_hd__o2bb2a_2 _568_ (.A1_N(_267_),
    .A2_N(_268_),
    .B1(\core.a_mem[0][3] ),
    .B2(_164_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_269_));
 sky130_fd_sc_hd__and2_2 _569_ (.A(_209_),
    .B(_269_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_270_));
 sky130_fd_sc_hd__and2b_2 _570_ (.A_N(_218_),
    .B(_252_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_271_));
 sky130_fd_sc_hd__a32o_2 _571_ (.A1(\core.b_mem[2][3] ),
    .A2(_122_),
    .A3(_156_),
    .B1(_199_),
    .B2(\core.b_mem[4][3] ),
    ...
    .VPWR(VPWR),
    .X(_272_));
 sky130_fd_sc_hd__a221o_2 _572_ (.A1(\core.b_mem[6][3] ),
    .A2(_197_),
    .B1(_200_),
    .B2(\core.b_mem[8][3] ),
    .C1(_272_),
    ...
    .VPWR(VPWR),
    .X(_273_));
 sky130_fd_sc_hd__a221o_2 _573_ (.A1(\core.b_mem[3][3] ),
    .A2(_192_),
    .B1(_194_),
    .B2(\core.b_mem[7][3] ),
    .C1(_206_),
    ...
    .VPWR(VPWR),
    .X(_274_));
 sky130_fd_sc_hd__a221o_2 _574_ (.A1(\core.b_mem[5][3] ),
    .A2(_196_),
    .B1(_204_),
    .B2(\core.b_mem[1][3] ),
    .C1(_273_),
    ...
    .VPWR(VPWR),
    .X(_275_));
 sky130_fd_sc_hd__o22a_2 _575_ (.A1(\core.b_mem[0][3] ),
    .A2(_207_),
    .B1(_274_),
    .B2(_275_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_276_));
 sky130_fd_sc_hd__nand2_2 _576_ (.A(_226_),
    .B(_276_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_277_));
 sky130_fd_sc_hd__nand4_2 _577_ (.A(_186_),
    .B(_226_),
    .C(_243_),
    .D(_276_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_278_));
 sky130_fd_sc_hd__a22o_2 _578_ (.A1(_226_),
    .A2(_243_),
    .B1(_276_),
    .B2(_186_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_279_));
 sky130_fd_sc_hd__a21o_2 _579_ (.A1(_278_),
    .A2(_279_),
    .B1(_271_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_280_));
 sky130_fd_sc_hd__nand3_2 _580_ (.A(_271_),
    .B(_278_),
    .C(_279_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_281_));
 sky130_fd_sc_hd__nand3b_2 _581_ (.A_N(_244_),
    .B(_280_),
    .C(_281_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_282_));
 sky130_fd_sc_hd__a21bo_2 _582_ (.A1(_280_),
    .A2(_281_),
    .B1_N(_244_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_283_));
 sky130_fd_sc_hd__nand3_2 _583_ (.A(_270_),
    .B(_282_),
    .C(_283_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_284_));
 sky130_fd_sc_hd__a21o_2 _584_ (.A1(_282_),
    .A2(_283_),
    .B1(_270_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_285_));
 sky130_fd_sc_hd__nand3_2 _585_ (.A(_254_),
    .B(_284_),
    .C(_285_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_286_));
 sky130_fd_sc_hd__a21o_2 _586_ (.A1(_284_),
    .A2(_285_),
    .B1(_254_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_287_));
 sky130_fd_sc_hd__nand3_2 _587_ (.A(\core.acc[3] ),
    .B(_286_),
    .C(_287_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_288_));
 sky130_fd_sc_hd__a21o_2 _588_ (.A1(_286_),
    .A2(_287_),
    .B1(\core.acc[3] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_289_));
 sky130_fd_sc_hd__a21o_2 _589_ (.A1(\core.acc[2] ),
    .A2(_258_),
    .B1(_257_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_290_));
 sky130_fd_sc_hd__and3_2 _590_ (.A(_288_),
    .B(_289_),
    .C(_290_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_291_));
 sky130_fd_sc_hd__a21o_2 _591_ (.A1(_288_),
    .A2(_289_),
    .B1(_290_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_292_));
 sky130_fd_sc_hd__nand2b_2 _592_ (.A_N(_291_),
    .B(_292_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_293_));
 sky130_fd_sc_hd__xnor2_2 _593_ (.A(_262_),
    .B(_293_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_294_));
 sky130_fd_sc_hd__a22o_2 _594_ (.A1(\core.acc[3] ),
    .A2(net9),
    .B1(_158_),
    .B2(_294_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_020_));
 sky130_fd_sc_hd__a21o_2 _595_ (.A1(_262_),
    .A2(_292_),
    .B1(_291_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_295_));
 sky130_fd_sc_hd__and2_2 _596_ (.A(_278_),
    .B(_281_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_296_));
 sky130_fd_sc_hd__and2b_2 _597_ (.A_N(_218_),
    .B(_269_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_297_));
 sky130_fd_sc_hd__and2_2 _598_ (.A(_243_),
    .B(_252_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_298_));
 sky130_fd_sc_hd__nand2_2 _599_ (.A(_243_),
    .B(_252_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_299_));
 sky130_fd_sc_hd__xnor2_2 _600_ (.A(_277_),
    .B(_298_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_300_));
 sky130_fd_sc_hd__xnor2_2 _601_ (.A(_297_),
    .B(_300_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_301_));
 sky130_fd_sc_hd__or2_2 _602_ (.A(_296_),
    .B(_301_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_302_));
 sky130_fd_sc_hd__xnor2_2 _603_ (.A(_296_),
    .B(_301_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_303_));
 sky130_fd_sc_hd__a21boi_2 _604_ (.A1(_270_),
    .A2(_283_),
    .B1_N(_282_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_304_));
 sky130_fd_sc_hd__nor2_2 _605_ (.A(_303_),
    .B(_304_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_305_));
 sky130_fd_sc_hd__xor2_2 _606_ (.A(_303_),
    .B(_304_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_306_));
 sky130_fd_sc_hd__xnor2_2 _607_ (.A(\core.acc[4] ),
    .B(_306_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_307_));
 sky130_fd_sc_hd__a21boi_2 _608_ (.A1(\core.acc[3] ),
    .A2(_287_),
    .B1_N(_286_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_308_));
 sky130_fd_sc_hd__nor2_2 _609_ (.A(_307_),
    .B(_308_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_2 _610_ (.A(_307_),
    ...
    .VPWR(VPWR),
    .Y(_310_));
 sky130_fd_sc_hd__nand2b_2 _611_ (.A_N(_310_),
    .B(_295_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_311_));
 sky130_fd_sc_hd__xnor2_2 _612_ (.A(_295_),
    .B(_310_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_312_));
 sky130_fd_sc_hd__a22o_2 _613_ (.A1(\core.acc[4] ),
    .A2(net9),
    .B1(_158_),
    .B2(_312_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_021_));
 sky130_fd_sc_hd__a2bb2o_2 _614_ (.A1_N(_277_),
    .A2_N(_299_),
    .B1(_300_),
    .B2(_297_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_313_));
 sky130_fd_sc_hd__and3_2 _615_ (.A(_269_),
    .B(_276_),
    .C(_298_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_314_));
 sky130_fd_sc_hd__a22oi_2 _616_ (.A1(_243_),
    .A2(_269_),
    .B1(_276_),
    .B2(_252_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_315_));
 sky130_fd_sc_hd__or2_2 _617_ (.A(_314_),
    .B(_315_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_316_));
 sky130_fd_sc_hd__and2b_2 _618_ (.A_N(_316_),
    .B(_313_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_317_));
 sky130_fd_sc_hd__xor2_2 _619_ (.A(_313_),
    .B(_316_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_318_));
 sky130_fd_sc_hd__or2_2 _620_ (.A(_302_),
    .B(_318_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_319_));
 sky130_fd_sc_hd__xor2_2 _621_ (.A(_302_),
    .B(_318_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_320_));
 sky130_fd_sc_hd__nand2_2 _622_ (.A(\core.acc[5] ),
    .B(_320_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_321_));
 sky130_fd_sc_hd__xnor2_2 _623_ (.A(\core.acc[5] ),
    .B(_320_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_322_));
 sky130_fd_sc_hd__a21o_2 _624_ (.A1(\core.acc[4] ),
    .A2(_306_),
    .B1(_305_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_323_));
 sky130_fd_sc_hd__and2b_2 _625_ (.A_N(_322_),
    .B(_323_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_324_));
 sky130_fd_sc_hd__xnor2_2 _626_ (.A(_322_),
    .B(_323_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_325_));
 sky130_fd_sc_hd__nor2_2 _627_ (.A(_309_),
    .B(_325_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_326_));
 sky130_fd_sc_hd__and2b_2 _628_ (.A_N(_310_),
    .B(_325_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_327_));
 sky130_fd_sc_hd__and2_2 _629_ (.A(_309_),
    .B(_325_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_328_));
 sky130_fd_sc_hd__a21o_2 _630_ (.A1(_295_),
    .A2(_327_),
    .B1(_328_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_329_));
 sky130_fd_sc_hd__a21oi_2 _631_ (.A1(_311_),
    .A2(_326_),
    .B1(_329_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_330_));
 sky130_fd_sc_hd__a22o_2 _632_ (.A1(\core.acc[5] ),
    .A2(net9),
    .B1(_158_),
    .B2(_330_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_022_));
 sky130_fd_sc_hd__and3_2 _633_ (.A(_269_),
    .B(_276_),
    .C(_299_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_331_));
 sky130_fd_sc_hd__nand2_2 _634_ (.A(_317_),
    .B(_331_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_332_));
 sky130_fd_sc_hd__xnor2_2 _635_ (.A(_317_),
    .B(_331_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_333_));
 sky130_fd_sc_hd__or2_2 _636_ (.A(_119_),
    .B(_333_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_334_));
 sky130_fd_sc_hd__xnor2_2 _637_ (.A(_119_),
    .B(_333_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_335_));
 sky130_fd_sc_hd__a21o_2 _638_ (.A1(_319_),
    .A2(_321_),
    .B1(_335_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_336_));
 sky130_fd_sc_hd__nand3_2 _639_ (.A(_319_),
    .B(_321_),
    .C(_335_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_337_));
 sky130_fd_sc_hd__and2_2 _640_ (.A(_336_),
    .B(_337_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_338_));
 sky130_fd_sc_hd__or3_2 _641_ (.A(_324_),
    .B(_329_),
    .C(_338_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_339_));
 sky130_fd_sc_hd__o21ai_2 _642_ (.A1(_324_),
    .A2(_329_),
    .B1(_338_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_340_));
 sky130_fd_sc_hd__a32o_2 _643_ (.A1(_158_),
    .A2(_339_),
    .A3(_340_),
    .B1(net9),
    .B2(net165),
    ...
    .VPWR(VPWR),
    .X(_023_));
 sky130_fd_sc_hd__and2_2 _644_ (.A(\core.acc[7] ),
    .B(_314_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_341_));
 sky130_fd_sc_hd__nor2_2 _645_ (.A(\core.acc[7] ),
    .B(_314_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_342_));
 sky130_fd_sc_hd__or2_2 _646_ (.A(_341_),
    .B(_342_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_343_));
 sky130_fd_sc_hd__and3_2 _647_ (.A(_332_),
    .B(_334_),
    .C(_343_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_344_));
 sky130_fd_sc_hd__a21oi_2 _648_ (.A1(_332_),
    .A2(_334_),
    .B1(_343_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_345_));
 sky130_fd_sc_hd__a211o_2 _649_ (.A1(_336_),
    .A2(_340_),
    .B1(_344_),
    .C1(_345_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_346_));
 sky130_fd_sc_hd__o211ai_2 _650_ (.A1(_344_),
    .A2(_345_),
    .B1(_336_),
    .C1(_340_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_347_));
 sky130_fd_sc_hd__a32o_2 _651_ (.A1(_158_),
    .A2(_346_),
    .A3(_347_),
    .B1(net9),
    .B2(net167),
    ...
    .VPWR(VPWR),
    .X(_024_));
 sky130_fd_sc_hd__nand2_2 _652_ (.A(\core.acc[8] ),
    .B(_341_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_348_));
 sky130_fd_sc_hd__or2_2 _653_ (.A(\core.acc[8] ),
    .B(_341_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_349_));
 sky130_fd_sc_hd__nand2_2 _654_ (.A(_348_),
    .B(_349_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_350_));
 sky130_fd_sc_hd__o21bai_2 _655_ (.A1(_336_),
    .A2(_344_),
    .B1_N(_345_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_351_));
 sky130_fd_sc_hd__a2111oi_2 _656_ (.A1(_295_),
    .A2(_327_),
    .B1(_328_),
    .C1(_351_),
    .D1(_324_),
    ...
    .VPWR(VPWR),
    .Y(_352_));
 sky130_fd_sc_hd__nor2_2 _657_ (.A(_337_),
    .B(_345_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_353_));
 sky130_fd_sc_hd__o31ai_2 _658_ (.A1(_344_),
    .A2(_352_),
    .A3(_353_),
    .B1(_350_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_354_));
 sky130_fd_sc_hd__or4_2 _659_ (.A(_344_),
    .B(_350_),
    .C(_352_),
    .D(_353_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_355_));
 sky130_fd_sc_hd__a32o_2 _660_ (.A1(_158_),
    .A2(_354_),
    .A3(_355_),
    .B1(net9),
    .B2(net171),
    ...
    .VPWR(VPWR),
    .X(_025_));
 sky130_fd_sc_hd__nand3b_2 _661_ (.A_N(\core.acc[9] ),
    .B(_348_),
    .C(_355_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_356_));
 sky130_fd_sc_hd__a21bo_2 _662_ (.A1(_348_),
    .A2(_355_),
    .B1_N(\core.acc[9] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_357_));
 sky130_fd_sc_hd__a32o_2 _663_ (.A1(_158_),
    .A2(_356_),
    .A3(_357_),
    .B1(net9),
    .B2(net152),
    ...
    .VPWR(VPWR),
    .X(_026_));
 sky130_fd_sc_hd__mux2_1 _664_ (.A0(net79),
    .A1(\core.acc[0] ),
    .S(net13),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_027_));
 sky130_fd_sc_hd__mux2_1 _665_ (.A0(net77),
    .A1(\core.acc[1] ),
    .S(net13),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_028_));
 sky130_fd_sc_hd__mux2_1 _666_ (.A0(net74),
    .A1(\core.acc[2] ),
    .S(net13),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_029_));
 sky130_fd_sc_hd__mux2_1 _667_ (.A0(net82),
    .A1(\core.acc[3] ),
    .S(_135_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_030_));
 sky130_fd_sc_hd__mux2_1 _668_ (.A0(net99),
    .A1(\core.acc[4] ),
    .S(net13),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_031_));
 sky130_fd_sc_hd__mux2_1 _669_ (.A0(net137),
    .A1(\core.acc[5] ),
    .S(net13),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_032_));
 sky130_fd_sc_hd__mux2_1 _670_ (.A0(net148),
    .A1(\core.acc[6] ),
    .S(net13),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_033_));
 sky130_fd_sc_hd__mux2_1 _671_ (.A0(net146),
    .A1(\core.acc[7] ),
    .S(net13),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_034_));
 sky130_fd_sc_hd__mux2_1 _672_ (.A0(net106),
    .A1(\core.acc[8] ),
    .S(net13),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_035_));
 sky130_fd_sc_hd__mux2_1 _673_ (.A0(net150),
    .A1(\core.acc[9] ),
    .S(net13),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_036_));
 sky130_fd_sc_hd__nor3_2 _674_ (.A(\core.load_idx[2] ),
    .B(\core.load_idx[3] ),
    .C(_129_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_358_));
 sky130_fd_sc_hd__and3_2 _675_ (.A(net15),
    .B(_127_),
    .C(_358_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_359_));
 sky130_fd_sc_hd__mux2_1 _676_ (.A0(net75),
    .A1(net35),
    .S(_359_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_037_));
 sky130_fd_sc_hd__mux2_1 _677_ (.A0(net141),
    .A1(net34),
    .S(_359_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_038_));
 sky130_fd_sc_hd__mux2_1 _678_ (.A0(net96),
    .A1(net31),
    .S(_359_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_039_));
 sky130_fd_sc_hd__mux2_1 _679_ (.A0(net76),
    .A1(net30),
    .S(_359_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_040_));
 sky130_fd_sc_hd__and3b_2 _680_ (.A_N(net27),
    .B(net28),
    .C(_358_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_360_));
 sky130_fd_sc_hd__and2_2 _681_ (.A(net15),
    .B(_360_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_361_));
 sky130_fd_sc_hd__mux2_1 _682_ (.A0(net118),
    .A1(net35),
    .S(_361_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_041_));
 sky130_fd_sc_hd__mux2_1 _683_ (.A0(net139),
    .A1(net33),
    .S(_361_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_042_));
 sky130_fd_sc_hd__mux2_1 _684_ (.A0(net160),
    .A1(net31),
    .S(_361_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_043_));
 sky130_fd_sc_hd__mux2_1 _685_ (.A0(net95),
    .A1(net29),
    .S(_361_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_044_));
 sky130_fd_sc_hd__and3b_2 _686_ (.A_N(net28),
    .B(_358_),
    .C(net27),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_362_));
 sky130_fd_sc_hd__and2_2 _687_ (.A(net15),
    .B(_362_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_363_));
 sky130_fd_sc_hd__mux2_1 _688_ (.A0(net164),
    .A1(net35),
    .S(_363_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_045_));
 sky130_fd_sc_hd__mux2_1 _689_ (.A0(net156),
    .A1(net34),
    .S(_363_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_046_));
 sky130_fd_sc_hd__mux2_1 _690_ (.A0(net111),
    .A1(net31),
    .S(_363_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_047_));
 sky130_fd_sc_hd__mux2_1 _691_ (.A0(net161),
    .A1(net29),
    .S(_363_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_048_));
 sky130_fd_sc_hd__and3_2 _692_ (.A(net27),
    .B(net28),
    .C(_358_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_364_));
 sky130_fd_sc_hd__and2_2 _693_ (.A(net15),
    .B(_364_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_365_));
 sky130_fd_sc_hd__mux2_1 _694_ (.A0(net142),
    .A1(net35),
    .S(_365_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_049_));
 sky130_fd_sc_hd__mux2_1 _695_ (.A0(net155),
    .A1(net34),
    .S(_365_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_050_));
 sky130_fd_sc_hd__mux2_1 _696_ (.A0(net129),
    .A1(net31),
    .S(_365_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_051_));
 sky130_fd_sc_hd__mux2_1 _697_ (.A0(net159),
    .A1(net30),
    .S(_365_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_052_));
 sky130_fd_sc_hd__and4b_2 _698_ (.A_N(\core.load_en_d ),
    .B(\core.load_idx[2] ),
    .C(_115_),
    .D(net6),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_366_));
 sky130_fd_sc_hd__and3_2 _699_ (.A(net15),
    .B(_127_),
    .C(_366_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_367_));
 sky130_fd_sc_hd__mux2_1 _700_ (.A0(net90),
    .A1(net35),
    .S(_367_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_053_));
 sky130_fd_sc_hd__mux2_1 _701_ (.A0(net127),
    .A1(net34),
    .S(_367_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_054_));
 sky130_fd_sc_hd__mux2_1 _702_ (.A0(net92),
    .A1(net31),
    .S(_367_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_055_));
 sky130_fd_sc_hd__mux2_1 _703_ (.A0(net122),
    .A1(net30),
    .S(_367_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_056_));
 sky130_fd_sc_hd__and4b_2 _704_ (.A_N(net27),
    .B(net28),
    .C(_366_),
    .D(net15),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_368_));
 sky130_fd_sc_hd__mux2_1 _705_ (.A0(net116),
    .A1(net35),
    .S(_368_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_057_));
 sky130_fd_sc_hd__mux2_1 _706_ (.A0(net130),
    .A1(net34),
    .S(_368_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_058_));
 sky130_fd_sc_hd__mux2_1 _707_ (.A0(net128),
    .A1(net31),
    .S(_368_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_059_));
 sky130_fd_sc_hd__mux2_1 _708_ (.A0(net134),
    .A1(net30),
    .S(_368_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_060_));
 sky130_fd_sc_hd__and4b_2 _709_ (.A_N(net28),
    .B(_366_),
    .C(\core.state[0] ),
    .D(net27),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_369_));
 sky130_fd_sc_hd__mux2_1 _710_ (.A0(net154),
    .A1(net35),
    .S(_369_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_061_));
 sky130_fd_sc_hd__mux2_1 _711_ (.A0(net153),
    .A1(net34),
    .S(_369_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_062_));
 sky130_fd_sc_hd__mux2_1 _712_ (.A0(net157),
    .A1(net31),
    .S(_369_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_063_));
 sky130_fd_sc_hd__mux2_1 _713_ (.A0(net144),
    .A1(net30),
    .S(_369_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_064_));
 sky130_fd_sc_hd__and4_2 _714_ (.A(net15),
    .B(net27),
    .C(net28),
    .D(_366_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_370_));
 sky130_fd_sc_hd__mux2_1 _715_ (.A0(net158),
    .A1(net35),
    .S(_370_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_065_));
 sky130_fd_sc_hd__mux2_1 _716_ (.A0(net162),
    .A1(net34),
    .S(_370_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_066_));
 sky130_fd_sc_hd__mux2_1 _717_ (.A0(net123),
    .A1(net31),
    .S(_370_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_067_));
 sky130_fd_sc_hd__mux2_1 _718_ (.A0(net143),
    .A1(net29),
    .S(_370_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_068_));
 sky130_fd_sc_hd__mux2_1 _719_ (.A0(net102),
    .A1(net35),
    .S(_132_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_069_));
 sky130_fd_sc_hd__mux2_1 _720_ (.A0(net132),
    .A1(net33),
    .S(_132_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_070_));
 sky130_fd_sc_hd__mux2_1 _721_ (.A0(net108),
    .A1(net31),
    .S(_132_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_071_));
 sky130_fd_sc_hd__mux2_1 _722_ (.A0(net88),
    .A1(net29),
    .S(_132_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_072_));
 sky130_fd_sc_hd__and3_2 _723_ (.A(net14),
    .B(_127_),
    .C(_358_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_371_));
 sky130_fd_sc_hd__mux2_1 _724_ (.A0(net93),
    .A1(net35),
    .S(_371_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_073_));
 sky130_fd_sc_hd__mux2_1 _725_ (.A0(net138),
    .A1(net33),
    .S(_371_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_074_));
 sky130_fd_sc_hd__mux2_1 _726_ (.A0(net81),
    .A1(net31),
    .S(_371_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_075_));
 sky130_fd_sc_hd__mux2_1 _727_ (.A0(net113),
    .A1(net29),
    .S(_371_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_076_));
 sky130_fd_sc_hd__and2_2 _728_ (.A(net14),
    .B(_360_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_372_));
 sky130_fd_sc_hd__mux2_1 _729_ (.A0(net114),
    .A1(net36),
    .S(_372_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_077_));
 sky130_fd_sc_hd__mux2_1 _730_ (.A0(net131),
    .A1(net33),
    .S(_372_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_078_));
 sky130_fd_sc_hd__mux2_1 _731_ (.A0(net140),
    .A1(net32),
    .S(_372_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_079_));
 sky130_fd_sc_hd__mux2_1 _732_ (.A0(net136),
    .A1(net29),
    .S(_372_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_080_));
 sky130_fd_sc_hd__and2_2 _733_ (.A(\core.state[3] ),
    .B(_362_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_373_));
 sky130_fd_sc_hd__mux2_1 _734_ (.A0(net103),
    .A1(net36),
    .S(_373_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_081_));
 sky130_fd_sc_hd__mux2_1 _735_ (.A0(net117),
    .A1(net33),
    .S(_373_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_082_));
 sky130_fd_sc_hd__mux2_1 _736_ (.A0(net105),
    .A1(net32),
    .S(_373_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_083_));
 sky130_fd_sc_hd__mux2_1 _737_ (.A0(net91),
    .A1(net29),
    .S(_373_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_084_));
 sky130_fd_sc_hd__and2_2 _738_ (.A(net14),
    .B(_364_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_374_));
 sky130_fd_sc_hd__mux2_1 _739_ (.A0(net124),
    .A1(net36),
    .S(_374_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_085_));
 sky130_fd_sc_hd__mux2_1 _740_ (.A0(net97),
    .A1(net33),
    .S(_374_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_086_));
 sky130_fd_sc_hd__mux2_1 _741_ (.A0(net101),
    .A1(net32),
    .S(_374_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_087_));
 sky130_fd_sc_hd__mux2_1 _742_ (.A0(net84),
    .A1(net29),
    .S(_374_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_088_));
 sky130_fd_sc_hd__and3_2 _743_ (.A(net14),
    .B(_127_),
    .C(_366_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_375_));
 sky130_fd_sc_hd__mux2_1 _744_ (.A0(net119),
    .A1(net36),
    .S(_375_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_089_));
 sky130_fd_sc_hd__mux2_1 _745_ (.A0(net125),
    .A1(net33),
    .S(_375_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_090_));
 sky130_fd_sc_hd__mux2_1 _746_ (.A0(net120),
    .A1(net32),
    .S(_375_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_091_));
 sky130_fd_sc_hd__mux2_1 _747_ (.A0(net126),
    .A1(net30),
    .S(_375_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_092_));
 sky130_fd_sc_hd__and4b_2 _748_ (.A_N(\core.load_idx[1] ),
    .B(\core.load_idx[0] ),
    .C(_366_),
    .D(net14),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_376_));
 sky130_fd_sc_hd__mux2_1 _749_ (.A0(net112),
    .A1(net36),
    .S(_376_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_093_));
 sky130_fd_sc_hd__mux2_1 _750_ (.A0(net85),
    .A1(net33),
    .S(_376_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_094_));
 sky130_fd_sc_hd__mux2_1 _751_ (.A0(net86),
    .A1(net32),
    .S(_376_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_095_));
 sky130_fd_sc_hd__mux2_1 _752_ (.A0(net87),
    .A1(net29),
    .S(_376_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_096_));
 sky130_fd_sc_hd__and4b_2 _753_ (.A_N(\core.load_idx[0] ),
    .B(_366_),
    .C(\core.state[3] ),
    .D(\core.load_idx[1] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_377_));
 sky130_fd_sc_hd__mux2_1 _754_ (.A0(net100),
    .A1(net36),
    .S(_377_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_097_));
 sky130_fd_sc_hd__mux2_1 _755_ (.A0(net109),
    .A1(net33),
    .S(_377_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_098_));
 sky130_fd_sc_hd__mux2_1 _756_ (.A0(net115),
    .A1(net32),
    .S(_377_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_099_));
 sky130_fd_sc_hd__mux2_1 _757_ (.A0(net83),
    .A1(net30),
    .S(_377_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_100_));
 sky130_fd_sc_hd__and4_2 _758_ (.A(net14),
    .B(net27),
    .C(net28),
    .D(_366_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_378_));
 sky130_fd_sc_hd__mux2_1 _759_ (.A0(net94),
    .A1(net36),
    .S(_378_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _760_ (.A0(net89),
    ...
    .VPWR(VPWR),
    .X(_102_));
 sky130_fd_sc_hd__mux2_1 _761_ (.A0(net98),
    .A1(net32),
    .S(_378_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_103_));
 sky130_fd_sc_hd__mux2_1 _762_ (.A0(net110),
    .A1(net29),
    .S(_378_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_104_));
 sky130_fd_sc_hd__mux2_1 _763_ (.A0(net104),
    .A1(net36),
    .S(_134_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_105_));
 sky130_fd_sc_hd__mux2_1 _764_ (.A0(net145),
    .A1(net34),
    .S(_134_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_106_));
 sky130_fd_sc_hd__mux2_1 _765_ (.A0(net135),
    .A1(net32),
    .S(_134_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_107_));
 sky130_fd_sc_hd__mux2_1 _766_ (.A0(net121),
    .A1(net30),
    .S(_134_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_108_));
 sky130_fd_sc_hd__dfrtp_2 _767_ (.CLK(clknet_4_3_0_clk),
    .D(_006_),
    .RESET_B(net54),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.load_idx[0] ));
 sky130_fd_sc_hd__dfrtp_2 _768_ (.CLK(clknet_4_12_0_clk),
    .D(_007_),
    .RESET_B(net54),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.load_idx[1] ));
 sky130_fd_sc_hd__dfrtp_2 _769_ (.CLK(clknet_4_6_0_clk),
    .D(_008_),
    .RESET_B(net54),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.load_idx[2] ));
 sky130_fd_sc_hd__dfrtp_2 _770_ (.CLK(clknet_4_3_0_clk),
    .D(_009_),
    .RESET_B(net54),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.load_idx[3] ));
 sky130_fd_sc_hd__dfrtp_2 _771_ (.CLK(clknet_4_6_0_clk),
    .D(_010_),
    .RESET_B(net54),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.i_idx[0] ));
 sky130_fd_sc_hd__dfrtp_2 _772_ (.CLK(clknet_4_6_0_clk),
    .D(_011_),
    .RESET_B(net44),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.i_idx[1] ));
 sky130_fd_sc_hd__dfrtp_2 _773_ (.CLK(clknet_4_12_0_clk),
    .D(_012_),
    .RESET_B(net54),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _774_ (.CLK(clknet_4_12_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\core.j_idx[1] ));
 sky130_fd_sc_hd__dfrtp_2 _775_ (.CLK(clknet_4_12_0_clk),
    .D(_014_),
    .RESET_B(net54),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.k_idx[0] ));
 sky130_fd_sc_hd__dfrtp_2 _776_ (.CLK(clknet_4_12_0_clk),
    .D(_015_),
    .RESET_B(net53),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.k_idx[1] ));
 sky130_fd_sc_hd__dfrtp_2 _777_ (.CLK(clknet_4_7_0_clk),
    .D(_016_),
    .RESET_B(net55),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.byte_idx ));
 sky130_fd_sc_hd__dfrtp_2 _778_ (.CLK(clknet_4_7_0_clk),
    .D(_017_),
    .RESET_B(net45),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _779_ (.CLK(clknet_4_7_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\core.acc[1] ));
 sky130_fd_sc_hd__dfrtp_2 _780_ (.CLK(clknet_4_6_0_clk),
    .D(_019_),
    .RESET_B(net44),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.acc[2] ));
 sky130_fd_sc_hd__dfrtp_2 _781_ (.CLK(clknet_4_5_0_clk),
    .D(_020_),
    .RESET_B(net43),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _782_ (.CLK(clknet_4_5_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\core.acc[4] ));
 sky130_fd_sc_hd__dfrtp_2 _783_ (.CLK(clknet_4_4_0_clk),
    .D(_022_),
    .RESET_B(net43),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.acc[5] ));
 sky130_fd_sc_hd__dfrtp_2 _784_ (.CLK(clknet_4_4_0_clk),
    .D(_023_),
    .RESET_B(net43),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.acc[6] ));
 sky130_fd_sc_hd__dfrtp_2 _785_ (.CLK(clknet_4_4_0_clk),
    .D(_024_),
    .RESET_B(net46),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.acc[7] ));
 sky130_fd_sc_hd__dfrtp_2 _786_ (.CLK(clknet_4_4_0_clk),
    .D(_025_),
    .RESET_B(net43),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.acc[8] ));
 sky130_fd_sc_hd__dfrtp_2 _787_ (.CLK(clknet_4_4_0_clk),
    .D(_026_),
    .RESET_B(net43),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.acc[9] ));
 sky130_fd_sc_hd__dfrtp_2 _788_ (.CLK(clknet_4_7_0_clk),
    .D(net80),
    .RESET_B(net45),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.result_latch[0] ));
 sky130_fd_sc_hd__dfrtp_2 _789_ (.CLK(clknet_4_7_0_clk),
    .D(net78),
    .RESET_B(net45),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.result_latch[1] ));
 sky130_fd_sc_hd__dfrtp_2 _790_ (.CLK(clknet_4_7_0_clk),
    .D(_029_),
    .RESET_B(net45),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _791_ (.CLK(clknet_4_5_0_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.result_latch[3] ));
 sky130_fd_sc_hd__dfrtp_2 _792_ (.CLK(clknet_4_5_0_clk),
    .D(_031_),
    .RESET_B(net42),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.result_latch[4] ));
 sky130_fd_sc_hd__dfrtp_2 _793_ (.CLK(clknet_4_4_0_clk),
    .D(_032_),
    .RESET_B(net43),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.result_latch[5] ));
 sky130_fd_sc_hd__dfrtp_2 _794_ (.CLK(clknet_4_5_0_clk),
    .D(net149),
    .RESET_B(net43),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _797_ (.CLK(clknet_4_5_0_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.result_latch[9] ));
 sky130_fd_sc_hd__dfrtp_2 _798_ (.CLK(clknet_4_0_0_clk),
    .D(_037_),
    .RESET_B(net37),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.a_mem[0][0] ));
 sky130_fd_sc_hd__dfrtp_2 _799_ (.CLK(clknet_4_1_0_clk),
    .D(_038_),
    .RESET_B(net41),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _800_ (.CLK(clknet_4_1_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\core.a_mem[0][2] ));
 sky130_fd_sc_hd__dfrtp_2 _801_ (.CLK(clknet_4_1_0_clk),
    .D(_040_),
    .RESET_B(net41),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.a_mem[0][3] ));
 sky130_fd_sc_hd__dfrtp_2 _802_ (.CLK(clknet_4_8_0_clk),
    .D(_041_),
    .RESET_B(net47),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _803_ (.CLK(clknet_4_9_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\core.a_mem[1][1] ));
 sky130_fd_sc_hd__dfrtp_2 _804_ (.CLK(clknet_4_9_0_clk),
    .D(_043_),
    .RESET_B(net47),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.a_mem[1][2] ));
 sky130_fd_sc_hd__dfrtp_2 _805_ (.CLK(clknet_4_9_0_clk),
    .D(_044_),
    .RESET_B(net48),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.a_mem[1][3] ));
 sky130_fd_sc_hd__dfrtp_2 _806_ (.CLK(clknet_4_3_0_clk),
    .D(_045_),
    .RESET_B(net39),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.a_mem[2][0] ));
 sky130_fd_sc_hd__dfrtp_2 _807_ (.CLK(clknet_4_3_0_clk),
    .D(_046_),
    .RESET_B(net52),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.a_mem[2][1] ));
 sky130_fd_sc_hd__dfrtp_2 _808_ (.CLK(clknet_4_2_0_clk),
    .D(_047_),
    .RESET_B(net39),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _809_ (.CLK(clknet_4_3_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\core.a_mem[2][3] ));
 sky130_fd_sc_hd__dfrtp_2 _810_ (.CLK(clknet_4_0_0_clk),
    .D(_049_),
    .RESET_B(net37),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.a_mem[3][0] ));
 sky130_fd_sc_hd__dfrtp_2 _811_ (.CLK(clknet_4_1_0_clk),
    .D(_050_),
    .RESET_B(net41),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.a_mem[3][1] ));
 sky130_fd_sc_hd__dfrtp_2 _812_ (.CLK(clknet_4_2_0_clk),
    .D(_051_),
    .RESET_B(net37),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.a_mem[3][2] ));
 sky130_fd_sc_hd__dfrtp_2 _813_ (.CLK(clknet_4_1_0_clk),
    .D(_052_),
    .RESET_B(net41),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.a_mem[3][3] ));
 sky130_fd_sc_hd__dfrtp_2 _814_ (.CLK(clknet_4_0_0_clk),
    .D(_053_),
    .RESET_B(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.a_mem[4][0] ));
 sky130_fd_sc_hd__dfrtp_2 _815_ (.CLK(clknet_4_1_0_clk),
    .D(_054_),
    .RESET_B(net41),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.a_mem[4][1] ));
 sky130_fd_sc_hd__dfrtp_2 _816_ (.CLK(clknet_4_2_0_clk),
    .D(_055_),
    .RESET_B(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.a_mem[4][2] ));
 sky130_fd_sc_hd__dfrtp_2 _817_ (.CLK(clknet_4_0_0_clk),
    .D(_056_),
    .RESET_B(net41),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _818_ (.CLK(clknet_4_0_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\core.a_mem[5][0] ));
 sky130_fd_sc_hd__dfrtp_2 _819_ (.CLK(clknet_4_1_0_clk),
    .D(_058_),
    .RESET_B(net41),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.a_mem[5][1] ));
 sky130_fd_sc_hd__dfrtp_2 _820_ (.CLK(clknet_4_2_0_clk),
    .D(_059_),
    .RESET_B(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.a_mem[5][2] ));
 sky130_fd_sc_hd__dfrtp_2 _821_ (.CLK(clknet_4_0_0_clk),
    .D(_060_),
    .RESET_B(net41),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.a_mem[5][3] ));
 sky130_fd_sc_hd__dfrtp_2 _822_ (.CLK(clknet_4_6_0_clk),
    .D(_061_),
    .RESET_B(net39),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.a_mem[6][0] ));
 sky130_fd_sc_hd__dfrtp_2 _823_ (.CLK(clknet_4_6_0_clk),
    .D(_062_),
    .RESET_B(net39),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.a_mem[6][1] ));
 sky130_fd_sc_hd__dfrtp_2 _824_ (.CLK(clknet_4_3_0_clk),
    .D(_063_),
    .RESET_B(net44),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.a_mem[6][2] ));
 sky130_fd_sc_hd__dfrtp_2 _825_ (.CLK(clknet_4_0_0_clk),
    .D(_064_),
    .RESET_B(net39),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _826_ (.CLK(clknet_4_8_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\core.a_mem[7][0] ));
 sky130_fd_sc_hd__dfrtp_2 _827_ (.CLK(clknet_4_2_0_clk),
    .D(_066_),
    .RESET_B(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.a_mem[7][1] ));
 sky130_fd_sc_hd__dfrtp_2 _828_ (.CLK(clknet_4_2_0_clk),
    .D(_067_),
    .RESET_B(net48),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.a_mem[7][2] ));
 sky130_fd_sc_hd__dfrtp_2 _829_ (.CLK(clknet_4_2_0_clk),
    .D(_068_),
    .RESET_B(net48),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.a_mem[7][3] ));
 sky130_fd_sc_hd__dfrtp_2 _830_ (.CLK(clknet_4_8_0_clk),
    .D(_069_),
    .RESET_B(net48),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _832_ (.CLK(clknet_4_8_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\core.a_mem[8][2] ));
 sky130_fd_sc_hd__dfrtp_2 _833_ (.CLK(clknet_4_8_0_clk),
    .D(_072_),
    .RESET_B(net48),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.a_mem[8][3] ));
 sky130_fd_sc_hd__dfrtp_2 _834_ (.CLK(clknet_4_10_0_clk),
    .D(_073_),
    .RESET_B(net50),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.b_mem[0][0] ));
 sky130_fd_sc_hd__dfrtp_2 _835_ (.CLK(clknet_4_10_0_clk),
    .D(_074_),
    .RESET_B(net50),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _836_ (.CLK(clknet_4_11_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\core.b_mem[0][2] ));
 sky130_fd_sc_hd__dfrtp_2 _837_ (.CLK(clknet_4_9_0_clk),
    .D(_076_),
    .RESET_B(net50),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.b_mem[0][3] ));
 sky130_fd_sc_hd__dfrtp_2 _838_ (.CLK(clknet_4_10_0_clk),
    .D(_077_),
    .RESET_B(net50),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.b_mem[1][0] ));
 sky130_fd_sc_hd__dfrtp_2 _839_ (.CLK(clknet_4_10_0_clk),
    .D(_078_),
    .RESET_B(net50),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _840_ (.CLK(clknet_4_10_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\core.b_mem[1][2] ));
 sky130_fd_sc_hd__dfrtp_2 _841_ (.CLK(clknet_4_9_0_clk),
    .D(_080_),
    .RESET_B(net50),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.b_mem[1][3] ));
 sky130_fd_sc_hd__dfrtp_2 _842_ (.CLK(clknet_4_14_0_clk),
    .D(_081_),
    .RESET_B(net56),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.b_mem[2][0] ));
 sky130_fd_sc_hd__dfrtp_2 _843_ (.CLK(clknet_4_15_0_clk),
    .D(_082_),
    .RESET_B(net56),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.b_mem[2][1] ));
 sky130_fd_sc_hd__dfrtp_2 _844_ (.CLK(clknet_4_15_0_clk),
    .D(_083_),
    .RESET_B(net56),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.b_mem[2][2] ));
 sky130_fd_sc_hd__dfrtp_2 _845_ (.CLK(clknet_4_15_0_clk),
    .D(_084_),
    .RESET_B(net57),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.b_mem[2][3] ));
 sky130_fd_sc_hd__dfrtp_2 _846_ (.CLK(clknet_4_10_0_clk),
    .D(_085_),
    .RESET_B(net49),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.b_mem[3][0] ));
 sky130_fd_sc_hd__dfrtp_2 _847_ (.CLK(clknet_4_14_0_clk),
    .D(_086_),
    .RESET_B(net59),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.b_mem[3][1] ));
 sky130_fd_sc_hd__dfrtp_2 _848_ (.CLK(clknet_4_11_0_clk),
    .D(_087_),
    .RESET_B(net51),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.b_mem[3][2] ));
 sky130_fd_sc_hd__dfrtp_2 _849_ (.CLK(clknet_4_9_0_clk),
    .D(_088_),
    .RESET_B(net50),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.b_mem[3][3] ));
 sky130_fd_sc_hd__dfrtp_2 _850_ (.CLK(clknet_4_15_0_clk),
    .D(_089_),
    .RESET_B(net57),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.b_mem[4][0] ));
 sky130_fd_sc_hd__dfrtp_2 _851_ (.CLK(clknet_4_14_0_clk),
    .D(_090_),
    .RESET_B(net58),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.b_mem[4][1] ));
 sky130_fd_sc_hd__dfrtp_2 _852_ (.CLK(clknet_4_13_0_clk),
    .D(_091_),
    .RESET_B(net57),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.b_mem[4][2] ));
 sky130_fd_sc_hd__dfrtp_2 _853_ (.CLK(clknet_4_13_0_clk),
    .D(_092_),
    .RESET_B(net57),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.b_mem[4][3] ));
 sky130_fd_sc_hd__dfrtp_2 _854_ (.CLK(clknet_4_14_0_clk),
    .D(_093_),
    .RESET_B(net59),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.b_mem[5][0] ));
 sky130_fd_sc_hd__dfrtp_2 _855_ (.CLK(clknet_4_11_0_clk),
    .D(_094_),
    .RESET_B(net59),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.b_mem[5][1] ));
 sky130_fd_sc_hd__dfrtp_2 _856_ (.CLK(clknet_4_11_0_clk),
    .D(_095_),
    .RESET_B(net59),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.b_mem[5][2] ));
 sky130_fd_sc_hd__dfrtp_2 _857_ (.CLK(clknet_4_11_0_clk),
    .D(_096_),
    .RESET_B(net51),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.b_mem[5][3] ));
 sky130_fd_sc_hd__dfrtp_2 _858_ (.CLK(clknet_4_14_0_clk),
    .D(_097_),
    .RESET_B(net58),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _859_ (.CLK(clknet_4_14_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\core.b_mem[6][1] ));
 sky130_fd_sc_hd__dfrtp_2 _860_ (.CLK(clknet_4_15_0_clk),
    .D(_099_),
    .RESET_B(net58),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _861_ (.CLK(clknet_4_12_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\core.b_mem[6][3] ));
 sky130_fd_sc_hd__dfrtp_2 _862_ (.CLK(clknet_4_10_0_clk),
    .D(_101_),
    .RESET_B(net51),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _863_ (.CLK(clknet_4_11_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\core.b_mem[7][1] ));
 sky130_fd_sc_hd__dfrtp_2 _864_ (.CLK(clknet_4_11_0_clk),
    .D(_103_),
    .RESET_B(net51),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.b_mem[7][2] ));
 sky130_fd_sc_hd__dfrtp_2 _865_ (.CLK(clknet_4_9_0_clk),
    .D(_104_),
    .RESET_B(net51),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.b_mem[7][3] ));
 sky130_fd_sc_hd__dfrtp_2 _866_ (.CLK(clknet_4_14_0_clk),
    .D(_105_),
    .RESET_B(net58),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _867_ (.CLK(clknet_4_15_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\core.b_mem[8][1] ));
 sky130_fd_sc_hd__dfrtp_2 _868_ (.CLK(clknet_4_15_0_clk),
    .D(_107_),
    .RESET_B(net57),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.b_mem[8][2] ));
 sky130_fd_sc_hd__dfrtp_2 _869_ (.CLK(clknet_4_13_0_clk),
    .D(_108_),
    .RESET_B(net57),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.b_mem[8][3] ));
 sky130_fd_sc_hd__dfstp_2 _870_ (.CLK(clknet_4_3_0_clk),
    .D(_000_),
    .SET_B(net52),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _871_ (.CLK(clknet_4_7_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\core.out_valid ));
 sky130_fd_sc_hd__dfrtp_2 _872_ (.CLK(clknet_4_13_0_clk),
    .D(_002_),
    .RESET_B(net55),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.state[2] ));
 sky130_fd_sc_hd__dfrtp_2 _873_ (.CLK(clknet_4_8_0_clk),
    .D(_003_),
    .RESET_B(net52),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.state[3] ));
 sky130_fd_sc_hd__dfrtp_2 _874_ (.CLK(clknet_4_6_0_clk),
    .D(_004_),
    .RESET_B(net46),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.done ));
 sky130_fd_sc_hd__dfrtp_2 _875_ (.CLK(clknet_4_13_0_clk),
    .D(_005_),
    .RESET_B(net55),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.state[5] ));
 sky130_fd_sc_hd__dfrtp_2 _876_ (.CLK(clknet_4_13_0_clk),
    .D(net8),
    .RESET_B(net55),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.read_en_d ));
 sky130_fd_sc_hd__dfrtp_2 _877_ (.CLK(clknet_4_12_0_clk),
    .D(net6),
    .RESET_B(net54),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.load_en_d ));
 sky130_fd_sc_hd__dfrtp_2 _878_ (.CLK(clknet_4_13_0_clk),
    .D(net7),
    .RESET_B(net55),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\core.start_d ));
 sky130_fd_sc_hd__buf_2 _892_ (.A(busy),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[0]));
 sky130_fd_sc_hd__buf_2 _893_ (.A(\core.done ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[1]));
 sky130_fd_sc_hd__buf_2 _894_ (.A(\core.out_valid ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 clkload9 (.A(clknet_4_10_0_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout13 (.A(_135_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net13));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout14 (.A(\core.state[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net14));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout15 (.A(\core.state[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net15));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout16 (.A(\core.byte_idx ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout18 (.A(net19),
    ...
    .VPWR(VPWR),
    .X(net18));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout19 (.A(\core.k_idx[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout20 (.A(net21),
    ...
    .VPWR(VPWR),
    .X(net20));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout21 (.A(\core.k_idx[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout22 (.A(net23),
    ...
    .VPWR(VPWR),
    .X(net22));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout23 (.A(\core.j_idx[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net23));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout24 (.A(\core.i_idx[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net24));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout25 (.A(\core.i_idx[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net25));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout26 (.A(\core.i_idx[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net26));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout27 (.A(\core.load_idx[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net27));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout28 (.A(\core.load_idx[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout29 (.A(net30),
    ...
    .VPWR(VPWR),
    .X(net29));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout30 (.A(net5),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net30));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout31 (.A(net4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net31));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout32 (.A(net4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout33 (.A(net34),
    ...
    .VPWR(VPWR),
    .X(net33));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout34 (.A(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net34));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout35 (.A(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout39 (.A(net41),
    ...
    .VPWR(VPWR),
    .X(net39));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout40 (.A(net60),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout44 (.A(net46),
    ...
    .VPWR(VPWR),
    .X(net44));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout46 (.A(net60),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout60 (.A(net1),
    ...
    .VPWR(VPWR),
    .X(net60));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout9 (.A(_155_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__dlygate4sd3_1 hold100 (.A(\core.b_mem[6][0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net100));
 sky130_fd_sc_hd__dlygate4sd3_1 hold101 (.A(\core.b_mem[3][2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net101));
 sky130_fd_sc_hd__dlygate4sd3_1 hold102 (.A(\core.a_mem[8][0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net102));
 sky130_fd_sc_hd__dlygate4sd3_1 hold103 (.A(\core.b_mem[2][0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net103));
 sky130_fd_sc_hd__dlygate4sd3_1 hold104 (.A(\core.b_mem[8][0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net104));
 sky130_fd_sc_hd__dlygate4sd3_1 hold105 (.A(\core.b_mem[2][2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net105));
 sky130_fd_sc_hd__dlygate4sd3_1 hold106 (.A(\core.result_latch[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold107 (.A(_035_),
    ...
    .VPWR(VPWR),
    .X(net107));
 sky130_fd_sc_hd__dlygate4sd3_1 hold108 (.A(\core.a_mem[8][2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net108));
 sky130_fd_sc_hd__dlygate4sd3_1 hold109 (.A(\core.b_mem[6][1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net109));
 sky130_fd_sc_hd__dlygate4sd3_1 hold110 (.A(\core.b_mem[7][3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net110));
 sky130_fd_sc_hd__dlygate4sd3_1 hold111 (.A(\core.a_mem[2][2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net111));
 sky130_fd_sc_hd__dlygate4sd3_1 hold112 (.A(\core.b_mem[5][0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net112));
 sky130_fd_sc_hd__dlygate4sd3_1 hold113 (.A(\core.b_mem[0][3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net113));
 sky130_fd_sc_hd__dlygate4sd3_1 hold114 (.A(\core.b_mem[1][0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net114));
 sky130_fd_sc_hd__dlygate4sd3_1 hold115 (.A(\core.b_mem[6][2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net115));
 sky130_fd_sc_hd__dlygate4sd3_1 hold116 (.A(\core.a_mem[5][0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net116));
 sky130_fd_sc_hd__dlygate4sd3_1 hold117 (.A(\core.b_mem[2][1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net117));
 sky130_fd_sc_hd__dlygate4sd3_1 hold118 (.A(\core.a_mem[1][0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net118));
 sky130_fd_sc_hd__dlygate4sd3_1 hold119 (.A(\core.b_mem[4][0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net119));
 sky130_fd_sc_hd__dlygate4sd3_1 hold120 (.A(\core.b_mem[4][2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net120));
 sky130_fd_sc_hd__dlygate4sd3_1 hold121 (.A(\core.b_mem[8][3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net121));
 sky130_fd_sc_hd__dlygate4sd3_1 hold122 (.A(\core.a_mem[4][3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net122));
 sky130_fd_sc_hd__dlygate4sd3_1 hold123 (.A(\core.a_mem[7][2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net123));
 sky130_fd_sc_hd__dlygate4sd3_1 hold124 (.A(\core.b_mem[3][0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net124));
 sky130_fd_sc_hd__dlygate4sd3_1 hold125 (.A(\core.b_mem[4][1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net125));
 sky130_fd_sc_hd__dlygate4sd3_1 hold126 (.A(\core.b_mem[4][3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net126));
 sky130_fd_sc_hd__dlygate4sd3_1 hold127 (.A(\core.a_mem[4][1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net127));
 sky130_fd_sc_hd__dlygate4sd3_1 hold128 (.A(\core.a_mem[5][2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net128));
 sky130_fd_sc_hd__dlygate4sd3_1 hold129 (.A(\core.a_mem[3][2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net129));
 sky130_fd_sc_hd__dlygate4sd3_1 hold130 (.A(\core.a_mem[5][1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net130));
 sky130_fd_sc_hd__dlygate4sd3_1 hold131 (.A(\core.b_mem[1][1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net131));
 sky130_fd_sc_hd__dlygate4sd3_1 hold132 (.A(\core.a_mem[8][1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net132));
 sky130_fd_sc_hd__dlygate4sd3_1 hold133 (.A(\core.byte_idx ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net133));
 sky130_fd_sc_hd__dlygate4sd3_1 hold134 (.A(\core.a_mem[5][3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net134));
 sky130_fd_sc_hd__dlygate4sd3_1 hold135 (.A(\core.b_mem[8][2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net135));
 sky130_fd_sc_hd__dlygate4sd3_1 hold136 (.A(\core.b_mem[1][3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net136));
 sky130_fd_sc_hd__dlygate4sd3_1 hold137 (.A(\core.result_latch[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net137));
 sky130_fd_sc_hd__dlygate4sd3_1 hold138 (.A(\core.b_mem[0][1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net138));
 sky130_fd_sc_hd__dlygate4sd3_1 hold139 (.A(\core.a_mem[1][1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net139));
 sky130_fd_sc_hd__dlygate4sd3_1 hold140 (.A(\core.b_mem[1][2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net140));
 sky130_fd_sc_hd__dlygate4sd3_1 hold141 (.A(\core.a_mem[0][1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net141));
 sky130_fd_sc_hd__dlygate4sd3_1 hold142 (.A(\core.a_mem[3][0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net142));
 sky130_fd_sc_hd__dlygate4sd3_1 hold143 (.A(\core.a_mem[7][3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net143));
 sky130_fd_sc_hd__dlygate4sd3_1 hold144 (.A(\core.a_mem[6][3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net144));
 sky130_fd_sc_hd__dlygate4sd3_1 hold145 (.A(\core.b_mem[8][1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net145));
 sky130_fd_sc_hd__dlygate4sd3_1 hold146 (.A(\core.result_latch[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net146));
 sky130_fd_sc_hd__dlygate4sd3_1 hold147 (.A(_034_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net147));
 sky130_fd_sc_hd__dlygate4sd3_1 hold148 (.A(\core.result_latch[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net148));
 sky130_fd_sc_hd__dlygate4sd3_1 hold149 (.A(_033_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net149));
 sky130_fd_sc_hd__dlygate4sd3_1 hold150 (.A(\core.result_latch[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net150));
 sky130_fd_sc_hd__dlygate4sd3_1 hold151 (.A(_036_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net151));
 sky130_fd_sc_hd__dlygate4sd3_1 hold152 (.A(\core.acc[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net152));
 sky130_fd_sc_hd__dlygate4sd3_1 hold153 (.A(\core.a_mem[6][1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net153));
 sky130_fd_sc_hd__dlygate4sd3_1 hold154 (.A(\core.a_mem[6][0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net154));
 sky130_fd_sc_hd__dlygate4sd3_1 hold155 (.A(\core.a_mem[3][1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net155));
 sky130_fd_sc_hd__dlygate4sd3_1 hold156 (.A(\core.a_mem[2][1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net156));
 sky130_fd_sc_hd__dlygate4sd3_1 hold157 (.A(\core.a_mem[6][2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net157));
 sky130_fd_sc_hd__dlygate4sd3_1 hold158 (.A(\core.a_mem[7][0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net158));
 sky130_fd_sc_hd__dlygate4sd3_1 hold159 (.A(\core.a_mem[3][3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net159));
 sky130_fd_sc_hd__dlygate4sd3_1 hold160 (.A(\core.a_mem[1][2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net160));
 sky130_fd_sc_hd__dlygate4sd3_1 hold161 (.A(\core.a_mem[2][3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net161));
 sky130_fd_sc_hd__dlygate4sd3_1 hold162 (.A(\core.a_mem[7][1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net162));
 sky130_fd_sc_hd__dlygate4sd3_1 hold163 (.A(\core.j_idx[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net163));
 sky130_fd_sc_hd__dlygate4sd3_1 hold164 (.A(\core.a_mem[2][0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net164));
 sky130_fd_sc_hd__dlygate4sd3_1 hold165 (.A(\core.acc[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net165));
 sky130_fd_sc_hd__dlygate4sd3_1 hold166 (.A(\core.acc[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net166));
 sky130_fd_sc_hd__dlygate4sd3_1 hold167 (.A(\core.acc[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net167));
 sky130_fd_sc_hd__dlygate4sd3_1 hold168 (.A(\core.load_idx[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net168));
 sky130_fd_sc_hd__dlygate4sd3_1 hold169 (.A(_143_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net169));
 sky130_fd_sc_hd__dlygate4sd3_1 hold170 (.A(\core.acc[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net170));
 sky130_fd_sc_hd__dlygate4sd3_1 hold171 (.A(\core.acc[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net171));
 sky130_fd_sc_hd__dlygate4sd3_1 hold73 (.A(\core.done ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net73));
 sky130_fd_sc_hd__dlygate4sd3_1 hold74 (.A(\core.result_latch[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net74));
 sky130_fd_sc_hd__dlygate4sd3_1 hold75 (.A(\core.a_mem[0][0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net75));
 sky130_fd_sc_hd__dlygate4sd3_1 hold76 (.A(\core.a_mem[0][3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net76));
 sky130_fd_sc_hd__dlygate4sd3_1 hold77 (.A(\core.result_latch[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net77));
 sky130_fd_sc_hd__dlygate4sd3_1 hold78 (.A(_028_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net78));
 sky130_fd_sc_hd__dlygate4sd3_1 hold79 (.A(\core.result_latch[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net79));
 sky130_fd_sc_hd__dlygate4sd3_1 hold80 (.A(_027_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net80));
 sky130_fd_sc_hd__dlygate4sd3_1 hold81 (.A(\core.b_mem[0][2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net81));
 sky130_fd_sc_hd__dlygate4sd3_1 hold82 (.A(\core.result_latch[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net82));
 sky130_fd_sc_hd__dlygate4sd3_1 hold83 (.A(\core.b_mem[6][3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net83));
 sky130_fd_sc_hd__dlygate4sd3_1 hold84 (.A(\core.b_mem[3][3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net84));
 sky130_fd_sc_hd__dlygate4sd3_1 hold85 (.A(\core.b_mem[5][1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net85));
 sky130_fd_sc_hd__dlygate4sd3_1 hold86 (.A(\core.b_mem[5][2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net86));
 sky130_fd_sc_hd__dlygate4sd3_1 hold87 (.A(\core.b_mem[5][3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net87));
 sky130_fd_sc_hd__dlygate4sd3_1 hold88 (.A(\core.a_mem[8][3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net88));
 sky130_fd_sc_hd__dlygate4sd3_1 hold89 (.A(\core.b_mem[7][1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net89));
 sky130_fd_sc_hd__dlygate4sd3_1 hold90 (.A(\core.a_mem[4][0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net90));
 sky130_fd_sc_hd__dlygate4sd3_1 hold91 (.A(\core.b_mem[2][3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net91));
 sky130_fd_sc_hd__dlygate4sd3_1 hold92 (.A(\core.a_mem[4][2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net92));
 sky130_fd_sc_hd__dlygate4sd3_1 hold93 (.A(\core.b_mem[0][0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net93));
 sky130_fd_sc_hd__dlygate4sd3_1 hold94 (.A(\core.b_mem[7][0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net94));
 sky130_fd_sc_hd__dlygate4sd3_1 hold95 (.A(\core.a_mem[1][3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net95));
 sky130_fd_sc_hd__dlygate4sd3_1 hold96 (.A(\core.a_mem[0][2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net96));
 sky130_fd_sc_hd__dlygate4sd3_1 hold97 (.A(\core.b_mem[3][1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net97));
 sky130_fd_sc_hd__dlygate4sd3_1 hold98 (.A(\core.b_mem[7][2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net98));
 sky130_fd_sc_hd__dlygate4sd3_1 hold99 (.A(\core.result_latch[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 input5 (.A(ui_in[3]),
    ...
    .VPWR(VPWR),
    .X(net5));
 sky130_fd_sc_hd__clkdlybuf4s25_1 input6 (.A(uio_in[3]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net6));
 sky130_fd_sc_hd__clkdlybuf4s25_1 input7 (.A(uio_in[4]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net7));
 sky130_fd_sc_hd__clkdlybuf4s25_1 input8 (.A(uio_in[5]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net8));
 sky130_fd_sc_hd__clkbuf_2 load_slew38 (.A(net37),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 load_slew57 (.A(net56),
    ...
    .VPWR(VPWR),
    .X(net57));
 sky130_fd_sc_hd__buf_1 max_cap10 (.A(_204_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net10));
 sky130_fd_sc_hd__buf_1 max_cap11 (.A(_204_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net11));
 sky130_fd_sc_hd__buf_1 max_cap12 (.A(_176_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net12));
 sky130_fd_sc_hd__conb_1 tt_um_umitanik_matmul3x3 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 tt_um_umitanik_matmul3x3_61 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net61));
 sky130_fd_sc_hd__conb_1 tt_um_umitanik_matmul3x3_62 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net62));
 sky130_fd_sc_hd__conb_1 tt_um_umitanik_matmul3x3_63 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net63));
 sky130_fd_sc_hd__conb_1 tt_um_umitanik_matmul3x3_64 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net64));
 sky130_fd_sc_hd__conb_1 tt_um_umitanik_matmul3x3_65 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net65));
 sky130_fd_sc_hd__conb_1 tt_um_umitanik_matmul3x3_66 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net66));
 sky130_fd_sc_hd__conb_1 tt_um_umitanik_matmul3x3_67 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net67));
 sky130_fd_sc_hd__conb_1 tt_um_umitanik_matmul3x3_68 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net68));
 sky130_fd_sc_hd__conb_1 tt_um_umitanik_matmul3x3_69 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net69));
 sky130_fd_sc_hd__conb_1 tt_um_umitanik_matmul3x3_70 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net70));
 sky130_fd_sc_hd__conb_1 tt_um_umitanik_matmul3x3_71 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net71));
 sky130_fd_sc_hd__conb_1 tt_um_umitanik_matmul3x3_72 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net72));
