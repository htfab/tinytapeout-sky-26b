module tt_um_jacob_kebaso_4bit_cpu (clk,
    ena,
    rst_n,
    VPWR,
    VGND,
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_137 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _142_ (.A(phase_out),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_101_));
 sky130_fd_sc_hd__inv_2 _143_ (.A(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_102_));
 sky130_fd_sc_hd__inv_2 _144_ (.A(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _145_ (.A(net18),
    ...
    .VPWR(VPWR),
    .Y(_104_));
 sky130_fd_sc_hd__inv_2 _146_ (.A(uio_out[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _147_ (.A(uio_out[3]),
    ...
    .VPWR(VPWR),
    .Y(_106_));
 sky130_fd_sc_hd__and2_2 _148_ (.A(net1),
    .B(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\u_cpu.rst_n ));
 sky130_fd_sc_hd__and2_2 _149_ (.A(net19),
    .B(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_107_));
 sky130_fd_sc_hd__nor2_2 _150_ (.A(phase_out),
    .B(halted_out),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_108_));
 sky130_fd_sc_hd__a41o_2 _151_ (.A1(phase_out),
    .A2(net22),
    .A3(net20),
    .A4(_107_),
    .B1(net41),
    ...
    .VPWR(VPWR),
    .X(_000_));
 sky130_fd_sc_hd__a311oi_2 _152_ (.A1(net22),
    .A2(net20),
    .A3(_107_),
    .B1(halted_out),
    .C1(_101_),
    ...
    .VPWR(VPWR),
    .Y(_109_));
 sky130_fd_sc_hd__and3b_2 _153_ (.A_N(net20),
    .B(net19),
    .C(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_110_));
 sky130_fd_sc_hd__nand3b_2 _154_ (.A_N(net19),
    .B(net18),
    .C(net20),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_111_));
 sky130_fd_sc_hd__or3_2 _155_ (.A(net20),
    .B(net19),
    .C(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_112_));
 sky130_fd_sc_hd__or2_2 _156_ (.A(net22),
    .B(_112_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_113_));
 sky130_fd_sc_hd__and4b_2 _157_ (.A_N(_110_),
    .B(_111_),
    .C(_113_),
    .D(_109_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_114_));
 sky130_fd_sc_hd__nand4b_2 _158_ (.A_N(_110_),
    .B(_111_),
    .C(_113_),
    .D(_109_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_115_));
 sky130_fd_sc_hd__nand2_2 _159_ (.A(\u_cpu.imm[0] ),
    .B(uo_out[0]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_116_));
 sky130_fd_sc_hd__nor2_2 _160_ (.A(\u_cpu.imm[0] ),
    .B(uo_out[0]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_117_));
 sky130_fd_sc_hd__or2_2 _161_ (.A(\u_cpu.imm[0] ),
    .B(uo_out[0]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_118_));
 sky130_fd_sc_hd__nand2_2 _162_ (.A(_116_),
    .B(_118_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_119_));
 sky130_fd_sc_hd__and2b_2 _163_ (.A_N(net22),
    .B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_120_));
 sky130_fd_sc_hd__or3b_2 _164_ (.A(net19),
    .B(net18),
    .C_N(_120_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_121_));
 sky130_fd_sc_hd__or4bb_2 _165_ (.A(net22),
    .B(net18),
    .C_N(net19),
    .D_N(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_122_));
 sky130_fd_sc_hd__and4_2 _166_ (.A(net22),
    .B(net20),
    .C(_103_),
    .D(_104_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_123_));
 sky130_fd_sc_hd__or4bb_2 _167_ (.A(net19),
    .B(net18),
    .C_N(net23),
    .D_N(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_124_));
 sky130_fd_sc_hd__and2_2 _168_ (.A(_122_),
    .B(_124_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_125_));
 sky130_fd_sc_hd__a21o_2 _169_ (.A1(_121_),
    .A2(_125_),
    .B1(_119_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_126_));
 sky130_fd_sc_hd__and4bb_2 _170_ (.A_N(net21),
    .B_N(net19),
    .C(net18),
    .D(net23),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_127_));
 sky130_fd_sc_hd__inv_2 _171_ (.A(_127_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_128_));
 sky130_fd_sc_hd__or4b_2 _172_ (.A(net23),
    .B(net21),
    .C(\u_cpu.ir[7] ),
    .D_N(\u_cpu.ir[6] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_129_));
 sky130_fd_sc_hd__inv_2 _173_ (.A(_129_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_130_));
 sky130_fd_sc_hd__o2bb2a_2 _174_ (.A1_N(uo_out[1]),
    .A2_N(_127_),
    .B1(_129_),
    .B2(_116_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_131_));
 sky130_fd_sc_hd__and2_2 _175_ (.A(_107_),
    .B(_120_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_132_));
 sky130_fd_sc_hd__or4b_2 _176_ (.A(_102_),
    .B(net18),
    .C(_103_),
    .D_N(net22),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_133_));
 sky130_fd_sc_hd__o2bb2a_2 _177_ (.A1_N(net11),
    .A2_N(_132_),
    .B1(_133_),
    .B2(net26),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_134_));
 sky130_fd_sc_hd__o311a_2 _178_ (.A1(_103_),
    .A2(_104_),
    .A3(_120_),
    .B1(_112_),
    .C1(_111_),
    ...
    .VPWR(VPWR),
    .X(_135_));
 sky130_fd_sc_hd__or4bb_2 _179_ (.A(net21),
    .B(\u_cpu.ir[7] ),
    .C_N(\u_cpu.ir[6] ),
    .D_N(net23),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_136_));
 sky130_fd_sc_hd__o2111a_2 _180_ (.A1(_117_),
    .A2(_136_),
    .B1(_135_),
    .C1(_134_),
    .D1(_131_),
    ...
    .VPWR(VPWR),
    .X(_137_));
 sky130_fd_sc_hd__o2bb2a_2 _181_ (.A1_N(_126_),
    .A2_N(_137_),
    .B1(_135_),
    .B2(\u_cpu.imm[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_138_));
 sky130_fd_sc_hd__mux2_1 _182_ (.A0(uo_out[0]),
    .A1(_138_),
    .S(_114_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_001_));
 sky130_fd_sc_hd__or2_2 _183_ (.A(\u_cpu.imm[1] ),
    .B(uo_out[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_139_));
 sky130_fd_sc_hd__and2b_2 _184_ (.A_N(_136_),
    .B(_139_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_140_));
 sky130_fd_sc_hd__xnor2_2 _185_ (.A(\u_cpu.imm[1] ),
    .B(uo_out[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_141_));
 sky130_fd_sc_hd__nand2b_2 _186_ (.A_N(uo_out[0]),
    .B(\u_cpu.imm[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_020_));
 sky130_fd_sc_hd__nand2_2 _187_ (.A(net17),
    .B(_020_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_021_));
 sky130_fd_sc_hd__or2_2 _188_ (.A(net17),
    .B(_020_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_022_));
 sky130_fd_sc_hd__xnor2_2 _189_ (.A(_116_),
    .B(_141_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_023_));
 sky130_fd_sc_hd__nor2_2 _190_ (.A(_121_),
    .B(_023_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_024_));
 sky130_fd_sc_hd__nor4b_2 _191_ (.A(net23),
    .B(net21),
    .C(\u_cpu.ir[6] ),
    .D_N(\u_cpu.ir[7] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_025_));
 sky130_fd_sc_hd__inv_2 _192_ (.A(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_026_));
 sky130_fd_sc_hd__o22ai_2 _193_ (.A1(uo_out[1]),
    .A2(_133_),
    .B1(net17),
    .B2(_122_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_027_));
 sky130_fd_sc_hd__a31o_2 _194_ (.A1(_123_),
    .A2(_021_),
    .A3(_022_),
    .B1(_027_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_028_));
 sky130_fd_sc_hd__a221o_2 _195_ (.A1(uo_out[2]),
    .A2(_127_),
    .B1(net16),
    .B2(uo_out[0]),
    .C1(_140_),
    ...
    .VPWR(VPWR),
    .X(_029_));
 sky130_fd_sc_hd__a32o_2 _196_ (.A1(\u_cpu.imm[1] ),
    .A2(uo_out[1]),
    .A3(_130_),
    .B1(_132_),
    .B2(net12),
    ...
    .VPWR(VPWR),
    .X(_030_));
 sky130_fd_sc_hd__or4b_2 _197_ (.A(_024_),
    .B(_029_),
    .C(_030_),
    .D_N(_135_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_031_));
 sky130_fd_sc_hd__nor2_2 _198_ (.A(_028_),
    .B(_031_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_032_));
 sky130_fd_sc_hd__o21ai_2 _199_ (.A1(\u_cpu.imm[1] ),
    .A2(_135_),
    .B1(_114_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_033_));
 sky130_fd_sc_hd__a2bb2o_2 _200_ (.A1_N(_032_),
    .A2_N(_033_),
    .B1(uo_out[1]),
    .B2(_115_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_002_));
 sky130_fd_sc_hd__and2_2 _201_ (.A(\u_cpu.imm[2] ),
    .B(uo_out[2]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_034_));
 sky130_fd_sc_hd__or2_2 _202_ (.A(\u_cpu.imm[2] ),
    .B(uo_out[2]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_035_));
 sky130_fd_sc_hd__nand2b_2 _203_ (.A_N(_034_),
    .B(_035_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_036_));
 sky130_fd_sc_hd__and2b_2 _204_ (.A_N(\u_cpu.imm[1] ),
    .B(uo_out[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_037_));
 sky130_fd_sc_hd__a21o_2 _205_ (.A1(net17),
    .A2(_020_),
    .B1(_037_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_038_));
 sky130_fd_sc_hd__a21oi_2 _206_ (.A1(_036_),
    .A2(_038_),
    .B1(_124_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_039_));
 sky130_fd_sc_hd__o21a_2 _207_ (.A1(_036_),
    .A2(_038_),
    .B1(_039_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_040_));
 sky130_fd_sc_hd__a22o_2 _208_ (.A1(\u_cpu.imm[1] ),
    .A2(uo_out[1]),
    .B1(uo_out[0]),
    .B2(\u_cpu.imm[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_041_));
 sky130_fd_sc_hd__nand2_2 _209_ (.A(_139_),
    .B(_041_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_042_));
 sky130_fd_sc_hd__xnor2_2 _210_ (.A(_036_),
    .B(_042_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_043_));
 sky130_fd_sc_hd__nor2_2 _211_ (.A(_121_),
    .B(_043_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_044_));
 sky130_fd_sc_hd__a22o_2 _212_ (.A1(uo_out[3]),
    .A2(_127_),
    .B1(_130_),
    .B2(_034_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_045_));
 sky130_fd_sc_hd__a22o_2 _213_ (.A1(net13),
    .A2(_132_),
    .B1(_025_),
    .B2(uo_out[1]),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_046_));
 sky130_fd_sc_hd__and2b_2 _214_ (.A_N(_136_),
    .B(_035_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_047_));
 sky130_fd_sc_hd__o221a_2 _215_ (.A1(uo_out[2]),
    .A2(_133_),
    .B1(_036_),
    .B2(_122_),
    .C1(_135_),
    ...
    .VPWR(VPWR),
    .X(_048_));
 sky130_fd_sc_hd__or4b_2 _216_ (.A(_045_),
    .B(_046_),
    .C(_047_),
    .D_N(_048_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_049_));
 sky130_fd_sc_hd__o32a_2 _217_ (.A1(_040_),
    .A2(_044_),
    .A3(_049_),
    .B1(_135_),
    .B2(\u_cpu.imm[2] ),
    ...
    .VPWR(VPWR),
    .X(_050_));
 sky130_fd_sc_hd__mux2_1 _218_ (.A0(uo_out[2]),
    .A1(_050_),
    .S(_114_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_003_));
 sky130_fd_sc_hd__and2_2 _219_ (.A(\u_cpu.imm[3] ),
    .B(uo_out[3]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_051_));
 sky130_fd_sc_hd__xor2_2 _220_ (.A(\u_cpu.imm[3] ),
    .B(uo_out[3]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_052_));
 sky130_fd_sc_hd__and2b_2 _221_ (.A_N(\u_cpu.imm[2] ),
    .B(uo_out[2]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_053_));
 sky130_fd_sc_hd__a21oi_2 _222_ (.A1(_036_),
    .A2(_038_),
    .B1(_053_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_054_));
 sky130_fd_sc_hd__nand2_2 _223_ (.A(_052_),
    .B(_054_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_055_));
 sky130_fd_sc_hd__o21a_2 _224_ (.A1(_052_),
    .A2(_054_),
    .B1(_123_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_056_));
 sky130_fd_sc_hd__and2b_2 _225_ (.A_N(_122_),
    .B(_052_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_057_));
 sky130_fd_sc_hd__o21ba_2 _226_ (.A1(\u_cpu.imm[3] ),
    .A2(uo_out[3]),
    .B1_N(_136_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_058_));
 sky130_fd_sc_hd__a221o_2 _227_ (.A1(net14),
    .A2(_132_),
    .B1(_025_),
    .B2(uo_out[2]),
    .C1(_057_),
    ...
    .VPWR(VPWR),
    .X(_059_));
 sky130_fd_sc_hd__a2bb2o_2 _228_ (.A1_N(uo_out[3]),
    .A2_N(_133_),
    .B1(_051_),
    .B2(_130_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_060_));
 sky130_fd_sc_hd__or4b_2 _229_ (.A(_058_),
    .B(_059_),
    .C(_060_),
    .D_N(_135_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_061_));
 sky130_fd_sc_hd__a31o_2 _230_ (.A1(_139_),
    .A2(_035_),
    .A3(_041_),
    .B1(_034_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_062_));
 sky130_fd_sc_hd__xnor2_2 _231_ (.A(_052_),
    .B(_062_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_063_));
 sky130_fd_sc_hd__nor2_2 _232_ (.A(_121_),
    .B(_063_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_064_));
 sky130_fd_sc_hd__a211o_2 _233_ (.A1(_055_),
    .A2(_056_),
    .B1(_061_),
    .C1(_064_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_065_));
 sky130_fd_sc_hd__o21a_2 _234_ (.A1(\u_cpu.imm[3] ),
    .A2(_135_),
    .B1(_114_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_066_));
 sky130_fd_sc_hd__a22o_2 _235_ (.A1(uo_out[3]),
    .A2(_115_),
    .B1(_065_),
    .B2(_066_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_004_));
 sky130_fd_sc_hd__and2b_2 _236_ (.A_N(\u_cpu.zero ),
    .B(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_067_));
 sky130_fd_sc_hd__and2b_2 _237_ (.A_N(net22),
    .B(carry_out),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_068_));
 sky130_fd_sc_hd__o21a_2 _238_ (.A1(_067_),
    .A2(_068_),
    .B1(_110_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_069_));
 sky130_fd_sc_hd__nor2_2 _239_ (.A(_111_),
    .B(_067_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_070_));
 sky130_fd_sc_hd__or2_2 _240_ (.A(_069_),
    .B(_070_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_071_));
 sky130_fd_sc_hd__o31ai_2 _241_ (.A1(uio_out[0]),
    .A2(_069_),
    .A3(_070_),
    .B1(net15),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_072_));
 sky130_fd_sc_hd__a21o_2 _242_ (.A1(\u_cpu.imm[0] ),
    .A2(_071_),
    .B1(_072_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_073_));
 sky130_fd_sc_hd__o21a_2 _243_ (.A1(uio_out[0]),
    .A2(net15),
    .B1(_073_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_005_));
 sky130_fd_sc_hd__o21bai_2 _244_ (.A1(uio_out[1]),
    .A2(_071_),
    .B1_N(_072_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _245_ (.A(_074_),
    ...
    .VPWR(VPWR),
    .Y(_075_));
 sky130_fd_sc_hd__a21oi_2 _246_ (.A1(\u_cpu.imm[1] ),
    .A2(_071_),
    .B1(_074_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_076_));
 sky130_fd_sc_hd__a21oi_2 _247_ (.A1(_105_),
    .A2(_072_),
    .B1(_076_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_006_));
 sky130_fd_sc_hd__o21ba_2 _248_ (.A1(uio_out[2]),
    .A2(_071_),
    .B1_N(_074_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_077_));
 sky130_fd_sc_hd__nand2_2 _249_ (.A(\u_cpu.imm[2] ),
    .B(_071_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_078_));
 sky130_fd_sc_hd__o2bb2a_2 _250_ (.A1_N(_077_),
    .A2_N(_078_),
    .B1(uio_out[2]),
    .B2(_075_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_007_));
 sky130_fd_sc_hd__mux2_1 _251_ (.A0(_106_),
    .A1(\u_cpu.imm[3] ),
    .S(_071_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_079_));
 sky130_fd_sc_hd__mux2_1 _252_ (.A0(uio_out[3]),
    .A1(_079_),
    .S(_077_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_008_));
 sky130_fd_sc_hd__a311o_2 _253_ (.A1(net22),
    .A2(_102_),
    .A3(_104_),
    .B1(_115_),
    .C1(net19),
    ...
    .VPWR(VPWR),
    .X(_080_));
 sky130_fd_sc_hd__nand2b_2 _254_ (.A_N(\u_cpu.imm[3] ),
    .B(uo_out[3]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_081_));
 sky130_fd_sc_hd__a21o_2 _255_ (.A1(_052_),
    .A2(_062_),
    .B1(_051_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_082_));
 sky130_fd_sc_hd__a22o_2 _256_ (.A1(uo_out[0]),
    .A2(_127_),
    .B1(net16),
    .B2(uo_out[3]),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_083_));
 sky130_fd_sc_hd__a221o_2 _257_ (.A1(_056_),
    .A2(_081_),
    .B1(_082_),
    .B2(_120_),
    .C1(_083_),
    ...
    .VPWR(VPWR),
    .X(_084_));
 sky130_fd_sc_hd__mux2_1 _258_ (.A0(_084_),
    .A1(net40),
    .S(_080_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_009_));
 sky130_fd_sc_hd__and4b_2 _259_ (.A_N(_121_),
    .B(_023_),
    .C(_043_),
    .D(_119_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_085_));
 sky130_fd_sc_hd__nand2_2 _260_ (.A(net17),
    .B(_036_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_086_));
 sky130_fd_sc_hd__or4b_2 _261_ (.A(_125_),
    .B(_086_),
    .C(_052_),
    .D_N(_119_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_087_));
 sky130_fd_sc_hd__o22a_2 _262_ (.A1(uo_out[3]),
    .A2(_128_),
    .B1(_026_),
    .B2(uo_out[0]),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_088_));
 sky130_fd_sc_hd__or3_2 _263_ (.A(net25),
    .B(uo_out[2]),
    .C(_088_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_089_));
 sky130_fd_sc_hd__or3_2 _264_ (.A(\u_cpu.imm[3] ),
    .B(net24),
    .C(_035_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_090_));
 sky130_fd_sc_hd__or4_2 _265_ (.A(_118_),
    .B(_136_),
    .C(_139_),
    .D(_090_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_091_));
 sky130_fd_sc_hd__or3_2 _266_ (.A(_129_),
    .B(_034_),
    .C(_051_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_092_));
 sky130_fd_sc_hd__or4b_2 _267_ (.A(net11),
    .B(net12),
    .C(net13),
    .D_N(_132_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_093_));
 sky130_fd_sc_hd__nand4_2 _268_ (.A(net25),
    .B(net26),
    .C(uo_out[2]),
    .D(net24),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_094_));
 sky130_fd_sc_hd__or2_2 _269_ (.A(_133_),
    .B(_094_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_095_));
 sky130_fd_sc_hd__o211a_2 _270_ (.A1(net14),
    .A2(_093_),
    .B1(_095_),
    .C1(_091_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_096_));
 sky130_fd_sc_hd__o2111ai_2 _271_ (.A1(_041_),
    .A2(_092_),
    .B1(_096_),
    .C1(_087_),
    .D1(_089_),
    ...
    .VPWR(VPWR),
    .Y(_097_));
 sky130_fd_sc_hd__o31ai_2 _272_ (.A1(\u_cpu.imm[0] ),
    .A2(\u_cpu.imm[2] ),
    .A3(\u_cpu.imm[3] ),
    .B1(_114_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_098_));
 sky130_fd_sc_hd__a22o_2 _273_ (.A1(_063_),
    .A2(_085_),
    .B1(_098_),
    .B2(_033_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_099_));
 sky130_fd_sc_hd__o22a_2 _274_ (.A1(\u_cpu.zero ),
    .A2(_114_),
    .B1(_097_),
    .B2(_099_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_010_));
 sky130_fd_sc_hd__and2_2 _275_ (.A(phase_out),
    .B(halted_out),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_100_));
 sky130_fd_sc_hd__or2_2 _276_ (.A(_108_),
    .B(_100_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_011_));
 sky130_fd_sc_hd__mux2_1 _277_ (.A0(\u_cpu.imm[0] ),
    .A1(net3),
    .S(_108_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_012_));
 sky130_fd_sc_hd__mux2_1 _278_ (.A0(\u_cpu.imm[1] ),
    .A1(net4),
    .S(_108_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_013_));
 sky130_fd_sc_hd__mux2_1 _279_ (.A0(\u_cpu.imm[2] ),
    .A1(net5),
    .S(_108_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_014_));
 sky130_fd_sc_hd__mux2_1 _280_ (.A0(\u_cpu.imm[3] ),
    .A1(net6),
    .S(_108_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_015_));
 sky130_fd_sc_hd__mux2_1 _281_ (.A0(net23),
    .A1(net7),
    .S(_108_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_016_));
 sky130_fd_sc_hd__mux2_1 _282_ (.A0(net21),
    .A1(net8),
    .S(_108_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_017_));
 sky130_fd_sc_hd__mux2_1 _283_ (.A0(net43),
    .A1(net9),
    .S(_108_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_018_));
 sky130_fd_sc_hd__mux2_1 _284_ (.A0(net42),
    .A1(net10),
    .S(_108_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_019_));
 sky130_fd_sc_hd__dfrtp_2 _285_ (.CLK(clknet_2_2__leaf_clk),
    .D(_001_),
    .RESET_B(net28),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net26));
 sky130_fd_sc_hd__dfrtp_2 _286_ (.CLK(clknet_2_0__leaf_clk),
    .D(_002_),
    .RESET_B(net27),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net25));
 sky130_fd_sc_hd__dfrtp_2 _287_ (.CLK(clknet_2_2__leaf_clk),
    .D(_003_),
    .RESET_B(net28),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[2]));
 sky130_fd_sc_hd__dfrtp_2 _288_ (.CLK(clknet_2_0__leaf_clk),
    .D(_004_),
    .RESET_B(net27),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _289_ (.CLK(clknet_2_0__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(uio_out[0]));
 sky130_fd_sc_hd__dfrtp_2 _290_ (.CLK(clknet_2_1__leaf_clk),
    .D(_006_),
    .RESET_B(net27),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uio_out[1]));
 sky130_fd_sc_hd__dfrtp_2 _291_ (.CLK(clknet_2_1__leaf_clk),
    .D(_007_),
    .RESET_B(net27),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uio_out[2]));
 sky130_fd_sc_hd__dfrtp_2 _292_ (.CLK(clknet_2_1__leaf_clk),
    .D(_008_),
    .RESET_B(net27),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _293_ (.CLK(clknet_2_0__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(carry_out));
 sky130_fd_sc_hd__dfstp_2 _294_ (.CLK(clknet_2_0__leaf_clk),
    .D(_010_),
    .SET_B(net27),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _295_ (.CLK(clknet_2_1__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(phase_out));
 sky130_fd_sc_hd__dfrtp_2 _296_ (.CLK(clknet_2_3__leaf_clk),
    .D(_012_),
    .RESET_B(net28),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _297_ (.CLK(clknet_2_3__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\u_cpu.imm[1] ));
 sky130_fd_sc_hd__dfrtp_2 _298_ (.CLK(clknet_2_3__leaf_clk),
    .D(_014_),
    .RESET_B(net28),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _303_ (.CLK(clknet_2_2__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\u_cpu.ir[7] ));
 sky130_fd_sc_hd__dfrtp_2 _304_ (.CLK(clknet_2_1__leaf_clk),
    .D(_000_),
    .RESET_B(net27),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(halted_out));
 sky130_fd_sc_hd__buf_2 _317_ (.A(carry_out),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[4]));
 sky130_fd_sc_hd__buf_2 _318_ (.A(\u_cpu.zero ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[5]));
 sky130_fd_sc_hd__buf_2 _319_ (.A(halted_out),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[6]));
 sky130_fd_sc_hd__buf_2 _320_ (.A(phase_out),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 clkload2 (.A(clknet_2_3__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout18 (.A(\u_cpu.ir[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net18));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout19 (.A(\u_cpu.ir[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net19));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout20 (.A(\u_cpu.ir[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net20));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout21 (.A(\u_cpu.ir[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout22 (.A(net23),
    ...
    .VPWR(VPWR),
    .X(net22));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout23 (.A(\u_cpu.ir[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout26 (.A(net26),
    ...
    .VPWR(VPWR),
    .X(uo_out[0]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout27 (.A(\u_cpu.rst_n ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net27));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout28 (.A(\u_cpu.rst_n ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net28));
 sky130_fd_sc_hd__dlygate4sd3_1 hold40 (.A(carry_out),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net40));
 sky130_fd_sc_hd__dlygate4sd3_1 hold41 (.A(halted_out),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net41));
 sky130_fd_sc_hd__dlygate4sd3_1 hold42 (.A(\u_cpu.ir[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net42));
 sky130_fd_sc_hd__dlygate4sd3_1 hold43 (.A(\u_cpu.ir[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 input9 (.A(ui_in[6]),
    ...
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__buf_1 max_cap15 (.A(_109_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net15));
 sky130_fd_sc_hd__clkbuf_2 max_cap16 (.A(_025_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net16));
 sky130_fd_sc_hd__clkbuf_2 max_cap17 (.A(_141_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net17));
 sky130_fd_sc_hd__conb_1 tt_um_jacob_kebaso_4bit_cpu (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 tt_um_jacob_kebaso_4bit_cpu_29 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net29));
 sky130_fd_sc_hd__conb_1 tt_um_jacob_kebaso_4bit_cpu_30 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net30));
 sky130_fd_sc_hd__conb_1 tt_um_jacob_kebaso_4bit_cpu_31 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net31));
 sky130_fd_sc_hd__conb_1 tt_um_jacob_kebaso_4bit_cpu_32 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net32));
 sky130_fd_sc_hd__conb_1 tt_um_jacob_kebaso_4bit_cpu_33 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net33));
 sky130_fd_sc_hd__conb_1 tt_um_jacob_kebaso_4bit_cpu_34 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net34));
 sky130_fd_sc_hd__conb_1 tt_um_jacob_kebaso_4bit_cpu_35 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net35));
 sky130_fd_sc_hd__conb_1 tt_um_jacob_kebaso_4bit_cpu_36 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net36));
 sky130_fd_sc_hd__conb_1 tt_um_jacob_kebaso_4bit_cpu_37 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net37));
 sky130_fd_sc_hd__conb_1 tt_um_jacob_kebaso_4bit_cpu_38 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net38));
 sky130_fd_sc_hd__conb_1 tt_um_jacob_kebaso_4bit_cpu_39 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net39));
