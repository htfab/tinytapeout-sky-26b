module tt_um_bn_lif_evan (clk,
 ...
 wire \bm_count[8] ;
 wire \bm_count[9] ;
 wire \lif_decay_val[0] ;
 wire \lif_decay_val[1] ;
 wire \lif_decay_val[2] ;
 wire \lif_decay_val[3] ;
 wire \lif_decay_val[4] ;
 wire \lif_decay_val[5] ;
 wire \lif_decay_val[6] ;
 wire \lif_decay_val[7] ;
 wire \lif_membrane[0] ;
 wire \lif_membrane[1] ;
 wire \lif_membrane[2] ;
 wire \lif_membrane[3] ;
 ...
 wire lif_mode_decay;
 wire lif_spike;
 wire \lif_threshold[0] ;
 wire \lif_threshold[1] ;
 wire \lif_threshold[2] ;
 wire \lif_threshold[3] ;
 wire \lif_threshold[4] ;
 wire \lif_threshold[5] ;
 wire \lif_threshold[6] ;
 wire \lif_threshold[7] ;
 wire \lif_v_reset[0] ;
 wire \lif_v_reset[1] ;
 wire \lif_v_reset[2] ;
 wire \lif_v_reset[3] ;
 ...
 wire \lif_v_reset[7] ;
 wire net1;
 wire \u_bm.q_bot_full[0] ;
 wire \u_bm.q_bot_full[1] ;
 wire \u_bm.q_bot_full[2] ;
 wire \u_bm.q_bot_full[3] ;
 wire \u_bm.q_bot_full[4] ;
 wire \u_bm.q_bot_full[5] ;
 wire \u_bm.q_bot_full[6] ;
 wire \u_bm.q_bot_full[7] ;
 wire \u_bm.q_top_full[0] ;
 wire \u_bm.q_top_full[1] ;
 wire \u_bm.q_top_full[2] ;
 wire \u_bm.q_top_full[3] ;
 wire \u_bm.q_top_full[4] ;
 wire \u_bm.q_top_full[5] ;
 wire \u_bm.q_top_full[6] ;
 wire \u_bm.q_top_full[7] ;
 wire net2;
 wire net3;
 wire net4;
 wire net5;
 ...
 sky130_fd_sc_hd__inv_2 _411_ (.A(net21),
    ...
    .VPWR(VPWR),
    .Y(_067_));
 sky130_fd_sc_hd__inv_2 _412_ (.A(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_068_));
 sky130_fd_sc_hd__inv_2 _413_ (.A(net92),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_069_));
 sky130_fd_sc_hd__inv_2 _414_ (.A(net95),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_070_));
 sky130_fd_sc_hd__inv_2 _415_ (.A(net94),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_071_));
 sky130_fd_sc_hd__inv_2 _416_ (.A(net93),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_072_));
 sky130_fd_sc_hd__inv_2 _417_ (.A(net97),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_073_));
 sky130_fd_sc_hd__inv_2 _418_ (.A(net101),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_074_));
 sky130_fd_sc_hd__inv_2 _419_ (.A(net96),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_075_));
 sky130_fd_sc_hd__inv_2 _420_ (.A(net90),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_076_));
 sky130_fd_sc_hd__inv_2 _421_ (.A(\lif_decay_val[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_077_));
 sky130_fd_sc_hd__inv_2 _422_ (.A(net102),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_078_));
 sky130_fd_sc_hd__inv_2 _423_ (.A(net98),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_079_));
 sky130_fd_sc_hd__inv_2 _424_ (.A(net99),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_080_));
 sky130_fd_sc_hd__inv_2 _425_ (.A(net100),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_081_));
 sky130_fd_sc_hd__inv_2 _426_ (.A(\lif_membrane[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_082_));
 sky130_fd_sc_hd__inv_2 _427_ (.A(\u_bm.q_top_full[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_083_));
 sky130_fd_sc_hd__inv_2 _428_ (.A(net56),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_084_));
 sky130_fd_sc_hd__inv_2 _429_ (.A(net74),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_085_));
 sky130_fd_sc_hd__inv_2 _430_ (.A(net65),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_086_));
 sky130_fd_sc_hd__inv_2 _431_ (.A(\u_bm.q_bot_full[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_087_));
 sky130_fd_sc_hd__inv_2 _432_ (.A(net64),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_088_));
 sky130_fd_sc_hd__inv_2 _433_ (.A(net75),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_089_));
 sky130_fd_sc_hd__inv_2 _434_ (.A(net67),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_090_));
 sky130_fd_sc_hd__inv_2 _435_ (.A(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_091_));
 sky130_fd_sc_hd__inv_2 _436_ (.A(net37),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_092_));
 sky130_fd_sc_hd__inv_2 _437_ (.A(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_093_));
 sky130_fd_sc_hd__nor2_2 _438_ (.A(net14),
    .B(_091_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_094_));
 sky130_fd_sc_hd__nor2_2 _439_ (.A(net14),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_095_));
 sky130_fd_sc_hd__and2_2 _440_ (.A(net14),
    .B(_091_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_096_));
 sky130_fd_sc_hd__a22o_2 _441_ (.A1(\bm_count[0] ),
    .A2(_095_),
    .B1(_096_),
    .B2(lif_spike),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_097_));
 sky130_fd_sc_hd__a31o_2 _442_ (.A1(net35),
    .A2(net29),
    .A3(_094_),
    .B1(_097_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(uo_out[0]));
 sky130_fd_sc_hd__and4_2 _443_ (.A(net33),
    .B(net35),
    .C(net28),
    .D(net29),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_098_));
 sky130_fd_sc_hd__inv_2 _444_ (.A(_098_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_099_));
 sky130_fd_sc_hd__a22o_2 _445_ (.A1(net35),
    .A2(net28),
    .B1(net29),
    .B2(net33),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_100_));
 sky130_fd_sc_hd__a32o_2 _446_ (.A1(_094_),
    .A2(_099_),
    .A3(_100_),
    .B1(_091_),
    .B2(\lif_membrane[1] ),
    ...
    .VPWR(VPWR),
    .X(_101_));
 sky130_fd_sc_hd__mux2_1 _447_ (.A0(_101_),
    .A1(\bm_count[1] ),
    .S(_095_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(uo_out[1]));
 sky130_fd_sc_hd__a22oi_2 _448_ (.A1(net33),
    .A2(net28),
    .B1(net29),
    .B2(net32),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_102_));
 sky130_fd_sc_hd__and2_2 _449_ (.A(net28),
    .B(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_103_));
 sky130_fd_sc_hd__and3_2 _450_ (.A(net33),
    .B(net29),
    .C(_103_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_104_));
 sky130_fd_sc_hd__nor2_2 _451_ (.A(_102_),
    .B(_104_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_105_));
 sky130_fd_sc_hd__a21oi_2 _452_ (.A1(net35),
    .A2(net27),
    .B1(_105_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_106_));
 sky130_fd_sc_hd__and3_2 _453_ (.A(net35),
    .B(net27),
    .C(_105_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_107_));
 sky130_fd_sc_hd__nor2_2 _454_ (.A(_106_),
    .B(_107_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_108_));
 sky130_fd_sc_hd__or2_2 _455_ (.A(_098_),
    .B(_108_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_109_));
 sky130_fd_sc_hd__and2_2 _456_ (.A(_098_),
    .B(_108_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_110_));
 sky130_fd_sc_hd__nand2_2 _457_ (.A(_098_),
    .B(_108_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_111_));
 sky130_fd_sc_hd__a22o_2 _458_ (.A1(\bm_count[2] ),
    .A2(_095_),
    .B1(_096_),
    .B2(\lif_membrane[2] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_112_));
 sky130_fd_sc_hd__a31o_2 _459_ (.A1(_094_),
    .A2(_109_),
    .A3(_111_),
    .B1(_112_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(uo_out[2]));
 sky130_fd_sc_hd__a21o_2 _460_ (.A1(net29),
    .A2(net31),
    .B1(_103_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _461_ (.A(_113_),
    ...
    .VPWR(VPWR),
    .Y(_114_));
 sky130_fd_sc_hd__and3_2 _462_ (.A(net29),
    .B(net31),
    .C(_103_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_115_));
 sky130_fd_sc_hd__o2bb2a_2 _463_ (.A1_N(net33),
    .A2_N(net27),
    .B1(_114_),
    .B2(_115_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_116_));
 sky130_fd_sc_hd__and4b_2 _464_ (.A_N(_115_),
    .B(net27),
    .C(net33),
    .D(_113_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_117_));
 sky130_fd_sc_hd__nor2_2 _465_ (.A(_116_),
    .B(_117_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_118_));
 sky130_fd_sc_hd__xor2_2 _466_ (.A(_104_),
    .B(_118_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_119_));
 sky130_fd_sc_hd__and2_2 _467_ (.A(net35),
    .B(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_120_));
 sky130_fd_sc_hd__nor2_2 _468_ (.A(_119_),
    .B(_120_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_2 _469_ (.A(_119_),
    ...
    .VPWR(VPWR),
    .X(_122_));
 sky130_fd_sc_hd__nor2_2 _470_ (.A(_121_),
    .B(_122_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_123_));
 sky130_fd_sc_hd__nor2_2 _471_ (.A(_107_),
    .B(_123_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_124_));
 sky130_fd_sc_hd__and2_2 _472_ (.A(_107_),
    .B(_123_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_125_));
 sky130_fd_sc_hd__nor2_2 _473_ (.A(_124_),
    .B(_125_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_2 _474_ (.A(_110_),
    ...
    .VPWR(VPWR),
    .Y(_127_));
 sky130_fd_sc_hd__or2_2 _475_ (.A(_110_),
    .B(_126_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_128_));
 sky130_fd_sc_hd__a32o_2 _476_ (.A1(_094_),
    .A2(_127_),
    .A3(_128_),
    .B1(_091_),
    .B2(\lif_membrane[3] ),
    ...
    .VPWR(VPWR),
    .X(_129_));
 sky130_fd_sc_hd__mux2_1 _477_ (.A0(_129_),
    .A1(\bm_count[3] ),
    .S(_095_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_2 _478_ (.A(net27),
    ...
    .VPWR(VPWR),
    .Y(_130_));
 sky130_fd_sc_hd__a21boi_2 _479_ (.A1(net28),
    .A2(net31),
    .B1_N(_130_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_131_));
 sky130_fd_sc_hd__and3_2 _480_ (.A(net27),
    .B(net31),
    .C(_103_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_2 _481_ (.A(_131_),
    ...
    .VPWR(VPWR),
    .Y(_133_));
 sky130_fd_sc_hd__a21oi_2 _482_ (.A1(net33),
    .A2(net26),
    .B1(_133_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_134_));
 sky130_fd_sc_hd__and3_2 _483_ (.A(net34),
    .B(net26),
    .C(_133_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_135_));
 sky130_fd_sc_hd__nor2_2 _484_ (.A(_134_),
    .B(_135_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_136_));
 sky130_fd_sc_hd__or2_2 _485_ (.A(_115_),
    .B(_117_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_2 _486_ (.A(_136_),
    ...
    .VPWR(VPWR),
    .Y(_138_));
 sky130_fd_sc_hd__or2_2 _487_ (.A(_136_),
    .B(_137_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_139_));
 sky130_fd_sc_hd__nand2_2 _488_ (.A(_138_),
    .B(_139_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_140_));
 sky130_fd_sc_hd__a21oi_2 _489_ (.A1(_104_),
    .A2(_118_),
    .B1(_122_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_141_));
 sky130_fd_sc_hd__or2_2 _490_ (.A(_140_),
    .B(_141_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_142_));
 sky130_fd_sc_hd__nand2_2 _491_ (.A(_140_),
    .B(_141_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_143_));
 sky130_fd_sc_hd__nand2_2 _492_ (.A(_142_),
    .B(_143_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_144_));
 sky130_fd_sc_hd__a21oi_2 _493_ (.A1(_110_),
    .A2(_126_),
    .B1(_125_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_145_));
 sky130_fd_sc_hd__xor2_2 _494_ (.A(_144_),
    .B(_145_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_146_));
 sky130_fd_sc_hd__a22o_2 _495_ (.A1(\bm_count[4] ),
    .A2(_095_),
    .B1(_096_),
    .B2(\lif_membrane[4] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_147_));
 sky130_fd_sc_hd__a21o_2 _496_ (.A1(_094_),
    .A2(_146_),
    .B1(_147_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(uo_out[4]));
 sky130_fd_sc_hd__o21a_2 _497_ (.A1(_144_),
    .A2(_145_),
    .B1(_142_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_148_));
 sky130_fd_sc_hd__a22o_2 _498_ (.A1(net8),
    .A2(net31),
    .B1(net32),
    .B2(net26),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_149_));
 sky130_fd_sc_hd__nand2_2 _499_ (.A(net26),
    .B(net31),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_150_));
 sky130_fd_sc_hd__o21a_2 _500_ (.A1(_130_),
    .A2(_150_),
    .B1(_149_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_151_));
 sky130_fd_sc_hd__o21ai_2 _501_ (.A1(_132_),
    .A2(_135_),
    .B1(_151_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_152_));
 sky130_fd_sc_hd__or3_2 _502_ (.A(_132_),
    .B(_135_),
    .C(_151_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_153_));
 sky130_fd_sc_hd__and2_2 _503_ (.A(_152_),
    .B(_153_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_154_));
 sky130_fd_sc_hd__xnor2_2 _504_ (.A(_138_),
    .B(_154_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_155_));
 sky130_fd_sc_hd__xnor2_2 _505_ (.A(_148_),
    .B(_155_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_156_));
 sky130_fd_sc_hd__a22o_2 _506_ (.A1(\bm_count[5] ),
    .A2(_095_),
    .B1(_096_),
    .B2(\lif_membrane[5] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_157_));
 sky130_fd_sc_hd__a21o_2 _507_ (.A1(_094_),
    .A2(_156_),
    .B1(_157_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(uo_out[5]));
 sky130_fd_sc_hd__and3_2 _508_ (.A(net26),
    .B(net5),
    .C(_130_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_158_));
 sky130_fd_sc_hd__xor2_2 _509_ (.A(_152_),
    .B(_158_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_159_));
 sky130_fd_sc_hd__nand3_2 _510_ (.A(_138_),
    .B(_142_),
    .C(_145_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_2 _511_ (.A(_154_),
    ...
    .VPWR(VPWR),
    .Y(_161_));
 sky130_fd_sc_hd__nand2_2 _512_ (.A(_159_),
    .B(_161_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_162_));
 sky130_fd_sc_hd__or2_2 _513_ (.A(_159_),
    .B(_161_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_163_));
 sky130_fd_sc_hd__a32o_2 _514_ (.A1(_094_),
    .A2(_162_),
    .A3(_163_),
    .B1(_091_),
    .B2(\lif_membrane[6] ),
    ...
    .VPWR(VPWR),
    .X(_164_));
 sky130_fd_sc_hd__mux2_1 _515_ (.A0(_164_),
    .A1(\bm_count[6] ),
    .S(_095_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(uo_out[6]));
 sky130_fd_sc_hd__a21o_2 _516_ (.A1(_130_),
    .A2(_152_),
    .B1(_150_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_165_));
 sky130_fd_sc_hd__a21boi_2 _517_ (.A1(_163_),
    .A2(_165_),
    .B1_N(_094_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_166_));
 sky130_fd_sc_hd__a221o_2 _518_ (.A1(\bm_count[7] ),
    .A2(_095_),
    .B1(_096_),
    .B2(\lif_membrane[7] ),
    .C1(_166_),
    ...
    .VPWR(VPWR),
    .X(uo_out[7]));
 sky130_fd_sc_hd__o22a_2 _519_ (.A1(net28),
    .A2(_085_),
    .B1(_086_),
    .B2(net30),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_167_));
 sky130_fd_sc_hd__a221o_2 _520_ (.A1(net27),
    .A2(_084_),
    .B1(_085_),
    .B2(net28),
    .C1(_167_),
    ...
    .VPWR(VPWR),
    .X(_168_));
 sky130_fd_sc_hd__o221a_2 _521_ (.A1(net26),
    .A2(_083_),
    .B1(_084_),
    .B2(net27),
    .C1(_168_),
    ...
    .VPWR(VPWR),
    .X(_169_));
 sky130_fd_sc_hd__a21oi_2 _522_ (.A1(net26),
    .A2(_083_),
    .B1(_169_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_170_));
 sky130_fd_sc_hd__o22a_2 _523_ (.A1(net34),
    .A2(_089_),
    .B1(_090_),
    .B2(net36),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_171_));
 sky130_fd_sc_hd__a221o_2 _524_ (.A1(net32),
    .A2(_088_),
    .B1(_089_),
    .B2(net34),
    .C1(_171_),
    ...
    .VPWR(VPWR),
    .X(_172_));
 sky130_fd_sc_hd__o221a_2 _525_ (.A1(net31),
    .A2(_087_),
    .B1(_088_),
    .B2(net32),
    .C1(_172_),
    ...
    .VPWR(VPWR),
    .X(_173_));
 sky130_fd_sc_hd__a21oi_2 _526_ (.A1(net31),
    .A2(_087_),
    .B1(_173_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_174_));
 sky130_fd_sc_hd__nor2_2 _527_ (.A(_170_),
    .B(_174_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_175_));
 sky130_fd_sc_hd__and2_2 _528_ (.A(\bm_count[0] ),
    .B(_175_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_176_));
 sky130_fd_sc_hd__o21ai_2 _529_ (.A1(net87),
    .A2(_175_),
    .B1(net41),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_177_));
 sky130_fd_sc_hd__nor2_2 _530_ (.A(_176_),
    .B(_177_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_000_));
 sky130_fd_sc_hd__and3_2 _531_ (.A(\bm_count[0] ),
    .B(\bm_count[1] ),
    .C(_175_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_178_));
 sky130_fd_sc_hd__o21ai_2 _532_ (.A1(net86),
    .A2(_176_),
    .B1(net41),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_2 _533_ (.A(_178_),
    ...
    .VPWR(VPWR),
    .Y(_001_));
 sky130_fd_sc_hd__and3_2 _534_ (.A(\bm_count[1] ),
    .B(\bm_count[2] ),
    .C(_176_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_180_));
 sky130_fd_sc_hd__o21ai_2 _535_ (.A1(net80),
    .A2(_178_),
    .B1(net41),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_181_));
 sky130_fd_sc_hd__nor2_2 _536_ (.A(_180_),
    .B(_181_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_002_));
 sky130_fd_sc_hd__and2_2 _537_ (.A(\bm_count[3] ),
    .B(_180_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_182_));
 sky130_fd_sc_hd__o21ai_2 _538_ (.A1(net84),
    .A2(_180_),
    .B1(net43),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_183_));
 sky130_fd_sc_hd__nor2_2 _539_ (.A(_182_),
    .B(_183_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_003_));
 sky130_fd_sc_hd__and3_2 _540_ (.A(\bm_count[3] ),
    .B(\bm_count[4] ),
    .C(_180_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_184_));
 sky130_fd_sc_hd__o21ai_2 _541_ (.A1(net79),
    .A2(_182_),
    .B1(net43),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_185_));
 sky130_fd_sc_hd__nor2_2 _542_ (.A(_184_),
    .B(_185_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_004_));
 sky130_fd_sc_hd__o21ai_2 _543_ (.A1(net63),
    .A2(_184_),
    .B1(net43),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_186_));
 sky130_fd_sc_hd__a21oi_2 _544_ (.A1(net63),
    .A2(_184_),
    .B1(_186_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_005_));
 sky130_fd_sc_hd__a21o_2 _545_ (.A1(\bm_count[5] ),
    .A2(_184_),
    .B1(\bm_count[6] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_187_));
 sky130_fd_sc_hd__and3_2 _546_ (.A(\bm_count[5] ),
    .B(\bm_count[6] ),
    .C(_184_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_188_));
 sky130_fd_sc_hd__and3b_2 _547_ (.A_N(_188_),
    .B(net43),
    .C(_187_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_006_));
 sky130_fd_sc_hd__and2_2 _548_ (.A(\bm_count[7] ),
    .B(_188_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_189_));
 sky130_fd_sc_hd__o21ai_2 _549_ (.A1(net78),
    .A2(_188_),
    .B1(net43),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_190_));
 sky130_fd_sc_hd__nor2_2 _550_ (.A(_189_),
    .B(_190_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_007_));
 sky130_fd_sc_hd__and3_2 _551_ (.A(\bm_count[7] ),
    .B(\bm_count[8] ),
    .C(_188_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_191_));
 sky130_fd_sc_hd__o21ai_2 _552_ (.A1(net69),
    .A2(_189_),
    .B1(net42),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_192_));
 sky130_fd_sc_hd__nor2_2 _553_ (.A(_191_),
    .B(_192_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_008_));
 sky130_fd_sc_hd__and2_2 _554_ (.A(\bm_count[9] ),
    .B(_191_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_193_));
 sky130_fd_sc_hd__o21ai_2 _555_ (.A1(net72),
    .A2(_191_),
    .B1(net43),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_194_));
 sky130_fd_sc_hd__nor2_2 _556_ (.A(_193_),
    .B(_194_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_009_));
 sky130_fd_sc_hd__and3_2 _557_ (.A(\bm_count[9] ),
    .B(\bm_count[10] ),
    .C(_191_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_195_));
 sky130_fd_sc_hd__o21ai_2 _558_ (.A1(net66),
    .A2(_193_),
    .B1(net44),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_196_));
 sky130_fd_sc_hd__nor2_2 _559_ (.A(_195_),
    .B(_196_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_010_));
 sky130_fd_sc_hd__o21ai_2 _560_ (.A1(net62),
    .A2(_195_),
    .B1(net40),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_197_));
 sky130_fd_sc_hd__a21oi_2 _561_ (.A1(net62),
    .A2(_195_),
    .B1(_197_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_011_));
 sky130_fd_sc_hd__a21o_2 _562_ (.A1(\bm_count[11] ),
    .A2(_195_),
    .B1(\bm_count[12] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_198_));
 sky130_fd_sc_hd__and3_2 _563_ (.A(\bm_count[11] ),
    .B(\bm_count[12] ),
    .C(_195_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_199_));
 sky130_fd_sc_hd__and3b_2 _564_ (.A_N(_199_),
    .B(net40),
    .C(_198_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_012_));
 sky130_fd_sc_hd__and2_2 _565_ (.A(\bm_count[13] ),
    .B(_199_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_200_));
 sky130_fd_sc_hd__o21ai_2 _566_ (.A1(net76),
    .A2(_199_),
    .B1(net41),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_201_));
 sky130_fd_sc_hd__nor2_2 _567_ (.A(_200_),
    .B(_201_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_013_));
 sky130_fd_sc_hd__and3_2 _568_ (.A(\bm_count[13] ),
    .B(\bm_count[14] ),
    .C(_199_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_202_));
 sky130_fd_sc_hd__o21ai_2 _569_ (.A1(net68),
    .A2(_200_),
    .B1(net44),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_203_));
 sky130_fd_sc_hd__nor2_2 _570_ (.A(_202_),
    .B(_203_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_014_));
 sky130_fd_sc_hd__o21ai_2 _571_ (.A1(net57),
    .A2(_202_),
    .B1(net44),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_204_));
 sky130_fd_sc_hd__a21oi_2 _572_ (.A1(net57),
    .A2(_202_),
    .B1(_204_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_015_));
 sky130_fd_sc_hd__xnor2_2 _573_ (.A(\u_bm.q_bot_full[4] ),
    .B(\u_bm.q_bot_full[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_205_));
 sky130_fd_sc_hd__xor2_2 _574_ (.A(\u_bm.q_bot_full[7] ),
    .B(\u_bm.q_bot_full[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_206_));
 sky130_fd_sc_hd__o21ai_2 _575_ (.A1(_205_),
    .A2(_206_),
    .B1(net37),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_207_));
 sky130_fd_sc_hd__a21o_2 _576_ (.A1(_205_),
    .A2(_206_),
    .B1(_207_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_016_));
 sky130_fd_sc_hd__and2_2 _577_ (.A(net37),
    .B(net60),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_017_));
 sky130_fd_sc_hd__and2_2 _578_ (.A(net37),
    .B(net61),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_018_));
 sky130_fd_sc_hd__and2_2 _579_ (.A(net37),
    .B(net58),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_019_));
 sky130_fd_sc_hd__and2_2 _580_ (.A(net70),
    .B(net37),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_020_));
 sky130_fd_sc_hd__nor2_2 _581_ (.A(_090_),
    .B(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_021_));
 sky130_fd_sc_hd__nor2_2 _582_ (.A(_089_),
    .B(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_022_));
 sky130_fd_sc_hd__nor2_2 _583_ (.A(_088_),
    .B(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_023_));
 sky130_fd_sc_hd__xnor2_2 _584_ (.A(\u_bm.q_top_full[4] ),
    .B(\u_bm.q_top_full[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_208_));
 sky130_fd_sc_hd__xor2_2 _585_ (.A(\u_bm.q_top_full[7] ),
    .B(\u_bm.q_top_full[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_209_));
 sky130_fd_sc_hd__o21ai_2 _586_ (.A1(_208_),
    .A2(_209_),
    .B1(net37),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_210_));
 sky130_fd_sc_hd__a21o_2 _587_ (.A1(_208_),
    .A2(_209_),
    .B1(_210_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_024_));
 sky130_fd_sc_hd__or2_2 _588_ (.A(net24),
    .B(net55),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_025_));
 sky130_fd_sc_hd__or2_2 _589_ (.A(net24),
    .B(net54),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_026_));
 sky130_fd_sc_hd__and2_2 _590_ (.A(net38),
    .B(net59),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_027_));
 sky130_fd_sc_hd__and2_2 _591_ (.A(net71),
    .B(net38),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_028_));
 sky130_fd_sc_hd__nand2_2 _592_ (.A(_086_),
    .B(net41),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_029_));
 sky130_fd_sc_hd__nor2_2 _593_ (.A(_085_),
    .B(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_030_));
 sky130_fd_sc_hd__nand2_2 _594_ (.A(_084_),
    .B(net41),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_031_));
 sky130_fd_sc_hd__nand2_2 _595_ (.A(net8),
    .B(\lif_membrane[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_211_));
 sky130_fd_sc_hd__or2_2 _596_ (.A(net8),
    .B(\lif_membrane[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_212_));
 sky130_fd_sc_hd__nand2_2 _597_ (.A(_211_),
    .B(_212_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_213_));
 sky130_fd_sc_hd__and2_2 _598_ (.A(net28),
    .B(\lif_membrane[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_214_));
 sky130_fd_sc_hd__or2_2 _599_ (.A(net7),
    .B(\lif_membrane[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_215_));
 sky130_fd_sc_hd__nand2_2 _600_ (.A(net29),
    .B(\lif_membrane[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_216_));
 sky130_fd_sc_hd__or2_2 _601_ (.A(net29),
    .B(\lif_membrane[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_217_));
 sky130_fd_sc_hd__nand2_2 _602_ (.A(_216_),
    .B(_217_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_218_));
 sky130_fd_sc_hd__and2_2 _603_ (.A(net5),
    .B(\lif_membrane[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_219_));
 sky130_fd_sc_hd__nor2_2 _604_ (.A(net5),
    .B(\lif_membrane[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_220_));
 sky130_fd_sc_hd__and2_2 _605_ (.A(net32),
    .B(\lif_membrane[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_221_));
 sky130_fd_sc_hd__nand2_2 _606_ (.A(net33),
    .B(\lif_membrane[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_222_));
 sky130_fd_sc_hd__xnor2_2 _607_ (.A(net33),
    .B(\lif_membrane[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_223_));
 sky130_fd_sc_hd__and2_2 _608_ (.A(net35),
    .B(\lif_membrane[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_224_));
 sky130_fd_sc_hd__nand2_2 _609_ (.A(net35),
    .B(\lif_membrane[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_225_));
 sky130_fd_sc_hd__o21ai_2 _610_ (.A1(_223_),
    .A2(_225_),
    .B1(_222_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_226_));
 sky130_fd_sc_hd__or2_2 _611_ (.A(net32),
    .B(\lif_membrane[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_227_));
 sky130_fd_sc_hd__and2b_2 _612_ (.A_N(_221_),
    .B(_227_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_228_));
 sky130_fd_sc_hd__a21oi_2 _613_ (.A1(_226_),
    .A2(_227_),
    .B1(_221_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_229_));
 sky130_fd_sc_hd__a211oi_2 _614_ (.A1(_226_),
    .A2(_227_),
    .B1(_219_),
    .C1(_221_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_230_));
 sky130_fd_sc_hd__nor3_2 _615_ (.A(_218_),
    .B(_220_),
    .C(_230_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_231_));
 sky130_fd_sc_hd__o31a_2 _616_ (.A1(_218_),
    .A2(_220_),
    .A3(_230_),
    .B1(_216_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_232_));
 sky130_fd_sc_hd__a31oi_2 _617_ (.A1(net29),
    .A2(\lif_membrane[4] ),
    .A3(_215_),
    .B1(_214_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_233_));
 sky130_fd_sc_hd__nand2b_2 _618_ (.A_N(_214_),
    .B(_215_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_234_));
 sky130_fd_sc_hd__or4_2 _619_ (.A(_218_),
    .B(_220_),
    .C(_230_),
    .D(_234_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_235_));
 sky130_fd_sc_hd__a21oi_2 _620_ (.A1(_233_),
    .A2(_235_),
    .B1(_213_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_236_));
 sky130_fd_sc_hd__a21o_2 _621_ (.A1(_233_),
    .A2(_235_),
    .B1(_213_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_237_));
 sky130_fd_sc_hd__xor2_2 _622_ (.A(net9),
    .B(\lif_membrane[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_238_));
 sky130_fd_sc_hd__inv_2 _623_ (.A(_238_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_239_));
 sky130_fd_sc_hd__a211oi_2 _624_ (.A1(_211_),
    .A2(_237_),
    .B1(_239_),
    .C1(net19),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_240_));
 sky130_fd_sc_hd__a21oi_2 _625_ (.A1(net19),
    .A2(_082_),
    .B1(_240_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_241_));
 sky130_fd_sc_hd__o21a_2 _626_ (.A1(net9),
    .A2(\lif_membrane[7] ),
    .B1(_241_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_242_));
 sky130_fd_sc_hd__and3_2 _627_ (.A(_213_),
    .B(_233_),
    .C(_235_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_243_));
 sky130_fd_sc_hd__nand2_2 _628_ (.A(net20),
    .B(\lif_membrane[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_244_));
 sky130_fd_sc_hd__o31a_2 _629_ (.A1(net20),
    .A2(_236_),
    .A3(_243_),
    .B1(_244_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_245_));
 sky130_fd_sc_hd__nor2_2 _630_ (.A(\lif_decay_val[6] ),
    .B(_245_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_246_));
 sky130_fd_sc_hd__or2_2 _631_ (.A(\lif_decay_val[6] ),
    .B(_245_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_247_));
 sky130_fd_sc_hd__and2_2 _632_ (.A(\lif_decay_val[6] ),
    .B(_245_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_248_));
 sky130_fd_sc_hd__nor2_2 _633_ (.A(_246_),
    .B(_248_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_249_));
 sky130_fd_sc_hd__xor2_2 _634_ (.A(_232_),
    .B(_234_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_250_));
 sky130_fd_sc_hd__mux2_1 _635_ (.A0(\lif_membrane[5] ),
    .A1(_250_),
    .S(lif_mode_add),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_251_));
 sky130_fd_sc_hd__and2_2 _636_ (.A(_078_),
    .B(_251_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_252_));
 sky130_fd_sc_hd__nor2_2 _637_ (.A(_078_),
    .B(_251_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_253_));
 sky130_fd_sc_hd__o21a_2 _638_ (.A1(_220_),
    .A2(_230_),
    .B1(_218_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_254_));
 sky130_fd_sc_hd__nand2_2 _639_ (.A(net20),
    .B(\lif_membrane[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_255_));
 sky130_fd_sc_hd__o31a_2 _640_ (.A1(net20),
    .A2(_231_),
    .A3(_254_),
    .B1(_255_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_256_));
 sky130_fd_sc_hd__nor2_2 _641_ (.A(\lif_decay_val[4] ),
    .B(_256_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_257_));
 sky130_fd_sc_hd__or2_2 _642_ (.A(net22),
    .B(\lif_membrane[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_258_));
 sky130_fd_sc_hd__nor2_2 _643_ (.A(_219_),
    .B(_220_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_259_));
 sky130_fd_sc_hd__xnor2_2 _644_ (.A(_229_),
    .B(_259_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_260_));
 sky130_fd_sc_hd__and2_2 _645_ (.A(net19),
    .B(\lif_membrane[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_261_));
 sky130_fd_sc_hd__o211a_2 _646_ (.A1(net19),
    .A2(_260_),
    .B1(_258_),
    .C1(_079_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_262_));
 sky130_fd_sc_hd__or2_2 _647_ (.A(net22),
    .B(\lif_membrane[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_263_));
 sky130_fd_sc_hd__xor2_2 _648_ (.A(_226_),
    .B(_228_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_264_));
 sky130_fd_sc_hd__and2_2 _649_ (.A(net19),
    .B(\lif_membrane[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_265_));
 sky130_fd_sc_hd__o211a_2 _650_ (.A1(net19),
    .A2(_264_),
    .B1(_263_),
    .C1(_080_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_266_));
 sky130_fd_sc_hd__a211o_2 _651_ (.A1(net22),
    .A2(_264_),
    .B1(_265_),
    .C1(_080_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_267_));
 sky130_fd_sc_hd__and2b_2 _652_ (.A_N(_266_),
    .B(_267_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_268_));
 sky130_fd_sc_hd__xnor2_2 _653_ (.A(_223_),
    .B(_224_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_269_));
 sky130_fd_sc_hd__and2_2 _654_ (.A(net19),
    .B(\lif_membrane[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_270_));
 sky130_fd_sc_hd__or2_2 _655_ (.A(net22),
    .B(\lif_membrane[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_271_));
 sky130_fd_sc_hd__o211a_2 _656_ (.A1(net19),
    .A2(_269_),
    .B1(_271_),
    .C1(_081_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_272_));
 sky130_fd_sc_hd__a21oi_2 _657_ (.A1(net22),
    .A2(net35),
    .B1(\lif_membrane[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_273_));
 sky130_fd_sc_hd__a21o_2 _658_ (.A1(net22),
    .A2(_224_),
    .B1(_273_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_274_));
 sky130_fd_sc_hd__nand2_2 _659_ (.A(\lif_decay_val[0] ),
    .B(_274_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_275_));
 sky130_fd_sc_hd__a211o_2 _660_ (.A1(net22),
    .A2(_269_),
    .B1(_270_),
    .C1(_081_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_276_));
 sky130_fd_sc_hd__nand2b_2 _661_ (.A_N(_272_),
    .B(_276_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_277_));
 sky130_fd_sc_hd__a21o_2 _662_ (.A1(_275_),
    .A2(_276_),
    .B1(_272_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_278_));
 sky130_fd_sc_hd__a21o_2 _663_ (.A1(_267_),
    .A2(_278_),
    .B1(_266_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_279_));
 sky130_fd_sc_hd__a211o_2 _664_ (.A1(net22),
    .A2(_260_),
    .B1(_261_),
    .C1(_079_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_280_));
 sky130_fd_sc_hd__and2b_2 _665_ (.A_N(_262_),
    .B(_280_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_281_));
 sky130_fd_sc_hd__nand2_2 _666_ (.A(_279_),
    .B(_281_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_282_));
 sky130_fd_sc_hd__a21o_2 _667_ (.A1(_279_),
    .A2(_280_),
    .B1(_262_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_283_));
 sky130_fd_sc_hd__nand2_2 _668_ (.A(\lif_decay_val[4] ),
    .B(_256_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_284_));
 sky130_fd_sc_hd__and2b_2 _669_ (.A_N(_257_),
    .B(_284_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_285_));
 sky130_fd_sc_hd__nand2_2 _670_ (.A(_283_),
    .B(_285_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_286_));
 sky130_fd_sc_hd__a21oi_2 _671_ (.A1(_283_),
    .A2(_284_),
    .B1(_257_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_287_));
 sky130_fd_sc_hd__a221oi_2 _672_ (.A1(_078_),
    .A2(_251_),
    .B1(_283_),
    .B2(_284_),
    .C1(_257_),
    ...
    .VPWR(VPWR),
    .Y(_288_));
 sky130_fd_sc_hd__or2_2 _673_ (.A(_253_),
    .B(_288_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_289_));
 sky130_fd_sc_hd__o31a_2 _674_ (.A1(_248_),
    .A2(_253_),
    .A3(_288_),
    .B1(_247_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_290_));
 sky130_fd_sc_hd__o311ai_2 _675_ (.A1(_248_),
    .A2(_253_),
    .A3(_288_),
    .B1(_247_),
    .C1(\lif_decay_val[7] ),
    ...
    .VPWR(VPWR),
    .Y(_291_));
 sky130_fd_sc_hd__and4_2 _676_ (.A(lif_mode_add),
    .B(_211_),
    .C(_237_),
    .D(_239_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_292_));
 sky130_fd_sc_hd__and2b_2 _677_ (.A_N(_292_),
    .B(_241_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_293_));
 sky130_fd_sc_hd__a211o_2 _678_ (.A1(net20),
    .A2(_082_),
    .B1(_240_),
    .C1(_292_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_294_));
 sky130_fd_sc_hd__or2_2 _679_ (.A(\lif_decay_val[7] ),
    .B(_294_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_295_));
 sky130_fd_sc_hd__xnor2_2 _680_ (.A(_077_),
    .B(_294_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_296_));
 sky130_fd_sc_hd__o2111a_2 _681_ (.A1(_290_),
    .A2(_293_),
    .B1(_295_),
    .C1(_291_),
    .D1(net21),
    ...
    .VPWR(VPWR),
    .X(_297_));
 sky130_fd_sc_hd__xor2_2 _682_ (.A(_242_),
    .B(_297_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_298_));
 sky130_fd_sc_hd__xnor2_2 _683_ (.A(_242_),
    .B(_297_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_299_));
 sky130_fd_sc_hd__or2_2 _684_ (.A(\lif_threshold[7] ),
    .B(_299_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_300_));
 sky130_fd_sc_hd__xnor2_2 _685_ (.A(_290_),
    .B(_296_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_301_));
 sky130_fd_sc_hd__or2_2 _686_ (.A(net21),
    .B(_294_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_302_));
 sky130_fd_sc_hd__a21boi_2 _687_ (.A1(net21),
    .A2(_301_),
    .B1_N(_302_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_303_));
 sky130_fd_sc_hd__a21bo_2 _688_ (.A1(net21),
    .A2(_301_),
    .B1_N(_302_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_304_));
 sky130_fd_sc_hd__nor2_2 _689_ (.A(_298_),
    .B(_303_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_305_));
 sky130_fd_sc_hd__nand2_2 _690_ (.A(_298_),
    .B(_303_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_306_));
 sky130_fd_sc_hd__nor2_2 _691_ (.A(_252_),
    .B(_253_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_307_));
 sky130_fd_sc_hd__xnor2_2 _692_ (.A(_287_),
    .B(_307_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_308_));
 sky130_fd_sc_hd__mux2_1 _693_ (.A0(_251_),
    .A1(_308_),
    .S(net21),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_309_));
 sky130_fd_sc_hd__a21o_2 _694_ (.A1(_306_),
    .A2(_309_),
    .B1(_305_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_310_));
 sky130_fd_sc_hd__nor2_2 _695_ (.A(lif_mode_decay),
    .B(_256_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_311_));
 sky130_fd_sc_hd__or2_2 _696_ (.A(_283_),
    .B(_285_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_312_));
 sky130_fd_sc_hd__a31o_2 _697_ (.A1(lif_mode_decay),
    .A2(_286_),
    .A3(_312_),
    .B1(_311_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_313_));
 sky130_fd_sc_hd__a21oi_2 _698_ (.A1(_306_),
    .A2(_313_),
    .B1(_305_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_314_));
 sky130_fd_sc_hd__a2bb2o_2 _699_ (.A1_N(\lif_threshold[4] ),
    .A2_N(_314_),
    .B1(_310_),
    .B2(_074_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_315_));
 sky130_fd_sc_hd__o211a_2 _700_ (.A1(net19),
    .A2(_260_),
    .B1(_258_),
    .C1(_067_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_316_));
 sky130_fd_sc_hd__or2_2 _701_ (.A(_279_),
    .B(_281_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_317_));
 sky130_fd_sc_hd__and3_2 _702_ (.A(net21),
    .B(_282_),
    .C(_317_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_318_));
 sky130_fd_sc_hd__a211o_2 _703_ (.A1(_299_),
    .A2(_304_),
    .B1(_316_),
    .C1(_318_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_319_));
 sky130_fd_sc_hd__nand2_2 _704_ (.A(_306_),
    .B(_319_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_320_));
 sky130_fd_sc_hd__and3b_2 _705_ (.A_N(\lif_threshold[3] ),
    .B(_306_),
    .C(_319_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_321_));
 sky130_fd_sc_hd__o211a_2 _706_ (.A1(net19),
    .A2(_264_),
    .B1(_263_),
    .C1(_067_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_322_));
 sky130_fd_sc_hd__or2_2 _707_ (.A(_268_),
    .B(_278_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_323_));
 sky130_fd_sc_hd__a21oi_2 _708_ (.A1(_268_),
    .A2(_278_),
    .B1(_067_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_324_));
 sky130_fd_sc_hd__a221o_2 _709_ (.A1(_299_),
    .A2(_304_),
    .B1(_323_),
    .B2(_324_),
    .C1(_322_),
    ...
    .VPWR(VPWR),
    .X(_325_));
 sky130_fd_sc_hd__nand2_2 _710_ (.A(_306_),
    .B(_325_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_326_));
 sky130_fd_sc_hd__and3b_2 _711_ (.A_N(\lif_threshold[2] ),
    .B(_306_),
    .C(_325_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_327_));
 sky130_fd_sc_hd__xnor2_2 _712_ (.A(_275_),
    .B(_277_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_328_));
 sky130_fd_sc_hd__a211o_2 _713_ (.A1(net22),
    .A2(_269_),
    .B1(_270_),
    .C1(net21),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_329_));
 sky130_fd_sc_hd__o221a_2 _714_ (.A1(_299_),
    .A2(_304_),
    .B1(_328_),
    .B2(_067_),
    .C1(_329_),
    ...
    .VPWR(VPWR),
    .X(_330_));
 sky130_fd_sc_hd__nor2_2 _715_ (.A(_305_),
    .B(_330_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_331_));
 sky130_fd_sc_hd__and3_2 _716_ (.A(net21),
    .B(\lif_decay_val[0] ),
    .C(_274_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_332_));
 sky130_fd_sc_hd__a21oi_2 _717_ (.A1(net21),
    .A2(\lif_decay_val[0] ),
    .B1(_274_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_333_));
 sky130_fd_sc_hd__o22a_2 _718_ (.A1(_299_),
    .A2(_304_),
    .B1(_332_),
    .B2(_333_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_334_));
 sky130_fd_sc_hd__nor2_2 _719_ (.A(_305_),
    .B(_334_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_335_));
 sky130_fd_sc_hd__a2111o_2 _720_ (.A1(_075_),
    .A2(_330_),
    .B1(_334_),
    .C1(_076_),
    .D1(_305_),
    ...
    .VPWR(VPWR),
    .X(_336_));
 sky130_fd_sc_hd__a21bo_2 _721_ (.A1(_306_),
    .A2(_325_),
    .B1_N(\lif_threshold[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_337_));
 sky130_fd_sc_hd__or3_2 _722_ (.A(_075_),
    .B(_305_),
    .C(_330_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_338_));
 sky130_fd_sc_hd__a311o_2 _723_ (.A1(_336_),
    .A2(_337_),
    .A3(_338_),
    .B1(_327_),
    .C1(_321_),
    ...
    .VPWR(VPWR),
    .X(_339_));
 sky130_fd_sc_hd__a22oi_2 _724_ (.A1(\lif_threshold[4] ),
    .A2(_314_),
    .B1(_320_),
    .B2(\lif_threshold[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_340_));
 sky130_fd_sc_hd__a21o_2 _725_ (.A1(_339_),
    .A2(_340_),
    .B1(_315_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_341_));
 sky130_fd_sc_hd__xnor2_2 _726_ (.A(_249_),
    .B(_289_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_342_));
 sky130_fd_sc_hd__nor2_2 _727_ (.A(_067_),
    .B(_342_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_343_));
 sky130_fd_sc_hd__a21oi_2 _728_ (.A1(_067_),
    .A2(_245_),
    .B1(_343_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_344_));
 sky130_fd_sc_hd__o21ai_2 _729_ (.A1(_305_),
    .A2(_344_),
    .B1(_306_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_345_));
 sky130_fd_sc_hd__a2bb2oi_2 _730_ (.A1_N(_074_),
    .A2_N(_310_),
    .B1(_345_),
    .B2(\lif_threshold[6] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_346_));
 sky130_fd_sc_hd__nor2_2 _731_ (.A(\lif_threshold[6] ),
    .B(_345_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_347_));
 sky130_fd_sc_hd__a221o_2 _732_ (.A1(\lif_threshold[7] ),
    .A2(_299_),
    .B1(_341_),
    .B2(_346_),
    .C1(_347_),
    ...
    .VPWR(VPWR),
    .X(_348_));
 sky130_fd_sc_hd__nand2_2 _733_ (.A(_300_),
    .B(_348_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_349_));
 sky130_fd_sc_hd__and2b_2 _734_ (.A_N(net13),
    .B(_096_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_350_));
 sky130_fd_sc_hd__or3b_2 _735_ (.A(net15),
    .B(net13),
    .C_N(net14),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_351_));
 sky130_fd_sc_hd__and4_2 _736_ (.A(net43),
    .B(_300_),
    .C(_348_),
    .D(_350_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_032_));
 sky130_fd_sc_hd__nand2_2 _737_ (.A(net77),
    .B(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_352_));
 sky130_fd_sc_hd__a31o_2 _738_ (.A1(_073_),
    .A2(_300_),
    .A3(_348_),
    .B1(net23),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_353_));
 sky130_fd_sc_hd__a21o_2 _739_ (.A1(_335_),
    .A2(_349_),
    .B1(_353_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_354_));
 sky130_fd_sc_hd__a21oi_2 _740_ (.A1(_352_),
    .A2(_354_),
    .B1(net24),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_033_));
 sky130_fd_sc_hd__nand2_2 _741_ (.A(net91),
    .B(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_355_));
 sky130_fd_sc_hd__a31o_2 _742_ (.A1(_072_),
    .A2(_300_),
    .A3(_348_),
    .B1(net23),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_356_));
 sky130_fd_sc_hd__a21o_2 _743_ (.A1(_331_),
    .A2(_349_),
    .B1(_356_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_357_));
 sky130_fd_sc_hd__a21oi_2 _744_ (.A1(_355_),
    .A2(_357_),
    .B1(net24),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_034_));
 sky130_fd_sc_hd__nand2_2 _745_ (.A(net81),
    .B(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_358_));
 sky130_fd_sc_hd__and3b_2 _746_ (.A_N(\lif_v_reset[2] ),
    .B(_300_),
    .C(_348_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_359_));
 sky130_fd_sc_hd__a211o_2 _747_ (.A1(_326_),
    .A2(_349_),
    .B1(net23),
    .C1(_359_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_360_));
 sky130_fd_sc_hd__a21oi_2 _748_ (.A1(_358_),
    .A2(_360_),
    .B1(net24),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_035_));
 sky130_fd_sc_hd__nand2_2 _749_ (.A(net85),
    .B(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_361_));
 sky130_fd_sc_hd__a31o_2 _750_ (.A1(_071_),
    .A2(_300_),
    .A3(_348_),
    .B1(net23),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_362_));
 sky130_fd_sc_hd__a21o_2 _751_ (.A1(_320_),
    .A2(_349_),
    .B1(_362_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_363_));
 sky130_fd_sc_hd__a21oi_2 _752_ (.A1(_361_),
    .A2(_363_),
    .B1(net25),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_036_));
 sky130_fd_sc_hd__nand2_2 _753_ (.A(net88),
    .B(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_364_));
 sky130_fd_sc_hd__a31o_2 _754_ (.A1(_070_),
    .A2(_300_),
    .A3(_348_),
    .B1(net23),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_365_));
 sky130_fd_sc_hd__a21o_2 _755_ (.A1(_314_),
    .A2(_349_),
    .B1(_365_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_366_));
 sky130_fd_sc_hd__a21oi_2 _756_ (.A1(_364_),
    .A2(_366_),
    .B1(net25),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_037_));
 sky130_fd_sc_hd__nand2_2 _757_ (.A(net73),
    .B(_351_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_367_));
 sky130_fd_sc_hd__a21o_2 _758_ (.A1(_300_),
    .A2(_348_),
    .B1(_310_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_368_));
 sky130_fd_sc_hd__o211ai_2 _759_ (.A1(\lif_v_reset[5] ),
    .A2(_349_),
    .B1(_350_),
    .C1(_368_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_369_));
 sky130_fd_sc_hd__a21oi_2 _760_ (.A1(_367_),
    .A2(_369_),
    .B1(net25),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_038_));
 sky130_fd_sc_hd__nand2_2 _761_ (.A(net82),
    .B(_351_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_370_));
 sky130_fd_sc_hd__a31o_2 _762_ (.A1(_069_),
    .A2(_300_),
    .A3(_348_),
    .B1(_351_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_371_));
 sky130_fd_sc_hd__a21o_2 _763_ (.A1(_345_),
    .A2(_349_),
    .B1(_371_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_2 _764_ (.A1(_370_),
    ...
    .VPWR(VPWR),
    .Y(_039_));
 sky130_fd_sc_hd__nand2_2 _765_ (.A(net89),
    .B(_351_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_373_));
 sky130_fd_sc_hd__o221ai_2 _766_ (.A1(_298_),
    .A2(_348_),
    .B1(_349_),
    .B2(net83),
    .C1(_350_),
    ...
    .VPWR(VPWR),
    .Y(_374_));
 sky130_fd_sc_hd__a21oi_2 _767_ (.A1(_373_),
    .A2(_374_),
    .B1(net25),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_040_));
 sky130_fd_sc_hd__nand2_2 _768_ (.A(net13),
    .B(_096_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_375_));
 sky130_fd_sc_hd__or3b_2 _769_ (.A(net12),
    .B(_375_),
    .C_N(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_376_));
 sky130_fd_sc_hd__nor2_2 _770_ (.A(net11),
    .B(_376_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_377_));
 sky130_fd_sc_hd__or2_2 _771_ (.A(net11),
    .B(_376_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_378_));
 sky130_fd_sc_hd__mux2_1 _772_ (.A0(net35),
    .A1(\lif_decay_val[0] ),
    .S(_378_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_379_));
 sky130_fd_sc_hd__or2_2 _773_ (.A(net25),
    .B(_379_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_041_));
 sky130_fd_sc_hd__nand2_2 _774_ (.A(_081_),
    .B(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_380_));
 sky130_fd_sc_hd__o211a_2 _775_ (.A1(net33),
    .A2(net18),
    .B1(_380_),
    .C1(net45),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_042_));
 sky130_fd_sc_hd__nand2_2 _776_ (.A(_080_),
    .B(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_381_));
 sky130_fd_sc_hd__o211a_2 _777_ (.A1(net4),
    .A2(net18),
    .B1(_381_),
    .C1(net45),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_043_));
 sky130_fd_sc_hd__nand2_2 _778_ (.A(_079_),
    .B(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_382_));
 sky130_fd_sc_hd__o211a_2 _779_ (.A1(net5),
    .A2(net18),
    .B1(_382_),
    .C1(net45),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_044_));
 sky130_fd_sc_hd__or2_2 _780_ (.A(\lif_decay_val[4] ),
    .B(_377_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_383_));
 sky130_fd_sc_hd__o211a_2 _781_ (.A1(net30),
    .A2(net18),
    .B1(_383_),
    .C1(net46),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_045_));
 sky130_fd_sc_hd__nand2_2 _782_ (.A(_078_),
    .B(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_384_));
 sky130_fd_sc_hd__o211a_2 _783_ (.A1(net7),
    .A2(net18),
    .B1(_384_),
    .C1(net45),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_046_));
 sky130_fd_sc_hd__or2_2 _784_ (.A(\lif_decay_val[6] ),
    .B(_377_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_385_));
 sky130_fd_sc_hd__o211a_2 _785_ (.A1(net8),
    .A2(net18),
    .B1(_385_),
    .C1(net46),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_047_));
 sky130_fd_sc_hd__nand2_2 _786_ (.A(_077_),
    .B(_378_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_386_));
 sky130_fd_sc_hd__o211a_2 _787_ (.A1(net9),
    .A2(_378_),
    .B1(_386_),
    .C1(net46),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_048_));
 sky130_fd_sc_hd__or2_2 _788_ (.A(net10),
    .B(_375_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_387_));
 sky130_fd_sc_hd__nor3_2 _789_ (.A(_093_),
    .B(net12),
    .C(_387_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_388_));
 sky130_fd_sc_hd__or3_2 _790_ (.A(_093_),
    .B(net12),
    .C(_387_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_389_));
 sky130_fd_sc_hd__nand2_2 _791_ (.A(_076_),
    .B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_390_));
 sky130_fd_sc_hd__o211a_2 _792_ (.A1(net36),
    .A2(net17),
    .B1(_390_),
    .C1(net39),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_049_));
 sky130_fd_sc_hd__nand2_2 _793_ (.A(_075_),
    .B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_391_));
 sky130_fd_sc_hd__o211a_2 _794_ (.A1(net34),
    .A2(net17),
    .B1(_391_),
    .C1(net39),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_050_));
 sky130_fd_sc_hd__or2_2 _795_ (.A(\lif_threshold[2] ),
    .B(_388_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_392_));
 sky130_fd_sc_hd__o211a_2 _796_ (.A1(net32),
    .A2(net17),
    .B1(_392_),
    .C1(net39),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_051_));
 sky130_fd_sc_hd__or2_2 _797_ (.A(\lif_threshold[3] ),
    .B(_388_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_393_));
 sky130_fd_sc_hd__o211a_2 _798_ (.A1(net31),
    .A2(net17),
    .B1(_393_),
    .C1(net39),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_052_));
 sky130_fd_sc_hd__or2_2 _799_ (.A(\lif_threshold[4] ),
    .B(_388_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_394_));
 sky130_fd_sc_hd__o211a_2 _800_ (.A1(net30),
    .A2(net17),
    .B1(_394_),
    .C1(net39),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_053_));
 sky130_fd_sc_hd__nand2_2 _801_ (.A(_074_),
    .B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_395_));
 sky130_fd_sc_hd__o211a_2 _802_ (.A1(net28),
    .A2(net17),
    .B1(_395_),
    .C1(net38),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_054_));
 sky130_fd_sc_hd__mux2_1 _803_ (.A0(net27),
    .A1(\lif_threshold[6] ),
    .S(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_396_));
 sky130_fd_sc_hd__or2_2 _804_ (.A(net24),
    .B(_396_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_055_));
 sky130_fd_sc_hd__or2_2 _805_ (.A(\lif_threshold[7] ),
    .B(_388_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_397_));
 sky130_fd_sc_hd__o211a_2 _806_ (.A1(net26),
    .A2(_389_),
    .B1(_397_),
    .C1(net43),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_056_));
 sky130_fd_sc_hd__nor2_2 _807_ (.A(_093_),
    .B(_376_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_398_));
 sky130_fd_sc_hd__or2_2 _808_ (.A(_093_),
    .B(_376_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_399_));
 sky130_fd_sc_hd__nand2_2 _809_ (.A(_073_),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_400_));
 sky130_fd_sc_hd__o211a_2 _810_ (.A1(net36),
    .A2(net16),
    .B1(_400_),
    .C1(net37),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_057_));
 sky130_fd_sc_hd__nand2_2 _811_ (.A(_072_),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_401_));
 sky130_fd_sc_hd__o211a_2 _812_ (.A1(net34),
    .A2(net16),
    .B1(_401_),
    .C1(net37),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_058_));
 sky130_fd_sc_hd__or2_2 _813_ (.A(net103),
    .B(_398_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_402_));
 sky130_fd_sc_hd__o211a_2 _814_ (.A1(net32),
    .A2(net16),
    .B1(_402_),
    .C1(net38),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_059_));
 sky130_fd_sc_hd__nand2_2 _815_ (.A(_071_),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_403_));
 sky130_fd_sc_hd__o211a_2 _816_ (.A1(net31),
    .A2(net16),
    .B1(_403_),
    .C1(net37),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_060_));
 sky130_fd_sc_hd__nand2_2 _817_ (.A(_070_),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_404_));
 sky130_fd_sc_hd__o211a_2 _818_ (.A1(net30),
    .A2(net16),
    .B1(_404_),
    .C1(net38),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_061_));
 sky130_fd_sc_hd__or2_2 _819_ (.A(\lif_v_reset[5] ),
    .B(_398_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_405_));
 sky130_fd_sc_hd__o211a_2 _820_ (.A1(net28),
    .A2(net16),
    .B1(_405_),
    .C1(net41),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_062_));
 sky130_fd_sc_hd__nand2_2 _821_ (.A(_069_),
    .B(_399_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_406_));
 sky130_fd_sc_hd__o211a_2 _822_ (.A1(net27),
    .A2(_399_),
    .B1(_406_),
    .C1(net41),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_063_));
 sky130_fd_sc_hd__or2_2 _823_ (.A(net26),
    .B(_399_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_407_));
 sky130_fd_sc_hd__o211a_2 _824_ (.A1(net83),
    .A2(_398_),
    .B1(_407_),
    .C1(net43),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_064_));
 sky130_fd_sc_hd__or3b_2 _825_ (.A(_387_),
    .B(net11),
    .C_N(net12),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_408_));
 sky130_fd_sc_hd__mux2_1 _826_ (.A0(net36),
    .A1(lif_mode_add),
    .S(_408_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_409_));
 sky130_fd_sc_hd__or2_2 _827_ (.A(net25),
    .B(_409_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_065_));
 sky130_fd_sc_hd__o21ai_2 _828_ (.A1(net34),
    .A2(_408_),
    .B1(net46),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_410_));
 sky130_fd_sc_hd__a21oi_2 _829_ (.A1(_067_),
    .A2(_408_),
    .B1(_410_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_066_));
 sky130_fd_sc_hd__dfxtp_2 _830_ (.CLK(clknet_3_2__leaf_clk),
    .D(_000_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\bm_count[0] ));
 sky130_fd_sc_hd__dfxtp_2 _831_ (.CLK(clknet_3_2__leaf_clk),
    .D(_001_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _834_ (.CLK(clknet_3_3__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\bm_count[4] ));
 sky130_fd_sc_hd__dfxtp_2 _835_ (.CLK(clknet_3_6__leaf_clk),
    .D(_005_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\bm_count[5] ));
 sky130_fd_sc_hd__dfxtp_2 _836_ (.CLK(clknet_3_6__leaf_clk),
    .D(_006_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\bm_count[6] ));
 sky130_fd_sc_hd__dfxtp_2 _837_ (.CLK(clknet_3_6__leaf_clk),
    .D(_007_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\bm_count[7] ));
 sky130_fd_sc_hd__dfxtp_2 _838_ (.CLK(clknet_3_6__leaf_clk),
    .D(_008_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\bm_count[8] ));
 sky130_fd_sc_hd__dfxtp_2 _839_ (.CLK(clknet_3_3__leaf_clk),
    .D(_009_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\bm_count[9] ));
 sky130_fd_sc_hd__dfxtp_2 _840_ (.CLK(clknet_3_3__leaf_clk),
    .D(_010_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\bm_count[10] ));
 sky130_fd_sc_hd__dfxtp_2 _841_ (.CLK(clknet_3_3__leaf_clk),
    .D(_011_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _842_ (.CLK(clknet_3_3__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\bm_count[12] ));
 sky130_fd_sc_hd__dfxtp_2 _843_ (.CLK(clknet_3_2__leaf_clk),
    .D(_013_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _846_ (.CLK(clknet_3_0__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\u_bm.q_bot_full[0] ));
 sky130_fd_sc_hd__dfxtp_2 _847_ (.CLK(clknet_3_0__leaf_clk),
    .D(_017_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _848_ (.CLK(clknet_3_0__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\u_bm.q_bot_full[2] ));
 sky130_fd_sc_hd__dfxtp_2 _849_ (.CLK(clknet_3_0__leaf_clk),
    .D(_019_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_bm.q_bot_full[3] ));
 sky130_fd_sc_hd__dfxtp_2 _850_ (.CLK(clknet_3_0__leaf_clk),
    .D(_020_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_bm.q_bot_full[4] ));
 sky130_fd_sc_hd__dfxtp_2 _851_ (.CLK(clknet_3_0__leaf_clk),
    .D(_021_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_bm.q_bot_full[5] ));
 sky130_fd_sc_hd__dfxtp_2 _852_ (.CLK(clknet_3_1__leaf_clk),
    .D(_022_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _853_ (.CLK(clknet_3_1__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\u_bm.q_bot_full[7] ));
 sky130_fd_sc_hd__dfxtp_2 _854_ (.CLK(clknet_3_1__leaf_clk),
    .D(_024_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _855_ (.CLK(clknet_3_1__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\u_bm.q_top_full[1] ));
 sky130_fd_sc_hd__dfxtp_2 _856_ (.CLK(clknet_3_1__leaf_clk),
    .D(_026_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_bm.q_top_full[2] ));
 sky130_fd_sc_hd__dfxtp_2 _857_ (.CLK(clknet_3_1__leaf_clk),
    .D(_027_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_bm.q_top_full[3] ));
 sky130_fd_sc_hd__dfxtp_2 _858_ (.CLK(clknet_3_2__leaf_clk),
    .D(_028_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_bm.q_top_full[4] ));
 sky130_fd_sc_hd__dfxtp_2 _859_ (.CLK(clknet_3_2__leaf_clk),
    .D(_029_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _862_ (.CLK(clknet_3_6__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(lif_spike));
 sky130_fd_sc_hd__dfxtp_2 _863_ (.CLK(clknet_3_5__leaf_clk),
    .D(_033_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\lif_membrane[0] ));
 sky130_fd_sc_hd__dfxtp_2 _864_ (.CLK(clknet_3_5__leaf_clk),
    .D(_034_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\lif_membrane[1] ));
 sky130_fd_sc_hd__dfxtp_2 _865_ (.CLK(clknet_3_5__leaf_clk),
    .D(_035_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\lif_membrane[2] ));
 sky130_fd_sc_hd__dfxtp_2 _866_ (.CLK(clknet_3_5__leaf_clk),
    .D(_036_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\lif_membrane[3] ));
 sky130_fd_sc_hd__dfxtp_2 _867_ (.CLK(clknet_3_6__leaf_clk),
    .D(_037_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _868_ (.CLK(clknet_3_7__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\lif_membrane[5] ));
 sky130_fd_sc_hd__dfxtp_2 _869_ (.CLK(clknet_3_7__leaf_clk),
    .D(_039_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\lif_membrane[6] ));
 sky130_fd_sc_hd__dfxtp_2 _870_ (.CLK(clknet_3_6__leaf_clk),
    .D(_040_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\lif_membrane[7] ));
 sky130_fd_sc_hd__dfxtp_2 _871_ (.CLK(clknet_3_5__leaf_clk),
    .D(_041_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _874_ (.CLK(clknet_3_5__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\lif_decay_val[3] ));
 sky130_fd_sc_hd__dfxtp_2 _875_ (.CLK(clknet_3_7__leaf_clk),
    .D(_045_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _878_ (.CLK(clknet_3_7__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\lif_decay_val[7] ));
 sky130_fd_sc_hd__dfxtp_2 _879_ (.CLK(clknet_3_4__leaf_clk),
    .D(_049_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\lif_threshold[0] ));
 sky130_fd_sc_hd__dfxtp_2 _880_ (.CLK(clknet_3_4__leaf_clk),
    .D(_050_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\lif_threshold[1] ));
 sky130_fd_sc_hd__dfxtp_2 _881_ (.CLK(clknet_3_4__leaf_clk),
    .D(_051_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\lif_threshold[2] ));
 sky130_fd_sc_hd__dfxtp_2 _882_ (.CLK(clknet_3_4__leaf_clk),
    .D(_052_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _884_ (.CLK(clknet_3_4__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\lif_threshold[5] ));
 sky130_fd_sc_hd__dfxtp_2 _885_ (.CLK(clknet_3_0__leaf_clk),
    .D(_055_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\lif_threshold[6] ));
 sky130_fd_sc_hd__dfxtp_2 _886_ (.CLK(clknet_3_6__leaf_clk),
    .D(_056_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\lif_threshold[7] ));
 sky130_fd_sc_hd__dfxtp_2 _887_ (.CLK(clknet_3_0__leaf_clk),
    .D(_057_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\lif_v_reset[0] ));
 sky130_fd_sc_hd__dfxtp_2 _888_ (.CLK(clknet_3_0__leaf_clk),
    .D(_058_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _891_ (.CLK(clknet_3_4__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\lif_v_reset[4] ));
 sky130_fd_sc_hd__dfxtp_2 _892_ (.CLK(clknet_3_1__leaf_clk),
    .D(_062_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\lif_v_reset[5] ));
 sky130_fd_sc_hd__dfxtp_2 _893_ (.CLK(clknet_3_1__leaf_clk),
    .D(_063_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\lif_v_reset[6] ));
 sky130_fd_sc_hd__dfxtp_2 _894_ (.CLK(clknet_3_3__leaf_clk),
    .D(_064_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _896_ (.CLK(clknet_3_7__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(lif_mode_decay));
 sky130_fd_sc_hd__buf_2 _905_ (.A(\bm_count[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[0]));
 sky130_fd_sc_hd__buf_2 _906_ (.A(\bm_count[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[1]));
 sky130_fd_sc_hd__buf_2 _907_ (.A(\bm_count[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[2]));
 sky130_fd_sc_hd__buf_2 _908_ (.A(\bm_count[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[3]));
 sky130_fd_sc_hd__buf_2 _909_ (.A(\bm_count[12] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[4]));
 sky130_fd_sc_hd__buf_2 _910_ (.A(\bm_count[13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[5]));
 sky130_fd_sc_hd__buf_2 _911_ (.A(\bm_count[14] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[6]));
 sky130_fd_sc_hd__buf_2 _912_ (.A(\bm_count[15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 clkload4 (.A(clknet_3_7__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout16 (.A(_399_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net16));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout17 (.A(_389_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net17));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout18 (.A(_378_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net18));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout19 (.A(_068_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net19));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout20 (.A(_068_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net20));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout21 (.A(lif_mode_decay),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net21));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout22 (.A(lif_mode_add),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net22));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout23 (.A(_351_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net23));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout24 (.A(_092_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net24));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout25 (.A(_092_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net25));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout26 (.A(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net26));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout27 (.A(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net27));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout28 (.A(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout29 (.A(net30),
    ...
    .VPWR(VPWR),
    .X(net29));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout30 (.A(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net30));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout31 (.A(net5),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout45 (.A(net1),
    ...
    .VPWR(VPWR),
    .X(net45));
 sky130_fd_sc_hd__dlygate4sd3_1 hold100 (.A(\lif_decay_val[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net100));
 sky130_fd_sc_hd__dlygate4sd3_1 hold101 (.A(\lif_threshold[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net101));
 sky130_fd_sc_hd__dlygate4sd3_1 hold102 (.A(\lif_decay_val[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net102));
 sky130_fd_sc_hd__dlygate4sd3_1 hold103 (.A(\lif_v_reset[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net103));
 sky130_fd_sc_hd__dlygate4sd3_1 hold54 (.A(\u_bm.q_top_full[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net54));
 sky130_fd_sc_hd__dlygate4sd3_1 hold55 (.A(\u_bm.q_top_full[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net55));
 sky130_fd_sc_hd__dlygate4sd3_1 hold56 (.A(\u_bm.q_top_full[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net56));
 sky130_fd_sc_hd__dlygate4sd3_1 hold57 (.A(\bm_count[15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net57));
 sky130_fd_sc_hd__dlygate4sd3_1 hold58 (.A(\u_bm.q_bot_full[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net58));
 sky130_fd_sc_hd__dlygate4sd3_1 hold59 (.A(\u_bm.q_top_full[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net59));
 sky130_fd_sc_hd__dlygate4sd3_1 hold60 (.A(\u_bm.q_bot_full[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net60));
 sky130_fd_sc_hd__dlygate4sd3_1 hold61 (.A(\u_bm.q_bot_full[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net61));
 sky130_fd_sc_hd__dlygate4sd3_1 hold62 (.A(\bm_count[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net62));
 sky130_fd_sc_hd__dlygate4sd3_1 hold63 (.A(\bm_count[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net63));
 sky130_fd_sc_hd__dlygate4sd3_1 hold64 (.A(\u_bm.q_bot_full[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net64));
 sky130_fd_sc_hd__dlygate4sd3_1 hold65 (.A(\u_bm.q_top_full[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net65));
 sky130_fd_sc_hd__dlygate4sd3_1 hold66 (.A(\bm_count[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net66));
 sky130_fd_sc_hd__dlygate4sd3_1 hold67 (.A(\u_bm.q_bot_full[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net67));
 sky130_fd_sc_hd__dlygate4sd3_1 hold68 (.A(\bm_count[14] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net68));
 sky130_fd_sc_hd__dlygate4sd3_1 hold69 (.A(\bm_count[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net69));
 sky130_fd_sc_hd__dlygate4sd3_1 hold70 (.A(\u_bm.q_bot_full[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net70));
 sky130_fd_sc_hd__dlygate4sd3_1 hold71 (.A(\u_bm.q_top_full[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net71));
 sky130_fd_sc_hd__dlygate4sd3_1 hold72 (.A(\bm_count[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net72));
 sky130_fd_sc_hd__dlygate4sd3_1 hold73 (.A(\lif_membrane[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net73));
 sky130_fd_sc_hd__dlygate4sd3_1 hold74 (.A(\u_bm.q_top_full[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net74));
 sky130_fd_sc_hd__dlygate4sd3_1 hold75 (.A(\u_bm.q_bot_full[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net75));
 sky130_fd_sc_hd__dlygate4sd3_1 hold76 (.A(\bm_count[13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net76));
 sky130_fd_sc_hd__dlygate4sd3_1 hold77 (.A(\lif_membrane[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net77));
 sky130_fd_sc_hd__dlygate4sd3_1 hold78 (.A(\bm_count[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net78));
 sky130_fd_sc_hd__dlygate4sd3_1 hold79 (.A(\bm_count[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net79));
 sky130_fd_sc_hd__dlygate4sd3_1 hold80 (.A(\bm_count[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net80));
 sky130_fd_sc_hd__dlygate4sd3_1 hold81 (.A(\lif_membrane[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net81));
 sky130_fd_sc_hd__dlygate4sd3_1 hold82 (.A(\lif_membrane[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net82));
 sky130_fd_sc_hd__dlygate4sd3_1 hold83 (.A(\lif_v_reset[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net83));
 sky130_fd_sc_hd__dlygate4sd3_1 hold84 (.A(\bm_count[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net84));
 sky130_fd_sc_hd__dlygate4sd3_1 hold85 (.A(\lif_membrane[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net85));
 sky130_fd_sc_hd__dlygate4sd3_1 hold86 (.A(\bm_count[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net86));
 sky130_fd_sc_hd__dlygate4sd3_1 hold87 (.A(\bm_count[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net87));
 sky130_fd_sc_hd__dlygate4sd3_1 hold88 (.A(\lif_membrane[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net88));
 sky130_fd_sc_hd__dlygate4sd3_1 hold89 (.A(\lif_membrane[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net89));
 sky130_fd_sc_hd__dlygate4sd3_1 hold90 (.A(\lif_threshold[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net90));
 sky130_fd_sc_hd__dlygate4sd3_1 hold91 (.A(\lif_membrane[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net91));
 sky130_fd_sc_hd__dlygate4sd3_1 hold92 (.A(\lif_v_reset[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net92));
 sky130_fd_sc_hd__dlygate4sd3_1 hold93 (.A(\lif_v_reset[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net93));
 sky130_fd_sc_hd__dlygate4sd3_1 hold94 (.A(\lif_v_reset[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net94));
 sky130_fd_sc_hd__dlygate4sd3_1 hold95 (.A(\lif_v_reset[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net95));
 sky130_fd_sc_hd__dlygate4sd3_1 hold96 (.A(\lif_threshold[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net96));
 sky130_fd_sc_hd__dlygate4sd3_1 hold97 (.A(\lif_v_reset[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net97));
 sky130_fd_sc_hd__dlygate4sd3_1 hold98 (.A(\lif_decay_val[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net98));
 sky130_fd_sc_hd__dlygate4sd3_1 hold99 (.A(\lif_decay_val[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 load_slew46 (.A(net45),
    ...
    .VPWR(VPWR),
    .X(net46));
 sky130_fd_sc_hd__conb_1 tt_um_bn_lif_evan (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net));
 sky130_fd_sc_hd__conb_1 tt_um_bn_lif_evan_47 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net47));
 sky130_fd_sc_hd__conb_1 tt_um_bn_lif_evan_48 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net48));
 sky130_fd_sc_hd__conb_1 tt_um_bn_lif_evan_49 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net49));
 sky130_fd_sc_hd__conb_1 tt_um_bn_lif_evan_50 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net50));
 sky130_fd_sc_hd__conb_1 tt_um_bn_lif_evan_51 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net51));
 sky130_fd_sc_hd__conb_1 tt_um_bn_lif_evan_52 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net52));
 sky130_fd_sc_hd__conb_1 tt_um_bn_lif_evan_53 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net53));
