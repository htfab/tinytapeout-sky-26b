module tt_um_8_bit_cpu (clk,
 ...
 wire \instruction[7] ;
 wire invalid_ins;
 wire \multiplexer.c[0] ;
 wire \multiplexer.c[1] ;
 wire \multiplexer.c[2] ;
 wire \multiplexer.c[3] ;
 wire \multiplexer.c[4] ;
 wire \multiplexer.c[5] ;
 wire \multiplexer.c[6] ;
 wire \multiplexer.c[7] ;
 wire net1;
 wire send_ins;
 wire \state[0] ;
 wire \state[1] ;
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_137 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _0489_ (.A(\alu_unit.A[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0087_));
 sky130_fd_sc_hd__inv_2 _0490_ (.A(\alu_unit.A[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0088_));
 sky130_fd_sc_hd__inv_2 _0491_ (.A(\alu_unit.A[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0089_));
 sky130_fd_sc_hd__inv_2 _0492_ (.A(\alu_unit.A[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0090_));
 sky130_fd_sc_hd__inv_2 _0493_ (.A(\alu_unit.A[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0091_));
 sky130_fd_sc_hd__inv_2 _0494_ (.A(\immediate[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0092_));
 sky130_fd_sc_hd__inv_2 _0495_ (.A(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0093_));
 sky130_fd_sc_hd__and2_2 _0496_ (.A(\state[0] ),
    .B(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0011_));
 sky130_fd_sc_hd__or4_2 _0497_ (.A(\instruction[3] ),
    .B(\instruction[2] ),
    .C(\instruction[1] ),
    .D(\instruction[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0094_));
 sky130_fd_sc_hd__or4_2 _0498_ (.A(\instruction[7] ),
    .B(\instruction[6] ),
    .C(\instruction[5] ),
    .D(\instruction[4] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0095_));
 sky130_fd_sc_hd__or2_2 _0499_ (.A(_0094_),
    .B(_0095_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0096_));
 sky130_fd_sc_hd__or4_2 _0500_ (.A(_0078_),
    .B(_0077_),
    .C(_0080_),
    .D(_0079_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0097_));
 sky130_fd_sc_hd__or4_2 _0501_ (.A(_0074_),
    .B(_0073_),
    .C(_0076_),
    .D(_0075_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0098_));
 sky130_fd_sc_hd__or4_2 _0502_ (.A(_0082_),
    .B(_0081_),
    .C(_0084_),
    .D(_0083_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0099_));
 sky130_fd_sc_hd__or3b_2 _0503_ (.A(_0086_),
    .B(_0085_),
    .C_N(\state[3] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0100_));
 sky130_fd_sc_hd__nor4_2 _0504_ (.A(_0097_),
    .B(_0098_),
    .C(_0099_),
    .D(_0100_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0101_));
 sky130_fd_sc_hd__or4_2 _0505_ (.A(_0097_),
    .B(_0098_),
    .C(_0099_),
    .D(_0100_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0102_));
 sky130_fd_sc_hd__a21o_2 _0506_ (.A1(\state[4] ),
    .A2(_0096_),
    .B1(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0103_));
 sky130_fd_sc_hd__and2_2 _0507_ (.A(_0082_),
    .B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0104_));
 sky130_fd_sc_hd__and3_2 _0508_ (.A(_0082_),
    .B(_0083_),
    .C(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0105_));
 sky130_fd_sc_hd__a21oi_2 _0509_ (.A1(_0083_),
    .A2(net17),
    .B1(_0103_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0106_));
 sky130_fd_sc_hd__a21oi_2 _0510_ (.A1(_0084_),
    .A2(net18),
    .B1(_0103_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0107_));
 sky130_fd_sc_hd__a21oi_2 _0511_ (.A1(_0084_),
    .A2(_0105_),
    .B1(_0103_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0108_));
 sky130_fd_sc_hd__a21o_2 _0512_ (.A1(_0084_),
    .A2(_0105_),
    .B1(_0103_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0109_));
 sky130_fd_sc_hd__nand2_2 _0513_ (.A(_0077_),
    .B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0110_));
 sky130_fd_sc_hd__or3_2 _0514_ (.A(\state[4] ),
    .B(\state[2] ),
    .C(\state[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0111_));
 sky130_fd_sc_hd__o31a_2 _0515_ (.A1(\state[3] ),
    .A2(\state[1] ),
    .A3(_0111_),
    .B1(_0110_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0112_));
 sky130_fd_sc_hd__and2_2 _0516_ (.A(net14),
    .B(_0112_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0113_));
 sky130_fd_sc_hd__nand2_2 _0517_ (.A(net14),
    .B(_0112_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0114_));
 sky130_fd_sc_hd__and2_2 _0518_ (.A(_0078_),
    .B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0115_));
 sky130_fd_sc_hd__nand2_2 _0519_ (.A(_0078_),
    .B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0116_));
 sky130_fd_sc_hd__nand2_2 _0520_ (.A(net14),
    .B(_0116_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0117_));
 sky130_fd_sc_hd__o21ai_2 _0521_ (.A1(_0112_),
    .A2(_0116_),
    .B1(net14),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0118_));
 sky130_fd_sc_hd__a221o_2 _0522_ (.A1(_0080_),
    .A2(net17),
    .B1(_0096_),
    .B2(\state[1] ),
    .C1(_0103_),
    ...
    .VPWR(VPWR),
    .X(_0119_));
 sky130_fd_sc_hd__and3_2 _0523_ (.A(_0109_),
    .B(_0118_),
    .C(_0119_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0120_));
 sky130_fd_sc_hd__a21oi_2 _0524_ (.A1(_0076_),
    .A2(net18),
    .B1(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0121_));
 sky130_fd_sc_hd__a21o_2 _0525_ (.A1(_0076_),
    .A2(net18),
    .B1(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0122_));
 sky130_fd_sc_hd__nand2_2 _0526_ (.A(_0075_),
    .B(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0123_));
 sky130_fd_sc_hd__a31o_2 _0527_ (.A1(_0076_),
    .A2(_0075_),
    .A3(net18),
    .B1(net15),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0124_));
 sky130_fd_sc_hd__and2_2 _0528_ (.A(_0074_),
    .B(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0125_));
 sky130_fd_sc_hd__or2_2 _0529_ (.A(net15),
    .B(_0125_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0126_));
 sky130_fd_sc_hd__nand2_2 _0530_ (.A(_0073_),
    .B(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0127_));
 sky130_fd_sc_hd__nand2_2 _0531_ (.A(net14),
    .B(_0127_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0128_));
 sky130_fd_sc_hd__and2_2 _0532_ (.A(_0126_),
    .B(_0128_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0129_));
 sky130_fd_sc_hd__nand2_2 _0533_ (.A(_0126_),
    .B(_0128_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0130_));
 sky130_fd_sc_hd__nand2_2 _0534_ (.A(_0124_),
    .B(_0129_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0131_));
 sky130_fd_sc_hd__or3b_2 _0535_ (.A(\instruction[7] ),
    .B(\instruction[6] ),
    .C_N(\state[3] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0132_));
 sky130_fd_sc_hd__and2_2 _0536_ (.A(_0102_),
    .B(_0132_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0133_));
 sky130_fd_sc_hd__nand2_2 _0537_ (.A(_0102_),
    .B(_0132_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0134_));
 sky130_fd_sc_hd__a21o_2 _0538_ (.A1(_0079_),
    .A2(net17),
    .B1(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0135_));
 sky130_fd_sc_hd__nor2_2 _0539_ (.A(\state[0] ),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0136_));
 sky130_fd_sc_hd__or2_2 _0540_ (.A(\state[0] ),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0137_));
 sky130_fd_sc_hd__a21o_2 _0541_ (.A1(_0086_),
    .A2(net17),
    .B1(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0138_));
 sky130_fd_sc_hd__a21o_2 _0542_ (.A1(_0085_),
    .A2(net17),
    .B1(_0101_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0139_));
 sky130_fd_sc_hd__a21o_2 _0543_ (.A1(_0081_),
    .A2(net17),
    .B1(net16),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0140_));
 sky130_fd_sc_hd__and4_2 _0544_ (.A(_0096_),
    .B(_0138_),
    .C(_0139_),
    .D(_0140_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0141_));
 sky130_fd_sc_hd__and4_2 _0545_ (.A(_0134_),
    .B(net13),
    .C(_0137_),
    .D(_0141_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0142_));
 sky130_fd_sc_hd__and4_2 _0546_ (.A(_0120_),
    .B(_0124_),
    .C(_0129_),
    .D(_0142_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(invalid_ins));
 sky130_fd_sc_hd__and2b_2 _0547_ (.A_N(invalid_ins),
    .B(net53),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0010_));
 sky130_fd_sc_hd__or2_2 _0548_ (.A(\state[1] ),
    .B(invalid_ins),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(send_ins));
 sky130_fd_sc_hd__a21o_2 _0549_ (.A1(\state[0] ),
    .A2(_0093_),
    .B1(send_ins),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0012_));
 sky130_fd_sc_hd__and3b_2 _0550_ (.A_N(invalid_ins),
    .B(\state[1] ),
    .C(_0119_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0143_));
 sky130_fd_sc_hd__and2_2 _0551_ (.A(\acc.reg_q[0] ),
    .B(_0143_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[0]));
 sky130_fd_sc_hd__and2_2 _0552_ (.A(\acc.reg_q[1] ),
    .B(_0143_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[1]));
 sky130_fd_sc_hd__and2_2 _0553_ (.A(\acc.reg_q[2] ),
    .B(_0143_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[2]));
 sky130_fd_sc_hd__and2_2 _0554_ (.A(\acc.reg_q[3] ),
    .B(_0143_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[3]));
 sky130_fd_sc_hd__and2_2 _0555_ (.A(\acc.reg_q[4] ),
    .B(_0143_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[4]));
 sky130_fd_sc_hd__and2_2 _0556_ (.A(\acc.reg_q[5] ),
    .B(_0143_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[5]));
 sky130_fd_sc_hd__and2_2 _0557_ (.A(\acc.reg_q[6] ),
    .B(_0143_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[6]));
 sky130_fd_sc_hd__and2_2 _0558_ (.A(\acc.reg_q[7] ),
    .B(_0143_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[7]));
 sky130_fd_sc_hd__mux2_1 _0559_ (.A0(\instruction[2] ),
    .A1(net4),
    .S(_0137_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0144_));
 sky130_fd_sc_hd__mux2_1 _0560_ (.A0(\instruction[1] ),
    .A1(net3),
    .S(_0137_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0145_));
 sky130_fd_sc_hd__nand2_2 _0561_ (.A(net24),
    .B(_0145_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0146_));
 sky130_fd_sc_hd__inv_2 _0562_ (.A(_0146_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0043_));
 sky130_fd_sc_hd__nor2_2 _0563_ (.A(_0144_),
    .B(_0146_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0147_));
 sky130_fd_sc_hd__or2_2 _0564_ (.A(\instruction[3] ),
    .B(_0137_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0148_));
 sky130_fd_sc_hd__o211ai_2 _0565_ (.A1(net5),
    .A2(_0136_),
    .B1(_0148_),
    .C1(net23),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0149_));
 sky130_fd_sc_hd__inv_2 _0566_ (.A(_0149_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0045_));
 sky130_fd_sc_hd__nand2_2 _0567_ (.A(net24),
    .B(_0144_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0150_));
 sky130_fd_sc_hd__inv_2 _0568_ (.A(_0150_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0044_));
 sky130_fd_sc_hd__or2_2 _0569_ (.A(_0145_),
    .B(_0150_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0151_));
 sky130_fd_sc_hd__nand2_2 _0570_ (.A(net11),
    .B(_0151_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0152_));
 sky130_fd_sc_hd__nor2_2 _0571_ (.A(_0147_),
    .B(_0152_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0153_));
 sky130_fd_sc_hd__or2_2 _0572_ (.A(\instruction[7] ),
    .B(_0137_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0154_));
 sky130_fd_sc_hd__o211ai_2 _0573_ (.A1(net9),
    .A2(_0136_),
    .B1(_0154_),
    .C1(net23),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0155_));
 sky130_fd_sc_hd__inv_2 _0574_ (.A(_0155_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0049_));
 sky130_fd_sc_hd__mux2_1 _0575_ (.A0(\instruction[4] ),
    .A1(net6),
    .S(_0137_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0156_));
 sky130_fd_sc_hd__nand2_2 _0576_ (.A(net25),
    .B(_0156_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0157_));
 sky130_fd_sc_hd__inv_2 _0577_ (.A(_0157_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0046_));
 sky130_fd_sc_hd__mux2_1 _0578_ (.A0(\instruction[5] ),
    .A1(net7),
    .S(_0137_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0158_));
 sky130_fd_sc_hd__nor2_2 _0579_ (.A(_0157_),
    .B(_0158_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0159_));
 sky130_fd_sc_hd__and2_2 _0580_ (.A(_0049_),
    .B(_0159_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0160_));
 sky130_fd_sc_hd__or2_2 _0581_ (.A(_0144_),
    .B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0161_));
 sky130_fd_sc_hd__or3b_2 _0582_ (.A(_0144_),
    .B(net11),
    .C_N(_0145_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0162_));
 sky130_fd_sc_hd__mux2_1 _0583_ (.A0(\instruction[0] ),
    .A1(net2),
    .S(_0137_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0163_));
 sky130_fd_sc_hd__nand2_2 _0584_ (.A(net25),
    .B(_0163_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0164_));
 sky130_fd_sc_hd__inv_2 _0585_ (.A(_0164_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0042_));
 sky130_fd_sc_hd__and4b_2 _0586_ (.A_N(_0153_),
    .B(_0160_),
    .C(_0162_),
    .D(_0042_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0165_));
 sky130_fd_sc_hd__nand2_2 _0587_ (.A(net24),
    .B(_0158_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0166_));
 sky130_fd_sc_hd__inv_2 _0588_ (.A(_0166_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0047_));
 sky130_fd_sc_hd__or2_2 _0589_ (.A(_0144_),
    .B(_0164_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0167_));
 sky130_fd_sc_hd__nor2_2 _0590_ (.A(_0145_),
    .B(_0167_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0168_));
 sky130_fd_sc_hd__and3_2 _0591_ (.A(net11),
    .B(_0157_),
    .C(_0168_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0169_));
 sky130_fd_sc_hd__or2_2 _0592_ (.A(_0047_),
    .B(_0169_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0170_));
 sky130_fd_sc_hd__or3_2 _0593_ (.A(_0043_),
    .B(_0149_),
    .C(_0044_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0171_));
 sky130_fd_sc_hd__a21o_2 _0594_ (.A1(_0163_),
    .A2(_0171_),
    .B1(_0157_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0172_));
 sky130_fd_sc_hd__nand2_2 _0595_ (.A(_0145_),
    .B(_0042_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0173_));
 sky130_fd_sc_hd__nor2_2 _0596_ (.A(_0161_),
    .B(_0173_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0174_));
 sky130_fd_sc_hd__o21a_2 _0597_ (.A1(_0046_),
    .A2(_0174_),
    .B1(_0172_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0175_));
 sky130_fd_sc_hd__or2_2 _0598_ (.A(\instruction[6] ),
    .B(_0137_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0176_));
 sky130_fd_sc_hd__o211ai_2 _0599_ (.A1(net8),
    .A2(_0136_),
    .B1(_0176_),
    .C1(net23),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0177_));
 sky130_fd_sc_hd__inv_2 _0600_ (.A(_0177_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0048_));
 sky130_fd_sc_hd__nor2_2 _0601_ (.A(_0049_),
    .B(_0048_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0178_));
 sky130_fd_sc_hd__and4_2 _0602_ (.A(_0144_),
    .B(_0145_),
    .C(net11),
    .D(_0042_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0179_));
 sky130_fd_sc_hd__o32a_2 _0603_ (.A1(_0166_),
    .A2(_0174_),
    .A3(_0179_),
    .B1(_0175_),
    .B2(_0170_),
    ...
    .VPWR(VPWR),
    .X(_0180_));
 sky130_fd_sc_hd__a21o_2 _0604_ (.A1(net10),
    .A2(_0180_),
    .B1(_0165_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0000_));
 sky130_fd_sc_hd__nor2_2 _0605_ (.A(_0155_),
    .B(_0177_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0181_));
 sky130_fd_sc_hd__or3_2 _0606_ (.A(_0144_),
    .B(_0146_),
    .C(_0163_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0182_));
 sky130_fd_sc_hd__nand2_2 _0607_ (.A(net11),
    .B(_0156_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0183_));
 sky130_fd_sc_hd__or2_2 _0608_ (.A(_0182_),
    .B(_0183_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0184_));
 sky130_fd_sc_hd__inv_2 _0609_ (.A(_0184_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0185_));
 sky130_fd_sc_hd__nand2_2 _0610_ (.A(net11),
    .B(_0047_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0186_));
 sky130_fd_sc_hd__nor2_2 _0611_ (.A(_0182_),
    .B(_0186_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0187_));
 sky130_fd_sc_hd__and3_2 _0612_ (.A(_0049_),
    .B(_0046_),
    .C(_0187_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0188_));
 sky130_fd_sc_hd__a21o_2 _0613_ (.A1(_0147_),
    .A2(_0163_),
    .B1(_0152_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0189_));
 sky130_fd_sc_hd__and3_2 _0614_ (.A(_0146_),
    .B(_0149_),
    .C(_0164_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0190_));
 sky130_fd_sc_hd__and2b_2 _0615_ (.A_N(_0190_),
    .B(_0160_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0191_));
 sky130_fd_sc_hd__or2_2 _0616_ (.A(_0174_),
    .B(_0190_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0192_));
 sky130_fd_sc_hd__inv_2 _0617_ (.A(_0192_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0193_));
 sky130_fd_sc_hd__a31o_2 _0618_ (.A1(_0160_),
    .A2(_0189_),
    .A3(_0193_),
    .B1(_0188_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0194_));
 sky130_fd_sc_hd__or2_2 _0619_ (.A(_0181_),
    .B(_0194_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0195_));
 sky130_fd_sc_hd__nand2_2 _0620_ (.A(_0145_),
    .B(_0044_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0196_));
 sky130_fd_sc_hd__nand2_2 _0621_ (.A(_0182_),
    .B(_0196_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0197_));
 sky130_fd_sc_hd__and4b_2 _0622_ (.A_N(_0158_),
    .B(_0156_),
    .C(net11),
    .D(_0147_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0198_));
 sky130_fd_sc_hd__a311o_2 _0623_ (.A1(_0149_),
    .A2(_0159_),
    .A3(_0197_),
    .B1(_0198_),
    .C1(_0187_),
    ...
    .VPWR(VPWR),
    .X(_0199_));
 sky130_fd_sc_hd__and4_2 _0624_ (.A(_0155_),
    .B(_0046_),
    .C(_0048_),
    .D(_0187_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0200_));
 sky130_fd_sc_hd__o21a_2 _0625_ (.A1(_0144_),
    .A2(_0173_),
    .B1(_0149_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0201_));
 sky130_fd_sc_hd__a31o_2 _0626_ (.A1(net11),
    .A2(_0182_),
    .A3(_0196_),
    .B1(_0201_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0202_));
 sky130_fd_sc_hd__nand2_2 _0627_ (.A(_0047_),
    .B(_0202_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0203_));
 sky130_fd_sc_hd__a211o_2 _0628_ (.A1(_0145_),
    .A2(_0046_),
    .B1(_0047_),
    .C1(_0174_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0204_));
 sky130_fd_sc_hd__a31o_2 _0629_ (.A1(net10),
    .A2(_0203_),
    .A3(_0204_),
    .B1(_0200_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0205_));
 sky130_fd_sc_hd__a21o_2 _0630_ (.A1(_0195_),
    .A2(_0199_),
    .B1(_0205_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0003_));
 sky130_fd_sc_hd__and4_2 _0631_ (.A(net25),
    .B(_0144_),
    .C(_0046_),
    .D(_0166_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0206_));
 sky130_fd_sc_hd__nor2_2 _0632_ (.A(_0186_),
    .B(_0196_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0207_));
 sky130_fd_sc_hd__or3_2 _0633_ (.A(net11),
    .B(_0151_),
    .C(_0163_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0208_));
 sky130_fd_sc_hd__or3b_2 _0634_ (.A(_0206_),
    .B(_0207_),
    .C_N(_0208_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0209_));
 sky130_fd_sc_hd__a32o_2 _0635_ (.A1(_0152_),
    .A2(_0161_),
    .A3(_0191_),
    .B1(_0209_),
    .B2(net10),
    ...
    .VPWR(VPWR),
    .X(_0004_));
 sky130_fd_sc_hd__nor3_2 _0636_ (.A(_0151_),
    .B(_0158_),
    .C(_0183_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0210_));
 sky130_fd_sc_hd__o31a_2 _0637_ (.A1(_0187_),
    .A2(_0198_),
    .A3(_0210_),
    .B1(_0195_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0211_));
 sky130_fd_sc_hd__nand2_2 _0638_ (.A(_0151_),
    .B(_0167_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0212_));
 sky130_fd_sc_hd__o22a_2 _0639_ (.A1(_0046_),
    .A2(_0171_),
    .B1(_0183_),
    .B2(_0168_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0213_));
 sky130_fd_sc_hd__o22a_2 _0640_ (.A1(_0186_),
    .A2(_0212_),
    .B1(_0213_),
    .B2(_0047_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0214_));
 sky130_fd_sc_hd__and2b_2 _0641_ (.A_N(_0214_),
    .B(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0215_));
 sky130_fd_sc_hd__or3_2 _0642_ (.A(_0200_),
    .B(_0211_),
    .C(_0215_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0005_));
 sky130_fd_sc_hd__o21a_2 _0643_ (.A1(_0151_),
    .A2(_0163_),
    .B1(_0201_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0216_));
 sky130_fd_sc_hd__or3_2 _0644_ (.A(_0043_),
    .B(_0044_),
    .C(_0042_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0217_));
 sky130_fd_sc_hd__a31o_2 _0645_ (.A1(_0045_),
    .A2(_0196_),
    .A3(_0217_),
    .B1(_0216_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0218_));
 sky130_fd_sc_hd__nor2_2 _0646_ (.A(_0153_),
    .B(_0192_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0219_));
 sky130_fd_sc_hd__nor2_2 _0647_ (.A(_0046_),
    .B(_0219_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0220_));
 sky130_fd_sc_hd__mux2_1 _0648_ (.A0(_0046_),
    .A1(_0220_),
    .S(_0218_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0221_));
 sky130_fd_sc_hd__o211a_2 _0649_ (.A1(_0156_),
    .A2(_0166_),
    .B1(net10),
    .C1(_0221_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0222_));
 sky130_fd_sc_hd__and2_2 _0650_ (.A(_0181_),
    .B(_0187_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0016_));
 sky130_fd_sc_hd__a31o_2 _0651_ (.A1(_0159_),
    .A2(_0181_),
    .A3(_0219_),
    .B1(_0016_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0223_));
 sky130_fd_sc_hd__or3_2 _0652_ (.A(_0200_),
    .B(_0222_),
    .C(_0223_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0006_));
 sky130_fd_sc_hd__nand2_2 _0653_ (.A(_0047_),
    .B(_0218_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0224_));
 sky130_fd_sc_hd__a32o_2 _0654_ (.A1(_0170_),
    .A2(_0178_),
    .A3(_0224_),
    .B1(_0194_),
    .B2(_0177_),
    ...
    .VPWR(VPWR),
    .X(_0225_));
 sky130_fd_sc_hd__or2_2 _0655_ (.A(_0223_),
    .B(_0225_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0007_));
 sky130_fd_sc_hd__nand2_2 _0656_ (.A(_0045_),
    .B(_0212_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0226_));
 sky130_fd_sc_hd__a31o_2 _0657_ (.A1(_0146_),
    .A2(_0150_),
    .A3(_0166_),
    .B1(_0149_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0227_));
 sky130_fd_sc_hd__a22o_2 _0658_ (.A1(_0047_),
    .A2(_0226_),
    .B1(_0227_),
    .B2(_0157_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0228_));
 sky130_fd_sc_hd__nand2_2 _0659_ (.A(_0178_),
    .B(_0228_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0229_));
 sky130_fd_sc_hd__and2_2 _0660_ (.A(_0181_),
    .B(_0185_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0015_));
 sky130_fd_sc_hd__or2_2 _0661_ (.A(_0188_),
    .B(_0015_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0230_));
 sky130_fd_sc_hd__a311o_2 _0662_ (.A1(_0166_),
    .A2(net10),
    .A3(_0185_),
    .B1(_0016_),
    .C1(_0230_),
    ...
    .VPWR(VPWR),
    .X(_0231_));
 sky130_fd_sc_hd__o21bai_2 _0663_ (.A1(_0216_),
    .A2(_0229_),
    .B1_N(_0231_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0008_));
 sky130_fd_sc_hd__a211o_2 _0664_ (.A1(net10),
    .A2(_0185_),
    .B1(_0200_),
    .C1(_0230_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0001_));
 sky130_fd_sc_hd__a211o_2 _0665_ (.A1(net10),
    .A2(_0187_),
    .B1(_0016_),
    .C1(_0001_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0009_));
 sky130_fd_sc_hd__o31a_2 _0666_ (.A1(_0046_),
    .A2(net10),
    .A3(_0181_),
    .B1(_0187_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0002_));
 sky130_fd_sc_hd__a21oi_2 _0667_ (.A1(_0183_),
    .A2(_0186_),
    .B1(_0196_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0232_));
 sky130_fd_sc_hd__and2_2 _0668_ (.A(net10),
    .B(_0232_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0013_));
 sky130_fd_sc_hd__o221a_2 _0669_ (.A1(_0166_),
    .A2(_0207_),
    .B1(_0232_),
    .B2(_0169_),
    .C1(_0178_),
    ...
    .VPWR(VPWR),
    .X(_0014_));
 sky130_fd_sc_hd__nand2_2 _0670_ (.A(net1),
    .B(_0111_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0233_));
 sky130_fd_sc_hd__nor3_2 _0671_ (.A(\state[4] ),
    .B(\state[0] ),
    .C(_0233_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0234_));
 sky130_fd_sc_hd__a22o_2 _0672_ (.A1(net35),
    .A2(_0233_),
    .B1(_0234_),
    .B2(_0140_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0017_));
 sky130_fd_sc_hd__or2_2 _0673_ (.A(\acc.reg_q[0] ),
    .B(_0109_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0235_));
 sky130_fd_sc_hd__o211a_2 _0674_ (.A1(net42),
    .A2(_0108_),
    .B1(_0235_),
    .C1(net21),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0018_));
 sky130_fd_sc_hd__or2_2 _0675_ (.A(\acc.reg_q[1] ),
    .B(_0109_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0236_));
 sky130_fd_sc_hd__o211a_2 _0676_ (.A1(net40),
    .A2(_0108_),
    .B1(_0236_),
    .C1(net21),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0019_));
 sky130_fd_sc_hd__or2_2 _0677_ (.A(\acc.reg_q[2] ),
    .B(_0109_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0237_));
 sky130_fd_sc_hd__o211a_2 _0678_ (.A1(net36),
    .A2(_0108_),
    .B1(_0237_),
    .C1(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0020_));
 sky130_fd_sc_hd__or2_2 _0679_ (.A(\acc.reg_q[3] ),
    .B(_0109_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0238_));
 sky130_fd_sc_hd__o211a_2 _0680_ (.A1(net44),
    .A2(_0108_),
    .B1(_0238_),
    .C1(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0021_));
 sky130_fd_sc_hd__or2_2 _0681_ (.A(\acc.reg_q[4] ),
    .B(_0109_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0239_));
 sky130_fd_sc_hd__o211a_2 _0682_ (.A1(net41),
    .A2(_0108_),
    .B1(_0239_),
    .C1(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0022_));
 sky130_fd_sc_hd__or2_2 _0683_ (.A(\acc.reg_q[5] ),
    .B(_0109_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0240_));
 sky130_fd_sc_hd__o211a_2 _0684_ (.A1(net39),
    .A2(_0108_),
    .B1(_0240_),
    .C1(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0023_));
 sky130_fd_sc_hd__or2_2 _0685_ (.A(\acc.reg_q[6] ),
    .B(_0109_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0241_));
 sky130_fd_sc_hd__o211a_2 _0686_ (.A1(net51),
    .A2(_0108_),
    .B1(_0241_),
    .C1(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0024_));
 sky130_fd_sc_hd__or2_2 _0687_ (.A(\acc.reg_q[7] ),
    .B(_0109_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0242_));
 sky130_fd_sc_hd__o211a_2 _0688_ (.A1(net50),
    .A2(_0108_),
    .B1(_0242_),
    .C1(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0025_));
 sky130_fd_sc_hd__and3_2 _0689_ (.A(net14),
    .B(_0112_),
    .C(_0116_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0243_));
 sky130_fd_sc_hd__a221o_2 _0690_ (.A1(\multiplexer.c[7] ),
    .A2(_0117_),
    .B1(_0243_),
    .B2(\immediate[7] ),
    .C1(_0118_),
    ...
    .VPWR(VPWR),
    .X(_0244_));
 sky130_fd_sc_hd__o21a_2 _0691_ (.A1(\acc.reg_q[7] ),
    .A2(_0113_),
    .B1(_0244_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0245_));
 sky130_fd_sc_hd__inv_2 _0692_ (.A(_0245_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0246_));
 sky130_fd_sc_hd__and2_2 _0693_ (.A(\alu_unit.A[7] ),
    .B(_0246_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0247_));
 sky130_fd_sc_hd__xnor2_2 _0694_ (.A(\alu_unit.A[7] ),
    .B(_0245_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0248_));
 sky130_fd_sc_hd__a22o_2 _0695_ (.A1(\acc.reg_q[6] ),
    .A2(_0118_),
    .B1(_0243_),
    .B2(\immediate[6] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0249_));
 sky130_fd_sc_hd__a31o_2 _0696_ (.A1(\multiplexer.c[6] ),
    .A2(_0113_),
    .A3(_0115_),
    .B1(_0249_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0250_));
 sky130_fd_sc_hd__nor2_2 _0697_ (.A(_0087_),
    .B(_0250_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0251_));
 sky130_fd_sc_hd__or2_2 _0698_ (.A(\alu_unit.A[6] ),
    .B(_0250_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0252_));
 sky130_fd_sc_hd__inv_2 _0699_ (.A(_0252_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0253_));
 sky130_fd_sc_hd__nand2_2 _0700_ (.A(\alu_unit.A[6] ),
    .B(_0250_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0254_));
 sky130_fd_sc_hd__nand2_2 _0701_ (.A(_0252_),
    .B(_0254_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0255_));
 sky130_fd_sc_hd__a221o_2 _0702_ (.A1(\multiplexer.c[5] ),
    .A2(_0117_),
    .B1(_0243_),
    .B2(\immediate[5] ),
    .C1(_0118_),
    ...
    .VPWR(VPWR),
    .X(_0256_));
 sky130_fd_sc_hd__o21a_2 _0703_ (.A1(\acc.reg_q[5] ),
    .A2(_0113_),
    .B1(_0256_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0257_));
 sky130_fd_sc_hd__and2b_2 _0704_ (.A_N(_0257_),
    .B(\alu_unit.A[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0258_));
 sky130_fd_sc_hd__or2_2 _0705_ (.A(\alu_unit.A[5] ),
    .B(_0257_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0259_));
 sky130_fd_sc_hd__and2_2 _0706_ (.A(\alu_unit.A[5] ),
    .B(_0257_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0260_));
 sky130_fd_sc_hd__nand2_2 _0707_ (.A(\alu_unit.A[5] ),
    .B(_0257_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0261_));
 sky130_fd_sc_hd__nand2_2 _0708_ (.A(_0259_),
    .B(_0261_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0262_));
 sky130_fd_sc_hd__and4_2 _0709_ (.A(\multiplexer.c[4] ),
    .B(net14),
    .C(_0112_),
    .D(_0115_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0263_));
 sky130_fd_sc_hd__a221o_2 _0710_ (.A1(\acc.reg_q[4] ),
    .A2(_0118_),
    .B1(_0243_),
    .B2(\immediate[4] ),
    .C1(_0263_),
    ...
    .VPWR(VPWR),
    .X(_0264_));
 sky130_fd_sc_hd__inv_2 _0711_ (.A(_0264_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0265_));
 sky130_fd_sc_hd__or2_2 _0712_ (.A(\alu_unit.A[4] ),
    .B(_0264_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0266_));
 sky130_fd_sc_hd__nand2_2 _0713_ (.A(\alu_unit.A[4] ),
    .B(_0264_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0267_));
 sky130_fd_sc_hd__inv_2 _0714_ (.A(_0267_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0268_));
 sky130_fd_sc_hd__nand2_2 _0715_ (.A(_0266_),
    .B(_0267_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0269_));
 sky130_fd_sc_hd__inv_2 _0716_ (.A(_0269_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0270_));
 sky130_fd_sc_hd__and4_2 _0717_ (.A(\multiplexer.c[3] ),
    .B(net14),
    .C(_0112_),
    .D(_0115_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0271_));
 sky130_fd_sc_hd__a221o_2 _0718_ (.A1(\acc.reg_q[3] ),
    .A2(_0118_),
    .B1(_0243_),
    .B2(\immediate[3] ),
    .C1(_0271_),
    ...
    .VPWR(VPWR),
    .X(_0272_));
 sky130_fd_sc_hd__nor2_2 _0719_ (.A(\alu_unit.A[3] ),
    .B(_0272_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0273_));
 sky130_fd_sc_hd__nand2_2 _0720_ (.A(\alu_unit.A[3] ),
    .B(_0272_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0274_));
 sky130_fd_sc_hd__xnor2_2 _0721_ (.A(_0089_),
    .B(_0272_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0275_));
 sky130_fd_sc_hd__and4_2 _0722_ (.A(\multiplexer.c[2] ),
    .B(net14),
    .C(_0112_),
    .D(_0115_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0276_));
 sky130_fd_sc_hd__a221o_2 _0723_ (.A1(\acc.reg_q[2] ),
    .A2(_0118_),
    .B1(_0243_),
    .B2(\immediate[2] ),
    .C1(_0276_),
    ...
    .VPWR(VPWR),
    .X(_0277_));
 sky130_fd_sc_hd__or2_2 _0724_ (.A(\alu_unit.A[2] ),
    .B(_0277_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0278_));
 sky130_fd_sc_hd__and2_2 _0725_ (.A(\alu_unit.A[2] ),
    .B(_0277_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0279_));
 sky130_fd_sc_hd__xnor2_2 _0726_ (.A(_0090_),
    .B(_0277_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0280_));
 sky130_fd_sc_hd__or2_2 _0727_ (.A(_0275_),
    .B(_0280_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0281_));
 sky130_fd_sc_hd__and4_2 _0728_ (.A(\multiplexer.c[1] ),
    .B(net14),
    .C(_0112_),
    .D(_0115_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0282_));
 sky130_fd_sc_hd__a221o_2 _0729_ (.A1(\acc.reg_q[1] ),
    .A2(_0118_),
    .B1(_0243_),
    .B2(\immediate[1] ),
    .C1(_0282_),
    ...
    .VPWR(VPWR),
    .X(_0283_));
 sky130_fd_sc_hd__nor2_2 _0730_ (.A(_0091_),
    .B(_0283_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0284_));
 sky130_fd_sc_hd__and2_2 _0731_ (.A(\alu_unit.A[1] ),
    .B(_0283_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0285_));
 sky130_fd_sc_hd__or2_2 _0732_ (.A(\alu_unit.A[1] ),
    .B(_0283_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0286_));
 sky130_fd_sc_hd__xnor2_2 _0733_ (.A(\alu_unit.A[1] ),
    .B(_0283_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0287_));
 sky130_fd_sc_hd__o21ai_2 _0734_ (.A1(net16),
    .A2(_0115_),
    .B1(\acc.reg_q[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0288_));
 sky130_fd_sc_hd__and4b_2 _0735_ (.A_N(\multiplexer.c[0] ),
    .B(_0102_),
    .C(_0112_),
    .D(_0115_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0289_));
 sky130_fd_sc_hd__a221oi_4 _0736_ (.A1(_0092_),
    .A2(_0243_),
    .B1(_0288_),
    .B2(_0114_),
    .C1(_0289_),
    ...
    .VPWR(VPWR),
    .Y(_0290_));
 sky130_fd_sc_hd__nand2b_2 _0737_ (.A_N(\alu_unit.A[0] ),
    .B(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0291_));
 sky130_fd_sc_hd__a21oi_2 _0738_ (.A1(_0287_),
    .A2(_0291_),
    .B1(_0284_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0292_));
 sky130_fd_sc_hd__or2_2 _0739_ (.A(_0090_),
    .B(_0277_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0293_));
 sky130_fd_sc_hd__or2_2 _0740_ (.A(_0275_),
    .B(_0293_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0294_));
 sky130_fd_sc_hd__o221a_2 _0741_ (.A1(_0089_),
    .A2(_0272_),
    .B1(_0281_),
    .B2(_0292_),
    .C1(_0294_),
    ...
    .VPWR(VPWR),
    .X(_0295_));
 sky130_fd_sc_hd__or2_2 _0742_ (.A(_0088_),
    .B(_0264_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0296_));
 sky130_fd_sc_hd__o21ai_2 _0743_ (.A1(_0270_),
    .A2(_0295_),
    .B1(_0296_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0297_));
 sky130_fd_sc_hd__a21o_2 _0744_ (.A1(_0262_),
    .A2(_0297_),
    .B1(_0258_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0298_));
 sky130_fd_sc_hd__a21o_2 _0745_ (.A1(_0255_),
    .A2(_0298_),
    .B1(_0251_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0299_));
 sky130_fd_sc_hd__a21o_2 _0746_ (.A1(_0248_),
    .A2(_0299_),
    .B1(_0247_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0300_));
 sky130_fd_sc_hd__and4_2 _0747_ (.A(_0255_),
    .B(_0262_),
    .C(_0269_),
    .D(_0287_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0301_));
 sky130_fd_sc_hd__nor2_2 _0748_ (.A(\alu_unit.A[0] ),
    .B(_0290_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0302_));
 sky130_fd_sc_hd__and2_2 _0749_ (.A(\alu_unit.A[0] ),
    .B(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0303_));
 sky130_fd_sc_hd__or2_2 _0750_ (.A(_0302_),
    .B(_0303_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0304_));
 sky130_fd_sc_hd__and4b_2 _0751_ (.A_N(_0281_),
    .B(_0301_),
    .C(_0304_),
    .D(_0248_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0305_));
 sky130_fd_sc_hd__inv_2 _0752_ (.A(_0305_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0306_));
 sky130_fd_sc_hd__nor2_2 _0753_ (.A(_0126_),
    .B(_0127_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0307_));
 sky130_fd_sc_hd__or2_2 _0754_ (.A(_0126_),
    .B(_0127_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0308_));
 sky130_fd_sc_hd__or4bb_2 _0755_ (.A(_0075_),
    .B(net15),
    .C_N(net18),
    .D_N(_0076_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0309_));
 sky130_fd_sc_hd__nor3_2 _0756_ (.A(_0130_),
    .B(_0300_),
    .C(_0309_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0310_));
 sky130_fd_sc_hd__nand2_2 _0757_ (.A(net13),
    .B(_0246_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0311_));
 sky130_fd_sc_hd__or4_2 _0758_ (.A(_0250_),
    .B(_0257_),
    .C(_0264_),
    .D(_0290_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0312_));
 sky130_fd_sc_hd__or4_2 _0759_ (.A(_0272_),
    .B(_0277_),
    .C(_0283_),
    .D(_0312_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0313_));
 sky130_fd_sc_hd__or4_2 _0760_ (.A(\alu_unit.A[7] ),
    .B(\alu_unit.A[6] ),
    .C(\alu_unit.A[5] ),
    .D(\alu_unit.A[4] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0314_));
 sky130_fd_sc_hd__or4_2 _0761_ (.A(\alu_unit.A[2] ),
    .B(\alu_unit.A[1] ),
    .C(\alu_unit.A[0] ),
    .D(_0314_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0315_));
 sky130_fd_sc_hd__or3_2 _0762_ (.A(\alu_unit.A[3] ),
    .B(net13),
    .C(_0315_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0316_));
 sky130_fd_sc_hd__o21ai_2 _0763_ (.A1(_0311_),
    .A2(_0313_),
    .B1(_0316_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0317_));
 sky130_fd_sc_hd__nand2_2 _0764_ (.A(_0125_),
    .B(_0127_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0318_));
 sky130_fd_sc_hd__nor2_2 _0765_ (.A(_0125_),
    .B(_0128_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0319_));
 sky130_fd_sc_hd__or2_2 _0766_ (.A(_0125_),
    .B(_0128_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0320_));
 sky130_fd_sc_hd__a32o_2 _0767_ (.A1(_0125_),
    .A2(_0127_),
    .A3(_0317_),
    .B1(_0319_),
    .B2(_0305_),
    ...
    .VPWR(VPWR),
    .X(_0321_));
 sky130_fd_sc_hd__nor2_2 _0768_ (.A(_0131_),
    .B(_0317_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0322_));
 sky130_fd_sc_hd__or2_2 _0769_ (.A(_0122_),
    .B(_0123_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0323_));
 sky130_fd_sc_hd__or2_2 _0770_ (.A(_0130_),
    .B(_0323_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0324_));
 sky130_fd_sc_hd__inv_2 _0771_ (.A(_0324_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0325_));
 sky130_fd_sc_hd__nor2_2 _0772_ (.A(_0318_),
    .B(_0323_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0326_));
 sky130_fd_sc_hd__nor2_2 _0773_ (.A(_0308_),
    .B(_0309_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0327_));
 sky130_fd_sc_hd__nor2_2 _0774_ (.A(_0308_),
    .B(_0323_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0328_));
 sky130_fd_sc_hd__and3b_2 _0775_ (.A_N(_0326_),
    .B(_0121_),
    .C(_0324_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0329_));
 sky130_fd_sc_hd__inv_2 _0776_ (.A(_0329_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0330_));
 sky130_fd_sc_hd__and3_2 _0777_ (.A(_0121_),
    .B(_0123_),
    .C(_0129_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0331_));
 sky130_fd_sc_hd__or4_2 _0778_ (.A(_0319_),
    .B(_0328_),
    .C(_0330_),
    .D(_0331_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0332_));
 sky130_fd_sc_hd__nor2_2 _0779_ (.A(_0309_),
    .B(_0320_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0333_));
 sky130_fd_sc_hd__mux2_1 _0780_ (.A0(\alu_unit.A[0] ),
    .A1(net12),
    .S(_0135_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0334_));
 sky130_fd_sc_hd__nor2_2 _0781_ (.A(_0320_),
    .B(_0323_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0335_));
 sky130_fd_sc_hd__mux2_1 _0782_ (.A0(\alu_unit.A[1] ),
    .A1(_0283_),
    .S(net13),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0336_));
 sky130_fd_sc_hd__nor2_2 _0783_ (.A(_0309_),
    .B(_0318_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0337_));
 sky130_fd_sc_hd__a22o_2 _0784_ (.A1(_0303_),
    .A2(_0328_),
    .B1(_0335_),
    .B2(_0336_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0338_));
 sky130_fd_sc_hd__a2bb2o_2 _0785_ (.A1_N(_0303_),
    .A2_N(_0324_),
    .B1(_0327_),
    .B2(net12),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0339_));
 sky130_fd_sc_hd__o21ba_2 _0786_ (.A1(_0326_),
    .A2(_0339_),
    .B1_N(_0302_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0340_));
 sky130_fd_sc_hd__mux2_1 _0787_ (.A0(_0333_),
    .A1(_0337_),
    .S(_0334_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0341_));
 sky130_fd_sc_hd__or4b_2 _0788_ (.A(_0338_),
    .B(_0340_),
    .C(_0341_),
    .D_N(_0332_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0342_));
 sky130_fd_sc_hd__a211o_2 _0789_ (.A1(_0124_),
    .A2(_0321_),
    .B1(_0322_),
    .C1(_0342_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0343_));
 sky130_fd_sc_hd__a41o_2 _0790_ (.A1(_0124_),
    .A2(_0300_),
    .A3(_0306_),
    .A4(_0307_),
    .B1(_0343_),
    ...
    .VPWR(VPWR),
    .X(_0344_));
 sky130_fd_sc_hd__nand2b_2 _0791_ (.A_N(_0332_),
    .B(_0304_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0345_));
 sky130_fd_sc_hd__o211a_2 _0792_ (.A1(_0310_),
    .A2(_0344_),
    .B1(_0345_),
    .C1(net19),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0026_));
 sky130_fd_sc_hd__xnor2_2 _0793_ (.A(_0287_),
    .B(_0303_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0346_));
 sky130_fd_sc_hd__or3b_2 _0794_ (.A(_0122_),
    .B(_0308_),
    .C_N(_0123_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0347_));
 sky130_fd_sc_hd__inv_2 _0795_ (.A(_0347_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0348_));
 sky130_fd_sc_hd__a21oi_2 _0796_ (.A1(net12),
    .A2(_0347_),
    .B1(_0346_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0349_));
 sky130_fd_sc_hd__a311oi_2 _0797_ (.A1(net12),
    .A2(_0346_),
    .A3(_0347_),
    .B1(_0349_),
    .C1(_0332_),
    ...
    .VPWR(VPWR),
    .Y(_0350_));
 sky130_fd_sc_hd__mux2_1 _0798_ (.A0(\alu_unit.A[2] ),
    .A1(_0277_),
    .S(net13),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0351_));
 sky130_fd_sc_hd__a22o_2 _0799_ (.A1(_0285_),
    .A2(_0328_),
    .B1(_0335_),
    .B2(_0351_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0352_));
 sky130_fd_sc_hd__nor2_2 _0800_ (.A(_0287_),
    .B(_0324_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0353_));
 sky130_fd_sc_hd__mux2_1 _0801_ (.A0(_0333_),
    .A1(_0337_),
    .S(_0336_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0354_));
 sky130_fd_sc_hd__a221o_2 _0802_ (.A1(_0286_),
    .A2(_0326_),
    .B1(_0327_),
    .B2(_0283_),
    .C1(_0353_),
    ...
    .VPWR(VPWR),
    .X(_0355_));
 sky130_fd_sc_hd__a211o_2 _0803_ (.A1(_0331_),
    .A2(_0334_),
    .B1(_0350_),
    .C1(_0352_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0356_));
 sky130_fd_sc_hd__o31a_2 _0804_ (.A1(_0354_),
    .A2(_0355_),
    .A3(_0356_),
    .B1(net25),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0027_));
 sky130_fd_sc_hd__a21o_2 _0805_ (.A1(_0286_),
    .A2(_0303_),
    .B1(_0285_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0357_));
 sky130_fd_sc_hd__mux2_1 _0806_ (.A0(_0292_),
    .A1(_0357_),
    .S(_0348_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0358_));
 sky130_fd_sc_hd__a21oi_2 _0807_ (.A1(_0280_),
    .A2(_0358_),
    .B1(_0332_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0359_));
 sky130_fd_sc_hd__o21a_2 _0808_ (.A1(_0280_),
    .A2(_0358_),
    .B1(_0359_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0360_));
 sky130_fd_sc_hd__mux2_1 _0809_ (.A0(\alu_unit.A[3] ),
    .A1(_0272_),
    .S(net13),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0361_));
 sky130_fd_sc_hd__mux2_1 _0810_ (.A0(_0333_),
    .A1(_0337_),
    .S(_0351_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0362_));
 sky130_fd_sc_hd__a221o_2 _0811_ (.A1(_0278_),
    .A2(_0326_),
    .B1(_0327_),
    .B2(_0277_),
    .C1(_0362_),
    ...
    .VPWR(VPWR),
    .X(_0363_));
 sky130_fd_sc_hd__a22o_2 _0812_ (.A1(_0279_),
    .A2(_0328_),
    .B1(_0335_),
    .B2(_0361_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0364_));
 sky130_fd_sc_hd__a221o_2 _0813_ (.A1(_0280_),
    .A2(_0325_),
    .B1(_0331_),
    .B2(_0336_),
    .C1(_0364_),
    ...
    .VPWR(VPWR),
    .X(_0365_));
 sky130_fd_sc_hd__o31a_2 _0814_ (.A1(_0360_),
    .A2(_0363_),
    .A3(_0365_),
    .B1(net19),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0028_));
 sky130_fd_sc_hd__o21ai_2 _0815_ (.A1(_0279_),
    .A2(_0357_),
    .B1(_0278_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0366_));
 sky130_fd_sc_hd__o21ai_2 _0816_ (.A1(_0280_),
    .A2(_0292_),
    .B1(_0293_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0367_));
 sky130_fd_sc_hd__mux2_1 _0817_ (.A0(_0366_),
    .A1(_0367_),
    .S(_0347_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0368_));
 sky130_fd_sc_hd__xor2_2 _0818_ (.A(_0275_),
    .B(_0368_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0369_));
 sky130_fd_sc_hd__nor2_2 _0819_ (.A(_0332_),
    .B(_0369_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0370_));
 sky130_fd_sc_hd__a21oi_2 _0820_ (.A1(_0272_),
    .A2(_0327_),
    .B1(_0326_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0371_));
 sky130_fd_sc_hd__nor2_2 _0821_ (.A(_0273_),
    .B(_0371_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0372_));
 sky130_fd_sc_hd__a31o_2 _0822_ (.A1(\alu_unit.A[3] ),
    .A2(_0272_),
    .A3(_0328_),
    .B1(_0372_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0373_));
 sky130_fd_sc_hd__mux2_1 _0823_ (.A0(_0333_),
    .A1(_0337_),
    .S(_0361_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0374_));
 sky130_fd_sc_hd__mux2_1 _0824_ (.A0(\alu_unit.A[4] ),
    .A1(_0264_),
    .S(net13),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0375_));
 sky130_fd_sc_hd__a221o_2 _0825_ (.A1(_0275_),
    .A2(_0325_),
    .B1(_0335_),
    .B2(_0375_),
    .C1(_0374_),
    ...
    .VPWR(VPWR),
    .X(_0376_));
 sky130_fd_sc_hd__a211o_2 _0826_ (.A1(_0331_),
    .A2(_0351_),
    .B1(_0373_),
    .C1(_0376_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0377_));
 sky130_fd_sc_hd__o21a_2 _0827_ (.A1(_0370_),
    .A2(_0377_),
    .B1(net19),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0029_));
 sky130_fd_sc_hd__a211o_2 _0828_ (.A1(_0274_),
    .A2(_0366_),
    .B1(_0347_),
    .C1(_0273_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0378_));
 sky130_fd_sc_hd__a21bo_2 _0829_ (.A1(_0295_),
    .A2(_0347_),
    .B1_N(_0378_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0379_));
 sky130_fd_sc_hd__a21oi_2 _0830_ (.A1(_0270_),
    .A2(_0379_),
    .B1(_0332_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0380_));
 sky130_fd_sc_hd__o21a_2 _0831_ (.A1(_0270_),
    .A2(_0379_),
    .B1(_0380_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0381_));
 sky130_fd_sc_hd__mux2_1 _0832_ (.A0(_0333_),
    .A1(_0337_),
    .S(_0375_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0382_));
 sky130_fd_sc_hd__mux2_1 _0833_ (.A0(\alu_unit.A[5] ),
    .A1(_0257_),
    .S(net13),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0383_));
 sky130_fd_sc_hd__a221o_2 _0834_ (.A1(_0266_),
    .A2(_0326_),
    .B1(_0327_),
    .B2(_0264_),
    .C1(_0382_),
    ...
    .VPWR(VPWR),
    .X(_0384_));
 sky130_fd_sc_hd__a22o_2 _0835_ (.A1(_0331_),
    .A2(_0361_),
    .B1(_0383_),
    .B2(_0335_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0385_));
 sky130_fd_sc_hd__a221o_2 _0836_ (.A1(_0270_),
    .A2(_0325_),
    .B1(_0328_),
    .B2(_0268_),
    .C1(_0385_),
    ...
    .VPWR(VPWR),
    .X(_0386_));
 sky130_fd_sc_hd__o31a_2 _0837_ (.A1(_0381_),
    .A2(_0384_),
    .A3(_0386_),
    .B1(net19),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0030_));
 sky130_fd_sc_hd__a221oi_2 _0838_ (.A1(_0088_),
    .A2(_0265_),
    .B1(_0274_),
    .B2(_0366_),
    .C1(_0273_),
    ...
    .VPWR(VPWR),
    .Y(_0387_));
 sky130_fd_sc_hd__nand2_2 _0839_ (.A(_0297_),
    .B(_0347_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0388_));
 sky130_fd_sc_hd__o31ai_2 _0840_ (.A1(_0268_),
    .A2(_0347_),
    .A3(_0387_),
    .B1(_0388_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0389_));
 sky130_fd_sc_hd__o21bai_2 _0841_ (.A1(_0262_),
    .A2(_0389_),
    .B1_N(_0332_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0390_));
 sky130_fd_sc_hd__a21oi_2 _0842_ (.A1(_0262_),
    .A2(_0389_),
    .B1(_0390_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0391_));
 sky130_fd_sc_hd__mux2_1 _0843_ (.A0(\alu_unit.A[6] ),
    .A1(_0250_),
    .S(net13),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0392_));
 sky130_fd_sc_hd__nor2_2 _0844_ (.A(_0262_),
    .B(_0324_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0393_));
 sky130_fd_sc_hd__a221o_2 _0845_ (.A1(_0331_),
    .A2(_0375_),
    .B1(_0392_),
    .B2(_0335_),
    .C1(_0393_),
    ...
    .VPWR(VPWR),
    .X(_0394_));
 sky130_fd_sc_hd__mux2_1 _0846_ (.A0(_0333_),
    .A1(_0337_),
    .S(_0383_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0395_));
 sky130_fd_sc_hd__a21o_2 _0847_ (.A1(_0257_),
    .A2(_0327_),
    .B1(_0326_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0396_));
 sky130_fd_sc_hd__a221o_2 _0848_ (.A1(_0260_),
    .A2(_0328_),
    .B1(_0396_),
    .B2(_0259_),
    .C1(_0395_),
    ...
    .VPWR(VPWR),
    .X(_0397_));
 sky130_fd_sc_hd__o31a_2 _0849_ (.A1(_0391_),
    .A2(_0394_),
    .A3(_0397_),
    .B1(net19),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0031_));
 sky130_fd_sc_hd__o31ai_2 _0850_ (.A1(_0260_),
    .A2(_0268_),
    .A3(_0387_),
    .B1(_0259_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0398_));
 sky130_fd_sc_hd__mux2_1 _0851_ (.A0(_0298_),
    .A1(_0398_),
    .S(_0348_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0399_));
 sky130_fd_sc_hd__a21oi_2 _0852_ (.A1(_0255_),
    .A2(_0399_),
    .B1(_0332_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0400_));
 sky130_fd_sc_hd__o21a_2 _0853_ (.A1(_0255_),
    .A2(_0399_),
    .B1(_0400_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0401_));
 sky130_fd_sc_hd__o21a_2 _0854_ (.A1(\alu_unit.A[7] ),
    .A2(net13),
    .B1(_0311_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0402_));
 sky130_fd_sc_hd__a22o_2 _0855_ (.A1(_0331_),
    .A2(_0383_),
    .B1(_0402_),
    .B2(_0335_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0403_));
 sky130_fd_sc_hd__nor2_2 _0856_ (.A(_0255_),
    .B(_0324_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0404_));
 sky130_fd_sc_hd__mux2_1 _0857_ (.A0(_0333_),
    .A1(_0337_),
    .S(_0392_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0405_));
 sky130_fd_sc_hd__a221o_2 _0858_ (.A1(_0252_),
    .A2(_0326_),
    .B1(_0327_),
    .B2(_0250_),
    .C1(_0405_),
    ...
    .VPWR(VPWR),
    .X(_0406_));
 sky130_fd_sc_hd__a311o_2 _0859_ (.A1(\alu_unit.A[6] ),
    .A2(_0250_),
    .A3(_0328_),
    .B1(_0403_),
    .C1(_0404_),
    ...
    .VPWR(VPWR),
    .X(_0407_));
 sky130_fd_sc_hd__o31a_2 _0860_ (.A1(_0401_),
    .A2(_0406_),
    .A3(_0407_),
    .B1(net19),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0032_));
 sky130_fd_sc_hd__a211o_2 _0861_ (.A1(_0254_),
    .A2(_0398_),
    .B1(_0347_),
    .C1(_0253_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0408_));
 sky130_fd_sc_hd__a211o_2 _0862_ (.A1(_0255_),
    .A2(_0298_),
    .B1(_0348_),
    .C1(_0251_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0409_));
 sky130_fd_sc_hd__and3_2 _0863_ (.A(_0248_),
    .B(_0408_),
    .C(_0409_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0410_));
 sky130_fd_sc_hd__a21oi_2 _0864_ (.A1(_0408_),
    .A2(_0409_),
    .B1(_0248_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0411_));
 sky130_fd_sc_hd__nor2_2 _0865_ (.A(_0248_),
    .B(_0324_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0412_));
 sky130_fd_sc_hd__mux2_1 _0866_ (.A0(_0333_),
    .A1(_0337_),
    .S(_0402_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0413_));
 sky130_fd_sc_hd__o21a_2 _0867_ (.A1(\alu_unit.A[7] ),
    .A2(_0245_),
    .B1(_0326_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0414_));
 sky130_fd_sc_hd__a2111o_2 _0868_ (.A1(_0245_),
    .A2(_0327_),
    .B1(_0329_),
    .C1(_0412_),
    .D1(_0414_),
    ...
    .VPWR(VPWR),
    .X(_0415_));
 sky130_fd_sc_hd__a31o_2 _0869_ (.A1(\alu_unit.A[7] ),
    .A2(_0245_),
    .A3(_0328_),
    .B1(_0330_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0416_));
 sky130_fd_sc_hd__o21a_2 _0870_ (.A1(_0413_),
    .A2(_0415_),
    .B1(_0416_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0417_));
 sky130_fd_sc_hd__a21oi_2 _0871_ (.A1(_0331_),
    .A2(_0392_),
    .B1(_0417_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0418_));
 sky130_fd_sc_hd__o31a_2 _0872_ (.A1(_0332_),
    .A2(_0410_),
    .A3(_0411_),
    .B1(_0418_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0419_));
 sky130_fd_sc_hd__nor2_2 _0873_ (.A(_0093_),
    .B(_0419_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0033_));
 sky130_fd_sc_hd__or2_2 _0874_ (.A(net2),
    .B(_0133_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0420_));
 sky130_fd_sc_hd__o211a_2 _0875_ (.A1(net57),
    .A2(_0134_),
    .B1(_0420_),
    .C1(net23),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0034_));
 sky130_fd_sc_hd__or2_2 _0876_ (.A(net3),
    .B(_0133_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0421_));
 sky130_fd_sc_hd__o211a_2 _0877_ (.A1(\immediate[1] ),
    .A2(_0134_),
    .B1(_0421_),
    .C1(net23),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0035_));
 sky130_fd_sc_hd__or2_2 _0878_ (.A(net4),
    .B(_0133_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0422_));
 sky130_fd_sc_hd__o211a_2 _0879_ (.A1(\immediate[2] ),
    .A2(_0134_),
    .B1(_0422_),
    .C1(net23),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0036_));
 sky130_fd_sc_hd__or2_2 _0880_ (.A(net5),
    .B(_0133_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0423_));
 sky130_fd_sc_hd__o211a_2 _0881_ (.A1(\immediate[3] ),
    .A2(_0134_),
    .B1(_0423_),
    .C1(net24),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0037_));
 sky130_fd_sc_hd__or2_2 _0882_ (.A(net6),
    .B(_0133_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0424_));
 sky130_fd_sc_hd__o211a_2 _0883_ (.A1(\immediate[4] ),
    .A2(_0134_),
    .B1(_0424_),
    .C1(net23),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0038_));
 sky130_fd_sc_hd__or2_2 _0884_ (.A(net7),
    .B(_0133_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0425_));
 sky130_fd_sc_hd__o211a_2 _0885_ (.A1(\immediate[5] ),
    .A2(_0134_),
    .B1(_0425_),
    .C1(net23),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0039_));
 sky130_fd_sc_hd__or2_2 _0886_ (.A(net8),
    .B(_0133_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0426_));
 sky130_fd_sc_hd__o211a_2 _0887_ (.A1(net55),
    .A2(_0134_),
    .B1(_0426_),
    .C1(net23),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0040_));
 sky130_fd_sc_hd__or2_2 _0888_ (.A(net9),
    .B(_0133_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0427_));
 sky130_fd_sc_hd__o211a_2 _0889_ (.A1(net54),
    .A2(_0134_),
    .B1(_0427_),
    .C1(net23),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0041_));
 sky130_fd_sc_hd__or4_2 _0890_ (.A(\acc.uio_in[5] ),
    .B(\acc.uio_in[4] ),
    .C(\acc.uio_in[3] ),
    .D(\acc.uio_in[2] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0428_));
 sky130_fd_sc_hd__nor3_2 _0891_ (.A(\acc.uio_in[7] ),
    .B(\acc.uio_in[6] ),
    .C(_0428_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0429_));
 sky130_fd_sc_hd__and4b_2 _0892_ (.A_N(\acc.uio_in[1] ),
    .B(\acc.uio_in[0] ),
    .C(branch),
    .D(_0429_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0430_));
 sky130_fd_sc_hd__and2b_2 _0893_ (.A_N(branch),
    .B(send_ins),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0431_));
 sky130_fd_sc_hd__nor2_2 _0894_ (.A(_0430_),
    .B(_0431_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0432_));
 sky130_fd_sc_hd__mux2_1 _0895_ (.A0(_0431_),
    .A1(_0432_),
    .S(uio_out[0]),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0433_));
 sky130_fd_sc_hd__a21oi_2 _0896_ (.A1(net52),
    .A2(_0430_),
    .B1(_0433_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0434_));
 sky130_fd_sc_hd__nor2_2 _0897_ (.A(_0093_),
    .B(_0434_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0050_));
 sky130_fd_sc_hd__o21ai_2 _0898_ (.A1(uio_out[1]),
    .A2(uio_out[0]),
    .B1(_0431_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0435_));
 sky130_fd_sc_hd__a21oi_2 _0899_ (.A1(uio_out[1]),
    .A2(uio_out[0]),
    .B1(_0435_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0436_));
 sky130_fd_sc_hd__a22o_2 _0900_ (.A1(\immediate[1] ),
    .A2(_0430_),
    .B1(_0432_),
    .B2(uio_out[1]),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0437_));
 sky130_fd_sc_hd__o21a_2 _0901_ (.A1(_0436_),
    .A2(_0437_),
    .B1(net21),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0051_));
 sky130_fd_sc_hd__nand3_2 _0902_ (.A(uio_out[2]),
    .B(uio_out[1]),
    .C(uio_out[0]),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0438_));
 sky130_fd_sc_hd__a21o_2 _0903_ (.A1(uio_out[1]),
    .A2(uio_out[0]),
    .B1(uio_out[2]),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0439_));
 sky130_fd_sc_hd__a32o_2 _0904_ (.A1(_0431_),
    .A2(_0438_),
    .A3(_0439_),
    .B1(_0430_),
    .B2(\immediate[2] ),
    ...
    .VPWR(VPWR),
    .X(_0440_));
 sky130_fd_sc_hd__a21oi_2 _0905_ (.A1(uio_out[2]),
    .A2(_0432_),
    .B1(_0440_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0441_));
 sky130_fd_sc_hd__nor2_2 _0906_ (.A(_0093_),
    .B(_0441_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0052_));
 sky130_fd_sc_hd__and4_2 _0907_ (.A(uio_out[3]),
    .B(uio_out[2]),
    .C(uio_out[1]),
    .D(uio_out[0]),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0442_));
 sky130_fd_sc_hd__a31o_2 _0908_ (.A1(uio_out[2]),
    .A2(uio_out[1]),
    .A3(uio_out[0]),
    .B1(uio_out[3]),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0443_));
 sky130_fd_sc_hd__and3b_2 _0909_ (.A_N(_0442_),
    .B(_0443_),
    .C(_0431_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0444_));
 sky130_fd_sc_hd__a221o_2 _0910_ (.A1(\immediate[3] ),
    .A2(_0430_),
    .B1(_0432_),
    .B2(uio_out[3]),
    .C1(_0444_),
    ...
    .VPWR(VPWR),
    .X(_0445_));
 sky130_fd_sc_hd__and2_2 _0911_ (.A(net21),
    .B(_0445_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0053_));
 sky130_fd_sc_hd__nand2_2 _0912_ (.A(uio_out[4]),
    .B(_0442_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0446_));
 sky130_fd_sc_hd__or2_2 _0913_ (.A(uio_out[4]),
    .B(_0442_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0447_));
 sky130_fd_sc_hd__a32o_2 _0914_ (.A1(_0431_),
    .A2(_0446_),
    .A3(_0447_),
    .B1(_0430_),
    .B2(\immediate[4] ),
    ...
    .VPWR(VPWR),
    .X(_0448_));
 sky130_fd_sc_hd__a21oi_2 _0915_ (.A1(uio_out[4]),
    .A2(_0432_),
    .B1(_0448_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0449_));
 sky130_fd_sc_hd__nor2_2 _0916_ (.A(_0093_),
    .B(_0449_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0054_));
 sky130_fd_sc_hd__xnor2_2 _0917_ (.A(uio_out[5]),
    .B(_0446_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0450_));
 sky130_fd_sc_hd__a22o_2 _0918_ (.A1(\immediate[5] ),
    .A2(_0430_),
    .B1(_0431_),
    .B2(_0450_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0451_));
 sky130_fd_sc_hd__a21oi_2 _0919_ (.A1(uio_out[5]),
    .A2(_0432_),
    .B1(_0451_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0452_));
 sky130_fd_sc_hd__nor2_2 _0920_ (.A(_0093_),
    .B(_0452_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0055_));
 sky130_fd_sc_hd__and2_2 _0921_ (.A(_0105_),
    .B(_0107_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0453_));
 sky130_fd_sc_hd__nand2_2 _0922_ (.A(_0105_),
    .B(_0107_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0454_));
 sky130_fd_sc_hd__nor2_2 _0923_ (.A(_0092_),
    .B(_0139_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0455_));
 sky130_fd_sc_hd__a211o_2 _0924_ (.A1(\acc.reg_q[0] ),
    .A2(_0139_),
    .B1(_0454_),
    .C1(_0455_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0456_));
 sky130_fd_sc_hd__o211a_2 _0925_ (.A1(\alu_unit.A[0] ),
    .A2(_0453_),
    .B1(_0456_),
    .C1(net25),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0056_));
 sky130_fd_sc_hd__mux2_1 _0926_ (.A0(\immediate[1] ),
    .A1(\acc.reg_q[1] ),
    .S(_0139_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0457_));
 sky130_fd_sc_hd__or2_2 _0927_ (.A(_0454_),
    .B(_0457_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0458_));
 sky130_fd_sc_hd__o211a_2 _0928_ (.A1(\alu_unit.A[1] ),
    .A2(_0453_),
    .B1(_0458_),
    .C1(net19),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0057_));
 sky130_fd_sc_hd__mux2_1 _0929_ (.A0(\immediate[2] ),
    .A1(\acc.reg_q[2] ),
    .S(_0139_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0459_));
 sky130_fd_sc_hd__or2_2 _0930_ (.A(_0454_),
    .B(_0459_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0460_));
 sky130_fd_sc_hd__o211a_2 _0931_ (.A1(net56),
    .A2(_0453_),
    .B1(_0460_),
    .C1(net22),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0058_));
 sky130_fd_sc_hd__mux2_1 _0932_ (.A0(\immediate[3] ),
    .A1(\acc.reg_q[3] ),
    .S(_0139_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0461_));
 sky130_fd_sc_hd__or2_2 _0933_ (.A(_0454_),
    .B(_0461_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0462_));
 sky130_fd_sc_hd__o211a_2 _0934_ (.A1(\alu_unit.A[3] ),
    .A2(_0453_),
    .B1(_0462_),
    .C1(net22),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0059_));
 sky130_fd_sc_hd__mux2_1 _0935_ (.A0(\immediate[4] ),
    .A1(\acc.reg_q[4] ),
    .S(_0139_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0463_));
 sky130_fd_sc_hd__or2_2 _0936_ (.A(_0454_),
    .B(_0463_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0464_));
 sky130_fd_sc_hd__o211a_2 _0937_ (.A1(\alu_unit.A[4] ),
    .A2(_0453_),
    .B1(_0464_),
    .C1(net19),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0060_));
 sky130_fd_sc_hd__mux2_1 _0938_ (.A0(\immediate[5] ),
    .A1(\acc.reg_q[5] ),
    .S(_0139_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0465_));
 sky130_fd_sc_hd__or2_2 _0939_ (.A(_0454_),
    .B(_0465_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0466_));
 sky130_fd_sc_hd__o211a_2 _0940_ (.A1(\alu_unit.A[5] ),
    .A2(_0453_),
    .B1(_0466_),
    .C1(net19),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0061_));
 sky130_fd_sc_hd__mux2_1 _0941_ (.A0(\immediate[6] ),
    .A1(\acc.reg_q[6] ),
    .S(_0139_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0467_));
 sky130_fd_sc_hd__or2_2 _0942_ (.A(_0454_),
    .B(_0467_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0468_));
 sky130_fd_sc_hd__o211a_2 _0943_ (.A1(\alu_unit.A[6] ),
    .A2(_0453_),
    .B1(_0468_),
    .C1(net19),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0062_));
 sky130_fd_sc_hd__mux2_1 _0944_ (.A0(\immediate[7] ),
    .A1(\acc.reg_q[7] ),
    .S(_0139_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0469_));
 sky130_fd_sc_hd__or2_2 _0945_ (.A(_0454_),
    .B(_0469_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0470_));
 sky130_fd_sc_hd__o211a_2 _0946_ (.A1(\alu_unit.A[7] ),
    .A2(_0453_),
    .B1(_0470_),
    .C1(net22),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0063_));
 sky130_fd_sc_hd__and3_2 _0947_ (.A(_0084_),
    .B(_0104_),
    .C(_0106_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0471_));
 sky130_fd_sc_hd__nand3_2 _0948_ (.A(_0084_),
    .B(_0104_),
    .C(_0106_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0472_));
 sky130_fd_sc_hd__nor2_2 _0949_ (.A(_0092_),
    .B(_0138_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0473_));
 sky130_fd_sc_hd__a211o_2 _0950_ (.A1(\acc.reg_q[0] ),
    .A2(_0138_),
    .B1(_0472_),
    .C1(_0473_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0474_));
 sky130_fd_sc_hd__o211a_2 _0951_ (.A1(net38),
    .A2(_0471_),
    .B1(_0474_),
    .C1(net21),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0064_));
 sky130_fd_sc_hd__mux2_1 _0952_ (.A0(\immediate[1] ),
    .A1(\acc.reg_q[1] ),
    .S(_0138_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0475_));
 sky130_fd_sc_hd__or2_2 _0953_ (.A(_0472_),
    .B(_0475_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0476_));
 sky130_fd_sc_hd__o211a_2 _0954_ (.A1(net37),
    .A2(_0471_),
    .B1(_0476_),
    .C1(net21),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0065_));
 sky130_fd_sc_hd__mux2_1 _0955_ (.A0(\immediate[2] ),
    .A1(\acc.reg_q[2] ),
    .S(_0138_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0477_));
 sky130_fd_sc_hd__or2_2 _0956_ (.A(_0472_),
    .B(_0477_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0478_));
 sky130_fd_sc_hd__o211a_2 _0957_ (.A1(net46),
    .A2(_0471_),
    .B1(_0478_),
    .C1(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0066_));
 sky130_fd_sc_hd__mux2_1 _0958_ (.A0(\immediate[3] ),
    .A1(\acc.reg_q[3] ),
    .S(_0138_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0479_));
 sky130_fd_sc_hd__or2_2 _0959_ (.A(_0472_),
    .B(_0479_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0480_));
 sky130_fd_sc_hd__o211a_2 _0960_ (.A1(net49),
    .A2(_0471_),
    .B1(_0480_),
    .C1(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0067_));
 sky130_fd_sc_hd__mux2_1 _0961_ (.A0(\immediate[4] ),
    .A1(\acc.reg_q[4] ),
    .S(_0138_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0481_));
 sky130_fd_sc_hd__or2_2 _0962_ (.A(_0472_),
    .B(_0481_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0482_));
 sky130_fd_sc_hd__o211a_2 _0963_ (.A1(net47),
    .A2(_0471_),
    .B1(_0482_),
    .C1(net21),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0068_));
 sky130_fd_sc_hd__mux2_1 _0964_ (.A0(\immediate[5] ),
    .A1(\acc.reg_q[5] ),
    .S(_0138_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0483_));
 sky130_fd_sc_hd__or2_2 _0965_ (.A(_0472_),
    .B(_0483_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0484_));
 sky130_fd_sc_hd__o211a_2 _0966_ (.A1(net48),
    .A2(_0471_),
    .B1(_0484_),
    .C1(net21),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0069_));
 sky130_fd_sc_hd__mux2_1 _0967_ (.A0(\immediate[6] ),
    .A1(\acc.reg_q[6] ),
    .S(_0138_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0485_));
 sky130_fd_sc_hd__or2_2 _0968_ (.A(_0472_),
    .B(_0485_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0486_));
 sky130_fd_sc_hd__o211a_2 _0969_ (.A1(net45),
    .A2(_0471_),
    .B1(_0486_),
    .C1(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0070_));
 sky130_fd_sc_hd__mux2_1 _0970_ (.A0(\immediate[7] ),
    .A1(\acc.reg_q[7] ),
    .S(_0138_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0487_));
 sky130_fd_sc_hd__or2_2 _0971_ (.A(_0472_),
    .B(_0487_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0488_));
 sky130_fd_sc_hd__o211a_2 _0972_ (.A1(net43),
    .A2(_0471_),
    .B1(_0488_),
    .C1(net21),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0071_));
 sky130_fd_sc_hd__or2_2 _0973_ (.A(\state[0] ),
    .B(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0072_));
 sky130_fd_sc_hd__dfxtp_2 _0974_ (.CLK(clknet_4_8_0_clk),
    .D(_0000_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(_0073_));
 sky130_fd_sc_hd__dfxtp_2 _0975_ (.CLK(clknet_4_8_0_clk),
    .D(_0003_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(_0074_));
 sky130_fd_sc_hd__dfxtp_2 _0976_ (.CLK(clknet_4_8_0_clk),
    .D(_0004_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(_0075_));
 sky130_fd_sc_hd__dfxtp_2 _0977_ (.CLK(clknet_4_8_0_clk),
    .D(_0005_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(_0076_));
 sky130_fd_sc_hd__dfxtp_2 _0978_ (.CLK(clknet_4_10_0_clk),
    .D(_0006_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(_0077_));
 sky130_fd_sc_hd__dfxtp_2 _0979_ (.CLK(clknet_4_10_0_clk),
    .D(_0007_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(_0078_));
 sky130_fd_sc_hd__dfxtp_2 _0980_ (.CLK(clknet_4_14_0_clk),
    .D(_0008_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(_0079_));
 sky130_fd_sc_hd__dfxtp_2 _0981_ (.CLK(clknet_4_9_0_clk),
    .D(_0009_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(_0082_));
 sky130_fd_sc_hd__dfxtp_2 _0982_ (.CLK(clknet_4_9_0_clk),
    .D(_0001_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(_0083_));
 sky130_fd_sc_hd__dfxtp_2 _0983_ (.CLK(clknet_4_9_0_clk),
    .D(_0002_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(_0084_));
 sky130_fd_sc_hd__dfxtp_2 _0984_ (.CLK(clknet_4_8_0_clk),
    .D(_0013_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(_0080_));
 sky130_fd_sc_hd__dfxtp_2 _0985_ (.CLK(clknet_4_9_0_clk),
    .D(_0014_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(_0081_));
 sky130_fd_sc_hd__dfxtp_2 _0986_ (.CLK(clknet_4_9_0_clk),
    .D(_0015_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(_0085_));
 sky130_fd_sc_hd__dfxtp_2 _0987_ (.CLK(clknet_4_10_0_clk),
    .D(_0016_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(_0086_));
 sky130_fd_sc_hd__dfxtp_2 _0988_ (.CLK(clknet_4_11_0_clk),
    .D(_0017_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(branch));
 sky130_fd_sc_hd__dfxtp_2 _0989_ (.CLK(clknet_4_3_0_clk),
    .D(_0018_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\acc.reg_q[0] ));
 sky130_fd_sc_hd__dfxtp_2 _0990_ (.CLK(clknet_4_3_0_clk),
    .D(_0019_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\acc.reg_q[1] ));
 sky130_fd_sc_hd__dfxtp_2 _0991_ (.CLK(clknet_4_1_0_clk),
    .D(_0020_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\acc.reg_q[2] ));
 sky130_fd_sc_hd__dfxtp_2 _0992_ (.CLK(clknet_4_1_0_clk),
    .D(_0021_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\acc.reg_q[3] ));
 sky130_fd_sc_hd__dfxtp_2 _0993_ (.CLK(clknet_4_4_0_clk),
    .D(_0022_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\acc.reg_q[4] ));
 sky130_fd_sc_hd__dfxtp_2 _0994_ (.CLK(clknet_4_1_0_clk),
    .D(_0023_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\acc.reg_q[5] ));
 sky130_fd_sc_hd__dfxtp_2 _0995_ (.CLK(clknet_4_4_0_clk),
    .D(_0024_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\acc.reg_q[6] ));
 sky130_fd_sc_hd__dfxtp_2 _0996_ (.CLK(clknet_4_4_0_clk),
    .D(_0025_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\acc.reg_q[7] ));
 sky130_fd_sc_hd__dfxtp_2 _0997_ (.CLK(clknet_4_2_0_clk),
    .D(_0026_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\acc.uio_in[0] ));
 sky130_fd_sc_hd__dfxtp_2 _0998_ (.CLK(clknet_4_3_0_clk),
    .D(_0027_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\acc.uio_in[1] ));
 sky130_fd_sc_hd__dfxtp_2 _0999_ (.CLK(clknet_4_0_0_clk),
    .D(_0028_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\acc.uio_in[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1000_ (.CLK(clknet_4_2_0_clk),
    .D(_0029_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\acc.uio_in[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1001_ (.CLK(clknet_4_0_0_clk),
    .D(_0030_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\acc.uio_in[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1002_ (.CLK(clknet_4_0_0_clk),
    .D(_0031_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\acc.uio_in[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1003_ (.CLK(clknet_4_0_0_clk),
    .D(_0032_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\acc.uio_in[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1004_ (.CLK(clknet_4_4_0_clk),
    .D(_0033_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\acc.uio_in[7] ));
 sky130_fd_sc_hd__dfxtp_2 _1005_ (.CLK(clknet_4_13_0_clk),
    .D(_0034_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1008_ (.CLK(clknet_4_13_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\immediate[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1009_ (.CLK(clknet_4_12_0_clk),
    .D(_0038_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\immediate[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1010_ (.CLK(clknet_4_15_0_clk),
    .D(_0039_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\immediate[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1011_ (.CLK(clknet_4_15_0_clk),
    .D(_0040_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\immediate[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1012_ (.CLK(clknet_4_15_0_clk),
    .D(_0041_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\immediate[7] ));
 sky130_fd_sc_hd__dfxtp_2 _1013_ (.CLK(clknet_4_14_0_clk),
    .D(_0042_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\instruction[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1014_ (.CLK(clknet_4_14_0_clk),
    .D(_0043_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\instruction[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1015_ (.CLK(clknet_4_15_0_clk),
    .D(_0044_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\instruction[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1016_ (.CLK(clknet_4_14_0_clk),
    .D(_0045_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1017_ (.CLK(clknet_4_10_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\instruction[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1018_ (.CLK(clknet_4_14_0_clk),
    .D(_0047_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\instruction[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1019_ (.CLK(clknet_4_11_0_clk),
    .D(_0048_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\instruction[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1020_ (.CLK(clknet_4_10_0_clk),
    .D(_0049_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1022_ (.CLK(clknet_4_7_0_clk),
    ...
    .VPWR(VPWR),
    .Q(uio_out[1]));
 sky130_fd_sc_hd__dfxtp_2 _1023_ (.CLK(clknet_4_5_0_clk),
    .D(_0052_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1024_ (.CLK(clknet_4_7_0_clk),
    ...
    .VPWR(VPWR),
    .Q(uio_out[3]));
 sky130_fd_sc_hd__dfxtp_2 _1025_ (.CLK(clknet_4_5_0_clk),
    .D(_0054_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uio_out[4]));
 sky130_fd_sc_hd__dfxtp_2 _1026_ (.CLK(clknet_4_5_0_clk),
    .D(_0055_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1029_ (.CLK(clknet_4_2_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\alu_unit.A[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1030_ (.CLK(clknet_4_6_0_clk),
    .D(_0059_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\alu_unit.A[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1031_ (.CLK(clknet_4_1_0_clk),
    .D(_0060_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\alu_unit.A[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1032_ (.CLK(clknet_4_0_0_clk),
    .D(_0061_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\alu_unit.A[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1033_ (.CLK(clknet_4_1_0_clk),
    .D(_0062_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\alu_unit.A[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1034_ (.CLK(clknet_4_2_0_clk),
    .D(_0063_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1035_ (.CLK(clknet_4_7_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\multiplexer.c[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1036_ (.CLK(clknet_4_6_0_clk),
    .D(_0065_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\multiplexer.c[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1037_ (.CLK(clknet_4_5_0_clk),
    .D(_0066_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\multiplexer.c[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1038_ (.CLK(clknet_4_5_0_clk),
    .D(_0067_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\multiplexer.c[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1039_ (.CLK(clknet_4_4_0_clk),
    .D(_0068_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\multiplexer.c[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1040_ (.CLK(clknet_4_6_0_clk),
    .D(_0069_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\multiplexer.c[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1041_ (.CLK(clknet_4_6_0_clk),
    .D(_0070_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\multiplexer.c[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1042_ (.CLK(clknet_4_6_0_clk),
    .D(_0071_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfrtp_2 _1043_ (.CLK(clknet_4_12_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\acc.rst_n ));
 sky130_fd_sc_hd__dfstp_2 _1044_ (.CLK(clknet_4_12_0_clk),
    .D(_0012_),
    .SET_B(net1),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\state[0] ));
 sky130_fd_sc_hd__dfrtp_2 _1045_ (.CLK(clknet_4_11_0_clk),
    .D(net34),
    .RESET_B(net1),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\state[1] ));
 sky130_fd_sc_hd__dfrtp_2 _1046_ (.CLK(clknet_4_12_0_clk),
    .D(_0010_),
    .RESET_B(net1),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\state[2] ));
 sky130_fd_sc_hd__dfrtp_2 _1047_ (.CLK(clknet_4_11_0_clk),
    .D(_0011_),
    .RESET_B(net1),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\state[3] ));
 sky130_fd_sc_hd__dfrtp_2 _1048_ (.CLK(clknet_4_12_0_clk),
    .D(net33),
    .RESET_B(net1),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\state[4] ));
 sky130_fd_sc_hd__buf_2 _1057_ (.A(invalid_ins),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[6]));
 sky130_fd_sc_hd__buf_2 _1058_ (.A(send_ins),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 clkload2 (.A(clknet_4_11_0_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkbuf_4 clkload3 (.A(clknet_4_12_0_clk),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__clkbuf_4 clkload5 (.A(clknet_4_15_0_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout10 (.A(_0178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net10));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout11 (.A(_0045_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net11));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout13 (.A(_0135_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net13));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout14 (.A(_0102_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net14));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout15 (.A(_0101_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout17 (.A(net18),
    ...
    .VPWR(VPWR),
    .X(net17));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout18 (.A(\state[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout21 (.A(net22),
    ...
    .VPWR(VPWR),
    .X(net21));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout22 (.A(\acc.rst_n ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout24 (.A(net25),
    ...
    .VPWR(VPWR),
    .X(net24));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout25 (.A(\acc.rst_n ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net25));
 sky130_fd_sc_hd__dlygate4sd3_1 hold33 (.A(\state[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net33));
 sky130_fd_sc_hd__dlygate4sd3_1 hold34 (.A(\state[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net34));
 sky130_fd_sc_hd__dlygate4sd3_1 hold35 (.A(branch),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net35));
 sky130_fd_sc_hd__dlygate4sd3_1 hold36 (.A(\acc.uio_in[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net36));
 sky130_fd_sc_hd__dlygate4sd3_1 hold37 (.A(\multiplexer.c[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net37));
 sky130_fd_sc_hd__dlygate4sd3_1 hold38 (.A(\multiplexer.c[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net38));
 sky130_fd_sc_hd__dlygate4sd3_1 hold39 (.A(\acc.uio_in[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net39));
 sky130_fd_sc_hd__dlygate4sd3_1 hold40 (.A(\acc.uio_in[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net40));
 sky130_fd_sc_hd__dlygate4sd3_1 hold41 (.A(\acc.uio_in[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net41));
 sky130_fd_sc_hd__dlygate4sd3_1 hold42 (.A(\acc.uio_in[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net42));
 sky130_fd_sc_hd__dlygate4sd3_1 hold43 (.A(\multiplexer.c[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net43));
 sky130_fd_sc_hd__dlygate4sd3_1 hold44 (.A(\acc.uio_in[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net44));
 sky130_fd_sc_hd__dlygate4sd3_1 hold45 (.A(\multiplexer.c[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net45));
 sky130_fd_sc_hd__dlygate4sd3_1 hold46 (.A(\multiplexer.c[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net46));
 sky130_fd_sc_hd__dlygate4sd3_1 hold47 (.A(\multiplexer.c[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net47));
 sky130_fd_sc_hd__dlygate4sd3_1 hold48 (.A(\multiplexer.c[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net48));
 sky130_fd_sc_hd__dlygate4sd3_1 hold49 (.A(\multiplexer.c[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net49));
 sky130_fd_sc_hd__dlygate4sd3_1 hold50 (.A(\acc.uio_in[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net50));
 sky130_fd_sc_hd__dlygate4sd3_1 hold51 (.A(\acc.uio_in[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net51));
 sky130_fd_sc_hd__dlygate4sd3_1 hold52 (.A(\immediate[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold53 (.A(\state[3] ),
    ...
    .VPWR(VPWR),
    .X(net53));
 sky130_fd_sc_hd__dlygate4sd3_1 hold54 (.A(\immediate[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net54));
 sky130_fd_sc_hd__dlygate4sd3_1 hold55 (.A(\immediate[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net55));
 sky130_fd_sc_hd__dlygate4sd3_1 hold56 (.A(\alu_unit.A[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net56));
 sky130_fd_sc_hd__dlygate4sd3_1 hold57 (.A(\immediate[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 input9 (.A(ui_in[7]),
    ...
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__clkbuf_2 max_cap12 (.A(_0290_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net12));
 sky130_fd_sc_hd__buf_1 max_cap16 (.A(_0101_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net16));
 sky130_fd_sc_hd__conb_1 tt_um_8_bit_cpu (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net));
 sky130_fd_sc_hd__conb_1 tt_um_8_bit_cpu_26 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net26));
 sky130_fd_sc_hd__conb_1 tt_um_8_bit_cpu_27 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net27));
 sky130_fd_sc_hd__conb_1 tt_um_8_bit_cpu_28 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net28));
 sky130_fd_sc_hd__conb_1 tt_um_8_bit_cpu_29 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net29));
 sky130_fd_sc_hd__conb_1 tt_um_8_bit_cpu_30 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net30));
 sky130_fd_sc_hd__conb_1 tt_um_8_bit_cpu_31 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net31));
 sky130_fd_sc_hd__conb_1 tt_um_8_bit_cpu_32 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net32));
