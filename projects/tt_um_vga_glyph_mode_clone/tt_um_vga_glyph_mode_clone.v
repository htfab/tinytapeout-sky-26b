module tt_um_vga_glyph_mode_clone (clk,
    ena,
    rst_n,
    VPWR,
    VGND,
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA_1 (.DIODE(\b[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_137 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _0662_ (.A(\g_x[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0641_));
 sky130_fd_sc_hd__inv_2 _0663_ (.A(\frame[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0002_));
 sky130_fd_sc_hd__inv_2 _0664_ (.A(net43),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _0665_ (.A(net42),
    ...
    .VPWR(VPWR),
    .Y(_0643_));
 sky130_fd_sc_hd__inv_2 _0666_ (.A(\hvsync_gen.vpos[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0644_));
 sky130_fd_sc_hd__inv_2 _0667_ (.A(\hvsync_gen.vpos[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0645_));
 sky130_fd_sc_hd__inv_2 _0668_ (.A(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0646_));
 sky130_fd_sc_hd__inv_2 _0669_ (.A(net37),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0647_));
 sky130_fd_sc_hd__inv_2 _0670_ (.A(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0648_));
 sky130_fd_sc_hd__inv_2 _0671_ (.A(net38),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0649_));
 sky130_fd_sc_hd__inv_2 _0672_ (.A(\g_x[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0650_));
 sky130_fd_sc_hd__inv_2 _0673_ (.A(\g_x[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0651_));
 sky130_fd_sc_hd__inv_2 _0674_ (.A(\hpos[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0652_));
 sky130_fd_sc_hd__inv_2 _0675_ (.A(\hpos[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0653_));
 sky130_fd_sc_hd__or2_2 _0676_ (.A(net4),
    .B(net42),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0654_));
 sky130_fd_sc_hd__nor2_2 _0677_ (.A(_0642_),
    .B(_0643_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0655_));
 sky130_fd_sc_hd__nand2_2 _0678_ (.A(net43),
    .B(net42),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0656_));
 sky130_fd_sc_hd__nand2_2 _0679_ (.A(net41),
    .B(net40),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0657_));
 sky130_fd_sc_hd__a22o_2 _0680_ (.A1(\hvsync_gen.vpos[7] ),
    .A2(net41),
    .B1(_0655_),
    .B2(net23),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0658_));
 sky130_fd_sc_hd__nand2_2 _0681_ (.A(_0642_),
    .B(net42),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0659_));
 sky130_fd_sc_hd__a22o_2 _0682_ (.A1(\hvsync_gen.vpos[5] ),
    .A2(net41),
    .B1(net20),
    ...
    .VPWR(VPWR),
    .X(_0660_));
 sky130_fd_sc_hd__or2_2 _0683_ (.A(\hvsync_gen.vpos[5] ),
    .B(net41),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0661_));
 sky130_fd_sc_hd__a21o_2 _0684_ (.A1(_0660_),
    .A2(_0661_),
    .B1(_0658_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0034_));
 sky130_fd_sc_hd__or2_2 _0685_ (.A(net43),
    .B(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0035_));
 sky130_fd_sc_hd__a21oi_2 _0686_ (.A1(net43),
    .A2(net24),
    .B1(net42),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0036_));
 sky130_fd_sc_hd__nor2_2 _0687_ (.A(_0642_),
    .B(net5),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0037_));
 sky130_fd_sc_hd__a22o_2 _0688_ (.A1(net42),
    .A2(net24),
    .B1(_0035_),
    .B2(_0036_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0038_));
 sky130_fd_sc_hd__a221o_2 _0689_ (.A1(net43),
    .A2(net24),
    .B1(_0038_),
    .B2(net25),
    .C1(_0034_),
    ...
    .VPWR(VPWR),
    .X(_0039_));
 sky130_fd_sc_hd__nor2_2 _0690_ (.A(net27),
    .B(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0040_));
 sky130_fd_sc_hd__or2_2 _0691_ (.A(net27),
    .B(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0041_));
 sky130_fd_sc_hd__o2bb2a_2 _0692_ (.A1_N(net25),
    .A2_N(net20),
    .B1(_0040_),
    .B2(_0643_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0042_));
 sky130_fd_sc_hd__and2_2 _0693_ (.A(net27),
    .B(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0043_));
 sky130_fd_sc_hd__o221a_2 _0694_ (.A1(\hvsync_gen.vpos[2] ),
    .A2(net20),
    .B1(_0043_),
    .B2(net42),
    .C1(_0042_),
    ...
    .VPWR(VPWR),
    .X(_0044_));
 sky130_fd_sc_hd__a21bo_2 _0695_ (.A1(_0038_),
    .A2(_0044_),
    .B1_N(_0039_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0045_));
 sky130_fd_sc_hd__or2_2 _0696_ (.A(net25),
    .B(_0043_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0046_));
 sky130_fd_sc_hd__o211a_2 _0697_ (.A1(net26),
    .A2(net41),
    .B1(net40),
    .C1(_0041_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0047_));
 sky130_fd_sc_hd__o22a_2 _0698_ (.A1(net43),
    .A2(net24),
    .B1(_0046_),
    .B2(_0047_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0048_));
 sky130_fd_sc_hd__a211o_2 _0699_ (.A1(net43),
    .A2(net24),
    .B1(_0034_),
    .C1(_0048_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0049_));
 sky130_fd_sc_hd__a21bo_2 _0700_ (.A1(net68),
    .A2(net40),
    .B1_N(net41),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0050_));
 sky130_fd_sc_hd__nor2_2 _0701_ (.A(net68),
    .B(net40),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0051_));
 sky130_fd_sc_hd__and2b_2 _0702_ (.A_N(\hvsync_gen.vpos[8] ),
    .B(\hvsync_gen.vpos[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0052_));
 sky130_fd_sc_hd__a21bo_2 _0703_ (.A1(net68),
    .A2(net40),
    .B1_N(net74),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0053_));
 sky130_fd_sc_hd__nand2_2 _0704_ (.A(net41),
    .B(_0053_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0054_));
 sky130_fd_sc_hd__and2b_2 _0705_ (.A_N(\hvsync_gen.vpos[9] ),
    .B(\hvsync_gen.vpos[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0055_));
 sky130_fd_sc_hd__o221a_2 _0706_ (.A1(net68),
    .A2(net40),
    .B1(net69),
    .B2(net41),
    .C1(_0054_),
    ...
    .VPWR(VPWR),
    .X(_0056_));
 sky130_fd_sc_hd__o22a_2 _0707_ (.A1(\hvsync_gen.vpos[7] ),
    .A2(net41),
    .B1(_0655_),
    .B2(net23),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0057_));
 sky130_fd_sc_hd__o22a_2 _0708_ (.A1(\hvsync_gen.vpos[5] ),
    .A2(net41),
    .B1(net20),
    .B2(\hvsync_gen.vpos[4] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0058_));
 sky130_fd_sc_hd__and4b_2 _0709_ (.A_N(_0660_),
    .B(_0056_),
    .C(_0057_),
    .D(_0058_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0059_));
 sky130_fd_sc_hd__and4b_2 _0710_ (.A_N(_0658_),
    .B(_0045_),
    .C(_0049_),
    .D(_0059_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0060_));
 sky130_fd_sc_hd__xor2_2 _0711_ (.A(_0657_),
    .B(_0060_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0001_));
 sky130_fd_sc_hd__a21bo_2 _0712_ (.A1(net4),
    .A2(net31),
    .B1_N(_0654_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0061_));
 sky130_fd_sc_hd__nor2_2 _0713_ (.A(net31),
    .B(net36),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0062_));
 sky130_fd_sc_hd__or2_2 _0714_ (.A(net31),
    .B(net36),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0063_));
 sky130_fd_sc_hd__o221a_2 _0715_ (.A1(_0647_),
    .A2(net20),
    .B1(_0061_),
    .B2(net39),
    .C1(_0063_),
    ...
    .VPWR(VPWR),
    .X(_0064_));
 sky130_fd_sc_hd__or2_2 _0716_ (.A(net31),
    .B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0065_));
 sky130_fd_sc_hd__a31o_2 _0717_ (.A1(_0642_),
    .A2(net42),
    .A3(net36),
    .B1(net34),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0066_));
 sky130_fd_sc_hd__a221o_2 _0718_ (.A1(net29),
    .A2(_0654_),
    .B1(_0065_),
    .B2(_0066_),
    .C1(_0064_),
    ...
    .VPWR(VPWR),
    .X(_0067_));
 sky130_fd_sc_hd__o211a_2 _0719_ (.A1(net5),
    .A2(net34),
    .B1(net40),
    .C1(net31),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0068_));
 sky130_fd_sc_hd__o21ba_2 _0720_ (.A1(net31),
    .A2(net40),
    .B1_N(_0068_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0069_));
 sky130_fd_sc_hd__xnor2_2 _0721_ (.A(net29),
    .B(_0037_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0070_));
 sky130_fd_sc_hd__nand2_2 _0722_ (.A(net32),
    .B(net36),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0071_));
 sky130_fd_sc_hd__o221ai_2 _0723_ (.A1(_0643_),
    .A2(_0648_),
    .B1(_0649_),
    .B2(_0657_),
    .C1(_0071_),
    ...
    .VPWR(VPWR),
    .Y(_0072_));
 sky130_fd_sc_hd__or3b_2 _0724_ (.A(_0069_),
    .B(_0070_),
    .C_N(_0072_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0073_));
 sky130_fd_sc_hd__and3_2 _0725_ (.A(_0652_),
    .B(\hpos[9] ),
    .C(net40),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0074_));
 sky130_fd_sc_hd__a21o_2 _0726_ (.A1(\hpos[10] ),
    .A2(_0655_),
    .B1(_0074_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0075_));
 sky130_fd_sc_hd__o221a_2 _0727_ (.A1(net29),
    .A2(_0654_),
    .B1(_0657_),
    .B2(net28),
    .C1(_0075_),
    ...
    .VPWR(VPWR),
    .X(_0076_));
 sky130_fd_sc_hd__o211ai_2 _0728_ (.A1(_0643_),
    .A2(net31),
    .B1(net29),
    .C1(net43),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0077_));
 sky130_fd_sc_hd__and4_2 _0729_ (.A(_0067_),
    .B(_0073_),
    .C(_0076_),
    .D(_0077_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0078_));
 sky130_fd_sc_hd__a21o_2 _0730_ (.A1(net42),
    .A2(\hpos[9] ),
    .B1(net28),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0079_));
 sky130_fd_sc_hd__a21bo_2 _0731_ (.A1(_0657_),
    .A2(_0079_),
    .B1_N(net20),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0080_));
 sky130_fd_sc_hd__mux2_1 _0732_ (.A0(_0659_),
    .A1(_0080_),
    .S(_0078_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0000_));
 sky130_fd_sc_hd__xor2_2 _0733_ (.A(\frame[0] ),
    .B(\frame[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0003_));
 sky130_fd_sc_hd__and3_2 _0734_ (.A(\frame[0] ),
    .B(\frame[1] ),
    .C(\frame[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0081_));
 sky130_fd_sc_hd__a21oi_2 _0735_ (.A1(\frame[0] ),
    .A2(\frame[1] ),
    .B1(\frame[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0082_));
 sky130_fd_sc_hd__nor2_2 _0736_ (.A(_0081_),
    .B(_0082_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0004_));
 sky130_fd_sc_hd__and2_2 _0737_ (.A(\frame[3] ),
    .B(_0081_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0083_));
 sky130_fd_sc_hd__nor2_2 _0738_ (.A(\frame[3] ),
    .B(_0081_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0084_));
 sky130_fd_sc_hd__nor2_2 _0739_ (.A(_0083_),
    .B(_0084_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0005_));
 sky130_fd_sc_hd__xor2_2 _0740_ (.A(\frame[4] ),
    .B(_0083_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0006_));
 sky130_fd_sc_hd__and3_2 _0741_ (.A(\frame[4] ),
    .B(\frame[5] ),
    .C(_0083_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0085_));
 sky130_fd_sc_hd__a21oi_2 _0742_ (.A1(\frame[4] ),
    .A2(_0083_),
    .B1(\frame[5] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0086_));
 sky130_fd_sc_hd__nor2_2 _0743_ (.A(_0085_),
    .B(_0086_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0007_));
 sky130_fd_sc_hd__xor2_2 _0744_ (.A(\frame[6] ),
    .B(_0085_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0008_));
 sky130_fd_sc_hd__and3_2 _0745_ (.A(\frame[6] ),
    .B(\frame[7] ),
    .C(_0085_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0087_));
 sky130_fd_sc_hd__a21oi_2 _0746_ (.A1(\frame[6] ),
    .A2(_0085_),
    .B1(\frame[7] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0088_));
 sky130_fd_sc_hd__nor2_2 _0747_ (.A(_0087_),
    .B(_0088_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0009_));
 sky130_fd_sc_hd__nand2_2 _0748_ (.A(\frame[8] ),
    .B(_0087_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0089_));
 sky130_fd_sc_hd__or2_2 _0749_ (.A(\frame[8] ),
    .B(_0087_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0090_));
 sky130_fd_sc_hd__and2_2 _0750_ (.A(_0089_),
    .B(_0090_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0010_));
 sky130_fd_sc_hd__xnor2_2 _0751_ (.A(\frame[9] ),
    .B(_0089_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0011_));
 sky130_fd_sc_hd__xnor2_2 _0752_ (.A(net75),
    .B(net67),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0091_));
 sky130_fd_sc_hd__mux2_4 _0753_ (.A0(_0052_),
    .A1(_0091_),
    .S(\hvsync_gen.vpos[7] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0092_));
 sky130_fd_sc_hd__nand2_2 _0754_ (.A(net22),
    .B(_0092_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0093_));
 sky130_fd_sc_hd__mux2_4 _0755_ (.A0(_0055_),
    .A1(_0052_),
    .S(\hvsync_gen.vpos[7] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0094_));
 sky130_fd_sc_hd__a21o_2 _0756_ (.A1(net22),
    .A2(_0092_),
    .B1(_0094_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0095_));
 sky130_fd_sc_hd__a21o_4 _0757_ (.A1(net22),
    .A2(_0094_),
    .B1(_0092_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0096_));
 sky130_fd_sc_hd__and3_4 _0758_ (.A(\hvsync_gen.vpos[5] ),
    .B(_0093_),
    .C(_0096_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0097_));
 sky130_fd_sc_hd__nor2_2 _0759_ (.A(net22),
    .B(net81),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0098_));
 sky130_fd_sc_hd__a21oi_2 _0760_ (.A1(net22),
    .A2(_0095_),
    .B1(_0098_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0099_));
 sky130_fd_sc_hd__a211oi_2 _0761_ (.A1(net22),
    .A2(_0095_),
    .B1(_0098_),
    .C1(_0644_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0100_));
 sky130_fd_sc_hd__a211o_2 _0762_ (.A1(net22),
    .A2(_0095_),
    .B1(_0098_),
    .C1(_0644_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0101_));
 sky130_fd_sc_hd__a21o_2 _0763_ (.A1(_0093_),
    .A2(_0096_),
    ...
    .VPWR(VPWR),
    .X(_0102_));
 sky130_fd_sc_hd__and3b_2 _0764_ (.A_N(net92),
    .B(_0101_),
    .C(_0102_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0103_));
 sky130_fd_sc_hd__or4b_4 _0765_ (.A(_0097_),
    .B(_0645_),
    .C(_0100_),
    .D_N(_0102_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0104_));
 sky130_fd_sc_hd__o21ai_2 _0766_ (.A1(net92),
    .A2(_0099_),
    .B1(_0101_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0105_));
 sky130_fd_sc_hd__nand2_2 _0767_ (.A(net65),
    .B(_0105_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0106_));
 sky130_fd_sc_hd__a21o_4 _0768_ (.A1(_0105_),
    .A2(_0104_),
    .B1(_0645_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0107_));
 sky130_fd_sc_hd__o21bai_2 _0769_ (.A1(_0645_),
    .A2(_0105_),
    .B1_N(_0103_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0108_));
 sky130_fd_sc_hd__and3_2 _0770_ (.A(net24),
    .B(net65),
    .C(_0108_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0109_));
 sky130_fd_sc_hd__nand2_2 _0771_ (.A(_0645_),
    .B(_0105_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0110_));
 sky130_fd_sc_hd__a32o_2 _0772_ (.A1(net24),
    .A2(_0110_),
    .A3(_0107_),
    .B1(_0108_),
    .B2(net65),
    ...
    .VPWR(VPWR),
    .X(_0111_));
 sky130_fd_sc_hd__xnor2_2 _0773_ (.A(_0111_),
    .B(_0646_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0112_));
 sky130_fd_sc_hd__a31o_2 _0774_ (.A1(_0646_),
    .A2(_0107_),
    .A3(_0110_),
    .B1(_0109_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0113_));
 sky130_fd_sc_hd__a21o_4 _0775_ (.A1(net25),
    .A2(_0112_),
    .B1(_0113_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0114_));
 sky130_fd_sc_hd__nand2_2 _0776_ (.A(net25),
    .B(net64),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0115_));
 sky130_fd_sc_hd__mux2_1 _0777_ (.A0(_0115_),
    .A1(net25),
    .S(net76),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0116_));
 sky130_fd_sc_hd__or2_2 _0778_ (.A(net26),
    .B(_0116_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0117_));
 sky130_fd_sc_hd__or2_2 _0779_ (.A(net27),
    .B(_0116_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0118_));
 sky130_fd_sc_hd__or2_2 _0780_ (.A(_0043_),
    .B(_0116_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0119_));
 sky130_fd_sc_hd__nor2_2 _0781_ (.A(_0043_),
    .B(_0116_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0120_));
 sky130_fd_sc_hd__o21a_2 _0782_ (.A1(net25),
    .A2(_0113_),
    .B1(_0115_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0121_));
 sky130_fd_sc_hd__o21ai_2 _0783_ (.A1(net25),
    .A2(_0113_),
    .B1(_0115_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0122_));
 sky130_fd_sc_hd__nand2_2 _0784_ (.A(net26),
    .B(_0116_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_2 _0785_ (.A(net14),
    ...
    .VPWR(VPWR),
    .X(_0124_));
 sky130_fd_sc_hd__and3_2 _0786_ (.A(_0119_),
    .B(net14),
    .C(_0123_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0125_));
 sky130_fd_sc_hd__nand2_2 _0787_ (.A(_0119_),
    .B(_0124_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0126_));
 sky130_fd_sc_hd__nand2_2 _0788_ (.A(net38),
    .B(net64),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0127_));
 sky130_fd_sc_hd__and2_4 _0789_ (.A(net37),
    .B(net63),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0128_));
 sky130_fd_sc_hd__nor2_2 _0790_ (.A(net37),
    .B(net63),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0129_));
 sky130_fd_sc_hd__nor2_4 _0791_ (.A(_0128_),
    .B(_0129_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0130_));
 sky130_fd_sc_hd__xor2_2 _0792_ (.A(_0127_),
    .B(_0130_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0131_));
 sky130_fd_sc_hd__a21o_2 _0793_ (.A1(\hvsync_gen.vpos[7] ),
    .A2(net69),
    .B1(_0052_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0132_));
 sky130_fd_sc_hd__nor2_2 _0794_ (.A(net28),
    .B(_0132_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0133_));
 sky130_fd_sc_hd__or2_2 _0795_ (.A(\b[3] ),
    .B(_0132_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0134_));
 sky130_fd_sc_hd__and2_2 _0796_ (.A(net30),
    .B(_0095_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0135_));
 sky130_fd_sc_hd__or2_2 _0797_ (.A(net30),
    .B(_0095_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0136_));
 sky130_fd_sc_hd__and2b_2 _0798_ (.A_N(_0135_),
    .B(_0136_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0137_));
 sky130_fd_sc_hd__a21o_2 _0799_ (.A1(_0093_),
    .A2(net91),
    .B1(_0100_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0138_));
 sky130_fd_sc_hd__or2_2 _0800_ (.A(net33),
    .B(_0138_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0139_));
 sky130_fd_sc_hd__nand2_2 _0801_ (.A(net33),
    .B(_0138_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_2 _0802_ (.A(net35),
    ...
    .VPWR(VPWR),
    .Y(_0141_));
 sky130_fd_sc_hd__inv_2 _0803_ (.A(_0141_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0142_));
 sky130_fd_sc_hd__a31o_4 _0804_ (.A1(net38),
    .A2(_0130_),
    .A3(_0114_),
    .B1(_0128_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0143_));
 sky130_fd_sc_hd__nor2_2 _0805_ (.A(net35),
    .B(_0106_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0144_));
 sky130_fd_sc_hd__nor2_2 _0806_ (.A(_0142_),
    .B(_0144_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0145_));
 sky130_fd_sc_hd__a21oi_2 _0807_ (.A1(net78),
    .A2(_0145_),
    .B1(_0142_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0146_));
 sky130_fd_sc_hd__a221o_2 _0808_ (.A1(net33),
    .A2(_0138_),
    .B1(_0145_),
    .B2(_0143_),
    .C1(_0142_),
    ...
    .VPWR(VPWR),
    .X(_0147_));
 sky130_fd_sc_hd__and3_4 _0809_ (.A(_0137_),
    .B(_0139_),
    .C(_0147_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0148_));
 sky130_fd_sc_hd__a31o_2 _0810_ (.A1(_0136_),
    .A2(_0139_),
    .A3(_0147_),
    .B1(_0135_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0149_));
 sky130_fd_sc_hd__and2_2 _0811_ (.A(\b[3] ),
    .B(_0132_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0150_));
 sky130_fd_sc_hd__a311o_2 _0812_ (.A1(_0147_),
    .A2(_0139_),
    .A3(_0137_),
    .B1(_0150_),
    .C1(_0135_),
    ...
    .VPWR(VPWR),
    .X(_0151_));
 sky130_fd_sc_hd__or3b_4 _0813_ (.A(_0653_),
    .B(_0133_),
    .C_N(_0151_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0152_));
 sky130_fd_sc_hd__a21o_4 _0814_ (.A1(_0151_),
    .A2(_0134_),
    .B1(\hpos[9] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0153_));
 sky130_fd_sc_hd__nand2_2 _0815_ (.A(_0152_),
    .B(net80),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0154_));
 sky130_fd_sc_hd__nor2_2 _0816_ (.A(_0133_),
    .B(_0150_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0155_));
 sky130_fd_sc_hd__xor2_2 _0817_ (.A(_0149_),
    .B(_0155_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0156_));
 sky130_fd_sc_hd__xnor2_2 _0818_ (.A(_0149_),
    .B(_0155_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0157_));
 sky130_fd_sc_hd__a21oi_2 _0819_ (.A1(_0139_),
    .A2(_0147_),
    .B1(_0137_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0158_));
 sky130_fd_sc_hd__or2_2 _0820_ (.A(_0148_),
    .B(_0158_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0159_));
 sky130_fd_sc_hd__nand2_2 _0821_ (.A(_0139_),
    .B(_0140_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0160_));
 sky130_fd_sc_hd__xnor2_2 _0822_ (.A(_0146_),
    .B(_0160_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0161_));
 sky130_fd_sc_hd__xnor2_2 _0823_ (.A(net78),
    .B(_0145_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0162_));
 sky130_fd_sc_hd__or2_2 _0824_ (.A(_0652_),
    .B(_0162_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0163_));
 sky130_fd_sc_hd__nor4_2 _0825_ (.A(_0148_),
    .B(_0158_),
    .C(_0161_),
    .D(_0163_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0164_));
 sky130_fd_sc_hd__and2_2 _0826_ (.A(_0156_),
    .B(_0164_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0165_));
 sky130_fd_sc_hd__and4_2 _0827_ (.A(_0152_),
    .B(_0153_),
    .C(_0156_),
    .D(_0164_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0166_));
 sky130_fd_sc_hd__inv_2 _0828_ (.A(_0166_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0167_));
 sky130_fd_sc_hd__xnor2_2 _0829_ (.A(_0652_),
    .B(net79),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0168_));
 sky130_fd_sc_hd__or2_2 _0830_ (.A(_0166_),
    .B(_0168_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0169_));
 sky130_fd_sc_hd__a41o_4 _0831_ (.A1(_0152_),
    .A2(_0153_),
    .A3(_0156_),
    .A4(_0164_),
    .B1(_0159_),
    ...
    .VPWR(VPWR),
    .X(_0170_));
 sky130_fd_sc_hd__or3_2 _0832_ (.A(_0131_),
    .B(_0161_),
    .C(_0162_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0171_));
 sky130_fd_sc_hd__or2_2 _0833_ (.A(net90),
    .B(_0171_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0172_));
 sky130_fd_sc_hd__nor2_2 _0834_ (.A(_0157_),
    .B(_0172_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0173_));
 sky130_fd_sc_hd__or4_4 _0835_ (.A(_0154_),
    .B(_0157_),
    .C(_0171_),
    .D(_0170_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0174_));
 sky130_fd_sc_hd__and2_2 _0836_ (.A(_0169_),
    .B(net83),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0175_));
 sky130_fd_sc_hd__a21oi_2 _0837_ (.A1(_0169_),
    .A2(net83),
    .B1(_0131_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0176_));
 sky130_fd_sc_hd__and3_4 _0838_ (.A(_0131_),
    .B(_0169_),
    .C(_0174_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0177_));
 sky130_fd_sc_hd__nor2_2 _0839_ (.A(_0176_),
    .B(net77),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0178_));
 sky130_fd_sc_hd__or2_2 _0840_ (.A(net38),
    .B(net64),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0179_));
 sky130_fd_sc_hd__and2_2 _0841_ (.A(_0127_),
    .B(_0179_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0180_));
 sky130_fd_sc_hd__inv_2 _0842_ (.A(_0180_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0181_));
 sky130_fd_sc_hd__or2_2 _0843_ (.A(_0162_),
    .B(_0166_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0182_));
 sky130_fd_sc_hd__a211o_2 _0844_ (.A1(_0169_),
    .A2(net83),
    .B1(_0182_),
    .C1(_0131_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0183_));
 sky130_fd_sc_hd__a21oi_2 _0845_ (.A1(_0167_),
    .A2(_0183_),
    .B1(_0161_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0184_));
 sky130_fd_sc_hd__a21oi_2 _0846_ (.A1(_0161_),
    .A2(_0183_),
    .B1(_0184_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0185_));
 sky130_fd_sc_hd__xnor2_2 _0847_ (.A(_0176_),
    .B(_0182_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0186_));
 sky130_fd_sc_hd__or2_2 _0848_ (.A(_0172_),
    .B(_0175_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0187_));
 sky130_fd_sc_hd__a2111o_2 _0849_ (.A1(net71),
    .A2(_0169_),
    .B1(_0182_),
    .C1(_0161_),
    .D1(_0131_),
    ...
    .VPWR(VPWR),
    .X(_0188_));
 sky130_fd_sc_hd__a2bb2o_4 _0850_ (.A1_N(_0172_),
    .A2_N(_0175_),
    .B1(_0188_),
    .B2(net90),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0189_));
 sky130_fd_sc_hd__or2_2 _0851_ (.A(_0157_),
    .B(_0166_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0190_));
 sky130_fd_sc_hd__and2_2 _0852_ (.A(_0178_),
    .B(_0180_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0191_));
 sky130_fd_sc_hd__or4_4 _0853_ (.A(_0176_),
    .B(_0177_),
    .C(_0181_),
    .D(_0182_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0192_));
 sky130_fd_sc_hd__and3_2 _0854_ (.A(_0185_),
    .B(_0186_),
    .C(_0191_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0193_));
 sky130_fd_sc_hd__a2111o_2 _0855_ (.A1(_0161_),
    .A2(_0183_),
    .B1(_0184_),
    .C1(_0192_),
    .D1(_0189_),
    ...
    .VPWR(VPWR),
    .X(_0194_));
 sky130_fd_sc_hd__or3_2 _0856_ (.A(_0157_),
    .B(_0169_),
    .C(_0172_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0195_));
 sky130_fd_sc_hd__o31a_2 _0857_ (.A1(_0154_),
    .A2(_0165_),
    .A3(_0173_),
    .B1(_0195_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0196_));
 sky130_fd_sc_hd__o21ai_4 _0858_ (.A1(_0194_),
    .A2(_0190_),
    .B1(_0196_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0197_));
 sky130_fd_sc_hd__a21o_2 _0859_ (.A1(_0180_),
    .A2(net66),
    .B1(_0178_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0198_));
 sky130_fd_sc_hd__nand2_2 _0860_ (.A(_0191_),
    .B(net66),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0199_));
 sky130_fd_sc_hd__nand2_2 _0861_ (.A(_0198_),
    .B(_0199_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0200_));
 sky130_fd_sc_hd__nand2_2 _0862_ (.A(_0193_),
    .B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0201_));
 sky130_fd_sc_hd__a21o_4 _0863_ (.A1(_0190_),
    .A2(_0196_),
    .B1(_0194_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0202_));
 sky130_fd_sc_hd__a21bo_2 _0864_ (.A1(_0193_),
    .A2(_0197_),
    .B1_N(_0189_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0203_));
 sky130_fd_sc_hd__and2_2 _0865_ (.A(net73),
    .B(_0203_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0204_));
 sky130_fd_sc_hd__nand2_2 _0866_ (.A(net73),
    .B(_0203_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0205_));
 sky130_fd_sc_hd__nand3_2 _0867_ (.A(_0186_),
    .B(_0191_),
    .C(_0197_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0206_));
 sky130_fd_sc_hd__a31o_4 _0868_ (.A1(_0186_),
    .A2(_0191_),
    .A3(net13),
    .B1(_0185_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0207_));
 sky130_fd_sc_hd__and2_4 _0869_ (.A(_0201_),
    .B(_0207_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0208_));
 sky130_fd_sc_hd__nand2_4 _0870_ (.A(_0201_),
    .B(_0207_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0209_));
 sky130_fd_sc_hd__a21o_4 _0871_ (.A1(_0191_),
    .A2(net13),
    .B1(_0186_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0210_));
 sky130_fd_sc_hd__a21oi_2 _0872_ (.A1(_0187_),
    .A2(net62),
    .B1(_0190_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0211_));
 sky130_fd_sc_hd__a31o_4 _0873_ (.A1(_0202_),
    .A2(_0190_),
    .A3(_0187_),
    .B1(_0211_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0212_));
 sky130_fd_sc_hd__a21oi_4 _0874_ (.A1(_0210_),
    .A2(_0206_),
    .B1(_0212_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0213_));
 sky130_fd_sc_hd__a21o_4 _0875_ (.A1(_0206_),
    .A2(_0210_),
    .B1(_0212_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0214_));
 sky130_fd_sc_hd__a22o_2 _0876_ (.A1(net73),
    .A2(_0203_),
    .B1(_0207_),
    .B2(_0201_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0215_));
 sky130_fd_sc_hd__and3_2 _0877_ (.A(_0204_),
    .B(_0209_),
    .C(_0213_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0216_));
 sky130_fd_sc_hd__or3_4 _0878_ (.A(_0214_),
    .B(_0208_),
    .C(_0205_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0217_));
 sky130_fd_sc_hd__a21oi_2 _0879_ (.A1(_0209_),
    .A2(_0213_),
    .B1(_0205_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0218_));
 sky130_fd_sc_hd__a21o_2 _0880_ (.A1(_0209_),
    .A2(_0213_),
    .B1(_0205_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0219_));
 sky130_fd_sc_hd__xnor2_4 _0881_ (.A(_0181_),
    .B(net66),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0220_));
 sky130_fd_sc_hd__and3_2 _0882_ (.A(_0206_),
    .B(_0210_),
    .C(_0212_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0221_));
 sky130_fd_sc_hd__nand3_2 _0883_ (.A(_0206_),
    .B(_0210_),
    .C(_0212_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0222_));
 sky130_fd_sc_hd__nor2_2 _0884_ (.A(_0209_),
    .B(_0213_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0223_));
 sky130_fd_sc_hd__nand2_2 _0885_ (.A(_0208_),
    .B(net72),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0224_));
 sky130_fd_sc_hd__or3_4 _0886_ (.A(_0209_),
    .B(_0213_),
    .C(_0221_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0225_));
 sky130_fd_sc_hd__a21o_2 _0887_ (.A1(_0198_),
    .A2(_0199_),
    .B1(_0220_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0226_));
 sky130_fd_sc_hd__nor2_2 _0888_ (.A(_0225_),
    .B(_0226_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0227_));
 sky130_fd_sc_hd__and2_2 _0889_ (.A(net12),
    .B(_0227_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0228_));
 sky130_fd_sc_hd__and2b_2 _0890_ (.A_N(_0178_),
    .B(_0220_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0229_));
 sky130_fd_sc_hd__nand2b_2 _0891_ (.A_N(_0178_),
    .B(_0220_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0230_));
 sky130_fd_sc_hd__a21oi_2 _0892_ (.A1(_0213_),
    .A2(_0215_),
    .B1(_0221_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0231_));
 sky130_fd_sc_hd__a21o_2 _0893_ (.A1(_0213_),
    .A2(_0215_),
    .B1(_0221_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0232_));
 sky130_fd_sc_hd__a211o_2 _0894_ (.A1(_0204_),
    .A2(_0213_),
    .B1(_0221_),
    .C1(_0208_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0233_));
 sky130_fd_sc_hd__o2111a_2 _0895_ (.A1(_0205_),
    .A2(_0214_),
    .B1(_0222_),
    .C1(_0229_),
    .D1(_0209_),
    ...
    .VPWR(VPWR),
    .X(_0234_));
 sky130_fd_sc_hd__and2_2 _0896_ (.A(net12),
    .B(_0234_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0235_));
 sky130_fd_sc_hd__nor2_4 _0897_ (.A(_0215_),
    .B(net72),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0236_));
 sky130_fd_sc_hd__nor2_2 _0898_ (.A(net12),
    .B(_0236_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0237_));
 sky130_fd_sc_hd__or2_2 _0899_ (.A(net12),
    .B(_0236_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0238_));
 sky130_fd_sc_hd__and3_4 _0900_ (.A(_0217_),
    .B(_0224_),
    .C(_0232_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0239_));
 sky130_fd_sc_hd__or2_4 _0901_ (.A(_0200_),
    .B(_0220_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0240_));
 sky130_fd_sc_hd__and2_2 _0902_ (.A(_0178_),
    .B(_0220_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0241_));
 sky130_fd_sc_hd__nand2_2 _0903_ (.A(_0178_),
    .B(_0220_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0242_));
 sky130_fd_sc_hd__nor2_2 _0904_ (.A(_0233_),
    .B(_0240_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0243_));
 sky130_fd_sc_hd__and4_4 _0905_ (.A(_0208_),
    .B(net72),
    .C(_0222_),
    .D(_0241_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0244_));
 sky130_fd_sc_hd__a311o_2 _0906_ (.A1(_0239_),
    .A2(_0230_),
    .A3(_0240_),
    .B1(_0243_),
    .C1(_0244_),
    ...
    .VPWR(VPWR),
    .X(_0245_));
 sky130_fd_sc_hd__a21o_2 _0907_ (.A1(net9),
    .A2(_0245_),
    .B1(_0235_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0246_));
 sky130_fd_sc_hd__a211o_4 _0908_ (.A1(_0245_),
    .A2(net9),
    .B1(_0228_),
    .C1(_0235_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0247_));
 sky130_fd_sc_hd__nor2_2 _0909_ (.A(_0040_),
    .B(_0043_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0248_));
 sky130_fd_sc_hd__or2_2 _0910_ (.A(_0040_),
    .B(_0043_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0249_));
 sky130_fd_sc_hd__or4_2 _0911_ (.A(_0216_),
    .B(_0223_),
    .C(_0230_),
    .D(_0231_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0250_));
 sky130_fd_sc_hd__o211a_2 _0912_ (.A1(_0208_),
    .A2(net72),
    .B1(_0229_),
    .C1(_0204_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0251_));
 sky130_fd_sc_hd__and4_4 _0913_ (.A(_0251_),
    .B(_0224_),
    .C(_0232_),
    .D(_0217_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0252_));
 sky130_fd_sc_hd__and3_2 _0914_ (.A(_0126_),
    .B(_0248_),
    .C(net82),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0253_));
 sky130_fd_sc_hd__and2b_2 _0915_ (.A_N(net27),
    .B(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0254_));
 sky130_fd_sc_hd__and2_2 _0916_ (.A(net14),
    .B(_0254_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0255_));
 sky130_fd_sc_hd__nand2_2 _0917_ (.A(net14),
    .B(_0254_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0256_));
 sky130_fd_sc_hd__or4_2 _0918_ (.A(_0216_),
    .B(_0223_),
    .C(_0231_),
    .D(_0240_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0257_));
 sky130_fd_sc_hd__nand2_2 _0919_ (.A(_0232_),
    .B(_0241_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0258_));
 sky130_fd_sc_hd__a21oi_2 _0920_ (.A1(_0257_),
    .A2(_0258_),
    .B1(net11),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0259_));
 sky130_fd_sc_hd__nor2_2 _0921_ (.A(_0116_),
    .B(_0249_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0260_));
 sky130_fd_sc_hd__nor2_2 _0922_ (.A(_0233_),
    .B(_0242_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0261_));
 sky130_fd_sc_hd__nand2_2 _0923_ (.A(_0237_),
    .B(_0261_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0262_));
 sky130_fd_sc_hd__and3_2 _0924_ (.A(net9),
    .B(_0260_),
    .C(_0261_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0263_));
 sky130_fd_sc_hd__or3_4 _0925_ (.A(net11),
    .B(_0225_),
    .C(_0240_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0264_));
 sky130_fd_sc_hd__nand2_2 _0926_ (.A(net27),
    .B(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0265_));
 sky130_fd_sc_hd__nor3b_2 _0927_ (.A(_0123_),
    .B(_0264_),
    .C_N(_0265_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0266_));
 sky130_fd_sc_hd__a211o_2 _0928_ (.A1(_0255_),
    .A2(_0259_),
    .B1(_0263_),
    .C1(_0266_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0267_));
 sky130_fd_sc_hd__a211o_4 _0929_ (.A1(_0126_),
    .A2(_0247_),
    .B1(_0253_),
    .C1(_0267_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0268_));
 sky130_fd_sc_hd__a2111o_2 _0930_ (.A1(_0204_),
    .A2(_0213_),
    .B1(_0221_),
    .C1(_0226_),
    .D1(_0208_),
    ...
    .VPWR(VPWR),
    .X(_0269_));
 sky130_fd_sc_hd__nor3_2 _0931_ (.A(net72),
    .B(_0215_),
    .C(_0269_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0270_));
 sky130_fd_sc_hd__a211oi_2 _0932_ (.A1(net70),
    .A2(_0224_),
    .B1(_0231_),
    .C1(_0240_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0271_));
 sky130_fd_sc_hd__a2111oi_2 _0933_ (.A1(net70),
    .A2(_0224_),
    .B1(_0231_),
    .C1(_0240_),
    .D1(_0219_),
    ...
    .VPWR(VPWR),
    .Y(_0272_));
 sky130_fd_sc_hd__or2_4 _0934_ (.A(_0270_),
    .B(_0272_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0273_));
 sky130_fd_sc_hd__nor2_2 _0935_ (.A(_0121_),
    .B(_0123_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0274_));
 sky130_fd_sc_hd__nor2_2 _0936_ (.A(_0254_),
    .B(_0274_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0275_));
 sky130_fd_sc_hd__nor2_2 _0937_ (.A(_0225_),
    .B(_0230_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0276_));
 sky130_fd_sc_hd__o211a_2 _0938_ (.A1(_0216_),
    .A2(_0223_),
    .B1(_0232_),
    .C1(_0241_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0277_));
 sky130_fd_sc_hd__o21ai_2 _0939_ (.A1(_0276_),
    .A2(_0277_),
    .B1(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0278_));
 sky130_fd_sc_hd__o221a_2 _0940_ (.A1(_0254_),
    .A2(_0274_),
    .B1(_0276_),
    .B2(_0277_),
    .C1(net9),
    ...
    .VPWR(VPWR),
    .X(_0279_));
 sky130_fd_sc_hd__nand2_2 _0941_ (.A(_0234_),
    .B(_0236_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0280_));
 sky130_fd_sc_hd__and3_2 _0942_ (.A(_0234_),
    .B(_0236_),
    .C(_0254_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0281_));
 sky130_fd_sc_hd__nand2b_2 _0943_ (.A_N(_0260_),
    .B(_0124_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0282_));
 sky130_fd_sc_hd__and2_2 _0944_ (.A(_0236_),
    .B(_0243_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0283_));
 sky130_fd_sc_hd__a211o_2 _0945_ (.A1(_0282_),
    .A2(_0283_),
    .B1(_0279_),
    .C1(_0281_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0284_));
 sky130_fd_sc_hd__or4_2 _0946_ (.A(net12),
    .B(_0225_),
    .C(_0226_),
    .D(_0236_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0285_));
 sky130_fd_sc_hd__or3_2 _0947_ (.A(net11),
    .B(_0233_),
    .C(_0242_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0286_));
 sky130_fd_sc_hd__nand2_2 _0948_ (.A(_0285_),
    .B(_0286_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0287_));
 sky130_fd_sc_hd__nand2_2 _0949_ (.A(_0121_),
    .B(_0248_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0288_));
 sky130_fd_sc_hd__or2_2 _0950_ (.A(net26),
    .B(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0289_));
 sky130_fd_sc_hd__inv_2 _0951_ (.A(_0289_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0290_));
 sky130_fd_sc_hd__and2_2 _0952_ (.A(net12),
    .B(_0244_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0291_));
 sky130_fd_sc_hd__a31o_2 _0953_ (.A1(net12),
    .A2(_0244_),
    .A3(_0290_),
    .B1(_0641_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0292_));
 sky130_fd_sc_hd__a31o_2 _0954_ (.A1(_0121_),
    .A2(_0248_),
    .A3(_0287_),
    .B1(_0292_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0293_));
 sky130_fd_sc_hd__a31o_2 _0955_ (.A1(net26),
    .A2(_0265_),
    .A3(_0273_),
    .B1(_0293_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0294_));
 sky130_fd_sc_hd__or2_2 _0956_ (.A(_0260_),
    .B(_0274_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0295_));
 sky130_fd_sc_hd__a21o_2 _0957_ (.A1(_0246_),
    .A2(_0295_),
    .B1(_0263_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0296_));
 sky130_fd_sc_hd__and4b_2 _0958_ (.A_N(net27),
    .B(net12),
    .C(_0227_),
    .D(_0274_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0297_));
 sky130_fd_sc_hd__nor2_2 _0959_ (.A(_0124_),
    .B(_0264_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0298_));
 sky130_fd_sc_hd__a2111o_2 _0960_ (.A1(_0259_),
    .A2(_0295_),
    .B1(_0297_),
    .C1(_0298_),
    .D1(_0279_),
    ...
    .VPWR(VPWR),
    .X(_0299_));
 sky130_fd_sc_hd__nor2_2 _0961_ (.A(net27),
    .B(_0122_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0300_));
 sky130_fd_sc_hd__inv_2 _0962_ (.A(_0300_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0301_));
 sky130_fd_sc_hd__o21ai_2 _0963_ (.A1(_0123_),
    .A2(_0300_),
    .B1(_0118_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0302_));
 sky130_fd_sc_hd__o21ai_2 _0964_ (.A1(_0043_),
    .A2(_0121_),
    .B1(_0116_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0303_));
 sky130_fd_sc_hd__a21oi_2 _0965_ (.A1(_0041_),
    .A2(_0121_),
    .B1(_0303_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0304_));
 sky130_fd_sc_hd__a211o_2 _0966_ (.A1(_0291_),
    .A2(_0304_),
    .B1(\g_x[0] ),
    .C1(_0281_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0305_));
 sky130_fd_sc_hd__a22o_2 _0967_ (.A1(_0287_),
    .A2(_0290_),
    .B1(_0302_),
    .B2(_0273_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0306_));
 sky130_fd_sc_hd__or4_4 _0968_ (.A(_0253_),
    .B(_0299_),
    .C(_0305_),
    .D(_0306_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0307_));
 sky130_fd_sc_hd__o32a_4 _0969_ (.A1(_0268_),
    .A2(_0284_),
    .A3(_0294_),
    .B1(_0296_),
    .B2(_0307_),
    ...
    .VPWR(VPWR),
    .X(_0308_));
 sky130_fd_sc_hd__a211o_2 _0970_ (.A1(net70),
    .A2(_0224_),
    .B1(_0226_),
    .C1(_0231_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0309_));
 sky130_fd_sc_hd__or2_2 _0971_ (.A(net11),
    .B(_0309_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0310_));
 sky130_fd_sc_hd__a31o_2 _0972_ (.A1(_0250_),
    .A2(_0257_),
    .A3(_0269_),
    .B1(_0238_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0311_));
 sky130_fd_sc_hd__and2_2 _0973_ (.A(_0310_),
    .B(_0311_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0312_));
 sky130_fd_sc_hd__nand2_2 _0974_ (.A(_0234_),
    .B(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0313_));
 sky130_fd_sc_hd__or2_2 _0975_ (.A(_0301_),
    .B(_0313_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0314_));
 sky130_fd_sc_hd__a21oi_2 _0976_ (.A1(_0312_),
    .A2(_0314_),
    .B1(_0123_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0315_));
 sky130_fd_sc_hd__nor2_2 _0977_ (.A(net11),
    .B(_0269_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0316_));
 sky130_fd_sc_hd__or2_2 _0978_ (.A(net11),
    .B(_0269_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0317_));
 sky130_fd_sc_hd__or3_2 _0979_ (.A(net11),
    .B(_0225_),
    .C(_0230_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0318_));
 sky130_fd_sc_hd__o21a_2 _0980_ (.A1(_0238_),
    .A2(_0309_),
    .B1(_0318_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0319_));
 sky130_fd_sc_hd__o21ai_2 _0981_ (.A1(_0238_),
    .A2(_0309_),
    .B1(_0318_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0320_));
 sky130_fd_sc_hd__or3_2 _0982_ (.A(net11),
    .B(_0233_),
    .C(_0240_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0321_));
 sky130_fd_sc_hd__or3_2 _0983_ (.A(net11),
    .B(_0220_),
    .C(_0233_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0322_));
 sky130_fd_sc_hd__nand2_2 _0984_ (.A(net9),
    .B(_0271_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0323_));
 sky130_fd_sc_hd__a21o_2 _0985_ (.A1(_0319_),
    .A2(_0323_),
    .B1(_0256_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0324_));
 sky130_fd_sc_hd__o21ai_2 _0986_ (.A1(_0275_),
    .A2(_0322_),
    .B1(_0324_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0325_));
 sky130_fd_sc_hd__o31a_2 _0987_ (.A1(_0255_),
    .A2(_0274_),
    .A3(_0316_),
    .B1(_0325_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0326_));
 sky130_fd_sc_hd__o31a_4 _0988_ (.A1(_0326_),
    .A2(_0315_),
    .A3(_0308_),
    .B1(\g_x[1] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0327_));
 sky130_fd_sc_hd__a21oi_2 _0989_ (.A1(net9),
    .A2(_0271_),
    .B1(net82),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0328_));
 sky130_fd_sc_hd__o211a_2 _0990_ (.A1(_0238_),
    .A2(_0309_),
    .B1(_0318_),
    .C1(_0280_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0329_));
 sky130_fd_sc_hd__nand2_2 _0991_ (.A(_0328_),
    .B(_0329_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0330_));
 sky130_fd_sc_hd__a31o_2 _0992_ (.A1(_0321_),
    .A2(_0328_),
    .A3(_0329_),
    .B1(_0125_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0331_));
 sky130_fd_sc_hd__o21ai_2 _0993_ (.A1(_0123_),
    .A2(_0265_),
    .B1(_0119_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0332_));
 sky130_fd_sc_hd__nand2_2 _0994_ (.A(_0273_),
    .B(_0332_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0333_));
 sky130_fd_sc_hd__o21a_2 _0995_ (.A1(_0275_),
    .A2(_0317_),
    .B1(\g_x[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0334_));
 sky130_fd_sc_hd__o211a_2 _0996_ (.A1(_0289_),
    .A2(_0317_),
    .B1(_0333_),
    .C1(_0334_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0335_));
 sky130_fd_sc_hd__and2_2 _0997_ (.A(_0117_),
    .B(_0303_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0336_));
 sky130_fd_sc_hd__and2b_2 _0998_ (.A_N(_0336_),
    .B(_0259_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0337_));
 sky130_fd_sc_hd__a21oi_2 _0999_ (.A1(_0118_),
    .A2(_0336_),
    .B1(_0264_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0338_));
 sky130_fd_sc_hd__a2111oi_1 _1000_ (.A1(_0246_),
    .A2(_0295_),
    .B1(_0297_),
    .C1(_0337_),
    .D1(_0338_),
    ...
    .VPWR(VPWR),
    .Y(_0339_));
 sky130_fd_sc_hd__or2_2 _1001_ (.A(_0125_),
    .B(_0328_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0340_));
 sky130_fd_sc_hd__and2_2 _1002_ (.A(_0117_),
    .B(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0341_));
 sky130_fd_sc_hd__a2bb2o_2 _1003_ (.A1_N(_0321_),
    .A2_N(_0341_),
    .B1(_0290_),
    .B2(_0316_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0342_));
 sky130_fd_sc_hd__a2111o_2 _1004_ (.A1(_0260_),
    .A2(_0273_),
    .B1(_0297_),
    .C1(_0342_),
    .D1(\g_x[0] ),
    ...
    .VPWR(VPWR),
    .X(_0343_));
 sky130_fd_sc_hd__nor2_2 _1005_ (.A(_0041_),
    .B(_0116_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0344_));
 sky130_fd_sc_hd__or2_2 _1006_ (.A(_0121_),
    .B(_0344_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0345_));
 sky130_fd_sc_hd__nor2_2 _1007_ (.A(net14),
    .B(_0123_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0346_));
 sky130_fd_sc_hd__nor2_2 _1008_ (.A(_0120_),
    .B(_0346_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0347_));
 sky130_fd_sc_hd__o2bb2a_2 _1009_ (.A1_N(_0259_),
    .A2_N(_0345_),
    .B1(_0347_),
    .B2(_0264_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0348_));
 sky130_fd_sc_hd__or2_2 _1010_ (.A(_0329_),
    .B(_0336_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0349_));
 sky130_fd_sc_hd__and4b_2 _1011_ (.A_N(_0343_),
    .B(_0348_),
    .C(_0349_),
    .D(_0340_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0350_));
 sky130_fd_sc_hd__a31o_2 _1012_ (.A1(_0331_),
    .A2(_0335_),
    .A3(net7),
    .B1(_0350_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0351_));
 sky130_fd_sc_hd__a21oi_2 _1013_ (.A1(_0234_),
    .A2(_0237_),
    .B1(_0291_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0352_));
 sky130_fd_sc_hd__and4b_2 _1014_ (.A_N(_0287_),
    .B(_0352_),
    .C(_0262_),
    .D(_0278_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0353_));
 sky130_fd_sc_hd__nand2_2 _1015_ (.A(_0312_),
    .B(_0353_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0354_));
 sky130_fd_sc_hd__nand2_2 _1016_ (.A(_0126_),
    .B(_0354_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0355_));
 sky130_fd_sc_hd__a21oi_4 _1017_ (.A1(_0355_),
    .A2(_0351_),
    .B1(\g_x[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0356_));
 sky130_fd_sc_hd__o211a_2 _1018_ (.A1(_0270_),
    .A2(_0272_),
    .B1(_0248_),
    .C1(_0265_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0357_));
 sky130_fd_sc_hd__a21o_2 _1019_ (.A1(_0119_),
    .A2(_0123_),
    .B1(_0322_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0358_));
 sky130_fd_sc_hd__o221ai_2 _1020_ (.A1(_0125_),
    .A2(_0313_),
    .B1(_0323_),
    .B2(_0336_),
    .C1(_0358_),
    ...
    .VPWR(VPWR),
    .Y(_0359_));
 sky130_fd_sc_hd__a21oi_2 _1021_ (.A1(_0310_),
    .A2(_0311_),
    .B1(_0124_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0360_));
 sky130_fd_sc_hd__a21oi_2 _1022_ (.A1(_0285_),
    .A2(_0286_),
    .B1(_0125_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0361_));
 sky130_fd_sc_hd__a31o_2 _1023_ (.A1(net26),
    .A2(_0116_),
    .A3(_0265_),
    .B1(_0120_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0362_));
 sky130_fd_sc_hd__and3_2 _1024_ (.A(_0234_),
    .B(_0236_),
    .C(_0362_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0363_));
 sky130_fd_sc_hd__a31o_2 _1025_ (.A1(net12),
    .A2(_0244_),
    .A3(_0304_),
    .B1(\g_x[1] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0364_));
 sky130_fd_sc_hd__a311o_2 _1026_ (.A1(_0126_),
    .A2(_0288_),
    .A3(_0252_),
    .B1(_0363_),
    .C1(_0364_),
    ...
    .VPWR(VPWR),
    .X(_0365_));
 sky130_fd_sc_hd__a2111o_2 _1027_ (.A1(_0255_),
    .A2(_0320_),
    .B1(_0357_),
    .C1(_0361_),
    .D1(_0365_),
    ...
    .VPWR(VPWR),
    .X(_0366_));
 sky130_fd_sc_hd__a2111o_2 _1028_ (.A1(_0246_),
    .A2(_0295_),
    .B1(_0360_),
    .C1(_0263_),
    .D1(_0366_),
    ...
    .VPWR(VPWR),
    .X(_0367_));
 sky130_fd_sc_hd__o21bai_2 _1029_ (.A1(_0116_),
    .A2(_0256_),
    .B1_N(_0304_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0368_));
 sky130_fd_sc_hd__a211oi_2 _1030_ (.A1(_0117_),
    .A2(_0123_),
    .B1(_0265_),
    .C1(_0319_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0369_));
 sky130_fd_sc_hd__and3_2 _1031_ (.A(_0126_),
    .B(net12),
    .C(_0244_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0370_));
 sky130_fd_sc_hd__a211o_2 _1032_ (.A1(_0273_),
    .A2(_0368_),
    .B1(_0370_),
    .C1(_0297_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0371_));
 sky130_fd_sc_hd__or4b_2 _1033_ (.A(_0651_),
    .B(_0369_),
    .C(_0371_),
    .D_N(_0348_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0372_));
 sky130_fd_sc_hd__o311a_4 _1034_ (.A1(_0299_),
    .A2(_0359_),
    .A3(_0367_),
    .B1(_0372_),
    .C1(\g_x[0] ),
    ...
    .VPWR(VPWR),
    .X(_0373_));
 sky130_fd_sc_hd__nor2_2 _1035_ (.A(\g_x[0] ),
    .B(\g_x[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0374_));
 sky130_fd_sc_hd__a22o_2 _1036_ (.A1(_0290_),
    .A2(_0291_),
    .B1(_0344_),
    .B2(_0287_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0375_));
 sky130_fd_sc_hd__a211o_2 _1037_ (.A1(_0254_),
    .A2(_0273_),
    .B1(_0284_),
    .C1(_0375_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0376_));
 sky130_fd_sc_hd__o41a_4 _1038_ (.A1(_0268_),
    .A2(_0315_),
    .A3(_0325_),
    .A4(_0376_),
    .B1(_0374_),
    ...
    .VPWR(VPWR),
    .X(_0377_));
 sky130_fd_sc_hd__a21oi_2 _1039_ (.A1(_0124_),
    .A2(_0256_),
    .B1(_0346_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0378_));
 sky130_fd_sc_hd__a32o_2 _1040_ (.A1(_0126_),
    .A2(_0249_),
    .A3(net82),
    .B1(_0273_),
    .B2(_0378_),
    ...
    .VPWR(VPWR),
    .X(_0379_));
 sky130_fd_sc_hd__a211o_2 _1041_ (.A1(_0301_),
    .A2(_0363_),
    .B1(_0370_),
    .C1(_0361_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0380_));
 sky130_fd_sc_hd__a2111oi_2 _1042_ (.A1(_0295_),
    .A2(_0320_),
    .B1(_0359_),
    .C1(_0379_),
    .D1(_0380_),
    ...
    .VPWR(VPWR),
    .Y(_0381_));
 sky130_fd_sc_hd__or2_2 _1043_ (.A(_0289_),
    .B(_0312_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0382_));
 sky130_fd_sc_hd__a311oi_4 _1044_ (.A1(_0382_),
    .A2(_0381_),
    .A3(net6),
    .B1(_0651_),
    .C1(\g_x[0] ),
    ...
    .VPWR(VPWR),
    .Y(_0383_));
 sky130_fd_sc_hd__a211o_2 _1045_ (.A1(_0225_),
    .A2(_0233_),
    .B1(net11),
    .C1(_0220_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0384_));
 sky130_fd_sc_hd__or4b_2 _1046_ (.A(_0259_),
    .B(_0273_),
    .C(_0283_),
    .D_N(_0384_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0385_));
 sky130_fd_sc_hd__or3_2 _1047_ (.A(_0246_),
    .B(_0330_),
    .C(_0385_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0386_));
 sky130_fd_sc_hd__xnor2_2 _1048_ (.A(net34),
    .B(net39),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0387_));
 sky130_fd_sc_hd__xnor2_2 _1049_ (.A(net29),
    .B(_0387_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0388_));
 sky130_fd_sc_hd__and2_2 _1050_ (.A(net31),
    .B(_0647_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0389_));
 sky130_fd_sc_hd__nor2_2 _1051_ (.A(net31),
    .B(_0647_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0390_));
 sky130_fd_sc_hd__nor2_2 _1052_ (.A(_0389_),
    .B(_0390_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0391_));
 sky130_fd_sc_hd__xnor2_2 _1053_ (.A(\hpos[9] ),
    .B(net28),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0392_));
 sky130_fd_sc_hd__xnor2_2 _1054_ (.A(net19),
    .B(_0392_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0393_));
 sky130_fd_sc_hd__xnor2_2 _1055_ (.A(_0388_),
    .B(_0393_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0394_));
 sky130_fd_sc_hd__mux2_1 _1056_ (.A0(\frame[7] ),
    .A1(\frame[6] ),
    .S(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0395_));
 sky130_fd_sc_hd__nand2_2 _1057_ (.A(_0137_),
    .B(_0395_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0396_));
 sky130_fd_sc_hd__and2_2 _1058_ (.A(net36),
    .B(_0132_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0397_));
 sky130_fd_sc_hd__nor2_2 _1059_ (.A(net36),
    .B(_0132_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0398_));
 sky130_fd_sc_hd__nor2_2 _1060_ (.A(_0397_),
    .B(_0398_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0399_));
 sky130_fd_sc_hd__mux2_1 _1061_ (.A0(\frame[8] ),
    .A1(\frame[7] ),
    .S(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0400_));
 sky130_fd_sc_hd__xor2_2 _1062_ (.A(_0399_),
    .B(_0400_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0401_));
 sky130_fd_sc_hd__inv_2 _1063_ (.A(_0401_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0402_));
 sky130_fd_sc_hd__and3_2 _1064_ (.A(_0136_),
    .B(_0396_),
    .C(_0402_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0403_));
 sky130_fd_sc_hd__a21o_2 _1065_ (.A1(_0136_),
    .A2(_0396_),
    .B1(_0402_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0404_));
 sky130_fd_sc_hd__xnor2_2 _1066_ (.A(_0647_),
    .B(_0138_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0405_));
 sky130_fd_sc_hd__mux2_1 _1067_ (.A0(\frame[6] ),
    .A1(\frame[5] ),
    .S(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0406_));
 sky130_fd_sc_hd__nand2_2 _1068_ (.A(_0405_),
    .B(_0406_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0407_));
 sky130_fd_sc_hd__o21ai_2 _1069_ (.A1(net37),
    .A2(_0138_),
    .B1(_0407_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0408_));
 sky130_fd_sc_hd__or2_2 _1070_ (.A(_0137_),
    .B(_0395_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0409_));
 sky130_fd_sc_hd__and2_2 _1071_ (.A(_0396_),
    .B(_0409_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0410_));
 sky130_fd_sc_hd__xnor2_2 _1072_ (.A(_0408_),
    .B(_0410_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0411_));
 sky130_fd_sc_hd__xnor2_2 _1073_ (.A(_0653_),
    .B(_0106_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0412_));
 sky130_fd_sc_hd__mux2_1 _1074_ (.A0(\frame[5] ),
    .A1(\frame[4] ),
    .S(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0413_));
 sky130_fd_sc_hd__a32o_2 _1075_ (.A1(_0653_),
    .A2(net65),
    .A3(_0105_),
    .B1(_0412_),
    .B2(_0413_),
    ...
    .VPWR(VPWR),
    .X(_0414_));
 sky130_fd_sc_hd__or2_2 _1076_ (.A(_0405_),
    .B(_0406_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_2 _1077_ (.A(_0407_),
    ...
    .VPWR(VPWR),
    .X(_0416_));
 sky130_fd_sc_hd__nand2_2 _1078_ (.A(_0414_),
    .B(_0416_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0417_));
 sky130_fd_sc_hd__or2_2 _1079_ (.A(_0414_),
    .B(_0416_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0418_));
 sky130_fd_sc_hd__nand2_2 _1080_ (.A(_0417_),
    .B(_0418_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0419_));
 sky130_fd_sc_hd__nand2_2 _1081_ (.A(net38),
    .B(net63),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0420_));
 sky130_fd_sc_hd__xor2_2 _1082_ (.A(_0412_),
    .B(_0413_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0421_));
 sky130_fd_sc_hd__nand2_2 _1083_ (.A(_0420_),
    .B(_0421_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0422_));
 sky130_fd_sc_hd__nor2_2 _1084_ (.A(net35),
    .B(net64),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0423_));
 sky130_fd_sc_hd__nand2_2 _1085_ (.A(net35),
    .B(net64),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0424_));
 sky130_fd_sc_hd__and2b_2 _1086_ (.A_N(_0423_),
    .B(_0424_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0425_));
 sky130_fd_sc_hd__mux2_1 _1087_ (.A0(\frame[3] ),
    .A1(\frame[2] ),
    .S(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0426_));
 sky130_fd_sc_hd__a21oi_2 _1088_ (.A1(_0424_),
    .A2(_0426_),
    .B1(_0423_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0427_));
 sky130_fd_sc_hd__or2_2 _1089_ (.A(net38),
    .B(net63),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0428_));
 sky130_fd_sc_hd__and2_2 _1090_ (.A(_0420_),
    .B(_0428_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0429_));
 sky130_fd_sc_hd__or2_2 _1091_ (.A(_0427_),
    .B(_0429_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0430_));
 sky130_fd_sc_hd__xor2_2 _1092_ (.A(_0427_),
    .B(_0429_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0431_));
 sky130_fd_sc_hd__mux2_1 _1093_ (.A0(\frame[4] ),
    .A1(\frame[3] ),
    .S(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0432_));
 sky130_fd_sc_hd__nand2_2 _1094_ (.A(_0431_),
    .B(_0432_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0433_));
 sky130_fd_sc_hd__or2_2 _1095_ (.A(_0420_),
    .B(_0421_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0434_));
 sky130_fd_sc_hd__nand2_2 _1096_ (.A(_0422_),
    .B(_0434_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0435_));
 sky130_fd_sc_hd__a21o_2 _1097_ (.A1(_0430_),
    .A2(_0433_),
    .B1(_0435_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0436_));
 sky130_fd_sc_hd__nand2_2 _1098_ (.A(_0422_),
    .B(_0436_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0437_));
 sky130_fd_sc_hd__a21o_2 _1099_ (.A1(_0422_),
    .A2(_0436_),
    .B1(_0419_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0438_));
 sky130_fd_sc_hd__a21oi_2 _1100_ (.A1(_0417_),
    .A2(_0438_),
    .B1(_0411_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0439_));
 sky130_fd_sc_hd__a21oi_2 _1101_ (.A1(_0408_),
    .A2(_0410_),
    .B1(_0439_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0440_));
 sky130_fd_sc_hd__o21ai_2 _1102_ (.A1(_0403_),
    .A2(_0440_),
    .B1(_0404_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0441_));
 sky130_fd_sc_hd__a21o_2 _1103_ (.A1(_0399_),
    .A2(_0400_),
    .B1(_0398_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0442_));
 sky130_fd_sc_hd__xnor2_2 _1104_ (.A(net31),
    .B(\hpos[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0443_));
 sky130_fd_sc_hd__mux2_1 _1105_ (.A0(\frame[9] ),
    .A1(\frame[8] ),
    .S(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0444_));
 sky130_fd_sc_hd__xnor2_2 _1106_ (.A(_0443_),
    .B(_0444_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0445_));
 sky130_fd_sc_hd__xnor2_2 _1107_ (.A(_0442_),
    .B(_0445_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0446_));
 sky130_fd_sc_hd__or2_2 _1108_ (.A(net34),
    .B(net39),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0447_));
 sky130_fd_sc_hd__inv_2 _1109_ (.A(_0447_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0448_));
 sky130_fd_sc_hd__mux2_1 _1110_ (.A0(_0063_),
    .A1(_0071_),
    .S(_0447_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0449_));
 sky130_fd_sc_hd__nor2_2 _1111_ (.A(net39),
    .B(_0391_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0450_));
 sky130_fd_sc_hd__xnor2_2 _1112_ (.A(net19),
    .B(_0447_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0451_));
 sky130_fd_sc_hd__mux2_1 _1113_ (.A0(net29),
    .A1(net32),
    .S(_0387_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0452_));
 sky130_fd_sc_hd__a22o_2 _1114_ (.A1(net34),
    .A2(_0450_),
    .B1(_0451_),
    .B2(_0452_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0453_));
 sky130_fd_sc_hd__a32o_2 _1115_ (.A1(\b[3] ),
    .A2(_0062_),
    .A3(_0448_),
    .B1(_0449_),
    .B2(_0453_),
    ...
    .VPWR(VPWR),
    .X(_0454_));
 sky130_fd_sc_hd__xnor2_2 _1116_ (.A(_0441_),
    .B(_0446_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0455_));
 sky130_fd_sc_hd__and3_2 _1117_ (.A(_0411_),
    .B(_0417_),
    .C(_0438_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0456_));
 sky130_fd_sc_hd__or2_2 _1118_ (.A(_0439_),
    .B(_0456_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0457_));
 sky130_fd_sc_hd__o21a_2 _1119_ (.A1(\hvsync_gen.vpos[3] ),
    .A2(_0659_),
    .B1(_0059_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0458_));
 sky130_fd_sc_hd__o211a_2 _1120_ (.A1(_0658_),
    .A2(_0057_),
    .B1(_0056_),
    .C1(_0034_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0459_));
 sky130_fd_sc_hd__a211o_2 _1121_ (.A1(net29),
    .A2(_0654_),
    .B1(_0065_),
    .C1(net34),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0460_));
 sky130_fd_sc_hd__xnor2_2 _1122_ (.A(net28),
    .B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0461_));
 sky130_fd_sc_hd__a31o_2 _1123_ (.A1(_0657_),
    .A2(_0075_),
    .A3(_0079_),
    .B1(\hpos[10] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0462_));
 sky130_fd_sc_hd__a21o_2 _1124_ (.A1(_0076_),
    .A2(_0460_),
    .B1(_0462_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0463_));
 sky130_fd_sc_hd__a211o_2 _1125_ (.A1(net74),
    .A2(_0050_),
    .B1(_0461_),
    .C1(_0463_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0464_));
 sky130_fd_sc_hd__nor3_2 _1126_ (.A(_0458_),
    .B(_0459_),
    .C(_0464_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0465_));
 sky130_fd_sc_hd__o41a_2 _1127_ (.A1(_0648_),
    .A2(net39),
    .A3(_0063_),
    .A4(_0457_),
    .B1(_0465_),
    ...
    .VPWR(VPWR),
    .X(_0466_));
 sky130_fd_sc_hd__and2b_2 _1128_ (.A_N(_0403_),
    .B(_0404_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0467_));
 sky130_fd_sc_hd__xnor2_2 _1129_ (.A(_0440_),
    .B(_0467_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0468_));
 sky130_fd_sc_hd__o2111a_2 _1130_ (.A1(net29),
    .A2(_0447_),
    .B1(_0468_),
    .C1(_0062_),
    .D1(_0387_),
    ...
    .VPWR(VPWR),
    .X(_0469_));
 sky130_fd_sc_hd__a21oi_2 _1131_ (.A1(_0454_),
    .A2(_0455_),
    .B1(_0469_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0470_));
 sky130_fd_sc_hd__mux2_1 _1132_ (.A0(_0138_),
    .A1(_0095_),
    .S(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0471_));
 sky130_fd_sc_hd__and2b_2 _1133_ (.A_N(_0443_),
    .B(_0471_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0472_));
 sky130_fd_sc_hd__and2b_2 _1134_ (.A_N(_0471_),
    .B(_0443_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_2 _1135_ (.A(_0472_),
    ...
    .VPWR(VPWR),
    .Y(_0474_));
 sky130_fd_sc_hd__mux2_1 _1136_ (.A0(_0106_),
    .A1(_0138_),
    .S(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0475_));
 sky130_fd_sc_hd__or2_2 _1137_ (.A(net37),
    .B(_0475_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0476_));
 sky130_fd_sc_hd__inv_2 _1138_ (.A(_0476_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0477_));
 sky130_fd_sc_hd__and2_2 _1139_ (.A(net37),
    .B(_0475_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0478_));
 sky130_fd_sc_hd__mux2_1 _1140_ (.A0(net63),
    .A1(_0106_),
    .S(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0479_));
 sky130_fd_sc_hd__xor2_2 _1141_ (.A(net30),
    .B(_0479_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0480_));
 sky130_fd_sc_hd__nand2b_2 _1142_ (.A_N(net63),
    .B(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0481_));
 sky130_fd_sc_hd__o21ai_2 _1143_ (.A1(net64),
    .A2(net18),
    .B1(_0481_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0482_));
 sky130_fd_sc_hd__nor2_2 _1144_ (.A(_0647_),
    .B(_0482_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0483_));
 sky130_fd_sc_hd__and3_2 _1145_ (.A(\hpos[9] ),
    .B(net64),
    .C(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0484_));
 sky130_fd_sc_hd__xnor2_2 _1146_ (.A(net37),
    .B(_0482_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0485_));
 sky130_fd_sc_hd__and2_2 _1147_ (.A(_0484_),
    .B(_0485_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0486_));
 sky130_fd_sc_hd__o21a_2 _1148_ (.A1(_0483_),
    .A2(_0486_),
    .B1(_0480_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0487_));
 sky130_fd_sc_hd__a21o_2 _1149_ (.A1(net30),
    .A2(_0479_),
    .B1(_0487_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0488_));
 sky130_fd_sc_hd__or2_2 _1150_ (.A(_0478_),
    .B(_0488_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0489_));
 sky130_fd_sc_hd__and3_2 _1151_ (.A(_0474_),
    .B(_0476_),
    .C(_0489_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0490_));
 sky130_fd_sc_hd__mux2_1 _1152_ (.A0(_0095_),
    .A1(_0132_),
    .S(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0491_));
 sky130_fd_sc_hd__o21ai_2 _1153_ (.A1(_0472_),
    .A2(_0490_),
    .B1(_0491_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0492_));
 sky130_fd_sc_hd__or3_2 _1154_ (.A(_0472_),
    .B(_0490_),
    .C(_0491_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0493_));
 sky130_fd_sc_hd__and2_2 _1155_ (.A(_0492_),
    .B(_0493_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0494_));
 sky130_fd_sc_hd__inv_2 _1156_ (.A(_0494_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0495_));
 sky130_fd_sc_hd__a21oi_2 _1157_ (.A1(_0476_),
    .A2(_0489_),
    .B1(_0474_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0496_));
 sky130_fd_sc_hd__or2_2 _1158_ (.A(_0490_),
    .B(_0496_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0497_));
 sky130_fd_sc_hd__nor2_2 _1159_ (.A(_0477_),
    .B(_0478_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0498_));
 sky130_fd_sc_hd__xnor2_2 _1160_ (.A(_0488_),
    .B(_0498_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0499_));
 sky130_fd_sc_hd__or2_2 _1161_ (.A(\frame[5] ),
    .B(_0499_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0500_));
 sky130_fd_sc_hd__nor3_2 _1162_ (.A(_0480_),
    .B(_0483_),
    .C(_0486_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0501_));
 sky130_fd_sc_hd__or2_2 _1163_ (.A(_0487_),
    .B(_0501_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0502_));
 sky130_fd_sc_hd__nor2_2 _1164_ (.A(_0484_),
    .B(_0485_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0503_));
 sky130_fd_sc_hd__or2_2 _1165_ (.A(_0486_),
    .B(_0503_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0504_));
 sky130_fd_sc_hd__a21oi_2 _1166_ (.A1(net64),
    .A2(net18),
    .B1(\hpos[9] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0505_));
 sky130_fd_sc_hd__a21o_2 _1167_ (.A1(_0649_),
    .A2(\frame[1] ),
    .B1(_0648_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0506_));
 sky130_fd_sc_hd__o22a_2 _1168_ (.A1(_0649_),
    .A2(\frame[1] ),
    .B1(_0506_),
    .B2(\frame[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0507_));
 sky130_fd_sc_hd__a211o_2 _1169_ (.A1(\frame[2] ),
    .A2(_0507_),
    .B1(_0505_),
    .C1(_0484_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0508_));
 sky130_fd_sc_hd__o221a_2 _1170_ (.A1(\frame[3] ),
    .A2(_0504_),
    .B1(_0507_),
    .B2(\frame[2] ),
    .C1(_0508_),
    ...
    .VPWR(VPWR),
    .X(_0509_));
 sky130_fd_sc_hd__and2_2 _1171_ (.A(\frame[3] ),
    .B(_0504_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0510_));
 sky130_fd_sc_hd__o22a_2 _1172_ (.A1(\frame[4] ),
    .A2(_0502_),
    .B1(_0509_),
    .B2(_0510_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0511_));
 sky130_fd_sc_hd__a221o_2 _1173_ (.A1(\frame[5] ),
    .A2(_0499_),
    .B1(_0502_),
    .B2(\frame[4] ),
    .C1(_0511_),
    ...
    .VPWR(VPWR),
    .X(_0512_));
 sky130_fd_sc_hd__a22o_2 _1174_ (.A1(\frame[6] ),
    .A2(_0497_),
    .B1(_0500_),
    .B2(_0512_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0513_));
 sky130_fd_sc_hd__o221a_2 _1175_ (.A1(\frame[7] ),
    .A2(_0495_),
    .B1(_0497_),
    .B2(\frame[6] ),
    .C1(_0513_),
    ...
    .VPWR(VPWR),
    .X(_0514_));
 sky130_fd_sc_hd__and2b_2 _1176_ (.A_N(net17),
    .B(_0132_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0515_));
 sky130_fd_sc_hd__nand2b_2 _1177_ (.A_N(_0492_),
    .B(_0515_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0516_));
 sky130_fd_sc_hd__xor2_2 _1178_ (.A(_0492_),
    .B(_0515_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0517_));
 sky130_fd_sc_hd__a221o_2 _1179_ (.A1(\frame[7] ),
    .A2(_0495_),
    .B1(_0517_),
    .B2(\frame[8] ),
    .C1(_0514_),
    ...
    .VPWR(VPWR),
    .X(_0518_));
 sky130_fd_sc_hd__o22a_2 _1180_ (.A1(\frame[9] ),
    .A2(_0516_),
    .B1(_0517_),
    .B2(\frame[8] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0519_));
 sky130_fd_sc_hd__a221o_2 _1181_ (.A1(\frame[9] ),
    .A2(_0516_),
    .B1(_0518_),
    .B2(_0519_),
    .C1(rst_drop),
    ...
    .VPWR(VPWR),
    .X(_0520_));
 sky130_fd_sc_hd__and3_2 _1182_ (.A(_0466_),
    .B(_0470_),
    .C(_0520_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0521_));
 sky130_fd_sc_hd__o21a_2 _1183_ (.A1(_0354_),
    .A2(_0386_),
    .B1(_0521_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0522_));
 sky130_fd_sc_hd__o41a_4 _1184_ (.A1(_0650_),
    .A2(_0377_),
    .A3(_0373_),
    .A4(_0383_),
    .B1(_0522_),
    ...
    .VPWR(VPWR),
    .X(_0523_));
 sky130_fd_sc_hd__or2_2 _1185_ (.A(_0431_),
    .B(_0432_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0524_));
 sky130_fd_sc_hd__nand2_2 _1186_ (.A(_0433_),
    .B(_0524_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0525_));
 sky130_fd_sc_hd__nor2_2 _1187_ (.A(_0649_),
    .B(_0525_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0526_));
 sky130_fd_sc_hd__xor2_2 _1188_ (.A(_0425_),
    .B(_0426_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0527_));
 sky130_fd_sc_hd__a211o_2 _1189_ (.A1(_0649_),
    .A2(_0527_),
    .B1(_0526_),
    .C1(net37),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0528_));
 sky130_fd_sc_hd__nand3_2 _1190_ (.A(_0430_),
    .B(_0433_),
    .C(_0435_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0529_));
 sky130_fd_sc_hd__nand2_2 _1191_ (.A(_0436_),
    .B(_0529_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0530_));
 sky130_fd_sc_hd__inv_2 _1192_ (.A(_0530_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0531_));
 sky130_fd_sc_hd__xnor2_2 _1193_ (.A(_0419_),
    .B(_0437_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0532_));
 sky130_fd_sc_hd__mux2_1 _1194_ (.A0(_0531_),
    .A1(_0532_),
    .S(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0533_));
 sky130_fd_sc_hd__o21a_2 _1195_ (.A1(_0647_),
    .A2(_0533_),
    .B1(_0528_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0534_));
 sky130_fd_sc_hd__nor2_2 _1196_ (.A(net38),
    .B(_0457_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0535_));
 sky130_fd_sc_hd__a21o_2 _1197_ (.A1(net38),
    .A2(_0468_),
    .B1(_0535_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0536_));
 sky130_fd_sc_hd__mux2_1 _1198_ (.A0(_0533_),
    .A1(_0536_),
    .S(net37),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0537_));
 sky130_fd_sc_hd__inv_2 _1199_ (.A(_0537_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0538_));
 sky130_fd_sc_hd__and2_2 _1200_ (.A(_0534_),
    .B(_0537_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0539_));
 sky130_fd_sc_hd__or2_2 _1201_ (.A(net44),
    .B(_0539_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0540_));
 sky130_fd_sc_hd__or2_2 _1202_ (.A(_0534_),
    .B(_0537_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0541_));
 sky130_fd_sc_hd__nand2_2 _1203_ (.A(_0540_),
    .B(_0541_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0542_));
 sky130_fd_sc_hd__mux2_1 _1204_ (.A0(_0525_),
    .A1(_0530_),
    .S(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0543_));
 sky130_fd_sc_hd__or2_2 _1205_ (.A(net39),
    .B(_0532_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0544_));
 sky130_fd_sc_hd__a21oi_2 _1206_ (.A1(net39),
    .A2(_0457_),
    .B1(_0647_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0545_));
 sky130_fd_sc_hd__a2bb2o_2 _1207_ (.A1_N(\a[1] ),
    .A2_N(_0543_),
    .B1(_0544_),
    .B2(_0545_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0546_));
 sky130_fd_sc_hd__and2_2 _1208_ (.A(_0538_),
    .B(_0546_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0547_));
 sky130_fd_sc_hd__mux2_1 _1209_ (.A0(_0547_),
    .A1(_0542_),
    .S(net3),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0548_));
 sky130_fd_sc_hd__nor2_2 _1210_ (.A(net10),
    .B(_0548_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0549_));
 sky130_fd_sc_hd__or2_2 _1211_ (.A(_0537_),
    .B(_0546_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0550_));
 sky130_fd_sc_hd__inv_2 _1212_ (.A(_0550_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0551_));
 sky130_fd_sc_hd__nor2_2 _1213_ (.A(_0534_),
    .B(_0550_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0552_));
 sky130_fd_sc_hd__and4b_2 _1214_ (.A_N(_0527_),
    .B(_0552_),
    .C(_0530_),
    .D(_0525_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0553_));
 sky130_fd_sc_hd__a211o_2 _1215_ (.A1(net10),
    .A2(_0548_),
    .B1(_0549_),
    .C1(_0553_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0554_));
 sky130_fd_sc_hd__o311a_4 _1216_ (.A1(\g_x[2] ),
    .A2(_0356_),
    .A3(_0327_),
    .B1(_0523_),
    .C1(_0554_),
    ...
    .VPWR(VPWR),
    .X(uo_out[6]));
 sky130_fd_sc_hd__and2_2 _1217_ (.A(_0537_),
    .B(_0546_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0555_));
 sky130_fd_sc_hd__nor2_2 _1218_ (.A(net44),
    .B(_0555_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0556_));
 sky130_fd_sc_hd__nand2_2 _1219_ (.A(_0541_),
    .B(_0550_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0557_));
 sky130_fd_sc_hd__o22a_2 _1220_ (.A1(net3),
    .A2(_0551_),
    .B1(_0556_),
    .B2(_0557_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0558_));
 sky130_fd_sc_hd__o21bai_2 _1221_ (.A1(net10),
    .A2(_0558_),
    .B1_N(_0553_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0559_));
 sky130_fd_sc_hd__a21o_2 _1222_ (.A1(net10),
    .A2(_0558_),
    .B1(_0559_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0560_));
 sky130_fd_sc_hd__o311a_4 _1223_ (.A1(\g_x[2] ),
    .A2(_0356_),
    .A3(_0327_),
    .B1(_0523_),
    .C1(_0560_),
    ...
    .VPWR(VPWR),
    .X(uo_out[2]));
 sky130_fd_sc_hd__o21a_2 _1224_ (.A1(_0534_),
    .A2(_0546_),
    .B1(_0557_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0561_));
 sky130_fd_sc_hd__nand2_2 _1225_ (.A(net44),
    .B(_0561_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0562_));
 sky130_fd_sc_hd__a21oi_2 _1226_ (.A1(_0540_),
    .A2(_0562_),
    .B1(net3),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0563_));
 sky130_fd_sc_hd__o21ai_2 _1227_ (.A1(net44),
    .A2(_0546_),
    .B1(net3),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0564_));
 sky130_fd_sc_hd__a2111oi_2 _1228_ (.A1(net44),
    .A2(_0534_),
    .B1(_0551_),
    .C1(_0555_),
    .D1(_0564_),
    ...
    .VPWR(VPWR),
    .Y(_0565_));
 sky130_fd_sc_hd__or2_2 _1229_ (.A(_0563_),
    .B(_0565_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0566_));
 sky130_fd_sc_hd__a21oi_2 _1230_ (.A1(net10),
    .A2(_0566_),
    .B1(_0553_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0567_));
 sky130_fd_sc_hd__o21ai_2 _1231_ (.A1(net10),
    .A2(_0566_),
    .B1(_0567_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0568_));
 sky130_fd_sc_hd__o311a_4 _1232_ (.A1(\g_x[2] ),
    .A2(_0356_),
    .A3(_0327_),
    .B1(_0523_),
    .C1(_0568_),
    ...
    .VPWR(VPWR),
    .X(uo_out[5]));
 sky130_fd_sc_hd__or3b_2 _1233_ (.A(_0555_),
    .B(_0557_),
    .C_N(net44),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0569_));
 sky130_fd_sc_hd__o211ai_2 _1234_ (.A1(net44),
    .A2(_0550_),
    .B1(_0569_),
    .C1(net3),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0570_));
 sky130_fd_sc_hd__o31a_2 _1235_ (.A1(net3),
    .A2(_0552_),
    .A3(_0556_),
    .B1(_0570_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0571_));
 sky130_fd_sc_hd__o21ba_2 _1236_ (.A1(net10),
    .A2(_0571_),
    .B1_N(_0553_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0572_));
 sky130_fd_sc_hd__a21bo_2 _1237_ (.A1(net10),
    .A2(_0571_),
    .B1_N(_0572_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0573_));
 sky130_fd_sc_hd__o311a_4 _1238_ (.A1(\g_x[2] ),
    .A2(_0356_),
    .A3(_0327_),
    .B1(_0523_),
    .C1(_0573_),
    ...
    .VPWR(VPWR),
    .X(uo_out[1]));
 sky130_fd_sc_hd__a21bo_2 _1239_ (.A1(_0534_),
    .A2(_0546_),
    .B1_N(net3),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0574_));
 sky130_fd_sc_hd__a211o_2 _1240_ (.A1(_0534_),
    .A2(_0538_),
    .B1(_0547_),
    .C1(_0574_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0575_));
 sky130_fd_sc_hd__o21a_2 _1241_ (.A1(net3),
    .A2(_0539_),
    .B1(net44),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0576_));
 sky130_fd_sc_hd__o2bb2a_2 _1242_ (.A1_N(_0575_),
    .A2_N(_0576_),
    .B1(net44),
    .B2(_0561_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0577_));
 sky130_fd_sc_hd__o21ba_2 _1243_ (.A1(net10),
    .A2(_0577_),
    .B1_N(_0553_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0578_));
 sky130_fd_sc_hd__a21bo_2 _1244_ (.A1(net10),
    .A2(_0577_),
    .B1_N(_0578_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0579_));
 sky130_fd_sc_hd__o311a_4 _1245_ (.A1(\g_x[2] ),
    .A2(_0356_),
    .A3(_0327_),
    .B1(_0523_),
    .C1(_0579_),
    ...
    .VPWR(VPWR),
    .X(uo_out[4]));
 sky130_fd_sc_hd__o221a_2 _1246_ (.A1(net3),
    .A2(_0555_),
    .B1(_0574_),
    .B2(_0547_),
    .C1(net44),
    ...
    .VPWR(VPWR),
    .X(_0580_));
 sky130_fd_sc_hd__o21ba_2 _1247_ (.A1(net2),
    .A2(_0552_),
    .B1_N(_0580_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0581_));
 sky130_fd_sc_hd__o21ba_2 _1248_ (.A1(_0520_),
    .A2(_0581_),
    .B1_N(_0553_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0582_));
 sky130_fd_sc_hd__a21bo_2 _1249_ (.A1(_0520_),
    .A2(_0581_),
    .B1_N(_0582_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0583_));
 sky130_fd_sc_hd__o311a_4 _1250_ (.A1(\g_x[2] ),
    .A2(_0356_),
    .A3(_0327_),
    .B1(_0523_),
    .C1(_0583_),
    ...
    .VPWR(VPWR),
    .X(uo_out[0]));
 sky130_fd_sc_hd__xnor2_2 _1251_ (.A(net28),
    .B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0584_));
 sky130_fd_sc_hd__nand2_2 _1252_ (.A(\g_x[0] ),
    .B(\g_x[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0585_));
 sky130_fd_sc_hd__or2_2 _1253_ (.A(_0650_),
    .B(_0585_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0586_));
 sky130_fd_sc_hd__nor2_2 _1254_ (.A(_0649_),
    .B(_0586_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0587_));
 sky130_fd_sc_hd__and3_2 _1255_ (.A(_0070_),
    .B(_0584_),
    .C(_0587_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0588_));
 sky130_fd_sc_hd__o21a_2 _1256_ (.A1(_0642_),
    .A2(_0389_),
    .B1(_0648_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0589_));
 sky130_fd_sc_hd__mux2_1 _1257_ (.A0(\hpos[10] ),
    .A1(\hpos[9] ),
    .S(net5),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0590_));
 sky130_fd_sc_hd__a21o_2 _1258_ (.A1(_0652_),
    .A2(_0653_),
    .B1(_0590_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0591_));
 sky130_fd_sc_hd__inv_2 _1259_ (.A(_0591_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0592_));
 sky130_fd_sc_hd__or2_2 _1260_ (.A(net34),
    .B(net40),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0593_));
 sky130_fd_sc_hd__o211a_2 _1261_ (.A1(net29),
    .A2(_0390_),
    .B1(_0592_),
    .C1(_0593_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0594_));
 sky130_fd_sc_hd__o211a_2 _1262_ (.A1(_0655_),
    .A2(_0589_),
    .B1(_0594_),
    .C1(_0588_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0595_));
 sky130_fd_sc_hd__mux2_1 _1263_ (.A0(_0390_),
    .A1(_0389_),
    .S(_0037_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0596_));
 sky130_fd_sc_hd__nand2_2 _1264_ (.A(net34),
    .B(_0656_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0597_));
 sky130_fd_sc_hd__and4_2 _1265_ (.A(_0070_),
    .B(_0593_),
    .C(_0596_),
    .D(_0597_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0598_));
 sky130_fd_sc_hd__nand4_2 _1266_ (.A(_0584_),
    .B(_0587_),
    .C(_0592_),
    .D(_0598_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0599_));
 sky130_fd_sc_hd__and2_2 _1267_ (.A(net45),
    .B(_0599_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0600_));
 sky130_fd_sc_hd__and3_2 _1268_ (.A(_0641_),
    .B(net45),
    .C(_0599_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0012_));
 sky130_fd_sc_hd__and3b_2 _1269_ (.A_N(_0374_),
    .B(_0585_),
    .C(net16),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0013_));
 sky130_fd_sc_hd__nand2_2 _1270_ (.A(_0650_),
    .B(_0585_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0601_));
 sky130_fd_sc_hd__and3_2 _1271_ (.A(_0586_),
    .B(net16),
    .C(_0601_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0014_));
 sky130_fd_sc_hd__nand2_2 _1272_ (.A(_0649_),
    .B(_0586_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0602_));
 sky130_fd_sc_hd__and3b_2 _1273_ (.A_N(_0587_),
    .B(_0602_),
    .C(net45),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0015_));
 sky130_fd_sc_hd__o21ai_2 _1274_ (.A1(net36),
    .A2(_0587_),
    .B1(net16),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0603_));
 sky130_fd_sc_hd__a21oi_2 _1275_ (.A1(net36),
    .A2(_0587_),
    .B1(_0603_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0016_));
 sky130_fd_sc_hd__and3_2 _1276_ (.A(net36),
    .B(net34),
    .C(_0587_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0604_));
 sky130_fd_sc_hd__a21o_2 _1277_ (.A1(net36),
    .A2(_0587_),
    .B1(net34),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0605_));
 sky130_fd_sc_hd__and3b_2 _1278_ (.A_N(_0604_),
    .B(_0605_),
    .C(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0017_));
 sky130_fd_sc_hd__o21ai_2 _1279_ (.A1(net32),
    .A2(_0604_),
    .B1(net16),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0606_));
 sky130_fd_sc_hd__a21oi_2 _1280_ (.A1(net32),
    .A2(_0604_),
    .B1(_0606_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0018_));
 sky130_fd_sc_hd__a21o_2 _1281_ (.A1(net32),
    .A2(_0604_),
    .B1(net29),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0607_));
 sky130_fd_sc_hd__and3_2 _1282_ (.A(net30),
    .B(net32),
    .C(_0604_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0608_));
 sky130_fd_sc_hd__and3b_2 _1283_ (.A_N(_0608_),
    .B(net15),
    .C(_0607_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0019_));
 sky130_fd_sc_hd__o21ai_2 _1284_ (.A1(net28),
    .A2(_0608_),
    .B1(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0609_));
 sky130_fd_sc_hd__a21oi_2 _1285_ (.A1(net28),
    .A2(_0608_),
    .B1(_0609_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0020_));
 sky130_fd_sc_hd__a21o_2 _1286_ (.A1(net28),
    .A2(_0608_),
    .B1(\hpos[9] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0610_));
 sky130_fd_sc_hd__and3_2 _1287_ (.A(\hpos[9] ),
    .B(net28),
    .C(_0608_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0611_));
 sky130_fd_sc_hd__and3b_2 _1288_ (.A_N(_0611_),
    .B(net15),
    .C(_0610_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0021_));
 sky130_fd_sc_hd__a21boi_2 _1289_ (.A1(\hpos[10] ),
    .A2(_0611_),
    .B1_N(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0612_));
 sky130_fd_sc_hd__o21a_2 _1290_ (.A1(\hpos[10] ),
    .A2(_0611_),
    .B1(_0612_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0022_));
 sky130_fd_sc_hd__o21ai_2 _1291_ (.A1(\hvsync_gen.vpos[2] ),
    .A2(net20),
    ...
    .VPWR(VPWR),
    .Y(_0613_));
 sky130_fd_sc_hd__a21o_2 _1292_ (.A1(\hvsync_gen.vpos[2] ),
    .A2(net20),
    .B1(\hvsync_gen.vpos[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0614_));
 sky130_fd_sc_hd__a31o_2 _1293_ (.A1(net27),
    ...
    .VPWR(VPWR),
    .X(_0615_));
 sky130_fd_sc_hd__or2_2 _1294_ (.A(net23),
    .B(\hvsync_gen.vpos[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0616_));
 sky130_fd_sc_hd__a211oi_2 _1295_ (.A1(_0642_),
    .A2(_0646_),
    .B1(\hvsync_gen.vpos[5] ),
    ...
    .VPWR(VPWR),
    .Y(_0617_));
 sky130_fd_sc_hd__nand2_2 _1296_ (.A(net23),
    .B(\hvsync_gen.vpos[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0618_));
 sky130_fd_sc_hd__mux2_1 _1297_ (.A0(_0618_),
    .A1(_0616_),
    .S(_0657_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0619_));
 sky130_fd_sc_hd__or4_2 _1298_ (.A(\hvsync_gen.vpos[7] ),
    .B(_0051_),
    .C(_0053_),
    .D(_0619_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0620_));
 sky130_fd_sc_hd__o2111ai_2 _1299_ (.A1(net42),
    .A2(_0617_),
    .B1(_0615_),
    .C1(_0614_),
    .D1(_0613_),
    ...
    .VPWR(VPWR),
    .Y(_0621_));
 sky130_fd_sc_hd__o211a_2 _1300_ (.A1(_0620_),
    .A2(_0621_),
    .B1(net45),
    .C1(_0595_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0622_));
 sky130_fd_sc_hd__mux2_1 _1301_ (.A0(_0622_),
    .A1(net15),
    .S(net27),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0023_));
 sky130_fd_sc_hd__a22o_2 _1302_ (.A1(net94),
    .A2(net16),
    .B1(_0622_),
    .B2(_0248_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0024_));
 sky130_fd_sc_hd__nand2_2 _1303_ (.A(net25),
    .B(_0043_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0623_));
 sky130_fd_sc_hd__a32o_2 _1304_ (.A1(_0046_),
    .A2(_0622_),
    .A3(_0623_),
    .B1(net15),
    .B2(net25),
    ...
    .VPWR(VPWR),
    .X(_0025_));
 sky130_fd_sc_hd__nor2_2 _1305_ (.A(_0646_),
    .B(_0623_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0624_));
 sky130_fd_sc_hd__and2_2 _1306_ (.A(_0646_),
    .B(_0623_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0625_));
 sky130_fd_sc_hd__nor2_2 _1307_ (.A(_0624_),
    .B(_0625_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0626_));
 sky130_fd_sc_hd__a22o_2 _1308_ (.A1(net24),
    .A2(net15),
    .B1(_0622_),
    .B2(_0626_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0026_));
 sky130_fd_sc_hd__or2_2 _1309_ (.A(\hvsync_gen.vpos[4] ),
    .B(_0624_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0627_));
 sky130_fd_sc_hd__nand2_2 _1310_ (.A(\hvsync_gen.vpos[4] ),
    .B(_0624_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0628_));
 sky130_fd_sc_hd__a32o_2 _1311_ (.A1(_0622_),
    .A2(_0627_),
    .A3(_0628_),
    .B1(net15),
    .B2(net95),
    ...
    .VPWR(VPWR),
    .X(_0027_));
 sky130_fd_sc_hd__and2_2 _1312_ (.A(_0644_),
    .B(_0628_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0629_));
 sky130_fd_sc_hd__nor2_2 _1313_ (.A(_0644_),
    .B(_0628_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0630_));
 sky130_fd_sc_hd__nor2_2 _1314_ (.A(_0629_),
    .B(_0630_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0631_));
 sky130_fd_sc_hd__a22o_2 _1315_ (.A1(\hvsync_gen.vpos[5] ),
    .A2(net15),
    .B1(_0622_),
    .B2(_0631_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0028_));
 sky130_fd_sc_hd__or2_2 _1316_ (.A(net22),
    .B(_0630_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0632_));
 sky130_fd_sc_hd__and2_2 _1317_ (.A(net22),
    .B(_0630_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0633_));
 sky130_fd_sc_hd__inv_2 _1318_ (.A(_0633_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0634_));
 sky130_fd_sc_hd__a32o_2 _1319_ (.A1(_0622_),
    .A2(_0632_),
    .A3(_0634_),
    .B1(net16),
    .B2(net22),
    ...
    .VPWR(VPWR),
    .X(_0029_));
 sky130_fd_sc_hd__nor2_2 _1320_ (.A(\hvsync_gen.vpos[7] ),
    .B(_0633_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0635_));
 sky130_fd_sc_hd__and3_2 _1321_ (.A(net23),
    .B(\hvsync_gen.vpos[7] ),
    .C(_0630_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0636_));
 sky130_fd_sc_hd__nor2_2 _1322_ (.A(_0635_),
    .B(_0636_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0637_));
 sky130_fd_sc_hd__a22o_2 _1323_ (.A1(\hvsync_gen.vpos[7] ),
    .A2(net16),
    .B1(_0622_),
    .B2(_0637_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0030_));
 sky130_fd_sc_hd__nand2_2 _1324_ (.A(net67),
    .B(_0636_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0638_));
 sky130_fd_sc_hd__a21o_2 _1325_ (.A1(_0622_),
    .A2(_0638_),
    .B1(net16),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0639_));
 sky130_fd_sc_hd__and2_2 _1326_ (.A(_0622_),
    .B(_0636_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0640_));
 sky130_fd_sc_hd__o21a_2 _1327_ (.A1(net67),
    .A2(_0640_),
    .B1(_0639_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0031_));
 sky130_fd_sc_hd__a22o_2 _1328_ (.A1(net93),
    .A2(_0639_),
    .B1(_0640_),
    .B2(net69),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0032_));
 sky130_fd_sc_hd__a31o_2 _1329_ (.A1(\frame[8] ),
    .A2(\frame[9] ),
    .A3(_0087_),
    .B1(rst_drop),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0033_));
 sky130_fd_sc_hd__dfxtp_2 _1330_ (.CLK(clknet_2_2__leaf_clk),
    .D(_0012_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\g_x[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1331_ (.CLK(clknet_2_2__leaf_clk),
    .D(_0013_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\g_x[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1332_ (.CLK(clknet_2_2__leaf_clk),
    .D(_0014_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\g_x[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1333_ (.CLK(clknet_2_2__leaf_clk),
    .D(_0015_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1336_ (.CLK(clknet_2_3__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\b[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1337_ (.CLK(clknet_2_3__leaf_clk),
    .D(_0019_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\b[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1338_ (.CLK(clknet_2_1__leaf_clk),
    .D(_0020_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\b[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1339_ (.CLK(clknet_2_1__leaf_clk),
    .D(_0021_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hpos[9] ));
 sky130_fd_sc_hd__dfxtp_2 _1340_ (.CLK(clknet_2_1__leaf_clk),
    .D(_0022_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hpos[10] ));
 sky130_fd_sc_hd__dfxtp_2 _1341_ (.CLK(clknet_2_0__leaf_clk),
    .D(_0023_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.vpos[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1342_ (.CLK(clknet_2_2__leaf_clk),
    .D(_0024_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.vpos[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1343_ (.CLK(clknet_2_0__leaf_clk),
    .D(_0025_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1346_ (.CLK(clknet_2_0__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\hvsync_gen.vpos[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1347_ (.CLK(clknet_2_1__leaf_clk),
    .D(_0029_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.vpos[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1348_ (.CLK(clknet_2_1__leaf_clk),
    .D(_0030_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.vpos[7] ));
 sky130_fd_sc_hd__dfxtp_4 _1349_ (.CLK(clknet_2_1__leaf_clk),
    .D(_0031_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.vpos[8] ));
 sky130_fd_sc_hd__dfxtp_4 _1350_ (.CLK(clknet_2_0__leaf_clk),
    .D(_0032_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.vpos[9] ));
 sky130_fd_sc_hd__dfrtp_2 _1351_ (.CLK(net21),
    .D(_0033_),
    .RESET_B(net45),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(rst_drop));
 sky130_fd_sc_hd__dfrtp_2 _1352_ (.CLK(net21),
    .D(_0002_),
    .RESET_B(net45),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\frame[0] ));
 sky130_fd_sc_hd__dfrtp_2 _1353_ (.CLK(net21),
    .D(_0003_),
    .RESET_B(net45),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\frame[1] ));
 sky130_fd_sc_hd__dfrtp_2 _1354_ (.CLK(net21),
    .D(_0004_),
    .RESET_B(net45),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\frame[2] ));
 sky130_fd_sc_hd__dfrtp_2 _1355_ (.CLK(net21),
    .D(_0005_),
    .RESET_B(net46),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\frame[3] ));
 sky130_fd_sc_hd__dfrtp_2 _1356_ (.CLK(net21),
    .D(_0006_),
    .RESET_B(net46),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\frame[4] ));
 sky130_fd_sc_hd__dfrtp_2 _1357_ (.CLK(net21),
    .D(_0007_),
    .RESET_B(net46),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\frame[5] ));
 sky130_fd_sc_hd__dfrtp_2 _1358_ (.CLK(\hvsync_gen.vsync ),
    .D(_0008_),
    .RESET_B(net46),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\frame[6] ));
 sky130_fd_sc_hd__dfrtp_2 _1359_ (.CLK(\hvsync_gen.vsync ),
    .D(_0009_),
    .RESET_B(net46),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\frame[7] ));
 sky130_fd_sc_hd__dfrtp_2 _1360_ (.CLK(net21),
    .D(_0010_),
    .RESET_B(net45),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\frame[8] ));
 sky130_fd_sc_hd__dfrtp_2 _1361_ (.CLK(net21),
    .D(_0011_),
    .RESET_B(net45),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\frame[9] ));
 sky130_fd_sc_hd__dfxtp_2 _1362_ (.CLK(clknet_2_2__leaf_clk),
    .D(_0001_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.vsync ));
 sky130_fd_sc_hd__dfxtp_2 _1363_ (.CLK(clknet_2_3__leaf_clk),
    .D(_0000_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(hsync));
 sky130_fd_sc_hd__buf_2 _1380_ (.A(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[3]));
 sky130_fd_sc_hd__buf_2 _1381_ (.A(hsync),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 clkload0 (.A(clknet_2_3__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout10 (.A(_0520_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net10));
 sky130_fd_sc_hd__clkbuf_2 fanout11 (.A(_0219_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout16 (.A(_0600_),
    ...
    .VPWR(VPWR),
    .X(net16));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout17 (.A(_0394_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net17));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout18 (.A(_0394_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net18));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout20 (.A(_0659_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net20));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout21 (.A(\hvsync_gen.vsync ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout22 (.A(net23),
    ...
    .VPWR(VPWR),
    .X(net22));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout23 (.A(\hvsync_gen.vpos[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net23));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout24 (.A(\hvsync_gen.vpos[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net24));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout25 (.A(\hvsync_gen.vpos[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net25));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout26 (.A(\hvsync_gen.vpos[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net26));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout27 (.A(\hvsync_gen.vpos[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net27));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout28 (.A(\b[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout29 (.A(net30),
    ...
    .VPWR(VPWR),
    .X(net29));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout30 (.A(\b[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout32 (.A(net33),
    ...
    .VPWR(VPWR),
    .X(net32));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout33 (.A(\b[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net33));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout34 (.A(\b[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net34));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout35 (.A(\b[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout36 (.A(net37),
    ...
    .VPWR(VPWR),
    .X(net36));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout37 (.A(\a[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout38 (.A(net39),
    ...
    .VPWR(VPWR),
    .X(net38));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout39 (.A(\a[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net39));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout40 (.A(_0656_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net40));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout41 (.A(_0654_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net41));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout42 (.A(net5),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold93 (.A(\hvsync_gen.vpos[9] ),
    ...
    .VPWR(VPWR),
    .X(net93));
 sky130_fd_sc_hd__dlygate4sd3_1 hold94 (.A(\hvsync_gen.vpos[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net94));
 sky130_fd_sc_hd__dlygate4sd3_1 hold95 (.A(\hvsync_gen.vpos[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 input5 (.A(ui_in[7]),
    ...
    .VPWR(VPWR),
    .X(net5));
 sky130_fd_sc_hd__buf_6 max_cap13 (.A(_0197_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net13));
 sky130_fd_sc_hd__buf_2 max_cap14 (.A(_0122_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net14));
 sky130_fd_sc_hd__buf_2 max_cap19 (.A(_0391_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net19));
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap7 (.A(_0339_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net7));
 sky130_fd_sc_hd__clkbuf_4 max_cap9 (.A(_0237_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__buf_2 rebuffer62 (.A(_0194_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net62));
 sky130_fd_sc_hd__buf_4 rebuffer63 (.A(_0111_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net63));
 sky130_fd_sc_hd__buf_2 rebuffer64 (.A(_0114_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net64));
 sky130_fd_sc_hd__buf_2 rebuffer65 (.A(_0104_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net65));
 sky130_fd_sc_hd__buf_4 rebuffer66 (.A(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net66));
 sky130_fd_sc_hd__buf_2 rebuffer67 (.A(\hvsync_gen.vpos[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net67));
 sky130_fd_sc_hd__buf_2 rebuffer68 (.A(\hvsync_gen.vpos[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net68));
 sky130_fd_sc_hd__buf_2 rebuffer69 (.A(_0055_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net69));
 sky130_fd_sc_hd__buf_2 rebuffer70 (.A(_0217_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net70));
 sky130_fd_sc_hd__buf_6 rebuffer71 (.A(_0174_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net71));
 sky130_fd_sc_hd__buf_4 rebuffer72 (.A(_0214_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net72));
 sky130_fd_sc_hd__buf_2 rebuffer73 (.A(_0202_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net73));
 sky130_fd_sc_hd__buf_2 rebuffer74 (.A(\hvsync_gen.vpos[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net74));
 sky130_fd_sc_hd__buf_2 rebuffer75 (.A(\hvsync_gen.vpos[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net75));
 sky130_fd_sc_hd__buf_2 rebuffer76 (.A(_0112_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net76));
 sky130_fd_sc_hd__buf_2 rebuffer77 (.A(_0177_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net77));
 sky130_fd_sc_hd__buf_2 rebuffer78 (.A(_0143_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net78));
 sky130_fd_sc_hd__buf_2 rebuffer79 (.A(_0152_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net79));
 sky130_fd_sc_hd__buf_2 rebuffer80 (.A(_0153_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net80));
 sky130_fd_sc_hd__buf_2 rebuffer81 (.A(_0094_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net81));
 sky130_fd_sc_hd__buf_2 rebuffer82 (.A(_0252_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net82));
 sky130_fd_sc_hd__buf_2 rebuffer83 (.A(net71),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net83));
 sky130_fd_sc_hd__buf_2 rebuffer90 (.A(_0170_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net90));
 sky130_fd_sc_hd__buf_2 rebuffer91 (.A(_0096_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net91));
 sky130_fd_sc_hd__buf_2 rebuffer92 (.A(_0097_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net92));
 sky130_fd_sc_hd__conb_1 tt_um_vga_glyph_mode_clone (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 tt_um_vga_glyph_mode_clone_47 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net47));
 sky130_fd_sc_hd__conb_1 tt_um_vga_glyph_mode_clone_48 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net48));
 sky130_fd_sc_hd__conb_1 tt_um_vga_glyph_mode_clone_49 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net49));
 sky130_fd_sc_hd__conb_1 tt_um_vga_glyph_mode_clone_50 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net50));
 sky130_fd_sc_hd__conb_1 tt_um_vga_glyph_mode_clone_51 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net51));
 sky130_fd_sc_hd__conb_1 tt_um_vga_glyph_mode_clone_52 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net52));
 sky130_fd_sc_hd__conb_1 tt_um_vga_glyph_mode_clone_53 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net53));
 sky130_fd_sc_hd__conb_1 tt_um_vga_glyph_mode_clone_54 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net54));
 sky130_fd_sc_hd__conb_1 tt_um_vga_glyph_mode_clone_55 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net55));
 sky130_fd_sc_hd__conb_1 tt_um_vga_glyph_mode_clone_56 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net56));
 sky130_fd_sc_hd__conb_1 tt_um_vga_glyph_mode_clone_57 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net57));
 sky130_fd_sc_hd__conb_1 tt_um_vga_glyph_mode_clone_58 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net58));
 sky130_fd_sc_hd__conb_1 tt_um_vga_glyph_mode_clone_59 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net59));
 sky130_fd_sc_hd__conb_1 tt_um_vga_glyph_mode_clone_60 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net60));
 sky130_fd_sc_hd__conb_1 tt_um_vga_glyph_mode_clone_61 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net61));
 sky130_fd_sc_hd__buf_2 wire12 (.A(_0218_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net12));
 sky130_fd_sc_hd__clkbuf_4 wire43 (.A(net4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net43));
 sky130_fd_sc_hd__clkdlybuf4s25_1 wire6 (.A(_0339_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
