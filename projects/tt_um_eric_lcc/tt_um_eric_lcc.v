module tt_um_eric_lcc (clk,
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_137 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _0576_ (.A(\color_index[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0063_));
 sky130_fd_sc_hd__inv_2 _0577_ (.A(net43),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0064_));
 sky130_fd_sc_hd__inv_2 _0578_ (.A(net44),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0065_));
 sky130_fd_sc_hd__inv_2 _0579_ (.A(\logo_top[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0066_));
 sky130_fd_sc_hd__inv_2 _0580_ (.A(\logo_top[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0067_));
 sky130_fd_sc_hd__inv_2 _0581_ (.A(\logo_left[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0068_));
 sky130_fd_sc_hd__inv_2 _0582_ (.A(\logo_left[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0069_));
 sky130_fd_sc_hd__inv_2 _0583_ (.A(net91),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0070_));
 sky130_fd_sc_hd__inv_2 _0584_ (.A(\pix_y[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0071_));
 sky130_fd_sc_hd__inv_2 _0585_ (.A(\pix_y[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0072_));
 sky130_fd_sc_hd__inv_2 _0586_ (.A(\pix_y[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0073_));
 sky130_fd_sc_hd__inv_2 _0587_ (.A(\pix_y[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0074_));
 sky130_fd_sc_hd__inv_2 _0588_ (.A(\pix_y[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0075_));
 sky130_fd_sc_hd__inv_2 _0589_ (.A(\pix_y[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0076_));
 sky130_fd_sc_hd__inv_2 _0590_ (.A(\pix_y[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0077_));
 sky130_fd_sc_hd__inv_2 _0591_ (.A(\prev_y[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0078_));
 sky130_fd_sc_hd__inv_2 _0592_ (.A(\prev_y[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0079_));
 sky130_fd_sc_hd__inv_2 _0593_ (.A(\prev_y[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _0594_ (.A(net45),
    ...
    .VPWR(VPWR),
    .Y(_0081_));
 sky130_fd_sc_hd__inv_2 _0595_ (.A(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0082_));
 sky130_fd_sc_hd__nand4_2 _0596_ (.A(\pix_y[5] ),
    .B(\pix_y[6] ),
    .C(\pix_y[7] ),
    .D(\pix_y[8] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0083_));
 sky130_fd_sc_hd__or4b_2 _0597_ (.A(_0072_),
    .B(\pix_y[4] ),
    .C(\pix_y[9] ),
    .D_N(\pix_y[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0084_));
 sky130_fd_sc_hd__and2_2 _0598_ (.A(\pix_y[2] ),
    .B(\pix_y[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0085_));
 sky130_fd_sc_hd__or3_2 _0599_ (.A(_0083_),
    .B(_0084_),
    .C(_0085_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0001_));
 sky130_fd_sc_hd__and3_2 _0600_ (.A(\pix_x[4] ),
    .B(\pix_x[5] ),
    .C(\pix_x[6] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0086_));
 sky130_fd_sc_hd__o311a_2 _0601_ (.A1(\pix_x[4] ),
    .A2(\pix_x[5] ),
    .A3(\pix_x[6] ),
    .B1(\pix_x[7] ),
    .C1(\pix_x[9] ),
    ...
    .VPWR(VPWR),
    .X(_0087_));
 sky130_fd_sc_hd__or3b_2 _0602_ (.A(\pix_x[8] ),
    .B(_0086_),
    .C_N(_0087_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0000_));
 sky130_fd_sc_hd__and3_2 _0603_ (.A(\pix_x[0] ),
    .B(\pix_x[1] ),
    .C(\pix_x[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0088_));
 sky130_fd_sc_hd__and2_2 _0604_ (.A(\pix_x[3] ),
    .B(_0088_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0089_));
 sky130_fd_sc_hd__and3_2 _0605_ (.A(\pix_x[3] ),
    .B(\pix_x[4] ),
    .C(_0088_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0090_));
 sky130_fd_sc_hd__nand3b_2 _0606_ (.A_N(\pix_x[7] ),
    .B(\pix_x[8] ),
    .C(\pix_x[9] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0091_));
 sky130_fd_sc_hd__or4b_2 _0607_ (.A(\pix_x[5] ),
    .B(_0091_),
    .C(\pix_x[6] ),
    .D_N(_0090_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0092_));
 sky130_fd_sc_hd__inv_2 _0608_ (.A(_0092_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0093_));
 sky130_fd_sc_hd__nor2_2 _0609_ (.A(_0081_),
    .B(_0093_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0094_));
 sky130_fd_sc_hd__or2_2 _0610_ (.A(\pix_y[0] ),
    .B(\pix_y[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0095_));
 sky130_fd_sc_hd__or2_2 _0611_ (.A(\pix_y[8] ),
    .B(_0095_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0096_));
 sky130_fd_sc_hd__or4_2 _0612_ (.A(\pix_y[4] ),
    .B(\pix_y[5] ),
    .C(\pix_y[6] ),
    .D(\pix_y[7] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0097_));
 sky130_fd_sc_hd__nand2_2 _0613_ (.A(\pix_y[9] ),
    .B(_0085_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0098_));
 sky130_fd_sc_hd__o311a_2 _0614_ (.A1(_0096_),
    .A2(_0097_),
    .A3(_0098_),
    .B1(_0093_),
    .C1(net50),
    ...
    .VPWR(VPWR),
    .X(_0099_));
 sky130_fd_sc_hd__mux2_1 _0615_ (.A0(net30),
    .A1(net29),
    .S(_0071_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0002_));
 sky130_fd_sc_hd__and3_2 _0616_ (.A(\pix_y[1] ),
    .B(net47),
    .C(_0092_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0100_));
 sky130_fd_sc_hd__nand2_2 _0617_ (.A(\pix_y[0] ),
    .B(\pix_y[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0101_));
 sky130_fd_sc_hd__a31o_2 _0618_ (.A1(_0095_),
    .A2(net29),
    .A3(_0101_),
    .B1(_0100_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0003_));
 sky130_fd_sc_hd__xnor2_2 _0619_ (.A(\pix_y[2] ),
    .B(_0101_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0102_));
 sky130_fd_sc_hd__a22o_2 _0620_ (.A1(\pix_y[2] ),
    .A2(net30),
    .B1(net29),
    .B2(_0102_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0004_));
 sky130_fd_sc_hd__a31o_2 _0621_ (.A1(\pix_y[0] ),
    .A2(\pix_y[1] ),
    .A3(\pix_y[2] ),
    .B1(\pix_y[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0103_));
 sky130_fd_sc_hd__and3_2 _0622_ (.A(\pix_y[0] ),
    .B(\pix_y[1] ),
    .C(_0085_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0104_));
 sky130_fd_sc_hd__and3b_2 _0623_ (.A_N(_0104_),
    .B(net29),
    .C(_0103_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0105_));
 sky130_fd_sc_hd__a21o_2 _0624_ (.A1(\pix_y[3] ),
    .A2(net30),
    .B1(_0105_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0005_));
 sky130_fd_sc_hd__or2_2 _0625_ (.A(\pix_y[4] ),
    .B(_0104_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0106_));
 sky130_fd_sc_hd__and2_2 _0626_ (.A(\pix_y[4] ),
    .B(_0104_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0107_));
 sky130_fd_sc_hd__and3b_2 _0627_ (.A_N(_0107_),
    .B(net29),
    .C(_0106_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0108_));
 sky130_fd_sc_hd__a21o_2 _0628_ (.A1(net90),
    .A2(net30),
    .B1(_0108_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0006_));
 sky130_fd_sc_hd__or2_2 _0629_ (.A(\pix_y[5] ),
    .B(_0107_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0109_));
 sky130_fd_sc_hd__and3_2 _0630_ (.A(\pix_y[4] ),
    .B(\pix_y[5] ),
    .C(_0104_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0110_));
 sky130_fd_sc_hd__and3b_2 _0631_ (.A_N(_0110_),
    .B(net29),
    .C(_0109_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0111_));
 sky130_fd_sc_hd__a21o_2 _0632_ (.A1(\pix_y[5] ),
    .A2(net30),
    .B1(_0111_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0007_));
 sky130_fd_sc_hd__nand2_2 _0633_ (.A(net93),
    .B(net31),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0112_));
 sky130_fd_sc_hd__and2_2 _0634_ (.A(\pix_y[6] ),
    .B(_0110_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0113_));
 sky130_fd_sc_hd__o21ai_2 _0635_ (.A1(\pix_y[6] ),
    .A2(_0110_),
    .B1(net29),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0114_));
 sky130_fd_sc_hd__o21ai_2 _0636_ (.A1(_0113_),
    .A2(_0114_),
    .B1(_0112_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0008_));
 sky130_fd_sc_hd__xnor2_2 _0637_ (.A(_0076_),
    .B(_0113_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0115_));
 sky130_fd_sc_hd__a22o_2 _0638_ (.A1(\pix_y[7] ),
    .A2(net31),
    .B1(net29),
    .B2(_0115_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0009_));
 sky130_fd_sc_hd__or3b_2 _0639_ (.A(_0076_),
    .B(_0077_),
    .C_N(_0113_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0116_));
 sky130_fd_sc_hd__a21o_2 _0640_ (.A1(net29),
    .A2(_0116_),
    .B1(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0117_));
 sky130_fd_sc_hd__a31o_2 _0641_ (.A1(\pix_y[7] ),
    .A2(net29),
    .A3(_0113_),
    .B1(\pix_y[8] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0118_));
 sky130_fd_sc_hd__and2_2 _0642_ (.A(_0117_),
    .B(_0118_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0010_));
 sky130_fd_sc_hd__or3b_2 _0643_ (.A(_0116_),
    .B(\pix_y[9] ),
    .C_N(_0099_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0119_));
 sky130_fd_sc_hd__a21bo_2 _0644_ (.A1(\pix_y[9] ),
    .A2(_0117_),
    .B1_N(_0119_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0011_));
 sky130_fd_sc_hd__and2b_2 _0645_ (.A_N(net97),
    .B(net31),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0012_));
 sky130_fd_sc_hd__o21ai_2 _0646_ (.A1(net72),
    .A2(\pix_x[1] ),
    .B1(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0120_));
 sky130_fd_sc_hd__a21oi_2 _0647_ (.A1(net72),
    .A2(\pix_x[1] ),
    .B1(_0120_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0013_));
 sky130_fd_sc_hd__a21o_2 _0648_ (.A1(\pix_x[0] ),
    .A2(\pix_x[1] ),
    .B1(\pix_x[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0121_));
 sky130_fd_sc_hd__and3b_2 _0649_ (.A_N(_0088_),
    .B(_0121_),
    .C(net45),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0014_));
 sky130_fd_sc_hd__o21ai_2 _0650_ (.A1(net85),
    .A2(_0088_),
    .B1(net45),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0122_));
 sky130_fd_sc_hd__nor2_2 _0651_ (.A(_0089_),
    .B(_0122_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0015_));
 sky130_fd_sc_hd__o21ai_2 _0652_ (.A1(net86),
    .A2(_0089_),
    .B1(net45),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0123_));
 sky130_fd_sc_hd__nor2_2 _0653_ (.A(_0090_),
    .B(_0123_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0016_));
 sky130_fd_sc_hd__o21ai_2 _0654_ (.A1(\pix_x[5] ),
    .A2(_0090_),
    .B1(net30),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0124_));
 sky130_fd_sc_hd__a21oi_2 _0655_ (.A1(net83),
    .A2(_0090_),
    .B1(_0124_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0017_));
 sky130_fd_sc_hd__a21o_2 _0656_ (.A1(\pix_x[5] ),
    .A2(_0090_),
    .B1(\pix_x[6] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0125_));
 sky130_fd_sc_hd__and3_2 _0657_ (.A(\pix_x[5] ),
    .B(\pix_x[6] ),
    .C(_0090_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0126_));
 sky130_fd_sc_hd__and3b_2 _0658_ (.A_N(_0126_),
    .B(net30),
    .C(_0125_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0018_));
 sky130_fd_sc_hd__or2_2 _0659_ (.A(\pix_x[7] ),
    .B(_0126_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0127_));
 sky130_fd_sc_hd__and3_2 _0660_ (.A(\pix_x[7] ),
    .B(_0086_),
    .C(_0089_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0128_));
 sky130_fd_sc_hd__and3b_2 _0661_ (.A_N(_0128_),
    .B(net30),
    .C(_0127_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0019_));
 sky130_fd_sc_hd__and2_2 _0662_ (.A(\pix_x[8] ),
    .B(_0128_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0129_));
 sky130_fd_sc_hd__o21ai_2 _0663_ (.A1(\pix_x[8] ),
    .A2(_0128_),
    .B1(net30),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0130_));
 sky130_fd_sc_hd__nor2_2 _0664_ (.A(_0129_),
    .B(_0130_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0020_));
 sky130_fd_sc_hd__o21ai_2 _0665_ (.A1(\pix_x[9] ),
    .A2(_0129_),
    .B1(net30),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0131_));
 sky130_fd_sc_hd__a21oi_2 _0666_ (.A1(net88),
    .A2(_0129_),
    .B1(_0131_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0021_));
 sky130_fd_sc_hd__mux2_1 _0667_ (.A0(net74),
    .A1(\pix_y[0] ),
    .S(net50),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0022_));
 sky130_fd_sc_hd__mux2_1 _0668_ (.A0(net76),
    .A1(\pix_y[1] ),
    .S(net48),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0023_));
 sky130_fd_sc_hd__mux2_1 _0669_ (.A0(net67),
    .A1(\pix_y[2] ),
    .S(net50),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0024_));
 sky130_fd_sc_hd__mux2_1 _0670_ (.A0(net80),
    .A1(\pix_y[3] ),
    .S(net48),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0025_));
 sky130_fd_sc_hd__mux2_1 _0671_ (.A0(net70),
    .A1(\pix_y[4] ),
    .S(net50),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0026_));
 sky130_fd_sc_hd__mux2_1 _0672_ (.A0(net81),
    .A1(\pix_y[5] ),
    .S(net50),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0027_));
 sky130_fd_sc_hd__mux2_1 _0673_ (.A0(net68),
    .A1(\pix_y[6] ),
    .S(net48),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0028_));
 sky130_fd_sc_hd__mux2_1 _0674_ (.A0(net69),
    .A1(\pix_y[7] ),
    .S(net48),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _0675_ (.A0(net77),
    ...
    .VPWR(VPWR),
    .X(_0030_));
 sky130_fd_sc_hd__mux2_1 _0676_ (.A0(net79),
    .A1(\pix_y[9] ),
    .S(net50),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0031_));
 sky130_fd_sc_hd__xnor2_2 _0677_ (.A(\pix_y[9] ),
    .B(\prev_y[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0132_));
 sky130_fd_sc_hd__o2bb2a_2 _0678_ (.A1_N(_0073_),
    .A2_N(\prev_y[2] ),
    .B1(\prev_y[6] ),
    .B2(_0075_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0133_));
 sky130_fd_sc_hd__xnor2_2 _0679_ (.A(\pix_y[3] ),
    .B(\prev_y[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0134_));
 sky130_fd_sc_hd__xnor2_2 _0680_ (.A(\pix_y[5] ),
    .B(\prev_y[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0135_));
 sky130_fd_sc_hd__a22o_2 _0681_ (.A1(_0075_),
    .A2(\prev_y[6] ),
    .B1(_0079_),
    .B2(\pix_y[7] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0136_));
 sky130_fd_sc_hd__o221a_2 _0682_ (.A1(_0071_),
    .A2(\prev_y[0] ),
    .B1(\prev_y[2] ),
    .B2(_0073_),
    .C1(_0134_),
    ...
    .VPWR(VPWR),
    .X(_0137_));
 sky130_fd_sc_hd__a22o_2 _0683_ (.A1(_0071_),
    .A2(\prev_y[0] ),
    .B1(\prev_y[8] ),
    .B2(_0077_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0138_));
 sky130_fd_sc_hd__a221o_2 _0684_ (.A1(_0074_),
    .A2(\prev_y[4] ),
    .B1(_0080_),
    .B2(\pix_y[8] ),
    .C1(_0138_),
    ...
    .VPWR(VPWR),
    .X(_0139_));
 sky130_fd_sc_hd__o221a_2 _0685_ (.A1(\pix_y[1] ),
    .A2(_0078_),
    .B1(\prev_y[4] ),
    .B2(_0074_),
    .C1(_0133_),
    ...
    .VPWR(VPWR),
    .X(_0140_));
 sky130_fd_sc_hd__o22a_2 _0686_ (.A1(_0072_),
    .A2(\prev_y[1] ),
    .B1(_0079_),
    .B2(\pix_y[7] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0141_));
 sky130_fd_sc_hd__and4bb_2 _0687_ (.A_N(_0136_),
    .B_N(_0139_),
    .C(_0140_),
    .D(_0141_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0142_));
 sky130_fd_sc_hd__and4_2 _0688_ (.A(_0132_),
    .B(_0135_),
    .C(_0137_),
    .D(_0142_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0143_));
 sky130_fd_sc_hd__or3_2 _0689_ (.A(\pix_y[2] ),
    .B(\pix_y[3] ),
    .C(\pix_y[9] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0144_));
 sky130_fd_sc_hd__nor4_2 _0690_ (.A(_0096_),
    .B(_0097_),
    .C(_0143_),
    .D(_0144_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0145_));
 sky130_fd_sc_hd__or4_2 _0691_ (.A(_0096_),
    .B(_0097_),
    .C(_0143_),
    .D(_0144_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0146_));
 sky130_fd_sc_hd__or4_2 _0692_ (.A(_0096_),
    .B(_0097_),
    .C(_0143_),
    .D(_0144_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0147_));
 sky130_fd_sc_hd__o21ai_2 _0693_ (.A1(\logo_left[0] ),
    .A2(net17),
    .B1(net46),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0148_));
 sky130_fd_sc_hd__a21oi_2 _0694_ (.A1(net87),
    .A2(net17),
    .B1(_0148_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0032_));
 sky130_fd_sc_hd__and2b_2 _0695_ (.A_N(net44),
    .B(\logo_left[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0149_));
 sky130_fd_sc_hd__and2b_2 _0696_ (.A_N(\logo_left[1] ),
    .B(net44),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0150_));
 sky130_fd_sc_hd__nor2_2 _0697_ (.A(_0149_),
    .B(_0150_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0151_));
 sky130_fd_sc_hd__nand2_2 _0698_ (.A(\logo_left[0] ),
    .B(_0151_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0152_));
 sky130_fd_sc_hd__or2_2 _0699_ (.A(\logo_left[0] ),
    .B(_0151_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0153_));
 sky130_fd_sc_hd__a21o_2 _0700_ (.A1(_0152_),
    .A2(_0153_),
    .B1(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0154_));
 sky130_fd_sc_hd__o211a_2 _0701_ (.A1(\logo_left[1] ),
    .A2(net17),
    .B1(_0154_),
    .C1(net46),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0033_));
 sky130_fd_sc_hd__xor2_2 _0702_ (.A(net44),
    .B(\logo_left[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0155_));
 sky130_fd_sc_hd__a21oi_2 _0703_ (.A1(\logo_left[0] ),
    .A2(_0151_),
    .B1(_0149_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0156_));
 sky130_fd_sc_hd__nor2_2 _0704_ (.A(_0155_),
    .B(_0156_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0157_));
 sky130_fd_sc_hd__and2_2 _0705_ (.A(_0155_),
    .B(_0156_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0158_));
 sky130_fd_sc_hd__or2_2 _0706_ (.A(_0157_),
    .B(_0158_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0159_));
 sky130_fd_sc_hd__a221oi_2 _0707_ (.A1(_0070_),
    .A2(_0147_),
    .B1(_0159_),
    .B2(net17),
    .C1(_0081_),
    ...
    .VPWR(VPWR),
    .Y(_0034_));
 sky130_fd_sc_hd__a21o_2 _0708_ (.A1(_0065_),
    .A2(\logo_left[2] ),
    .B1(_0157_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0160_));
 sky130_fd_sc_hd__and2_2 _0709_ (.A(_0065_),
    .B(\logo_left[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0161_));
 sky130_fd_sc_hd__nor2_2 _0710_ (.A(_0065_),
    .B(\logo_left[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0162_));
 sky130_fd_sc_hd__or3_2 _0711_ (.A(_0160_),
    .B(_0161_),
    .C(_0162_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0163_));
 sky130_fd_sc_hd__o21ai_2 _0712_ (.A1(_0161_),
    .A2(_0162_),
    .B1(_0160_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0164_));
 sky130_fd_sc_hd__a21oi_2 _0713_ (.A1(_0163_),
    .A2(_0164_),
    .B1(_0147_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0165_));
 sky130_fd_sc_hd__a211o_2 _0714_ (.A1(net95),
    .A2(net15),
    .B1(_0165_),
    .C1(_0081_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0035_));
 sky130_fd_sc_hd__xnor2_2 _0715_ (.A(net44),
    .B(\logo_left[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0166_));
 sky130_fd_sc_hd__o21ba_2 _0716_ (.A1(_0160_),
    .A2(_0161_),
    .B1_N(_0162_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0167_));
 sky130_fd_sc_hd__and2_2 _0717_ (.A(_0166_),
    .B(_0167_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0168_));
 sky130_fd_sc_hd__nor2_2 _0718_ (.A(_0166_),
    .B(_0167_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0169_));
 sky130_fd_sc_hd__o21ai_2 _0719_ (.A1(_0168_),
    .A2(_0169_),
    .B1(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0170_));
 sky130_fd_sc_hd__o211a_2 _0720_ (.A1(\logo_left[4] ),
    .A2(net17),
    .B1(_0170_),
    .C1(net46),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0036_));
 sky130_fd_sc_hd__or2_2 _0721_ (.A(\logo_left[5] ),
    .B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0171_));
 sky130_fd_sc_hd__a21oi_2 _0722_ (.A1(_0065_),
    .A2(\logo_left[4] ),
    .B1(_0168_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0172_));
 sky130_fd_sc_hd__xnor2_2 _0723_ (.A(net44),
    .B(\logo_left[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0173_));
 sky130_fd_sc_hd__xnor2_2 _0724_ (.A(_0172_),
    .B(_0173_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0174_));
 sky130_fd_sc_hd__o211a_2 _0725_ (.A1(net15),
    .A2(_0174_),
    .B1(_0171_),
    .C1(net46),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0037_));
 sky130_fd_sc_hd__nor2_2 _0726_ (.A(_0065_),
    .B(\logo_left[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0175_));
 sky130_fd_sc_hd__nor2_2 _0727_ (.A(net44),
    .B(_0069_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0176_));
 sky130_fd_sc_hd__or2_2 _0728_ (.A(_0175_),
    .B(_0176_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0177_));
 sky130_fd_sc_hd__nand2_2 _0729_ (.A(_0168_),
    .B(_0173_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0178_));
 sky130_fd_sc_hd__o21ai_2 _0730_ (.A1(\logo_left[5] ),
    .A2(\logo_left[4] ),
    .B1(_0065_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0179_));
 sky130_fd_sc_hd__a21oi_2 _0731_ (.A1(_0178_),
    .A2(_0179_),
    .B1(_0177_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0180_));
 sky130_fd_sc_hd__a31o_2 _0732_ (.A1(_0177_),
    .A2(_0178_),
    .A3(_0179_),
    .B1(_0147_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0181_));
 sky130_fd_sc_hd__o221ai_2 _0733_ (.A1(_0069_),
    .A2(net16),
    .B1(_0180_),
    .B2(_0181_),
    .C1(net46),
    ...
    .VPWR(VPWR),
    .Y(_0038_));
 sky130_fd_sc_hd__a21o_2 _0734_ (.A1(\logo_left[7] ),
    .A2(net15),
    .B1(_0081_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0182_));
 sky130_fd_sc_hd__xnor2_2 _0735_ (.A(net44),
    .B(\logo_left[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0183_));
 sky130_fd_sc_hd__o21ai_2 _0736_ (.A1(_0176_),
    .A2(_0180_),
    .B1(_0183_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0184_));
 sky130_fd_sc_hd__or3_2 _0737_ (.A(_0176_),
    .B(_0180_),
    .C(_0183_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0185_));
 sky130_fd_sc_hd__a31o_2 _0738_ (.A1(net16),
    .A2(_0184_),
    .A3(_0185_),
    .B1(_0182_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0039_));
 sky130_fd_sc_hd__and2_2 _0739_ (.A(_0065_),
    .B(\logo_left[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0186_));
 sky130_fd_sc_hd__nor2_2 _0740_ (.A(_0065_),
    .B(\logo_left[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0187_));
 sky130_fd_sc_hd__nor2_2 _0741_ (.A(_0186_),
    .B(_0187_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0188_));
 sky130_fd_sc_hd__or3b_2 _0742_ (.A(_0177_),
    .B(_0178_),
    .C_N(_0183_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0189_));
 sky130_fd_sc_hd__a21o_2 _0743_ (.A1(_0068_),
    .A2(_0069_),
    .B1(net44),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0190_));
 sky130_fd_sc_hd__and3_2 _0744_ (.A(_0179_),
    .B(_0189_),
    .C(_0190_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0191_));
 sky130_fd_sc_hd__xnor2_2 _0745_ (.A(_0188_),
    .B(_0191_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0192_));
 sky130_fd_sc_hd__or2_2 _0746_ (.A(\logo_left[8] ),
    .B(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0193_));
 sky130_fd_sc_hd__o211a_2 _0747_ (.A1(net15),
    .A2(_0192_),
    .B1(_0193_),
    .C1(net47),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0040_));
 sky130_fd_sc_hd__o21ba_2 _0748_ (.A1(_0187_),
    .A2(_0191_),
    .B1_N(_0186_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0194_));
 sky130_fd_sc_hd__xnor2_2 _0749_ (.A(net44),
    .B(\logo_left[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0195_));
 sky130_fd_sc_hd__xnor2_2 _0750_ (.A(_0194_),
    .B(_0195_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0196_));
 sky130_fd_sc_hd__or2_2 _0751_ (.A(_0147_),
    .B(_0196_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0197_));
 sky130_fd_sc_hd__o211a_2 _0752_ (.A1(\logo_left[9] ),
    .A2(net18),
    .B1(_0197_),
    .C1(net47),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0041_));
 sky130_fd_sc_hd__or2_2 _0753_ (.A(\logo_top[0] ),
    .B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0198_));
 sky130_fd_sc_hd__nand2_2 _0754_ (.A(\logo_top[0] ),
    .B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0199_));
 sky130_fd_sc_hd__and3_2 _0755_ (.A(net48),
    .B(_0198_),
    .C(_0199_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0042_));
 sky130_fd_sc_hd__nor2_2 _0756_ (.A(net43),
    .B(_0067_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0200_));
 sky130_fd_sc_hd__nor2_2 _0757_ (.A(_0064_),
    .B(\logo_top[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0201_));
 sky130_fd_sc_hd__nor2_2 _0758_ (.A(_0200_),
    .B(_0201_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0202_));
 sky130_fd_sc_hd__xnor2_2 _0759_ (.A(\logo_top[0] ),
    .B(_0202_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0203_));
 sky130_fd_sc_hd__a221oi_2 _0760_ (.A1(_0067_),
    .A2(_0147_),
    .B1(_0203_),
    .B2(net18),
    .C1(_0081_),
    ...
    .VPWR(VPWR),
    .Y(_0043_));
 sky130_fd_sc_hd__nor2_2 _0761_ (.A(_0064_),
    .B(\logo_top[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0204_));
 sky130_fd_sc_hd__and2_2 _0762_ (.A(_0064_),
    .B(\logo_top[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0205_));
 sky130_fd_sc_hd__or2_2 _0763_ (.A(_0204_),
    .B(_0205_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0206_));
 sky130_fd_sc_hd__a21oi_2 _0764_ (.A1(\logo_top[0] ),
    .A2(_0202_),
    .B1(_0200_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0207_));
 sky130_fd_sc_hd__nor2_2 _0765_ (.A(_0206_),
    .B(_0207_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0208_));
 sky130_fd_sc_hd__and2_2 _0766_ (.A(_0206_),
    .B(_0207_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0209_));
 sky130_fd_sc_hd__o21ai_2 _0767_ (.A1(_0208_),
    .A2(_0209_),
    .B1(net19),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0210_));
 sky130_fd_sc_hd__o211a_2 _0768_ (.A1(\logo_top[2] ),
    .A2(net19),
    .B1(_0210_),
    .C1(net48),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0044_));
 sky130_fd_sc_hd__nor2_2 _0769_ (.A(\logo_top[2] ),
    .B(_0207_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0211_));
 sky130_fd_sc_hd__a2111o_2 _0770_ (.A1(net43),
    .A2(_0207_),
    .B1(_0211_),
    .C1(net15),
    .D1(_0205_),
    ...
    .VPWR(VPWR),
    .X(_0212_));
 sky130_fd_sc_hd__o21ai_2 _0771_ (.A1(\logo_top[3] ),
    .A2(_0212_),
    .B1(net48),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0213_));
 sky130_fd_sc_hd__a21o_2 _0772_ (.A1(net96),
    .A2(_0212_),
    .B1(_0213_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0045_));
 sky130_fd_sc_hd__or2_2 _0773_ (.A(_0064_),
    .B(\logo_top[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0214_));
 sky130_fd_sc_hd__nand2_2 _0774_ (.A(_0064_),
    .B(\logo_top[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0215_));
 sky130_fd_sc_hd__nand2_2 _0775_ (.A(_0214_),
    .B(_0215_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0216_));
 sky130_fd_sc_hd__a41o_2 _0776_ (.A1(\logo_top[3] ),
    .A2(\logo_top[2] ),
    .A3(\logo_top[1] ),
    .A4(\logo_top[0] ),
    .B1(_0064_),
    ...
    .VPWR(VPWR),
    .X(_0217_));
 sky130_fd_sc_hd__o31a_2 _0777_ (.A1(\logo_top[3] ),
    .A2(\logo_top[2] ),
    .A3(_0208_),
    .B1(_0217_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0218_));
 sky130_fd_sc_hd__nand2b_2 _0778_ (.A_N(_0216_),
    .B(_0218_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0219_));
 sky130_fd_sc_hd__xor2_2 _0779_ (.A(_0216_),
    .B(_0218_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0220_));
 sky130_fd_sc_hd__nand2_2 _0780_ (.A(net19),
    .B(_0220_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0221_));
 sky130_fd_sc_hd__o211a_2 _0781_ (.A1(\logo_top[4] ),
    .A2(net19),
    .B1(_0221_),
    .C1(net48),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0046_));
 sky130_fd_sc_hd__or2_2 _0782_ (.A(\logo_top[5] ),
    .B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0222_));
 sky130_fd_sc_hd__xor2_2 _0783_ (.A(net43),
    .B(\logo_top[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0223_));
 sky130_fd_sc_hd__nand2_2 _0784_ (.A(_0215_),
    .B(_0219_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0224_));
 sky130_fd_sc_hd__xnor2_2 _0785_ (.A(_0223_),
    .B(_0224_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0225_));
 sky130_fd_sc_hd__o211a_2 _0786_ (.A1(net15),
    .A2(_0225_),
    .B1(_0222_),
    .C1(net48),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0047_));
 sky130_fd_sc_hd__xnor2_2 _0787_ (.A(net43),
    .B(\logo_top[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0226_));
 sky130_fd_sc_hd__nor2_2 _0788_ (.A(_0219_),
    .B(_0223_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0227_));
 sky130_fd_sc_hd__o21a_2 _0789_ (.A1(\logo_top[5] ),
    .A2(\logo_top[4] ),
    .B1(_0064_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0228_));
 sky130_fd_sc_hd__or2_2 _0790_ (.A(_0227_),
    .B(_0228_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0229_));
 sky130_fd_sc_hd__nand2_2 _0791_ (.A(_0226_),
    .B(_0229_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0230_));
 sky130_fd_sc_hd__o21ba_2 _0792_ (.A1(_0226_),
    .A2(_0229_),
    .B1_N(_0147_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0231_));
 sky130_fd_sc_hd__a221o_2 _0793_ (.A1(\logo_top[6] ),
    .A2(net15),
    .B1(_0230_),
    .B2(_0231_),
    .C1(_0081_),
    ...
    .VPWR(VPWR),
    .X(_0048_));
 sky130_fd_sc_hd__xor2_2 _0794_ (.A(net43),
    .B(\logo_top[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0232_));
 sky130_fd_sc_hd__inv_2 _0795_ (.A(_0232_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0233_));
 sky130_fd_sc_hd__o21a_2 _0796_ (.A1(net43),
    .A2(_0066_),
    .B1(_0230_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0234_));
 sky130_fd_sc_hd__xnor2_2 _0797_ (.A(_0232_),
    .B(_0234_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0235_));
 sky130_fd_sc_hd__nor2_2 _0798_ (.A(net15),
    .B(_0235_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0236_));
 sky130_fd_sc_hd__a211o_2 _0799_ (.A1(\logo_top[7] ),
    .A2(net15),
    .B1(_0236_),
    .C1(_0081_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0049_));
 sky130_fd_sc_hd__o41a_2 _0800_ (.A1(\logo_top[7] ),
    .A2(\logo_top[6] ),
    .A3(\logo_top[5] ),
    .A4(\logo_top[4] ),
    .B1(_0064_),
    ...
    .VPWR(VPWR),
    .X(_0237_));
 sky130_fd_sc_hd__a31o_2 _0801_ (.A1(_0226_),
    .A2(_0227_),
    .A3(_0233_),
    .B1(_0237_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0238_));
 sky130_fd_sc_hd__nor2_2 _0802_ (.A(net43),
    .B(\logo_top[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0239_));
 sky130_fd_sc_hd__nand2_2 _0803_ (.A(net43),
    .B(\logo_top[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0240_));
 sky130_fd_sc_hd__and2b_2 _0804_ (.A_N(_0239_),
    .B(_0240_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0241_));
 sky130_fd_sc_hd__xnor2_2 _0805_ (.A(_0238_),
    .B(_0241_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0242_));
 sky130_fd_sc_hd__or2_2 _0806_ (.A(\logo_top[8] ),
    .B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0243_));
 sky130_fd_sc_hd__o211a_2 _0807_ (.A1(_0146_),
    .A2(_0242_),
    .B1(_0243_),
    .C1(net48),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0050_));
 sky130_fd_sc_hd__nand2_2 _0808_ (.A(_0238_),
    .B(_0240_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0244_));
 sky130_fd_sc_hd__o211a_2 _0809_ (.A1(_0238_),
    .A2(_0239_),
    .B1(_0244_),
    .C1(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0245_));
 sky130_fd_sc_hd__a21oi_2 _0810_ (.A1(\logo_top[9] ),
    .A2(_0245_),
    .B1(_0081_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0246_));
 sky130_fd_sc_hd__o21a_2 _0811_ (.A1(net94),
    .A2(_0245_),
    .B1(_0246_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0051_));
 sky130_fd_sc_hd__or3_2 _0812_ (.A(\logo_left[3] ),
    .B(\logo_left[2] ),
    .C(\logo_left[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0247_));
 sky130_fd_sc_hd__or4_2 _0813_ (.A(\logo_left[8] ),
    .B(\logo_left[6] ),
    .C(\logo_left[5] ),
    .D(\logo_left[4] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0248_));
 sky130_fd_sc_hd__o41a_2 _0814_ (.A1(dir_x),
    .A2(\logo_left[9] ),
    .A3(_0247_),
    .A4(_0248_),
    .B1(_0068_),
    ...
    .VPWR(VPWR),
    .X(_0249_));
 sky130_fd_sc_hd__and3_2 _0815_ (.A(\logo_left[3] ),
    .B(\logo_left[2] ),
    .C(\logo_left[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0250_));
 sky130_fd_sc_hd__and4b_2 _0816_ (.A_N(\logo_left[9] ),
    .B(\logo_left[8] ),
    .C(\logo_left[6] ),
    .D(\logo_left[4] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0251_));
 sky130_fd_sc_hd__a41o_2 _0817_ (.A1(dir_x),
    .A2(\logo_left[5] ),
    .A3(_0250_),
    .A4(_0251_),
    .B1(_0068_),
    ...
    .VPWR(VPWR),
    .X(_0252_));
 sky130_fd_sc_hd__and4b_2 _0818_ (.A_N(_0249_),
    .B(_0252_),
    .C(\logo_left[0] ),
    .D(net16),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0253_));
 sky130_fd_sc_hd__o21ai_2 _0819_ (.A1(_0065_),
    .A2(_0253_),
    .B1(net45),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0254_));
 sky130_fd_sc_hd__a21o_2 _0820_ (.A1(_0065_),
    .A2(_0253_),
    .B1(_0254_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0052_));
 sky130_fd_sc_hd__or4_2 _0821_ (.A(net43),
    .B(\logo_top[8] ),
    .C(\logo_top[3] ),
    .D(\logo_top[2] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0255_));
 sky130_fd_sc_hd__and4_2 _0822_ (.A(dir_y),
    .B(\logo_top[8] ),
    .C(\logo_top[4] ),
    .D(\logo_top[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0256_));
 sky130_fd_sc_hd__a31o_2 _0823_ (.A1(\logo_top[6] ),
    .A2(\logo_top[2] ),
    .A3(_0256_),
    .B1(_0067_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0257_));
 sky130_fd_sc_hd__or4b_2 _0824_ (.A(\logo_top[9] ),
    .B(\logo_top[7] ),
    .C(\logo_top[5] ),
    .D_N(_0257_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0258_));
 sky130_fd_sc_hd__o31a_2 _0825_ (.A1(\logo_top[6] ),
    .A2(\logo_top[4] ),
    .A3(_0255_),
    .B1(_0067_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0259_));
 sky130_fd_sc_hd__nor3_2 _0826_ (.A(_0199_),
    .B(_0258_),
    .C(_0259_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0260_));
 sky130_fd_sc_hd__o21ai_2 _0827_ (.A1(net66),
    .A2(net5),
    .B1(net50),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0261_));
 sky130_fd_sc_hd__a21oi_2 _0828_ (.A1(net66),
    .A2(net5),
    .B1(_0261_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0053_));
 sky130_fd_sc_hd__or3_2 _0829_ (.A(\color_index[0] ),
    .B(_0253_),
    .C(_0260_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0262_));
 sky130_fd_sc_hd__o21a_2 _0830_ (.A1(_0253_),
    .A2(_0260_),
    .B1(\color_index[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0263_));
 sky130_fd_sc_hd__and3b_2 _0831_ (.A_N(_0263_),
    .B(net47),
    .C(_0262_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0054_));
 sky130_fd_sc_hd__and2_2 _0832_ (.A(\color_index[1] ),
    .B(_0263_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0264_));
 sky130_fd_sc_hd__o21ai_2 _0833_ (.A1(net89),
    .A2(_0263_),
    .B1(net47),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0265_));
 sky130_fd_sc_hd__nor2_2 _0834_ (.A(_0264_),
    .B(_0265_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0055_));
 sky130_fd_sc_hd__o21ai_2 _0835_ (.A1(net82),
    .A2(_0264_),
    .B1(net47),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0266_));
 sky130_fd_sc_hd__a21oi_2 _0836_ (.A1(net82),
    .A2(_0264_),
    .B1(_0266_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0056_));
 sky130_fd_sc_hd__and2b_2 _0837_ (.A_N(\pix_x[2] ),
    .B(\logo_left[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0267_));
 sky130_fd_sc_hd__and2b_2 _0838_ (.A_N(\logo_left[2] ),
    .B(\pix_x[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0268_));
 sky130_fd_sc_hd__nor2_2 _0839_ (.A(_0267_),
    .B(_0268_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0269_));
 sky130_fd_sc_hd__and2b_2 _0840_ (.A_N(\logo_left[1] ),
    .B(\pix_x[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0270_));
 sky130_fd_sc_hd__nand2b_2 _0841_ (.A_N(\pix_x[0] ),
    .B(\logo_left[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0271_));
 sky130_fd_sc_hd__xnor2_2 _0842_ (.A(\logo_left[1] ),
    .B(\pix_x[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0272_));
 sky130_fd_sc_hd__a21o_2 _0843_ (.A1(_0271_),
    .A2(_0272_),
    .B1(_0270_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0273_));
 sky130_fd_sc_hd__xnor2_2 _0844_ (.A(_0269_),
    .B(_0273_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0274_));
 sky130_fd_sc_hd__nand2_2 _0845_ (.A(\logo_top[6] ),
    .B(_0075_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0275_));
 sky130_fd_sc_hd__nand2_2 _0846_ (.A(_0066_),
    .B(\pix_y[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0276_));
 sky130_fd_sc_hd__nand2_2 _0847_ (.A(_0275_),
    .B(_0276_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0277_));
 sky130_fd_sc_hd__nand2b_2 _0848_ (.A_N(\pix_y[5] ),
    .B(\logo_top[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0278_));
 sky130_fd_sc_hd__nand2b_2 _0849_ (.A_N(\logo_top[5] ),
    .B(\pix_y[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0279_));
 sky130_fd_sc_hd__nor2_2 _0850_ (.A(\logo_top[4] ),
    .B(_0074_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0280_));
 sky130_fd_sc_hd__nand2b_2 _0851_ (.A_N(\logo_top[3] ),
    .B(\pix_y[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0281_));
 sky130_fd_sc_hd__nand2b_2 _0852_ (.A_N(\pix_y[3] ),
    .B(\logo_top[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0282_));
 sky130_fd_sc_hd__nand2_2 _0853_ (.A(_0281_),
    .B(_0282_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0283_));
 sky130_fd_sc_hd__nor2_2 _0854_ (.A(\logo_top[2] ),
    .B(_0073_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0284_));
 sky130_fd_sc_hd__nand2b_2 _0855_ (.A_N(\pix_y[0] ),
    .B(\logo_top[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0285_));
 sky130_fd_sc_hd__xnor2_2 _0856_ (.A(\logo_top[1] ),
    .B(\pix_y[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0286_));
 sky130_fd_sc_hd__nand2_2 _0857_ (.A(_0285_),
    .B(_0286_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0287_));
 sky130_fd_sc_hd__o21ai_2 _0858_ (.A1(\logo_top[1] ),
    .A2(_0072_),
    .B1(_0287_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0288_));
 sky130_fd_sc_hd__and2_2 _0859_ (.A(\logo_top[2] ),
    .B(_0073_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0289_));
 sky130_fd_sc_hd__nor2_2 _0860_ (.A(_0284_),
    .B(_0289_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0290_));
 sky130_fd_sc_hd__a21oi_2 _0861_ (.A1(_0288_),
    .A2(_0290_),
    .B1(_0284_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0291_));
 sky130_fd_sc_hd__o21ai_2 _0862_ (.A1(_0283_),
    .A2(_0291_),
    .B1(_0281_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0292_));
 sky130_fd_sc_hd__and2_2 _0863_ (.A(\logo_top[4] ),
    .B(_0074_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0293_));
 sky130_fd_sc_hd__nor2_2 _0864_ (.A(_0280_),
    .B(_0293_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0294_));
 sky130_fd_sc_hd__a21o_2 _0865_ (.A1(_0292_),
    .A2(_0294_),
    .B1(_0280_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0295_));
 sky130_fd_sc_hd__a21bo_2 _0866_ (.A1(_0278_),
    .A2(_0295_),
    .B1_N(_0279_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0296_));
 sky130_fd_sc_hd__xnor2_2 _0867_ (.A(_0277_),
    .B(_0296_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0297_));
 sky130_fd_sc_hd__inv_2 _0868_ (.A(net4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0298_));
 sky130_fd_sc_hd__xnor2_2 _0869_ (.A(\logo_left[6] ),
    .B(\pix_x[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0299_));
 sky130_fd_sc_hd__and2b_2 _0870_ (.A_N(\pix_x[5] ),
    .B(\logo_left[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0300_));
 sky130_fd_sc_hd__nand2b_2 _0871_ (.A_N(\pix_x[5] ),
    .B(\logo_left[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0301_));
 sky130_fd_sc_hd__and2b_2 _0872_ (.A_N(\logo_left[5] ),
    .B(\pix_x[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0302_));
 sky130_fd_sc_hd__and2b_2 _0873_ (.A_N(\logo_left[4] ),
    .B(\pix_x[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0303_));
 sky130_fd_sc_hd__and2b_2 _0874_ (.A_N(\pix_x[4] ),
    .B(\logo_left[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0304_));
 sky130_fd_sc_hd__nor2_2 _0875_ (.A(_0303_),
    .B(_0304_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0305_));
 sky130_fd_sc_hd__and2b_2 _0876_ (.A_N(\pix_x[3] ),
    .B(\logo_left[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0306_));
 sky130_fd_sc_hd__nand2b_2 _0877_ (.A_N(\pix_x[3] ),
    .B(\logo_left[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0307_));
 sky130_fd_sc_hd__and2b_2 _0878_ (.A_N(\logo_left[3] ),
    .B(\pix_x[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0308_));
 sky130_fd_sc_hd__a31o_2 _0879_ (.A1(_0070_),
    .A2(\pix_x[2] ),
    .A3(_0307_),
    .B1(_0308_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0309_));
 sky130_fd_sc_hd__nor2_2 _0880_ (.A(_0306_),
    .B(_0308_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0310_));
 sky130_fd_sc_hd__a31o_2 _0881_ (.A1(_0269_),
    .A2(_0273_),
    .A3(_0310_),
    .B1(_0309_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0311_));
 sky130_fd_sc_hd__a21o_2 _0882_ (.A1(_0305_),
    .A2(_0311_),
    .B1(_0303_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0312_));
 sky130_fd_sc_hd__a211o_2 _0883_ (.A1(_0305_),
    .A2(_0311_),
    .B1(_0302_),
    .C1(_0303_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0313_));
 sky130_fd_sc_hd__and3_2 _0884_ (.A(_0299_),
    .B(_0301_),
    .C(_0313_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0314_));
 sky130_fd_sc_hd__nand3_2 _0885_ (.A(_0299_),
    .B(_0301_),
    .C(_0313_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0315_));
 sky130_fd_sc_hd__a21oi_2 _0886_ (.A1(_0301_),
    .A2(_0313_),
    .B1(_0299_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0316_));
 sky130_fd_sc_hd__a21o_2 _0887_ (.A1(_0301_),
    .A2(_0313_),
    .B1(_0299_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0317_));
 sky130_fd_sc_hd__nor2_2 _0888_ (.A(_0314_),
    .B(_0316_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0318_));
 sky130_fd_sc_hd__nand2_2 _0889_ (.A(_0315_),
    .B(_0317_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0319_));
 sky130_fd_sc_hd__a21oi_2 _0890_ (.A1(_0269_),
    .A2(_0273_),
    .B1(_0268_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0320_));
 sky130_fd_sc_hd__xor2_2 _0891_ (.A(_0310_),
    .B(_0320_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0321_));
 sky130_fd_sc_hd__xnor2_4 _0892_ (.A(_0310_),
    .B(_0320_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0322_));
 sky130_fd_sc_hd__nor2_2 _0893_ (.A(_0300_),
    .B(_0302_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0323_));
 sky130_fd_sc_hd__xor2_2 _0894_ (.A(_0312_),
    .B(_0323_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0324_));
 sky130_fd_sc_hd__xnor2_2 _0895_ (.A(_0312_),
    .B(_0323_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0325_));
 sky130_fd_sc_hd__xor2_2 _0896_ (.A(_0305_),
    .B(_0311_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0326_));
 sky130_fd_sc_hd__xnor2_2 _0897_ (.A(_0305_),
    .B(_0311_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0327_));
 sky130_fd_sc_hd__nand2_2 _0898_ (.A(net37),
    .B(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0328_));
 sky130_fd_sc_hd__or2_2 _0899_ (.A(net27),
    .B(_0328_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0329_));
 sky130_fd_sc_hd__a211o_2 _0900_ (.A1(_0315_),
    .A2(_0317_),
    .B1(net28),
    .C1(_0328_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0330_));
 sky130_fd_sc_hd__xor2_2 _0901_ (.A(_0292_),
    .B(_0294_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0331_));
 sky130_fd_sc_hd__xnor2_2 _0902_ (.A(_0292_),
    .B(_0294_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0332_));
 sky130_fd_sc_hd__xor2_2 _0903_ (.A(_0288_),
    .B(_0290_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0333_));
 sky130_fd_sc_hd__xnor2_2 _0904_ (.A(_0288_),
    .B(_0290_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0334_));
 sky130_fd_sc_hd__xor2_2 _0905_ (.A(_0283_),
    .B(_0291_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0335_));
 sky130_fd_sc_hd__xnor2_2 _0906_ (.A(_0283_),
    .B(_0291_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0336_));
 sky130_fd_sc_hd__nor2_2 _0907_ (.A(net34),
    .B(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0337_));
 sky130_fd_sc_hd__inv_2 _0908_ (.A(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0338_));
 sky130_fd_sc_hd__xor2_2 _0909_ (.A(_0285_),
    .B(_0286_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0339_));
 sky130_fd_sc_hd__xnor2_2 _0910_ (.A(_0285_),
    .B(_0286_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0340_));
 sky130_fd_sc_hd__nand2_2 _0911_ (.A(net32),
    .B(net40),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0341_));
 sky130_fd_sc_hd__inv_2 _0912_ (.A(_0341_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0342_));
 sky130_fd_sc_hd__nand2_2 _0913_ (.A(net23),
    .B(_0341_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0343_));
 sky130_fd_sc_hd__nor2_2 _0914_ (.A(net37),
    .B(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0344_));
 sky130_fd_sc_hd__nand2_2 _0915_ (.A(_0322_),
    .B(net36),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0345_));
 sky130_fd_sc_hd__or3_2 _0916_ (.A(net12),
    .B(net24),
    .C(_0345_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0346_));
 sky130_fd_sc_hd__nand2_2 _0917_ (.A(_0322_),
    .B(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0347_));
 sky130_fd_sc_hd__nor2_2 _0918_ (.A(_0324_),
    .B(_0347_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0348_));
 sky130_fd_sc_hd__or2_2 _0919_ (.A(net27),
    .B(_0347_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0349_));
 sky130_fd_sc_hd__nand2_2 _0920_ (.A(net11),
    .B(_0348_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0350_));
 sky130_fd_sc_hd__nand2_2 _0921_ (.A(_0346_),
    .B(_0350_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0351_));
 sky130_fd_sc_hd__a21o_2 _0922_ (.A1(net11),
    .A2(_0348_),
    .B1(_0343_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0352_));
 sky130_fd_sc_hd__o2111ai_2 _0923_ (.A1(_0343_),
    .A2(_0351_),
    .B1(_0330_),
    .C1(net10),
    .D1(_0338_),
    ...
    .VPWR(VPWR),
    .Y(_0353_));
 sky130_fd_sc_hd__xor2_2 _0924_ (.A(_0271_),
    .B(_0272_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0354_));
 sky130_fd_sc_hd__xnor2_2 _0925_ (.A(_0271_),
    .B(_0272_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0355_));
 sky130_fd_sc_hd__nand2_2 _0926_ (.A(net34),
    .B(net39),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0356_));
 sky130_fd_sc_hd__nand2_2 _0927_ (.A(net27),
    .B(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0357_));
 sky130_fd_sc_hd__or3_2 _0928_ (.A(_0322_),
    .B(net24),
    .C(net36),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0358_));
 sky130_fd_sc_hd__o22a_2 _0929_ (.A1(_0314_),
    .A2(_0316_),
    .B1(net27),
    .B2(_0347_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0359_));
 sky130_fd_sc_hd__nor2_2 _0930_ (.A(_0322_),
    .B(_0327_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0360_));
 sky130_fd_sc_hd__inv_2 _0931_ (.A(_0360_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0361_));
 sky130_fd_sc_hd__xnor2_2 _0932_ (.A(_0322_),
    .B(net36),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0362_));
 sky130_fd_sc_hd__xnor2_2 _0933_ (.A(net37),
    .B(net36),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0363_));
 sky130_fd_sc_hd__nand2_2 _0934_ (.A(net26),
    .B(_0362_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0364_));
 sky130_fd_sc_hd__nand2_2 _0935_ (.A(_0322_),
    .B(net27),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0365_));
 sky130_fd_sc_hd__mux2_1 _0936_ (.A0(net37),
    .A1(_0363_),
    .S(net25),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0366_));
 sky130_fd_sc_hd__a22o_2 _0937_ (.A1(net8),
    .A2(net7),
    .B1(_0366_),
    .B2(net13),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0367_));
 sky130_fd_sc_hd__a221o_2 _0938_ (.A1(net8),
    .A2(net7),
    .B1(_0366_),
    .B2(net13),
    .C1(net32),
    ...
    .VPWR(VPWR),
    .X(_0368_));
 sky130_fd_sc_hd__or3_2 _0939_ (.A(_0314_),
    .B(_0316_),
    .C(_0322_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0369_));
 sky130_fd_sc_hd__o2111a_2 _0940_ (.A1(net27),
    .A2(net36),
    .B1(_0315_),
    .C1(_0317_),
    .D1(net37),
    ...
    .VPWR(VPWR),
    .X(_0370_));
 sky130_fd_sc_hd__a221o_2 _0941_ (.A1(net8),
    .A2(net7),
    .B1(_0368_),
    .B2(_0356_),
    .C1(_0370_),
    ...
    .VPWR(VPWR),
    .X(_0371_));
 sky130_fd_sc_hd__nand2_2 _0942_ (.A(net33),
    .B(_0369_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0372_));
 sky130_fd_sc_hd__a221o_2 _0943_ (.A1(net14),
    .A2(net38),
    .B1(net8),
    .B2(_0359_),
    .C1(net34),
    ...
    .VPWR(VPWR),
    .X(_0373_));
 sky130_fd_sc_hd__a21o_2 _0944_ (.A1(net28),
    .A2(net35),
    .B1(_0322_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0374_));
 sky130_fd_sc_hd__o211a_2 _0945_ (.A1(_0314_),
    .A2(_0316_),
    .B1(_0322_),
    .C1(net27),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0375_));
 sky130_fd_sc_hd__nand2_2 _0946_ (.A(_0322_),
    .B(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0376_));
 sky130_fd_sc_hd__o22a_2 _0947_ (.A1(_0314_),
    .A2(_0316_),
    .B1(net37),
    .B2(net27),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0377_));
 sky130_fd_sc_hd__and2_2 _0948_ (.A(net8),
    .B(_0377_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0378_));
 sky130_fd_sc_hd__o21ai_2 _0949_ (.A1(net13),
    .A2(_0365_),
    .B1(_0374_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0379_));
 sky130_fd_sc_hd__a21o_2 _0950_ (.A1(_0341_),
    .A2(_0373_),
    .B1(_0379_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0380_));
 sky130_fd_sc_hd__a21o_2 _0951_ (.A1(_0371_),
    .A2(_0380_),
    .B1(_0354_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0381_));
 sky130_fd_sc_hd__a21o_2 _0952_ (.A1(net8),
    .A2(_0377_),
    .B1(_0370_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0382_));
 sky130_fd_sc_hd__nand2_2 _0953_ (.A(net32),
    .B(net41),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0383_));
 sky130_fd_sc_hd__a31o_2 _0954_ (.A1(net32),
    .A2(net41),
    .A3(_0382_),
    .B1(_0355_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0384_));
 sky130_fd_sc_hd__nand2_2 _0955_ (.A(net13),
    .B(_0374_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0385_));
 sky130_fd_sc_hd__a31o_2 _0956_ (.A1(net39),
    .A2(_0376_),
    .A3(_0385_),
    .B1(net34),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0386_));
 sky130_fd_sc_hd__a21o_2 _0957_ (.A1(_0368_),
    .A2(_0386_),
    .B1(_0384_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0387_));
 sky130_fd_sc_hd__nand2_2 _0958_ (.A(_0324_),
    .B(_0362_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0388_));
 sky130_fd_sc_hd__o211a_2 _0959_ (.A1(net24),
    .A2(_0363_),
    .B1(_0315_),
    .C1(_0317_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0389_));
 sky130_fd_sc_hd__nand2_2 _0960_ (.A(net28),
    .B(_0363_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0390_));
 sky130_fd_sc_hd__a21o_2 _0961_ (.A1(_0349_),
    .A2(_0389_),
    .B1(_0377_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0391_));
 sky130_fd_sc_hd__a21o_2 _0962_ (.A1(net26),
    .A2(_0347_),
    .B1(_0360_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0392_));
 sky130_fd_sc_hd__a21o_2 _0963_ (.A1(net14),
    .A2(_0392_),
    .B1(_0377_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0393_));
 sky130_fd_sc_hd__and3_2 _0964_ (.A(net41),
    .B(_0355_),
    .C(_0393_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0394_));
 sky130_fd_sc_hd__o211a_2 _0965_ (.A1(net11),
    .A2(_0388_),
    .B1(_0376_),
    .C1(net41),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0395_));
 sky130_fd_sc_hd__and2_2 _0966_ (.A(_0354_),
    .B(_0395_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0396_));
 sky130_fd_sc_hd__a32o_2 _0967_ (.A1(net33),
    .A2(_0346_),
    .A3(_0350_),
    .B1(_0391_),
    .B2(net40),
    ...
    .VPWR(VPWR),
    .X(_0397_));
 sky130_fd_sc_hd__o31a_2 _0968_ (.A1(_0394_),
    .A2(_0396_),
    .A3(_0397_),
    .B1(net21),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0398_));
 sky130_fd_sc_hd__a311o_2 _0969_ (.A1(net23),
    .A2(_0381_),
    .A3(_0387_),
    .B1(_0398_),
    .C1(net10),
    ...
    .VPWR(VPWR),
    .X(_0399_));
 sky130_fd_sc_hd__a21o_2 _0970_ (.A1(_0353_),
    .A2(_0399_),
    .B1(net4),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0400_));
 sky130_fd_sc_hd__nand2_2 _0971_ (.A(_0278_),
    .B(_0279_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0401_));
 sky130_fd_sc_hd__xnor2_2 _0972_ (.A(_0295_),
    .B(_0401_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0402_));
 sky130_fd_sc_hd__inv_2 _0973_ (.A(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0403_));
 sky130_fd_sc_hd__a221o_2 _0974_ (.A1(net8),
    .A2(net7),
    .B1(_0372_),
    .B2(_0341_),
    .C1(_0370_),
    ...
    .VPWR(VPWR),
    .X(_0404_));
 sky130_fd_sc_hd__a211o_2 _0975_ (.A1(net41),
    .A2(_0393_),
    .B1(_0379_),
    .C1(net33),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0405_));
 sky130_fd_sc_hd__a21o_2 _0976_ (.A1(_0404_),
    .A2(_0405_),
    .B1(_0354_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0406_));
 sky130_fd_sc_hd__a31o_2 _0977_ (.A1(net39),
    .A2(_0376_),
    .A3(_0385_),
    .B1(_0395_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0407_));
 sky130_fd_sc_hd__a221o_2 _0978_ (.A1(_0342_),
    .A2(_0367_),
    .B1(_0407_),
    .B2(net34),
    .C1(_0384_),
    ...
    .VPWR(VPWR),
    .X(_0408_));
 sky130_fd_sc_hd__nor2_2 _0979_ (.A(net33),
    .B(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0409_));
 sky130_fd_sc_hd__and3_2 _0980_ (.A(net21),
    .B(_0406_),
    .C(_0408_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0410_));
 sky130_fd_sc_hd__and3_2 _0981_ (.A(net22),
    .B(net39),
    .C(_0391_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0411_));
 sky130_fd_sc_hd__nand2_2 _0982_ (.A(net10),
    .B(_0343_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0412_));
 sky130_fd_sc_hd__and3_2 _0983_ (.A(_0346_),
    .B(_0350_),
    .C(_0412_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0413_));
 sky130_fd_sc_hd__or4_2 _0984_ (.A(_0298_),
    .B(_0410_),
    .C(_0411_),
    .D(_0413_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0414_));
 sky130_fd_sc_hd__a31o_2 _0985_ (.A1(net12),
    .A2(net41),
    .A3(_0347_),
    .B1(net34),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0415_));
 sky130_fd_sc_hd__and3_2 _0986_ (.A(_0315_),
    .B(_0317_),
    .C(_0345_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0416_));
 sky130_fd_sc_hd__a32o_2 _0987_ (.A1(net12),
    .A2(_0347_),
    .A3(_0357_),
    .B1(_0416_),
    .B2(_0329_),
    ...
    .VPWR(VPWR),
    .X(_0417_));
 sky130_fd_sc_hd__or3_2 _0988_ (.A(net27),
    .B(_0328_),
    .C(net41),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0418_));
 sky130_fd_sc_hd__o21a_2 _0989_ (.A1(net37),
    .A2(net24),
    .B1(_0347_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0419_));
 sky130_fd_sc_hd__a221o_2 _0990_ (.A1(_0416_),
    .A2(_0418_),
    .B1(_0419_),
    .B2(net12),
    .C1(net32),
    ...
    .VPWR(VPWR),
    .X(_0420_));
 sky130_fd_sc_hd__nand2_2 _0991_ (.A(net28),
    .B(net36),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0421_));
 sky130_fd_sc_hd__and3_2 _0992_ (.A(net7),
    .B(_0365_),
    .C(_0421_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0422_));
 sky130_fd_sc_hd__a21o_2 _0993_ (.A1(net24),
    .A2(_0327_),
    .B1(_0363_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0423_));
 sky130_fd_sc_hd__a32o_2 _0994_ (.A1(net7),
    .A2(_0365_),
    .A3(_0421_),
    .B1(_0416_),
    .B2(net8),
    ...
    .VPWR(VPWR),
    .X(_0424_));
 sky130_fd_sc_hd__a21o_2 _0995_ (.A1(net7),
    .A2(_0421_),
    .B1(_0389_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0425_));
 sky130_fd_sc_hd__o211a_2 _0996_ (.A1(_0415_),
    .A2(_0417_),
    .B1(_0420_),
    .C1(net21),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0426_));
 sky130_fd_sc_hd__mux2_1 _0997_ (.A0(_0424_),
    .A1(_0425_),
    .S(_0341_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0427_));
 sky130_fd_sc_hd__a211o_2 _0998_ (.A1(net22),
    .A2(_0427_),
    .B1(_0426_),
    .C1(_0331_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0428_));
 sky130_fd_sc_hd__o211a_2 _0999_ (.A1(net37),
    .A2(net24),
    .B1(_0315_),
    .C1(_0317_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0429_));
 sky130_fd_sc_hd__a32o_2 _1000_ (.A1(net12),
    .A2(_0347_),
    .A3(_0357_),
    .B1(_0429_),
    .B2(_0329_),
    ...
    .VPWR(VPWR),
    .X(_0430_));
 sky130_fd_sc_hd__a22o_2 _1001_ (.A1(_0356_),
    .A2(_0368_),
    .B1(_0430_),
    .B2(net39),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0431_));
 sky130_fd_sc_hd__a221o_2 _1002_ (.A1(net12),
    .A2(_0419_),
    .B1(_0429_),
    .B2(_0329_),
    .C1(_0415_),
    ...
    .VPWR(VPWR),
    .X(_0432_));
 sky130_fd_sc_hd__and3_2 _1003_ (.A(net22),
    .B(_0431_),
    .C(_0432_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0433_));
 sky130_fd_sc_hd__a211o_2 _1004_ (.A1(net41),
    .A2(_0419_),
    .B1(_0429_),
    .C1(net32),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0434_));
 sky130_fd_sc_hd__a21o_2 _1005_ (.A1(net39),
    .A2(_0422_),
    .B1(_0434_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0435_));
 sky130_fd_sc_hd__o211a_2 _1006_ (.A1(net24),
    .A2(net36),
    .B1(_0315_),
    .C1(_0317_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0436_));
 sky130_fd_sc_hd__and3_2 _1007_ (.A(net38),
    .B(_0327_),
    .C(net41),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0437_));
 sky130_fd_sc_hd__a221o_2 _1008_ (.A1(net7),
    .A2(_0421_),
    .B1(_0436_),
    .B2(_0365_),
    .C1(_0437_),
    ...
    .VPWR(VPWR),
    .X(_0438_));
 sky130_fd_sc_hd__o211a_2 _1009_ (.A1(net34),
    .A2(_0438_),
    .B1(_0435_),
    .C1(net21),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0439_));
 sky130_fd_sc_hd__o311a_2 _1010_ (.A1(net10),
    .A2(_0433_),
    .A3(_0439_),
    .B1(_0355_),
    .C1(_0428_),
    ...
    .VPWR(VPWR),
    .X(_0440_));
 sky130_fd_sc_hd__a22o_2 _1011_ (.A1(net8),
    .A2(net7),
    .B1(_0429_),
    .B2(_0329_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0441_));
 sky130_fd_sc_hd__a22o_2 _1012_ (.A1(_0356_),
    .A2(_0368_),
    .B1(_0441_),
    .B2(net39),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0442_));
 sky130_fd_sc_hd__o31a_2 _1013_ (.A1(net34),
    .A2(_0419_),
    .A3(_0429_),
    .B1(net22),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0443_));
 sky130_fd_sc_hd__or2_2 _1014_ (.A(_0383_),
    .B(_0430_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0444_));
 sky130_fd_sc_hd__a2111o_2 _1015_ (.A1(net7),
    .A2(_0421_),
    .B1(_0375_),
    .C1(net34),
    .D1(_0389_),
    ...
    .VPWR(VPWR),
    .X(_0445_));
 sky130_fd_sc_hd__or3_2 _1016_ (.A(net32),
    .B(_0419_),
    .C(_0429_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0446_));
 sky130_fd_sc_hd__o2111a_2 _1017_ (.A1(_0365_),
    .A2(_0383_),
    .B1(_0445_),
    .C1(_0446_),
    .D1(net21),
    ...
    .VPWR(VPWR),
    .X(_0447_));
 sky130_fd_sc_hd__a311o_2 _1018_ (.A1(_0442_),
    .A2(_0443_),
    .A3(_0444_),
    .B1(_0447_),
    .C1(net10),
    ...
    .VPWR(VPWR),
    .X(_0448_));
 sky130_fd_sc_hd__a21o_2 _1019_ (.A1(net11),
    .A2(_0419_),
    .B1(_0416_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0449_));
 sky130_fd_sc_hd__or2_2 _1020_ (.A(_0341_),
    .B(_0449_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0450_));
 sky130_fd_sc_hd__o32a_2 _1021_ (.A1(net32),
    .A2(_0375_),
    .A3(_0425_),
    .B1(_0424_),
    .B2(_0383_),
    ...
    .VPWR(VPWR),
    .X(_0451_));
 sky130_fd_sc_hd__a21o_2 _1022_ (.A1(_0409_),
    .A2(_0449_),
    .B1(_0331_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0452_));
 sky130_fd_sc_hd__a22o_2 _1023_ (.A1(net8),
    .A2(_0359_),
    .B1(_0416_),
    .B2(_0329_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0453_));
 sky130_fd_sc_hd__or3_2 _1024_ (.A(net14),
    .B(net40),
    .C(_0419_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0454_));
 sky130_fd_sc_hd__and3_2 _1025_ (.A(_0337_),
    .B(_0453_),
    .C(_0454_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0455_));
 sky130_fd_sc_hd__a31o_2 _1026_ (.A1(net22),
    .A2(_0450_),
    .A3(_0451_),
    .B1(_0455_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0456_));
 sky130_fd_sc_hd__o211a_2 _1027_ (.A1(_0452_),
    .A2(_0456_),
    .B1(_0354_),
    .C1(_0448_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0457_));
 sky130_fd_sc_hd__or3_2 _1028_ (.A(net4),
    .B(_0440_),
    .C(_0457_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0458_));
 sky130_fd_sc_hd__nor2_2 _1029_ (.A(net32),
    .B(net39),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0459_));
 sky130_fd_sc_hd__nand2_2 _1030_ (.A(net34),
    .B(net42),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_2 _1031_ (.A1(_0330_),
    ...
    .VPWR(VPWR),
    .X(_0461_));
 sky130_fd_sc_hd__o2111a_2 _1032_ (.A1(net23),
    .A2(_0351_),
    .B1(_0461_),
    .C1(net10),
    .D1(net4),
    ...
    .VPWR(VPWR),
    .X(_0462_));
 sky130_fd_sc_hd__nor2_2 _1033_ (.A(_0403_),
    .B(_0462_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0463_));
 sky130_fd_sc_hd__a32o_2 _1034_ (.A1(_0400_),
    .A2(_0403_),
    .A3(_0414_),
    .B1(_0458_),
    .B2(_0463_),
    ...
    .VPWR(VPWR),
    .X(_0464_));
 sky130_fd_sc_hd__mux2_1 _1035_ (.A0(_0374_),
    .A1(_0423_),
    .S(net12),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0465_));
 sky130_fd_sc_hd__nand2_2 _1036_ (.A(net25),
    .B(_0344_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0466_));
 sky130_fd_sc_hd__a22o_2 _1037_ (.A1(_0315_),
    .A2(_0317_),
    .B1(net24),
    .B2(_0344_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0467_));
 sky130_fd_sc_hd__o2111a_2 _1038_ (.A1(net13),
    .A2(_0466_),
    .B1(_0460_),
    .C1(_0369_),
    .D1(_0341_),
    ...
    .VPWR(VPWR),
    .X(_0468_));
 sky130_fd_sc_hd__mux2_1 _1039_ (.A0(net38),
    .A1(_0362_),
    .S(net25),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0469_));
 sky130_fd_sc_hd__a21oi_2 _1040_ (.A1(_0467_),
    .A2(_0469_),
    .B1(_0341_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0470_));
 sky130_fd_sc_hd__a211o_2 _1041_ (.A1(_0459_),
    .A2(_0465_),
    .B1(_0468_),
    .C1(_0470_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0471_));
 sky130_fd_sc_hd__or2_2 _1042_ (.A(_0369_),
    .B(_0421_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0472_));
 sky130_fd_sc_hd__a21boi_2 _1043_ (.A1(_0467_),
    .A2(_0469_),
    .B1_N(_0409_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0473_));
 sky130_fd_sc_hd__mux2_1 _1044_ (.A0(net37),
    .A1(_0344_),
    .S(net24),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0474_));
 sky130_fd_sc_hd__a211oi_2 _1045_ (.A1(net13),
    .A2(_0474_),
    .B1(_0356_),
    .C1(net22),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0475_));
 sky130_fd_sc_hd__a2111o_2 _1046_ (.A1(net9),
    .A2(_0472_),
    .B1(_0473_),
    .C1(_0475_),
    .D1(net10),
    ...
    .VPWR(VPWR),
    .X(_0476_));
 sky130_fd_sc_hd__a21o_2 _1047_ (.A1(net22),
    .A2(_0471_),
    .B1(_0476_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0477_));
 sky130_fd_sc_hd__and4_2 _1048_ (.A(_0330_),
    .B(net10),
    .C(_0338_),
    .D(_0346_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0478_));
 sky130_fd_sc_hd__a31o_2 _1049_ (.A1(net14),
    .A2(_0324_),
    .A3(_0360_),
    .B1(_0343_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0479_));
 sky130_fd_sc_hd__o211a_2 _1050_ (.A1(_0314_),
    .A2(_0316_),
    .B1(net28),
    .C1(_0363_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0480_));
 sky130_fd_sc_hd__a31o_2 _1051_ (.A1(net13),
    .A2(_0357_),
    .A3(_0474_),
    .B1(_0480_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0481_));
 sky130_fd_sc_hd__nor3_2 _1052_ (.A(net26),
    .B(_0369_),
    .C(_0460_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0482_));
 sky130_fd_sc_hd__o21ai_2 _1053_ (.A1(_0481_),
    .A2(_0482_),
    .B1(net23),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0483_));
 sky130_fd_sc_hd__mux2_1 _1054_ (.A0(_0361_),
    .A1(_0388_),
    .S(net11),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0484_));
 sky130_fd_sc_hd__o2bb2a_2 _1055_ (.A1_N(_0459_),
    .A2_N(_0481_),
    .B1(_0484_),
    .B2(net22),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0485_));
 sky130_fd_sc_hd__a21o_2 _1056_ (.A1(_0483_),
    .A2(_0485_),
    .B1(_0331_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0486_));
 sky130_fd_sc_hd__o22a_2 _1057_ (.A1(net13),
    .A2(_0388_),
    .B1(_0421_),
    .B2(_0369_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0487_));
 sky130_fd_sc_hd__mux2_1 _1058_ (.A0(_0465_),
    .A1(_0487_),
    .S(_0460_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0488_));
 sky130_fd_sc_hd__a311o_2 _1059_ (.A1(net12),
    .A2(net32),
    .A3(_0390_),
    .B1(_0487_),
    .C1(net39),
    ...
    .VPWR(VPWR),
    .X(_0489_));
 sky130_fd_sc_hd__o221a_2 _1060_ (.A1(net25),
    .A2(_0369_),
    .B1(_0390_),
    .B2(net13),
    .C1(net21),
    ...
    .VPWR(VPWR),
    .X(_0490_));
 sky130_fd_sc_hd__a221o_2 _1061_ (.A1(net22),
    .A2(_0488_),
    .B1(_0489_),
    .B2(_0490_),
    .C1(net10),
    ...
    .VPWR(VPWR),
    .X(_0491_));
 sky130_fd_sc_hd__a21oi_2 _1062_ (.A1(_0478_),
    .A2(_0479_),
    .B1(net6),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0492_));
 sky130_fd_sc_hd__a32o_2 _1063_ (.A1(net6),
    .A2(_0486_),
    .A3(_0491_),
    .B1(_0492_),
    .B2(_0477_),
    ...
    .VPWR(VPWR),
    .X(_0493_));
 sky130_fd_sc_hd__a211oi_2 _1064_ (.A1(net13),
    .A2(_0474_),
    .B1(net41),
    .C1(net21),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0494_));
 sky130_fd_sc_hd__o21ai_2 _1065_ (.A1(net39),
    .A2(_0466_),
    .B1(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0495_));
 sky130_fd_sc_hd__a21oi_2 _1066_ (.A1(_0385_),
    .A2(_0467_),
    .B1(_0495_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0496_));
 sky130_fd_sc_hd__a31o_2 _1067_ (.A1(net22),
    .A2(_0341_),
    .A3(_0472_),
    .B1(_0473_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0497_));
 sky130_fd_sc_hd__o31a_2 _1068_ (.A1(_0494_),
    .A2(_0496_),
    .A3(_0497_),
    .B1(net10),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0498_));
 sky130_fd_sc_hd__a211o_2 _1069_ (.A1(_0331_),
    .A2(_0472_),
    .B1(_0498_),
    .C1(net6),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0499_));
 sky130_fd_sc_hd__o2111ai_2 _1070_ (.A1(net21),
    .A2(_0346_),
    .B1(net6),
    .C1(_0461_),
    .D1(_0332_),
    ...
    .VPWR(VPWR),
    .Y(_0500_));
 sky130_fd_sc_hd__a21o_2 _1071_ (.A1(net21),
    .A2(_0472_),
    .B1(_0500_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0501_));
 sky130_fd_sc_hd__and2_2 _1072_ (.A(net4),
    .B(_0501_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0502_));
 sky130_fd_sc_hd__a221oi_2 _1073_ (.A1(_0298_),
    .A2(_0493_),
    .B1(_0499_),
    .B2(_0502_),
    .C1(_0355_),
    ...
    .VPWR(VPWR),
    .Y(_0503_));
 sky130_fd_sc_hd__o311a_2 _1074_ (.A1(net37),
    .A2(net24),
    .A3(net36),
    .B1(_0317_),
    .C1(_0315_),
    ...
    .VPWR(VPWR),
    .X(_0504_));
 sky130_fd_sc_hd__a221o_2 _1075_ (.A1(net36),
    .A2(net42),
    .B1(_0504_),
    .B2(_0329_),
    .C1(net33),
    ...
    .VPWR(VPWR),
    .X(_0505_));
 sky130_fd_sc_hd__o221a_2 _1076_ (.A1(net36),
    .A2(_0369_),
    .B1(_0377_),
    .B2(_0436_),
    .C1(net42),
    ...
    .VPWR(VPWR),
    .X(_0506_));
 sky130_fd_sc_hd__o211a_2 _1077_ (.A1(_0326_),
    .A2(_0369_),
    .B1(_0376_),
    .C1(net40),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0507_));
 sky130_fd_sc_hd__o32a_2 _1078_ (.A1(_0333_),
    .A2(_0506_),
    .A3(_0507_),
    .B1(_0378_),
    .B2(_0505_),
    ...
    .VPWR(VPWR),
    .X(_0508_));
 sky130_fd_sc_hd__or2_2 _1079_ (.A(net11),
    .B(_0358_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0509_));
 sky130_fd_sc_hd__o211a_2 _1080_ (.A1(net11),
    .A2(_0358_),
    .B1(_0376_),
    .C1(_0409_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0510_));
 sky130_fd_sc_hd__a211o_2 _1081_ (.A1(net9),
    .A2(_0350_),
    .B1(_0510_),
    .C1(_0332_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0511_));
 sky130_fd_sc_hd__a21oi_2 _1082_ (.A1(net23),
    .A2(_0508_),
    .B1(_0511_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0512_));
 sky130_fd_sc_hd__a211o_2 _1083_ (.A1(_0352_),
    .A2(_0478_),
    .B1(_0512_),
    .C1(_0402_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0513_));
 sky130_fd_sc_hd__a221o_2 _1084_ (.A1(net11),
    .A2(_0392_),
    .B1(_0481_),
    .B2(net42),
    .C1(_0504_),
    ...
    .VPWR(VPWR),
    .X(_0514_));
 sky130_fd_sc_hd__a21o_2 _1085_ (.A1(_0359_),
    .A2(_0388_),
    .B1(_0505_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0515_));
 sky130_fd_sc_hd__o211a_2 _1086_ (.A1(_0333_),
    .A2(_0514_),
    .B1(_0515_),
    .C1(net23),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0516_));
 sky130_fd_sc_hd__a211o_2 _1087_ (.A1(net38),
    .A2(net42),
    .B1(_0422_),
    .C1(_0436_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0517_));
 sky130_fd_sc_hd__a21o_2 _1088_ (.A1(net26),
    .A2(_0347_),
    .B1(_0362_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0518_));
 sky130_fd_sc_hd__mux2_1 _1089_ (.A0(_0358_),
    .A1(_0518_),
    .S(net11),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0519_));
 sky130_fd_sc_hd__a221o_2 _1090_ (.A1(_0409_),
    .A2(_0517_),
    .B1(_0519_),
    .B2(net9),
    .C1(_0332_),
    ...
    .VPWR(VPWR),
    .X(_0520_));
 sky130_fd_sc_hd__nor2_2 _1091_ (.A(net40),
    .B(_0366_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0521_));
 sky130_fd_sc_hd__a21o_2 _1092_ (.A1(net11),
    .A2(_0518_),
    .B1(net33),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0522_));
 sky130_fd_sc_hd__a311o_2 _1093_ (.A1(net14),
    .A2(_0358_),
    .A3(_0466_),
    .B1(_0521_),
    .C1(_0522_),
    ...
    .VPWR(VPWR),
    .X(_0523_));
 sky130_fd_sc_hd__o211a_2 _1094_ (.A1(net27),
    .A2(_0345_),
    .B1(_0315_),
    .C1(_0317_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0524_));
 sky130_fd_sc_hd__nor2_2 _1095_ (.A(net40),
    .B(_0388_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0525_));
 sky130_fd_sc_hd__or4_2 _1096_ (.A(_0333_),
    .B(_0422_),
    .C(_0524_),
    .D(_0525_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0526_));
 sky130_fd_sc_hd__a22o_2 _1097_ (.A1(_0359_),
    .A2(_0388_),
    .B1(_0418_),
    .B2(net14),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0527_));
 sky130_fd_sc_hd__a211o_2 _1098_ (.A1(net12),
    .A2(_0392_),
    .B1(_0524_),
    .C1(net42),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0528_));
 sky130_fd_sc_hd__a32o_2 _1099_ (.A1(_0409_),
    .A2(_0454_),
    .A3(_0528_),
    .B1(_0527_),
    .B2(_0337_),
    ...
    .VPWR(VPWR),
    .X(_0529_));
 sky130_fd_sc_hd__a311o_2 _1100_ (.A1(net23),
    .A2(_0523_),
    .A3(_0526_),
    .B1(_0529_),
    .C1(_0331_),
    ...
    .VPWR(VPWR),
    .X(_0530_));
 sky130_fd_sc_hd__o211ai_2 _1101_ (.A1(_0516_),
    .A2(_0520_),
    .B1(_0530_),
    .C1(_0402_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0531_));
 sky130_fd_sc_hd__a21o_2 _1102_ (.A1(_0513_),
    .A2(_0531_),
    .B1(net4),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0532_));
 sky130_fd_sc_hd__a211o_2 _1103_ (.A1(_0364_),
    .A2(_0504_),
    .B1(_0525_),
    .C1(_0378_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0533_));
 sky130_fd_sc_hd__a32o_2 _1104_ (.A1(net23),
    .A2(_0376_),
    .A3(_0509_),
    .B1(_0507_),
    .B2(_0409_),
    ...
    .VPWR(VPWR),
    .X(_0534_));
 sky130_fd_sc_hd__a221o_2 _1105_ (.A1(net42),
    .A2(_0510_),
    .B1(_0533_),
    .B2(net9),
    .C1(_0534_),
    ...
    .VPWR(VPWR),
    .X(_0535_));
 sky130_fd_sc_hd__a221o_2 _1106_ (.A1(_0350_),
    .A2(_0412_),
    .B1(_0535_),
    .B2(_0332_),
    .C1(_0402_),
    ...
    .VPWR(VPWR),
    .X(_0536_));
 sky130_fd_sc_hd__a21o_2 _1107_ (.A1(_0336_),
    .A2(_0350_),
    .B1(_0500_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0537_));
 sky130_fd_sc_hd__a31oi_2 _1108_ (.A1(net4),
    .A2(_0536_),
    .A3(_0537_),
    .B1(_0354_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0538_));
 sky130_fd_sc_hd__a211oi_2 _1109_ (.A1(_0532_),
    .A2(_0538_),
    .B1(_0274_),
    .C1(_0503_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0539_));
 sky130_fd_sc_hd__xnor2_2 _1110_ (.A(\logo_top[9] ),
    .B(\pix_y[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0540_));
 sky130_fd_sc_hd__o21ai_2 _1111_ (.A1(\logo_top[8] ),
    .A2(_0077_),
    .B1(_0540_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0541_));
 sky130_fd_sc_hd__nand2_2 _1112_ (.A(\logo_top[7] ),
    .B(_0076_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0542_));
 sky130_fd_sc_hd__a21bo_2 _1113_ (.A1(_0275_),
    .A2(_0296_),
    .B1_N(_0276_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0543_));
 sky130_fd_sc_hd__nor2_2 _1114_ (.A(\logo_top[7] ),
    .B(_0076_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0544_));
 sky130_fd_sc_hd__a211o_2 _1115_ (.A1(_0542_),
    .A2(_0543_),
    .B1(_0544_),
    .C1(_0541_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0545_));
 sky130_fd_sc_hd__a21oi_2 _1116_ (.A1(_0069_),
    .A2(\pix_x[6] ),
    .B1(_0314_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0546_));
 sky130_fd_sc_hd__nor2_2 _1117_ (.A(_0068_),
    .B(\pix_x[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0547_));
 sky130_fd_sc_hd__and2_2 _1118_ (.A(_0068_),
    .B(\pix_x[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0548_));
 sky130_fd_sc_hd__nand2b_2 _1119_ (.A_N(\pix_x[8] ),
    .B(\logo_left[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0549_));
 sky130_fd_sc_hd__nand2b_2 _1120_ (.A_N(\logo_left[8] ),
    .B(\pix_x[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0550_));
 sky130_fd_sc_hd__nand2_2 _1121_ (.A(_0549_),
    .B(_0550_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0551_));
 sky130_fd_sc_hd__a21o_2 _1122_ (.A1(_0547_),
    .A2(_0551_),
    .B1(_0548_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0552_));
 sky130_fd_sc_hd__nand2_2 _1123_ (.A(_0546_),
    .B(_0552_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0553_));
 sky130_fd_sc_hd__o31a_2 _1124_ (.A1(_0546_),
    .A2(_0547_),
    .A3(_0548_),
    .B1(_0553_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0554_));
 sky130_fd_sc_hd__xor2_2 _1125_ (.A(\logo_left[9] ),
    .B(\pix_x[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0555_));
 sky130_fd_sc_hd__xnor2_2 _1126_ (.A(_0549_),
    .B(_0555_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0556_));
 sky130_fd_sc_hd__a21oi_2 _1127_ (.A1(\logo_top[8] ),
    .A2(_0077_),
    .B1(_0540_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0557_));
 sky130_fd_sc_hd__a31o_2 _1128_ (.A1(\logo_top[8] ),
    .A2(_0077_),
    .A3(_0540_),
    .B1(_0556_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0558_));
 sky130_fd_sc_hd__o21ai_2 _1129_ (.A1(_0542_),
    .A2(_0543_),
    .B1(_0541_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0559_));
 sky130_fd_sc_hd__o21bai_2 _1130_ (.A1(_0546_),
    .A2(_0547_),
    .B1_N(_0548_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0560_));
 sky130_fd_sc_hd__a2111o_2 _1131_ (.A1(_0551_),
    .A2(_0560_),
    .B1(_0558_),
    .C1(_0557_),
    .D1(_0554_),
    ...
    .VPWR(VPWR),
    .X(_0561_));
 sky130_fd_sc_hd__a21oi_2 _1132_ (.A1(_0543_),
    .A2(_0544_),
    .B1(_0561_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0562_));
 sky130_fd_sc_hd__a31o_2 _1133_ (.A1(_0545_),
    .A2(_0559_),
    .A3(_0562_),
    .B1(net2),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0563_));
 sky130_fd_sc_hd__o21ai_2 _1134_ (.A1(\pix_x[7] ),
    .A2(\pix_x[8] ),
    .B1(\pix_x[9] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0564_));
 sky130_fd_sc_hd__and4b_2 _1135_ (.A_N(\pix_y[9] ),
    .B(net50),
    .C(_0083_),
    .D(_0564_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0565_));
 sky130_fd_sc_hd__nand2_2 _1136_ (.A(_0563_),
    .B(_0565_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0566_));
 sky130_fd_sc_hd__a211oi_2 _1137_ (.A1(_0274_),
    .A2(_0464_),
    .B1(_0539_),
    .C1(_0566_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0567_));
 sky130_fd_sc_hd__a211o_2 _1138_ (.A1(_0274_),
    .A2(_0464_),
    .B1(_0539_),
    .C1(_0566_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0568_));
 sky130_fd_sc_hd__o31a_2 _1139_ (.A1(net92),
    .A2(_0063_),
    .A3(_0082_),
    .B1(_0567_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0057_));
 sky130_fd_sc_hd__and2_2 _1140_ (.A(\color_index[2] ),
    .B(\color_index[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0569_));
 sky130_fd_sc_hd__nand2_2 _1141_ (.A(net89),
    .B(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0570_));
 sky130_fd_sc_hd__o21a_2 _1142_ (.A1(_0569_),
    .A2(_0570_),
    .B1(_0567_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0058_));
 sky130_fd_sc_hd__or2_2 _1143_ (.A(\color_index[2] ),
    .B(_0570_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0571_));
 sky130_fd_sc_hd__nor2_2 _1144_ (.A(\color_index[0] ),
    .B(_0082_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0572_));
 sky130_fd_sc_hd__mux2_1 _1145_ (.A0(\color_index[0] ),
    .A1(_0572_),
    .S(_0571_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0573_));
 sky130_fd_sc_hd__nor2_2 _1146_ (.A(_0568_),
    .B(_0573_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0059_));
 sky130_fd_sc_hd__nor2_2 _1147_ (.A(\color_index[2] ),
    .B(\color_index[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0574_));
 sky130_fd_sc_hd__nor2_2 _1148_ (.A(_0569_),
    .B(_0574_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0575_));
 sky130_fd_sc_hd__a31oi_2 _1149_ (.A1(net3),
    .A2(_0571_),
    .A3(_0575_),
    .B1(_0568_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0060_));
 sky130_fd_sc_hd__o31a_2 _1150_ (.A1(net92),
    .A2(\color_index[0] ),
    .A3(_0082_),
    .B1(_0567_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0061_));
 sky130_fd_sc_hd__o31a_2 _1151_ (.A1(net89),
    .A2(_0082_),
    .A3(_0575_),
    .B1(_0567_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0062_));
 sky130_fd_sc_hd__dfxtp_2 _1152_ (.CLK(clknet_3_4__leaf_clk),
    .D(_0002_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_y[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1153_ (.CLK(clknet_3_1__leaf_clk),
    .D(_0003_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_y[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1154_ (.CLK(clknet_3_4__leaf_clk),
    .D(_0004_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_y[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1155_ (.CLK(clknet_3_1__leaf_clk),
    .D(_0005_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_y[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1156_ (.CLK(clknet_3_1__leaf_clk),
    .D(_0006_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_y[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1157_ (.CLK(clknet_3_1__leaf_clk),
    .D(_0007_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_y[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1158_ (.CLK(clknet_3_6__leaf_clk),
    .D(_0008_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_y[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1159_ (.CLK(clknet_3_6__leaf_clk),
    .D(_0009_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_y[7] ));
 sky130_fd_sc_hd__dfxtp_2 _1160_ (.CLK(clknet_3_6__leaf_clk),
    .D(_0010_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1161_ (.CLK(clknet_3_6__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\pix_y[9] ));
 sky130_fd_sc_hd__dfxtp_2 _1162_ (.CLK(clknet_3_0__leaf_clk),
    .D(_0012_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1163_ (.CLK(clknet_3_0__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\pix_x[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1164_ (.CLK(clknet_3_0__leaf_clk),
    .D(_0014_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_x[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1165_ (.CLK(clknet_3_1__leaf_clk),
    .D(_0015_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_x[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1166_ (.CLK(clknet_3_1__leaf_clk),
    .D(_0016_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_x[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1167_ (.CLK(clknet_3_1__leaf_clk),
    .D(net84),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_x[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1168_ (.CLK(clknet_3_1__leaf_clk),
    .D(_0018_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_x[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1169_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0019_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_x[7] ));
 sky130_fd_sc_hd__dfxtp_2 _1170_ (.CLK(clknet_3_2__leaf_clk),
    .D(_0020_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_x[8] ));
 sky130_fd_sc_hd__dfxtp_2 _1171_ (.CLK(clknet_3_2__leaf_clk),
    .D(_0021_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_x[9] ));
 sky130_fd_sc_hd__dfxtp_2 _1172_ (.CLK(clknet_3_4__leaf_clk),
    .D(net75),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\prev_y[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1173_ (.CLK(clknet_3_5__leaf_clk),
    .D(_0023_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1174_ (.CLK(clknet_3_4__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\prev_y[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1175_ (.CLK(clknet_3_5__leaf_clk),
    .D(_0025_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\prev_y[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1176_ (.CLK(clknet_3_4__leaf_clk),
    .D(net71),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\prev_y[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1177_ (.CLK(clknet_3_4__leaf_clk),
    .D(_0027_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1179_ (.CLK(clknet_3_5__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\prev_y[7] ));
 sky130_fd_sc_hd__dfxtp_2 _1180_ (.CLK(clknet_3_4__leaf_clk),
    .D(net78),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1181_ (.CLK(clknet_3_4__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\prev_y[9] ));
 sky130_fd_sc_hd__dfxtp_2 _1182_ (.CLK(clknet_3_0__leaf_clk),
    .D(_0032_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_left[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1183_ (.CLK(clknet_3_0__leaf_clk),
    .D(_0033_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_left[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1184_ (.CLK(clknet_3_0__leaf_clk),
    .D(_0034_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_left[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1185_ (.CLK(clknet_3_0__leaf_clk),
    .D(_0035_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_left[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1186_ (.CLK(clknet_3_0__leaf_clk),
    .D(_0036_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_left[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1187_ (.CLK(clknet_3_2__leaf_clk),
    .D(_0037_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_left[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1188_ (.CLK(clknet_3_2__leaf_clk),
    .D(_0038_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1191_ (.CLK(clknet_3_2__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\logo_left[9] ));
 sky130_fd_sc_hd__dfxtp_2 _1192_ (.CLK(clknet_3_5__leaf_clk),
    .D(_0042_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_top[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1193_ (.CLK(clknet_3_5__leaf_clk),
    .D(_0043_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_top[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1194_ (.CLK(clknet_3_5__leaf_clk),
    .D(_0044_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_top[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1195_ (.CLK(clknet_3_5__leaf_clk),
    .D(_0045_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_top[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1196_ (.CLK(clknet_3_7__leaf_clk),
    .D(_0046_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_top[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1197_ (.CLK(clknet_3_7__leaf_clk),
    .D(_0047_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_top[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1198_ (.CLK(clknet_3_7__leaf_clk),
    .D(_0048_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_top[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1199_ (.CLK(clknet_3_7__leaf_clk),
    .D(_0049_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_top[7] ));
 sky130_fd_sc_hd__dfxtp_2 _1200_ (.CLK(clknet_3_7__leaf_clk),
    .D(_0050_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_top[8] ));
 sky130_fd_sc_hd__dfxtp_2 _1201_ (.CLK(clknet_3_7__leaf_clk),
    .D(_0051_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1202_ (.CLK(clknet_3_2__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(dir_x));
 sky130_fd_sc_hd__dfxtp_2 _1203_ (.CLK(clknet_3_7__leaf_clk),
    .D(_0053_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(dir_y));
 sky130_fd_sc_hd__dfxtp_2 _1204_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0054_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\color_index[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1205_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0055_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\color_index[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1206_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0056_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\color_index[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1207_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0057_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1208_ (.CLK(clknet_3_6__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(uo_out[2]));
 sky130_fd_sc_hd__dfxtp_2 _1209_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0059_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uo_out[5]));
 sky130_fd_sc_hd__dfxtp_2 _1210_ (.CLK(clknet_3_6__leaf_clk),
    .D(_0060_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1211_ (.CLK(clknet_3_3__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(uo_out[4]));
 sky130_fd_sc_hd__dfxtp_2 _1212_ (.CLK(clknet_3_6__leaf_clk),
    .D(_0062_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uo_out[0]));
 sky130_fd_sc_hd__dfxtp_2 _1213_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0000_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 _1231_ (.A(\vga_sync_gen.vsync ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[3]));
 sky130_fd_sc_hd__buf_2 _1232_ (.A(hsync),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 clkload0 (.A(clknet_3_7__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout10 (.A(_0332_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout11 (.A(net12),
    ...
    .VPWR(VPWR),
    .X(net11));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout12 (.A(_0319_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net12));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout13 (.A(_0318_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net13));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout14 (.A(_0318_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net14));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout15 (.A(_0146_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout16 (.A(net18),
    ...
    .VPWR(VPWR),
    .X(net16));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout18 (.A(_0145_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net18));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout21 (.A(_0336_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net21));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout22 (.A(_0335_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net22));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout23 (.A(_0335_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout25 (.A(net26),
    ...
    .VPWR(VPWR),
    .X(net25));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout26 (.A(_0325_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout27 (.A(net28),
    ...
    .VPWR(VPWR),
    .X(net27));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout28 (.A(_0324_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net28));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout29 (.A(_0099_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout30 (.A(net31),
    ...
    .VPWR(VPWR),
    .X(net30));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout31 (.A(_0094_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net31));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout32 (.A(_0334_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net32));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout33 (.A(_0334_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net33));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout34 (.A(_0333_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net34));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout36 (.A(_0326_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout37 (.A(net38),
    ...
    .VPWR(VPWR),
    .X(net37));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout38 (.A(_0321_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net38));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout39 (.A(_0340_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net39));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout40 (.A(_0340_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net40));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout41 (.A(_0339_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net41));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout42 (.A(_0339_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net42));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout43 (.A(dir_y),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net43));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout44 (.A(dir_x),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout48 (.A(net49),
    ...
    .VPWR(VPWR),
    .X(net48));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout49 (.A(net1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net49));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout7 (.A(_0359_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net7));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout8 (.A(_0358_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net8));
 sky130_fd_sc_hd__dlygate4sd3_1 hold66 (.A(dir_y),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net66));
 sky130_fd_sc_hd__dlygate4sd3_1 hold67 (.A(\prev_y[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net67));
 sky130_fd_sc_hd__dlygate4sd3_1 hold68 (.A(\prev_y[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net68));
 sky130_fd_sc_hd__dlygate4sd3_1 hold69 (.A(\prev_y[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net69));
 sky130_fd_sc_hd__dlygate4sd3_1 hold70 (.A(\prev_y[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net70));
 sky130_fd_sc_hd__dlygate4sd3_1 hold71 (.A(_0026_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net71));
 sky130_fd_sc_hd__dlygate4sd3_1 hold72 (.A(\pix_x[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold73 (.A(_0013_),
    ...
    .VPWR(VPWR),
    .X(net73));
 sky130_fd_sc_hd__dlygate4sd3_1 hold74 (.A(\prev_y[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net74));
 sky130_fd_sc_hd__dlygate4sd3_1 hold75 (.A(_0022_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net75));
 sky130_fd_sc_hd__dlygate4sd3_1 hold76 (.A(\prev_y[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net76));
 sky130_fd_sc_hd__dlygate4sd3_1 hold77 (.A(\prev_y[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net77));
 sky130_fd_sc_hd__dlygate4sd3_1 hold78 (.A(_0030_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net78));
 sky130_fd_sc_hd__dlygate4sd3_1 hold79 (.A(\prev_y[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net79));
 sky130_fd_sc_hd__dlygate4sd3_1 hold80 (.A(\prev_y[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net80));
 sky130_fd_sc_hd__dlygate4sd3_1 hold81 (.A(\prev_y[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net81));
 sky130_fd_sc_hd__dlygate4sd3_1 hold82 (.A(\color_index[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net82));
 sky130_fd_sc_hd__dlygate4sd3_1 hold83 (.A(\pix_x[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net83));
 sky130_fd_sc_hd__dlygate4sd3_1 hold84 (.A(_0017_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net84));
 sky130_fd_sc_hd__dlygate4sd3_1 hold85 (.A(\pix_x[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net85));
 sky130_fd_sc_hd__dlygate4sd3_1 hold86 (.A(\pix_x[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net86));
 sky130_fd_sc_hd__dlygate4sd3_1 hold87 (.A(\logo_left[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net87));
 sky130_fd_sc_hd__dlygate4sd3_1 hold88 (.A(\pix_x[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net88));
 sky130_fd_sc_hd__dlygate4sd3_1 hold89 (.A(\color_index[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net89));
 sky130_fd_sc_hd__dlygate4sd3_1 hold90 (.A(\pix_y[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net90));
 sky130_fd_sc_hd__dlygate4sd3_1 hold91 (.A(\logo_left[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net91));
 sky130_fd_sc_hd__dlygate4sd3_1 hold92 (.A(\color_index[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net92));
 sky130_fd_sc_hd__dlygate4sd3_1 hold93 (.A(\pix_y[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net93));
 sky130_fd_sc_hd__dlygate4sd3_1 hold94 (.A(\logo_top[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net94));
 sky130_fd_sc_hd__dlygate4sd3_1 hold95 (.A(\logo_left[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net95));
 sky130_fd_sc_hd__dlygate4sd3_1 hold96 (.A(\logo_top[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net96));
 sky130_fd_sc_hd__dlygate4sd3_1 hold97 (.A(\pix_x[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 load_slew17 (.A(net16),
    ...
    .VPWR(VPWR),
    .X(net17));
 sky130_fd_sc_hd__buf_2 load_slew19 (.A(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 load_slew46 (.A(net45),
    ...
    .VPWR(VPWR),
    .X(net46));
 sky130_fd_sc_hd__buf_1 max_cap20 (.A(_0145_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net20));
 sky130_fd_sc_hd__clkbuf_2 max_cap35 (.A(_0327_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net35));
 sky130_fd_sc_hd__clkbuf_2 max_cap5 (.A(_0260_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net5));
 sky130_fd_sc_hd__clkbuf_2 max_cap6 (.A(_0402_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net6));
 sky130_fd_sc_hd__buf_2 max_cap9 (.A(_0337_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__conb_1 tt_um_eric_lcc (.VGND(VGND),
    ...
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 tt_um_eric_lcc_51 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net51));
 sky130_fd_sc_hd__conb_1 tt_um_eric_lcc_52 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net52));
 sky130_fd_sc_hd__conb_1 tt_um_eric_lcc_53 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net53));
 sky130_fd_sc_hd__conb_1 tt_um_eric_lcc_54 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net54));
 sky130_fd_sc_hd__conb_1 tt_um_eric_lcc_55 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net55));
 sky130_fd_sc_hd__conb_1 tt_um_eric_lcc_56 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net56));
 sky130_fd_sc_hd__conb_1 tt_um_eric_lcc_57 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net57));
 sky130_fd_sc_hd__conb_1 tt_um_eric_lcc_58 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net58));
 sky130_fd_sc_hd__conb_1 tt_um_eric_lcc_59 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net59));
 sky130_fd_sc_hd__conb_1 tt_um_eric_lcc_60 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net60));
 sky130_fd_sc_hd__conb_1 tt_um_eric_lcc_61 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net61));
 sky130_fd_sc_hd__conb_1 tt_um_eric_lcc_62 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net62));
 sky130_fd_sc_hd__conb_1 tt_um_eric_lcc_63 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net63));
 ...
 sky130_fd_sc_hd__conb_1 tt_um_eric_lcc_65 (.VGND(VGND),
    ...
    .VPWR(VPWR),
    .LO(net65));
 sky130_fd_sc_hd__buf_2 wire4 (.A(_0297_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
