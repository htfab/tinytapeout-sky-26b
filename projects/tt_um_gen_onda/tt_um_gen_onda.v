module tt_um_gen_onda (clk,
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_137 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _269_ (.A(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_222_));
 sky130_fd_sc_hd__inv_2 _270_ (.A(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_223_));
 sky130_fd_sc_hd__inv_2 _271_ (.A(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_224_));
 sky130_fd_sc_hd__inv_2 _272_ (.A(net4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_225_));
 sky130_fd_sc_hd__inv_2 _273_ (.A(net33),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_226_));
 sky130_fd_sc_hd__or3_2 _274_ (.A(net9),
    .B(net10),
    .C(net30),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_227_));
 sky130_fd_sc_hd__or4b_2 _275_ (.A(net9),
    .B(net30),
    .C(net10),
    .D_N(\phase_acc[7] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_228_));
 sky130_fd_sc_hd__xnor2_2 _276_ (.A(net49),
    .B(_227_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_000_));
 sky130_fd_sc_hd__xnor2_2 _277_ (.A(net29),
    .B(_228_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_001_));
 sky130_fd_sc_hd__a21oi_2 _278_ (.A1(\phase_acc[7] ),
    .A2(net29),
    .B1(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_229_));
 sky130_fd_sc_hd__nor2_2 _279_ (.A(net10),
    .B(_229_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_230_));
 sky130_fd_sc_hd__nand2_2 _280_ (.A(net33),
    .B(_230_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_231_));
 sky130_fd_sc_hd__xnor2_2 _281_ (.A(net27),
    .B(_231_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_002_));
 sky130_fd_sc_hd__a22o_2 _282_ (.A1(_222_),
    .A2(net10),
    .B1(net27),
    .B2(_230_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_232_));
 sky130_fd_sc_hd__and3_2 _283_ (.A(net24),
    .B(net33),
    .C(_232_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_233_));
 sky130_fd_sc_hd__a21oi_2 _284_ (.A1(net33),
    .A2(_232_),
    .B1(net24),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_234_));
 sky130_fd_sc_hd__nor2_2 _285_ (.A(_233_),
    .B(_234_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_003_));
 sky130_fd_sc_hd__nor2_2 _286_ (.A(net22),
    .B(_233_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_235_));
 sky130_fd_sc_hd__and3_2 _287_ (.A(net25),
    .B(net22),
    .C(net33),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_236_));
 sky130_fd_sc_hd__a21oi_2 _288_ (.A1(_232_),
    .A2(_236_),
    .B1(_235_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_004_));
 sky130_fd_sc_hd__a32o_2 _289_ (.A1(net9),
    .A2(net10),
    .A3(net33),
    .B1(_232_),
    .B2(_236_),
    ...
    .VPWR(VPWR),
    .X(_237_));
 sky130_fd_sc_hd__and2_2 _290_ (.A(net21),
    .B(_237_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_238_));
 sky130_fd_sc_hd__xnor2_2 _291_ (.A(_223_),
    .B(_237_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_005_));
 sky130_fd_sc_hd__xor2_2 _292_ (.A(net18),
    .B(_238_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_006_));
 sky130_fd_sc_hd__nand2_2 _293_ (.A(net17),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_239_));
 sky130_fd_sc_hd__and3_2 _294_ (.A(net18),
    .B(net15),
    .C(_238_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_240_));
 sky130_fd_sc_hd__a21oi_2 _295_ (.A1(net18),
    .A2(_238_),
    .B1(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_241_));
 sky130_fd_sc_hd__nor2_2 _296_ (.A(_240_),
    .B(_241_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_007_));
 sky130_fd_sc_hd__xnor2_2 _297_ (.A(_224_),
    .B(_240_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_008_));
 sky130_fd_sc_hd__nor3_2 _298_ (.A(net8),
    .B(net7),
    .C(net6),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_242_));
 sky130_fd_sc_hd__and2_2 _299_ (.A(net26),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_243_));
 sky130_fd_sc_hd__and2_2 _300_ (.A(net25),
    .B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_244_));
 sky130_fd_sc_hd__nand2_2 _301_ (.A(net16),
    .B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_245_));
 sky130_fd_sc_hd__nand2_2 _302_ (.A(net24),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_246_));
 sky130_fd_sc_hd__nand4_2 _303_ (.A(net26),
    .B(net24),
    .C(net15),
    .D(net13),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_247_));
 sky130_fd_sc_hd__nand2_2 _304_ (.A(net22),
    .B(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_248_));
 sky130_fd_sc_hd__nand2_2 _305_ (.A(net26),
    .B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_249_));
 sky130_fd_sc_hd__a22o_2 _306_ (.A1(net24),
    .A2(net15),
    .B1(net13),
    .B2(net26),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_250_));
 sky130_fd_sc_hd__nand3b_2 _307_ (.A_N(_248_),
    .B(_250_),
    .C(_247_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_251_));
 sky130_fd_sc_hd__nand2_2 _308_ (.A(_247_),
    .B(_251_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_252_));
 sky130_fd_sc_hd__a21bo_2 _309_ (.A1(_247_),
    .A2(_250_),
    .B1_N(_248_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_253_));
 sky130_fd_sc_hd__nand2_2 _310_ (.A(net28),
    .B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_254_));
 sky130_fd_sc_hd__a22o_2 _311_ (.A1(net26),
    .A2(net15),
    .B1(net13),
    .B2(net28),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_255_));
 sky130_fd_sc_hd__nand2_2 _312_ (.A(net28),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_256_));
 sky130_fd_sc_hd__and2_2 _313_ (.A(net24),
    .B(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_257_));
 sky130_fd_sc_hd__a2bb2o_2 _314_ (.A1_N(_249_),
    .A2_N(_256_),
    .B1(_257_),
    .B2(_255_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_258_));
 sky130_fd_sc_hd__nand3_2 _315_ (.A(_251_),
    .B(_253_),
    .C(_258_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_259_));
 sky130_fd_sc_hd__nand2_2 _316_ (.A(net22),
    .B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_260_));
 sky130_fd_sc_hd__xnor2_2 _317_ (.A(_223_),
    .B(_248_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_261_));
 sky130_fd_sc_hd__nor2_2 _318_ (.A(_246_),
    .B(_261_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_262_));
 sky130_fd_sc_hd__xor2_2 _319_ (.A(_246_),
    .B(_261_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_263_));
 sky130_fd_sc_hd__a21o_2 _320_ (.A1(_251_),
    .A2(_253_),
    .B1(_258_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_264_));
 sky130_fd_sc_hd__nand3_2 _321_ (.A(_259_),
    .B(_263_),
    .C(_264_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_265_));
 sky130_fd_sc_hd__and2_2 _322_ (.A(_259_),
    .B(_265_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_266_));
 sky130_fd_sc_hd__a21oi_2 _323_ (.A1(_247_),
    .A2(_251_),
    .B1(_266_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_267_));
 sky130_fd_sc_hd__a31o_2 _324_ (.A1(net22),
    .A2(net21),
    .A3(net18),
    .B1(_262_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xnor2_2 _325_ (.A(_252_),
    ...
    .VPWR(VPWR),
    .Y(_017_));
 sky130_fd_sc_hd__a21o_2 _326_ (.A1(_268_),
    .A2(_017_),
    .B1(_267_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_018_));
 sky130_fd_sc_hd__a22o_2 _327_ (.A1(net20),
    .A2(net17),
    .B1(net16),
    .B2(net22),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_019_));
 sky130_fd_sc_hd__o21a_2 _328_ (.A1(_239_),
    .A2(_260_),
    .B1(_019_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_020_));
 sky130_fd_sc_hd__and2_2 _329_ (.A(_244_),
    .B(_020_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_021_));
 sky130_fd_sc_hd__o21ai_2 _330_ (.A1(_244_),
    .A2(_020_),
    .B1(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_022_));
 sky130_fd_sc_hd__mux2_1 _331_ (.A0(_022_),
    .A1(net17),
    .S(_021_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_023_));
 sky130_fd_sc_hd__o31a_2 _332_ (.A1(net17),
    .A2(_244_),
    .A3(_019_),
    .B1(_023_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_024_));
 sky130_fd_sc_hd__nand2_2 _333_ (.A(_018_),
    .B(_024_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_025_));
 sky130_fd_sc_hd__inv_2 _334_ (.A(_025_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_026_));
 sky130_fd_sc_hd__xnor2_2 _335_ (.A(_018_),
    .B(_024_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_027_));
 sky130_fd_sc_hd__xor2_2 _336_ (.A(_268_),
    .B(_017_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_028_));
 sky130_fd_sc_hd__a21o_2 _337_ (.A1(_259_),
    .A2(_264_),
    .B1(_263_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_029_));
 sky130_fd_sc_hd__o21a_2 _338_ (.A1(_249_),
    .A2(_256_),
    .B1(_255_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_030_));
 sky130_fd_sc_hd__nand2_2 _339_ (.A(net28),
    .B(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_031_));
 sky130_fd_sc_hd__and3_2 _340_ (.A(net28),
    .B(net18),
    .C(_243_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_032_));
 sky130_fd_sc_hd__nand4_2 _341_ (.A(net28),
    .B(net27),
    .C(net18),
    .D(net15),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_033_));
 sky130_fd_sc_hd__mux2_1 _342_ (.A0(_257_),
    .A1(_032_),
    .S(_030_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_034_));
 sky130_fd_sc_hd__nand3_2 _343_ (.A(_265_),
    .B(_029_),
    .C(_034_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_035_));
 sky130_fd_sc_hd__nand2_2 _344_ (.A(net20),
    .B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_036_));
 sky130_fd_sc_hd__nor2_2 _345_ (.A(_249_),
    .B(_260_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_037_));
 sky130_fd_sc_hd__and2_2 _346_ (.A(_249_),
    .B(_260_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_038_));
 sky130_fd_sc_hd__nor2_2 _347_ (.A(_037_),
    .B(_038_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_039_));
 sky130_fd_sc_hd__a21o_2 _348_ (.A1(_265_),
    .A2(_029_),
    .B1(_034_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_040_));
 sky130_fd_sc_hd__nand3_2 _349_ (.A(_035_),
    .B(_039_),
    .C(_040_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_041_));
 sky130_fd_sc_hd__and2_2 _350_ (.A(_035_),
    .B(_041_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_042_));
 sky130_fd_sc_hd__nand2b_2 _351_ (.A_N(_042_),
    .B(_028_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_043_));
 sky130_fd_sc_hd__xnor2_2 _352_ (.A(_028_),
    .B(_042_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_044_));
 sky130_fd_sc_hd__nand2_2 _353_ (.A(_037_),
    .B(_044_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_045_));
 sky130_fd_sc_hd__a21oi_2 _354_ (.A1(_043_),
    .A2(_045_),
    .B1(_027_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_046_));
 sky130_fd_sc_hd__and3_2 _355_ (.A(_027_),
    .B(_043_),
    .C(_045_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_047_));
 sky130_fd_sc_hd__nor2_2 _356_ (.A(_046_),
    .B(_047_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_048_));
 sky130_fd_sc_hd__xnor2_2 _357_ (.A(_037_),
    .B(_044_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_2 _358_ (.A1(_035_),
    ...
    .VPWR(VPWR),
    .X(_050_));
 sky130_fd_sc_hd__nand2_2 _359_ (.A(net26),
    .B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_051_));
 sky130_fd_sc_hd__nand2_2 _360_ (.A(net20),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_052_));
 sky130_fd_sc_hd__a21o_2 _361_ (.A1(net24),
    .A2(net21),
    .B1(_243_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_053_));
 sky130_fd_sc_hd__o21a_2 _362_ (.A1(_246_),
    .A2(_051_),
    .B1(_053_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_054_));
 sky130_fd_sc_hd__and3_2 _363_ (.A(net28),
    .B(net13),
    .C(_054_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_055_));
 sky130_fd_sc_hd__xnor2_2 _364_ (.A(_254_),
    .B(_054_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_056_));
 sky130_fd_sc_hd__a22o_2 _365_ (.A1(net27),
    .A2(net18),
    .B1(net15),
    .B2(net29),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_057_));
 sky130_fd_sc_hd__and3_2 _366_ (.A(net22),
    .B(_033_),
    .C(_057_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_058_));
 sky130_fd_sc_hd__or2_2 _367_ (.A(_032_),
    .B(_058_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_059_));
 sky130_fd_sc_hd__xor2_2 _368_ (.A(_030_),
    .B(_059_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_060_));
 sky130_fd_sc_hd__a22o_2 _369_ (.A1(_030_),
    .A2(_058_),
    .B1(_060_),
    .B2(_056_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3_2 _370_ (.A(_041_),
    ...
    .VPWR(VPWR),
    .X(_062_));
 sky130_fd_sc_hd__o21ba_2 _371_ (.A1(_246_),
    .A2(_051_),
    .B1_N(_055_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_063_));
 sky130_fd_sc_hd__a21oi_2 _372_ (.A1(_041_),
    .A2(_050_),
    .B1(_061_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_064_));
 sky130_fd_sc_hd__or3_2 _373_ (.A(_062_),
    .B(_063_),
    .C(_064_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_065_));
 sky130_fd_sc_hd__and2b_2 _374_ (.A_N(_062_),
    .B(_065_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_066_));
 sky130_fd_sc_hd__or2_2 _375_ (.A(_049_),
    .B(_066_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_067_));
 sky130_fd_sc_hd__xnor2_2 _376_ (.A(_049_),
    .B(_066_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_068_));
 sky130_fd_sc_hd__o21ai_2 _377_ (.A1(_062_),
    .A2(_064_),
    .B1(_063_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_069_));
 sky130_fd_sc_hd__a21oi_2 _378_ (.A1(_033_),
    .A2(_057_),
    .B1(net23),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_070_));
 sky130_fd_sc_hd__nor4_2 _379_ (.A(_031_),
    .B(_051_),
    .C(_058_),
    .D(_070_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_071_));
 sky130_fd_sc_hd__o22a_2 _380_ (.A1(_031_),
    .A2(_051_),
    .B1(_058_),
    .B2(_070_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_072_));
 sky130_fd_sc_hd__nor2_2 _381_ (.A(_071_),
    .B(_072_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_073_));
 sky130_fd_sc_hd__and3_2 _382_ (.A(net27),
    .B(net23),
    .C(_257_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_074_));
 sky130_fd_sc_hd__a22oi_2 _383_ (.A1(net24),
    .A2(net23),
    .B1(net19),
    .B2(net27),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_075_));
 sky130_fd_sc_hd__nor2_2 _384_ (.A(_074_),
    .B(_075_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_076_));
 sky130_fd_sc_hd__xnor2_2 _385_ (.A(_256_),
    .B(_076_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_077_));
 sky130_fd_sc_hd__a21o_2 _386_ (.A1(_073_),
    .A2(_077_),
    .B1(_071_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_078_));
 sky130_fd_sc_hd__xnor2_2 _387_ (.A(_056_),
    .B(_060_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_079_));
 sky130_fd_sc_hd__and2b_2 _388_ (.A_N(_079_),
    .B(_078_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_080_));
 sky130_fd_sc_hd__a31o_2 _389_ (.A1(net29),
    .A2(\phase[6] ),
    .A3(_076_),
    .B1(_074_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_081_));
 sky130_fd_sc_hd__xnor2_2 _390_ (.A(_078_),
    .B(_079_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_082_));
 sky130_fd_sc_hd__and2_2 _391_ (.A(_081_),
    .B(_082_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_083_));
 sky130_fd_sc_hd__or2_2 _392_ (.A(_080_),
    .B(_083_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_084_));
 sky130_fd_sc_hd__and3_2 _393_ (.A(_065_),
    .B(_069_),
    .C(_084_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_085_));
 sky130_fd_sc_hd__and3_2 _394_ (.A(net28),
    .B(net23),
    .C(net21),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_086_));
 sky130_fd_sc_hd__nor2_2 _395_ (.A(_081_),
    .B(_082_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_087_));
 sky130_fd_sc_hd__a32o_2 _396_ (.A1(net28),
    .A2(net24),
    .A3(net21),
    .B1(net23),
    .B2(net26),
    ...
    .VPWR(VPWR),
    .X(_088_));
 sky130_fd_sc_hd__o21a_2 _397_ (.A1(net26),
    .A2(net23),
    .B1(net24),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_089_));
 sky130_fd_sc_hd__o21ai_2 _398_ (.A1(_086_),
    .A2(_089_),
    .B1(_088_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_090_));
 sky130_fd_sc_hd__xnor2_2 _399_ (.A(_073_),
    .B(_077_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_091_));
 sky130_fd_sc_hd__a221o_2 _400_ (.A1(_031_),
    .A2(_051_),
    .B1(_090_),
    .B2(_091_),
    .C1(_087_),
    ...
    .VPWR(VPWR),
    .X(_092_));
 sky130_fd_sc_hd__o2bb2a_2 _401_ (.A1_N(_074_),
    .A2_N(_086_),
    .B1(_092_),
    .B2(_083_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_093_));
 sky130_fd_sc_hd__a21oi_2 _402_ (.A1(_065_),
    .A2(_069_),
    .B1(_084_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_094_));
 sky130_fd_sc_hd__or2_2 _403_ (.A(_085_),
    .B(_094_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_095_));
 sky130_fd_sc_hd__or2_2 _404_ (.A(_093_),
    .B(_095_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_096_));
 sky130_fd_sc_hd__o21ba_2 _405_ (.A1(_093_),
    .A2(_094_),
    .B1_N(_085_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_097_));
 sky130_fd_sc_hd__o21ai_2 _406_ (.A1(_068_),
    .A2(_097_),
    .B1(_067_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_098_));
 sky130_fd_sc_hd__and2_2 _407_ (.A(_048_),
    .B(_098_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_099_));
 sky130_fd_sc_hd__nand2_2 _408_ (.A(net22),
    .B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_100_));
 sky130_fd_sc_hd__xor2_2 _409_ (.A(_052_),
    .B(_100_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_101_));
 sky130_fd_sc_hd__a2bb2o_2 _410_ (.A1_N(_239_),
    .A2_N(_260_),
    .B1(_021_),
    .B2(net17),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_102_));
 sky130_fd_sc_hd__xnor2_2 _411_ (.A(_101_),
    .B(_102_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_103_));
 sky130_fd_sc_hd__nor2_2 _412_ (.A(_023_),
    .B(_103_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_104_));
 sky130_fd_sc_hd__and2_2 _413_ (.A(_023_),
    .B(_103_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_105_));
 sky130_fd_sc_hd__nor2_2 _414_ (.A(_104_),
    .B(_105_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_106_));
 sky130_fd_sc_hd__xnor2_2 _415_ (.A(_025_),
    .B(_106_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_107_));
 sky130_fd_sc_hd__or3_2 _416_ (.A(_046_),
    .B(_099_),
    .C(_107_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_108_));
 sky130_fd_sc_hd__and3b_2 _417_ (.A_N(net3),
    .B(_225_),
    .C(net5),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_109_));
 sky130_fd_sc_hd__o21ai_2 _418_ (.A1(_046_),
    .A2(_099_),
    .B1(_107_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_110_));
 sky130_fd_sc_hd__nand2b_2 _419_ (.A_N(net5),
    .B(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_111_));
 sky130_fd_sc_hd__o21ai_2 _420_ (.A1(_225_),
    .A2(net5),
    .B1(_111_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_112_));
 sky130_fd_sc_hd__nor2_2 _421_ (.A(_109_),
    .B(_112_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_113_));
 sky130_fd_sc_hd__or2_2 _422_ (.A(_109_),
    .B(_112_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_114_));
 sky130_fd_sc_hd__or4_2 _423_ (.A(net13),
    .B(net3),
    .C(_225_),
    .D(net5),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_115_));
 sky130_fd_sc_hd__inv_2 _424_ (.A(_115_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_116_));
 sky130_fd_sc_hd__nand2_2 _425_ (.A(_114_),
    .B(_115_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_117_));
 sky130_fd_sc_hd__nor2_2 _426_ (.A(_225_),
    .B(_111_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_118_));
 sky130_fd_sc_hd__nor2_2 _427_ (.A(net25),
    .B(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_119_));
 sky130_fd_sc_hd__nor2_2 _428_ (.A(_244_),
    .B(_119_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_120_));
 sky130_fd_sc_hd__nor2_2 _429_ (.A(net4),
    .B(_111_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_121_));
 sky130_fd_sc_hd__a221o_2 _430_ (.A1(_118_),
    .A2(_120_),
    .B1(_121_),
    .B2(net22),
    .C1(_117_),
    ...
    .VPWR(VPWR),
    .X(_122_));
 sky130_fd_sc_hd__a31o_2 _431_ (.A1(_108_),
    .A2(_109_),
    .A3(_110_),
    .B1(_122_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_123_));
 sky130_fd_sc_hd__or2_2 _432_ (.A(net19),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_124_));
 sky130_fd_sc_hd__a211o_2 _433_ (.A1(_223_),
    .A2(_124_),
    .B1(_114_),
    .C1(net14),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_125_));
 sky130_fd_sc_hd__nand2_2 _434_ (.A(_239_),
    .B(_124_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_126_));
 sky130_fd_sc_hd__a31o_2 _435_ (.A1(net20),
    .A2(_239_),
    .A3(_124_),
    .B1(_224_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_127_));
 sky130_fd_sc_hd__o211a_2 _436_ (.A1(_114_),
    .A2(_127_),
    .B1(_125_),
    .C1(_123_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_128_));
 sky130_fd_sc_hd__nor3b_2 _437_ (.A(net8),
    .B(net7),
    .C_N(net6),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_129_));
 sky130_fd_sc_hd__nand2b_2 _438_ (.A_N(net17),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_130_));
 sky130_fd_sc_hd__o211a_2 _439_ (.A1(net20),
    .A2(net16),
    .B1(_239_),
    .C1(_124_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_131_));
 sky130_fd_sc_hd__nor2_2 _440_ (.A(net17),
    .B(_224_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_132_));
 sky130_fd_sc_hd__inv_2 _441_ (.A(_132_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_133_));
 sky130_fd_sc_hd__o211a_2 _442_ (.A1(net12),
    .A2(_131_),
    .B1(_133_),
    .C1(_036_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_134_));
 sky130_fd_sc_hd__o21ai_2 _443_ (.A1(_048_),
    .A2(_098_),
    .B1(_109_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_135_));
 sky130_fd_sc_hd__nor2_2 _444_ (.A(_099_),
    .B(_135_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_136_));
 sky130_fd_sc_hd__or2_2 _445_ (.A(net26),
    .B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_137_));
 sky130_fd_sc_hd__a32o_2 _446_ (.A1(_249_),
    .A2(_118_),
    .A3(_137_),
    .B1(_121_),
    .B2(net25),
    ...
    .VPWR(VPWR),
    .X(_138_));
 sky130_fd_sc_hd__o32a_2 _447_ (.A1(_117_),
    .A2(_136_),
    .A3(_138_),
    .B1(_134_),
    .B2(_114_),
    ...
    .VPWR(VPWR),
    .X(_139_));
 sky130_fd_sc_hd__nor3b_2 _448_ (.A(net8),
    .B(net6),
    .C_N(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_140_));
 sky130_fd_sc_hd__or3b_2 _449_ (.A(net8),
    .B(net6),
    .C_N(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_141_));
 sky130_fd_sc_hd__a21o_2 _450_ (.A1(net7),
    .A2(net6),
    .B1(net8),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_142_));
 sky130_fd_sc_hd__a21oi_2 _451_ (.A1(net7),
    .A2(net6),
    .B1(net8),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_143_));
 sky130_fd_sc_hd__xor2_2 _452_ (.A(_068_),
    .B(_097_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_144_));
 sky130_fd_sc_hd__or2_2 _453_ (.A(net28),
    .B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_145_));
 sky130_fd_sc_hd__a32o_2 _454_ (.A1(_254_),
    .A2(_118_),
    .A3(_145_),
    .B1(_121_),
    .B2(net26),
    ...
    .VPWR(VPWR),
    .X(_146_));
 sky130_fd_sc_hd__a211o_2 _455_ (.A1(_109_),
    .A2(_144_),
    .B1(_146_),
    .C1(_117_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_147_));
 sky130_fd_sc_hd__xnor2_2 _456_ (.A(net17),
    .B(_052_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_148_));
 sky130_fd_sc_hd__o311ai_2 _457_ (.A1(_224_),
    .A2(_114_),
    .A3(_148_),
    .B1(_147_),
    .C1(_125_),
    ...
    .VPWR(VPWR),
    .Y(_149_));
 sky130_fd_sc_hd__o2bb2ai_2 _458_ (.A1_N(_242_),
    .A2_N(_128_),
    .B1(_141_),
    .B2(_149_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_150_));
 sky130_fd_sc_hd__a211o_2 _459_ (.A1(_129_),
    .A2(_139_),
    .B1(_142_),
    .C1(_150_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_151_));
 sky130_fd_sc_hd__nand2_2 _460_ (.A(_093_),
    .B(_095_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_152_));
 sky130_fd_sc_hd__a221o_2 _461_ (.A1(net14),
    .A2(_118_),
    .B1(_121_),
    .B2(net29),
    .C1(_116_),
    ...
    .VPWR(VPWR),
    .X(_153_));
 sky130_fd_sc_hd__a31o_2 _462_ (.A1(_113_),
    .A2(_127_),
    .A3(_131_),
    .B1(_153_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_154_));
 sky130_fd_sc_hd__a31o_2 _463_ (.A1(_096_),
    .A2(_109_),
    .A3(_152_),
    .B1(_143_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_155_));
 sky130_fd_sc_hd__o21a_2 _464_ (.A1(_154_),
    .A2(_155_),
    .B1(net1),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_156_));
 sky130_fd_sc_hd__a22o_2 _465_ (.A1(_226_),
    .A2(uo_out[0]),
    .B1(_151_),
    .B2(_156_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_009_));
 sky130_fd_sc_hd__or2_2 _466_ (.A(net20),
    .B(_124_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_157_));
 sky130_fd_sc_hd__a21o_2 _467_ (.A1(net20),
    .A2(_126_),
    .B1(_224_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_158_));
 sky130_fd_sc_hd__a21o_2 _468_ (.A1(_157_),
    .A2(_158_),
    .B1(_114_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_159_));
 sky130_fd_sc_hd__and2_2 _469_ (.A(_036_),
    .B(_130_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_160_));
 sky130_fd_sc_hd__nor2_2 _470_ (.A(_036_),
    .B(_130_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_161_));
 sky130_fd_sc_hd__nor2_2 _471_ (.A(_160_),
    .B(_161_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_162_));
 sky130_fd_sc_hd__a2bb2o_2 _472_ (.A1_N(_245_),
    .A2_N(_260_),
    .B1(_101_),
    .B2(_102_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_163_));
 sky130_fd_sc_hd__nand2_2 _473_ (.A(_162_),
    .B(_163_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_164_));
 sky130_fd_sc_hd__xor2_2 _474_ (.A(_162_),
    .B(_163_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_165_));
 sky130_fd_sc_hd__and2_2 _475_ (.A(_104_),
    .B(_165_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_166_));
 sky130_fd_sc_hd__nor2_2 _476_ (.A(_104_),
    .B(_165_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_167_));
 sky130_fd_sc_hd__nor2_2 _477_ (.A(_166_),
    .B(_167_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_168_));
 sky130_fd_sc_hd__o21a_2 _478_ (.A1(_026_),
    .A2(_046_),
    .B1(_106_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_169_));
 sky130_fd_sc_hd__a31o_2 _479_ (.A1(_048_),
    .A2(_098_),
    .A3(_107_),
    .B1(_169_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_170_));
 sky130_fd_sc_hd__xor2_2 _480_ (.A(_168_),
    .B(_170_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_171_));
 sky130_fd_sc_hd__or2_2 _481_ (.A(net22),
    .B(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_172_));
 sky130_fd_sc_hd__a32o_2 _482_ (.A1(_100_),
    .A2(_118_),
    .A3(_172_),
    .B1(_121_),
    .B2(net20),
    ...
    .VPWR(VPWR),
    .X(_173_));
 sky130_fd_sc_hd__a211o_2 _483_ (.A1(_109_),
    .A2(_171_),
    .B1(_173_),
    .C1(_117_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_174_));
 sky130_fd_sc_hd__nand2_2 _484_ (.A(_159_),
    .B(_174_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_175_));
 sky130_fd_sc_hd__and3_2 _485_ (.A(_242_),
    .B(_159_),
    .C(_174_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_176_));
 sky130_fd_sc_hd__a221o_2 _486_ (.A1(_128_),
    .A2(_129_),
    .B1(_139_),
    .B2(_140_),
    .C1(_142_),
    ...
    .VPWR(VPWR),
    .X(_177_));
 sky130_fd_sc_hd__or2_2 _487_ (.A(_176_),
    .B(_177_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_178_));
 sky130_fd_sc_hd__a21oi_2 _488_ (.A1(_142_),
    .A2(_149_),
    .B1(_226_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_179_));
 sky130_fd_sc_hd__a22o_2 _489_ (.A1(_226_),
    .A2(uo_out[1]),
    .B1(_178_),
    .B2(_179_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_010_));
 sky130_fd_sc_hd__or2_2 _490_ (.A(net16),
    .B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_180_));
 sky130_fd_sc_hd__and2_2 _491_ (.A(_245_),
    .B(_180_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_181_));
 sky130_fd_sc_hd__nand2_2 _492_ (.A(net17),
    .B(_181_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_182_));
 sky130_fd_sc_hd__and3b_2 _493_ (.A_N(_161_),
    .B(_164_),
    .C(_182_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_183_));
 sky130_fd_sc_hd__inv_2 _494_ (.A(_183_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_184_));
 sky130_fd_sc_hd__nor2_2 _495_ (.A(_164_),
    .B(_182_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_185_));
 sky130_fd_sc_hd__nor2_2 _496_ (.A(_183_),
    .B(_185_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_186_));
 sky130_fd_sc_hd__a211o_2 _497_ (.A1(_168_),
    .A2(_170_),
    .B1(_186_),
    .C1(_166_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_187_));
 sky130_fd_sc_hd__a22o_2 _498_ (.A1(_021_),
    .A2(_170_),
    .B1(_184_),
    .B2(_166_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_188_));
 sky130_fd_sc_hd__and3b_2 _499_ (.A_N(_188_),
    .B(_109_),
    .C(_187_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_189_));
 sky130_fd_sc_hd__or2_2 _500_ (.A(net20),
    .B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_190_));
 sky130_fd_sc_hd__nand2_2 _501_ (.A(_036_),
    .B(_190_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_191_));
 sky130_fd_sc_hd__a32o_2 _502_ (.A1(_036_),
    .A2(_118_),
    .A3(_190_),
    .B1(_121_),
    .B2(net19),
    ...
    .VPWR(VPWR),
    .X(_192_));
 sky130_fd_sc_hd__a21oi_2 _503_ (.A1(_130_),
    .A2(_191_),
    .B1(_132_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_193_));
 sky130_fd_sc_hd__o32a_2 _504_ (.A1(_117_),
    .A2(_189_),
    .A3(_192_),
    .B1(_193_),
    .B2(_114_),
    ...
    .VPWR(VPWR),
    .X(_194_));
 sky130_fd_sc_hd__and3_2 _505_ (.A(_129_),
    .B(_159_),
    .C(_174_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_195_));
 sky130_fd_sc_hd__a21o_2 _506_ (.A1(_128_),
    .A2(_140_),
    .B1(_142_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_196_));
 sky130_fd_sc_hd__a211o_2 _507_ (.A1(_242_),
    .A2(_194_),
    .B1(_195_),
    .C1(_196_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_197_));
 sky130_fd_sc_hd__o21a_2 _508_ (.A1(_139_),
    .A2(_143_),
    .B1(net33),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_198_));
 sky130_fd_sc_hd__a22o_2 _509_ (.A1(net30),
    .A2(uo_out[2]),
    .B1(_197_),
    .B2(_198_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_011_));
 sky130_fd_sc_hd__nor2_2 _510_ (.A(_141_),
    .B(_175_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_199_));
 sky130_fd_sc_hd__a211o_2 _511_ (.A1(_128_),
    .A2(_142_),
    .B1(_199_),
    .C1(net30),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_200_));
 sky130_fd_sc_hd__o21a_2 _512_ (.A1(_223_),
    .A2(_239_),
    .B1(_124_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_201_));
 sky130_fd_sc_hd__o21a_2 _513_ (.A1(net12),
    .A2(_201_),
    .B1(_158_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_202_));
 sky130_fd_sc_hd__o211ai_2 _514_ (.A1(_185_),
    .A2(_188_),
    .B1(net11),
    .C1(_130_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_203_));
 sky130_fd_sc_hd__a211o_2 _515_ (.A1(net11),
    .A2(_130_),
    .B1(_185_),
    .C1(_188_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_204_));
 sky130_fd_sc_hd__and2_2 _516_ (.A(net19),
    .B(_224_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_205_));
 sky130_fd_sc_hd__o21a_2 _517_ (.A1(_132_),
    .A2(_205_),
    .B1(_118_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_206_));
 sky130_fd_sc_hd__a21o_2 _518_ (.A1(net16),
    .A2(_121_),
    .B1(_206_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_207_));
 sky130_fd_sc_hd__a31o_2 _519_ (.A1(_109_),
    .A2(_203_),
    .A3(_204_),
    .B1(_207_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_208_));
 sky130_fd_sc_hd__o22a_2 _520_ (.A1(_114_),
    .A2(_202_),
    .B1(_208_),
    .B2(_117_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_209_));
 sky130_fd_sc_hd__a22o_2 _521_ (.A1(_129_),
    .A2(_194_),
    .B1(_209_),
    .B2(_242_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_210_));
 sky130_fd_sc_hd__o22a_2 _522_ (.A1(net33),
    .A2(uo_out[3]),
    .B1(_200_),
    .B2(_210_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_012_));
 sky130_fd_sc_hd__and3_2 _523_ (.A(net12),
    .B(_113_),
    .C(_157_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_211_));
 sky130_fd_sc_hd__o311ai_2 _524_ (.A1(net16),
    .A2(_185_),
    .A3(_188_),
    .B1(net11),
    .C1(_109_),
    ...
    .VPWR(VPWR),
    .Y(_212_));
 sky130_fd_sc_hd__a221oi_2 _525_ (.A1(net11),
    .A2(_121_),
    .B1(_181_),
    .B2(_118_),
    .C1(_117_),
    ...
    .VPWR(VPWR),
    .Y(_213_));
 sky130_fd_sc_hd__a21oi_2 _526_ (.A1(_212_),
    .A2(_213_),
    .B1(_211_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_214_));
 sky130_fd_sc_hd__a22o_2 _527_ (.A1(_140_),
    .A2(_194_),
    .B1(_214_),
    .B2(_242_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_215_));
 sky130_fd_sc_hd__a211o_2 _528_ (.A1(_129_),
    .A2(_209_),
    .B1(_215_),
    .C1(_142_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_216_));
 sky130_fd_sc_hd__a21oi_2 _529_ (.A1(_142_),
    .A2(_175_),
    .B1(net30),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_217_));
 sky130_fd_sc_hd__a22o_2 _530_ (.A1(net30),
    .A2(uo_out[4]),
    .B1(_216_),
    .B2(_217_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and2_2 _531_ (.A(_129_),
    ...
    .VPWR(VPWR),
    .X(_218_));
 sky130_fd_sc_hd__a221o_2 _532_ (.A1(_142_),
    .A2(_194_),
    .B1(_209_),
    .B2(_140_),
    .C1(net30),
    ...
    .VPWR(VPWR),
    .X(_219_));
 sky130_fd_sc_hd__o22a_2 _533_ (.A1(net33),
    .A2(uo_out[5]),
    .B1(_218_),
    .B2(_219_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_014_));
 sky130_fd_sc_hd__and3_2 _534_ (.A(net33),
    .B(_140_),
    .C(_214_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_220_));
 sky130_fd_sc_hd__nor2_2 _535_ (.A(net30),
    .B(_143_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_221_));
 sky130_fd_sc_hd__a221o_2 _536_ (.A1(net30),
    .A2(uo_out[6]),
    .B1(_209_),
    .B2(_221_),
    .C1(_220_),
    ...
    .VPWR(VPWR),
    .X(_015_));
 sky130_fd_sc_hd__a22o_2 _537_ (.A1(net30),
    .A2(uo_out[7]),
    .B1(_214_),
    .B2(_221_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_016_));
 sky130_fd_sc_hd__dfrtp_2 _538_ (.CLK(clknet_1_0__leaf_clk),
    .D(_000_),
    .RESET_B(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\phase_acc[7] ));
 sky130_fd_sc_hd__dfrtp_2 _539_ (.CLK(clknet_1_1__leaf_clk),
    .D(_001_),
    .RESET_B(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\phase[0] ));
 sky130_fd_sc_hd__dfrtp_2 _540_ (.CLK(clknet_1_1__leaf_clk),
    .D(_002_),
    .RESET_B(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\phase[1] ));
 sky130_fd_sc_hd__dfrtp_2 _541_ (.CLK(clknet_1_1__leaf_clk),
    .D(_003_),
    .RESET_B(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\phase[2] ));
 sky130_fd_sc_hd__dfrtp_2 _542_ (.CLK(clknet_1_1__leaf_clk),
    .D(_004_),
    .RESET_B(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\phase[3] ));
 sky130_fd_sc_hd__dfrtp_2 _543_ (.CLK(clknet_1_1__leaf_clk),
    .D(_005_),
    .RESET_B(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\phase[4] ));
 sky130_fd_sc_hd__dfrtp_2 _544_ (.CLK(clknet_1_1__leaf_clk),
    .D(_006_),
    .RESET_B(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\phase[5] ));
 sky130_fd_sc_hd__dfrtp_2 _545_ (.CLK(clknet_1_1__leaf_clk),
    .D(_007_),
    .RESET_B(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\phase[6] ));
 sky130_fd_sc_hd__dfrtp_2 _546_ (.CLK(clknet_1_1__leaf_clk),
    .D(_008_),
    .RESET_B(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\phase[7] ));
 sky130_fd_sc_hd__dfrtp_2 _547_ (.CLK(clknet_1_0__leaf_clk),
    .D(_009_),
    .RESET_B(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[0]));
 sky130_fd_sc_hd__dfrtp_2 _548_ (.CLK(clknet_1_0__leaf_clk),
    .D(_010_),
    .RESET_B(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[1]));
 sky130_fd_sc_hd__dfrtp_2 _549_ (.CLK(clknet_1_0__leaf_clk),
    .D(_011_),
    .RESET_B(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[2]));
 sky130_fd_sc_hd__dfrtp_2 _550_ (.CLK(clknet_1_0__leaf_clk),
    .D(_012_),
    .RESET_B(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[3]));
 sky130_fd_sc_hd__dfrtp_2 _551_ (.CLK(clknet_1_0__leaf_clk),
    .D(_013_),
    .RESET_B(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[4]));
 sky130_fd_sc_hd__dfrtp_2 _552_ (.CLK(clknet_1_0__leaf_clk),
    .D(_014_),
    .RESET_B(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[5]));
 sky130_fd_sc_hd__dfrtp_2 _553_ (.CLK(clknet_1_0__leaf_clk),
    .D(_015_),
    .RESET_B(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[6]));
 sky130_fd_sc_hd__dfrtp_2 _554_ (.CLK(clknet_1_0__leaf_clk),
    .D(_016_),
    .RESET_B(net31),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_4 clkload0 (.A(clknet_1_1__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout11 (.A(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout13 (.A(net14),
    ...
    .VPWR(VPWR),
    .X(net13));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout14 (.A(\phase[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net14));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout15 (.A(\phase[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net15));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout16 (.A(\phase[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout18 (.A(net19),
    ...
    .VPWR(VPWR),
    .X(net18));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout19 (.A(\phase[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net19));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout20 (.A(\phase[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net20));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout21 (.A(\phase[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net21));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout22 (.A(\phase[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net22));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout23 (.A(\phase[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout24 (.A(net25),
    ...
    .VPWR(VPWR),
    .X(net24));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout25 (.A(\phase[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout26 (.A(net27),
    ...
    .VPWR(VPWR),
    .X(net26));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout27 (.A(\phase[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout28 (.A(net29),
    ...
    .VPWR(VPWR),
    .X(net28));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout29 (.A(\phase[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net29));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout30 (.A(_226_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net30));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout31 (.A(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout33 (.A(net1),
    ...
    .VPWR(VPWR),
    .X(net33));
 sky130_fd_sc_hd__dlygate4sd3_1 hold49 (.A(\phase_acc[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 input9 (.A(ui_in[6]),
    ...
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__conb_1 tt_um_gen_onda (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 tt_um_gen_onda_34 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net34));
 sky130_fd_sc_hd__conb_1 tt_um_gen_onda_35 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net35));
 sky130_fd_sc_hd__conb_1 tt_um_gen_onda_36 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net36));
 sky130_fd_sc_hd__conb_1 tt_um_gen_onda_37 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net37));
 sky130_fd_sc_hd__conb_1 tt_um_gen_onda_38 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net38));
 sky130_fd_sc_hd__conb_1 tt_um_gen_onda_39 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net39));
 sky130_fd_sc_hd__conb_1 tt_um_gen_onda_40 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net40));
 sky130_fd_sc_hd__conb_1 tt_um_gen_onda_41 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net41));
 sky130_fd_sc_hd__conb_1 tt_um_gen_onda_42 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net42));
 sky130_fd_sc_hd__conb_1 tt_um_gen_onda_43 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net43));
 sky130_fd_sc_hd__conb_1 tt_um_gen_onda_44 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net44));
 sky130_fd_sc_hd__conb_1 tt_um_gen_onda_45 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net45));
 sky130_fd_sc_hd__conb_1 tt_um_gen_onda_46 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net46));
 sky130_fd_sc_hd__conb_1 tt_um_gen_onda_47 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net47));
 sky130_fd_sc_hd__conb_1 tt_um_gen_onda_48 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net48));
