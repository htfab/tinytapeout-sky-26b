module tt_um_youweiterrylu (clk,
    ena,
    rst_n,
    VPWR,
    VGND,
 ...
 wire _265_;
 wire net1;
 wire \u_dma.csr_baseaddr[0] ;
 wire \u_dma.csr_baseaddr[10] ;
 wire \u_dma.csr_baseaddr[11] ;
 wire \u_dma.csr_baseaddr[12] ;
 wire \u_dma.csr_baseaddr[13] ;
 wire \u_dma.csr_baseaddr[14] ;
 wire \u_dma.csr_baseaddr[15] ;
 wire \u_dma.csr_baseaddr[1] ;
 wire \u_dma.csr_baseaddr[2] ;
 wire \u_dma.csr_baseaddr[3] ;
 wire \u_dma.csr_baseaddr[4] ;
 wire \u_dma.csr_baseaddr[5] ;
 wire \u_dma.csr_baseaddr[6] ;
 wire \u_dma.csr_baseaddr[7] ;
 wire \u_dma.csr_baseaddr[8] ;
 wire \u_dma.csr_baseaddr[9] ;
 wire \u_dma.csr_busy ;
 wire \u_dma.csr_enable ;
 wire \u_dma.csr_head[0] ;
 wire \u_dma.csr_head[1] ;
 wire \u_dma.csr_head[2] ;
 wire \u_dma.csr_head[3] ;
 wire \u_dma.csr_head[4] ;
 wire \u_dma.csr_head[5] ;
 wire \u_dma.csr_head[6] ;
 wire \u_dma.csr_head[7] ;
 wire \u_dma.csr_irq_en ;
 wire \u_dma.csr_reset ;
 wire \u_dma.csr_ring_empty ;
 wire \u_dma.csr_ringlen[0] ;
 wire \u_dma.csr_ringlen[1] ;
 wire \u_dma.csr_ringlen[2] ;
 wire \u_dma.csr_ringlen[3] ;
 wire \u_dma.csr_ringlen[4] ;
 wire \u_dma.csr_ringlen[5] ;
 wire \u_dma.csr_ringlen[6] ;
 wire \u_dma.csr_ringlen[7] ;
 wire \u_dma.csr_tail[0] ;
 wire \u_dma.csr_tail[1] ;
 wire \u_dma.csr_tail[2] ;
 wire \u_dma.csr_tail[3] ;
 wire \u_dma.csr_tail[4] ;
 wire \u_dma.csr_tail[5] ;
 wire \u_dma.csr_tail[6] ;
 wire \u_dma.csr_tail[7] ;
 wire \u_dma.dm_done ;
 wire \u_dma.fetch_req_valid ;
 wire \u_dma.irq ;
 wire \u_dma.probe_df_in_wr_en ;
 wire \u_dma.probe_dm_instr_rw ;
 wire \u_dma.probe_dm_wr_en ;
 wire \u_dma.rst_core_n ;
 wire \u_dma.spi_miso ;
 wire \u_dma.u_csr.bit_cnt[0] ;
 wire \u_dma.u_csr.bit_cnt[1] ;
 wire \u_dma.u_csr.bit_cnt[2] ;
 wire \u_dma.u_csr.bit_cnt[3] ;
 wire \u_dma.u_csr.csn_r[0] ;
 wire \u_dma.u_csr.csn_r[1] ;
 wire \u_dma.u_csr.is_read ;
 wire \u_dma.u_csr.mosi_r[0] ;
 wire \u_dma.u_csr.mosi_r[1] ;
 wire \u_dma.u_csr.reg_addr[0] ;
 wire \u_dma.u_csr.reg_addr[1] ;
 wire \u_dma.u_csr.reg_addr[2] ;
 wire \u_dma.u_csr.reg_addr[3] ;
 wire \u_dma.u_csr.reg_addr[4] ;
 wire \u_dma.u_csr.reg_addr[5] ;
 wire \u_dma.u_csr.reg_addr[6] ;
 wire \u_dma.u_csr.reg_irq_empty ;
 wire \u_dma.u_csr.rx_byte[0] ;
 wire \u_dma.u_csr.rx_byte[1] ;
 wire \u_dma.u_csr.rx_byte[2] ;
 wire \u_dma.u_csr.rx_byte[3] ;
 wire \u_dma.u_csr.rx_byte[4] ;
 wire \u_dma.u_csr.rx_byte[5] ;
 wire \u_dma.u_csr.rx_byte[6] ;
 wire \u_dma.u_csr.rx_data[0] ;
 wire \u_dma.u_csr.rx_data[1] ;
 wire \u_dma.u_csr.rx_data[2] ;
 wire \u_dma.u_csr.rx_data[3] ;
 wire \u_dma.u_csr.rx_data[4] ;
 wire \u_dma.u_csr.rx_data[5] ;
 wire \u_dma.u_csr.rx_data[6] ;
 wire \u_dma.u_csr.rx_data[7] ;
 wire \u_dma.u_csr.sclk_r[0] ;
 wire \u_dma.u_csr.sclk_r[1] ;
 wire \u_dma.u_csr.tx_byte[0] ;
 wire \u_dma.u_csr.tx_byte[1] ;
 wire \u_dma.u_csr.tx_byte[2] ;
 wire \u_dma.u_csr.tx_byte[3] ;
 wire \u_dma.u_csr.tx_byte[4] ;
 wire \u_dma.u_csr.tx_byte[5] ;
 wire \u_dma.u_csr.tx_byte[6] ;
 wire \u_dma.u_irq.status_empty ;
 wire \u_dma.u_movement.df_dm_in_empty ;
 wire \u_dma.u_movement.df_dm_in_rd_en ;
 wire \u_dma.u_movement.df_in_full ;
 wire \u_dma.u_movement.df_out_rd_en ;
 wire \u_dma.u_movement.dm_in_wr_en ;
 wire \u_dma.u_movement.u_data_mover.state[0] ;
 wire \u_dma.u_movement.u_data_mover.state[2] ;
 wire \u_dma.u_movement.u_desc_to_dm_fifo.rd_addr[0] ;
 wire \u_dma.u_movement.u_desc_to_dm_fifo.rd_addr[1] ;
 wire \u_dma.u_movement.u_desc_to_dm_fifo.rd_addr[2] ;
 wire \u_dma.u_movement.u_desc_to_dm_fifo.rd_addr_t[0] ;
 wire \u_dma.u_movement.u_desc_to_dm_fifo.rd_addr_t[1] ;
 wire \u_dma.u_movement.u_desc_to_dm_fifo.rd_addr_t[2] ;
 wire \u_dma.u_movement.u_desc_to_dm_fifo.wr_addr[0] ;
 wire \u_dma.u_movement.u_desc_to_dm_fifo.wr_addr[1] ;
 wire \u_dma.u_movement.u_desc_to_dm_fifo.wr_addr[2] ;
 wire \u_dma.u_movement.u_df.df_in_wr_en_c ;
 wire \u_dma.u_ring_manager.was_empty ;
 wire net2;
 wire net3;
 wire net4;
 wire net32;
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_137 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _266_ (.A(\u_dma.csr_head[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_089_));
 sky130_fd_sc_hd__inv_2 _267_ (.A(\u_dma.u_movement.u_desc_to_dm_fifo.rd_addr[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_090_));
 sky130_fd_sc_hd__inv_2 _268_ (.A(\u_dma.csr_reset ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_091_));
 sky130_fd_sc_hd__inv_2 _269_ (.A(\u_dma.u_movement.df_in_full ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_092_));
 sky130_fd_sc_hd__inv_2 _270_ (.A(net85),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_093_));
 sky130_fd_sc_hd__inv_2 _271_ (.A(\u_dma.u_csr.tx_byte[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_094_));
 sky130_fd_sc_hd__or3_2 _272_ (.A(\u_dma.csr_ringlen[0] ),
    .B(\u_dma.csr_ringlen[1] ),
    .C(\u_dma.csr_ringlen[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_095_));
 sky130_fd_sc_hd__or4_2 _273_ (.A(\u_dma.csr_ringlen[0] ),
    .B(\u_dma.csr_ringlen[1] ),
    .C(\u_dma.csr_ringlen[2] ),
    .D(\u_dma.csr_ringlen[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_096_));
 sky130_fd_sc_hd__or2_2 _274_ (.A(\u_dma.csr_ringlen[4] ),
    .B(\u_dma.csr_ringlen[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_097_));
 sky130_fd_sc_hd__or3_2 _275_ (.A(\u_dma.csr_ringlen[6] ),
    .B(_096_),
    .C(_097_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_098_));
 sky130_fd_sc_hd__or4_2 _276_ (.A(\u_dma.csr_ringlen[6] ),
    .B(\u_dma.csr_ringlen[7] ),
    .C(_096_),
    .D(_097_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_099_));
 sky130_fd_sc_hd__xor2_2 _277_ (.A(\u_dma.csr_head[5] ),
    .B(\u_dma.csr_tail[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_100_));
 sky130_fd_sc_hd__xor2_2 _278_ (.A(net14),
    .B(\u_dma.csr_tail[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_101_));
 sky130_fd_sc_hd__xor2_2 _279_ (.A(\u_dma.csr_head[6] ),
    .B(\u_dma.csr_tail[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_102_));
 sky130_fd_sc_hd__xor2_2 _280_ (.A(\u_dma.csr_head[7] ),
    .B(\u_dma.csr_tail[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_103_));
 sky130_fd_sc_hd__xor2_2 _281_ (.A(\u_dma.csr_head[1] ),
    .B(\u_dma.csr_tail[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_104_));
 sky130_fd_sc_hd__xor2_2 _282_ (.A(\u_dma.csr_head[2] ),
    .B(\u_dma.csr_tail[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_105_));
 sky130_fd_sc_hd__xor2_2 _283_ (.A(net15),
    .B(\u_dma.csr_tail[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_106_));
 sky130_fd_sc_hd__xor2_2 _284_ (.A(\u_dma.csr_head[4] ),
    .B(\u_dma.csr_tail[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_107_));
 sky130_fd_sc_hd__or4_2 _285_ (.A(_100_),
    .B(_101_),
    .C(_105_),
    .D(_106_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_108_));
 sky130_fd_sc_hd__or4_2 _286_ (.A(_102_),
    .B(_103_),
    .C(_104_),
    .D(_107_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_109_));
 sky130_fd_sc_hd__nor2_2 _287_ (.A(_108_),
    .B(_109_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(\u_dma.csr_ring_empty ));
 sky130_fd_sc_hd__and2b_2 _288_ (.A_N(\u_dma.csr_busy ),
    .B(\u_dma.csr_enable ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_110_));
 sky130_fd_sc_hd__o211a_2 _289_ (.A1(_108_),
    .A2(_109_),
    .B1(_110_),
    .C1(_099_),
    .VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\u_dma.fetch_req_valid ));
 sky130_fd_sc_hd__o2111a_2 _290_ (.A1(_108_),
    .A2(_109_),
    .B1(_110_),
    .C1(_099_),
    .D1(_092_),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\u_dma.u_movement.u_df.df_in_wr_en_c ));
 sky130_fd_sc_hd__inv_2 _291_ (.A(\u_dma.u_movement.u_df.df_in_wr_en_c ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_111_));
 sky130_fd_sc_hd__and2b_2 _292_ (.A_N(\u_dma.u_movement.df_dm_in_empty ),
    .B(\u_dma.u_movement.u_data_mover.state[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\u_dma.u_movement.df_dm_in_rd_en ));
 sky130_fd_sc_hd__xor2_2 _293_ (.A(\u_dma.u_movement.u_desc_to_dm_fifo.rd_addr[2] ),
    .B(\u_dma.u_movement.u_desc_to_dm_fifo.wr_addr[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_112_));
 sky130_fd_sc_hd__xor2_2 _294_ (.A(\u_dma.u_movement.u_desc_to_dm_fifo.rd_addr[1] ),
    .B(\u_dma.u_movement.u_desc_to_dm_fifo.wr_addr[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_113_));
 sky130_fd_sc_hd__xor2_2 _295_ (.A(\u_dma.u_movement.u_desc_to_dm_fifo.wr_addr[0] ),
    .B(\u_dma.u_movement.u_desc_to_dm_fifo.rd_addr[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_114_));
 sky130_fd_sc_hd__o31ai_2 _296_ (.A1(_112_),
    .A2(_113_),
    .A3(_114_),
    .B1(\u_dma.u_movement.df_dm_in_rd_en ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_115_));
 sky130_fd_sc_hd__nor2_2 _297_ (.A(_090_),
    .B(_115_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_116_));
 sky130_fd_sc_hd__and2_2 _298_ (.A(_090_),
    .B(_115_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_117_));
 sky130_fd_sc_hd__nor2_2 _299_ (.A(_116_),
    .B(_117_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(\u_dma.u_movement.u_desc_to_dm_fifo.rd_addr_t[0] ));
 sky130_fd_sc_hd__nand2_2 _300_ (.A(\u_dma.u_movement.u_desc_to_dm_fifo.rd_addr[1] ),
    .B(_116_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_118_));
 sky130_fd_sc_hd__or2_2 _301_ (.A(\u_dma.u_movement.u_desc_to_dm_fifo.rd_addr[1] ),
    .B(_116_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_119_));
 sky130_fd_sc_hd__and2_2 _302_ (.A(_118_),
    .B(_119_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\u_dma.u_movement.u_desc_to_dm_fifo.rd_addr_t[1] ));
 sky130_fd_sc_hd__xnor2_2 _303_ (.A(net83),
    .B(_118_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(\u_dma.u_movement.u_desc_to_dm_fifo.rd_addr_t[2] ));
 sky130_fd_sc_hd__and2_2 _304_ (.A(\u_dma.csr_irq_en ),
    .B(\u_dma.u_irq.status_empty ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__and2_2 _305_ (.A(net26),
    ...
    .VPWR(VPWR),
    .X(\u_dma.rst_core_n ));
 sky130_fd_sc_hd__xor2_2 _306_ (.A(\u_dma.csr_head[1] ),
    .B(\u_dma.csr_baseaddr[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_120_));
 sky130_fd_sc_hd__nand2_2 _307_ (.A(net15),
    .B(\u_dma.csr_baseaddr[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_121_));
 sky130_fd_sc_hd__and2b_2 _308_ (.A_N(_120_),
    .B(_121_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_122_));
 sky130_fd_sc_hd__and3_2 _309_ (.A(net15),
    .B(\u_dma.csr_baseaddr[3] ),
    .C(_120_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_123_));
 sky130_fd_sc_hd__nor2_2 _310_ (.A(_122_),
    .B(_123_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net8));
 sky130_fd_sc_hd__nor2_2 _311_ (.A(\u_dma.csr_head[2] ),
    .B(\u_dma.csr_baseaddr[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_124_));
 sky130_fd_sc_hd__nand2_2 _312_ (.A(\u_dma.csr_head[2] ),
    .B(\u_dma.csr_baseaddr[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_125_));
 sky130_fd_sc_hd__and2b_2 _313_ (.A_N(_124_),
    .B(_125_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_126_));
 sky130_fd_sc_hd__a21oi_2 _314_ (.A1(\u_dma.csr_head[1] ),
    .A2(\u_dma.csr_baseaddr[4] ),
    .B1(_123_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_127_));
 sky130_fd_sc_hd__xnor2_2 _315_ (.A(_126_),
    .B(_127_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net7));
 sky130_fd_sc_hd__nor2_2 _316_ (.A(net14),
    .B(\u_dma.csr_baseaddr[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_128_));
 sky130_fd_sc_hd__nand2_2 _317_ (.A(net14),
    .B(\u_dma.csr_baseaddr[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_129_));
 sky130_fd_sc_hd__and2b_2 _318_ (.A_N(_128_),
    .B(_129_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_130_));
 sky130_fd_sc_hd__o21a_2 _319_ (.A1(_124_),
    .A2(_127_),
    .B1(_125_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_131_));
 sky130_fd_sc_hd__xnor2_2 _320_ (.A(_130_),
    .B(_131_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net6));
 sky130_fd_sc_hd__o21a_2 _321_ (.A1(_128_),
    .A2(_131_),
    .B1(_129_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_132_));
 sky130_fd_sc_hd__xor2_2 _322_ (.A(\u_dma.csr_head[4] ),
    .B(\u_dma.csr_baseaddr[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_133_));
 sky130_fd_sc_hd__xnor2_2 _323_ (.A(_132_),
    .B(_133_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net5));
 sky130_fd_sc_hd__or2_2 _324_ (.A(net15),
    .B(\u_dma.csr_baseaddr[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_134_));
 sky130_fd_sc_hd__and2_2 _325_ (.A(_121_),
    .B(_134_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[3]));
 sky130_fd_sc_hd__or3b_2 _326_ (.A(_113_),
    .B(_114_),
    .C_N(_112_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2_2 _327_ (.A(net114),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\u_dma.u_movement.df_out_rd_en ));
 sky130_fd_sc_hd__a21o_2 _328_ (.A1(net45),
    .A2(\u_dma.u_movement.df_dm_in_empty ),
    .B1(net43),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_000_));
 sky130_fd_sc_hd__mux2_1 _329_ (.A0(_115_),
    .A1(\u_dma.u_movement.df_dm_in_rd_en ),
    .S(_114_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_136_));
 sky130_fd_sc_hd__xnor2_2 _330_ (.A(_113_),
    .B(_116_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_137_));
 sky130_fd_sc_hd__xor2_2 _331_ (.A(_112_),
    .B(_118_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_138_));
 sky130_fd_sc_hd__and3_2 _332_ (.A(_136_),
    .B(_137_),
    .C(_138_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_003_));
 sky130_fd_sc_hd__and2b_2 _333_ (.A_N(\u_dma.u_ring_manager.was_empty ),
    .B(\u_dma.csr_ring_empty ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_139_));
 sky130_fd_sc_hd__nor4_2 _334_ (.A(\u_dma.u_csr.reg_addr[3] ),
    .B(\u_dma.u_csr.reg_addr[5] ),
    .C(\u_dma.u_csr.reg_addr[4] ),
    .D(\u_dma.u_csr.reg_addr[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_140_));
 sky130_fd_sc_hd__or4_2 _335_ (.A(\u_dma.u_csr.reg_addr[3] ),
    .B(\u_dma.u_csr.reg_addr[5] ),
    .C(\u_dma.u_csr.reg_addr[4] ),
    .D(\u_dma.u_csr.reg_addr[6] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_141_));
 sky130_fd_sc_hd__and4_2 _336_ (.A(\u_dma.u_csr.reg_addr[1] ),
    .B(\u_dma.u_csr.reg_addr[0] ),
    .C(\u_dma.u_csr.reg_addr[2] ),
    .D(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_142_));
 sky130_fd_sc_hd__or3b_2 _337_ (.A(\u_dma.u_csr.csn_r[1] ),
    .B(\u_dma.u_csr.is_read ),
    .C_N(\u_dma.u_csr.csn_r[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_143_));
 sky130_fd_sc_hd__nand2_2 _338_ (.A(\u_dma.u_csr.rx_data[0] ),
    .B(_142_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_144_));
 sky130_fd_sc_hd__or2_2 _339_ (.A(_143_),
    .B(_144_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_145_));
 sky130_fd_sc_hd__o211a_2 _340_ (.A1(net113),
    .A2(_139_),
    .B1(_145_),
    .C1(_091_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_002_));
 sky130_fd_sc_hd__and4bb_2 _341_ (.A_N(\u_dma.u_csr.reg_addr[1] ),
    .B_N(\u_dma.u_csr.reg_addr[0] ),
    .C(\u_dma.u_csr.reg_addr[2] ),
    .D(net13),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_146_));
 sky130_fd_sc_hd__and2b_2 _342_ (.A_N(_143_),
    .B(_146_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_147_));
 sky130_fd_sc_hd__and2_2 _343_ (.A(_091_),
    .B(\u_dma.u_csr.rx_data[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_148_));
 sky130_fd_sc_hd__and2_2 _344_ (.A(_147_),
    .B(_148_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_001_));
 sky130_fd_sc_hd__and4bb_2 _345_ (.A_N(\u_dma.u_csr.reg_addr[0] ),
    .B_N(\u_dma.u_csr.reg_addr[2] ),
    .C(net13),
    .D(\u_dma.u_csr.reg_addr[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_149_));
 sky130_fd_sc_hd__and2b_2 _346_ (.A_N(_143_),
    .B(_149_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_150_));
 sky130_fd_sc_hd__nor2_2 _347_ (.A(\u_dma.csr_reset ),
    .B(_150_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_151_));
 sky130_fd_sc_hd__a22o_2 _348_ (.A1(_148_),
    .A2(_150_),
    .B1(_151_),
    .B2(\u_dma.csr_ringlen[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_004_));
 sky130_fd_sc_hd__and2_2 _349_ (.A(_091_),
    .B(\u_dma.u_csr.rx_data[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_152_));
 sky130_fd_sc_hd__a22o_2 _350_ (.A1(\u_dma.csr_ringlen[2] ),
    .A2(_151_),
    .B1(_152_),
    .B2(_150_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_005_));
 sky130_fd_sc_hd__and2_2 _351_ (.A(_091_),
    .B(\u_dma.u_csr.rx_data[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_153_));
 sky130_fd_sc_hd__a22o_2 _352_ (.A1(\u_dma.csr_ringlen[3] ),
    .A2(_151_),
    .B1(_153_),
    .B2(_150_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_006_));
 sky130_fd_sc_hd__and2_2 _353_ (.A(_091_),
    .B(\u_dma.u_csr.rx_data[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_154_));
 sky130_fd_sc_hd__a22o_2 _354_ (.A1(\u_dma.csr_ringlen[4] ),
    .A2(_151_),
    .B1(_154_),
    .B2(_150_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_007_));
 sky130_fd_sc_hd__and2_2 _355_ (.A(_091_),
    .B(\u_dma.u_csr.rx_data[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_155_));
 sky130_fd_sc_hd__a22o_2 _356_ (.A1(\u_dma.csr_ringlen[5] ),
    .A2(_151_),
    .B1(_155_),
    .B2(_150_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_008_));
 sky130_fd_sc_hd__and2_2 _357_ (.A(_091_),
    .B(\u_dma.u_csr.rx_data[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_156_));
 sky130_fd_sc_hd__a22o_2 _358_ (.A1(net127),
    .A2(_151_),
    .B1(_156_),
    .B2(_150_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_009_));
 sky130_fd_sc_hd__and2_2 _359_ (.A(_091_),
    .B(\u_dma.u_csr.rx_data[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_157_));
 sky130_fd_sc_hd__a22o_2 _360_ (.A1(\u_dma.csr_ringlen[7] ),
    .A2(_151_),
    .B1(_157_),
    .B2(_150_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_010_));
 sky130_fd_sc_hd__and4b_2 _361_ (.A_N(\u_dma.u_csr.reg_addr[2] ),
    .B(net13),
    .C(\u_dma.u_csr.reg_addr[1] ),
    .D(\u_dma.u_csr.reg_addr[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_158_));
 sky130_fd_sc_hd__and2b_2 _362_ (.A_N(_143_),
    .B(_158_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_159_));
 sky130_fd_sc_hd__nor2_2 _363_ (.A(\u_dma.csr_reset ),
    .B(_159_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_160_));
 sky130_fd_sc_hd__and2_2 _364_ (.A(_091_),
    .B(\u_dma.u_csr.rx_data[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_161_));
 sky130_fd_sc_hd__a22o_2 _365_ (.A1(net122),
    .A2(_160_),
    .B1(_161_),
    .B2(_159_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_011_));
 sky130_fd_sc_hd__a22o_2 _366_ (.A1(_148_),
    .A2(_159_),
    .B1(_160_),
    .B2(net115),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_012_));
 sky130_fd_sc_hd__a22o_2 _367_ (.A1(_152_),
    .A2(_159_),
    .B1(_160_),
    .B2(net118),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_013_));
 sky130_fd_sc_hd__a22o_2 _368_ (.A1(_153_),
    .A2(_159_),
    .B1(_160_),
    .B2(net116),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_014_));
 sky130_fd_sc_hd__a22o_2 _369_ (.A1(_154_),
    .A2(_159_),
    .B1(_160_),
    .B2(net120),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_015_));
 sky130_fd_sc_hd__a22o_2 _370_ (.A1(_155_),
    .A2(_159_),
    .B1(_160_),
    .B2(net119),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_016_));
 sky130_fd_sc_hd__a22o_2 _371_ (.A1(_156_),
    .A2(_159_),
    .B1(_160_),
    .B2(net117),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_017_));
 sky130_fd_sc_hd__a22o_2 _372_ (.A1(_157_),
    .A2(_159_),
    .B1(_160_),
    .B2(net126),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_018_));
 sky130_fd_sc_hd__nor2_2 _373_ (.A(\u_dma.csr_reset ),
    .B(_147_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_162_));
 sky130_fd_sc_hd__a22o_2 _374_ (.A1(_147_),
    .A2(_161_),
    .B1(_162_),
    .B2(net80),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_019_));
 sky130_fd_sc_hd__a22o_2 _375_ (.A1(_147_),
    .A2(_152_),
    .B1(_162_),
    .B2(net81),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_020_));
 sky130_fd_sc_hd__and2b_2 _376_ (.A_N(\u_dma.u_csr.sclk_r[1] ),
    .B(\u_dma.u_csr.sclk_r[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_163_));
 sky130_fd_sc_hd__nor2_2 _377_ (.A(\u_dma.u_csr.csn_r[1] ),
    .B(_163_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_164_));
 sky130_fd_sc_hd__and2b_2 _378_ (.A_N(\u_dma.u_csr.csn_r[1] ),
    .B(_163_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_165_));
 sky130_fd_sc_hd__or3b_2 _379_ (.A(\u_dma.u_csr.csn_r[1] ),
    .B(\u_dma.u_csr.sclk_r[1] ),
    .C_N(\u_dma.u_csr.sclk_r[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__mux2_1 _380_ (.A0(_165_),
    ...
    .VPWR(VPWR),
    .X(_021_));
 sky130_fd_sc_hd__nand2_2 _381_ (.A(\u_dma.u_csr.bit_cnt[1] ),
    .B(\u_dma.u_csr.bit_cnt[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_167_));
 sky130_fd_sc_hd__or2_2 _382_ (.A(\u_dma.u_csr.bit_cnt[1] ),
    .B(\u_dma.u_csr.bit_cnt[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_168_));
 sky130_fd_sc_hd__a32o_2 _383_ (.A1(_165_),
    .A2(_167_),
    .A3(_168_),
    .B1(_164_),
    .B2(net96),
    ...
    .VPWR(VPWR),
    .X(_022_));
 sky130_fd_sc_hd__nor2_2 _384_ (.A(_166_),
    .B(_167_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_169_));
 sky130_fd_sc_hd__and3_2 _385_ (.A(\u_dma.u_csr.bit_cnt[1] ),
    .B(\u_dma.u_csr.bit_cnt[0] ),
    .C(\u_dma.u_csr.bit_cnt[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_170_));
 sky130_fd_sc_hd__a21oi_2 _386_ (.A1(_163_),
    .A2(_170_),
    .B1(\u_dma.u_csr.csn_r[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_171_));
 sky130_fd_sc_hd__o21a_2 _387_ (.A1(net111),
    .A2(_169_),
    .B1(_171_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_023_));
 sky130_fd_sc_hd__or3b_2 _388_ (.A(\u_dma.u_csr.bit_cnt[3] ),
    .B(_166_),
    .C_N(_170_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_172_));
 sky130_fd_sc_hd__a21bo_2 _389_ (.A1(net107),
    .A2(_171_),
    .B1_N(_172_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_024_));
 sky130_fd_sc_hd__mux2_1 _390_ (.A0(net90),
    .A1(net97),
    .S(_166_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_025_));
 sky130_fd_sc_hd__mux2_1 _391_ (.A0(net97),
    .A1(net91),
    .S(_166_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_026_));
 sky130_fd_sc_hd__mux2_1 _392_ (.A0(net91),
    .A1(\u_dma.u_csr.rx_byte[2] ),
    .S(_166_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_027_));
 sky130_fd_sc_hd__mux2_1 _393_ (.A0(net110),
    .A1(net98),
    .S(_166_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_028_));
 sky130_fd_sc_hd__mux2_1 _394_ (.A0(net98),
    .A1(\u_dma.u_csr.rx_byte[4] ),
    .S(_166_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_029_));
 sky130_fd_sc_hd__mux2_1 _395_ (.A0(net108),
    .A1(\u_dma.u_csr.rx_byte[5] ),
    .S(_166_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_030_));
 sky130_fd_sc_hd__mux2_1 _396_ (.A0(\u_dma.u_csr.rx_byte[5] ),
    .A1(net93),
    .S(_166_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_031_));
 sky130_fd_sc_hd__nand3b_2 _397_ (.A_N(\u_dma.u_csr.sclk_r[0] ),
    .B(\u_dma.u_csr.sclk_r[1] ),
    .C(\u_dma.u_csr.bit_cnt[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_173_));
 sky130_fd_sc_hd__nor2_1 _398_ (.A(\u_dma.u_csr.csn_r[1] ),
    .B(_173_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_174_));
 sky130_fd_sc_hd__and4b_2 _399_ (.A_N(\u_dma.u_csr.reg_addr[0] ),
    .B(\u_dma.u_csr.reg_addr[2] ),
    .C(net13),
    .D(\u_dma.u_csr.reg_addr[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_175_));
 sky130_fd_sc_hd__and4b_2 _400_ (.A_N(\u_dma.u_csr.reg_addr[1] ),
    .B(\u_dma.u_csr.reg_addr[0] ),
    .C(\u_dma.u_csr.reg_addr[2] ),
    .D(net13),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_176_));
 sky130_fd_sc_hd__and4bb_2 _401_ (.A_N(\u_dma.u_csr.reg_addr[1] ),
    .B_N(\u_dma.u_csr.reg_addr[2] ),
    .C(net13),
    .D(\u_dma.u_csr.reg_addr[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_177_));
 sky130_fd_sc_hd__nor4_4 _402_ (.A(\u_dma.u_csr.reg_addr[1] ),
    .B(\u_dma.u_csr.reg_addr[0] ),
    .C(\u_dma.u_csr.reg_addr[2] ),
    .D(_141_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_178_));
 sky130_fd_sc_hd__a22o_2 _403_ (.A1(\u_dma.csr_ringlen[0] ),
    .A2(_149_),
    .B1(_158_),
    .B2(\u_dma.csr_tail[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_179_));
 sky130_fd_sc_hd__a221o_2 _404_ (.A1(\u_dma.csr_enable ),
    .A2(_146_),
    .B1(_176_),
    .B2(\u_dma.csr_head[0] ),
    .C1(_179_),
    ...
    .VPWR(VPWR),
    .X(_180_));
 sky130_fd_sc_hd__a22o_2 _405_ (.A1(\u_dma.u_csr.reg_irq_empty ),
    .A2(_142_),
    .B1(_177_),
    .B2(\u_dma.csr_baseaddr[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_181_));
 sky130_fd_sc_hd__a221o_2 _406_ (.A1(\u_dma.csr_busy ),
    .A2(_175_),
    .B1(_178_),
    .B2(\u_dma.csr_baseaddr[0] ),
    .C1(_181_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_182_));
 sky130_fd_sc_hd__nor2_2 _407_ (.A(\u_dma.u_csr.bit_cnt[2] ),
    .B(_168_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_183_));
 sky130_fd_sc_hd__o31a_2 _408_ (.A1(_141_),
    .A2(_180_),
    .A3(_182_),
    .B1(_183_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_184_));
 sky130_fd_sc_hd__mux2_1 _409_ (.A0(net55),
    .A1(_184_),
    .S(_174_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_032_));
 sky130_fd_sc_hd__or4_2 _410_ (.A(\u_dma.u_csr.bit_cnt[2] ),
    .B(_141_),
    .C(_168_),
    .D(_173_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_185_));
 sky130_fd_sc_hd__or2_2 _411_ (.A(\u_dma.u_csr.tx_byte[0] ),
    .B(_183_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_186_));
 sky130_fd_sc_hd__a22o_2 _412_ (.A1(\u_dma.csr_tail[1] ),
    .A2(_158_),
    .B1(_176_),
    .B2(\u_dma.csr_head[1] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_187_));
 sky130_fd_sc_hd__a21o_2 _413_ (.A1(\u_dma.csr_baseaddr[1] ),
    .A2(_178_),
    .B1(_187_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_188_));
 sky130_fd_sc_hd__a22o_2 _414_ (.A1(\u_dma.csr_ringlen[1] ),
    .A2(_149_),
    .B1(_177_),
    .B2(\u_dma.csr_baseaddr[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_189_));
 sky130_fd_sc_hd__a22o_2 _415_ (.A1(\u_dma.csr_reset ),
    .A2(_146_),
    .B1(_175_),
    .B2(\u_dma.csr_ring_empty ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_190_));
 sky130_fd_sc_hd__o41a_2 _416_ (.A1(_185_),
    .A2(_188_),
    .A3(_189_),
    .A4(_190_),
    .B1(_186_),
    ...
    .VPWR(VPWR),
    .X(_191_));
 sky130_fd_sc_hd__mux2_1 _417_ (.A0(net59),
    .A1(_191_),
    .S(_174_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_033_));
 sky130_fd_sc_hd__o21a_2 _418_ (.A1(\u_dma.u_csr.tx_byte[1] ),
    .A2(_183_),
    .B1(_174_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_192_));
 sky130_fd_sc_hd__a22o_2 _419_ (.A1(\u_dma.csr_tail[2] ),
    .A2(_158_),
    .B1(_177_),
    .B2(\u_dma.csr_baseaddr[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_193_));
 sky130_fd_sc_hd__a22o_2 _420_ (.A1(\u_dma.csr_head[2] ),
    .A2(_176_),
    .B1(net9),
    .B2(\u_dma.csr_baseaddr[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_194_));
 sky130_fd_sc_hd__a22o_2 _421_ (.A1(\u_dma.csr_irq_en ),
    .A2(_146_),
    .B1(_149_),
    .B2(\u_dma.csr_ringlen[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_195_));
 sky130_fd_sc_hd__or4_2 _422_ (.A(_185_),
    .B(_193_),
    .C(_194_),
    .D(_195_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_196_));
 sky130_fd_sc_hd__a2bb2o_2 _423_ (.A1_N(_094_),
    .A2_N(_174_),
    .B1(_192_),
    .B2(_196_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_034_));
 sky130_fd_sc_hd__a22o_2 _424_ (.A1(\u_dma.csr_tail[3] ),
    .A2(_158_),
    .B1(_177_),
    .B2(\u_dma.csr_baseaddr[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_197_));
 sky130_fd_sc_hd__a22o_2 _425_ (.A1(\u_dma.csr_ringlen[3] ),
    .A2(_149_),
    .B1(_176_),
    .B2(\u_dma.csr_head[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_198_));
 sky130_fd_sc_hd__a211o_2 _426_ (.A1(\u_dma.csr_baseaddr[3] ),
    .A2(net9),
    .B1(_197_),
    .C1(_198_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_199_));
 sky130_fd_sc_hd__o22a_2 _427_ (.A1(\u_dma.u_csr.tx_byte[2] ),
    .A2(_183_),
    .B1(_185_),
    .B2(_199_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_200_));
 sky130_fd_sc_hd__mux2_1 _428_ (.A0(net73),
    .A1(_200_),
    .S(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_035_));
 sky130_fd_sc_hd__a22o_2 _429_ (.A1(\u_dma.csr_tail[4] ),
    .A2(_158_),
    .B1(_177_),
    .B2(\u_dma.csr_baseaddr[12] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_201_));
 sky130_fd_sc_hd__and2_2 _430_ (.A(\u_dma.csr_head[4] ),
    .B(_176_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_202_));
 sky130_fd_sc_hd__a221o_2 _431_ (.A1(\u_dma.csr_ringlen[4] ),
    .A2(_149_),
    .B1(net9),
    .B2(\u_dma.csr_baseaddr[4] ),
    .C1(_201_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_203_));
 sky130_fd_sc_hd__o32a_2 _432_ (.A1(_185_),
    .A2(_202_),
    .A3(_203_),
    .B1(_183_),
    .B2(\u_dma.u_csr.tx_byte[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_204_));
 sky130_fd_sc_hd__mux2_1 _433_ (.A0(net74),
    .A1(_204_),
    .S(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_036_));
 sky130_fd_sc_hd__and2_2 _434_ (.A(\u_dma.csr_ringlen[5] ),
    .B(_149_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_205_));
 sky130_fd_sc_hd__a22o_2 _435_ (.A1(\u_dma.csr_head[5] ),
    .A2(_176_),
    .B1(net9),
    .B2(\u_dma.csr_baseaddr[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_206_));
 sky130_fd_sc_hd__a221o_2 _436_ (.A1(\u_dma.csr_tail[5] ),
    .A2(_158_),
    .B1(_177_),
    .B2(\u_dma.csr_baseaddr[13] ),
    .C1(_206_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_207_));
 sky130_fd_sc_hd__o32a_2 _437_ (.A1(_185_),
    .A2(_205_),
    .A3(_207_),
    .B1(_183_),
    .B2(\u_dma.u_csr.tx_byte[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_208_));
 sky130_fd_sc_hd__mux2_1 _438_ (.A0(net68),
    .A1(_208_),
    .S(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_037_));
 sky130_fd_sc_hd__a22o_2 _439_ (.A1(\u_dma.csr_ringlen[6] ),
    .A2(_149_),
    .B1(_176_),
    .B2(\u_dma.csr_head[6] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_209_));
 sky130_fd_sc_hd__and2_2 _440_ (.A(\u_dma.csr_baseaddr[6] ),
    .B(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_210_));
 sky130_fd_sc_hd__a221o_2 _441_ (.A1(\u_dma.csr_tail[6] ),
    .A2(_158_),
    .B1(_177_),
    .B2(\u_dma.csr_baseaddr[14] ),
    .C1(_209_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_211_));
 sky130_fd_sc_hd__o32a_2 _442_ (.A1(_185_),
    .A2(_210_),
    .A3(_211_),
    .B1(_183_),
    .B2(\u_dma.u_csr.tx_byte[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_212_));
 sky130_fd_sc_hd__mux2_1 _443_ (.A0(net69),
    .A1(_212_),
    .S(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_038_));
 sky130_fd_sc_hd__a22o_2 _444_ (.A1(\u_dma.csr_ringlen[7] ),
    .A2(_149_),
    .B1(_176_),
    .B2(\u_dma.csr_head[7] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_213_));
 sky130_fd_sc_hd__a21o_2 _445_ (.A1(\u_dma.csr_baseaddr[7] ),
    .A2(net9),
    .B1(_213_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_214_));
 sky130_fd_sc_hd__a22o_2 _446_ (.A1(\u_dma.csr_tail[7] ),
    .A2(_158_),
    .B1(_177_),
    .B2(\u_dma.csr_baseaddr[15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_215_));
 sky130_fd_sc_hd__o32a_2 _447_ (.A1(_185_),
    .A2(_214_),
    .A3(_215_),
    .B1(_183_),
    .B2(\u_dma.u_csr.tx_byte[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_216_));
 sky130_fd_sc_hd__mux2_1 _448_ (.A0(net50),
    .A1(_216_),
    .S(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_039_));
 sky130_fd_sc_hd__mux2_1 _449_ (.A0(\u_dma.u_csr.rx_byte[6] ),
    .A1(net64),
    .S(_172_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_040_));
 sky130_fd_sc_hd__mux2_1 _450_ (.A0(net90),
    .A1(\u_dma.u_csr.reg_addr[0] ),
    .S(_172_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_041_));
 sky130_fd_sc_hd__mux2_1 _451_ (.A0(net97),
    .A1(\u_dma.u_csr.reg_addr[1] ),
    .S(_172_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_042_));
 sky130_fd_sc_hd__mux2_1 _452_ (.A0(net91),
    .A1(\u_dma.u_csr.reg_addr[2] ),
    .S(_172_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_043_));
 sky130_fd_sc_hd__mux2_1 _453_ (.A0(\u_dma.u_csr.rx_byte[2] ),
    .A1(net100),
    .S(_172_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_044_));
 sky130_fd_sc_hd__mux2_1 _454_ (.A0(net98),
    .A1(net102),
    .S(_172_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_045_));
 sky130_fd_sc_hd__mux2_1 _455_ (.A0(\u_dma.u_csr.rx_byte[4] ),
    .A1(net105),
    .S(_172_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_046_));
 sky130_fd_sc_hd__mux2_1 _456_ (.A0(\u_dma.u_csr.rx_byte[5] ),
    .A1(net103),
    .S(_172_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_047_));
 sky130_fd_sc_hd__and3_2 _457_ (.A(\u_dma.u_csr.bit_cnt[3] ),
    .B(_165_),
    .C(_170_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_217_));
 sky130_fd_sc_hd__mux2_1 _458_ (.A0(net95),
    .A1(net90),
    .S(_217_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_048_));
 sky130_fd_sc_hd__mux2_1 _459_ (.A0(net62),
    .A1(\u_dma.u_csr.rx_byte[0] ),
    .S(_217_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__mux2_1 _460_ (.A0(net66),
    ...
    .VPWR(VPWR),
    .X(_050_));
 sky130_fd_sc_hd__mux2_1 _461_ (.A0(net48),
    .A1(\u_dma.u_csr.rx_byte[2] ),
    .S(_217_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _462_ (.A0(net71),
    ...
    .VPWR(VPWR),
    .X(_052_));
 sky130_fd_sc_hd__mux2_1 _463_ (.A0(net57),
    .A1(\u_dma.u_csr.rx_byte[4] ),
    .S(_217_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_053_));
 sky130_fd_sc_hd__mux2_1 _464_ (.A0(net46),
    .A1(\u_dma.u_csr.rx_byte[5] ),
    .S(_217_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_054_));
 sky130_fd_sc_hd__mux2_1 _465_ (.A0(net52),
    .A1(\u_dma.u_csr.rx_byte[6] ),
    .S(_217_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_055_));
 sky130_fd_sc_hd__a21o_2 _466_ (.A1(net51),
    .A2(_145_),
    .B1(_139_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_056_));
 sky130_fd_sc_hd__o21ba_2 _467_ (.A1(\u_dma.u_movement.df_in_full ),
    .A2(net87),
    .B1_N(\u_dma.u_movement.df_out_rd_en ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_057_));
 sky130_fd_sc_hd__and3_2 _468_ (.A(\u_dma.u_movement.u_desc_to_dm_fifo.wr_addr[0] ),
    .B(\u_dma.u_movement.dm_in_wr_en ),
    .C(_135_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_218_));
 sky130_fd_sc_hd__a21oi_2 _469_ (.A1(net77),
    .A2(_135_),
    .B1(\u_dma.u_movement.u_desc_to_dm_fifo.wr_addr[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_219_));
 sky130_fd_sc_hd__nor2_2 _470_ (.A(_218_),
    .B(net78),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_058_));
 sky130_fd_sc_hd__nand2_2 _471_ (.A(\u_dma.u_movement.u_desc_to_dm_fifo.wr_addr[1] ),
    .B(_218_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_220_));
 sky130_fd_sc_hd__or2_2 _472_ (.A(\u_dma.u_movement.u_desc_to_dm_fifo.wr_addr[1] ),
    .B(_218_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_221_));
 sky130_fd_sc_hd__and2_2 _473_ (.A(_220_),
    .B(_221_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_059_));
 sky130_fd_sc_hd__xnor2_2 _474_ (.A(net82),
    .B(_220_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_060_));
 sky130_fd_sc_hd__o21ai_2 _475_ (.A1(_096_),
    .A2(_097_),
    .B1(\u_dma.csr_ringlen[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_222_));
 sky130_fd_sc_hd__and3_2 _476_ (.A(\u_dma.csr_head[6] ),
    .B(_098_),
    .C(_222_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_223_));
 sky130_fd_sc_hd__a21oi_2 _477_ (.A1(_098_),
    .A2(_222_),
    .B1(\u_dma.csr_head[6] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_224_));
 sky130_fd_sc_hd__or2_2 _478_ (.A(_223_),
    .B(_224_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_225_));
 sky130_fd_sc_hd__xor2_2 _479_ (.A(net14),
    .B(\u_dma.csr_ringlen[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_226_));
 sky130_fd_sc_hd__xnor2_2 _480_ (.A(_095_),
    .B(_226_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_227_));
 sky130_fd_sc_hd__o21ai_2 _481_ (.A1(\u_dma.csr_ringlen[0] ),
    .A2(\u_dma.csr_ringlen[1] ),
    .B1(\u_dma.csr_ringlen[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_228_));
 sky130_fd_sc_hd__a21oi_2 _482_ (.A1(_095_),
    .A2(_228_),
    .B1(\u_dma.csr_head[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_229_));
 sky130_fd_sc_hd__and3_2 _483_ (.A(\u_dma.csr_head[2] ),
    .B(_095_),
    .C(_228_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_230_));
 sky130_fd_sc_hd__xor2_2 _484_ (.A(\u_dma.csr_head[1] ),
    .B(\u_dma.csr_ringlen[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_231_));
 sky130_fd_sc_hd__nand2b_2 _485_ (.A_N(net15),
    .B(\u_dma.csr_ringlen[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_232_));
 sky130_fd_sc_hd__nand2b_2 _486_ (.A_N(\u_dma.csr_ringlen[0] ),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__mux2_1 _487_ (.A0(_232_),
    ...
    .VPWR(VPWR),
    .X(_234_));
 sky130_fd_sc_hd__or4_2 _488_ (.A(_227_),
    .B(_229_),
    .C(_230_),
    .D(_234_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_235_));
 sky130_fd_sc_hd__xnor2_2 _489_ (.A(\u_dma.csr_head[5] ),
    .B(\u_dma.csr_ringlen[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_236_));
 sky130_fd_sc_hd__nor2_2 _490_ (.A(\u_dma.csr_ringlen[4] ),
    .B(_096_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_237_));
 sky130_fd_sc_hd__xnor2_2 _491_ (.A(_236_),
    .B(_237_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_238_));
 sky130_fd_sc_hd__xnor2_2 _492_ (.A(\u_dma.csr_ringlen[4] ),
    .B(_096_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_239_));
 sky130_fd_sc_hd__or2_2 _493_ (.A(\u_dma.csr_head[4] ),
    .B(_239_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_240_));
 sky130_fd_sc_hd__nand2_2 _494_ (.A(\u_dma.csr_head[4] ),
    .B(_239_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_241_));
 sky130_fd_sc_hd__a211o_2 _495_ (.A1(_240_),
    .A2(_241_),
    .B1(_235_),
    .C1(_238_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_242_));
 sky130_fd_sc_hd__xor2_2 _496_ (.A(\u_dma.csr_ringlen[7] ),
    .B(_098_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_243_));
 sky130_fd_sc_hd__xnor2_2 _497_ (.A(\u_dma.csr_head[7] ),
    .B(_243_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_244_));
 sky130_fd_sc_hd__o41a_2 _498_ (.A1(_111_),
    .A2(_225_),
    .A3(_242_),
    .A4(_244_),
    .B1(net12),
    ...
    .VPWR(VPWR),
    .X(_245_));
 sky130_fd_sc_hd__and2_2 _499_ (.A(net15),
    .B(\u_dma.u_movement.u_df.df_in_wr_en_c ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_246_));
 sky130_fd_sc_hd__or2_2 _500_ (.A(net15),
    .B(\u_dma.u_movement.u_df.df_in_wr_en_c ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_247_));
 sky130_fd_sc_hd__and3b_2 _501_ (.A_N(_246_),
    .B(_247_),
    .C(_245_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_061_));
 sky130_fd_sc_hd__nand2_2 _502_ (.A(\u_dma.csr_head[1] ),
    .B(_246_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_248_));
 sky130_fd_sc_hd__or2_2 _503_ (.A(\u_dma.csr_head[1] ),
    .B(_246_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_249_));
 sky130_fd_sc_hd__and3_2 _504_ (.A(_245_),
    .B(_248_),
    .C(_249_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_062_));
 sky130_fd_sc_hd__and4_2 _505_ (.A(\u_dma.csr_head[2] ),
    .B(\u_dma.csr_head[1] ),
    .C(net15),
    .D(\u_dma.u_movement.u_df.df_in_wr_en_c ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_250_));
 sky130_fd_sc_hd__a31o_2 _506_ (.A1(\u_dma.csr_head[1] ),
    .A2(net15),
    .A3(\u_dma.u_movement.u_df.df_in_wr_en_c ),
    .B1(\u_dma.csr_head[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_251_));
 sky130_fd_sc_hd__and3b_2 _507_ (.A_N(_250_),
    .B(_251_),
    .C(_245_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_063_));
 sky130_fd_sc_hd__nand2_2 _508_ (.A(net14),
    .B(_250_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_252_));
 sky130_fd_sc_hd__or2_2 _509_ (.A(net14),
    .B(_250_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_253_));
 sky130_fd_sc_hd__and3_2 _510_ (.A(_245_),
    .B(_252_),
    .C(_253_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_064_));
 sky130_fd_sc_hd__nand3_2 _511_ (.A(\u_dma.csr_head[4] ),
    .B(net14),
    .C(_250_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_254_));
 sky130_fd_sc_hd__a21oi_2 _512_ (.A1(net14),
    .A2(_250_),
    .B1(\u_dma.csr_head[4] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_255_));
 sky130_fd_sc_hd__and3b_2 _513_ (.A_N(_255_),
    .B(_245_),
    .C(_254_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_065_));
 sky130_fd_sc_hd__a31o_2 _514_ (.A1(\u_dma.csr_head[4] ),
    .A2(net14),
    .A3(_250_),
    .B1(\u_dma.csr_head[5] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_256_));
 sky130_fd_sc_hd__and3_2 _515_ (.A(\u_dma.csr_head[5] ),
    .B(\u_dma.csr_head[4] ),
    .C(net14),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_257_));
 sky130_fd_sc_hd__nand2_2 _516_ (.A(_250_),
    .B(_257_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_258_));
 sky130_fd_sc_hd__and3_2 _517_ (.A(_245_),
    .B(_256_),
    .C(_258_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_066_));
 sky130_fd_sc_hd__nand3_2 _518_ (.A(\u_dma.csr_head[6] ),
    .B(_250_),
    .C(_257_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_259_));
 sky130_fd_sc_hd__a21o_2 _519_ (.A1(_250_),
    .A2(_257_),
    .B1(\u_dma.csr_head[6] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_260_));
 sky130_fd_sc_hd__and3_2 _520_ (.A(_245_),
    .B(_259_),
    .C(_260_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_067_));
 sky130_fd_sc_hd__a31o_2 _521_ (.A1(\u_dma.csr_head[6] ),
    .A2(_250_),
    .A3(_257_),
    .B1(\u_dma.csr_head[7] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_261_));
 sky130_fd_sc_hd__o211a_2 _522_ (.A1(_089_),
    .A2(_259_),
    .B1(_261_),
    .C1(_245_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_068_));
 sky130_fd_sc_hd__o211a_2 _523_ (.A1(\u_dma.csr_busy ),
    .A2(\u_dma.u_movement.u_df.df_in_wr_en_c ),
    .B1(net12),
    .C1(_093_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_069_));
 sky130_fd_sc_hd__o21ai_2 _524_ (.A1(_108_),
    .A2(_109_),
    .B1(net12),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_070_));
 sky130_fd_sc_hd__or2_2 _525_ (.A(net44),
    .B(net41),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_071_));
 sky130_fd_sc_hd__and2b_2 _526_ (.A_N(_143_),
    .B(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_262_));
 sky130_fd_sc_hd__nor2_2 _527_ (.A(\u_dma.csr_reset ),
    .B(_262_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_263_));
 sky130_fd_sc_hd__a22o_2 _528_ (.A1(_161_),
    .A2(_262_),
    .B1(_263_),
    .B2(net112),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_072_));
 sky130_fd_sc_hd__a22o_2 _529_ (.A1(_148_),
    .A2(_262_),
    .B1(_263_),
    .B2(net89),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_073_));
 sky130_fd_sc_hd__a22o_2 _530_ (.A1(_152_),
    .A2(_262_),
    .B1(_263_),
    .B2(net84),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_074_));
 sky130_fd_sc_hd__a22o_2 _531_ (.A1(_153_),
    .A2(_262_),
    .B1(_263_),
    .B2(net123),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_075_));
 sky130_fd_sc_hd__a22o_2 _532_ (.A1(_154_),
    .A2(_262_),
    .B1(_263_),
    .B2(\u_dma.csr_baseaddr[4] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_076_));
 sky130_fd_sc_hd__a22o_2 _533_ (.A1(_155_),
    .A2(_262_),
    .B1(_263_),
    .B2(net128),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_077_));
 sky130_fd_sc_hd__a22o_2 _534_ (.A1(_156_),
    .A2(_262_),
    .B1(_263_),
    .B2(net124),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_078_));
 sky130_fd_sc_hd__a22o_2 _535_ (.A1(_157_),
    .A2(_262_),
    .B1(_263_),
    .B2(net125),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_079_));
 sky130_fd_sc_hd__and2b_2 _536_ (.A_N(_143_),
    .B(_177_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_264_));
 sky130_fd_sc_hd__nor2_2 _537_ (.A(\u_dma.csr_reset ),
    .B(_264_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_265_));
 sky130_fd_sc_hd__a22o_2 _538_ (.A1(_161_),
    .A2(_264_),
    .B1(_265_),
    .B2(net75),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_080_));
 sky130_fd_sc_hd__a22o_2 _539_ (.A1(_148_),
    .A2(_264_),
    .B1(_265_),
    .B2(net54),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_081_));
 sky130_fd_sc_hd__a22o_2 _540_ (.A1(_152_),
    .A2(_264_),
    .B1(_265_),
    .B2(net60),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_082_));
 sky130_fd_sc_hd__a22o_2 _541_ (.A1(_153_),
    .A2(_264_),
    .B1(_265_),
    .B2(net61),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_083_));
 sky130_fd_sc_hd__a22o_2 _542_ (.A1(_154_),
    .A2(_264_),
    .B1(_265_),
    .B2(net70),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_084_));
 sky130_fd_sc_hd__a22o_2 _543_ (.A1(_155_),
    .A2(_264_),
    .B1(_265_),
    .B2(net79),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_085_));
 sky130_fd_sc_hd__a22o_2 _544_ (.A1(_156_),
    .A2(_264_),
    .B1(_265_),
    .B2(net76),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_086_));
 sky130_fd_sc_hd__a22o_2 _545_ (.A1(_157_),
    .A2(_264_),
    .B1(_265_),
    .B2(net56),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_087_));
 sky130_fd_sc_hd__a22o_2 _546_ (.A1(\u_dma.csr_ringlen[0] ),
    .A2(_151_),
    .B1(_161_),
    .B2(_150_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_088_));
 sky130_fd_sc_hd__dfrtp_2 _547_ (.CLK(clknet_4_2_0_clk),
    .D(_004_),
    .RESET_B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.csr_ringlen[1] ));
 sky130_fd_sc_hd__dfrtp_2 _548_ (.CLK(clknet_4_1_0_clk),
    .D(_005_),
    .RESET_B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.csr_ringlen[2] ));
 sky130_fd_sc_hd__dfrtp_2 _549_ (.CLK(clknet_4_2_0_clk),
    .D(_006_),
    .RESET_B(net17),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _553_ (.CLK(clknet_4_0_0_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.csr_ringlen[7] ));
 sky130_fd_sc_hd__dfrtp_2 _554_ (.CLK(clknet_4_3_0_clk),
    .D(_011_),
    .RESET_B(net19),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\u_dma.csr_tail[0] ));
 sky130_fd_sc_hd__dfrtp_2 _555_ (.CLK(clknet_4_2_0_clk),
    .D(_012_),
    .RESET_B(net16),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\u_dma.csr_tail[1] ));
 sky130_fd_sc_hd__dfrtp_2 _556_ (.CLK(clknet_4_3_0_clk),
    .D(_013_),
    .RESET_B(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\u_dma.csr_tail[2] ));
 sky130_fd_sc_hd__dfrtp_2 _557_ (.CLK(clknet_4_3_0_clk),
    .D(_014_),
    .RESET_B(net19),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _558_ (.CLK(clknet_4_2_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\u_dma.csr_tail[4] ));
 sky130_fd_sc_hd__dfrtp_2 _559_ (.CLK(clknet_4_2_0_clk),
    .D(_016_),
    .RESET_B(net19),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\u_dma.csr_tail[5] ));
 sky130_fd_sc_hd__dfrtp_2 _560_ (.CLK(clknet_4_2_0_clk),
    .D(_017_),
    .RESET_B(net19),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\u_dma.csr_tail[6] ));
 sky130_fd_sc_hd__dfrtp_2 _561_ (.CLK(clknet_4_8_0_clk),
    .D(_018_),
    .RESET_B(net19),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\u_dma.csr_tail[7] ));
 sky130_fd_sc_hd__dfrtp_2 _562_ (.CLK(clknet_4_3_0_clk),
    .D(_001_),
    .RESET_B(net30),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\u_dma.csr_reset ));
 sky130_fd_sc_hd__dfrtp_2 _563_ (.CLK(clknet_4_12_0_clk),
    .D(_019_),
    .RESET_B(net21),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\u_dma.csr_enable ));
 sky130_fd_sc_hd__dfrtp_2 _564_ (.CLK(clknet_4_6_0_clk),
    .D(_020_),
    .RESET_B(net30),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\u_dma.csr_irq_en ));
 sky130_fd_sc_hd__dfrtp_2 _565_ (.CLK(clknet_4_13_0_clk),
    .D(_021_),
    .RESET_B(net28),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_csr.bit_cnt[0] ));
 sky130_fd_sc_hd__dfrtp_2 _566_ (.CLK(clknet_4_13_0_clk),
    .D(_022_),
    .RESET_B(net28),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_csr.bit_cnt[1] ));
 sky130_fd_sc_hd__dfrtp_2 _567_ (.CLK(clknet_4_14_0_clk),
    .D(_023_),
    .RESET_B(net28),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_csr.bit_cnt[2] ));
 sky130_fd_sc_hd__dfrtp_2 _568_ (.CLK(clknet_4_15_0_clk),
    .D(_024_),
    .RESET_B(net27),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_csr.bit_cnt[3] ));
 sky130_fd_sc_hd__dfrtp_2 _569_ (.CLK(clknet_4_14_0_clk),
    .D(_025_),
    .RESET_B(net27),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_csr.rx_byte[0] ));
 sky130_fd_sc_hd__dfrtp_2 _570_ (.CLK(clknet_4_11_0_clk),
    .D(_026_),
    .RESET_B(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_csr.rx_byte[1] ));
 sky130_fd_sc_hd__dfrtp_2 _571_ (.CLK(clknet_4_11_0_clk),
    .D(net92),
    .RESET_B(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_csr.rx_byte[2] ));
 sky130_fd_sc_hd__dfrtp_2 _572_ (.CLK(clknet_4_9_0_clk),
    .D(_028_),
    .RESET_B(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_csr.rx_byte[3] ));
 sky130_fd_sc_hd__dfrtp_2 _573_ (.CLK(clknet_4_10_0_clk),
    .D(net99),
    .RESET_B(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_csr.rx_byte[4] ));
 sky130_fd_sc_hd__dfrtp_2 _574_ (.CLK(clknet_4_10_0_clk),
    .D(net109),
    .RESET_B(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_csr.rx_byte[5] ));
 sky130_fd_sc_hd__dfrtp_2 _575_ (.CLK(clknet_4_9_0_clk),
    .D(net94),
    .RESET_B(net24),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _578_ (.CLK(clknet_4_12_0_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_csr.tx_byte[2] ));
 sky130_fd_sc_hd__dfrtp_2 _579_ (.CLK(clknet_4_7_0_clk),
    .D(_035_),
    .RESET_B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_csr.tx_byte[3] ));
 sky130_fd_sc_hd__dfrtp_2 _580_ (.CLK(clknet_4_6_0_clk),
    .D(_036_),
    .RESET_B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_csr.tx_byte[4] ));
 sky130_fd_sc_hd__dfrtp_2 _581_ (.CLK(clknet_4_6_0_clk),
    .D(_037_),
    .RESET_B(net21),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _582_ (.CLK(clknet_4_12_0_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_csr.tx_byte[6] ));
 sky130_fd_sc_hd__dfrtp_2 _583_ (.CLK(clknet_4_12_0_clk),
    .D(_039_),
    .RESET_B(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\u_dma.spi_miso ));
 sky130_fd_sc_hd__dfrtp_2 _584_ (.CLK(clknet_4_14_0_clk),
    .D(net65),
    .RESET_B(net27),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_csr.is_read ));
 sky130_fd_sc_hd__dfrtp_2 _585_ (.CLK(clknet_4_14_0_clk),
    .D(_041_),
    .RESET_B(net27),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_csr.reg_addr[0] ));
 sky130_fd_sc_hd__dfrtp_2 _586_ (.CLK(clknet_4_11_0_clk),
    .D(_042_),
    .RESET_B(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_csr.reg_addr[1] ));
 sky130_fd_sc_hd__dfrtp_2 _587_ (.CLK(clknet_4_14_0_clk),
    .D(_043_),
    .RESET_B(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_csr.reg_addr[2] ));
 sky130_fd_sc_hd__dfrtp_2 _588_ (.CLK(clknet_4_10_0_clk),
    .D(net101),
    .RESET_B(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_csr.reg_addr[3] ));
 sky130_fd_sc_hd__dfrtp_2 _589_ (.CLK(clknet_4_10_0_clk),
    .D(_045_),
    .RESET_B(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_csr.reg_addr[4] ));
 sky130_fd_sc_hd__dfrtp_2 _590_ (.CLK(clknet_4_10_0_clk),
    .D(net106),
    .RESET_B(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_csr.reg_addr[5] ));
 sky130_fd_sc_hd__dfrtp_2 _591_ (.CLK(clknet_4_10_0_clk),
    .D(net104),
    .RESET_B(net25),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _592_ (.CLK(clknet_4_14_0_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_csr.rx_data[0] ));
 sky130_fd_sc_hd__dfrtp_2 _593_ (.CLK(clknet_4_11_0_clk),
    .D(net63),
    .RESET_B(net25),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _597_ (.CLK(clknet_4_8_0_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_csr.rx_data[5] ));
 sky130_fd_sc_hd__dfrtp_2 _598_ (.CLK(clknet_4_8_0_clk),
    .D(net47),
    .RESET_B(net26),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _599_ (.CLK(clknet_4_10_0_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_csr.rx_data[7] ));
 sky130_fd_sc_hd__dfrtp_2 _600_ (.CLK(clknet_4_13_0_clk),
    .D(_056_),
    .RESET_B(net30),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _601_ (.CLK(clknet_4_4_0_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_movement.df_in_full ));
 sky130_fd_sc_hd__dfrtp_2 _602_ (.CLK(clknet_4_4_0_clk),
    .D(_058_),
    .RESET_B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_movement.u_desc_to_dm_fifo.wr_addr[0] ));
 sky130_fd_sc_hd__dfrtp_2 _603_ (.CLK(clknet_4_4_0_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_movement.u_desc_to_dm_fifo.wr_addr[1] ));
 sky130_fd_sc_hd__dfrtp_2 _604_ (.CLK(clknet_4_4_0_clk),
    .D(_060_),
    .RESET_B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_movement.u_desc_to_dm_fifo.wr_addr[2] ));
 sky130_fd_sc_hd__dfxtp_2 _605_ (.CLK(clknet_4_4_0_clk),
    .D(_061_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.csr_head[0] ));
 sky130_fd_sc_hd__dfxtp_2 _606_ (.CLK(clknet_4_4_0_clk),
    .D(_062_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.csr_head[1] ));
 sky130_fd_sc_hd__dfxtp_2 _607_ (.CLK(clknet_4_1_0_clk),
    .D(_063_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.csr_head[2] ));
 sky130_fd_sc_hd__dfxtp_2 _608_ (.CLK(clknet_4_1_0_clk),
    .D(_064_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.csr_head[3] ));
 sky130_fd_sc_hd__dfxtp_2 _609_ (.CLK(clknet_4_0_0_clk),
    .D(_065_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.csr_head[4] ));
 sky130_fd_sc_hd__dfxtp_2 _610_ (.CLK(clknet_4_0_0_clk),
    .D(_066_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.csr_head[5] ));
 sky130_fd_sc_hd__dfxtp_2 _611_ (.CLK(clknet_4_0_0_clk),
    .D(_067_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.csr_head[6] ));
 sky130_fd_sc_hd__dfxtp_2 _612_ (.CLK(clknet_4_0_0_clk),
    .D(_068_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.csr_head[7] ));
 sky130_fd_sc_hd__dfxtp_2 _613_ (.CLK(clknet_4_7_0_clk),
    .D(net86),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.csr_busy ));
 sky130_fd_sc_hd__dfxtp_2 _614_ (.CLK(clknet_4_12_0_clk),
    .D(_070_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_ring_manager.was_empty ));
 sky130_fd_sc_hd__dfstp_2 _615_ (.CLK(clknet_4_5_0_clk),
    .D(_000_),
    .SET_B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_movement.u_data_mover.state[0] ));
 sky130_fd_sc_hd__dfrtp_2 _616_ (.CLK(clknet_4_7_0_clk),
    .D(net41),
    .RESET_B(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.probe_dm_wr_en ));
 sky130_fd_sc_hd__dfrtp_2 _617_ (.CLK(clknet_4_5_0_clk),
    .D(\u_dma.u_movement.df_dm_in_rd_en ),
    .RESET_B(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_movement.u_data_mover.state[2] ));
 sky130_fd_sc_hd__dfrtp_2 _618_ (.CLK(clknet_4_7_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\u_dma.dm_done ));
 sky130_fd_sc_hd__dfrtp_2 _619_ (.CLK(clknet_4_4_0_clk),
    .D(\u_dma.u_movement.df_out_rd_en ),
    .RESET_B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_movement.dm_in_wr_en ));
 sky130_fd_sc_hd__dfrtp_2 _620_ (.CLK(clknet_4_7_0_clk),
    .D(\u_dma.u_movement.u_df.df_in_wr_en_c ),
    .RESET_B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.probe_df_in_wr_en ));
 sky130_fd_sc_hd__dfstp_2 _621_ (.CLK(clknet_4_5_0_clk),
    .D(_003_),
    .SET_B(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_movement.df_dm_in_empty ));
 sky130_fd_sc_hd__dfrtp_2 _622_ (.CLK(clknet_4_5_0_clk),
    .D(\u_dma.u_movement.u_desc_to_dm_fifo.rd_addr_t[0] ),
    .RESET_B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_movement.u_desc_to_dm_fifo.rd_addr[0] ));
 sky130_fd_sc_hd__dfrtp_2 _623_ (.CLK(clknet_4_5_0_clk),
    .D(\u_dma.u_movement.u_desc_to_dm_fifo.rd_addr_t[1] ),
    .RESET_B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_movement.u_desc_to_dm_fifo.rd_addr[1] ));
 sky130_fd_sc_hd__dfrtp_2 _624_ (.CLK(clknet_4_5_0_clk),
    .D(\u_dma.u_movement.u_desc_to_dm_fifo.rd_addr_t[2] ),
    .RESET_B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_movement.u_desc_to_dm_fifo.rd_addr[2] ));
 sky130_fd_sc_hd__dfstp_2 _625_ (.CLK(clknet_4_13_0_clk),
    .D(net4),
    .SET_B(net30),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_csr.csn_r[0] ));
 sky130_fd_sc_hd__dfstp_2 _626_ (.CLK(clknet_4_13_0_clk),
    .D(net40),
    .SET_B(net30),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_csr.csn_r[1] ));
 sky130_fd_sc_hd__dfrtp_2 _627_ (.CLK(clknet_4_15_0_clk),
    .D(_002_),
    .RESET_B(net28),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_csr.reg_irq_empty ));
 sky130_fd_sc_hd__dfrtp_2 _628_ (.CLK(clknet_4_15_0_clk),
    .D(net3),
    .RESET_B(net28),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_csr.mosi_r[0] ));
 sky130_fd_sc_hd__dfrtp_2 _629_ (.CLK(clknet_4_15_0_clk),
    .D(net39),
    .RESET_B(net31),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_csr.mosi_r[1] ));
 sky130_fd_sc_hd__dfrtp_2 _630_ (.CLK(clknet_4_15_0_clk),
    .D(net2),
    .RESET_B(net31),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_csr.sclk_r[0] ));
 sky130_fd_sc_hd__dfrtp_2 _631_ (.CLK(clknet_4_15_0_clk),
    .D(net42),
    .RESET_B(net29),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.u_csr.sclk_r[1] ));
 sky130_fd_sc_hd__dfrtp_2 _632_ (.CLK(clknet_4_7_0_clk),
    .D(_071_),
    .RESET_B(net12),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _633_ (.CLK(clknet_4_6_0_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.csr_baseaddr[0] ));
 sky130_fd_sc_hd__dfrtp_2 _634_ (.CLK(clknet_4_6_0_clk),
    .D(_073_),
    .RESET_B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.csr_baseaddr[1] ));
 sky130_fd_sc_hd__dfrtp_2 _635_ (.CLK(clknet_4_6_0_clk),
    .D(_074_),
    .RESET_B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.csr_baseaddr[2] ));
 sky130_fd_sc_hd__dfrtp_2 _636_ (.CLK(clknet_4_1_0_clk),
    .D(_075_),
    .RESET_B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.csr_baseaddr[3] ));
 sky130_fd_sc_hd__dfrtp_2 _637_ (.CLK(clknet_4_3_0_clk),
    .D(_076_),
    .RESET_B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.csr_baseaddr[4] ));
 sky130_fd_sc_hd__dfrtp_2 _638_ (.CLK(clknet_4_1_0_clk),
    .D(_077_),
    .RESET_B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.csr_baseaddr[5] ));
 sky130_fd_sc_hd__dfrtp_2 _639_ (.CLK(clknet_4_3_0_clk),
    .D(_078_),
    .RESET_B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.csr_baseaddr[6] ));
 sky130_fd_sc_hd__dfrtp_2 _640_ (.CLK(clknet_4_6_0_clk),
    .D(_079_),
    .RESET_B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.csr_baseaddr[7] ));
 sky130_fd_sc_hd__dfrtp_2 _641_ (.CLK(clknet_4_9_0_clk),
    .D(_080_),
    .RESET_B(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.csr_baseaddr[8] ));
 sky130_fd_sc_hd__dfrtp_2 _642_ (.CLK(clknet_4_11_0_clk),
    .D(_081_),
    .RESET_B(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.csr_baseaddr[9] ));
 sky130_fd_sc_hd__dfrtp_2 _643_ (.CLK(clknet_4_13_0_clk),
    .D(_082_),
    .RESET_B(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.csr_baseaddr[10] ));
 sky130_fd_sc_hd__dfrtp_2 _644_ (.CLK(clknet_4_8_0_clk),
    .D(_083_),
    .RESET_B(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.csr_baseaddr[11] ));
 sky130_fd_sc_hd__dfrtp_2 _645_ (.CLK(clknet_4_8_0_clk),
    .D(_084_),
    .RESET_B(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.csr_baseaddr[12] ));
 sky130_fd_sc_hd__dfrtp_2 _646_ (.CLK(clknet_4_9_0_clk),
    .D(_085_),
    .RESET_B(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.csr_baseaddr[13] ));
 sky130_fd_sc_hd__dfrtp_2 _647_ (.CLK(clknet_4_8_0_clk),
    .D(_086_),
    .RESET_B(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.csr_baseaddr[14] ));
 sky130_fd_sc_hd__dfrtp_2 _648_ (.CLK(clknet_4_9_0_clk),
    .D(_087_),
    .RESET_B(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.csr_baseaddr[15] ));
 sky130_fd_sc_hd__dfrtp_2 _649_ (.CLK(clknet_4_1_0_clk),
    .D(_088_),
    .RESET_B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_dma.csr_ringlen[0] ));
 sky130_fd_sc_hd__buf_2 _658_ (.A(\u_dma.csr_baseaddr[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[0]));
 sky130_fd_sc_hd__buf_2 _659_ (.A(\u_dma.csr_baseaddr[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[1]));
 sky130_fd_sc_hd__buf_2 _660_ (.A(\u_dma.csr_baseaddr[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[2]));
 sky130_fd_sc_hd__buf_2 _661_ (.A(\u_dma.spi_miso ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[0]));
 sky130_fd_sc_hd__buf_2 _662_ (.A(\u_dma.irq ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[1]));
 sky130_fd_sc_hd__buf_2 _663_ (.A(\u_dma.fetch_req_valid ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[2]));
 sky130_fd_sc_hd__buf_2 _664_ (.A(\u_dma.probe_df_in_wr_en ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[3]));
 sky130_fd_sc_hd__buf_2 _665_ (.A(\u_dma.probe_dm_wr_en ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[4]));
 sky130_fd_sc_hd__buf_2 _666_ (.A(\u_dma.probe_dm_instr_rw ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[5]));
 sky130_fd_sc_hd__buf_2 _667_ (.A(\u_dma.csr_ring_empty ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[6]));
 sky130_fd_sc_hd__buf_2 _668_ (.A(\u_dma.csr_busy ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout11 (.A(net12),
    ...
    .VPWR(VPWR),
    .X(net11));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout12 (.A(\u_dma.rst_core_n ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net12));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout14 (.A(\u_dma.csr_head[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net14));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout15 (.A(\u_dma.csr_head[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout23 (.A(net25),
    ...
    .VPWR(VPWR),
    .X(net23));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout25 (.A(net31),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout31 (.A(net1),
    ...
    .VPWR(VPWR),
    .X(net31));
 sky130_fd_sc_hd__dlygate4sd3_1 hold100 (.A(\u_dma.u_csr.reg_addr[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net100));
 sky130_fd_sc_hd__dlygate4sd3_1 hold101 (.A(_044_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net101));
 sky130_fd_sc_hd__dlygate4sd3_1 hold102 (.A(\u_dma.u_csr.reg_addr[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net102));
 sky130_fd_sc_hd__dlygate4sd3_1 hold103 (.A(\u_dma.u_csr.reg_addr[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net103));
 sky130_fd_sc_hd__dlygate4sd3_1 hold104 (.A(_047_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net104));
 sky130_fd_sc_hd__dlygate4sd3_1 hold105 (.A(\u_dma.u_csr.reg_addr[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net105));
 sky130_fd_sc_hd__dlygate4sd3_1 hold106 (.A(_046_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net106));
 sky130_fd_sc_hd__dlygate4sd3_1 hold107 (.A(\u_dma.u_csr.bit_cnt[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net107));
 sky130_fd_sc_hd__dlygate4sd3_1 hold108 (.A(\u_dma.u_csr.rx_byte[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net108));
 sky130_fd_sc_hd__dlygate4sd3_1 hold109 (.A(_030_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net109));
 sky130_fd_sc_hd__dlygate4sd3_1 hold110 (.A(\u_dma.u_csr.rx_byte[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net110));
 sky130_fd_sc_hd__dlygate4sd3_1 hold111 (.A(\u_dma.u_csr.bit_cnt[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net111));
 sky130_fd_sc_hd__dlygate4sd3_1 hold112 (.A(\u_dma.csr_baseaddr[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net112));
 sky130_fd_sc_hd__dlygate4sd3_1 hold113 (.A(\u_dma.u_csr.reg_irq_empty ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net113));
 sky130_fd_sc_hd__dlygate4sd3_1 hold114 (.A(\u_dma.u_movement.df_in_full ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net114));
 sky130_fd_sc_hd__dlygate4sd3_1 hold115 (.A(\u_dma.csr_tail[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net115));
 sky130_fd_sc_hd__dlygate4sd3_1 hold116 (.A(\u_dma.csr_tail[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net116));
 sky130_fd_sc_hd__dlygate4sd3_1 hold117 (.A(\u_dma.csr_tail[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net117));
 sky130_fd_sc_hd__dlygate4sd3_1 hold118 (.A(\u_dma.csr_tail[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net118));
 sky130_fd_sc_hd__dlygate4sd3_1 hold119 (.A(\u_dma.csr_tail[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net119));
 sky130_fd_sc_hd__dlygate4sd3_1 hold120 (.A(\u_dma.csr_tail[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net120));
 sky130_fd_sc_hd__dlygate4sd3_1 hold121 (.A(\u_dma.u_csr.bit_cnt[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net121));
 sky130_fd_sc_hd__dlygate4sd3_1 hold122 (.A(\u_dma.csr_tail[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net122));
 sky130_fd_sc_hd__dlygate4sd3_1 hold123 (.A(\u_dma.csr_baseaddr[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net123));
 sky130_fd_sc_hd__dlygate4sd3_1 hold124 (.A(\u_dma.csr_baseaddr[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net124));
 sky130_fd_sc_hd__dlygate4sd3_1 hold125 (.A(\u_dma.csr_baseaddr[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net125));
 sky130_fd_sc_hd__dlygate4sd3_1 hold126 (.A(\u_dma.csr_tail[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net126));
 sky130_fd_sc_hd__dlygate4sd3_1 hold127 (.A(\u_dma.csr_ringlen[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net127));
 sky130_fd_sc_hd__dlygate4sd3_1 hold128 (.A(\u_dma.csr_baseaddr[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net128));
 sky130_fd_sc_hd__dlygate4sd3_1 hold39 (.A(\u_dma.u_csr.mosi_r[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net39));
 sky130_fd_sc_hd__dlygate4sd3_1 hold40 (.A(\u_dma.u_csr.csn_r[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net40));
 sky130_fd_sc_hd__dlygate4sd3_1 hold41 (.A(\u_dma.u_movement.u_data_mover.state[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net41));
 sky130_fd_sc_hd__dlygate4sd3_1 hold42 (.A(\u_dma.u_csr.sclk_r[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net42));
 sky130_fd_sc_hd__dlygate4sd3_1 hold43 (.A(\u_dma.probe_dm_wr_en ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net43));
 sky130_fd_sc_hd__dlygate4sd3_1 hold44 (.A(\u_dma.probe_dm_instr_rw ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net44));
 sky130_fd_sc_hd__dlygate4sd3_1 hold45 (.A(\u_dma.u_movement.u_data_mover.state[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net45));
 sky130_fd_sc_hd__dlygate4sd3_1 hold46 (.A(\u_dma.u_csr.rx_data[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold47 (.A(_054_),
    ...
    .VPWR(VPWR),
    .X(net47));
 sky130_fd_sc_hd__dlygate4sd3_1 hold48 (.A(\u_dma.u_csr.rx_data[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold49 (.A(_051_),
    ...
    .VPWR(VPWR),
    .X(net49));
 sky130_fd_sc_hd__dlygate4sd3_1 hold50 (.A(\u_dma.spi_miso ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net50));
 sky130_fd_sc_hd__dlygate4sd3_1 hold51 (.A(\u_dma.u_irq.status_empty ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net51));
 sky130_fd_sc_hd__dlygate4sd3_1 hold52 (.A(\u_dma.u_csr.rx_data[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net52));
 sky130_fd_sc_hd__dlygate4sd3_1 hold53 (.A(_055_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net53));
 sky130_fd_sc_hd__dlygate4sd3_1 hold54 (.A(\u_dma.csr_baseaddr[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net54));
 sky130_fd_sc_hd__dlygate4sd3_1 hold55 (.A(\u_dma.u_csr.tx_byte[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net55));
 sky130_fd_sc_hd__dlygate4sd3_1 hold56 (.A(\u_dma.csr_baseaddr[15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net56));
 sky130_fd_sc_hd__dlygate4sd3_1 hold57 (.A(\u_dma.u_csr.rx_data[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net57));
 sky130_fd_sc_hd__dlygate4sd3_1 hold58 (.A(_053_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net58));
 sky130_fd_sc_hd__dlygate4sd3_1 hold59 (.A(\u_dma.u_csr.tx_byte[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net59));
 sky130_fd_sc_hd__dlygate4sd3_1 hold60 (.A(\u_dma.csr_baseaddr[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net60));
 sky130_fd_sc_hd__dlygate4sd3_1 hold61 (.A(\u_dma.csr_baseaddr[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net61));
 sky130_fd_sc_hd__dlygate4sd3_1 hold62 (.A(\u_dma.u_csr.rx_data[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net62));
 sky130_fd_sc_hd__dlygate4sd3_1 hold63 (.A(_049_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net63));
 sky130_fd_sc_hd__dlygate4sd3_1 hold64 (.A(\u_dma.u_csr.is_read ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold65 (.A(_040_),
    ...
    .VPWR(VPWR),
    .X(net65));
 sky130_fd_sc_hd__dlygate4sd3_1 hold66 (.A(\u_dma.u_csr.rx_data[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net66));
 sky130_fd_sc_hd__dlygate4sd3_1 hold67 (.A(_050_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net67));
 sky130_fd_sc_hd__dlygate4sd3_1 hold68 (.A(\u_dma.u_csr.tx_byte[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net68));
 sky130_fd_sc_hd__dlygate4sd3_1 hold69 (.A(\u_dma.u_csr.tx_byte[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net69));
 sky130_fd_sc_hd__dlygate4sd3_1 hold70 (.A(\u_dma.csr_baseaddr[12] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net70));
 sky130_fd_sc_hd__dlygate4sd3_1 hold71 (.A(\u_dma.u_csr.rx_data[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net71));
 sky130_fd_sc_hd__dlygate4sd3_1 hold72 (.A(_052_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net72));
 sky130_fd_sc_hd__dlygate4sd3_1 hold73 (.A(\u_dma.u_csr.tx_byte[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net73));
 sky130_fd_sc_hd__dlygate4sd3_1 hold74 (.A(\u_dma.u_csr.tx_byte[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net74));
 sky130_fd_sc_hd__dlygate4sd3_1 hold75 (.A(\u_dma.csr_baseaddr[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net75));
 sky130_fd_sc_hd__dlygate4sd3_1 hold76 (.A(\u_dma.csr_baseaddr[14] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net76));
 sky130_fd_sc_hd__dlygate4sd3_1 hold77 (.A(\u_dma.u_movement.dm_in_wr_en ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net77));
 sky130_fd_sc_hd__dlygate4sd3_1 hold78 (.A(_219_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net78));
 sky130_fd_sc_hd__dlygate4sd3_1 hold79 (.A(\u_dma.csr_baseaddr[13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net79));
 sky130_fd_sc_hd__dlygate4sd3_1 hold80 (.A(\u_dma.csr_enable ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net80));
 sky130_fd_sc_hd__dlygate4sd3_1 hold81 (.A(\u_dma.csr_irq_en ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net81));
 sky130_fd_sc_hd__dlygate4sd3_1 hold82 (.A(\u_dma.u_movement.u_desc_to_dm_fifo.wr_addr[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net82));
 sky130_fd_sc_hd__dlygate4sd3_1 hold83 (.A(\u_dma.u_movement.u_desc_to_dm_fifo.rd_addr[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net83));
 sky130_fd_sc_hd__dlygate4sd3_1 hold84 (.A(\u_dma.csr_baseaddr[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net84));
 sky130_fd_sc_hd__dlygate4sd3_1 hold85 (.A(\u_dma.dm_done ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net85));
 sky130_fd_sc_hd__dlygate4sd3_1 hold86 (.A(_069_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net86));
 sky130_fd_sc_hd__dlygate4sd3_1 hold87 (.A(\u_dma.probe_df_in_wr_en ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net87));
 sky130_fd_sc_hd__dlygate4sd3_1 hold88 (.A(_057_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net88));
 sky130_fd_sc_hd__dlygate4sd3_1 hold89 (.A(\u_dma.csr_baseaddr[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net89));
 sky130_fd_sc_hd__dlygate4sd3_1 hold90 (.A(\u_dma.u_csr.mosi_r[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net90));
 sky130_fd_sc_hd__dlygate4sd3_1 hold91 (.A(\u_dma.u_csr.rx_byte[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold92 (.A(_027_),
    ...
    .VPWR(VPWR),
    .X(net92));
 sky130_fd_sc_hd__dlygate4sd3_1 hold93 (.A(\u_dma.u_csr.rx_byte[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net93));
 sky130_fd_sc_hd__dlygate4sd3_1 hold94 (.A(_031_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net94));
 sky130_fd_sc_hd__dlygate4sd3_1 hold95 (.A(\u_dma.u_csr.rx_data[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net95));
 sky130_fd_sc_hd__dlygate4sd3_1 hold96 (.A(\u_dma.u_csr.bit_cnt[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net96));
 sky130_fd_sc_hd__dlygate4sd3_1 hold97 (.A(\u_dma.u_csr.rx_byte[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net97));
 sky130_fd_sc_hd__dlygate4sd3_1 hold98 (.A(\u_dma.u_csr.rx_byte[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net98));
 sky130_fd_sc_hd__dlygate4sd3_1 hold99 (.A(_029_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 load_slew24 (.A(net23),
    ...
    .VPWR(VPWR),
    .X(net24));
 sky130_fd_sc_hd__clkbuf_2 load_slew28 (.A(net27),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_4 load_slew30 (.A(net29),
    ...
    .VPWR(VPWR),
    .X(net30));
 sky130_fd_sc_hd__clkbuf_2 max_cap9 (.A(_178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__conb_1 tt_um_youweiterrylu (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net));
 sky130_fd_sc_hd__conb_1 tt_um_youweiterrylu_32 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net32));
 sky130_fd_sc_hd__conb_1 tt_um_youweiterrylu_33 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net33));
 sky130_fd_sc_hd__conb_1 tt_um_youweiterrylu_34 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net34));
 sky130_fd_sc_hd__conb_1 tt_um_youweiterrylu_35 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net35));
 sky130_fd_sc_hd__conb_1 tt_um_youweiterrylu_36 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net36));
 sky130_fd_sc_hd__conb_1 tt_um_youweiterrylu_37 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net37));
 sky130_fd_sc_hd__conb_1 tt_um_youweiterrylu_38 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net38));
 sky130_fd_sc_hd__clkbuf_2 wire10 (.A(_174_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net10));
 sky130_fd_sc_hd__buf_1 wire13 (.A(_140_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
