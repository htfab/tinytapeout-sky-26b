module tt_um_jasonbrave_terre (clk,
    ena,
    rst_n,
    VPWR,
    VGND,
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_137 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _0538_ (.A(\color_index[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0063_));
 sky130_fd_sc_hd__inv_2 _0539_ (.A(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0064_));
 sky130_fd_sc_hd__inv_2 _0540_ (.A(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0065_));
 sky130_fd_sc_hd__inv_2 _0541_ (.A(\logo_top[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0066_));
 sky130_fd_sc_hd__inv_2 _0542_ (.A(\logo_top[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0067_));
 sky130_fd_sc_hd__inv_2 _0543_ (.A(\logo_top[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0068_));
 sky130_fd_sc_hd__inv_2 _0544_ (.A(\logo_left[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0069_));
 sky130_fd_sc_hd__inv_2 _0545_ (.A(\logo_left[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0070_));
 sky130_fd_sc_hd__inv_2 _0546_ (.A(\logo_left[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0071_));
 sky130_fd_sc_hd__inv_2 _0547_ (.A(\logo_left[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0072_));
 sky130_fd_sc_hd__inv_2 _0548_ (.A(\logo_left[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0073_));
 sky130_fd_sc_hd__inv_2 _0549_ (.A(\logo_left[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0074_));
 sky130_fd_sc_hd__inv_2 _0550_ (.A(\pix_x[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0075_));
 sky130_fd_sc_hd__inv_2 _0551_ (.A(\pix_y[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0076_));
 sky130_fd_sc_hd__inv_2 _0552_ (.A(\pix_y[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0077_));
 sky130_fd_sc_hd__inv_2 _0553_ (.A(\pix_y[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0078_));
 sky130_fd_sc_hd__inv_2 _0554_ (.A(\pix_y[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0079_));
 sky130_fd_sc_hd__inv_2 _0555_ (.A(\pix_y[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0080_));
 sky130_fd_sc_hd__inv_2 _0556_ (.A(\pix_y[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0081_));
 sky130_fd_sc_hd__inv_2 _0557_ (.A(\pix_y[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0082_));
 sky130_fd_sc_hd__inv_2 _0558_ (.A(\prev_y[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0083_));
 sky130_fd_sc_hd__inv_2 _0559_ (.A(\prev_y[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0084_));
 sky130_fd_sc_hd__inv_2 _0560_ (.A(\prev_y[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0085_));
 sky130_fd_sc_hd__inv_2 _0561_ (.A(\prev_y[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0086_));
 sky130_fd_sc_hd__inv_2 _0562_ (.A(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0087_));
 sky130_fd_sc_hd__or4_2 _0563_ (.A(_0078_),
    .B(_0079_),
    .C(_0080_),
    .D(_0081_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0088_));
 sky130_fd_sc_hd__or4bb_2 _0564_ (.A(\pix_y[4] ),
    .B(\pix_y[9] ),
    .C_N(net27),
    .D_N(\pix_y[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0089_));
 sky130_fd_sc_hd__and2_2 _0565_ (.A(\pix_y[2] ),
    .B(\pix_y[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0090_));
 sky130_fd_sc_hd__or3_2 _0566_ (.A(_0088_),
    .B(_0089_),
    .C(_0090_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0001_));
 sky130_fd_sc_hd__and3_2 _0567_ (.A(\pix_x[4] ),
    .B(\pix_x[5] ),
    .C(\pix_x[6] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0091_));
 sky130_fd_sc_hd__o311a_2 _0568_ (.A1(\pix_x[4] ),
    .A2(\pix_x[5] ),
    .A3(\pix_x[6] ),
    .B1(\pix_x[7] ),
    .C1(\pix_x[9] ),
    ...
    .VPWR(VPWR),
    .X(_0092_));
 sky130_fd_sc_hd__or3b_2 _0569_ (.A(\pix_x[8] ),
    .B(_0091_),
    .C_N(_0092_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0000_));
 sky130_fd_sc_hd__and3_2 _0570_ (.A(\pix_x[0] ),
    .B(\pix_x[1] ),
    .C(\pix_x[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0093_));
 sky130_fd_sc_hd__and2_2 _0571_ (.A(\pix_x[3] ),
    .B(_0093_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0094_));
 sky130_fd_sc_hd__and3_2 _0572_ (.A(\pix_x[3] ),
    .B(\pix_x[4] ),
    .C(_0093_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0095_));
 sky130_fd_sc_hd__nor3_2 _0573_ (.A(\pix_x[5] ),
    .B(\pix_x[6] ),
    .C(\pix_x[7] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0096_));
 sky130_fd_sc_hd__and4_2 _0574_ (.A(\pix_x[8] ),
    .B(\pix_x[9] ),
    .C(_0095_),
    .D(_0096_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0097_));
 sky130_fd_sc_hd__or4_2 _0575_ (.A(\pix_y[4] ),
    .B(\pix_y[5] ),
    .C(\pix_y[6] ),
    .D(\pix_y[7] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0098_));
 sky130_fd_sc_hd__or2_2 _0576_ (.A(net28),
    .B(net27),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0099_));
 sky130_fd_sc_hd__or2_2 _0577_ (.A(\pix_y[8] ),
    .B(_0099_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0100_));
 sky130_fd_sc_hd__nand2_2 _0578_ (.A(\pix_y[9] ),
    .B(_0090_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0101_));
 sky130_fd_sc_hd__or3_2 _0579_ (.A(_0098_),
    .B(_0100_),
    .C(_0101_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0102_));
 sky130_fd_sc_hd__and3_2 _0580_ (.A(net34),
    .B(_0097_),
    .C(_0102_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0103_));
 sky130_fd_sc_hd__a21oi_2 _0581_ (.A1(net28),
    .A2(net34),
    .B1(_0103_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0104_));
 sky130_fd_sc_hd__a21oi_2 _0582_ (.A1(net28),
    .A2(_0097_),
    .B1(_0104_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0002_));
 sky130_fd_sc_hd__and2b_2 _0583_ (.A_N(_0097_),
    .B(net29),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0105_));
 sky130_fd_sc_hd__nand2_2 _0584_ (.A(net28),
    .B(net27),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0106_));
 sky130_fd_sc_hd__and3_2 _0585_ (.A(_0099_),
    .B(_0103_),
    .C(_0106_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0107_));
 sky130_fd_sc_hd__a21o_2 _0586_ (.A1(net27),
    .A2(net19),
    .B1(_0107_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0003_));
 sky130_fd_sc_hd__xnor2_2 _0587_ (.A(\pix_y[2] ),
    .B(_0106_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0108_));
 sky130_fd_sc_hd__a22o_2 _0588_ (.A1(\pix_y[2] ),
    .A2(net19),
    .B1(_0108_),
    .B2(_0103_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0004_));
 sky130_fd_sc_hd__a31o_2 _0589_ (.A1(net28),
    .A2(net27),
    .A3(\pix_y[2] ),
    .B1(\pix_y[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0109_));
 sky130_fd_sc_hd__and3_2 _0590_ (.A(net28),
    .B(net27),
    .C(_0090_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0110_));
 sky130_fd_sc_hd__and3b_2 _0591_ (.A_N(_0110_),
    .B(_0103_),
    .C(_0109_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0111_));
 sky130_fd_sc_hd__a21o_2 _0592_ (.A1(\pix_y[3] ),
    .A2(net19),
    .B1(_0111_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0005_));
 sky130_fd_sc_hd__xnor2_2 _0593_ (.A(_0077_),
    .B(_0110_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0112_));
 sky130_fd_sc_hd__a22o_2 _0594_ (.A1(net74),
    .A2(net20),
    .B1(_0112_),
    .B2(_0103_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0006_));
 sky130_fd_sc_hd__a21oi_2 _0595_ (.A1(\pix_y[4] ),
    .A2(_0110_),
    .B1(\pix_y[5] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0113_));
 sky130_fd_sc_hd__and3_2 _0596_ (.A(\pix_y[4] ),
    .B(\pix_y[5] ),
    .C(_0110_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0114_));
 sky130_fd_sc_hd__nor2_2 _0597_ (.A(_0113_),
    .B(_0114_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0115_));
 sky130_fd_sc_hd__a22o_2 _0598_ (.A1(net77),
    .A2(net20),
    .B1(_0115_),
    .B2(_0103_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0007_));
 sky130_fd_sc_hd__or2_2 _0599_ (.A(\pix_y[6] ),
    .B(_0114_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0116_));
 sky130_fd_sc_hd__and2_2 _0600_ (.A(\pix_y[6] ),
    .B(_0114_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0117_));
 sky130_fd_sc_hd__and3b_2 _0601_ (.A_N(_0117_),
    .B(_0103_),
    .C(_0116_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0118_));
 sky130_fd_sc_hd__a21o_2 _0602_ (.A1(\pix_y[6] ),
    .A2(net20),
    .B1(_0118_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0008_));
 sky130_fd_sc_hd__or3b_2 _0603_ (.A(_0079_),
    .B(_0080_),
    .C_N(_0114_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0119_));
 sky130_fd_sc_hd__o211a_2 _0604_ (.A1(\pix_y[7] ),
    .A2(_0117_),
    .B1(_0119_),
    .C1(_0103_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0120_));
 sky130_fd_sc_hd__a21o_2 _0605_ (.A1(\pix_y[7] ),
    .A2(net20),
    .B1(_0120_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0009_));
 sky130_fd_sc_hd__or2_2 _0606_ (.A(_0081_),
    .B(_0119_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0121_));
 sky130_fd_sc_hd__a31o_2 _0607_ (.A1(net34),
    .A2(_0102_),
    .A3(_0121_),
    .B1(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0122_));
 sky130_fd_sc_hd__a41o_2 _0608_ (.A1(\pix_y[6] ),
    .A2(\pix_y[7] ),
    .A3(_0103_),
    .A4(_0114_),
    .B1(\pix_y[8] ),
    ...
    .VPWR(VPWR),
    .X(_0123_));
 sky130_fd_sc_hd__and2_2 _0609_ (.A(_0122_),
    .B(_0123_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0010_));
 sky130_fd_sc_hd__or3b_2 _0610_ (.A(_0121_),
    .B(\pix_y[9] ),
    .C_N(_0103_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0124_));
 sky130_fd_sc_hd__a21bo_2 _0611_ (.A1(\pix_y[9] ),
    .A2(_0122_),
    .B1_N(_0124_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0011_));
 sky130_fd_sc_hd__and2b_2 _0612_ (.A_N(\pix_x[0] ),
    .B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0012_));
 sky130_fd_sc_hd__o21ai_2 _0613_ (.A1(net65),
    .A2(\pix_x[1] ),
    .B1(net19),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0125_));
 sky130_fd_sc_hd__a21oi_2 _0614_ (.A1(net65),
    .A2(\pix_x[1] ),
    .B1(_0125_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0013_));
 sky130_fd_sc_hd__a21o_2 _0615_ (.A1(\pix_x[0] ),
    .A2(\pix_x[1] ),
    .B1(\pix_x[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0126_));
 sky130_fd_sc_hd__and3b_2 _0616_ (.A_N(_0093_),
    .B(_0126_),
    .C(net29),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0014_));
 sky130_fd_sc_hd__o21ai_2 _0617_ (.A1(net68),
    .A2(_0093_),
    .B1(net29),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0127_));
 sky130_fd_sc_hd__nor2_2 _0618_ (.A(_0094_),
    .B(_0127_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0015_));
 sky130_fd_sc_hd__o21ai_2 _0619_ (.A1(net71),
    .A2(_0094_),
    .B1(net29),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0128_));
 sky130_fd_sc_hd__nor2_2 _0620_ (.A(_0095_),
    .B(_0128_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0016_));
 sky130_fd_sc_hd__o21ai_2 _0621_ (.A1(\pix_x[5] ),
    .A2(_0095_),
    .B1(net19),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0129_));
 sky130_fd_sc_hd__a21oi_2 _0622_ (.A1(net73),
    .A2(_0095_),
    .B1(_0129_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0017_));
 sky130_fd_sc_hd__a21o_2 _0623_ (.A1(\pix_x[5] ),
    .A2(_0095_),
    .B1(\pix_x[6] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0130_));
 sky130_fd_sc_hd__and3_2 _0624_ (.A(\pix_x[5] ),
    .B(\pix_x[6] ),
    .C(_0095_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0131_));
 sky130_fd_sc_hd__and3b_2 _0625_ (.A_N(_0131_),
    .B(net19),
    .C(_0130_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0018_));
 sky130_fd_sc_hd__or2_2 _0626_ (.A(\pix_x[7] ),
    .B(_0131_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0132_));
 sky130_fd_sc_hd__and3_2 _0627_ (.A(\pix_x[7] ),
    .B(_0091_),
    .C(_0094_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0133_));
 sky130_fd_sc_hd__and3b_2 _0628_ (.A_N(_0133_),
    .B(net19),
    .C(_0132_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0019_));
 sky130_fd_sc_hd__and2_2 _0629_ (.A(\pix_x[8] ),
    .B(_0133_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0134_));
 sky130_fd_sc_hd__o21ai_2 _0630_ (.A1(\pix_x[8] ),
    .A2(_0133_),
    .B1(net19),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0135_));
 sky130_fd_sc_hd__nor2_2 _0631_ (.A(_0134_),
    .B(_0135_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0020_));
 sky130_fd_sc_hd__o21ai_2 _0632_ (.A1(\pix_x[9] ),
    .A2(_0134_),
    .B1(net19),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0136_));
 sky130_fd_sc_hd__a21oi_2 _0633_ (.A1(net69),
    .A2(_0134_),
    .B1(_0136_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0021_));
 sky130_fd_sc_hd__mux2_1 _0634_ (.A0(net53),
    .A1(net28),
    .S(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0022_));
 sky130_fd_sc_hd__mux2_1 _0635_ (.A0(net51),
    .A1(net27),
    .S(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0023_));
 sky130_fd_sc_hd__mux2_1 _0636_ (.A0(net54),
    .A1(\pix_y[2] ),
    .S(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0024_));
 sky130_fd_sc_hd__mux2_1 _0637_ (.A0(net61),
    .A1(\pix_y[3] ),
    .S(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0025_));
 sky130_fd_sc_hd__mux2_1 _0638_ (.A0(net56),
    .A1(\pix_y[4] ),
    .S(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0026_));
 sky130_fd_sc_hd__mux2_1 _0639_ (.A0(net62),
    .A1(\pix_y[5] ),
    .S(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0027_));
 sky130_fd_sc_hd__mux2_1 _0640_ (.A0(net60),
    .A1(\pix_y[6] ),
    .S(net35),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _0642_ (.A0(net58),
    ...
    .VPWR(VPWR),
    .X(_0030_));
 sky130_fd_sc_hd__mux2_1 _0643_ (.A0(net55),
    .A1(\pix_y[9] ),
    .S(net34),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0031_));
 sky130_fd_sc_hd__a2bb2o_2 _0644_ (.A1_N(\prev_y[7] ),
    .A2_N(_0080_),
    .B1(net27),
    .B2(_0084_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0137_));
 sky130_fd_sc_hd__xor2_2 _0645_ (.A(\pix_y[3] ),
    .B(\prev_y[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0138_));
 sky130_fd_sc_hd__a221o_2 _0646_ (.A1(\pix_y[5] ),
    .A2(_0085_),
    .B1(\prev_y[6] ),
    .B2(_0079_),
    .C1(_0138_),
    ...
    .VPWR(VPWR),
    .X(_0139_));
 sky130_fd_sc_hd__a2bb2o_2 _0647_ (.A1_N(_0076_),
    .A2_N(\prev_y[2] ),
    .B1(\prev_y[7] ),
    .B2(_0080_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0140_));
 sky130_fd_sc_hd__o22ai_2 _0648_ (.A1(_0077_),
    .A2(\prev_y[4] ),
    .B1(\prev_y[6] ),
    .B2(_0079_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0141_));
 sky130_fd_sc_hd__a22o_2 _0649_ (.A1(_0078_),
    .A2(\prev_y[5] ),
    .B1(\prev_y[9] ),
    .B2(_0082_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0142_));
 sky130_fd_sc_hd__o22ai_2 _0650_ (.A1(net28),
    .A2(_0083_),
    .B1(_0084_),
    .B2(\pix_y[1] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0143_));
 sky130_fd_sc_hd__a221o_2 _0651_ (.A1(_0076_),
    .A2(\prev_y[2] ),
    .B1(\prev_y[8] ),
    .B2(_0081_),
    .C1(_0142_),
    ...
    .VPWR(VPWR),
    .X(_0144_));
 sky130_fd_sc_hd__a2bb2o_2 _0652_ (.A1_N(_0082_),
    .A2_N(\prev_y[9] ),
    .B1(\prev_y[4] ),
    .B2(_0077_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0145_));
 sky130_fd_sc_hd__or4_2 _0653_ (.A(_0140_),
    .B(_0143_),
    .C(_0144_),
    .D(_0145_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0146_));
 sky130_fd_sc_hd__a221o_2 _0654_ (.A1(net28),
    .A2(_0083_),
    .B1(_0086_),
    .B2(\pix_y[8] ),
    .C1(_0146_),
    ...
    .VPWR(VPWR),
    .X(_0147_));
 sky130_fd_sc_hd__or4_2 _0655_ (.A(_0137_),
    .B(_0139_),
    .C(_0141_),
    .D(_0147_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0148_));
 sky130_fd_sc_hd__and4bb_2 _0656_ (.A_N(\pix_y[3] ),
    .B_N(_0100_),
    .C(_0082_),
    .D(_0076_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0149_));
 sky130_fd_sc_hd__and3b_2 _0657_ (.A_N(_0098_),
    .B(_0148_),
    .C(_0149_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0150_));
 sky130_fd_sc_hd__and3b_2 _0658_ (.A_N(_0098_),
    .B(_0148_),
    .C(_0149_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0151_));
 sky130_fd_sc_hd__o21ai_2 _0659_ (.A1(\logo_left[0] ),
    .A2(net5),
    .B1(net29),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0152_));
 sky130_fd_sc_hd__a21oi_2 _0660_ (.A1(net72),
    .A2(net5),
    .B1(_0152_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0032_));
 sky130_fd_sc_hd__and2b_2 _0661_ (.A_N(net26),
    .B(\logo_left[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0153_));
 sky130_fd_sc_hd__and2b_2 _0662_ (.A_N(\logo_left[1] ),
    .B(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0154_));
 sky130_fd_sc_hd__nor2_2 _0663_ (.A(_0153_),
    .B(_0154_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0155_));
 sky130_fd_sc_hd__xnor2_2 _0664_ (.A(\logo_left[0] ),
    .B(_0155_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0156_));
 sky130_fd_sc_hd__nand2_2 _0665_ (.A(net4),
    .B(_0156_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0157_));
 sky130_fd_sc_hd__o211a_2 _0666_ (.A1(\logo_left[1] ),
    .A2(net4),
    .B1(_0157_),
    .C1(net30),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0033_));
 sky130_fd_sc_hd__xor2_2 _0667_ (.A(net26),
    .B(\logo_left[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0158_));
 sky130_fd_sc_hd__a21oi_2 _0668_ (.A1(\logo_left[0] ),
    .A2(_0155_),
    .B1(_0153_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0159_));
 sky130_fd_sc_hd__nor2_2 _0669_ (.A(_0158_),
    .B(_0159_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0160_));
 sky130_fd_sc_hd__xnor2_2 _0670_ (.A(_0158_),
    .B(_0159_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0161_));
 sky130_fd_sc_hd__nand2_2 _0671_ (.A(net4),
    .B(_0161_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0162_));
 sky130_fd_sc_hd__o211a_2 _0672_ (.A1(\logo_left[2] ),
    .A2(net4),
    .B1(_0162_),
    .C1(net30),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0034_));
 sky130_fd_sc_hd__o21ai_2 _0673_ (.A1(_0073_),
    .A2(net4),
    .B1(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0163_));
 sky130_fd_sc_hd__a21oi_2 _0674_ (.A1(_0065_),
    .A2(\logo_left[2] ),
    .B1(_0160_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0164_));
 sky130_fd_sc_hd__nand2_2 _0675_ (.A(_0065_),
    .B(\logo_left[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0165_));
 sky130_fd_sc_hd__xnor2_2 _0676_ (.A(net26),
    .B(\logo_left[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0166_));
 sky130_fd_sc_hd__xnor2_2 _0677_ (.A(_0164_),
    .B(_0166_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0167_));
 sky130_fd_sc_hd__a21o_2 _0678_ (.A1(net4),
    .A2(_0167_),
    .B1(_0163_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0035_));
 sky130_fd_sc_hd__and2_2 _0679_ (.A(_0065_),
    .B(\logo_left[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0168_));
 sky130_fd_sc_hd__nor2_2 _0680_ (.A(_0065_),
    .B(\logo_left[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0169_));
 sky130_fd_sc_hd__a21o_2 _0681_ (.A1(net26),
    .A2(_0073_),
    .B1(_0164_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0170_));
 sky130_fd_sc_hd__a211oi_2 _0682_ (.A1(_0165_),
    .A2(_0170_),
    .B1(_0169_),
    .C1(_0168_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0171_));
 sky130_fd_sc_hd__o211a_2 _0683_ (.A1(_0168_),
    .A2(_0169_),
    .B1(_0170_),
    .C1(_0165_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0172_));
 sky130_fd_sc_hd__o21ai_2 _0684_ (.A1(_0171_),
    .A2(_0172_),
    .B1(net4),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0173_));
 sky130_fd_sc_hd__o211a_2 _0685_ (.A1(\logo_left[4] ),
    .A2(net4),
    .B1(_0173_),
    .C1(net31),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0036_));
 sky130_fd_sc_hd__xnor2_2 _0686_ (.A(net26),
    .B(\logo_left[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0174_));
 sky130_fd_sc_hd__or2_2 _0687_ (.A(_0168_),
    .B(_0171_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0175_));
 sky130_fd_sc_hd__xnor2_2 _0688_ (.A(_0174_),
    .B(_0175_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0176_));
 sky130_fd_sc_hd__nand2_2 _0689_ (.A(_0151_),
    .B(_0176_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0177_));
 sky130_fd_sc_hd__o211a_2 _0690_ (.A1(\logo_left[5] ),
    .A2(net4),
    .B1(_0177_),
    .C1(net31),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0037_));
 sky130_fd_sc_hd__xor2_2 _0691_ (.A(net26),
    .B(\logo_left[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0178_));
 sky130_fd_sc_hd__inv_2 _0692_ (.A(_0178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0179_));
 sky130_fd_sc_hd__and2_2 _0693_ (.A(_0171_),
    .B(_0174_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0180_));
 sky130_fd_sc_hd__o21a_2 _0694_ (.A1(\logo_left[5] ),
    .A2(\logo_left[4] ),
    .B1(_0065_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0181_));
 sky130_fd_sc_hd__or3_2 _0695_ (.A(_0179_),
    .B(_0180_),
    .C(_0181_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0182_));
 sky130_fd_sc_hd__o21a_2 _0696_ (.A1(_0180_),
    .A2(_0181_),
    .B1(_0179_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0183_));
 sky130_fd_sc_hd__inv_2 _0697_ (.A(_0183_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0184_));
 sky130_fd_sc_hd__o21ai_2 _0698_ (.A1(_0071_),
    .A2(net4),
    .B1(net30),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0185_));
 sky130_fd_sc_hd__a31o_2 _0699_ (.A1(net5),
    .A2(_0182_),
    .A3(_0184_),
    .B1(_0185_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0038_));
 sky130_fd_sc_hd__o21ai_2 _0700_ (.A1(_0070_),
    .A2(net5),
    .B1(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0186_));
 sky130_fd_sc_hd__xnor2_2 _0701_ (.A(net26),
    .B(\logo_left[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0187_));
 sky130_fd_sc_hd__a21oi_2 _0702_ (.A1(_0065_),
    .A2(\logo_left[6] ),
    .B1(_0183_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0188_));
 sky130_fd_sc_hd__xnor2_2 _0703_ (.A(_0187_),
    .B(_0188_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0189_));
 sky130_fd_sc_hd__a21o_2 _0704_ (.A1(net5),
    .A2(_0189_),
    .B1(_0186_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0039_));
 sky130_fd_sc_hd__o41a_2 _0705_ (.A1(\logo_left[7] ),
    .A2(\logo_left[6] ),
    .A3(\logo_left[5] ),
    .A4(\logo_left[4] ),
    .B1(_0065_),
    ...
    .VPWR(VPWR),
    .X(_0190_));
 sky130_fd_sc_hd__a31o_2 _0706_ (.A1(_0179_),
    .A2(_0180_),
    .A3(_0187_),
    .B1(_0190_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0191_));
 sky130_fd_sc_hd__xnor2_2 _0707_ (.A(net26),
    .B(\logo_left[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0192_));
 sky130_fd_sc_hd__xnor2_2 _0708_ (.A(_0191_),
    .B(_0192_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0193_));
 sky130_fd_sc_hd__nand2_2 _0709_ (.A(_0151_),
    .B(_0193_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0194_));
 sky130_fd_sc_hd__o211a_2 _0710_ (.A1(\logo_left[8] ),
    .A2(net5),
    .B1(_0194_),
    .C1(net31),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0040_));
 sky130_fd_sc_hd__mux2_1 _0711_ (.A0(_0065_),
    .A1(\logo_left[8] ),
    .S(_0191_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0195_));
 sky130_fd_sc_hd__o211a_2 _0712_ (.A1(dir_x),
    .A2(_0069_),
    .B1(_0151_),
    .C1(_0195_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0196_));
 sky130_fd_sc_hd__o21a_2 _0713_ (.A1(\logo_left[9] ),
    .A2(_0196_),
    .B1(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0197_));
 sky130_fd_sc_hd__a21boi_2 _0714_ (.A1(net64),
    .A2(_0196_),
    .B1_N(_0197_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0041_));
 sky130_fd_sc_hd__or2_2 _0715_ (.A(\logo_top[0] ),
    .B(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0198_));
 sky130_fd_sc_hd__nand2_2 _0716_ (.A(\logo_top[0] ),
    .B(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0199_));
 sky130_fd_sc_hd__and3_2 _0717_ (.A(net29),
    .B(_0198_),
    .C(_0199_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0042_));
 sky130_fd_sc_hd__and2_2 _0718_ (.A(_0064_),
    .B(\logo_top[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0200_));
 sky130_fd_sc_hd__nor2_2 _0719_ (.A(_0064_),
    .B(\logo_top[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0201_));
 sky130_fd_sc_hd__nor2_2 _0720_ (.A(_0200_),
    .B(_0201_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0202_));
 sky130_fd_sc_hd__xnor2_2 _0721_ (.A(\logo_top[0] ),
    .B(_0202_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0203_));
 sky130_fd_sc_hd__nand2_2 _0722_ (.A(net6),
    .B(_0203_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0204_));
 sky130_fd_sc_hd__o211a_2 _0723_ (.A1(\logo_top[1] ),
    .A2(net6),
    .B1(_0204_),
    .C1(net32),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0043_));
 sky130_fd_sc_hd__or2_2 _0724_ (.A(_0064_),
    .B(\logo_top[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0205_));
 sky130_fd_sc_hd__nand2_2 _0725_ (.A(_0064_),
    .B(\logo_top[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0206_));
 sky130_fd_sc_hd__nand2_2 _0726_ (.A(_0205_),
    .B(_0206_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0207_));
 sky130_fd_sc_hd__a21oi_2 _0727_ (.A1(\logo_top[0] ),
    .A2(_0202_),
    .B1(_0200_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0208_));
 sky130_fd_sc_hd__xnor2_2 _0728_ (.A(_0207_),
    .B(_0208_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0209_));
 sky130_fd_sc_hd__nand2_2 _0729_ (.A(net6),
    .B(_0209_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0210_));
 sky130_fd_sc_hd__o211a_2 _0730_ (.A1(\logo_top[2] ),
    .A2(_0150_),
    .B1(_0210_),
    .C1(net32),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0044_));
 sky130_fd_sc_hd__nand2_2 _0731_ (.A(net25),
    .B(_0208_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0211_));
 sky130_fd_sc_hd__o2111ai_2 _0732_ (.A1(\logo_top[2] ),
    .A2(_0208_),
    .B1(_0211_),
    .C1(_0150_),
    .D1(_0206_),
    ...
    .VPWR(VPWR),
    .Y(_0212_));
 sky130_fd_sc_hd__a21boi_2 _0733_ (.A1(net70),
    .A2(_0212_),
    .B1_N(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0213_));
 sky130_fd_sc_hd__nor2_2 _0734_ (.A(_0064_),
    .B(\logo_top[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0214_));
 sky130_fd_sc_hd__o21ai_2 _0735_ (.A1(net70),
    .A2(_0212_),
    .B1(_0213_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0045_));
 sky130_fd_sc_hd__nand2_2 _0736_ (.A(dir_y),
    .B(_0068_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0215_));
 sky130_fd_sc_hd__nand2_2 _0737_ (.A(_0064_),
    .B(\logo_top[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0216_));
 sky130_fd_sc_hd__nand2_2 _0738_ (.A(_0215_),
    .B(_0216_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0217_));
 sky130_fd_sc_hd__nor2_2 _0739_ (.A(\logo_top[3] ),
    .B(\logo_top[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0218_));
 sky130_fd_sc_hd__o32ai_2 _0740_ (.A1(_0207_),
    .A2(_0208_),
    .A3(_0214_),
    .B1(_0218_),
    .B2(dir_y),
    ...
    .VPWR(VPWR),
    .Y(_0219_));
 sky130_fd_sc_hd__nand2b_2 _0741_ (.A_N(_0217_),
    .B(_0219_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0220_));
 sky130_fd_sc_hd__xnor2_2 _0742_ (.A(_0217_),
    .B(_0219_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0221_));
 sky130_fd_sc_hd__mux2_1 _0743_ (.A0(\logo_top[4] ),
    .A1(_0221_),
    .S(_0151_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0222_));
 sky130_fd_sc_hd__and2_2 _0744_ (.A(net32),
    .B(_0222_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0046_));
 sky130_fd_sc_hd__xor2_2 _0745_ (.A(net25),
    .B(\logo_top[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0223_));
 sky130_fd_sc_hd__nand2_2 _0746_ (.A(_0216_),
    .B(_0220_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0224_));
 sky130_fd_sc_hd__xor2_2 _0747_ (.A(_0223_),
    .B(_0224_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0225_));
 sky130_fd_sc_hd__nand2_2 _0748_ (.A(_0151_),
    .B(_0225_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0226_));
 sky130_fd_sc_hd__o211a_2 _0749_ (.A1(\logo_top[5] ),
    .A2(net6),
    .B1(_0226_),
    .C1(net34),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0047_));
 sky130_fd_sc_hd__xnor2_2 _0750_ (.A(net25),
    .B(\logo_top[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0227_));
 sky130_fd_sc_hd__nor2_2 _0751_ (.A(_0220_),
    .B(_0223_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0228_));
 sky130_fd_sc_hd__o21a_2 _0752_ (.A1(\logo_top[5] ),
    .A2(\logo_top[4] ),
    .B1(_0064_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0229_));
 sky130_fd_sc_hd__or2_2 _0753_ (.A(_0228_),
    .B(_0229_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0230_));
 sky130_fd_sc_hd__or2_2 _0754_ (.A(_0227_),
    .B(_0230_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0231_));
 sky130_fd_sc_hd__nand2_2 _0755_ (.A(_0227_),
    .B(_0230_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0232_));
 sky130_fd_sc_hd__o21ai_2 _0756_ (.A1(_0067_),
    .A2(net6),
    .B1(net34),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0233_));
 sky130_fd_sc_hd__a31o_2 _0757_ (.A1(net6),
    .A2(_0231_),
    .A3(_0232_),
    .B1(_0233_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0048_));
 sky130_fd_sc_hd__xnor2_2 _0758_ (.A(net25),
    .B(\logo_top[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0234_));
 sky130_fd_sc_hd__o21ai_2 _0759_ (.A1(net25),
    .A2(_0067_),
    .B1(_0232_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0235_));
 sky130_fd_sc_hd__o21ai_2 _0760_ (.A1(_0234_),
    .A2(_0235_),
    .B1(net6),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0236_));
 sky130_fd_sc_hd__a21o_2 _0761_ (.A1(_0234_),
    .A2(_0235_),
    .B1(_0236_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0237_));
 sky130_fd_sc_hd__o211ai_2 _0762_ (.A1(_0066_),
    .A2(net6),
    .B1(_0237_),
    .C1(net34),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0049_));
 sky130_fd_sc_hd__o41a_2 _0763_ (.A1(\logo_top[7] ),
    .A2(\logo_top[6] ),
    .A3(\logo_top[5] ),
    .A4(\logo_top[4] ),
    .B1(_0064_),
    ...
    .VPWR(VPWR),
    .X(_0238_));
 sky130_fd_sc_hd__a31o_2 _0764_ (.A1(_0227_),
    .A2(_0228_),
    .A3(_0234_),
    .B1(_0238_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0239_));
 sky130_fd_sc_hd__nor2_2 _0765_ (.A(net25),
    .B(\logo_top[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0240_));
 sky130_fd_sc_hd__and2_2 _0766_ (.A(net25),
    .B(\logo_top[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0241_));
 sky130_fd_sc_hd__o21ai_2 _0767_ (.A1(_0240_),
    .A2(_0241_),
    .B1(_0239_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0242_));
 sky130_fd_sc_hd__or3_2 _0768_ (.A(_0239_),
    .B(_0240_),
    .C(_0241_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0243_));
 sky130_fd_sc_hd__a21bo_2 _0769_ (.A1(_0242_),
    .A2(_0243_),
    .B1_N(net5),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0244_));
 sky130_fd_sc_hd__o211a_2 _0770_ (.A1(net75),
    .A2(net5),
    .B1(_0244_),
    .C1(net29),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0050_));
 sky130_fd_sc_hd__mux2_1 _0771_ (.A0(_0240_),
    .A1(_0241_),
    .S(_0239_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0245_));
 sky130_fd_sc_hd__a21o_2 _0772_ (.A1(_0151_),
    .A2(_0245_),
    .B1(\logo_top[9] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0246_));
 sky130_fd_sc_hd__nand3_2 _0773_ (.A(\logo_top[9] ),
    .B(_0151_),
    .C(_0245_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0247_));
 sky130_fd_sc_hd__and3_2 _0774_ (.A(net34),
    .B(_0246_),
    .C(_0247_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0051_));
 sky130_fd_sc_hd__or4_2 _0775_ (.A(\logo_left[8] ),
    .B(\logo_left[7] ),
    .C(\logo_left[6] ),
    .D(\logo_left[5] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0248_));
 sky130_fd_sc_hd__or4_2 _0776_ (.A(\logo_left[3] ),
    .B(\logo_left[2] ),
    .C(\logo_left[1] ),
    .D(_0248_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0249_));
 sky130_fd_sc_hd__and3_2 _0777_ (.A(\logo_left[4] ),
    .B(\logo_left[3] ),
    .C(\logo_left[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0250_));
 sky130_fd_sc_hd__and4_2 _0778_ (.A(\logo_left[8] ),
    .B(\logo_left[7] ),
    .C(\logo_left[6] ),
    .D(\logo_left[5] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0251_));
 sky130_fd_sc_hd__a31o_2 _0779_ (.A1(\logo_left[1] ),
    .A2(_0250_),
    .A3(_0251_),
    .B1(_0065_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0252_));
 sky130_fd_sc_hd__a211oi_2 _0780_ (.A1(_0065_),
    .A2(_0249_),
    .B1(_0168_),
    .C1(\logo_left[9] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0253_));
 sky130_fd_sc_hd__and4_2 _0781_ (.A(\logo_left[0] ),
    .B(_0151_),
    .C(_0252_),
    .D(_0253_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0254_));
 sky130_fd_sc_hd__xnor2_2 _0782_ (.A(net67),
    .B(_0254_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0255_));
 sky130_fd_sc_hd__nand2_2 _0783_ (.A(net31),
    .B(_0255_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0052_));
 sky130_fd_sc_hd__or3_2 _0784_ (.A(\logo_top[9] ),
    .B(\logo_top[7] ),
    .C(\logo_top[5] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0256_));
 sky130_fd_sc_hd__and4_2 _0785_ (.A(\logo_top[6] ),
    .B(\logo_top[4] ),
    .C(\logo_top[3] ),
    .D(\logo_top[2] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0257_));
 sky130_fd_sc_hd__a21bo_2 _0786_ (.A1(_0241_),
    .A2(_0257_),
    .B1_N(\logo_top[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0258_));
 sky130_fd_sc_hd__a41o_2 _0787_ (.A1(_0067_),
    .A2(_0068_),
    .A3(_0218_),
    .A4(_0240_),
    .B1(\logo_top[1] ),
    ...
    .VPWR(VPWR),
    .X(_0259_));
 sky130_fd_sc_hd__and4bb_2 _0788_ (.A_N(_0199_),
    .B_N(_0256_),
    .C(_0258_),
    .D(_0259_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0260_));
 sky130_fd_sc_hd__o21ai_2 _0789_ (.A1(net25),
    .A2(_0260_),
    .B1(net29),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0261_));
 sky130_fd_sc_hd__a21oi_2 _0790_ (.A1(net25),
    .A2(_0260_),
    .B1(_0261_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0053_));
 sky130_fd_sc_hd__or3_2 _0791_ (.A(\color_index[0] ),
    .B(_0254_),
    .C(_0260_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0262_));
 sky130_fd_sc_hd__o21a_2 _0792_ (.A1(_0254_),
    .A2(_0260_),
    .B1(\color_index[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0263_));
 sky130_fd_sc_hd__and3b_2 _0793_ (.A_N(_0263_),
    .B(net29),
    .C(_0262_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0054_));
 sky130_fd_sc_hd__or2_2 _0794_ (.A(\color_index[1] ),
    .B(_0263_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0264_));
 sky130_fd_sc_hd__nand2_2 _0795_ (.A(\color_index[1] ),
    .B(_0263_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0265_));
 sky130_fd_sc_hd__and3_2 _0796_ (.A(net29),
    .B(_0264_),
    .C(_0265_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0055_));
 sky130_fd_sc_hd__a21o_2 _0797_ (.A1(\color_index[1] ),
    .A2(_0263_),
    .B1(\color_index[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0266_));
 sky130_fd_sc_hd__nand3_2 _0798_ (.A(\color_index[2] ),
    .B(\color_index[1] ),
    .C(_0263_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0267_));
 sky130_fd_sc_hd__and3_2 _0799_ (.A(net35),
    .B(_0266_),
    .C(_0267_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0056_));
 sky130_fd_sc_hd__nand2b_2 _0800_ (.A_N(\pix_x[0] ),
    .B(\logo_left[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0268_));
 sky130_fd_sc_hd__nand2b_2 _0801_ (.A_N(\logo_left[0] ),
    .B(\pix_x[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0269_));
 sky130_fd_sc_hd__and2_2 _0802_ (.A(_0268_),
    .B(_0269_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0270_));
 sky130_fd_sc_hd__nand2_2 _0803_ (.A(_0268_),
    .B(_0269_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0271_));
 sky130_fd_sc_hd__xnor2_2 _0804_ (.A(\logo_top[6] ),
    .B(\pix_y[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0272_));
 sky130_fd_sc_hd__and2_2 _0805_ (.A(\logo_top[5] ),
    .B(_0078_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0273_));
 sky130_fd_sc_hd__nand2_2 _0806_ (.A(\logo_top[5] ),
    .B(_0078_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0274_));
 sky130_fd_sc_hd__nor2_2 _0807_ (.A(\logo_top[5] ),
    .B(_0078_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0275_));
 sky130_fd_sc_hd__nor2_2 _0808_ (.A(\logo_top[4] ),
    .B(_0077_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0276_));
 sky130_fd_sc_hd__and2b_2 _0809_ (.A_N(\logo_top[3] ),
    .B(\pix_y[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0277_));
 sky130_fd_sc_hd__nand2b_2 _0810_ (.A_N(\pix_y[3] ),
    .B(\logo_top[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0278_));
 sky130_fd_sc_hd__nand2b_2 _0811_ (.A_N(_0277_),
    .B(_0278_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0279_));
 sky130_fd_sc_hd__and2b_2 _0812_ (.A_N(\logo_top[2] ),
    .B(\pix_y[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0280_));
 sky130_fd_sc_hd__and2b_2 _0813_ (.A_N(\logo_top[1] ),
    .B(net27),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0281_));
 sky130_fd_sc_hd__xnor2_2 _0814_ (.A(\logo_top[1] ),
    .B(net27),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0282_));
 sky130_fd_sc_hd__nand2b_2 _0815_ (.A_N(net28),
    .B(\logo_top[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0283_));
 sky130_fd_sc_hd__and2_2 _0816_ (.A(_0282_),
    .B(_0283_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0284_));
 sky130_fd_sc_hd__a21o_2 _0817_ (.A1(_0282_),
    .A2(_0283_),
    .B1(_0281_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0285_));
 sky130_fd_sc_hd__and2b_2 _0818_ (.A_N(\pix_y[2] ),
    .B(\logo_top[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0286_));
 sky130_fd_sc_hd__nor2_2 _0819_ (.A(_0280_),
    .B(_0286_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0287_));
 sky130_fd_sc_hd__a21o_2 _0820_ (.A1(_0285_),
    .A2(_0287_),
    .B1(_0280_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0288_));
 sky130_fd_sc_hd__a21o_2 _0821_ (.A1(_0278_),
    .A2(_0288_),
    .B1(_0277_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0289_));
 sky130_fd_sc_hd__nand2_2 _0822_ (.A(\logo_top[4] ),
    .B(_0077_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0290_));
 sky130_fd_sc_hd__nand2b_2 _0823_ (.A_N(_0276_),
    .B(_0290_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0291_));
 sky130_fd_sc_hd__a21o_2 _0824_ (.A1(_0289_),
    .A2(_0290_),
    .B1(_0276_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0292_));
 sky130_fd_sc_hd__a21o_2 _0825_ (.A1(_0274_),
    .A2(_0292_),
    .B1(_0275_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0293_));
 sky130_fd_sc_hd__nand2_2 _0826_ (.A(_0272_),
    .B(_0293_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0294_));
 sky130_fd_sc_hd__xor2_2 _0827_ (.A(_0272_),
    .B(_0293_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0295_));
 sky130_fd_sc_hd__xnor2_2 _0828_ (.A(_0272_),
    .B(_0293_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0296_));
 sky130_fd_sc_hd__or2_2 _0829_ (.A(_0072_),
    .B(\pix_x[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0297_));
 sky130_fd_sc_hd__nand2_2 _0830_ (.A(_0072_),
    .B(\pix_x[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0298_));
 sky130_fd_sc_hd__nand2_2 _0831_ (.A(_0297_),
    .B(_0298_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0299_));
 sky130_fd_sc_hd__and2b_2 _0832_ (.A_N(\logo_left[4] ),
    .B(\pix_x[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0300_));
 sky130_fd_sc_hd__and2b_2 _0833_ (.A_N(\pix_x[4] ),
    .B(\logo_left[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0301_));
 sky130_fd_sc_hd__nor2_2 _0834_ (.A(_0300_),
    .B(_0301_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0302_));
 sky130_fd_sc_hd__and2b_2 _0835_ (.A_N(\pix_x[3] ),
    .B(\logo_left[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0303_));
 sky130_fd_sc_hd__nand2b_2 _0836_ (.A_N(\pix_x[3] ),
    .B(\logo_left[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0304_));
 sky130_fd_sc_hd__and2b_2 _0837_ (.A_N(\logo_left[2] ),
    .B(\pix_x[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0305_));
 sky130_fd_sc_hd__and2b_2 _0838_ (.A_N(\pix_x[2] ),
    .B(\logo_left[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0306_));
 sky130_fd_sc_hd__nor2_2 _0839_ (.A(_0305_),
    .B(_0306_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2b_2 _0840_ (.A_N(\logo_left[1] ),
    ...
    .VPWR(VPWR),
    .X(_0308_));
 sky130_fd_sc_hd__xnor2_2 _0841_ (.A(\logo_left[1] ),
    .B(\pix_x[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0309_));
 sky130_fd_sc_hd__a21o_2 _0842_ (.A1(_0268_),
    .A2(_0309_),
    .B1(_0308_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0310_));
 sky130_fd_sc_hd__and2b_2 _0843_ (.A_N(\logo_left[3] ),
    .B(\pix_x[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0311_));
 sky130_fd_sc_hd__a31o_2 _0844_ (.A1(_0074_),
    .A2(\pix_x[2] ),
    .A3(_0304_),
    .B1(_0311_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0312_));
 sky130_fd_sc_hd__nor2_2 _0845_ (.A(_0303_),
    .B(_0311_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0313_));
 sky130_fd_sc_hd__a31o_2 _0846_ (.A1(_0307_),
    .A2(_0310_),
    .A3(_0313_),
    .B1(_0312_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0314_));
 sky130_fd_sc_hd__a21oi_2 _0847_ (.A1(_0302_),
    .A2(_0314_),
    .B1(_0300_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0315_));
 sky130_fd_sc_hd__xnor2_2 _0848_ (.A(_0299_),
    .B(_0315_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0316_));
 sky130_fd_sc_hd__xor2_2 _0849_ (.A(_0299_),
    .B(_0315_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0317_));
 sky130_fd_sc_hd__a21oi_2 _0850_ (.A1(_0307_),
    .A2(_0310_),
    .B1(_0305_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0318_));
 sky130_fd_sc_hd__xnor2_2 _0851_ (.A(_0313_),
    .B(_0318_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0319_));
 sky130_fd_sc_hd__inv_2 _0852_ (.A(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0320_));
 sky130_fd_sc_hd__xor2_2 _0853_ (.A(_0302_),
    .B(_0314_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0321_));
 sky130_fd_sc_hd__xnor2_2 _0854_ (.A(_0302_),
    .B(_0314_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0322_));
 sky130_fd_sc_hd__nor2_2 _0855_ (.A(net18),
    .B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0323_));
 sky130_fd_sc_hd__or2_2 _0856_ (.A(net18),
    .B(_0321_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0324_));
 sky130_fd_sc_hd__nor2_2 _0857_ (.A(net12),
    .B(_0324_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0325_));
 sky130_fd_sc_hd__nor2_2 _0858_ (.A(net18),
    .B(_0322_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0326_));
 sky130_fd_sc_hd__or2_2 _0859_ (.A(net18),
    .B(_0322_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0327_));
 sky130_fd_sc_hd__xnor2_2 _0860_ (.A(\logo_left[6] ),
    .B(\pix_x[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0328_));
 sky130_fd_sc_hd__a221o_2 _0861_ (.A1(_0072_),
    .A2(\pix_x[5] ),
    .B1(_0302_),
    .B2(_0314_),
    .C1(_0300_),
    ...
    .VPWR(VPWR),
    .X(_0329_));
 sky130_fd_sc_hd__and3_2 _0862_ (.A(_0297_),
    .B(_0328_),
    .C(_0329_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0330_));
 sky130_fd_sc_hd__nand3_2 _0863_ (.A(_0297_),
    .B(_0328_),
    .C(_0329_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0331_));
 sky130_fd_sc_hd__a21oi_2 _0864_ (.A1(_0297_),
    .A2(_0329_),
    .B1(_0328_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0332_));
 sky130_fd_sc_hd__a21o_2 _0865_ (.A1(_0297_),
    .A2(_0329_),
    .B1(_0328_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0333_));
 sky130_fd_sc_hd__nor2_2 _0866_ (.A(_0330_),
    .B(_0332_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0334_));
 sky130_fd_sc_hd__nand2_2 _0867_ (.A(net11),
    .B(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0335_));
 sky130_fd_sc_hd__nor2_2 _0868_ (.A(net14),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0336_));
 sky130_fd_sc_hd__xnor2_2 _0869_ (.A(net12),
    .B(_0321_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0337_));
 sky130_fd_sc_hd__a31o_2 _0870_ (.A1(_0327_),
    .A2(net8),
    .A3(net7),
    .B1(_0325_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0338_));
 sky130_fd_sc_hd__nand2b_2 _0871_ (.A_N(\logo_top[0] ),
    .B(\pix_y[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0339_));
 sky130_fd_sc_hd__and2_2 _0872_ (.A(_0283_),
    .B(_0339_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0340_));
 sky130_fd_sc_hd__nand2_2 _0873_ (.A(_0283_),
    .B(_0339_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0341_));
 sky130_fd_sc_hd__nor2_2 _0874_ (.A(\pix_y[0] ),
    .B(_0282_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0342_));
 sky130_fd_sc_hd__a21oi_2 _0875_ (.A1(\logo_top[0] ),
    .A2(_0342_),
    .B1(_0284_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0343_));
 sky130_fd_sc_hd__a21o_2 _0876_ (.A1(\logo_top[0] ),
    .A2(_0342_),
    .B1(_0284_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0344_));
 sky130_fd_sc_hd__xor2_2 _0877_ (.A(_0285_),
    .B(_0287_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0345_));
 sky130_fd_sc_hd__inv_2 _0878_ (.A(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0346_));
 sky130_fd_sc_hd__nor2_2 _0879_ (.A(_0344_),
    .B(_0346_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0347_));
 sky130_fd_sc_hd__nand2_2 _0880_ (.A(net22),
    .B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0348_));
 sky130_fd_sc_hd__a21oi_2 _0881_ (.A1(net11),
    .A2(net10),
    .B1(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0349_));
 sky130_fd_sc_hd__a21o_2 _0882_ (.A1(net11),
    .A2(net10),
    .B1(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0350_));
 sky130_fd_sc_hd__and2_2 _0883_ (.A(_0319_),
    .B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0351_));
 sky130_fd_sc_hd__nand2_2 _0884_ (.A(net18),
    .B(_0321_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0352_));
 sky130_fd_sc_hd__nor2_2 _0885_ (.A(net12),
    .B(_0351_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0353_));
 sky130_fd_sc_hd__and4_2 _0886_ (.A(net14),
    .B(net11),
    .C(net10),
    .D(_0352_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0354_));
 sky130_fd_sc_hd__nand2_2 _0887_ (.A(net8),
    .B(_0353_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0355_));
 sky130_fd_sc_hd__a21o_2 _0888_ (.A1(net12),
    .A2(_0351_),
    .B1(net24),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0356_));
 sky130_fd_sc_hd__a211o_2 _0889_ (.A1(_0323_),
    .A2(_0335_),
    .B1(_0354_),
    .C1(_0356_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0357_));
 sky130_fd_sc_hd__o211ai_2 _0890_ (.A1(_0338_),
    .A2(net23),
    .B1(_0347_),
    .C1(_0357_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0358_));
 sky130_fd_sc_hd__nand2_2 _0891_ (.A(net23),
    .B(_0344_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0359_));
 sky130_fd_sc_hd__nand2b_2 _0892_ (.A_N(_0359_),
    .B(_0338_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0360_));
 sky130_fd_sc_hd__nor2_2 _0893_ (.A(net24),
    .B(_0344_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0361_));
 sky130_fd_sc_hd__nand2_2 _0894_ (.A(net23),
    .B(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0362_));
 sky130_fd_sc_hd__or3_2 _0895_ (.A(net17),
    .B(_0330_),
    .C(_0332_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0363_));
 sky130_fd_sc_hd__and2_2 _0896_ (.A(net18),
    .B(_0322_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0364_));
 sky130_fd_sc_hd__and4_2 _0897_ (.A(_0350_),
    .B(_0353_),
    .C(_0361_),
    .D(_0363_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0365_));
 sky130_fd_sc_hd__nand2_2 _0898_ (.A(net12),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0366_));
 sky130_fd_sc_hd__a211o_2 _0899_ (.A1(net11),
    .A2(net10),
    .B1(net14),
    .C1(_0324_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0367_));
 sky130_fd_sc_hd__nor2_2 _0900_ (.A(_0344_),
    .B(_0367_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0368_));
 sky130_fd_sc_hd__nor2_2 _0901_ (.A(_0273_),
    .B(_0275_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_2 _0902_ (.A(_0292_),
    ...
    .VPWR(VPWR),
    .Y(_0370_));
 sky130_fd_sc_hd__xnor2_2 _0903_ (.A(_0289_),
    .B(_0291_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0371_));
 sky130_fd_sc_hd__xnor2_2 _0904_ (.A(_0279_),
    .B(_0288_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0372_));
 sky130_fd_sc_hd__and3b_2 _0905_ (.A_N(_0370_),
    .B(_0371_),
    .C(_0372_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0373_));
 sky130_fd_sc_hd__and2_2 _0906_ (.A(_0282_),
    .B(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0374_));
 sky130_fd_sc_hd__nand2_2 _0907_ (.A(_0282_),
    .B(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0375_));
 sky130_fd_sc_hd__a31o_2 _0908_ (.A1(_0350_),
    .A2(_0353_),
    .A3(_0363_),
    .B1(_0375_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0376_));
 sky130_fd_sc_hd__o311a_2 _0909_ (.A1(net21),
    .A2(_0365_),
    .A3(_0368_),
    .B1(_0373_),
    .C1(_0376_),
    ...
    .VPWR(VPWR),
    .X(_0377_));
 sky130_fd_sc_hd__a31o_2 _0910_ (.A1(_0358_),
    .A2(_0360_),
    .A3(_0377_),
    .B1(_0295_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0378_));
 sky130_fd_sc_hd__nor2_2 _0911_ (.A(_0371_),
    .B(_0372_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0379_));
 sky130_fd_sc_hd__nand2_2 _0912_ (.A(_0370_),
    .B(_0379_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0380_));
 sky130_fd_sc_hd__nand3_2 _0913_ (.A(_0346_),
    .B(_0370_),
    .C(_0379_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0381_));
 sky130_fd_sc_hd__o31ai_2 _0914_ (.A1(_0361_),
    .A2(_0367_),
    .A3(_0380_),
    .B1(_0381_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0382_));
 sky130_fd_sc_hd__a32o_2 _0915_ (.A1(_0327_),
    .A2(net8),
    .A3(net7),
    .B1(_0349_),
    .B2(_0322_),
    ...
    .VPWR(VPWR),
    .X(_0383_));
 sky130_fd_sc_hd__nor2_2 _0916_ (.A(_0344_),
    .B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0384_));
 sky130_fd_sc_hd__nand2_2 _0917_ (.A(_0383_),
    .B(_0384_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0385_));
 sky130_fd_sc_hd__a21o_2 _0918_ (.A1(_0382_),
    .A2(_0385_),
    .B1(_0296_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0386_));
 sky130_fd_sc_hd__a21o_2 _0919_ (.A1(net11),
    .A2(net10),
    .B1(_0326_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0387_));
 sky130_fd_sc_hd__a22o_2 _0920_ (.A1(net14),
    .A2(_0322_),
    .B1(net11),
    .B2(net10),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0388_));
 sky130_fd_sc_hd__nor2_2 _0921_ (.A(_0337_),
    .B(_0387_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0389_));
 sky130_fd_sc_hd__nand2_2 _0922_ (.A(net24),
    .B(_0389_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0390_));
 sky130_fd_sc_hd__xnor2_2 _0923_ (.A(_0319_),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0391_));
 sky130_fd_sc_hd__a31o_2 _0924_ (.A1(net14),
    .A2(_0331_),
    .A3(_0333_),
    .B1(_0391_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0392_));
 sky130_fd_sc_hd__or2_2 _0925_ (.A(net22),
    .B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0393_));
 sky130_fd_sc_hd__a31o_2 _0926_ (.A1(_0355_),
    .A2(_0390_),
    .A3(_0392_),
    .B1(_0393_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0394_));
 sky130_fd_sc_hd__a31o_2 _0927_ (.A1(_0378_),
    .A2(_0386_),
    .A3(_0394_),
    .B1(_0271_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0395_));
 sky130_fd_sc_hd__xor2_2 _0928_ (.A(_0268_),
    .B(_0309_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0396_));
 sky130_fd_sc_hd__xnor2_2 _0929_ (.A(_0268_),
    .B(_0309_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0397_));
 sky130_fd_sc_hd__o2111a_2 _0930_ (.A1(net9),
    .A2(net23),
    .B1(net22),
    .C1(_0350_),
    .D1(_0353_),
    ...
    .VPWR(VPWR),
    .X(_0398_));
 sky130_fd_sc_hd__nand2_2 _0931_ (.A(net12),
    .B(_0326_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0399_));
 sky130_fd_sc_hd__o211a_2 _0932_ (.A1(net12),
    .A2(_0352_),
    .B1(net10),
    .C1(net11),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0400_));
 sky130_fd_sc_hd__a211o_2 _0933_ (.A1(_0399_),
    .A2(_0400_),
    .B1(_0325_),
    .C1(net24),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0401_));
 sky130_fd_sc_hd__a22o_2 _0934_ (.A1(net15),
    .A2(_0323_),
    .B1(_0331_),
    .B2(_0333_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0402_));
 sky130_fd_sc_hd__a21o_2 _0935_ (.A1(net12),
    .A2(_0391_),
    .B1(_0402_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0403_));
 sky130_fd_sc_hd__a21o_2 _0936_ (.A1(net13),
    .A2(net17),
    .B1(_0351_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0404_));
 sky130_fd_sc_hd__a31o_2 _0937_ (.A1(net9),
    .A2(net24),
    .A3(_0404_),
    .B1(net22),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0405_));
 sky130_fd_sc_hd__nand3b_2 _0938_ (.A_N(_0405_),
    .B(_0403_),
    .C(_0401_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0406_));
 sky130_fd_sc_hd__and4b_2 _0939_ (.A_N(_0398_),
    .B(_0295_),
    .C(_0382_),
    .D(_0406_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0407_));
 sky130_fd_sc_hd__or4_2 _0940_ (.A(net13),
    .B(_0330_),
    .C(_0332_),
    .D(_0391_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0408_));
 sky130_fd_sc_hd__or4_2 _0941_ (.A(net15),
    .B(_0330_),
    .C(_0332_),
    .D(_0351_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0409_));
 sky130_fd_sc_hd__o22a_2 _0942_ (.A1(_0323_),
    .A2(net9),
    .B1(net23),
    .B2(net13),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21oi_2 _0943_ (.A1(_0331_),
    ...
    .VPWR(VPWR),
    .Y(_0411_));
 sky130_fd_sc_hd__a21boi_2 _0944_ (.A1(net7),
    .A2(_0411_),
    .B1_N(_0408_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0412_));
 sky130_fd_sc_hd__a31o_2 _0945_ (.A1(_0402_),
    .A2(_0408_),
    .A3(_0409_),
    .B1(_0375_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0413_));
 sky130_fd_sc_hd__a211o_2 _0946_ (.A1(net7),
    .A2(_0349_),
    .B1(_0354_),
    .C1(net24),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0414_));
 sky130_fd_sc_hd__and4_2 _0947_ (.A(net15),
    .B(_0323_),
    .C(_0331_),
    .D(_0333_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0415_));
 sky130_fd_sc_hd__nand2_2 _0948_ (.A(_0325_),
    .B(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0416_));
 sky130_fd_sc_hd__a211o_2 _0949_ (.A1(net7),
    .A2(_0411_),
    .B1(_0415_),
    .C1(net23),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0417_));
 sky130_fd_sc_hd__nand3_2 _0950_ (.A(_0347_),
    .B(_0414_),
    .C(_0417_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0418_));
 sky130_fd_sc_hd__o2111a_2 _0951_ (.A1(_0359_),
    .A2(_0412_),
    .B1(_0413_),
    .C1(_0373_),
    .D1(_0296_),
    ...
    .VPWR(VPWR),
    .X(_0419_));
 sky130_fd_sc_hd__a41o_2 _0952_ (.A1(net22),
    .A2(_0408_),
    .A3(_0409_),
    .A4(_0410_),
    .B1(net21),
    ...
    .VPWR(VPWR),
    .X(_0420_));
 sky130_fd_sc_hd__and3_2 _0953_ (.A(_0418_),
    .B(_0419_),
    .C(_0420_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0421_));
 sky130_fd_sc_hd__o31a_2 _0954_ (.A1(_0270_),
    .A2(_0407_),
    .A3(_0421_),
    .B1(_0397_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0422_));
 sky130_fd_sc_hd__xor2_2 _0955_ (.A(_0307_),
    .B(_0310_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0423_));
 sky130_fd_sc_hd__or3b_2 _0956_ (.A(_0323_),
    .B(net9),
    .C_N(_0353_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0424_));
 sky130_fd_sc_hd__or3_2 _0957_ (.A(net13),
    .B(_0335_),
    .C(_0364_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0425_));
 sky130_fd_sc_hd__o21a_2 _0958_ (.A1(_0340_),
    .A2(_0425_),
    .B1(_0424_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0426_));
 sky130_fd_sc_hd__or4b_2 _0959_ (.A(net15),
    .B(net9),
    .C(net23),
    .D_N(_0391_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0427_));
 sky130_fd_sc_hd__a31o_2 _0960_ (.A1(_0344_),
    .A2(_0363_),
    .A3(_0427_),
    .B1(_0271_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0428_));
 sky130_fd_sc_hd__a31o_2 _0961_ (.A1(_0343_),
    .A2(_0416_),
    .A3(_0426_),
    .B1(_0428_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0429_));
 sky130_fd_sc_hd__nor2_2 _0962_ (.A(net14),
    .B(_0320_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0430_));
 sky130_fd_sc_hd__a21o_2 _0963_ (.A1(_0352_),
    .A2(_0388_),
    .B1(_0430_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0431_));
 sky130_fd_sc_hd__a221o_2 _0964_ (.A1(_0336_),
    .A2(net23),
    .B1(net22),
    .B2(_0324_),
    .C1(_0270_),
    ...
    .VPWR(VPWR),
    .X(_0432_));
 sky130_fd_sc_hd__a21o_2 _0965_ (.A1(_0363_),
    .A2(_0431_),
    .B1(_0432_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0433_));
 sky130_fd_sc_hd__nand2_2 _0966_ (.A(_0271_),
    .B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0434_));
 sky130_fd_sc_hd__and4_2 _0967_ (.A(_0295_),
    .B(_0382_),
    .C(_0433_),
    .D(_0434_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0435_));
 sky130_fd_sc_hd__o221a_2 _0968_ (.A1(net9),
    .A2(_0399_),
    .B1(_0430_),
    .B2(_0363_),
    .C1(_0341_),
    ...
    .VPWR(VPWR),
    .X(_0436_));
 sky130_fd_sc_hd__a311o_2 _0969_ (.A1(_0340_),
    .A2(_0424_),
    .A3(_0425_),
    .B1(_0436_),
    .C1(_0348_),
    ...
    .VPWR(VPWR),
    .X(_0437_));
 sky130_fd_sc_hd__a211o_2 _0970_ (.A1(_0424_),
    .A2(_0425_),
    .B1(_0340_),
    .C1(_0343_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0438_));
 sky130_fd_sc_hd__a21o_2 _0971_ (.A1(_0437_),
    .A2(_0438_),
    .B1(_0271_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0439_));
 sky130_fd_sc_hd__and3_2 _0972_ (.A(_0361_),
    .B(_0363_),
    .C(_0431_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0440_));
 sky130_fd_sc_hd__a211o_2 _0973_ (.A1(net11),
    .A2(net10),
    .B1(_0352_),
    .C1(net12),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0441_));
 sky130_fd_sc_hd__nand2_2 _0974_ (.A(_0367_),
    .B(_0441_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0442_));
 sky130_fd_sc_hd__a41o_2 _0975_ (.A1(_0362_),
    .A2(_0367_),
    .A3(_0408_),
    .A4(_0441_),
    .B1(_0434_),
    ...
    .VPWR(VPWR),
    .X(_0443_));
 sky130_fd_sc_hd__nand2_2 _0976_ (.A(net9),
    .B(_0430_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0444_));
 sky130_fd_sc_hd__and4_2 _0977_ (.A(net12),
    .B(net17),
    .C(net11),
    .D(net10),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0445_));
 sky130_fd_sc_hd__or4_2 _0978_ (.A(net14),
    .B(_0322_),
    .C(_0330_),
    .D(_0332_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0446_));
 sky130_fd_sc_hd__nor2_2 _0979_ (.A(_0320_),
    .B(_0446_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0447_));
 sky130_fd_sc_hd__a211o_2 _0980_ (.A1(net15),
    .A2(_0364_),
    .B1(_0332_),
    .C1(_0330_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0448_));
 sky130_fd_sc_hd__a22o_2 _0981_ (.A1(net21),
    .A2(_0375_),
    .B1(_0402_),
    .B2(_0448_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0449_));
 sky130_fd_sc_hd__or3_2 _0982_ (.A(net17),
    .B(_0341_),
    .C(net21),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0450_));
 sky130_fd_sc_hd__o2111a_2 _0983_ (.A1(_0447_),
    .A2(_0449_),
    .B1(_0450_),
    .C1(_0373_),
    .D1(_0296_),
    ...
    .VPWR(VPWR),
    .X(_0451_));
 sky130_fd_sc_hd__o211a_2 _0984_ (.A1(_0440_),
    .A2(_0443_),
    .B1(_0451_),
    .C1(_0393_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0452_));
 sky130_fd_sc_hd__a22o_2 _0985_ (.A1(_0429_),
    .A2(_0435_),
    .B1(_0439_),
    .B2(_0452_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0453_));
 sky130_fd_sc_hd__a221o_2 _0986_ (.A1(_0395_),
    .A2(_0422_),
    .B1(_0453_),
    .B2(_0396_),
    .C1(_0423_),
    ...
    .VPWR(VPWR),
    .X(_0454_));
 sky130_fd_sc_hd__a21oi_2 _0987_ (.A1(_0402_),
    .A2(_0448_),
    .B1(_0375_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0455_));
 sky130_fd_sc_hd__nor2_2 _0988_ (.A(_0415_),
    .B(_0445_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0456_));
 sky130_fd_sc_hd__a211o_2 _0989_ (.A1(_0336_),
    .A2(_0349_),
    .B1(_0415_),
    .C1(_0445_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0457_));
 sky130_fd_sc_hd__or4_2 _0990_ (.A(_0323_),
    .B(net9),
    .C(_0353_),
    .D(_0362_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0458_));
 sky130_fd_sc_hd__or3b_2 _0991_ (.A(_0455_),
    .B(_0457_),
    .C_N(_0458_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0459_));
 sky130_fd_sc_hd__or3_2 _0992_ (.A(_0323_),
    .B(net8),
    .C(_0375_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0460_));
 sky130_fd_sc_hd__or3_2 _0993_ (.A(net16),
    .B(net8),
    .C(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0461_));
 sky130_fd_sc_hd__or3_2 _0994_ (.A(_0320_),
    .B(net8),
    .C(_0337_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0462_));
 sky130_fd_sc_hd__and4_2 _0995_ (.A(_0456_),
    .B(_0460_),
    .C(_0461_),
    .D(_0462_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0463_));
 sky130_fd_sc_hd__nand2_2 _0996_ (.A(_0295_),
    .B(_0346_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0464_));
 sky130_fd_sc_hd__o2bb2a_2 _0997_ (.A1_N(_0296_),
    .A2_N(_0459_),
    .B1(_0463_),
    .B2(_0464_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0465_));
 sky130_fd_sc_hd__nor2_2 _0998_ (.A(_0271_),
    .B(_0465_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0466_));
 sky130_fd_sc_hd__a31o_2 _0999_ (.A1(_0361_),
    .A2(_0402_),
    .A3(_0448_),
    .B1(net21),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0467_));
 sky130_fd_sc_hd__nand2_2 _1000_ (.A(_0373_),
    .B(_0467_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0468_));
 sky130_fd_sc_hd__o31a_2 _1001_ (.A1(_0361_),
    .A2(_0374_),
    .A3(_0441_),
    .B1(_0345_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0469_));
 sky130_fd_sc_hd__o21a_2 _1002_ (.A1(_0380_),
    .A2(_0469_),
    .B1(_0295_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0470_));
 sky130_fd_sc_hd__a211o_2 _1003_ (.A1(_0296_),
    .A2(_0468_),
    .B1(_0470_),
    .C1(_0397_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0471_));
 sky130_fd_sc_hd__o221a_2 _1004_ (.A1(net14),
    .A2(net18),
    .B1(_0330_),
    .B2(_0332_),
    .C1(net17),
    ...
    .VPWR(VPWR),
    .X(_0472_));
 sky130_fd_sc_hd__o31ai_2 _1005_ (.A1(_0415_),
    .A2(_0445_),
    .A3(_0472_),
    .B1(net22),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0473_));
 sky130_fd_sc_hd__and3_2 _1006_ (.A(net14),
    .B(net24),
    .C(_0364_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0474_));
 sky130_fd_sc_hd__a21oi_2 _1007_ (.A1(net8),
    .A2(_0337_),
    .B1(_0474_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0475_));
 sky130_fd_sc_hd__o211a_2 _1008_ (.A1(net22),
    .A2(_0475_),
    .B1(_0473_),
    .C1(_0461_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0476_));
 sky130_fd_sc_hd__mux2_1 _1009_ (.A0(net7),
    .A1(_0404_),
    .S(_0335_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0477_));
 sky130_fd_sc_hd__a211o_2 _1010_ (.A1(_0361_),
    .A2(_0477_),
    .B1(_0457_),
    .C1(_0455_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0478_));
 sky130_fd_sc_hd__nor2_2 _1011_ (.A(_0295_),
    .B(_0346_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0479_));
 sky130_fd_sc_hd__a2bb2o_2 _1012_ (.A1_N(_0464_),
    .A2_N(_0476_),
    .B1(_0478_),
    .B2(_0479_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0480_));
 sky130_fd_sc_hd__a21o_2 _1013_ (.A1(_0271_),
    .A2(_0480_),
    .B1(_0471_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0481_));
 sky130_fd_sc_hd__a31o_2 _1014_ (.A1(_0324_),
    .A2(_0441_),
    .A3(_0446_),
    .B1(_0359_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0482_));
 sky130_fd_sc_hd__a2111o_2 _1015_ (.A1(net14),
    .A2(_0364_),
    .B1(_0332_),
    .C1(_0330_),
    .D1(_0326_),
    ...
    .VPWR(VPWR),
    .X(_0483_));
 sky130_fd_sc_hd__a31o_2 _1016_ (.A1(_0367_),
    .A2(_0441_),
    .A3(_0483_),
    .B1(_0344_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0484_));
 sky130_fd_sc_hd__a41o_2 _1017_ (.A1(_0324_),
    .A2(net24),
    .A3(_0441_),
    .A4(_0446_),
    .B1(_0271_),
    ...
    .VPWR(VPWR),
    .X(_0485_));
 sky130_fd_sc_hd__a21oi_2 _1018_ (.A1(_0482_),
    .A2(_0484_),
    .B1(_0485_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0486_));
 sky130_fd_sc_hd__o31a_2 _1019_ (.A1(_0325_),
    .A2(_0336_),
    .A3(_0430_),
    .B1(net8),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0487_));
 sky130_fd_sc_hd__nor2_2 _1020_ (.A(net8),
    .B(_0366_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0488_));
 sky130_fd_sc_hd__a21oi_2 _1021_ (.A1(net13),
    .A2(_0351_),
    .B1(_0323_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0489_));
 sky130_fd_sc_hd__o211ai_2 _1022_ (.A1(_0335_),
    .A2(_0489_),
    .B1(_0441_),
    .C1(_0361_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0490_));
 sky130_fd_sc_hd__o311a_2 _1023_ (.A1(_0361_),
    .A2(_0487_),
    .A3(_0488_),
    .B1(_0490_),
    .C1(_0271_),
    ...
    .VPWR(VPWR),
    .X(_0491_));
 sky130_fd_sc_hd__or4_2 _1024_ (.A(_0455_),
    .B(_0468_),
    .C(_0486_),
    .D(_0491_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0492_));
 sky130_fd_sc_hd__a21o_2 _1025_ (.A1(_0319_),
    .A2(_0445_),
    .B1(net23),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0493_));
 sky130_fd_sc_hd__a211o_2 _1026_ (.A1(_0487_),
    .A2(_0493_),
    .B1(_0389_),
    .C1(_0415_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0494_));
 sky130_fd_sc_hd__o21ai_2 _1027_ (.A1(_0335_),
    .A2(_0489_),
    .B1(_0387_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0495_));
 sky130_fd_sc_hd__a21oi_2 _1028_ (.A1(net23),
    .A2(_0364_),
    .B1(_0393_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0496_));
 sky130_fd_sc_hd__o21a_2 _1029_ (.A1(net8),
    .A2(_0366_),
    .B1(_0496_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0497_));
 sky130_fd_sc_hd__a2111o_2 _1030_ (.A1(_0495_),
    .A2(_0497_),
    .B1(_0270_),
    .C1(_0380_),
    .D1(_0469_),
    ...
    .VPWR(VPWR),
    .X(_0498_));
 sky130_fd_sc_hd__a21o_2 _1031_ (.A1(_0384_),
    .A2(_0494_),
    .B1(_0498_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0499_));
 sky130_fd_sc_hd__o2111ai_2 _1032_ (.A1(_0343_),
    .A2(_0391_),
    .B1(_0416_),
    .C1(_0444_),
    .D1(_0270_),
    ...
    .VPWR(VPWR),
    .Y(_0500_));
 sky130_fd_sc_hd__o31a_2 _1033_ (.A1(_0381_),
    .A2(_0442_),
    .A3(_0500_),
    .B1(_0295_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0501_));
 sky130_fd_sc_hd__a221o_2 _1034_ (.A1(_0296_),
    .A2(_0492_),
    .B1(_0499_),
    .B2(_0501_),
    .C1(_0396_),
    ...
    .VPWR(VPWR),
    .X(_0502_));
 sky130_fd_sc_hd__o211a_2 _1035_ (.A1(_0466_),
    .A2(_0481_),
    .B1(_0502_),
    .C1(_0423_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0503_));
 sky130_fd_sc_hd__and2_2 _1036_ (.A(_0070_),
    .B(\pix_x[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0504_));
 sky130_fd_sc_hd__nor2_2 _1037_ (.A(_0070_),
    .B(\pix_x[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0505_));
 sky130_fd_sc_hd__nor2_2 _1038_ (.A(_0504_),
    .B(_0505_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0506_));
 sky130_fd_sc_hd__a21o_2 _1039_ (.A1(_0071_),
    .A2(\pix_x[6] ),
    .B1(_0330_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0507_));
 sky130_fd_sc_hd__xnor2_2 _1040_ (.A(_0506_),
    .B(_0507_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0508_));
 sky130_fd_sc_hd__xnor2_2 _1041_ (.A(\logo_left[9] ),
    .B(\pix_x[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0509_));
 sky130_fd_sc_hd__nor2_2 _1042_ (.A(_0069_),
    .B(\pix_x[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0510_));
 sky130_fd_sc_hd__or2_2 _1043_ (.A(\logo_top[8] ),
    .B(_0081_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0511_));
 sky130_fd_sc_hd__nand2_2 _1044_ (.A(\logo_top[8] ),
    .B(_0081_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0512_));
 sky130_fd_sc_hd__a22o_2 _1045_ (.A1(\logo_top[7] ),
    .A2(_0080_),
    .B1(_0511_),
    .B2(_0512_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0513_));
 sky130_fd_sc_hd__xor2_2 _1046_ (.A(\logo_top[9] ),
    .B(\pix_y[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0514_));
 sky130_fd_sc_hd__and3b_2 _1047_ (.A_N(_0514_),
    .B(\logo_top[7] ),
    .C(_0080_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0515_));
 sky130_fd_sc_hd__a32o_2 _1048_ (.A1(\logo_left[8] ),
    .A2(_0075_),
    .A3(_0509_),
    .B1(_0512_),
    .B2(_0514_),
    ...
    .VPWR(VPWR),
    .X(_0516_));
 sky130_fd_sc_hd__o2bb2a_2 _1049_ (.A1_N(_0511_),
    .A2_N(_0515_),
    .B1(_0509_),
    .B2(_0510_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0517_));
 sky130_fd_sc_hd__and4b_2 _1050_ (.A_N(_0516_),
    .B(_0517_),
    .C(_0508_),
    .D(_0513_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0518_));
 sky130_fd_sc_hd__nor2_2 _1051_ (.A(\logo_left[8] ),
    .B(_0075_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0519_));
 sky130_fd_sc_hd__or2_2 _1052_ (.A(_0510_),
    .B(_0519_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0520_));
 sky130_fd_sc_hd__a21oi_2 _1053_ (.A1(_0506_),
    .A2(_0507_),
    .B1(_0504_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0521_));
 sky130_fd_sc_hd__o21ai_2 _1054_ (.A1(\logo_top[6] ),
    .A2(_0079_),
    .B1(_0294_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0522_));
 sky130_fd_sc_hd__xnor2_2 _1055_ (.A(\logo_top[7] ),
    .B(\pix_y[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0523_));
 sky130_fd_sc_hd__xnor2_2 _1056_ (.A(_0522_),
    .B(_0523_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0524_));
 sky130_fd_sc_hd__xnor2_2 _1057_ (.A(_0520_),
    .B(_0521_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0525_));
 sky130_fd_sc_hd__a31o_2 _1058_ (.A1(_0518_),
    .A2(_0524_),
    .A3(_0525_),
    .B1(net2),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0526_));
 sky130_fd_sc_hd__o21ai_2 _1059_ (.A1(\pix_x[7] ),
    .A2(\pix_x[8] ),
    .B1(\pix_x[9] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0527_));
 sky130_fd_sc_hd__and4_2 _1060_ (.A(_0082_),
    .B(net34),
    .C(_0088_),
    .D(_0527_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0528_));
 sky130_fd_sc_hd__and4b_2 _1061_ (.A_N(_0503_),
    .B(_0528_),
    .C(_0526_),
    .D(_0454_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0529_));
 sky130_fd_sc_hd__nand2_2 _1062_ (.A(net76),
    .B(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0530_));
 sky130_fd_sc_hd__o21a_2 _1063_ (.A1(\color_index[2] ),
    .A2(_0530_),
    .B1(_0529_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0057_));
 sky130_fd_sc_hd__and2_2 _1064_ (.A(\color_index[2] ),
    .B(\color_index[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0531_));
 sky130_fd_sc_hd__nand2_2 _1065_ (.A(\color_index[1] ),
    .B(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0532_));
 sky130_fd_sc_hd__o21a_2 _1066_ (.A1(_0531_),
    .A2(_0532_),
    .B1(_0529_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0058_));
 sky130_fd_sc_hd__or2_2 _1067_ (.A(\color_index[2] ),
    .B(_0532_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0533_));
 sky130_fd_sc_hd__or3b_2 _1068_ (.A(\color_index[0] ),
    .B(_0087_),
    .C_N(_0533_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0534_));
 sky130_fd_sc_hd__o311a_2 _1069_ (.A1(\color_index[2] ),
    .A2(_0063_),
    .A3(_0530_),
    .B1(_0534_),
    .C1(_0529_),
    ...
    .VPWR(VPWR),
    .X(_0059_));
 sky130_fd_sc_hd__nor2_2 _1070_ (.A(\color_index[2] ),
    .B(\color_index[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0535_));
 sky130_fd_sc_hd__nor2_2 _1071_ (.A(_0531_),
    .B(_0535_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0536_));
 sky130_fd_sc_hd__nand2_2 _1072_ (.A(_0533_),
    .B(_0536_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0537_));
 sky130_fd_sc_hd__o21a_2 _1073_ (.A1(_0087_),
    .A2(_0537_),
    .B1(_0529_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0060_));
 sky130_fd_sc_hd__o31a_2 _1074_ (.A1(\color_index[2] ),
    .A2(net76),
    .A3(_0087_),
    .B1(_0529_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0061_));
 sky130_fd_sc_hd__o31a_2 _1075_ (.A1(\color_index[1] ),
    .A2(_0087_),
    .A3(_0536_),
    .B1(_0529_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0062_));
 sky130_fd_sc_hd__dfxtp_2 _1076_ (.CLK(clknet_3_4__leaf_clk),
    .D(_0002_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_y[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1077_ (.CLK(clknet_3_5__leaf_clk),
    .D(_0003_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_y[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1078_ (.CLK(clknet_3_5__leaf_clk),
    .D(_0004_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_y[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1079_ (.CLK(clknet_3_4__leaf_clk),
    .D(_0005_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1080_ (.CLK(clknet_3_7__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\pix_y[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1081_ (.CLK(clknet_3_6__leaf_clk),
    .D(_0007_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_y[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1082_ (.CLK(clknet_3_6__leaf_clk),
    .D(_0008_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1083_ (.CLK(clknet_3_6__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\pix_y[7] ));
 sky130_fd_sc_hd__dfxtp_2 _1084_ (.CLK(clknet_3_4__leaf_clk),
    .D(_0010_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_y[8] ));
 sky130_fd_sc_hd__dfxtp_2 _1085_ (.CLK(clknet_3_4__leaf_clk),
    .D(_0011_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_y[9] ));
 sky130_fd_sc_hd__dfxtp_2 _1086_ (.CLK(clknet_3_1__leaf_clk),
    .D(_0012_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_x[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1087_ (.CLK(clknet_3_1__leaf_clk),
    .D(net66),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_x[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1088_ (.CLK(clknet_3_1__leaf_clk),
    .D(_0014_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_x[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1089_ (.CLK(clknet_3_1__leaf_clk),
    .D(_0015_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_x[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1090_ (.CLK(clknet_3_0__leaf_clk),
    .D(_0016_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_x[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1091_ (.CLK(clknet_3_1__leaf_clk),
    .D(_0017_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_x[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1092_ (.CLK(clknet_3_2__leaf_clk),
    .D(_0018_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_x[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1093_ (.CLK(clknet_3_2__leaf_clk),
    .D(_0019_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_x[7] ));
 sky130_fd_sc_hd__dfxtp_2 _1094_ (.CLK(clknet_3_2__leaf_clk),
    .D(_0020_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_x[8] ));
 sky130_fd_sc_hd__dfxtp_2 _1095_ (.CLK(clknet_3_2__leaf_clk),
    .D(_0021_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_x[9] ));
 sky130_fd_sc_hd__dfxtp_2 _1096_ (.CLK(clknet_3_5__leaf_clk),
    .D(_0022_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\prev_y[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1097_ (.CLK(clknet_3_7__leaf_clk),
    .D(_0023_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\prev_y[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1098_ (.CLK(clknet_3_5__leaf_clk),
    .D(_0024_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1100_ (.CLK(clknet_3_7__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\prev_y[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1101_ (.CLK(clknet_3_7__leaf_clk),
    .D(net63),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1102_ (.CLK(clknet_3_6__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\prev_y[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1103_ (.CLK(clknet_3_7__leaf_clk),
    .D(_0029_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\prev_y[7] ));
 sky130_fd_sc_hd__dfxtp_2 _1104_ (.CLK(clknet_3_5__leaf_clk),
    .D(net59),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\prev_y[8] ));
 sky130_fd_sc_hd__dfxtp_2 _1105_ (.CLK(clknet_3_7__leaf_clk),
    .D(_0031_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\prev_y[9] ));
 sky130_fd_sc_hd__dfxtp_2 _1106_ (.CLK(clknet_3_0__leaf_clk),
    .D(_0032_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_left[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1107_ (.CLK(clknet_3_0__leaf_clk),
    .D(_0033_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_left[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1108_ (.CLK(clknet_3_0__leaf_clk),
    .D(_0034_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_left[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1109_ (.CLK(clknet_3_0__leaf_clk),
    .D(_0035_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_left[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1110_ (.CLK(clknet_3_0__leaf_clk),
    .D(_0036_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_left[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1111_ (.CLK(clknet_3_0__leaf_clk),
    .D(_0037_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_left[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1112_ (.CLK(clknet_3_0__leaf_clk),
    .D(_0038_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_left[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1113_ (.CLK(clknet_3_2__leaf_clk),
    .D(_0039_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1114_ (.CLK(clknet_3_2__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\logo_left[8] ));
 sky130_fd_sc_hd__dfxtp_2 _1115_ (.CLK(clknet_3_2__leaf_clk),
    .D(_0041_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_left[9] ));
 sky130_fd_sc_hd__dfxtp_2 _1116_ (.CLK(clknet_3_1__leaf_clk),
    .D(_0042_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_top[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1117_ (.CLK(clknet_3_5__leaf_clk),
    .D(_0043_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_top[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1118_ (.CLK(clknet_3_5__leaf_clk),
    .D(_0044_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_top[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1119_ (.CLK(clknet_3_5__leaf_clk),
    .D(_0045_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_top[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1120_ (.CLK(clknet_3_4__leaf_clk),
    .D(_0046_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_top[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1121_ (.CLK(clknet_3_4__leaf_clk),
    .D(_0047_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_top[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1122_ (.CLK(clknet_3_4__leaf_clk),
    .D(_0048_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_top[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1123_ (.CLK(clknet_3_4__leaf_clk),
    .D(_0049_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_top[7] ));
 sky130_fd_sc_hd__dfxtp_2 _1124_ (.CLK(clknet_3_1__leaf_clk),
    .D(_0050_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1125_ (.CLK(clknet_3_3__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\logo_top[9] ));
 sky130_fd_sc_hd__dfxtp_2 _1126_ (.CLK(clknet_3_2__leaf_clk),
    .D(_0052_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(dir_x));
 sky130_fd_sc_hd__dfxtp_2 _1127_ (.CLK(clknet_3_1__leaf_clk),
    .D(_0053_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(dir_y));
 sky130_fd_sc_hd__dfxtp_2 _1128_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0054_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\color_index[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1129_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0055_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\color_index[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1130_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0056_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\color_index[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1131_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0057_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1132_ (.CLK(clknet_3_6__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(uo_out[2]));
 sky130_fd_sc_hd__dfxtp_2 _1133_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0059_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1134_ (.CLK(clknet_3_6__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(uo_out[1]));
 sky130_fd_sc_hd__dfxtp_2 _1135_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0061_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uo_out[4]));
 sky130_fd_sc_hd__dfxtp_2 _1136_ (.CLK(clknet_3_6__leaf_clk),
    .D(_0062_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uo_out[0]));
 sky130_fd_sc_hd__dfxtp_2 _1137_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0000_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(hsync));
 sky130_fd_sc_hd__dfxtp_2 _1138_ (.CLK(clknet_3_6__leaf_clk),
    .D(_0001_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 _1155_ (.A(\vga_sync_gen.vsync ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[3]));
 sky130_fd_sc_hd__buf_2 _1156_ (.A(hsync),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 clkload0 (.A(clknet_3_7__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout10 (.A(_0333_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net10));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout11 (.A(_0331_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net11));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout12 (.A(_0317_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net12));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout13 (.A(_0317_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout14 (.A(net15),
    ...
    .VPWR(VPWR),
    .X(net14));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout15 (.A(_0316_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net15));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout18 (.A(_0319_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net18));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout19 (.A(_0105_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net19));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout20 (.A(_0105_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net20));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout21 (.A(_0345_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net21));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout22 (.A(_0343_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net22));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout23 (.A(_0341_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net23));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout24 (.A(_0340_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net24));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout25 (.A(dir_y),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net25));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout26 (.A(dir_x),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net26));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout27 (.A(\pix_y[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net27));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout28 (.A(\pix_y[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net28));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout29 (.A(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout4 (.A(net5),
    ...
    .VPWR(VPWR),
    .X(net4));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout5 (.A(_0150_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net5));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout6 (.A(_0150_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net6));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout8 (.A(_0334_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net8));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout9 (.A(_0334_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__dlygate4sd3_1 hold51 (.A(\prev_y[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net51));
 sky130_fd_sc_hd__dlygate4sd3_1 hold52 (.A(\prev_y[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net52));
 sky130_fd_sc_hd__dlygate4sd3_1 hold53 (.A(\prev_y[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net53));
 sky130_fd_sc_hd__dlygate4sd3_1 hold54 (.A(\prev_y[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net54));
 sky130_fd_sc_hd__dlygate4sd3_1 hold55 (.A(\prev_y[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net55));
 sky130_fd_sc_hd__dlygate4sd3_1 hold56 (.A(\prev_y[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net56));
 sky130_fd_sc_hd__dlygate4sd3_1 hold57 (.A(_0026_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net57));
 sky130_fd_sc_hd__dlygate4sd3_1 hold58 (.A(\prev_y[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net58));
 sky130_fd_sc_hd__dlygate4sd3_1 hold59 (.A(_0030_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net59));
 sky130_fd_sc_hd__dlygate4sd3_1 hold60 (.A(\prev_y[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net60));
 sky130_fd_sc_hd__dlygate4sd3_1 hold61 (.A(\prev_y[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net61));
 sky130_fd_sc_hd__dlygate4sd3_1 hold62 (.A(\prev_y[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net62));
 sky130_fd_sc_hd__dlygate4sd3_1 hold63 (.A(_0027_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net63));
 sky130_fd_sc_hd__dlygate4sd3_1 hold64 (.A(\logo_left[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net64));
 sky130_fd_sc_hd__dlygate4sd3_1 hold65 (.A(\pix_x[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net65));
 sky130_fd_sc_hd__dlygate4sd3_1 hold66 (.A(_0013_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net66));
 sky130_fd_sc_hd__dlygate4sd3_1 hold67 (.A(dir_x),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net67));
 sky130_fd_sc_hd__dlygate4sd3_1 hold68 (.A(\pix_x[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold69 (.A(\pix_x[9] ),
    ...
    .VPWR(VPWR),
    .X(net69));
 sky130_fd_sc_hd__dlygate4sd3_1 hold70 (.A(\logo_top[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net70));
 sky130_fd_sc_hd__dlygate4sd3_1 hold71 (.A(\pix_x[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net71));
 sky130_fd_sc_hd__dlygate4sd3_1 hold72 (.A(\logo_left[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net72));
 sky130_fd_sc_hd__dlygate4sd3_1 hold73 (.A(\pix_x[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net73));
 sky130_fd_sc_hd__dlygate4sd3_1 hold74 (.A(\pix_y[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net74));
 sky130_fd_sc_hd__dlygate4sd3_1 hold75 (.A(\logo_top[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net75));
 sky130_fd_sc_hd__dlygate4sd3_1 hold76 (.A(\color_index[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net76));
 sky130_fd_sc_hd__dlygate4sd3_1 hold77 (.A(\pix_y[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 load_slew34 (.A(net33),
    ...
    .VPWR(VPWR),
    .X(net34));
 sky130_fd_sc_hd__clkbuf_2 max_cap16 (.A(_0322_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net16));
 sky130_fd_sc_hd__buf_2 max_cap17 (.A(_0321_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net17));
 sky130_fd_sc_hd__clkbuf_2 max_cap7 (.A(_0337_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net7));
 sky130_fd_sc_hd__conb_1 tt_um_jasonbrave_terre (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 tt_um_jasonbrave_terre_36 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net36));
 sky130_fd_sc_hd__conb_1 tt_um_jasonbrave_terre_37 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net37));
 sky130_fd_sc_hd__conb_1 tt_um_jasonbrave_terre_38 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net38));
 sky130_fd_sc_hd__conb_1 tt_um_jasonbrave_terre_39 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net39));
 sky130_fd_sc_hd__conb_1 tt_um_jasonbrave_terre_40 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net40));
 sky130_fd_sc_hd__conb_1 tt_um_jasonbrave_terre_41 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net41));
 sky130_fd_sc_hd__conb_1 tt_um_jasonbrave_terre_42 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net42));
 sky130_fd_sc_hd__conb_1 tt_um_jasonbrave_terre_43 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net43));
 sky130_fd_sc_hd__conb_1 tt_um_jasonbrave_terre_44 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net44));
 sky130_fd_sc_hd__conb_1 tt_um_jasonbrave_terre_45 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net45));
 sky130_fd_sc_hd__conb_1 tt_um_jasonbrave_terre_46 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net46));
 sky130_fd_sc_hd__conb_1 tt_um_jasonbrave_terre_47 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net47));
 sky130_fd_sc_hd__conb_1 tt_um_jasonbrave_terre_48 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net48));
 sky130_fd_sc_hd__conb_1 tt_um_jasonbrave_terre_49 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net49));
 sky130_fd_sc_hd__conb_1 tt_um_jasonbrave_terre_50 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net50));
