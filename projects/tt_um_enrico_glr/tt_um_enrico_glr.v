module tt_um_enrico_glr (clk,
 ...
 wire _107_;
 wire \my_game.busy_o ;
 wire \my_game.guess_counter_p[0] ;
 wire \my_game.guess_counter_p[1] ;
 wire \my_game.guess_counter_p[2] ;
 wire \my_game.guess_counter_p[3] ;
 wire \my_game.guess_p[0] ;
 wire \my_game.guess_p[1] ;
 wire \my_game.guess_p[2] ;
 wire \my_game.guess_p[3] ;
 wire \my_game.guess_used_p[0] ;
 wire \my_game.guess_used_p[1] ;
 wire \my_game.guess_used_p[2] ;
 wire \my_game.guess_used_p[3] ;
 wire \my_game.idx_p[0] ;
 wire \my_game.idx_p[1] ;
 wire \my_game.secret_p[0] ;
 wire \my_game.secret_p[1] ;
 wire \my_game.secret_p[2] ;
 wire \my_game.secret_p[3] ;
 wire \my_game.secret_used_p[0] ;
 wire \my_game.secret_used_p[1] ;
 wire \my_game.secret_used_p[2] ;
 wire \my_game.secret_used_p[3] ;
 wire \my_game.state_p[0] ;
 wire \my_game.state_p[1] ;
 wire \my_game.state_p[2] ;
 wire \my_game.state_p[3] ;
 wire \my_game.state_p[4] ;
 wire \my_game.state_p[5] ;
 wire \my_game.state_p[6] ;
 wire \my_game.state_p[7] ;
 wire \my_game.valid_n ;
 wire \my_game.valid_o ;
 wire \my_game.win_o ;
 wire net1;
 wire net2;
 wire net3;
 ...
 sky130_fd_sc_hd__inv_2 _108_ (.A(net6),
    ...
    .VPWR(VPWR),
    .Y(_098_));
 sky130_fd_sc_hd__inv_2 _109_ (.A(\my_game.state_p[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_099_));
 sky130_fd_sc_hd__inv_2 _110_ (.A(\my_game.secret_used_p[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_100_));
 sky130_fd_sc_hd__inv_2 _111_ (.A(uo_out[0]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_101_));
 sky130_fd_sc_hd__inv_2 _112_ (.A(uo_out[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_102_));
 sky130_fd_sc_hd__inv_2 _113_ (.A(uo_out[4]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_103_));
 sky130_fd_sc_hd__o31a_2 _114_ (.A1(net35),
    .A2(\my_game.state_p[0] ),
    .A3(net53),
    .B1(net6),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_002_));
 sky130_fd_sc_hd__nand2_2 _115_ (.A(\my_game.idx_p[0] ),
    .B(\my_game.idx_p[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_104_));
 sky130_fd_sc_hd__and3_2 _116_ (.A(net12),
    .B(\my_game.idx_p[0] ),
    .C(\my_game.idx_p[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_001_));
 sky130_fd_sc_hd__and2_2 _117_ (.A(net58),
    .B(_098_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_000_));
 sky130_fd_sc_hd__and3_2 _118_ (.A(_101_),
    .B(_102_),
    .C(uo_out[2]),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(\my_game.win_o ));
 sky130_fd_sc_hd__or2_2 _119_ (.A(\my_game.guess_counter_p[1] ),
    .B(\my_game.guess_counter_p[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_105_));
 sky130_fd_sc_hd__a211oi_2 _120_ (.A1(\my_game.guess_counter_p[2] ),
    .A2(_105_),
    .B1(\my_game.win_o ),
    .C1(\my_game.guess_counter_p[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_106_));
 sky130_fd_sc_hd__inv_2 _121_ (.A(_106_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_107_));
 sky130_fd_sc_hd__a22o_2 _122_ (.A1(net35),
    .A2(_098_),
    .B1(net46),
    .B2(_107_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_006_));
 sky130_fd_sc_hd__a22oi_2 _123_ (.A1(\my_game.state_p[6] ),
    .A2(_098_),
    .B1(net46),
    .B2(_106_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_036_));
 sky130_fd_sc_hd__o21bai_2 _124_ (.A1(net7),
    .A2(_036_),
    .B1_N(net49),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_005_));
 sky130_fd_sc_hd__and2b_2 _125_ (.A_N(_036_),
    .B(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_004_));
 sky130_fd_sc_hd__a21o_2 _126_ (.A1(\my_game.state_p[1] ),
    .A2(_104_),
    .B1(net45),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_003_));
 sky130_fd_sc_hd__or2_2 _127_ (.A(net13),
    .B(\my_game.state_p[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_037_));
 sky130_fd_sc_hd__or3_2 _128_ (.A(\my_game.state_p[4] ),
    .B(\my_game.state_p[2] ),
    .C(_037_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(\my_game.busy_o ));
 sky130_fd_sc_hd__nor4_2 _129_ (.A(net35),
    .B(\my_game.state_p[0] ),
    .C(\my_game.state_p[6] ),
    .D(\my_game.busy_o ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(\my_game.valid_n ));
 sky130_fd_sc_hd__nand2b_2 _130_ (.A_N(\my_game.idx_p[0] ),
    .B(\my_game.idx_p[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_038_));
 sky130_fd_sc_hd__inv_2 _131_ (.A(_038_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_039_));
 sky130_fd_sc_hd__nor2_2 _132_ (.A(\my_game.idx_p[0] ),
    .B(\my_game.idx_p[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_040_));
 sky130_fd_sc_hd__nand2b_2 _133_ (.A_N(\my_game.idx_p[1] ),
    .B(\my_game.idx_p[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_041_));
 sky130_fd_sc_hd__mux4_2 _134_ (.A0(\my_game.guess_p[0] ),
    .A1(\my_game.guess_p[1] ),
    .A2(\my_game.guess_p[2] ),
    .A3(\my_game.guess_p[3] ),
    .S0(\my_game.idx_p[0] ),
    .S1(\my_game.idx_p[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_042_));
 sky130_fd_sc_hd__mux4_2 _135_ (.A0(\my_game.secret_p[0] ),
    .A1(\my_game.secret_p[1] ),
    .A2(\my_game.secret_p[2] ),
    .A3(\my_game.secret_p[3] ),
    .S0(\my_game.idx_p[0] ),
    .S1(\my_game.idx_p[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_043_));
 sky130_fd_sc_hd__xor2_2 _136_ (.A(_042_),
    .B(_043_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_044_));
 sky130_fd_sc_hd__or3_2 _137_ (.A(\my_game.state_p[7] ),
    .B(\my_game.state_p[6] ),
    .C(\my_game.state_p[3] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_045_));
 sky130_fd_sc_hd__a211o_2 _138_ (.A1(\my_game.state_p[1] ),
    .A2(_044_),
    .B1(_045_),
    .C1(net12),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_046_));
 sky130_fd_sc_hd__or2_2 _139_ (.A(\my_game.state_p[4] ),
    .B(_046_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_047_));
 sky130_fd_sc_hd__or2_2 _140_ (.A(\my_game.state_p[1] ),
    .B(_047_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_048_));
 sky130_fd_sc_hd__or2_2 _141_ (.A(\my_game.state_p[4] ),
    .B(_045_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_049_));
 sky130_fd_sc_hd__mux4_2 _142_ (.A0(\my_game.guess_used_p[0] ),
    .A1(\my_game.guess_used_p[1] ),
    .A2(\my_game.guess_used_p[2] ),
    .A3(\my_game.guess_used_p[3] ),
    .S0(\my_game.idx_p[0] ),
    .S1(\my_game.idx_p[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_050_));
 sky130_fd_sc_hd__and2_2 _143_ (.A(net12),
    .B(_050_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_051_));
 sky130_fd_sc_hd__a211o_2 _144_ (.A1(\my_game.state_p[1] ),
    .A2(_044_),
    .B1(_049_),
    .C1(_051_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_052_));
 sky130_fd_sc_hd__inv_2 _145_ (.A(_052_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_053_));
 sky130_fd_sc_hd__xnor2_2 _146_ (.A(\my_game.secret_p[0] ),
    .B(_042_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_054_));
 sky130_fd_sc_hd__xor2_2 _147_ (.A(\my_game.secret_p[1] ),
    .B(_042_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_055_));
 sky130_fd_sc_hd__a2bb2o_2 _148_ (.A1_N(\my_game.secret_used_p[1] ),
    .A2_N(_055_),
    .B1(_100_),
    .B2(_054_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_056_));
 sky130_fd_sc_hd__a21oi_2 _149_ (.A1(net12),
    .A2(_056_),
    .B1(_052_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_057_));
 sky130_fd_sc_hd__xor2_2 _150_ (.A(\my_game.secret_p[3] ),
    .B(_042_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_058_));
 sky130_fd_sc_hd__nor2_2 _151_ (.A(\my_game.secret_used_p[3] ),
    .B(_058_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_059_));
 sky130_fd_sc_hd__xor2_2 _152_ (.A(\my_game.secret_p[2] ),
    .B(_042_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_060_));
 sky130_fd_sc_hd__o21ai_2 _153_ (.A1(\my_game.secret_used_p[2] ),
    .A2(_060_),
    .B1(net12),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_061_));
 sky130_fd_sc_hd__o32a_2 _154_ (.A1(\my_game.secret_used_p[3] ),
    .A2(_058_),
    .A3(_061_),
    .B1(_104_),
    .B2(net12),
    ...
    .VPWR(VPWR),
    .X(_062_));
 sky130_fd_sc_hd__a211oi_2 _155_ (.A1(net12),
    .A2(_056_),
    .B1(_062_),
    .C1(_052_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_063_));
 sky130_fd_sc_hd__o21a_2 _156_ (.A1(net50),
    .A2(_063_),
    .B1(_048_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_007_));
 sky130_fd_sc_hd__nor3_2 _157_ (.A(\my_game.idx_p[0] ),
    .B(\my_game.idx_p[1] ),
    .C(_047_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_064_));
 sky130_fd_sc_hd__o21a_2 _158_ (.A1(net39),
    .A2(_064_),
    .B1(_048_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_008_));
 sky130_fd_sc_hd__nor2_2 _159_ (.A(_041_),
    .B(_047_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_065_));
 sky130_fd_sc_hd__o21a_2 _160_ (.A1(net43),
    .A2(_065_),
    .B1(_048_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_009_));
 sky130_fd_sc_hd__nor2_2 _161_ (.A(_038_),
    .B(_047_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_066_));
 sky130_fd_sc_hd__o21a_2 _162_ (.A1(net44),
    .A2(_066_),
    .B1(_048_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_010_));
 sky130_fd_sc_hd__nor2_2 _163_ (.A(_104_),
    .B(_047_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_067_));
 sky130_fd_sc_hd__o21a_2 _164_ (.A1(net38),
    .A2(_067_),
    .B1(_048_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_011_));
 sky130_fd_sc_hd__nor2_2 _165_ (.A(_037_),
    .B(_045_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_068_));
 sky130_fd_sc_hd__or2_2 _166_ (.A(_037_),
    .B(_045_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_069_));
 sky130_fd_sc_hd__and2_2 _167_ (.A(\my_game.state_p[2] ),
    .B(_068_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_070_));
 sky130_fd_sc_hd__mux2_1 _168_ (.A0(_070_),
    .A1(_069_),
    .S(\my_game.guess_counter_p[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_012_));
 sky130_fd_sc_hd__nand2_2 _169_ (.A(\my_game.guess_counter_p[1] ),
    .B(\my_game.guess_counter_p[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_071_));
 sky130_fd_sc_hd__a32o_2 _170_ (.A1(_105_),
    .A2(_070_),
    .A3(_071_),
    .B1(_069_),
    .B2(net54),
    ...
    .VPWR(VPWR),
    .X(_013_));
 sky130_fd_sc_hd__nand3_2 _171_ (.A(\my_game.guess_counter_p[2] ),
    .B(\my_game.guess_counter_p[1] ),
    .C(\my_game.guess_counter_p[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_072_));
 sky130_fd_sc_hd__a21o_2 _172_ (.A1(\my_game.state_p[2] ),
    .A2(_072_),
    .B1(_069_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_073_));
 sky130_fd_sc_hd__a31o_2 _173_ (.A1(\my_game.guess_counter_p[1] ),
    .A2(\my_game.guess_counter_p[0] ),
    .A3(_068_),
    .B1(\my_game.guess_counter_p[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_074_));
 sky130_fd_sc_hd__and2_2 _174_ (.A(_073_),
    .B(_074_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_014_));
 sky130_fd_sc_hd__nor2_2 _175_ (.A(\my_game.guess_counter_p[3] ),
    .B(_072_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_075_));
 sky130_fd_sc_hd__a22o_2 _176_ (.A1(net52),
    .A2(_073_),
    .B1(_075_),
    .B2(_070_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_015_));
 sky130_fd_sc_hd__and2b_2 _177_ (.A_N(_049_),
    .B(_037_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_076_));
 sky130_fd_sc_hd__mux2_1 _178_ (.A0(_076_),
    .A1(_049_),
    .S(\my_game.idx_p[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_016_));
 sky130_fd_sc_hd__nand2_2 _179_ (.A(_038_),
    .B(_041_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_077_));
 sky130_fd_sc_hd__a22o_2 _180_ (.A1(\my_game.idx_p[1] ),
    .A2(_049_),
    .B1(_076_),
    .B2(_077_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_017_));
 sky130_fd_sc_hd__nor2_2 _181_ (.A(_101_),
    .B(_046_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_2 _182_ (.A(_099_),
    ...
    .VPWR(VPWR),
    .Y(_079_));
 sky130_fd_sc_hd__o21ba_2 _183_ (.A1(uo_out[0]),
    .A2(_079_),
    .B1_N(_078_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_018_));
 sky130_fd_sc_hd__nand2_2 _184_ (.A(uo_out[0]),
    .B(uo_out[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_080_));
 sky130_fd_sc_hd__a21o_2 _185_ (.A1(\my_game.state_p[1] ),
    .A2(_080_),
    .B1(_046_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_081_));
 sky130_fd_sc_hd__o21a_2 _186_ (.A1(uo_out[1]),
    .A2(_078_),
    .B1(_081_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_019_));
 sky130_fd_sc_hd__nor2_2 _187_ (.A(uo_out[2]),
    .B(_080_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_082_));
 sky130_fd_sc_hd__a22o_2 _188_ (.A1(uo_out[2]),
    .A2(_081_),
    .B1(_082_),
    .B2(_079_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_020_));
 sky130_fd_sc_hd__nor3_2 _189_ (.A(\my_game.state_p[1] ),
    .B(_045_),
    .C(_051_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_083_));
 sky130_fd_sc_hd__o31a_2 _190_ (.A1(_056_),
    .A2(_059_),
    .A3(_061_),
    .B1(_083_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_084_));
 sky130_fd_sc_hd__nand2_2 _191_ (.A(uo_out[3]),
    .B(_084_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_085_));
 sky130_fd_sc_hd__and2_2 _192_ (.A(net13),
    .B(_084_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_086_));
 sky130_fd_sc_hd__o21a_2 _193_ (.A1(uo_out[3]),
    .A2(_086_),
    .B1(_085_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_021_));
 sky130_fd_sc_hd__nand2_2 _194_ (.A(uo_out[3]),
    .B(uo_out[4]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_087_));
 sky130_fd_sc_hd__a21bo_2 _195_ (.A1(net13),
    .A2(_087_),
    .B1_N(_084_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_088_));
 sky130_fd_sc_hd__a21boi_2 _196_ (.A1(_103_),
    .A2(_085_),
    .B1_N(_088_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_022_));
 sky130_fd_sc_hd__nor2_2 _197_ (.A(uo_out[5]),
    .B(_087_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_089_));
 sky130_fd_sc_hd__a22o_2 _198_ (.A1(uo_out[5]),
    .A2(_088_),
    .B1(_089_),
    .B2(_086_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_023_));
 sky130_fd_sc_hd__mux2_1 _199_ (.A0(\my_game.state_p[1] ),
    .A1(net13),
    .S(_104_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_024_));
 sky130_fd_sc_hd__or3_2 _200_ (.A(\my_game.state_p[0] ),
    .B(\my_game.state_p[2] ),
    .C(_069_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_090_));
 sky130_fd_sc_hd__mux2_1 _201_ (.A0(net8),
    .A1(net57),
    .S(_090_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_025_));
 sky130_fd_sc_hd__mux2_1 _202_ (.A0(net9),
    .A1(net59),
    .S(_090_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_026_));
 sky130_fd_sc_hd__mux2_1 _203_ (.A0(net10),
    .A1(net55),
    .S(_090_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _204_ (.A0(net11),
    ...
    .VPWR(VPWR),
    .X(_028_));
 sky130_fd_sc_hd__or3_2 _205_ (.A(\my_game.state_p[0] ),
    .B(\my_game.state_p[4] ),
    .C(_069_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _206_ (.A0(net2),
    ...
    .VPWR(VPWR),
    .X(_029_));
 sky130_fd_sc_hd__mux2_1 _207_ (.A0(net3),
    .A1(net40),
    .S(_091_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _208_ (.A0(net4),
    ...
    .VPWR(VPWR),
    .X(_031_));
 sky130_fd_sc_hd__mux2_1 _209_ (.A0(net5),
    .A1(net37),
    .S(_091_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_032_));
 sky130_fd_sc_hd__a21bo_2 _210_ (.A1(_100_),
    .A2(_054_),
    .B1_N(net12),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_092_));
 sky130_fd_sc_hd__o211a_2 _211_ (.A1(net12),
    .A2(_040_),
    .B1(_053_),
    .C1(_092_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_093_));
 sky130_fd_sc_hd__o21a_2 _212_ (.A1(net47),
    .A2(_093_),
    .B1(_048_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_033_));
 sky130_fd_sc_hd__o32a_2 _213_ (.A1(\my_game.secret_used_p[1] ),
    .A2(_055_),
    .A3(_092_),
    .B1(_041_),
    .B2(net13),
    ...
    .VPWR(VPWR),
    .X(_094_));
 sky130_fd_sc_hd__nor2_2 _214_ (.A(_052_),
    .B(_094_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_095_));
 sky130_fd_sc_hd__o21a_2 _215_ (.A1(net48),
    .A2(_095_),
    .B1(_048_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_034_));
 sky130_fd_sc_hd__nand2_2 _216_ (.A(_057_),
    .B(_061_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_096_));
 sky130_fd_sc_hd__o31a_2 _217_ (.A1(net12),
    .A2(\my_game.secret_used_p[2] ),
    .A3(_039_),
    .B1(_037_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_097_));
 sky130_fd_sc_hd__mux2_1 _218_ (.A0(_097_),
    .A1(net51),
    .S(_096_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_035_));
 sky130_fd_sc_hd__dfrtp_2 _219_ (.CLK(clknet_3_5__leaf_clk),
    .D(_007_),
    .RESET_B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\my_game.secret_used_p[3] ));
 sky130_fd_sc_hd__dfrtp_2 _220_ (.CLK(clknet_3_5__leaf_clk),
    .D(_008_),
    .RESET_B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\my_game.guess_used_p[0] ));
 sky130_fd_sc_hd__dfrtp_2 _221_ (.CLK(clknet_3_5__leaf_clk),
    .D(_009_),
    .RESET_B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\my_game.guess_used_p[1] ));
 sky130_fd_sc_hd__dfrtp_2 _222_ (.CLK(clknet_3_4__leaf_clk),
    .D(_010_),
    .RESET_B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\my_game.guess_used_p[2] ));
 sky130_fd_sc_hd__dfrtp_2 _223_ (.CLK(clknet_3_4__leaf_clk),
    .D(_011_),
    .RESET_B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\my_game.guess_used_p[3] ));
 sky130_fd_sc_hd__dfrtp_2 _224_ (.CLK(clknet_3_1__leaf_clk),
    .D(_012_),
    .RESET_B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\my_game.guess_counter_p[0] ));
 sky130_fd_sc_hd__dfrtp_2 _225_ (.CLK(clknet_3_1__leaf_clk),
    .D(_013_),
    .RESET_B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\my_game.guess_counter_p[1] ));
 sky130_fd_sc_hd__dfrtp_2 _226_ (.CLK(clknet_3_0__leaf_clk),
    .D(_014_),
    .RESET_B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\my_game.guess_counter_p[2] ));
 sky130_fd_sc_hd__dfrtp_2 _227_ (.CLK(clknet_3_0__leaf_clk),
    .D(_015_),
    .RESET_B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\my_game.guess_counter_p[3] ));
 sky130_fd_sc_hd__dfrtp_2 _228_ (.CLK(clknet_3_4__leaf_clk),
    .D(_016_),
    .RESET_B(net20),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\my_game.idx_p[0] ));
 sky130_fd_sc_hd__dfrtp_2 _229_ (.CLK(clknet_3_4__leaf_clk),
    .D(_017_),
    .RESET_B(net20),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\my_game.idx_p[1] ));
 sky130_fd_sc_hd__dfrtp_2 _230_ (.CLK(clknet_3_0__leaf_clk),
    .D(_018_),
    .RESET_B(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[0]));
 sky130_fd_sc_hd__dfrtp_2 _231_ (.CLK(clknet_3_2__leaf_clk),
    .D(_019_),
    .RESET_B(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[1]));
 sky130_fd_sc_hd__dfrtp_2 _232_ (.CLK(clknet_3_0__leaf_clk),
    .D(_020_),
    .RESET_B(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[2]));
 sky130_fd_sc_hd__dfrtp_2 _233_ (.CLK(clknet_3_2__leaf_clk),
    .D(_021_),
    .RESET_B(net17),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _235_ (.CLK(clknet_3_2__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(uo_out[5]));
 sky130_fd_sc_hd__dfstp_2 _236_ (.CLK(clknet_3_3__leaf_clk),
    .D(_000_),
    .SET_B(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\my_game.state_p[0] ));
 sky130_fd_sc_hd__dfrtp_2 _237_ (.CLK(clknet_3_1__leaf_clk),
    .D(_003_),
    .RESET_B(net14),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\my_game.state_p[1] ));
 sky130_fd_sc_hd__dfrtp_2 _238_ (.CLK(clknet_3_3__leaf_clk),
    .D(_004_),
    .RESET_B(net14),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\my_game.state_p[2] ));
 sky130_fd_sc_hd__dfrtp_2 _239_ (.CLK(clknet_3_0__leaf_clk),
    .D(_001_),
    .RESET_B(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\my_game.state_p[3] ));
 sky130_fd_sc_hd__dfrtp_2 _240_ (.CLK(clknet_3_3__leaf_clk),
    .D(_002_),
    .RESET_B(net15),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _241_ (.CLK(clknet_3_3__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\my_game.state_p[6] ));
 sky130_fd_sc_hd__dfrtp_2 _242_ (.CLK(clknet_3_1__leaf_clk),
    .D(_006_),
    .RESET_B(net15),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _243_ (.CLK(clknet_3_2__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\my_game.valid_o ));
 sky130_fd_sc_hd__dfrtp_2 _244_ (.CLK(clknet_3_1__leaf_clk),
    .D(_024_),
    .RESET_B(net14),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\my_game.state_p[5] ));
 sky130_fd_sc_hd__dfrtp_2 _245_ (.CLK(clknet_3_6__leaf_clk),
    .D(_025_),
    .RESET_B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\my_game.secret_p[0] ));
 sky130_fd_sc_hd__dfrtp_2 _246_ (.CLK(clknet_3_6__leaf_clk),
    .D(_026_),
    .RESET_B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\my_game.secret_p[1] ));
 sky130_fd_sc_hd__dfrtp_2 _247_ (.CLK(clknet_3_6__leaf_clk),
    .D(_027_),
    .RESET_B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\my_game.secret_p[2] ));
 sky130_fd_sc_hd__dfrtp_2 _248_ (.CLK(clknet_3_6__leaf_clk),
    .D(_028_),
    .RESET_B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\my_game.secret_p[3] ));
 sky130_fd_sc_hd__dfrtp_2 _249_ (.CLK(clknet_3_7__leaf_clk),
    .D(_029_),
    .RESET_B(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\my_game.guess_p[0] ));
 sky130_fd_sc_hd__dfrtp_2 _250_ (.CLK(clknet_3_7__leaf_clk),
    .D(_030_),
    .RESET_B(net19),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\my_game.guess_p[1] ));
 sky130_fd_sc_hd__dfrtp_2 _251_ (.CLK(clknet_3_7__leaf_clk),
    .D(_031_),
    .RESET_B(net19),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\my_game.guess_p[2] ));
 sky130_fd_sc_hd__dfrtp_2 _252_ (.CLK(clknet_3_6__leaf_clk),
    .D(_032_),
    .RESET_B(net19),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\my_game.guess_p[3] ));
 sky130_fd_sc_hd__dfrtp_2 _253_ (.CLK(clknet_3_7__leaf_clk),
    .D(_033_),
    .RESET_B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\my_game.secret_used_p[0] ));
 sky130_fd_sc_hd__dfrtp_2 _254_ (.CLK(clknet_3_5__leaf_clk),
    .D(_034_),
    .RESET_B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\my_game.secret_used_p[1] ));
 sky130_fd_sc_hd__dfrtp_2 _255_ (.CLK(clknet_3_4__leaf_clk),
    .D(_035_),
    .RESET_B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\my_game.secret_used_p[2] ));
 sky130_fd_sc_hd__buf_2 _271_ (.A(\my_game.win_o ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[7]));
 sky130_fd_sc_hd__buf_2 _272_ (.A(\my_game.busy_o ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[6]));
 sky130_fd_sc_hd__buf_2 _273_ (.A(\my_game.valid_o ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout12 (.A(net13),
    ...
    .VPWR(VPWR),
    .X(net12));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout13 (.A(\my_game.state_p[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout20 (.A(net1),
    ...
    .VPWR(VPWR),
    .X(net20));
 sky130_fd_sc_hd__dlygate4sd3_1 hold35 (.A(\my_game.state_p[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net35));
 sky130_fd_sc_hd__dlygate4sd3_1 hold36 (.A(\my_game.valid_n ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net36));
 sky130_fd_sc_hd__dlygate4sd3_1 hold37 (.A(\my_game.guess_p[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net37));
 sky130_fd_sc_hd__dlygate4sd3_1 hold38 (.A(\my_game.guess_used_p[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net38));
 sky130_fd_sc_hd__dlygate4sd3_1 hold39 (.A(\my_game.guess_used_p[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net39));
 sky130_fd_sc_hd__dlygate4sd3_1 hold40 (.A(\my_game.guess_p[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net40));
 sky130_fd_sc_hd__dlygate4sd3_1 hold41 (.A(\my_game.guess_p[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net41));
 sky130_fd_sc_hd__dlygate4sd3_1 hold42 (.A(\my_game.guess_p[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net42));
 sky130_fd_sc_hd__dlygate4sd3_1 hold43 (.A(\my_game.guess_used_p[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net43));
 sky130_fd_sc_hd__dlygate4sd3_1 hold44 (.A(\my_game.guess_used_p[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net44));
 sky130_fd_sc_hd__dlygate4sd3_1 hold45 (.A(\my_game.state_p[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net45));
 sky130_fd_sc_hd__dlygate4sd3_1 hold46 (.A(\my_game.state_p[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net46));
 sky130_fd_sc_hd__dlygate4sd3_1 hold47 (.A(\my_game.secret_used_p[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net47));
 sky130_fd_sc_hd__dlygate4sd3_1 hold48 (.A(\my_game.secret_used_p[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net48));
 sky130_fd_sc_hd__dlygate4sd3_1 hold49 (.A(\my_game.state_p[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net49));
 sky130_fd_sc_hd__dlygate4sd3_1 hold50 (.A(\my_game.secret_used_p[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net50));
 sky130_fd_sc_hd__dlygate4sd3_1 hold51 (.A(\my_game.secret_used_p[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net51));
 sky130_fd_sc_hd__dlygate4sd3_1 hold52 (.A(\my_game.guess_counter_p[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net52));
 sky130_fd_sc_hd__dlygate4sd3_1 hold53 (.A(\my_game.state_p[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net53));
 sky130_fd_sc_hd__dlygate4sd3_1 hold54 (.A(\my_game.guess_counter_p[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net54));
 sky130_fd_sc_hd__dlygate4sd3_1 hold55 (.A(\my_game.secret_p[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net55));
 sky130_fd_sc_hd__dlygate4sd3_1 hold56 (.A(\my_game.secret_p[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net56));
 sky130_fd_sc_hd__dlygate4sd3_1 hold57 (.A(\my_game.secret_p[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net57));
 sky130_fd_sc_hd__dlygate4sd3_1 hold58 (.A(\my_game.state_p[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net58));
 sky130_fd_sc_hd__dlygate4sd3_1 hold59 (.A(\my_game.secret_p[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 load_slew19 (.A(net18),
    ...
    .VPWR(VPWR),
    .X(net19));
 sky130_fd_sc_hd__conb_1 tt_um_enrico_glr (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 tt_um_enrico_glr_21 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net21));
 sky130_fd_sc_hd__conb_1 tt_um_enrico_glr_22 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net22));
 sky130_fd_sc_hd__conb_1 tt_um_enrico_glr_23 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net23));
 sky130_fd_sc_hd__conb_1 tt_um_enrico_glr_24 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net24));
 sky130_fd_sc_hd__conb_1 tt_um_enrico_glr_25 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net25));
 sky130_fd_sc_hd__conb_1 tt_um_enrico_glr_26 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net26));
 sky130_fd_sc_hd__conb_1 tt_um_enrico_glr_27 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net27));
 sky130_fd_sc_hd__conb_1 tt_um_enrico_glr_28 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net28));
 sky130_fd_sc_hd__conb_1 tt_um_enrico_glr_29 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net29));
 sky130_fd_sc_hd__conb_1 tt_um_enrico_glr_30 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net30));
 sky130_fd_sc_hd__conb_1 tt_um_enrico_glr_31 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net31));
 sky130_fd_sc_hd__conb_1 tt_um_enrico_glr_32 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net32));
 sky130_fd_sc_hd__conb_1 tt_um_enrico_glr_33 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net33));
 sky130_fd_sc_hd__conb_1 tt_um_enrico_glr_34 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net34));
