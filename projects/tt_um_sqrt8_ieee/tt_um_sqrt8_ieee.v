module tt_um_sqrt8_ieee (clk,
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_137 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _197_ (.A(net56),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_048_));
 sky130_fd_sc_hd__inv_2 _198_ (.A(net52),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_049_));
 sky130_fd_sc_hd__inv_2 _199_ (.A(\core.q[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_050_));
 sky130_fd_sc_hd__inv_2 _200_ (.A(\core.rem[13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_051_));
 sky130_fd_sc_hd__inv_2 _201_ (.A(\core.tmp[14] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_052_));
 sky130_fd_sc_hd__inv_2 _202_ (.A(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_053_));
 sky130_fd_sc_hd__inv_2 _203_ (.A(\core.state[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_054_));
 sky130_fd_sc_hd__nand4_2 _204_ (.A(net53),
    .B(net54),
    .C(\core.i[1] ),
    .D(\core.i[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_055_));
 sky130_fd_sc_hd__nand2_2 _205_ (.A(net28),
    .B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_056_));
 sky130_fd_sc_hd__nor2_2 _206_ (.A(_055_),
    .B(_056_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_000_));
 sky130_fd_sc_hd__a22o_2 _207_ (.A1(\core.state[0] ),
    .A2(net10),
    .B1(_055_),
    .B2(net21),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_057_));
 sky130_fd_sc_hd__and2_2 _208_ (.A(net26),
    .B(_057_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_002_));
 sky130_fd_sc_hd__o21ai_2 _209_ (.A1(_054_),
    .A2(net10),
    .B1(net28),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_058_));
 sky130_fd_sc_hd__or2_2 _210_ (.A(net22),
    .B(_058_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_001_));
 sky130_fd_sc_hd__o211a_2 _211_ (.A1(_054_),
    .A2(net10),
    .B1(_055_),
    .C1(net21),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_059_));
 sky130_fd_sc_hd__inv_2 _212_ (.A(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_060_));
 sky130_fd_sc_hd__a31oi_2 _213_ (.A1(_053_),
    .A2(\core.state[0] ),
    .A3(net10),
    .B1(net19),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_061_));
 sky130_fd_sc_hd__a31o_2 _214_ (.A1(_053_),
    .A2(\core.state[0] ),
    .A3(net10),
    .B1(net19),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_062_));
 sky130_fd_sc_hd__a21o_2 _215_ (.A1(_053_),
    .A2(net2),
    .B1(net16),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_063_));
 sky130_fd_sc_hd__o211a_2 _216_ (.A1(net48),
    .A2(net13),
    .B1(_063_),
    .C1(net26),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_003_));
 sky130_fd_sc_hd__a21o_2 _217_ (.A1(_053_),
    .A2(net3),
    .B1(net16),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_064_));
 sky130_fd_sc_hd__o211a_2 _218_ (.A1(net46),
    .A2(net13),
    .B1(_064_),
    .C1(net26),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_004_));
 sky130_fd_sc_hd__mux2_1 _219_ (.A0(net4),
    .A1(\core.tmp[8] ),
    .S(net21),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_065_));
 sky130_fd_sc_hd__or2_2 _220_ (.A(net16),
    .B(_065_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_066_));
 sky130_fd_sc_hd__o211a_2 _221_ (.A1(net49),
    .A2(net13),
    .B1(_066_),
    .C1(net26),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _222_ (.A0(net5),
    ...
    .VPWR(VPWR),
    .X(_067_));
 sky130_fd_sc_hd__or2_2 _223_ (.A(net16),
    .B(_067_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_068_));
 sky130_fd_sc_hd__o211a_2 _224_ (.A1(net47),
    .A2(net13),
    .B1(_068_),
    .C1(net27),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_006_));
 sky130_fd_sc_hd__mux2_1 _225_ (.A0(net6),
    .A1(\core.tmp[10] ),
    .S(net21),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_069_));
 sky130_fd_sc_hd__or2_2 _226_ (.A(net16),
    .B(_069_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_070_));
 sky130_fd_sc_hd__o211a_2 _227_ (.A1(net50),
    .A2(net13),
    .B1(_070_),
    .C1(net27),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _228_ (.A0(net7),
    ...
    .VPWR(VPWR),
    .X(_071_));
 sky130_fd_sc_hd__or2_2 _229_ (.A(net17),
    .B(_071_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_072_));
 sky130_fd_sc_hd__o211a_2 _230_ (.A1(net45),
    .A2(net13),
    .B1(_072_),
    .C1(net28),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_008_));
 sky130_fd_sc_hd__mux2_1 _231_ (.A0(net8),
    .A1(\core.tmp[12] ),
    .S(net21),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_073_));
 sky130_fd_sc_hd__or2_2 _232_ (.A(net16),
    .B(_073_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_074_));
 sky130_fd_sc_hd__o211a_2 _233_ (.A1(net51),
    .A2(net13),
    .B1(_074_),
    .C1(net27),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _234_ (.A0(net9),
    ...
    .VPWR(VPWR),
    .X(_075_));
 sky130_fd_sc_hd__or2_2 _235_ (.A(net17),
    .B(_075_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_076_));
 sky130_fd_sc_hd__o211a_2 _236_ (.A1(net55),
    .A2(net13),
    .B1(_076_),
    .C1(net28),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_010_));
 sky130_fd_sc_hd__nand2_2 _237_ (.A(\core.i[0] ),
    .B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_077_));
 sky130_fd_sc_hd__o211a_2 _238_ (.A1(\core.i[0] ),
    .A2(net13),
    .B1(_077_),
    .C1(net26),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_011_));
 sky130_fd_sc_hd__xnor2_2 _239_ (.A(\core.i[1] ),
    .B(\core.i[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_078_));
 sky130_fd_sc_hd__o221a_2 _240_ (.A1(\core.i[1] ),
    .A2(net13),
    .B1(_078_),
    .B2(_060_),
    .C1(net26),
    ...
    .VPWR(VPWR),
    .X(_012_));
 sky130_fd_sc_hd__or3_2 _241_ (.A(\core.i[2] ),
    .B(\core.i[1] ),
    .C(\core.i[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_079_));
 sky130_fd_sc_hd__a21oi_2 _242_ (.A1(\core.state[2] ),
    .A2(_079_),
    .B1(net16),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_080_));
 sky130_fd_sc_hd__o31a_2 _243_ (.A1(\core.i[1] ),
    .A2(\core.i[0] ),
    .A3(net17),
    .B1(net54),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_081_));
 sky130_fd_sc_hd__o21a_2 _244_ (.A1(_080_),
    .A2(_081_),
    .B1(net27),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_013_));
 sky130_fd_sc_hd__nand2_2 _245_ (.A(net53),
    .B(_080_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_082_));
 sky130_fd_sc_hd__or2_2 _246_ (.A(_060_),
    .B(_079_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_083_));
 sky130_fd_sc_hd__inv_2 _247_ (.A(_083_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_084_));
 sky130_fd_sc_hd__o211a_2 _248_ (.A1(net53),
    .A2(_084_),
    .B1(_082_),
    .C1(net27),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_014_));
 sky130_fd_sc_hd__mux2_1 _249_ (.A0(uo_out[0]),
    .A1(\core.q[0] ),
    .S(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_085_));
 sky130_fd_sc_hd__and2_2 _250_ (.A(net24),
    .B(_085_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_015_));
 sky130_fd_sc_hd__o21ai_2 _251_ (.A1(net43),
    .A2(uo_out[1]),
    .B1(net28),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_2 _252_ (.A1(_050_),
    ...
    .VPWR(VPWR),
    .Y(_016_));
 sky130_fd_sc_hd__mux2_1 _253_ (.A0(uo_out[2]),
    .A1(\core.q[2] ),
    .S(\core.state[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_087_));
 sky130_fd_sc_hd__and2_2 _254_ (.A(net24),
    .B(_087_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_017_));
 sky130_fd_sc_hd__mux2_1 _255_ (.A0(uo_out[3]),
    .A1(\core.q[3] ),
    .S(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_088_));
 sky130_fd_sc_hd__and2_2 _256_ (.A(net24),
    .B(_088_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_018_));
 sky130_fd_sc_hd__mux2_1 _257_ (.A0(uo_out[4]),
    .A1(\core.q[4] ),
    .S(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_089_));
 sky130_fd_sc_hd__and2_2 _258_ (.A(net23),
    .B(_089_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_019_));
 sky130_fd_sc_hd__o21ai_2 _259_ (.A1(net22),
    .A2(uo_out[5]),
    .B1(net24),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_090_));
 sky130_fd_sc_hd__a21oi_2 _260_ (.A1(_049_),
    .A2(net22),
    .B1(_090_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_020_));
 sky130_fd_sc_hd__mux2_1 _261_ (.A0(uo_out[6]),
    .A1(\core.q[6] ),
    .S(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_091_));
 sky130_fd_sc_hd__and2_2 _262_ (.A(net23),
    .B(_091_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_021_));
 sky130_fd_sc_hd__o21ai_2 _263_ (.A1(net22),
    .A2(uo_out[7]),
    .B1(net24),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_092_));
 sky130_fd_sc_hd__a21oi_2 _264_ (.A1(_048_),
    .A2(net22),
    .B1(_092_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_022_));
 sky130_fd_sc_hd__a21o_2 _265_ (.A1(net58),
    .A2(_054_),
    .B1(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_093_));
 sky130_fd_sc_hd__and2_2 _266_ (.A(net23),
    .B(_093_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_023_));
 sky130_fd_sc_hd__xnor2_2 _267_ (.A(\core.q[7] ),
    .B(\core.rem[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_094_));
 sky130_fd_sc_hd__nand2b_2 _268_ (.A_N(\core.q[2] ),
    .B(\core.rem[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_095_));
 sky130_fd_sc_hd__xnor2_2 _269_ (.A(\core.q[2] ),
    .B(\core.rem[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_096_));
 sky130_fd_sc_hd__or2_2 _270_ (.A(_050_),
    .B(\core.rem[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_097_));
 sky130_fd_sc_hd__and2b_2 _271_ (.A_N(\core.q[0] ),
    .B(\core.rem[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_098_));
 sky130_fd_sc_hd__xnor2_2 _272_ (.A(\core.q[0] ),
    .B(\core.rem[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_099_));
 sky130_fd_sc_hd__or2_2 _273_ (.A(\core.tmp[15] ),
    .B(\core.tmp[14] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_100_));
 sky130_fd_sc_hd__nand2_2 _274_ (.A(_050_),
    .B(\core.rem[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_101_));
 sky130_fd_sc_hd__a221o_2 _275_ (.A1(_050_),
    .A2(\core.rem[1] ),
    .B1(_099_),
    .B2(_100_),
    .C1(_098_),
    ...
    .VPWR(VPWR),
    .X(_102_));
 sky130_fd_sc_hd__nand3_2 _276_ (.A(_096_),
    .B(_097_),
    .C(_102_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_103_));
 sky130_fd_sc_hd__nand2b_2 _277_ (.A_N(\core.q[3] ),
    .B(\core.rem[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_104_));
 sky130_fd_sc_hd__and2b_2 _278_ (.A_N(\core.rem[3] ),
    .B(\core.q[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_105_));
 sky130_fd_sc_hd__xnor2_2 _279_ (.A(\core.q[3] ),
    .B(\core.rem[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_106_));
 sky130_fd_sc_hd__nand2b_2 _280_ (.A_N(\core.q[4] ),
    .B(\core.rem[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_107_));
 sky130_fd_sc_hd__xor2_2 _281_ (.A(\core.q[4] ),
    .B(\core.rem[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_108_));
 sky130_fd_sc_hd__xor2_2 _282_ (.A(\core.q[5] ),
    .B(\core.rem[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_109_));
 sky130_fd_sc_hd__nor2_2 _283_ (.A(_108_),
    .B(_109_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_110_));
 sky130_fd_sc_hd__and2_2 _284_ (.A(_096_),
    .B(_106_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_111_));
 sky130_fd_sc_hd__and4_2 _285_ (.A(_097_),
    .B(_102_),
    .C(_110_),
    .D(_111_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_112_));
 sky130_fd_sc_hd__a21oi_2 _286_ (.A1(_095_),
    .A2(_104_),
    .B1(_105_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_113_));
 sky130_fd_sc_hd__o21ba_2 _287_ (.A1(_049_),
    .A2(\core.rem[5] ),
    .B1_N(_107_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_114_));
 sky130_fd_sc_hd__a221o_2 _288_ (.A1(_049_),
    .A2(\core.rem[5] ),
    .B1(_110_),
    .B2(_113_),
    .C1(_114_),
    ...
    .VPWR(VPWR),
    .X(_115_));
 sky130_fd_sc_hd__and2b_2 _289_ (.A_N(\core.rem[6] ),
    .B(\core.q[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_116_));
 sky130_fd_sc_hd__and2b_2 _290_ (.A_N(\core.q[6] ),
    .B(\core.rem[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_117_));
 sky130_fd_sc_hd__nor2_2 _291_ (.A(_116_),
    .B(_117_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_118_));
 sky130_fd_sc_hd__o21a_2 _292_ (.A1(_112_),
    .A2(_115_),
    .B1(_118_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_119_));
 sky130_fd_sc_hd__o21ai_2 _293_ (.A1(_048_),
    .A2(\core.rem[7] ),
    .B1(\core.rem[6] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_120_));
 sky130_fd_sc_hd__a2bb2o_2 _294_ (.A1_N(_120_),
    .A2_N(\core.q[6] ),
    .B1(_048_),
    .B2(\core.rem[7] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_121_));
 sky130_fd_sc_hd__or3_2 _295_ (.A(\core.rem[9] ),
    .B(\core.rem[8] ),
    .C(_121_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_122_));
 sky130_fd_sc_hd__a21o_2 _296_ (.A1(_094_),
    .A2(_119_),
    .B1(_122_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_123_));
 sky130_fd_sc_hd__or2_2 _297_ (.A(\core.rem[11] ),
    .B(\core.rem[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_124_));
 sky130_fd_sc_hd__a211o_2 _298_ (.A1(_094_),
    .A2(_119_),
    .B1(_122_),
    .C1(_124_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_125_));
 sky130_fd_sc_hd__or4_2 _299_ (.A(\core.rem[15] ),
    .B(\core.rem[14] ),
    .C(\core.rem[13] ),
    .D(\core.rem[12] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_126_));
 sky130_fd_sc_hd__inv_2 _300_ (.A(_126_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_127_));
 sky130_fd_sc_hd__a2111o_2 _301_ (.A1(_094_),
    .A2(_119_),
    .B1(_122_),
    .C1(_124_),
    .D1(_126_),
    ...
    .VPWR(VPWR),
    .X(_128_));
 sky130_fd_sc_hd__inv_2 _302_ (.A(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_129_));
 sky130_fd_sc_hd__xnor2_2 _303_ (.A(_052_),
    .B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_130_));
 sky130_fd_sc_hd__a22o_2 _304_ (.A1(\core.rem[0] ),
    .A2(net16),
    .B1(_130_),
    .B2(net19),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_131_));
 sky130_fd_sc_hd__and2_2 _305_ (.A(net26),
    .B(_131_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_024_));
 sky130_fd_sc_hd__nand3_2 _306_ (.A(\core.tmp[15] ),
    .B(_052_),
    .C(net12),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_132_));
 sky130_fd_sc_hd__a21o_2 _307_ (.A1(_052_),
    .A2(net12),
    .B1(\core.tmp[15] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_133_));
 sky130_fd_sc_hd__a32o_2 _308_ (.A1(net19),
    .A2(_132_),
    .A3(_133_),
    .B1(net17),
    .B2(\core.rem[1] ),
    ...
    .VPWR(VPWR),
    .X(_134_));
 sky130_fd_sc_hd__and2_2 _309_ (.A(net28),
    .B(_134_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_025_));
 sky130_fd_sc_hd__xor2_2 _310_ (.A(_099_),
    .B(_100_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_135_));
 sky130_fd_sc_hd__mux2_1 _311_ (.A0(\core.rem[0] ),
    .A1(_135_),
    .S(net12),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_136_));
 sky130_fd_sc_hd__a22o_2 _312_ (.A1(\core.rem[2] ),
    .A2(net14),
    .B1(_136_),
    .B2(net18),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and2_2 _313_ (.A(net24),
    ...
    .VPWR(VPWR),
    .X(_026_));
 sky130_fd_sc_hd__nand2_2 _314_ (.A(_097_),
    .B(_101_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_138_));
 sky130_fd_sc_hd__a21o_2 _315_ (.A1(_099_),
    .A2(_100_),
    .B1(_098_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_139_));
 sky130_fd_sc_hd__xnor2_2 _316_ (.A(_138_),
    .B(_139_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_140_));
 sky130_fd_sc_hd__mux2_1 _317_ (.A0(\core.rem[1] ),
    .A1(_140_),
    .S(net12),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_141_));
 sky130_fd_sc_hd__a22o_2 _318_ (.A1(\core.rem[3] ),
    .A2(net15),
    .B1(_141_),
    .B2(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_142_));
 sky130_fd_sc_hd__and2_2 _319_ (.A(net24),
    .B(_142_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_027_));
 sky130_fd_sc_hd__or2_2 _320_ (.A(\core.rem[2] ),
    .B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_143_));
 sky130_fd_sc_hd__a21o_2 _321_ (.A1(_097_),
    .A2(_102_),
    .B1(_096_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_144_));
 sky130_fd_sc_hd__a21bo_2 _322_ (.A1(_103_),
    .A2(_144_),
    .B1_N(net11),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_145_));
 sky130_fd_sc_hd__a32o_2 _323_ (.A1(net18),
    .A2(_143_),
    .A3(_145_),
    .B1(net14),
    .B2(\core.rem[4] ),
    ...
    .VPWR(VPWR),
    .X(_146_));
 sky130_fd_sc_hd__and2_2 _324_ (.A(net23),
    .B(_146_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_028_));
 sky130_fd_sc_hd__nand2_2 _325_ (.A(_095_),
    .B(_103_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_147_));
 sky130_fd_sc_hd__xor2_2 _326_ (.A(_106_),
    .B(_147_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_148_));
 sky130_fd_sc_hd__mux2_1 _327_ (.A0(\core.rem[3] ),
    .A1(_148_),
    .S(net11),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_149_));
 sky130_fd_sc_hd__a22o_2 _328_ (.A1(\core.rem[5] ),
    .A2(net14),
    .B1(_149_),
    .B2(net18),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_150_));
 sky130_fd_sc_hd__and2_2 _329_ (.A(net23),
    .B(_150_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_029_));
 sky130_fd_sc_hd__a31o_2 _330_ (.A1(_095_),
    .A2(_103_),
    .A3(_104_),
    .B1(_105_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_151_));
 sky130_fd_sc_hd__xor2_2 _331_ (.A(_108_),
    .B(_151_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_152_));
 sky130_fd_sc_hd__mux2_1 _332_ (.A0(\core.rem[4] ),
    .A1(_152_),
    .S(net11),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_153_));
 sky130_fd_sc_hd__a22o_2 _333_ (.A1(\core.rem[6] ),
    .A2(net14),
    .B1(_153_),
    .B2(net18),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_154_));
 sky130_fd_sc_hd__and2_2 _334_ (.A(net23),
    .B(_154_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_030_));
 sky130_fd_sc_hd__and2_2 _335_ (.A(\core.rem[7] ),
    .B(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_155_));
 sky130_fd_sc_hd__or2_2 _336_ (.A(\core.rem[5] ),
    .B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_156_));
 sky130_fd_sc_hd__o21a_2 _337_ (.A1(_108_),
    .A2(_151_),
    .B1(_107_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_157_));
 sky130_fd_sc_hd__xor2_2 _338_ (.A(_109_),
    .B(_157_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_158_));
 sky130_fd_sc_hd__o211a_2 _339_ (.A1(_129_),
    .A2(_158_),
    .B1(_156_),
    .C1(net18),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_159_));
 sky130_fd_sc_hd__o21a_2 _340_ (.A1(_155_),
    .A2(_159_),
    .B1(net23),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_031_));
 sky130_fd_sc_hd__nor3_2 _341_ (.A(_112_),
    .B(_115_),
    .C(_118_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_160_));
 sky130_fd_sc_hd__nor2_2 _342_ (.A(_119_),
    .B(_160_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_161_));
 sky130_fd_sc_hd__mux2_1 _343_ (.A0(\core.rem[6] ),
    .A1(_161_),
    .S(net11),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_162_));
 sky130_fd_sc_hd__a22o_2 _344_ (.A1(\core.rem[8] ),
    .A2(net15),
    .B1(_162_),
    .B2(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_163_));
 sky130_fd_sc_hd__and2_2 _345_ (.A(net24),
    .B(_163_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_032_));
 sky130_fd_sc_hd__and2_2 _346_ (.A(\core.rem[9] ),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_164_));
 sky130_fd_sc_hd__or3_2 _347_ (.A(_094_),
    .B(_117_),
    .C(_119_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_165_));
 sky130_fd_sc_hd__o21ai_2 _348_ (.A1(_117_),
    .A2(_119_),
    .B1(_094_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_166_));
 sky130_fd_sc_hd__a21bo_2 _349_ (.A1(_165_),
    .A2(_166_),
    .B1_N(net11),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_167_));
 sky130_fd_sc_hd__o211a_2 _350_ (.A1(\core.rem[7] ),
    .A2(net11),
    .B1(_167_),
    .C1(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_168_));
 sky130_fd_sc_hd__o21a_2 _351_ (.A1(_164_),
    .A2(_168_),
    .B1(net24),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_033_));
 sky130_fd_sc_hd__a21o_2 _352_ (.A1(_094_),
    .A2(_119_),
    .B1(_121_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_169_));
 sky130_fd_sc_hd__a211oi_2 _353_ (.A1(_094_),
    .A2(_119_),
    .B1(_121_),
    .C1(\core.rem[8] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_170_));
 sky130_fd_sc_hd__xnor2_2 _354_ (.A(\core.rem[8] ),
    .B(_169_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_171_));
 sky130_fd_sc_hd__a32o_2 _355_ (.A1(net19),
    .A2(net12),
    .A3(_171_),
    .B1(net17),
    .B2(\core.rem[10] ),
    ...
    .VPWR(VPWR),
    .X(_172_));
 sky130_fd_sc_hd__and2_2 _356_ (.A(net28),
    .B(_172_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_034_));
 sky130_fd_sc_hd__a21oi_2 _357_ (.A1(net12),
    .A2(_170_),
    .B1(\core.rem[9] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_173_));
 sky130_fd_sc_hd__a31o_2 _358_ (.A1(\core.rem[9] ),
    .A2(net12),
    .A3(_170_),
    .B1(_060_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_174_));
 sky130_fd_sc_hd__a2bb2o_2 _359_ (.A1_N(_173_),
    .A2_N(_174_),
    .B1(\core.rem[11] ),
    .B2(net17),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_175_));
 sky130_fd_sc_hd__and2_2 _360_ (.A(net28),
    .B(_175_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_035_));
 sky130_fd_sc_hd__nor4_2 _361_ (.A(\core.rem[10] ),
    .B(_060_),
    .C(_123_),
    .D(_129_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_176_));
 sky130_fd_sc_hd__a32o_2 _362_ (.A1(\core.rem[10] ),
    .A2(net19),
    .A3(_123_),
    .B1(net17),
    .B2(\core.rem[12] ),
    ...
    .VPWR(VPWR),
    .X(_177_));
 sky130_fd_sc_hd__o21a_2 _363_ (.A1(_176_),
    .A2(_177_),
    .B1(net28),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_036_));
 sky130_fd_sc_hd__nor2_2 _364_ (.A(_051_),
    .B(_062_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_178_));
 sky130_fd_sc_hd__or2_2 _365_ (.A(_125_),
    .B(_127_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_179_));
 sky130_fd_sc_hd__o21ai_2 _366_ (.A1(\core.rem[10] ),
    .A2(_123_),
    .B1(\core.rem[11] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_180_));
 sky130_fd_sc_hd__a21oi_2 _367_ (.A1(_179_),
    .A2(_180_),
    .B1(_060_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_181_));
 sky130_fd_sc_hd__o21a_2 _368_ (.A1(_178_),
    .A2(_181_),
    .B1(net26),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_037_));
 sky130_fd_sc_hd__or3_2 _369_ (.A(\core.rem[12] ),
    .B(_125_),
    .C(_127_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_182_));
 sky130_fd_sc_hd__nand2_2 _370_ (.A(\core.rem[12] ),
    .B(_125_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_183_));
 sky130_fd_sc_hd__a21oi_2 _371_ (.A1(_182_),
    .A2(_183_),
    .B1(_060_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_184_));
 sky130_fd_sc_hd__and2_2 _372_ (.A(net57),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_185_));
 sky130_fd_sc_hd__o21a_2 _373_ (.A1(_184_),
    .A2(_185_),
    .B1(net26),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_038_));
 sky130_fd_sc_hd__o31ai_2 _374_ (.A1(\core.rem[12] ),
    .A2(_125_),
    .A3(_127_),
    .B1(_051_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_186_));
 sky130_fd_sc_hd__or3_2 _375_ (.A(_051_),
    .B(\core.rem[12] ),
    .C(_125_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_187_));
 sky130_fd_sc_hd__a32o_2 _376_ (.A1(net20),
    .A2(_186_),
    .A3(_187_),
    .B1(net16),
    .B2(net59),
    ...
    .VPWR(VPWR),
    .X(_188_));
 sky130_fd_sc_hd__and2_2 _377_ (.A(net26),
    .B(_188_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_039_));
 sky130_fd_sc_hd__a22o_2 _378_ (.A1(\core.q[0] ),
    .A2(net15),
    .B1(net12),
    .B2(net19),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_189_));
 sky130_fd_sc_hd__and2_2 _379_ (.A(net28),
    .B(_189_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_040_));
 sky130_fd_sc_hd__a22o_2 _380_ (.A1(\core.q[0] ),
    .A2(net19),
    .B1(net15),
    .B2(\core.q[1] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_190_));
 sky130_fd_sc_hd__and2_2 _381_ (.A(net24),
    .B(_190_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_041_));
 sky130_fd_sc_hd__a22o_2 _382_ (.A1(\core.q[1] ),
    .A2(net20),
    .B1(net15),
    .B2(\core.q[2] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_191_));
 sky130_fd_sc_hd__and2_2 _383_ (.A(net25),
    .B(_191_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_042_));
 sky130_fd_sc_hd__a22o_2 _384_ (.A1(\core.q[2] ),
    .A2(net18),
    .B1(net14),
    .B2(\core.q[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_192_));
 sky130_fd_sc_hd__and2_2 _385_ (.A(net25),
    .B(_192_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_043_));
 sky130_fd_sc_hd__a22o_2 _386_ (.A1(\core.q[3] ),
    .A2(net18),
    .B1(net14),
    .B2(\core.q[4] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_193_));
 sky130_fd_sc_hd__and2_2 _387_ (.A(net25),
    .B(_193_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_044_));
 sky130_fd_sc_hd__a22o_2 _388_ (.A1(\core.q[4] ),
    .A2(net18),
    .B1(net14),
    .B2(\core.q[5] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_194_));
 sky130_fd_sc_hd__and2_2 _389_ (.A(net23),
    .B(_194_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_045_));
 sky130_fd_sc_hd__a22o_2 _390_ (.A1(\core.q[5] ),
    .A2(net18),
    .B1(net14),
    .B2(\core.q[6] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_195_));
 sky130_fd_sc_hd__and2_2 _391_ (.A(net23),
    .B(_195_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_046_));
 sky130_fd_sc_hd__a22o_2 _392_ (.A1(\core.q[6] ),
    .A2(net18),
    .B1(net14),
    .B2(\core.q[7] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_196_));
 sky130_fd_sc_hd__and2_2 _393_ (.A(net23),
    .B(_196_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_047_));
 sky130_fd_sc_hd__dfxtp_2 _394_ (.CLK(clknet_3_7__leaf_clk),
    .D(_003_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.tmp[8] ));
 sky130_fd_sc_hd__dfxtp_2 _395_ (.CLK(clknet_3_7__leaf_clk),
    .D(_004_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.tmp[9] ));
 sky130_fd_sc_hd__dfxtp_2 _396_ (.CLK(clknet_3_7__leaf_clk),
    .D(_005_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.tmp[10] ));
 sky130_fd_sc_hd__dfxtp_2 _397_ (.CLK(clknet_3_6__leaf_clk),
    .D(_006_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.tmp[11] ));
 sky130_fd_sc_hd__dfxtp_2 _398_ (.CLK(clknet_3_7__leaf_clk),
    .D(_007_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.tmp[12] ));
 sky130_fd_sc_hd__dfxtp_2 _399_ (.CLK(clknet_3_6__leaf_clk),
    .D(_008_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.tmp[13] ));
 sky130_fd_sc_hd__dfxtp_2 _400_ (.CLK(clknet_3_5__leaf_clk),
    .D(_009_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.tmp[14] ));
 sky130_fd_sc_hd__dfxtp_2 _401_ (.CLK(clknet_3_6__leaf_clk),
    .D(_010_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.tmp[15] ));
 sky130_fd_sc_hd__dfxtp_2 _402_ (.CLK(clknet_3_5__leaf_clk),
    .D(_011_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.i[0] ));
 sky130_fd_sc_hd__dfxtp_2 _403_ (.CLK(clknet_3_5__leaf_clk),
    .D(_012_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.i[1] ));
 sky130_fd_sc_hd__dfxtp_2 _404_ (.CLK(clknet_3_7__leaf_clk),
    .D(_013_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.i[2] ));
 sky130_fd_sc_hd__dfxtp_2 _405_ (.CLK(clknet_3_7__leaf_clk),
    .D(_014_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.i[3] ));
 sky130_fd_sc_hd__dfxtp_2 _406_ (.CLK(clknet_3_3__leaf_clk),
    .D(_015_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uo_out[0]));
 sky130_fd_sc_hd__dfxtp_2 _407_ (.CLK(clknet_3_3__leaf_clk),
    .D(net44),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uo_out[1]));
 sky130_fd_sc_hd__dfxtp_2 _408_ (.CLK(clknet_3_3__leaf_clk),
    .D(_017_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uo_out[2]));
 sky130_fd_sc_hd__dfxtp_2 _409_ (.CLK(clknet_3_3__leaf_clk),
    .D(_018_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uo_out[3]));
 sky130_fd_sc_hd__dfxtp_2 _410_ (.CLK(clknet_3_2__leaf_clk),
    .D(_019_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uo_out[4]));
 sky130_fd_sc_hd__dfxtp_2 _411_ (.CLK(clknet_3_2__leaf_clk),
    .D(_020_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uo_out[5]));
 sky130_fd_sc_hd__dfxtp_2 _412_ (.CLK(clknet_3_2__leaf_clk),
    .D(_021_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uo_out[6]));
 sky130_fd_sc_hd__dfxtp_2 _413_ (.CLK(clknet_3_2__leaf_clk),
    .D(_022_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uo_out[7]));
 sky130_fd_sc_hd__dfxtp_2 _414_ (.CLK(clknet_3_2__leaf_clk),
    .D(_023_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.done ));
 sky130_fd_sc_hd__dfxtp_2 _415_ (.CLK(clknet_3_5__leaf_clk),
    .D(_024_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.rem[0] ));
 sky130_fd_sc_hd__dfxtp_2 _416_ (.CLK(clknet_3_4__leaf_clk),
    .D(_025_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.rem[1] ));
 sky130_fd_sc_hd__dfxtp_2 _417_ (.CLK(clknet_3_1__leaf_clk),
    .D(_026_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.rem[2] ));
 sky130_fd_sc_hd__dfxtp_2 _418_ (.CLK(clknet_3_1__leaf_clk),
    .D(_027_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.rem[3] ));
 sky130_fd_sc_hd__dfxtp_2 _419_ (.CLK(clknet_3_0__leaf_clk),
    .D(_028_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.rem[4] ));
 sky130_fd_sc_hd__dfxtp_2 _420_ (.CLK(clknet_3_0__leaf_clk),
    .D(_029_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.rem[5] ));
 sky130_fd_sc_hd__dfxtp_2 _421_ (.CLK(clknet_3_0__leaf_clk),
    .D(_030_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.rem[6] ));
 sky130_fd_sc_hd__dfxtp_2 _422_ (.CLK(clknet_3_1__leaf_clk),
    .D(_031_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.rem[7] ));
 sky130_fd_sc_hd__dfxtp_2 _423_ (.CLK(clknet_3_1__leaf_clk),
    .D(_032_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.rem[8] ));
 sky130_fd_sc_hd__dfxtp_2 _424_ (.CLK(clknet_3_1__leaf_clk),
    .D(_033_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.rem[9] ));
 sky130_fd_sc_hd__dfxtp_2 _425_ (.CLK(clknet_3_4__leaf_clk),
    .D(_034_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.rem[10] ));
 sky130_fd_sc_hd__dfxtp_2 _426_ (.CLK(clknet_3_4__leaf_clk),
    .D(_035_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.rem[11] ));
 sky130_fd_sc_hd__dfxtp_2 _427_ (.CLK(clknet_3_4__leaf_clk),
    .D(_036_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.rem[12] ));
 sky130_fd_sc_hd__dfxtp_2 _428_ (.CLK(clknet_3_4__leaf_clk),
    .D(_037_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.rem[13] ));
 sky130_fd_sc_hd__dfxtp_2 _429_ (.CLK(clknet_3_5__leaf_clk),
    .D(_038_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.rem[14] ));
 sky130_fd_sc_hd__dfxtp_2 _430_ (.CLK(clknet_3_4__leaf_clk),
    .D(_039_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.rem[15] ));
 sky130_fd_sc_hd__dfxtp_2 _431_ (.CLK(clknet_3_3__leaf_clk),
    .D(_040_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.q[0] ));
 sky130_fd_sc_hd__dfxtp_2 _432_ (.CLK(clknet_3_6__leaf_clk),
    .D(_041_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.q[1] ));
 sky130_fd_sc_hd__dfxtp_2 _433_ (.CLK(clknet_3_3__leaf_clk),
    .D(_042_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.q[2] ));
 sky130_fd_sc_hd__dfxtp_2 _434_ (.CLK(clknet_3_0__leaf_clk),
    .D(_043_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.q[3] ));
 sky130_fd_sc_hd__dfxtp_2 _435_ (.CLK(clknet_3_2__leaf_clk),
    .D(_044_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.q[4] ));
 sky130_fd_sc_hd__dfxtp_2 _436_ (.CLK(clknet_3_0__leaf_clk),
    .D(_045_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.q[5] ));
 sky130_fd_sc_hd__dfxtp_2 _437_ (.CLK(clknet_3_0__leaf_clk),
    .D(_046_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.q[6] ));
 sky130_fd_sc_hd__dfxtp_2 _438_ (.CLK(clknet_3_1__leaf_clk),
    .D(_047_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.q[7] ));
 sky130_fd_sc_hd__dfxtp_2 _439_ (.CLK(clknet_3_6__leaf_clk),
    .D(_001_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.state[0] ));
 sky130_fd_sc_hd__dfxtp_2 _440_ (.CLK(clknet_3_6__leaf_clk),
    .D(_000_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.state[1] ));
 sky130_fd_sc_hd__dfxtp_2 _441_ (.CLK(clknet_3_5__leaf_clk),
    .D(_002_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.state[2] ));
 sky130_fd_sc_hd__buf_2 _457_ (.A(\core.done ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout11 (.A(_128_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net11));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout12 (.A(_128_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net12));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout13 (.A(_062_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net13));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout14 (.A(_061_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net14));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout15 (.A(_061_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout16 (.A(net17),
    ...
    .VPWR(VPWR),
    .X(net16));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout17 (.A(_061_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout19 (.A(net20),
    ...
    .VPWR(VPWR),
    .X(net19));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout20 (.A(_059_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net20));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout21 (.A(\core.state[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net21));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout22 (.A(\core.state[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout28 (.A(net1),
    ...
    .VPWR(VPWR),
    .X(net28));
 sky130_fd_sc_hd__dlygate4sd3_1 hold43 (.A(\core.state[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net43));
 sky130_fd_sc_hd__dlygate4sd3_1 hold44 (.A(_016_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net44));
 sky130_fd_sc_hd__dlygate4sd3_1 hold45 (.A(\core.tmp[13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net45));
 sky130_fd_sc_hd__dlygate4sd3_1 hold46 (.A(\core.tmp[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net46));
 sky130_fd_sc_hd__dlygate4sd3_1 hold47 (.A(\core.tmp[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net47));
 sky130_fd_sc_hd__dlygate4sd3_1 hold48 (.A(\core.tmp[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net48));
 sky130_fd_sc_hd__dlygate4sd3_1 hold49 (.A(\core.tmp[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net49));
 sky130_fd_sc_hd__dlygate4sd3_1 hold50 (.A(\core.tmp[12] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net50));
 sky130_fd_sc_hd__dlygate4sd3_1 hold51 (.A(\core.tmp[14] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net51));
 sky130_fd_sc_hd__dlygate4sd3_1 hold52 (.A(\core.q[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net52));
 sky130_fd_sc_hd__dlygate4sd3_1 hold53 (.A(\core.i[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net53));
 sky130_fd_sc_hd__dlygate4sd3_1 hold54 (.A(\core.i[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net54));
 sky130_fd_sc_hd__dlygate4sd3_1 hold55 (.A(\core.tmp[15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net55));
 sky130_fd_sc_hd__dlygate4sd3_1 hold56 (.A(\core.q[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net56));
 sky130_fd_sc_hd__dlygate4sd3_1 hold57 (.A(\core.rem[14] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net57));
 sky130_fd_sc_hd__dlygate4sd3_1 hold58 (.A(\core.done ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net58));
 sky130_fd_sc_hd__dlygate4sd3_1 hold59 (.A(\core.rem[15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 input9 (.A(ui_in[7]),
    ...
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__conb_1 tt_um_sqrt8_ieee (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 tt_um_sqrt8_ieee_29 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net29));
 sky130_fd_sc_hd__conb_1 tt_um_sqrt8_ieee_30 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net30));
 sky130_fd_sc_hd__conb_1 tt_um_sqrt8_ieee_31 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net31));
 sky130_fd_sc_hd__conb_1 tt_um_sqrt8_ieee_32 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net32));
 sky130_fd_sc_hd__conb_1 tt_um_sqrt8_ieee_33 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net33));
 sky130_fd_sc_hd__conb_1 tt_um_sqrt8_ieee_34 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net34));
 sky130_fd_sc_hd__conb_1 tt_um_sqrt8_ieee_35 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net35));
 sky130_fd_sc_hd__conb_1 tt_um_sqrt8_ieee_36 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net36));
 sky130_fd_sc_hd__conb_1 tt_um_sqrt8_ieee_37 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net37));
 sky130_fd_sc_hd__conb_1 tt_um_sqrt8_ieee_38 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net38));
 sky130_fd_sc_hd__conb_1 tt_um_sqrt8_ieee_39 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net39));
 sky130_fd_sc_hd__conb_1 tt_um_sqrt8_ieee_40 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net40));
 sky130_fd_sc_hd__conb_1 tt_um_sqrt8_ieee_41 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net41));
 sky130_fd_sc_hd__conb_1 tt_um_sqrt8_ieee_42 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net42));
