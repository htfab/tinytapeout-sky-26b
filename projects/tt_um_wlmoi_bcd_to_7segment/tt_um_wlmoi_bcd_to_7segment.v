module tt_um_wlmoi_bcd_to_7segment (clk,
    ena,
    rst_n,
    VPWR,
    VGND,
 ...
 sky130_fd_sc_hd__inv_2 _32_ (.A(net3),
    ...
    .VPWR(VPWR),
    .Y(_00_));
 sky130_fd_sc_hd__inv_2 _33_ (.A(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_01_));
 sky130_fd_sc_hd__and4b_2 _34_ (.A_N(net8),
    .B(net7),
    .C(net1),
    .D(net2),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(display_on));
 sky130_fd_sc_hd__o21ai_2 _35_ (.A1(net10),
    .A2(net9),
    .B1(display_on),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_02_));
 sky130_fd_sc_hd__xnor2_2 _36_ (.A(net19),
    .B(_02_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(dp_pin));
 sky130_fd_sc_hd__or2_2 _37_ (.A(net4),
    .B(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_03_));
 sky130_fd_sc_hd__nand2_2 _38_ (.A(net5),
    .B(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_04_));
 sky130_fd_sc_hd__a21boi_2 _39_ (.A1(net4),
    .A2(net3),
    .B1_N(net5),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_05_));
 sky130_fd_sc_hd__and2b_2 _40_ (.A_N(net5),
    .B(net4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_06_));
 sky130_fd_sc_hd__o32a_2 _41_ (.A1(net6),
    .A2(_05_),
    .A3(_06_),
    .B1(_03_),
    .B2(_04_),
 ...
 sky130_fd_sc_hd__o21ai_2 _42_ (.A1(net9),
    ...
    .VPWR(VPWR),
    .Y(_08_));
 sky130_fd_sc_hd__xnor2_2 _43_ (.A(net11),
    .B(_08_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net18));
 sky130_fd_sc_hd__and2b_2 _44_ (.A_N(net4),
    .B(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_09_));
 sky130_fd_sc_hd__nand2_2 _45_ (.A(_01_),
    .B(_03_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_10_));
 sky130_fd_sc_hd__o32a_2 _46_ (.A1(net4),
    .A2(_00_),
    .A3(_04_),
    .B1(_05_),
    .B2(_10_),
    ...
    .VPWR(VPWR),
    .X(_11_));
 sky130_fd_sc_hd__o21ai_2 _47_ (.A1(net9),
    .A2(_11_),
    .B1(display_on),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_12_));
 sky130_fd_sc_hd__xnor2_2 _48_ (.A(net19),
    .B(_12_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net16));
 sky130_fd_sc_hd__a21oi_2 _49_ (.A1(net4),
    .A2(net3),
    .B1(net5),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_13_));
 sky130_fd_sc_hd__nor2_2 _50_ (.A(_01_),
    .B(_13_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_14_));
 sky130_fd_sc_hd__and2b_2 _51_ (.A_N(net3),
    .B(net4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_15_));
 sky130_fd_sc_hd__nor2_2 _52_ (.A(net5),
    .B(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_16_));
 sky130_fd_sc_hd__o41a_2 _53_ (.A1(net9),
    .A2(_14_),
    .A3(_15_),
    .A4(_16_),
    .B1(display_on),
    ...
    .VPWR(VPWR),
    .X(_17_));
 sky130_fd_sc_hd__xor2_2 _54_ (.A(net19),
    .B(_17_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net17));
 sky130_fd_sc_hd__and2_2 _55_ (.A(_03_),
    .B(_05_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_18_));
 sky130_fd_sc_hd__or3_2 _56_ (.A(net6),
    .B(_06_),
    .C(_16_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_19_));
 sky130_fd_sc_hd__nor2_2 _57_ (.A(net5),
    .B(_15_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_20_));
 sky130_fd_sc_hd__o32a_2 _58_ (.A1(_01_),
    .A2(_05_),
    .A3(_20_),
    .B1(_19_),
    .B2(_18_),
    ...
    .VPWR(VPWR),
    .X(_21_));
 sky130_fd_sc_hd__o21ai_2 _59_ (.A1(net9),
    .A2(_21_),
    .B1(display_on),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_22_));
 sky130_fd_sc_hd__xnor2_2 _60_ (.A(net19),
    .B(_22_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net15));
 sky130_fd_sc_hd__nor2_2 _61_ (.A(_04_),
    .B(_09_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_23_));
 sky130_fd_sc_hd__a31oi_2 _62_ (.A1(net4),
    .A2(_01_),
    .A3(_16_),
    .B1(_23_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_24_));
 sky130_fd_sc_hd__o21ai_2 _63_ (.A1(net9),
    .A2(_24_),
    .B1(display_on),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_25_));
 sky130_fd_sc_hd__xnor2_2 _64_ (.A(net19),
    .B(_25_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net14));
 sky130_fd_sc_hd__nor2_2 _65_ (.A(net6),
    .B(_18_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_26_));
 sky130_fd_sc_hd__o21a_2 _66_ (.A1(_09_),
    .A2(_16_),
    .B1(net6),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_27_));
 sky130_fd_sc_hd__o31a_2 _67_ (.A1(net9),
    .A2(_26_),
    .A3(_27_),
    .B1(display_on),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_28_));
 sky130_fd_sc_hd__xor2_2 _68_ (.A(net19),
    .B(_28_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net13));
 sky130_fd_sc_hd__and2_2 _69_ (.A(net5),
    .B(_03_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_29_));
 sky130_fd_sc_hd__o21ba_2 _70_ (.A1(_19_),
    .A2(_29_),
    .B1_N(_14_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_30_));
 sky130_fd_sc_hd__o31a_2 _71_ (.A1(net9),
    .A2(_23_),
    .A3(_30_),
    .B1(display_on),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_31_));
 sky130_fd_sc_hd__xor2_2 _72_ (.A(net19),
    .B(_31_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net12));
 sky130_fd_sc_hd__buf_2 _86_ (.A(display_on),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[4]));
 sky130_fd_sc_hd__buf_2 _87_ (.A(display_on),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[6]));
 sky130_fd_sc_hd__buf_2 _88_ (.A(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[7]));
 sky130_fd_sc_hd__buf_2 _89_ (.A(dp_pin),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 input9 (.A(ui_in[6]),
    ...
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__clkbuf_8 max_cap19 (.A(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net19));
 sky130_fd_sc_hd__conb_1 tt_um_wlmoi_bcd_to_7segment (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 tt_um_wlmoi_bcd_to_7segment_20 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net20));
 sky130_fd_sc_hd__conb_1 tt_um_wlmoi_bcd_to_7segment_21 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net21));
 sky130_fd_sc_hd__conb_1 tt_um_wlmoi_bcd_to_7segment_22 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net22));
 sky130_fd_sc_hd__conb_1 tt_um_wlmoi_bcd_to_7segment_23 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net23));
 sky130_fd_sc_hd__conb_1 tt_um_wlmoi_bcd_to_7segment_24 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net24));
 sky130_fd_sc_hd__conb_1 tt_um_wlmoi_bcd_to_7segment_25 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net25));
 sky130_fd_sc_hd__conb_1 tt_um_wlmoi_bcd_to_7segment_26 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net26));
 sky130_fd_sc_hd__conb_1 tt_um_wlmoi_bcd_to_7segment_27 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net27));
 sky130_fd_sc_hd__conb_1 tt_um_wlmoi_bcd_to_7segment_28 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net28));
 sky130_fd_sc_hd__conb_1 tt_um_wlmoi_bcd_to_7segment_29 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net29));
 sky130_fd_sc_hd__conb_1 tt_um_wlmoi_bcd_to_7segment_30 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net30));
 sky130_fd_sc_hd__conb_1 tt_um_wlmoi_bcd_to_7segment_31 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net31));
