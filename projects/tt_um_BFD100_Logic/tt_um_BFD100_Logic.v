module tt_um_BFD100_Logic (clk,
 ...
 wire \U1.EnL ;
 wire \U1.EnR ;
 wire \U1.MotorlR.counter[0] ;
 wire \U1.MotorlR.counter[1] ;
 wire \U1.MotorlR.counter[2] ;
 wire \U1.MotorlR.counter[3] ;
 wire \U1.MotorlR.counter[4] ;
 wire \U1.MotorlR.counter[5] ;
 wire \U1.MotorlR.counter[6] ;
 wire \U1.MotorlR.counter[7] ;
 wire \U1.MotorlR.duty_l[0] ;
 wire \U1.MotorlR.duty_l[1] ;
 wire \U1.MotorlR.duty_l[2] ;
 wire \U1.MotorlR.duty_l[3] ;
 wire \U1.MotorlR.duty_l[4] ;
 wire \U1.MotorlR.duty_l[5] ;
 wire \U1.MotorlR.duty_l[6] ;
 wire \U1.MotorlR.duty_l[7] ;
 wire \U1.MotorlR.duty_r[1] ;
 wire \U1.MotorlR.duty_r[2] ;
 wire \U1.MotorlR.duty_r[3] ;
 wire \U1.MotorlR.duty_r[4] ;
 wire \U1.MotorlR.duty_r[5] ;
 wire \U1.MotorlR.duty_r[6] ;
 wire \U1.MotorlR.duty_r[7] ;
 wire \U1.Rduty_l[0] ;
 wire \U1.Rduty_l[1] ;
 wire \U1.Rduty_l[2] ;
 wire \U1.Rduty_l[3] ;
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_137 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _255_ (.A(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_067_));
 sky130_fd_sc_hd__inv_2 _256_ (.A(\U1.MotorlR.duty_l[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_068_));
 sky130_fd_sc_hd__inv_2 _257_ (.A(net30),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_069_));
 sky130_fd_sc_hd__inv_2 _258_ (.A(net31),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_070_));
 sky130_fd_sc_hd__inv_2 _259_ (.A(net75),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_071_));
 sky130_fd_sc_hd__inv_2 _260_ (.A(\U1.MotorlR.counter[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_072_));
 sky130_fd_sc_hd__inv_2 _261_ (.A(\U1.MotorlR.counter[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_073_));
 sky130_fd_sc_hd__inv_2 _262_ (.A(\U1.MotorlR.counter[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_074_));
 sky130_fd_sc_hd__inv_2 _263_ (.A(\U1.MotorlR.counter[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_075_));
 sky130_fd_sc_hd__inv_2 _264_ (.A(\U1.MotorlR.counter[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_076_));
 sky130_fd_sc_hd__inv_2 _265_ (.A(uio_out[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_077_));
 sky130_fd_sc_hd__inv_2 _266_ (.A(net5),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _267_ (.A(net34),
    ...
    .VPWR(VPWR),
    .Y(_079_));
 sky130_fd_sc_hd__inv_2 _268_ (.A(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_080_));
 sky130_fd_sc_hd__inv_2 _269_ (.A(\U2.DirR ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_081_));
 sky130_fd_sc_hd__mux2_1 _270_ (.A0(\U1.EnL ),
    .A1(\U2.EnL ),
    .S(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(uo_out[0]));
 sky130_fd_sc_hd__mux2_1 _271_ (.A0(_070_),
    .A1(\U2.DirL ),
    .S(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(uo_out[1]));
 sky130_fd_sc_hd__and3b_2 _272_ (.A_N(\U2.DirL ),
    .B(net9),
    .C(\U2.EnL ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_082_));
 sky130_fd_sc_hd__a31o_2 _273_ (.A1(net31),
    .A2(\U1.EnL ),
    .A3(_080_),
    .B1(_082_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(uo_out[2]));
 sky130_fd_sc_hd__and3_2 _274_ (.A(\U2.EnL ),
    .B(net9),
    .C(\U2.DirL ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_083_));
 sky130_fd_sc_hd__a31o_2 _275_ (.A1(_070_),
    .A2(\U1.EnL ),
    .A3(_080_),
    .B1(_083_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(uo_out[3]));
 sky130_fd_sc_hd__and2_2 _276_ (.A(_080_),
    .B(\U1.EnR ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_084_));
 sky130_fd_sc_hd__a21o_2 _277_ (.A1(net9),
    .A2(\U2.EnR ),
    .B1(_084_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(uo_out[4]));
 sky130_fd_sc_hd__mux2_1 _278_ (.A0(_069_),
    .A1(\U2.DirR ),
    .S(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(uo_out[5]));
 sky130_fd_sc_hd__a32o_2 _279_ (.A1(net9),
    .A2(\U2.EnR ),
    .A3(_081_),
    .B1(_084_),
    .B2(\U1.Rduty_r[8] ),
    ...
    .VPWR(VPWR),
    .X(uo_out[6]));
 sky130_fd_sc_hd__a32o_2 _280_ (.A1(net9),
    .A2(\U2.EnR ),
    .A3(\U2.DirR ),
    .B1(_084_),
    .B2(_069_),
    ...
    .VPWR(VPWR),
    .X(uo_out[7]));
 sky130_fd_sc_hd__and2b_2 _281_ (.A_N(net4),
    .B(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_085_));
 sky130_fd_sc_hd__and3_2 _282_ (.A(net6),
    .B(net3),
    .C(_085_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_086_));
 sky130_fd_sc_hd__and4b_2 _283_ (.A_N(net6),
    .B(net3),
    .C(net2),
    .D(net4),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_087_));
 sky130_fd_sc_hd__o21ai_2 _284_ (.A1(_086_),
    .A2(_087_),
    .B1(_078_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_088_));
 sky130_fd_sc_hd__and2b_2 _285_ (.A_N(net2),
    .B(net4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_089_));
 sky130_fd_sc_hd__nor2_2 _286_ (.A(_085_),
    .B(_089_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_090_));
 sky130_fd_sc_hd__nand2_2 _287_ (.A(net6),
    .B(net5),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_091_));
 sky130_fd_sc_hd__o31a_2 _288_ (.A1(net3),
    .A2(_090_),
    .A3(_091_),
    .B1(net34),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_092_));
 sky130_fd_sc_hd__o2bb2a_2 _289_ (.A1_N(_088_),
    .A2_N(_092_),
    .B1(\U1.error[0] ),
    .B2(net34),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_000_));
 sky130_fd_sc_hd__a41o_2 _290_ (.A1(net6),
    .A2(_078_),
    .A3(net3),
    .A4(net2),
    .B1(_079_),
    ...
    .VPWR(VPWR),
    .X(_093_));
 sky130_fd_sc_hd__and3_2 _291_ (.A(net6),
    .B(net5),
    .C(_089_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_094_));
 sky130_fd_sc_hd__and2_2 _292_ (.A(net3),
    .B(_094_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_095_));
 sky130_fd_sc_hd__o32a_2 _293_ (.A1(_087_),
    .A2(_093_),
    .A3(_095_),
    .B1(net34),
    .B2(net42),
    ...
    .VPWR(VPWR),
    .X(_001_));
 sky130_fd_sc_hd__o22a_2 _294_ (.A1(net74),
    .A2(net34),
    .B1(_087_),
    .B2(_093_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_002_));
 sky130_fd_sc_hd__and4b_2 _295_ (.A_N(net3),
    .B(net4),
    .C(net6),
    .D(net5),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_096_));
 sky130_fd_sc_hd__o22a_2 _296_ (.A1(net67),
    .A2(net34),
    .B1(_093_),
    .B2(_096_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_003_));
 sky130_fd_sc_hd__or3b_2 _297_ (.A(uio_out[0]),
    .B(uio_out[1]),
    .C_N(\U1.error[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_097_));
 sky130_fd_sc_hd__nor2_2 _298_ (.A(net29),
    .B(uio_out[3]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_098_));
 sky130_fd_sc_hd__nor2_2 _299_ (.A(net29),
    .B(_097_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_099_));
 sky130_fd_sc_hd__and2b_2 _300_ (.A_N(_097_),
    .B(_098_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_100_));
 sky130_fd_sc_hd__nand2_2 _301_ (.A(\U1.Corr[0] ),
    .B(_100_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_101_));
 sky130_fd_sc_hd__a21o_2 _302_ (.A1(_067_),
    .A2(_100_),
    .B1(\U1.Corr[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_102_));
 sky130_fd_sc_hd__o211a_2 _303_ (.A1(net33),
    .A2(_101_),
    .B1(_102_),
    .C1(net35),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_004_));
 sky130_fd_sc_hd__nor2_2 _304_ (.A(_067_),
    .B(_079_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_103_));
 sky130_fd_sc_hd__mux2_1 _305_ (.A0(\U1.error[1] ),
    .A1(\U1.error[0] ),
    .S(uio_out[0]),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_104_));
 sky130_fd_sc_hd__nand2_2 _306_ (.A(_077_),
    .B(_104_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_105_));
 sky130_fd_sc_hd__and4_2 _307_ (.A(\U1.Corr[1] ),
    .B(_077_),
    .C(_098_),
    .D(_104_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_106_));
 sky130_fd_sc_hd__a31o_2 _308_ (.A1(_077_),
    .A2(_098_),
    .A3(_104_),
    .B1(\U1.Corr[1] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_107_));
 sky130_fd_sc_hd__nand2b_2 _309_ (.A_N(_106_),
    .B(_107_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_108_));
 sky130_fd_sc_hd__nand2_2 _310_ (.A(_101_),
    .B(_108_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_2 _311_ (.A(_101_),
    ...
    .VPWR(VPWR),
    .X(_110_));
 sky130_fd_sc_hd__nor2_2 _312_ (.A(net33),
    .B(_079_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_111_));
 sky130_fd_sc_hd__nand2_2 _313_ (.A(_067_),
    .B(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_112_));
 sky130_fd_sc_hd__a32o_2 _314_ (.A1(_109_),
    .A2(_110_),
    .A3(net21),
    .B1(net24),
    .B2(net87),
    ...
    .VPWR(VPWR),
    .X(_005_));
 sky130_fd_sc_hd__a31o_2 _315_ (.A1(\U1.Corr[0] ),
    .A2(_100_),
    .A3(_107_),
    .B1(_106_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_113_));
 sky130_fd_sc_hd__nand2_2 _316_ (.A(\U1.error[0] ),
    .B(uio_out[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_114_));
 sky130_fd_sc_hd__mux2_1 _317_ (.A0(\U1.error[2] ),
    .A1(\U1.error[1] ),
    .S(uio_out[0]),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_115_));
 sky130_fd_sc_hd__a2bb2o_2 _318_ (.A1_N(uio_out[0]),
    .A2_N(_114_),
    .B1(_115_),
    .B2(_077_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_116_));
 sky130_fd_sc_hd__and3_2 _319_ (.A(\U1.Corr[2] ),
    .B(_098_),
    .C(_116_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_117_));
 sky130_fd_sc_hd__nand3_2 _320_ (.A(\U1.Corr[2] ),
    .B(_098_),
    .C(_116_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_118_));
 sky130_fd_sc_hd__a21o_2 _321_ (.A1(_098_),
    .A2(_116_),
    .B1(\U1.Corr[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_119_));
 sky130_fd_sc_hd__a21oi_2 _322_ (.A1(_118_),
    .A2(_119_),
    .B1(_113_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_120_));
 sky130_fd_sc_hd__and3_2 _323_ (.A(_113_),
    .B(_118_),
    .C(_119_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_121_));
 sky130_fd_sc_hd__nor2_2 _324_ (.A(_120_),
    .B(_121_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_122_));
 sky130_fd_sc_hd__a22o_2 _325_ (.A1(net86),
    .A2(net24),
    .B1(net21),
    .B2(_122_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_006_));
 sky130_fd_sc_hd__mux2_1 _326_ (.A0(\U1.error[3] ),
    .A1(\U1.error[2] ),
    .S(uio_out[0]),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_123_));
 sky130_fd_sc_hd__mux2_1 _327_ (.A0(_104_),
    .A1(_123_),
    .S(_077_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_124_));
 sky130_fd_sc_hd__and3_2 _328_ (.A(\U1.Corr[3] ),
    .B(_098_),
    .C(_124_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_125_));
 sky130_fd_sc_hd__a21o_2 _329_ (.A1(_098_),
    .A2(_124_),
    .B1(\U1.Corr[3] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_126_));
 sky130_fd_sc_hd__and2b_2 _330_ (.A_N(_125_),
    .B(_126_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_127_));
 sky130_fd_sc_hd__or3_2 _331_ (.A(_117_),
    .B(_121_),
    .C(_127_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_128_));
 sky130_fd_sc_hd__o21ai_2 _332_ (.A1(_117_),
    .A2(_121_),
    .B1(_127_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_129_));
 sky130_fd_sc_hd__a32o_2 _333_ (.A1(net21),
    .A2(_128_),
    .A3(_129_),
    .B1(net24),
    .B2(net78),
    ...
    .VPWR(VPWR),
    .X(_007_));
 sky130_fd_sc_hd__and2b_2 _334_ (.A_N(uio_out[1]),
    .B(\U1.error[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_130_));
 sky130_fd_sc_hd__a21o_2 _335_ (.A1(uio_out[1]),
    .A2(_115_),
    .B1(_130_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_131_));
 sky130_fd_sc_hd__a211o_2 _336_ (.A1(uio_out[1]),
    .A2(_115_),
    .B1(_130_),
    .C1(net29),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_132_));
 sky130_fd_sc_hd__a21oi_2 _337_ (.A1(net29),
    .A2(_097_),
    .B1(uio_out[3]),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_133_));
 sky130_fd_sc_hd__nand3_2 _338_ (.A(\U1.Corr[4] ),
    .B(_132_),
    .C(_133_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_134_));
 sky130_fd_sc_hd__a21o_2 _339_ (.A1(_132_),
    .A2(_133_),
    .B1(\U1.Corr[4] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_135_));
 sky130_fd_sc_hd__and2_2 _340_ (.A(_134_),
    .B(_135_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_136_));
 sky130_fd_sc_hd__a211o_2 _341_ (.A1(_113_),
    .A2(_119_),
    .B1(_125_),
    .C1(_117_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_137_));
 sky130_fd_sc_hd__a21o_2 _342_ (.A1(_126_),
    .A2(_137_),
    .B1(_136_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_138_));
 sky130_fd_sc_hd__nand3_2 _343_ (.A(_126_),
    .B(_136_),
    .C(_137_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_139_));
 sky130_fd_sc_hd__a32o_2 _344_ (.A1(net21),
    .A2(_138_),
    .A3(_139_),
    .B1(net24),
    .B2(\U1.Corr[4] ),
    ...
    .VPWR(VPWR),
    .X(_008_));
 sky130_fd_sc_hd__a211o_2 _345_ (.A1(uio_out[1]),
    .A2(_123_),
    .B1(_130_),
    .C1(net29),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_140_));
 sky130_fd_sc_hd__a21oi_2 _346_ (.A1(net29),
    .A2(_105_),
    .B1(uio_out[3]),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_141_));
 sky130_fd_sc_hd__a21oi_2 _347_ (.A1(_140_),
    .A2(_141_),
    .B1(\U1.Corr[5] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_142_));
 sky130_fd_sc_hd__nand3_2 _348_ (.A(\U1.Corr[5] ),
    .B(_140_),
    .C(_141_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_143_));
 sky130_fd_sc_hd__and2b_2 _349_ (.A_N(_142_),
    .B(_143_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_144_));
 sky130_fd_sc_hd__a21oi_2 _350_ (.A1(_134_),
    .A2(_139_),
    .B1(_144_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_145_));
 sky130_fd_sc_hd__a31o_2 _351_ (.A1(_134_),
    .A2(_139_),
    .A3(_144_),
    .B1(net32),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_146_));
 sky130_fd_sc_hd__o221a_2 _352_ (.A1(_067_),
    .A2(\U1.Corr[5] ),
    .B1(_145_),
    .B2(_146_),
    .C1(net35),
    ...
    .VPWR(VPWR),
    .X(_009_));
 sky130_fd_sc_hd__and2b_2 _353_ (.A_N(net29),
    .B(\U1.error[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_147_));
 sky130_fd_sc_hd__a21oi_2 _354_ (.A1(net29),
    .A2(_116_),
    .B1(_147_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_148_));
 sky130_fd_sc_hd__nor2_2 _355_ (.A(uio_out[3]),
    .B(_148_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_149_));
 sky130_fd_sc_hd__nand2_2 _356_ (.A(\U1.Corr[6] ),
    .B(_149_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_150_));
 sky130_fd_sc_hd__xnor2_2 _357_ (.A(\U1.Corr[6] ),
    .B(_149_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_151_));
 sky130_fd_sc_hd__a31o_2 _358_ (.A1(_134_),
    .A2(_139_),
    .A3(_143_),
    .B1(_142_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_2 _359_ (.A(_151_),
    ...
    .VPWR(VPWR),
    .Y(_153_));
 sky130_fd_sc_hd__a311o_2 _360_ (.A1(_134_),
    .A2(_139_),
    .A3(_143_),
    .B1(_151_),
    .C1(_142_),
    ...
    .VPWR(VPWR),
    .X(_154_));
 sky130_fd_sc_hd__a32o_2 _361_ (.A1(net21),
    .A2(_153_),
    .A3(_154_),
    .B1(net23),
    .B2(\U1.Corr[6] ),
    ...
    .VPWR(VPWR),
    .X(_010_));
 sky130_fd_sc_hd__a21oi_2 _362_ (.A1(net29),
    .A2(_124_),
    .B1(_147_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_155_));
 sky130_fd_sc_hd__o21ba_2 _363_ (.A1(uio_out[3]),
    .A2(_155_),
    .B1_N(\U1.Corr[7] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_156_));
 sky130_fd_sc_hd__or3b_2 _364_ (.A(uio_out[3]),
    .B(_155_),
    .C_N(\U1.Corr[7] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_157_));
 sky130_fd_sc_hd__nand2b_2 _365_ (.A_N(_156_),
    .B(_157_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_158_));
 sky130_fd_sc_hd__a21oi_2 _366_ (.A1(_150_),
    .A2(_154_),
    .B1(_158_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_159_));
 sky130_fd_sc_hd__a31o_2 _367_ (.A1(_150_),
    .A2(_154_),
    .A3(_158_),
    .B1(net18),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_160_));
 sky130_fd_sc_hd__a2bb2o_2 _368_ (.A1_N(_159_),
    .A2_N(_160_),
    .B1(\U1.Corr[7] ),
    .B2(net23),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_011_));
 sky130_fd_sc_hd__nand2_2 _369_ (.A(net84),
    .B(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_161_));
 sky130_fd_sc_hd__o21a_2 _370_ (.A1(_150_),
    .A2(_156_),
    .B1(_157_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_162_));
 sky130_fd_sc_hd__a21o_2 _371_ (.A1(net29),
    .A2(_131_),
    .B1(_147_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_163_));
 sky130_fd_sc_hd__mux2_1 _372_ (.A0(_163_),
    .A1(_099_),
    .S(uio_out[3]),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_164_));
 sky130_fd_sc_hd__xnor2_2 _373_ (.A(\U1.Corr[8] ),
    .B(_164_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_165_));
 sky130_fd_sc_hd__a311oi_2 _374_ (.A1(_150_),
    .A2(_154_),
    .A3(_157_),
    .B1(_165_),
    .C1(_156_),
    ...
    .VPWR(VPWR),
    .Y(_166_));
 sky130_fd_sc_hd__o311a_2 _375_ (.A1(_151_),
    .A2(_152_),
    .A3(_158_),
    .B1(_162_),
    .C1(_165_),
    ...
    .VPWR(VPWR),
    .X(_167_));
 sky130_fd_sc_hd__o31ai_2 _376_ (.A1(net18),
    .A2(_166_),
    .A3(_167_),
    .B1(_161_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_012_));
 sky130_fd_sc_hd__xnor2_2 _377_ (.A(\U1.Corr[1] ),
    .B(\U1.Corr[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_168_));
 sky130_fd_sc_hd__a22o_2 _378_ (.A1(net82),
    .A2(net25),
    .B1(net20),
    .B2(_168_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_013_));
 sky130_fd_sc_hd__o21ai_2 _379_ (.A1(\U1.Corr[1] ),
    .A2(\U1.Corr[0] ),
    .B1(\U1.Corr[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_169_));
 sky130_fd_sc_hd__or3_2 _380_ (.A(\U1.Corr[2] ),
    .B(\U1.Corr[1] ),
    .C(\U1.Corr[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_170_));
 sky130_fd_sc_hd__nand2_2 _381_ (.A(_169_),
    .B(_170_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_171_));
 sky130_fd_sc_hd__a22o_2 _382_ (.A1(net77),
    .A2(net25),
    .B1(net19),
    .B2(_171_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_014_));
 sky130_fd_sc_hd__or2_2 _383_ (.A(\U1.Corr[3] ),
    .B(_170_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_172_));
 sky130_fd_sc_hd__nand2_2 _384_ (.A(\U1.Corr[3] ),
    .B(_170_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_173_));
 sky130_fd_sc_hd__nand2_2 _385_ (.A(_172_),
    .B(_173_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_174_));
 sky130_fd_sc_hd__a22o_2 _386_ (.A1(net64),
    .A2(net25),
    .B1(net20),
    .B2(_174_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_015_));
 sky130_fd_sc_hd__xnor2_2 _387_ (.A(\U1.Corr[4] ),
    .B(_172_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_175_));
 sky130_fd_sc_hd__a22o_2 _388_ (.A1(net61),
    .A2(net26),
    .B1(net20),
    .B2(_175_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_016_));
 sky130_fd_sc_hd__or3_2 _389_ (.A(\U1.Corr[5] ),
    .B(\U1.Corr[4] ),
    .C(_172_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_176_));
 sky130_fd_sc_hd__o21ai_2 _390_ (.A1(\U1.Corr[4] ),
    .A2(_172_),
    .B1(\U1.Corr[5] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_177_));
 sky130_fd_sc_hd__nand2_2 _391_ (.A(_176_),
    .B(_177_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_178_));
 sky130_fd_sc_hd__a22o_2 _392_ (.A1(net62),
    .A2(net25),
    .B1(net19),
    .B2(_178_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_017_));
 sky130_fd_sc_hd__or2_2 _393_ (.A(\U1.Corr[6] ),
    .B(_176_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_179_));
 sky130_fd_sc_hd__nand2_2 _394_ (.A(\U1.Corr[6] ),
    .B(_176_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_180_));
 sky130_fd_sc_hd__a21oi_2 _395_ (.A1(_179_),
    .A2(_180_),
    .B1(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_181_));
 sky130_fd_sc_hd__a21o_2 _396_ (.A1(net49),
    .A2(net27),
    .B1(_181_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_018_));
 sky130_fd_sc_hd__nand2_2 _397_ (.A(\U1.Corr[7] ),
    .B(_179_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_182_));
 sky130_fd_sc_hd__or2_2 _398_ (.A(\U1.Corr[7] ),
    .B(_179_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_183_));
 sky130_fd_sc_hd__a32o_2 _399_ (.A1(net19),
    .A2(_182_),
    .A3(_183_),
    .B1(net27),
    .B2(net63),
    ...
    .VPWR(VPWR),
    .X(_019_));
 sky130_fd_sc_hd__nand2_2 _400_ (.A(\U1.Corr[7] ),
    .B(\U1.Corr[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_184_));
 sky130_fd_sc_hd__xnor2_2 _401_ (.A(\U1.Corr[8] ),
    .B(_182_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_185_));
 sky130_fd_sc_hd__a22o_2 _402_ (.A1(net31),
    .A2(net27),
    .B1(net19),
    .B2(_185_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_020_));
 sky130_fd_sc_hd__a2bb2o_2 _403_ (.A1_N(\U1.Corr[0] ),
    .A2_N(net18),
    .B1(net24),
    .B2(\U1.Rduty_l[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_021_));
 sky130_fd_sc_hd__a2bb2o_2 _404_ (.A1_N(\U1.Corr[1] ),
    .A2_N(net18),
    .B1(net24),
    .B2(net81),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_022_));
 sky130_fd_sc_hd__a2bb2o_2 _405_ (.A1_N(\U1.Corr[2] ),
    .A2_N(net18),
    .B1(net24),
    .B2(net73),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_023_));
 sky130_fd_sc_hd__a2bb2o_2 _406_ (.A1_N(\U1.Corr[3] ),
    .A2_N(net18),
    .B1(net24),
    .B2(net70),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_024_));
 sky130_fd_sc_hd__a2bb2o_2 _407_ (.A1_N(\U1.Corr[4] ),
    .A2_N(net18),
    .B1(net25),
    .B2(net71),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_025_));
 sky130_fd_sc_hd__a2bb2o_2 _408_ (.A1_N(\U1.Corr[5] ),
    .A2_N(net18),
    .B1(net24),
    .B2(net85),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_026_));
 sky130_fd_sc_hd__a2bb2o_2 _409_ (.A1_N(\U1.Corr[6] ),
    .A2_N(net18),
    .B1(net27),
    .B2(net83),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_027_));
 sky130_fd_sc_hd__a22o_2 _410_ (.A1(net65),
    .A2(net27),
    .B1(net19),
    .B2(\U1.Corr[7] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_028_));
 sky130_fd_sc_hd__or2_2 _411_ (.A(\U1.Corr[7] ),
    .B(\U1.Corr[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a32o_2 _412_ (.A1(net19),
    ...
    .VPWR(VPWR),
    .X(_029_));
 sky130_fd_sc_hd__a21oi_2 _413_ (.A1(\U1.Rduty_l[0] ),
    .A2(net31),
    .B1(\U1.Rduty_l[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_187_));
 sky130_fd_sc_hd__a31o_2 _414_ (.A1(\U1.Rduty_l[0] ),
    .A2(net31),
    .A3(\U1.Rduty_l[1] ),
    .B1(_112_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_188_));
 sky130_fd_sc_hd__a2bb2o_2 _415_ (.A1_N(_187_),
    .A2_N(_188_),
    .B1(net59),
    .B2(net26),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_030_));
 sky130_fd_sc_hd__o21a_2 _416_ (.A1(\U1.Rduty_l[0] ),
    .A2(\U1.Rduty_l[1] ),
    .B1(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_189_));
 sky130_fd_sc_hd__nand2_2 _417_ (.A(\U1.Rduty_l[2] ),
    .B(_189_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_190_));
 sky130_fd_sc_hd__or2_2 _418_ (.A(\U1.Rduty_l[2] ),
    .B(_189_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_191_));
 sky130_fd_sc_hd__a32o_2 _419_ (.A1(net20),
    .A2(_190_),
    .A3(_191_),
    .B1(net26),
    .B2(net43),
    ...
    .VPWR(VPWR),
    .X(_031_));
 sky130_fd_sc_hd__o31a_2 _420_ (.A1(\U1.Rduty_l[0] ),
    .A2(\U1.Rduty_l[2] ),
    .A3(\U1.Rduty_l[1] ),
    .B1(net31),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_192_));
 sky130_fd_sc_hd__nand2_2 _421_ (.A(\U1.Rduty_l[3] ),
    .B(_192_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_193_));
 sky130_fd_sc_hd__or2_2 _422_ (.A(\U1.Rduty_l[3] ),
    .B(_192_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_194_));
 sky130_fd_sc_hd__a32o_2 _423_ (.A1(net20),
    .A2(_193_),
    .A3(_194_),
    .B1(net26),
    .B2(net40),
    ...
    .VPWR(VPWR),
    .X(_032_));
 sky130_fd_sc_hd__or4_2 _424_ (.A(\U1.Rduty_l[0] ),
    .B(\U1.Rduty_l[3] ),
    .C(\U1.Rduty_l[2] ),
    .D(\U1.Rduty_l[1] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_195_));
 sky130_fd_sc_hd__a21oi_2 _425_ (.A1(net31),
    .A2(_195_),
    .B1(\U1.Rduty_l[4] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_196_));
 sky130_fd_sc_hd__a31o_2 _426_ (.A1(net31),
    .A2(\U1.Rduty_l[4] ),
    .A3(_195_),
    .B1(_112_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_197_));
 sky130_fd_sc_hd__a2bb2o_2 _427_ (.A1_N(_196_),
    .A2_N(_197_),
    .B1(net69),
    .B2(net26),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_033_));
 sky130_fd_sc_hd__nor2_2 _428_ (.A(_070_),
    .B(_196_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_198_));
 sky130_fd_sc_hd__nand2_2 _429_ (.A(\U1.Rduty_l[5] ),
    .B(_198_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_199_));
 sky130_fd_sc_hd__or2_2 _430_ (.A(\U1.Rduty_l[5] ),
    .B(_198_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_200_));
 sky130_fd_sc_hd__a32o_2 _431_ (.A1(net20),
    .A2(_199_),
    .A3(_200_),
    .B1(net27),
    .B2(net45),
    ...
    .VPWR(VPWR),
    .X(_034_));
 sky130_fd_sc_hd__a21oi_2 _432_ (.A1(net31),
    .A2(_200_),
    .B1(\U1.Rduty_l[6] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_201_));
 sky130_fd_sc_hd__a31o_2 _433_ (.A1(\U1.Rduty_l[8] ),
    .A2(\U1.Rduty_l[6] ),
    .A3(_200_),
    .B1(_112_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_202_));
 sky130_fd_sc_hd__a2bb2o_2 _434_ (.A1_N(_201_),
    .A2_N(_202_),
    .B1(net68),
    .B2(net27),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_035_));
 sky130_fd_sc_hd__nor2_2 _435_ (.A(_070_),
    .B(_201_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_203_));
 sky130_fd_sc_hd__xor2_2 _436_ (.A(\U1.Rduty_l[7] ),
    .B(_203_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_204_));
 sky130_fd_sc_hd__a22o_2 _437_ (.A1(net56),
    .A2(net27),
    .B1(net20),
    .B2(_204_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_036_));
 sky130_fd_sc_hd__a22o_2 _438_ (.A1(net48),
    .A2(net26),
    .B1(net20),
    .B2(\U1.Rduty_l[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_037_));
 sky130_fd_sc_hd__nand3_2 _439_ (.A(\U1.Rduty_l[0] ),
    .B(net30),
    .C(\U1.Rduty_r[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_205_));
 sky130_fd_sc_hd__a21o_2 _440_ (.A1(\U1.Rduty_l[0] ),
    .A2(net30),
    .B1(\U1.Rduty_r[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_206_));
 sky130_fd_sc_hd__a32o_2 _441_ (.A1(net19),
    .A2(_205_),
    .A3(_206_),
    .B1(net25),
    .B2(net39),
    ...
    .VPWR(VPWR),
    .X(_038_));
 sky130_fd_sc_hd__o21a_2 _442_ (.A1(\U1.Rduty_l[0] ),
    .A2(\U1.Rduty_r[1] ),
    .B1(net30),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_207_));
 sky130_fd_sc_hd__nand2_2 _443_ (.A(\U1.Rduty_r[2] ),
    .B(_207_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_208_));
 sky130_fd_sc_hd__or2_2 _444_ (.A(\U1.Rduty_r[2] ),
    .B(_207_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_209_));
 sky130_fd_sc_hd__a32o_2 _445_ (.A1(net19),
    .A2(_208_),
    .A3(_209_),
    .B1(net25),
    .B2(net57),
    ...
    .VPWR(VPWR),
    .X(_039_));
 sky130_fd_sc_hd__and2_2 _446_ (.A(net30),
    .B(_209_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_210_));
 sky130_fd_sc_hd__or2_2 _447_ (.A(\U1.Rduty_r[3] ),
    .B(_210_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_211_));
 sky130_fd_sc_hd__nand2_2 _448_ (.A(\U1.Rduty_r[3] ),
    .B(_210_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_212_));
 sky130_fd_sc_hd__a32o_2 _449_ (.A1(net19),
    .A2(_211_),
    .A3(_212_),
    .B1(net25),
    .B2(net54),
    ...
    .VPWR(VPWR),
    .X(_040_));
 sky130_fd_sc_hd__a21o_2 _450_ (.A1(net30),
    .A2(_211_),
    .B1(\U1.Rduty_r[4] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_213_));
 sky130_fd_sc_hd__nand3_2 _451_ (.A(net30),
    .B(\U1.Rduty_r[4] ),
    .C(_211_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_214_));
 sky130_fd_sc_hd__a32o_2 _452_ (.A1(net19),
    .A2(_213_),
    .A3(_214_),
    .B1(net25),
    .B2(net52),
    ...
    .VPWR(VPWR),
    .X(_041_));
 sky130_fd_sc_hd__a21oi_2 _453_ (.A1(net30),
    .A2(_213_),
    .B1(\U1.Rduty_r[5] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_215_));
 sky130_fd_sc_hd__a31o_2 _454_ (.A1(net30),
    .A2(\U1.Rduty_r[5] ),
    .A3(_213_),
    .B1(_112_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_216_));
 sky130_fd_sc_hd__a2bb2o_2 _455_ (.A1_N(_215_),
    .A2_N(_216_),
    .B1(net72),
    .B2(net25),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_042_));
 sky130_fd_sc_hd__o21ai_2 _456_ (.A1(\U1.Rduty_r[5] ),
    .A2(_213_),
    .B1(net30),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_217_));
 sky130_fd_sc_hd__xnor2_2 _457_ (.A(\U1.Rduty_r[6] ),
    .B(_217_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_218_));
 sky130_fd_sc_hd__a22o_2 _458_ (.A1(net50),
    .A2(net27),
    .B1(net20),
    .B2(_218_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_043_));
 sky130_fd_sc_hd__o31a_2 _459_ (.A1(\U1.Rduty_r[6] ),
    .A2(\U1.Rduty_r[5] ),
    .A3(_213_),
    .B1(\U1.Rduty_r[8] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_219_));
 sky130_fd_sc_hd__xor2_2 _460_ (.A(\U1.Rduty_r[7] ),
    .B(_219_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_220_));
 sky130_fd_sc_hd__a22o_2 _461_ (.A1(net51),
    .A2(net28),
    .B1(net20),
    .B2(_220_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_044_));
 sky130_fd_sc_hd__mux2_1 _462_ (.A0(uio_out[0]),
    .A1(net10),
    .S(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_045_));
 sky130_fd_sc_hd__mux2_1 _463_ (.A0(uio_out[1]),
    .A1(net11),
    .S(net23),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_046_));
 sky130_fd_sc_hd__mux2_1 _464_ (.A0(uio_out[2]),
    .A1(net12),
    .S(net23),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_047_));
 sky130_fd_sc_hd__mux2_1 _465_ (.A0(uio_out[3]),
    .A1(net13),
    .S(net23),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_048_));
 sky130_fd_sc_hd__mux2_1 _466_ (.A0(uio_out[4]),
    .A1(net14),
    .S(net28),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_049_));
 sky130_fd_sc_hd__mux2_1 _467_ (.A0(uio_out[5]),
    .A1(net15),
    .S(net23),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_050_));
 sky130_fd_sc_hd__mux2_1 _468_ (.A0(uio_out[6]),
    .A1(net16),
    .S(net23),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_051_));
 sky130_fd_sc_hd__mux2_1 _469_ (.A0(net36),
    .A1(net17),
    .S(net23),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_052_));
 sky130_fd_sc_hd__or2_2 _470_ (.A(\U1.MotorlR.counter[0] ),
    .B(\U1.MotorlR.counter[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_221_));
 sky130_fd_sc_hd__nor2_2 _471_ (.A(_068_),
    .B(_221_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_222_));
 sky130_fd_sc_hd__nand2_2 _472_ (.A(net37),
    .B(\U1.MotorlR.counter[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_223_));
 sky130_fd_sc_hd__o21ai_2 _473_ (.A1(_068_),
    .A2(\U1.MotorlR.counter[0] ),
    .B1(\U1.MotorlR.counter[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_224_));
 sky130_fd_sc_hd__o221a_2 _474_ (.A1(\U1.MotorlR.duty_l[2] ),
    .A2(_071_),
    .B1(_222_),
    .B2(\U1.MotorlR.duty_l[1] ),
    .C1(_224_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_225_));
 sky130_fd_sc_hd__a221o_2 _475_ (.A1(\U1.MotorlR.duty_l[2] ),
    .A2(_071_),
    .B1(_072_),
    .B2(\U1.MotorlR.duty_l[3] ),
    .C1(_225_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_226_));
 sky130_fd_sc_hd__o22a_2 _476_ (.A1(\U1.MotorlR.duty_l[3] ),
    .A2(_072_),
    .B1(_073_),
    .B2(\U1.MotorlR.duty_l[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_227_));
 sky130_fd_sc_hd__a22o_2 _477_ (.A1(\U1.MotorlR.duty_l[4] ),
    .A2(_073_),
    .B1(_074_),
    .B2(\U1.MotorlR.duty_l[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_228_));
 sky130_fd_sc_hd__a21o_2 _478_ (.A1(_226_),
    .A2(_227_),
    .B1(_228_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_229_));
 sky130_fd_sc_hd__o221a_2 _479_ (.A1(\U1.MotorlR.duty_l[5] ),
    .A2(_074_),
    .B1(_075_),
    .B2(\U1.MotorlR.duty_l[6] ),
    .C1(_229_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_230_));
 sky130_fd_sc_hd__a221o_2 _480_ (.A1(\U1.MotorlR.duty_l[6] ),
    .A2(_075_),
    .B1(_076_),
    .B2(\U1.MotorlR.duty_l[7] ),
    .C1(_230_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_231_));
 sky130_fd_sc_hd__nor2_2 _481_ (.A(net7),
    .B(_079_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_232_));
 sky130_fd_sc_hd__o211a_2 _482_ (.A1(net56),
    .A2(_076_),
    .B1(_231_),
    .C1(_232_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_053_));
 sky130_fd_sc_hd__o221a_2 _483_ (.A1(\U1.MotorlR.duty_r[2] ),
    .A2(_071_),
    .B1(_222_),
    .B2(\U1.MotorlR.duty_r[1] ),
    .C1(_224_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_233_));
 sky130_fd_sc_hd__a221o_2 _484_ (.A1(\U1.MotorlR.duty_r[2] ),
    .A2(_071_),
    .B1(_072_),
    .B2(\U1.MotorlR.duty_r[3] ),
    .C1(_233_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_234_));
 sky130_fd_sc_hd__o22a_2 _485_ (.A1(\U1.MotorlR.duty_r[3] ),
    .A2(_072_),
    .B1(_073_),
    .B2(\U1.MotorlR.duty_r[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_235_));
 sky130_fd_sc_hd__a22o_2 _486_ (.A1(\U1.MotorlR.duty_r[4] ),
    .A2(_073_),
    .B1(_074_),
    .B2(\U1.MotorlR.duty_r[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_236_));
 sky130_fd_sc_hd__a21o_2 _487_ (.A1(_234_),
    .A2(_235_),
    .B1(_236_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_237_));
 sky130_fd_sc_hd__o221a_2 _488_ (.A1(\U1.MotorlR.duty_r[5] ),
    .A2(_074_),
    .B1(_075_),
    .B2(\U1.MotorlR.duty_r[6] ),
    .C1(_237_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_238_));
 sky130_fd_sc_hd__a221o_2 _489_ (.A1(\U1.MotorlR.duty_r[6] ),
    .A2(_075_),
    .B1(_076_),
    .B2(\U1.MotorlR.duty_r[7] ),
    .C1(_238_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_239_));
 sky130_fd_sc_hd__o211a_2 _490_ (.A1(net51),
    .A2(_076_),
    .B1(_232_),
    .C1(_239_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_054_));
 sky130_fd_sc_hd__nor2_2 _491_ (.A(net37),
    .B(_079_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_055_));
 sky130_fd_sc_hd__and3_2 _492_ (.A(net34),
    .B(_221_),
    .C(_223_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_056_));
 sky130_fd_sc_hd__nor2_2 _493_ (.A(_071_),
    .B(_223_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_240_));
 sky130_fd_sc_hd__or2_2 _494_ (.A(_079_),
    .B(_240_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_241_));
 sky130_fd_sc_hd__a21oi_2 _495_ (.A1(_071_),
    .A2(_223_),
    .B1(_241_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_057_));
 sky130_fd_sc_hd__a21oi_2 _496_ (.A1(\U1.MotorlR.counter[3] ),
    .A2(_240_),
    .B1(_079_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_242_));
 sky130_fd_sc_hd__o21a_2 _497_ (.A1(net79),
    .A2(_240_),
    .B1(_242_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_058_));
 sky130_fd_sc_hd__a21o_2 _498_ (.A1(\U1.MotorlR.counter[3] ),
    .A2(_240_),
    .B1(\U1.MotorlR.counter[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_243_));
 sky130_fd_sc_hd__and3_2 _499_ (.A(\U1.MotorlR.counter[3] ),
    .B(\U1.MotorlR.counter[4] ),
    .C(_240_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_244_));
 sky130_fd_sc_hd__and3b_2 _500_ (.A_N(_244_),
    .B(net34),
    .C(_243_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_059_));
 sky130_fd_sc_hd__o21ai_2 _501_ (.A1(net47),
    .A2(_244_),
    .B1(net34),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_245_));
 sky130_fd_sc_hd__a21oi_2 _502_ (.A1(net47),
    .A2(_244_),
    .B1(_245_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_060_));
 sky130_fd_sc_hd__a21o_2 _503_ (.A1(\U1.MotorlR.counter[5] ),
    .A2(_244_),
    .B1(\U1.MotorlR.counter[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_246_));
 sky130_fd_sc_hd__and3_2 _504_ (.A(\U1.MotorlR.counter[5] ),
    .B(\U1.MotorlR.counter[6] ),
    .C(_244_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_247_));
 sky130_fd_sc_hd__and3b_2 _505_ (.A_N(_247_),
    .B(net34),
    .C(_246_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_061_));
 sky130_fd_sc_hd__o21ai_2 _506_ (.A1(net38),
    .A2(_247_),
    .B1(net35),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_248_));
 sky130_fd_sc_hd__a21oi_2 _507_ (.A1(net38),
    .A2(_247_),
    .B1(_248_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_062_));
 sky130_fd_sc_hd__and4_2 _508_ (.A(net3),
    .B(net2),
    .C(net4),
    .D(_091_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_249_));
 sky130_fd_sc_hd__or4_2 _509_ (.A(net5),
    .B(net3),
    .C(net2),
    .D(net4),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_250_));
 sky130_fd_sc_hd__nor2_2 _510_ (.A(net6),
    .B(_250_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_251_));
 sky130_fd_sc_hd__or3_2 _511_ (.A(_086_),
    .B(_249_),
    .C(_251_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_252_));
 sky130_fd_sc_hd__o211a_2 _512_ (.A1(_094_),
    .A2(_252_),
    .B1(_232_),
    .C1(net33),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_063_));
 sky130_fd_sc_hd__and2_2 _513_ (.A(net35),
    .B(_252_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_064_));
 sky130_fd_sc_hd__nor2_2 _514_ (.A(_090_),
    .B(_091_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_253_));
 sky130_fd_sc_hd__or3_2 _515_ (.A(_096_),
    .B(_251_),
    .C(_253_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_254_));
 sky130_fd_sc_hd__o211a_2 _516_ (.A1(_087_),
    .A2(_254_),
    .B1(_232_),
    .C1(net33),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_065_));
 sky130_fd_sc_hd__and2_2 _517_ (.A(net35),
    .B(_254_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_066_));
 sky130_fd_sc_hd__dfxtp_2 _518_ (.CLK(clknet_3_7__leaf_clk),
    .D(_000_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.error[0] ));
 sky130_fd_sc_hd__dfxtp_2 _519_ (.CLK(clknet_3_7__leaf_clk),
    .D(_001_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.error[2] ));
 sky130_fd_sc_hd__dfxtp_2 _520_ (.CLK(clknet_3_7__leaf_clk),
    .D(_002_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.error[3] ));
 sky130_fd_sc_hd__dfxtp_2 _521_ (.CLK(clknet_3_7__leaf_clk),
    .D(_003_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.error[1] ));
 sky130_fd_sc_hd__dfxtp_2 _522_ (.CLK(clknet_3_0__leaf_clk),
    .D(_004_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.Corr[0] ));
 sky130_fd_sc_hd__dfxtp_2 _523_ (.CLK(clknet_3_0__leaf_clk),
    .D(_005_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.Corr[1] ));
 sky130_fd_sc_hd__dfxtp_2 _524_ (.CLK(clknet_3_0__leaf_clk),
    .D(_006_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.Corr[2] ));
 sky130_fd_sc_hd__dfxtp_2 _525_ (.CLK(clknet_3_0__leaf_clk),
    .D(_007_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.Corr[3] ));
 sky130_fd_sc_hd__dfxtp_2 _526_ (.CLK(clknet_3_0__leaf_clk),
    .D(_008_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.Corr[4] ));
 sky130_fd_sc_hd__dfxtp_2 _527_ (.CLK(clknet_3_0__leaf_clk),
    .D(_009_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.Corr[5] ));
 sky130_fd_sc_hd__dfxtp_2 _528_ (.CLK(clknet_3_0__leaf_clk),
    .D(_010_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.Corr[6] ));
 sky130_fd_sc_hd__dfxtp_2 _529_ (.CLK(clknet_3_2__leaf_clk),
    .D(_011_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.Corr[7] ));
 sky130_fd_sc_hd__dfxtp_2 _530_ (.CLK(clknet_3_2__leaf_clk),
    .D(_012_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _531_ (.CLK(clknet_3_4__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\U1.Rduty_l[1] ));
 sky130_fd_sc_hd__dfxtp_2 _532_ (.CLK(clknet_3_4__leaf_clk),
    .D(_014_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.Rduty_l[2] ));
 sky130_fd_sc_hd__dfxtp_2 _533_ (.CLK(clknet_3_4__leaf_clk),
    .D(_015_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.Rduty_l[3] ));
 sky130_fd_sc_hd__dfxtp_2 _534_ (.CLK(clknet_3_4__leaf_clk),
    .D(_016_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _535_ (.CLK(clknet_3_1__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\U1.Rduty_l[5] ));
 sky130_fd_sc_hd__dfxtp_2 _536_ (.CLK(clknet_3_3__leaf_clk),
    .D(_018_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.Rduty_l[6] ));
 sky130_fd_sc_hd__dfxtp_2 _537_ (.CLK(clknet_3_3__leaf_clk),
    .D(_019_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.Rduty_l[7] ));
 sky130_fd_sc_hd__dfxtp_2 _538_ (.CLK(clknet_3_3__leaf_clk),
    .D(_020_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.Rduty_l[8] ));
 sky130_fd_sc_hd__dfxtp_2 _539_ (.CLK(clknet_3_1__leaf_clk),
    .D(_021_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _540_ (.CLK(clknet_3_1__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\U1.Rduty_r[1] ));
 sky130_fd_sc_hd__dfxtp_2 _541_ (.CLK(clknet_3_0__leaf_clk),
    .D(_023_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.Rduty_r[2] ));
 sky130_fd_sc_hd__dfxtp_2 _542_ (.CLK(clknet_3_0__leaf_clk),
    .D(_024_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _543_ (.CLK(clknet_3_1__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\U1.Rduty_r[4] ));
 sky130_fd_sc_hd__dfxtp_2 _544_ (.CLK(clknet_3_1__leaf_clk),
    .D(_026_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _545_ (.CLK(clknet_3_3__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\U1.Rduty_r[6] ));
 sky130_fd_sc_hd__dfxtp_2 _546_ (.CLK(clknet_3_3__leaf_clk),
    .D(net66),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.Rduty_r[7] ));
 sky130_fd_sc_hd__dfxtp_2 _547_ (.CLK(clknet_3_3__leaf_clk),
    .D(_029_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.Rduty_r[8] ));
 sky130_fd_sc_hd__dfxtp_2 _548_ (.CLK(clknet_3_4__leaf_clk),
    .D(_030_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.MotorlR.duty_l[1] ));
 sky130_fd_sc_hd__dfxtp_2 _549_ (.CLK(clknet_3_5__leaf_clk),
    .D(net44),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.MotorlR.duty_l[2] ));
 sky130_fd_sc_hd__dfxtp_2 _550_ (.CLK(clknet_3_5__leaf_clk),
    .D(net41),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.MotorlR.duty_l[3] ));
 sky130_fd_sc_hd__dfxtp_2 _551_ (.CLK(clknet_3_4__leaf_clk),
    .D(_033_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.MotorlR.duty_l[4] ));
 sky130_fd_sc_hd__dfxtp_2 _552_ (.CLK(clknet_3_4__leaf_clk),
    .D(net46),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.MotorlR.duty_l[5] ));
 sky130_fd_sc_hd__dfxtp_2 _553_ (.CLK(clknet_3_6__leaf_clk),
    .D(_035_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.MotorlR.duty_l[6] ));
 sky130_fd_sc_hd__dfxtp_2 _554_ (.CLK(clknet_3_6__leaf_clk),
    .D(_036_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.MotorlR.duty_l[7] ));
 sky130_fd_sc_hd__dfxtp_2 _555_ (.CLK(clknet_3_5__leaf_clk),
    .D(_037_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.MotorlR.duty_l[0] ));
 sky130_fd_sc_hd__dfxtp_2 _556_ (.CLK(clknet_3_4__leaf_clk),
    .D(_038_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.MotorlR.duty_r[1] ));
 sky130_fd_sc_hd__dfxtp_2 _557_ (.CLK(clknet_3_1__leaf_clk),
    .D(net58),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.MotorlR.duty_r[2] ));
 sky130_fd_sc_hd__dfxtp_2 _558_ (.CLK(clknet_3_4__leaf_clk),
    .D(net55),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.MotorlR.duty_r[3] ));
 sky130_fd_sc_hd__dfxtp_2 _559_ (.CLK(clknet_3_1__leaf_clk),
    .D(net53),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.MotorlR.duty_r[4] ));
 sky130_fd_sc_hd__dfxtp_2 _560_ (.CLK(clknet_3_1__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.MotorlR.duty_r[5] ));
 sky130_fd_sc_hd__dfxtp_2 _561_ (.CLK(clknet_3_7__leaf_clk),
    .D(_043_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.MotorlR.duty_r[6] ));
 sky130_fd_sc_hd__dfxtp_2 _562_ (.CLK(clknet_3_6__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.MotorlR.duty_r[7] ));
 sky130_fd_sc_hd__dfxtp_2 _563_ (.CLK(clknet_3_3__leaf_clk),
    .D(_045_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uio_out[0]));
 sky130_fd_sc_hd__dfxtp_2 _564_ (.CLK(clknet_3_2__leaf_clk),
    .D(_046_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uio_out[1]));
 sky130_fd_sc_hd__dfxtp_2 _565_ (.CLK(clknet_3_2__leaf_clk),
    .D(_047_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _566_ (.CLK(clknet_3_2__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(uio_out[3]));
 sky130_fd_sc_hd__dfxtp_2 _567_ (.CLK(clknet_3_2__leaf_clk),
    .D(_049_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uio_out[4]));
 sky130_fd_sc_hd__dfxtp_2 _568_ (.CLK(clknet_3_2__leaf_clk),
    .D(_050_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _570_ (.CLK(clknet_3_2__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\U1.S_Ki ));
 sky130_fd_sc_hd__dfxtp_2 _571_ (.CLK(clknet_3_6__leaf_clk),
    .D(_053_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.EnL ));
 sky130_fd_sc_hd__dfxtp_2 _572_ (.CLK(clknet_3_6__leaf_clk),
    .D(_054_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.EnR ));
 sky130_fd_sc_hd__dfxtp_2 _573_ (.CLK(clknet_3_5__leaf_clk),
    .D(_055_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.MotorlR.counter[0] ));
 sky130_fd_sc_hd__dfxtp_2 _574_ (.CLK(clknet_3_5__leaf_clk),
    .D(_056_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.MotorlR.counter[1] ));
 sky130_fd_sc_hd__dfxtp_2 _575_ (.CLK(clknet_3_5__leaf_clk),
    .D(net76),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.MotorlR.counter[2] ));
 sky130_fd_sc_hd__dfxtp_2 _576_ (.CLK(clknet_3_5__leaf_clk),
    .D(net80),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.MotorlR.counter[3] ));
 sky130_fd_sc_hd__dfxtp_2 _577_ (.CLK(clknet_3_5__leaf_clk),
    .D(_059_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.MotorlR.counter[4] ));
 sky130_fd_sc_hd__dfxtp_2 _578_ (.CLK(clknet_3_7__leaf_clk),
    .D(_060_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.MotorlR.counter[5] ));
 sky130_fd_sc_hd__dfxtp_2 _579_ (.CLK(clknet_3_7__leaf_clk),
    .D(_061_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.MotorlR.counter[6] ));
 sky130_fd_sc_hd__dfxtp_2 _580_ (.CLK(clknet_3_7__leaf_clk),
    .D(_062_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U1.MotorlR.counter[7] ));
 sky130_fd_sc_hd__dfxtp_2 _581_ (.CLK(clknet_3_6__leaf_clk),
    .D(_063_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U2.EnL ));
 sky130_fd_sc_hd__dfxtp_2 _582_ (.CLK(clknet_3_6__leaf_clk),
    .D(_064_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U2.DirL ));
 sky130_fd_sc_hd__dfxtp_2 _583_ (.CLK(clknet_3_6__leaf_clk),
    .D(_065_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U2.EnR ));
 sky130_fd_sc_hd__dfxtp_2 _584_ (.CLK(clknet_3_3__leaf_clk),
    .D(_066_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\U2.DirR ));
 sky130_fd_sc_hd__buf_2 _585_ (.A(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_oe[0]));
 sky130_fd_sc_hd__buf_2 _586_ (.A(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_oe[1]));
 sky130_fd_sc_hd__buf_2 _587_ (.A(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_oe[2]));
 sky130_fd_sc_hd__buf_2 _588_ (.A(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_oe[3]));
 sky130_fd_sc_hd__buf_2 _589_ (.A(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 _590_ (.A(net32),
    ...
    .VPWR(VPWR),
    .X(uio_oe[5]));
 sky130_fd_sc_hd__buf_2 _591_ (.A(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_oe[6]));
 sky130_fd_sc_hd__buf_2 _592_ (.A(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_oe[7]));
 sky130_fd_sc_hd__buf_2 _593_ (.A(\U1.S_Ki ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 clkload4 (.A(clknet_3_7__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout18 (.A(_112_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout20 (.A(net21),
    ...
    .VPWR(VPWR),
    .X(net20));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout21 (.A(_111_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout27 (.A(net28),
    ...
    .VPWR(VPWR),
    .X(net27));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout28 (.A(_103_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net28));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout29 (.A(uio_out[2]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net29));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout30 (.A(\U1.Rduty_r[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net30));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout31 (.A(\U1.Rduty_l[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout32 (.A(net33),
    ...
    .VPWR(VPWR),
    .X(net32));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout33 (.A(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout35 (.A(net1),
    ...
    .VPWR(VPWR),
    .X(net35));
 sky130_fd_sc_hd__dlygate4sd3_1 hold36 (.A(\U1.S_Ki ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net36));
 sky130_fd_sc_hd__dlygate4sd3_1 hold37 (.A(\U1.MotorlR.counter[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net37));
 sky130_fd_sc_hd__dlygate4sd3_1 hold38 (.A(\U1.MotorlR.counter[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net38));
 sky130_fd_sc_hd__dlygate4sd3_1 hold39 (.A(\U1.MotorlR.duty_r[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net39));
 sky130_fd_sc_hd__dlygate4sd3_1 hold40 (.A(\U1.MotorlR.duty_l[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net40));
 sky130_fd_sc_hd__dlygate4sd3_1 hold41 (.A(_032_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net41));
 sky130_fd_sc_hd__dlygate4sd3_1 hold42 (.A(\U1.error[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net42));
 sky130_fd_sc_hd__dlygate4sd3_1 hold43 (.A(\U1.MotorlR.duty_l[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net43));
 sky130_fd_sc_hd__dlygate4sd3_1 hold44 (.A(_031_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net44));
 sky130_fd_sc_hd__dlygate4sd3_1 hold45 (.A(\U1.MotorlR.duty_l[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold46 (.A(_034_),
    ...
    .VPWR(VPWR),
    .X(net46));
 sky130_fd_sc_hd__dlygate4sd3_1 hold47 (.A(\U1.MotorlR.counter[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net47));
 sky130_fd_sc_hd__dlygate4sd3_1 hold48 (.A(\U1.MotorlR.duty_l[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net48));
 sky130_fd_sc_hd__dlygate4sd3_1 hold49 (.A(\U1.Rduty_l[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net49));
 sky130_fd_sc_hd__dlygate4sd3_1 hold50 (.A(\U1.MotorlR.duty_r[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net50));
 sky130_fd_sc_hd__dlygate4sd3_1 hold51 (.A(\U1.MotorlR.duty_r[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net51));
 sky130_fd_sc_hd__dlygate4sd3_1 hold52 (.A(\U1.MotorlR.duty_r[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net52));
 sky130_fd_sc_hd__dlygate4sd3_1 hold53 (.A(_041_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net53));
 sky130_fd_sc_hd__dlygate4sd3_1 hold54 (.A(\U1.MotorlR.duty_r[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net54));
 sky130_fd_sc_hd__dlygate4sd3_1 hold55 (.A(_040_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net55));
 sky130_fd_sc_hd__dlygate4sd3_1 hold56 (.A(\U1.MotorlR.duty_l[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net56));
 sky130_fd_sc_hd__dlygate4sd3_1 hold57 (.A(\U1.MotorlR.duty_r[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold58 (.A(_039_),
    ...
    .VPWR(VPWR),
    .X(net58));
 sky130_fd_sc_hd__dlygate4sd3_1 hold59 (.A(\U1.MotorlR.duty_l[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net59));
 sky130_fd_sc_hd__dlygate4sd3_1 hold60 (.A(\U1.Rduty_r[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net60));
 sky130_fd_sc_hd__dlygate4sd3_1 hold61 (.A(\U1.Rduty_l[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net61));
 sky130_fd_sc_hd__dlygate4sd3_1 hold62 (.A(\U1.Rduty_l[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net62));
 sky130_fd_sc_hd__dlygate4sd3_1 hold63 (.A(\U1.Rduty_l[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net63));
 sky130_fd_sc_hd__dlygate4sd3_1 hold64 (.A(\U1.Rduty_l[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net64));
 sky130_fd_sc_hd__dlygate4sd3_1 hold65 (.A(\U1.Rduty_r[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold66 (.A(_028_),
    ...
    .VPWR(VPWR),
    .X(net66));
 sky130_fd_sc_hd__dlygate4sd3_1 hold67 (.A(\U1.error[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net67));
 sky130_fd_sc_hd__dlygate4sd3_1 hold68 (.A(\U1.MotorlR.duty_l[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net68));
 sky130_fd_sc_hd__dlygate4sd3_1 hold69 (.A(\U1.MotorlR.duty_l[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net69));
 sky130_fd_sc_hd__dlygate4sd3_1 hold70 (.A(\U1.Rduty_r[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net70));
 sky130_fd_sc_hd__dlygate4sd3_1 hold71 (.A(\U1.Rduty_r[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net71));
 sky130_fd_sc_hd__dlygate4sd3_1 hold72 (.A(\U1.MotorlR.duty_r[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net72));
 sky130_fd_sc_hd__dlygate4sd3_1 hold73 (.A(\U1.Rduty_r[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net73));
 sky130_fd_sc_hd__dlygate4sd3_1 hold74 (.A(\U1.error[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net74));
 sky130_fd_sc_hd__dlygate4sd3_1 hold75 (.A(\U1.MotorlR.counter[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net75));
 sky130_fd_sc_hd__dlygate4sd3_1 hold76 (.A(_057_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net76));
 sky130_fd_sc_hd__dlygate4sd3_1 hold77 (.A(\U1.Rduty_l[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net77));
 sky130_fd_sc_hd__dlygate4sd3_1 hold78 (.A(\U1.Corr[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net78));
 sky130_fd_sc_hd__dlygate4sd3_1 hold79 (.A(\U1.MotorlR.counter[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net79));
 sky130_fd_sc_hd__dlygate4sd3_1 hold80 (.A(_058_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net80));
 sky130_fd_sc_hd__dlygate4sd3_1 hold81 (.A(\U1.Rduty_r[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net81));
 sky130_fd_sc_hd__dlygate4sd3_1 hold82 (.A(\U1.Rduty_l[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net82));
 sky130_fd_sc_hd__dlygate4sd3_1 hold83 (.A(\U1.Rduty_r[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net83));
 sky130_fd_sc_hd__dlygate4sd3_1 hold84 (.A(\U1.Corr[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net84));
 sky130_fd_sc_hd__dlygate4sd3_1 hold85 (.A(\U1.Rduty_r[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net85));
 sky130_fd_sc_hd__dlygate4sd3_1 hold86 (.A(\U1.Corr[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net86));
 sky130_fd_sc_hd__dlygate4sd3_1 hold87 (.A(\U1.Corr[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
