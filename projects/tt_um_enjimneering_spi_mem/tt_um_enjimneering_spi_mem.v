module tt_um_enjimneering_spi_mem (clk,
    ena,
    rst_n,
    VPWR,
    VGND,
 ...
 wire spi_mosi;
 wire spi_sck;
 wire \u_spi_mem_ctrl.bit_count[0] ;
 wire \u_spi_mem_ctrl.bit_count[1] ;
 wire \u_spi_mem_ctrl.bit_count[2] ;
 wire \u_spi_mem_ctrl.bit_count[3] ;
 wire \u_spi_mem_ctrl.bit_count[4] ;
 wire \u_spi_mem_ctrl.clk_shifter ;
 wire \u_spi_mem_ctrl.clk_spi ;
 wire \u_spi_mem_ctrl.phase ;
 wire \u_spi_mem_ctrl.shift_in[0] ;
 wire \u_spi_mem_ctrl.shift_in[1] ;
 wire \u_spi_mem_ctrl.shift_in[2] ;
 wire \u_spi_mem_ctrl.shift_in[3] ;
 wire \u_spi_mem_ctrl.shift_in[4] ;
 wire \u_spi_mem_ctrl.shift_in[5] ;
 wire \u_spi_mem_ctrl.shift_in[6] ;
 wire \u_spi_mem_ctrl.shift_out[0] ;
 wire \u_spi_mem_ctrl.shift_out[10] ;
 wire \u_spi_mem_ctrl.shift_out[11] ;
 wire \u_spi_mem_ctrl.shift_out[12] ;
 wire \u_spi_mem_ctrl.shift_out[13] ;
 wire \u_spi_mem_ctrl.shift_out[14] ;
 wire \u_spi_mem_ctrl.shift_out[15] ;
 wire \u_spi_mem_ctrl.shift_out[16] ;
 wire \u_spi_mem_ctrl.shift_out[17] ;
 wire \u_spi_mem_ctrl.shift_out[18] ;
 wire \u_spi_mem_ctrl.shift_out[19] ;
 wire \u_spi_mem_ctrl.shift_out[1] ;
 wire \u_spi_mem_ctrl.shift_out[20] ;
 wire \u_spi_mem_ctrl.shift_out[21] ;
 wire \u_spi_mem_ctrl.shift_out[22] ;
 wire \u_spi_mem_ctrl.shift_out[23] ;
 wire \u_spi_mem_ctrl.shift_out[2] ;
 wire \u_spi_mem_ctrl.shift_out[3] ;
 wire \u_spi_mem_ctrl.shift_out[4] ;
 wire \u_spi_mem_ctrl.shift_out[5] ;
 wire \u_spi_mem_ctrl.shift_out[6] ;
 wire \u_spi_mem_ctrl.shift_out[7] ;
 wire \u_spi_mem_ctrl.shift_out[8] ;
 wire \u_spi_mem_ctrl.shift_out[9] ;
 wire \u_spi_mem_ctrl.state[0] ;
 wire \u_spi_mem_ctrl.state[1] ;
 wire \u_spi_mem_ctrl.state[2] ;
 wire \u_spi_mem_ctrl.state[3] ;
 wire \u_spi_mem_ctrl.valid ;
 wire \u_vga_sync.hpos[0] ;
 wire \u_vga_sync.hpos[1] ;
 wire \u_vga_sync.hpos[2] ;
 wire \u_vga_sync.hpos[3] ;
 wire \u_vga_sync.hpos[4] ;
 wire \u_vga_sync.hpos[5] ;
 wire \u_vga_sync.hpos[6] ;
 wire \u_vga_sync.hpos[7] ;
 wire \u_vga_sync.hpos[8] ;
 wire \u_vga_sync.hpos[9] ;
 wire \u_vga_sync.vpos[0] ;
 wire \u_vga_sync.vpos[1] ;
 wire \u_vga_sync.vpos[2] ;
 wire \u_vga_sync.vpos[3] ;
 wire \u_vga_sync.vpos[4] ;
 wire \u_vga_sync.vpos[5] ;
 wire \u_vga_sync.vpos[6] ;
 wire \u_vga_sync.vpos[7] ;
 wire \u_vga_sync.vpos[8] ;
 wire \u_vga_sync.vpos[9] ;
 wire \u_vga_sync.vsync ;
 wire net2;
 wire net3;
 wire net4;
 wire net5;
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_137 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _311_ (.A(\u_spi_mem_ctrl.bit_count[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _313_ (.A(net4),
    ...
    .VPWR(VPWR),
    .Y(_108_));
 sky130_fd_sc_hd__inv_2 _314_ (.A(\u_spi_mem_ctrl.state[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_109_));
 sky130_fd_sc_hd__nor3_2 _315_ (.A(\u_spi_mem_ctrl.bit_count[4] ),
    .B(\u_spi_mem_ctrl.bit_count[3] ),
    .C(\u_spi_mem_ctrl.bit_count[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_110_));
 sky130_fd_sc_hd__and4b_2 _316_ (.A_N(\u_spi_mem_ctrl.bit_count[1] ),
    .B(\u_spi_mem_ctrl.bit_count[0] ),
    .C(\u_spi_mem_ctrl.phase ),
    .D(_110_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_111_));
 sky130_fd_sc_hd__nand2_2 _317_ (.A(net32),
    .B(_111_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_112_));
 sky130_fd_sc_hd__and2b_2 _318_ (.A_N(net5),
    .B(net40),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_113_));
 sky130_fd_sc_hd__nand2b_2 _319_ (.A_N(net5),
    .B(net40),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_114_));
 sky130_fd_sc_hd__nor2_2 _320_ (.A(_112_),
    .B(_114_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_008_));
 sky130_fd_sc_hd__or2_2 _321_ (.A(\u_vga_sync.hpos[4] ),
    .B(\u_vga_sync.hpos[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_115_));
 sky130_fd_sc_hd__or4_2 _322_ (.A(\u_vga_sync.hpos[0] ),
    .B(\u_vga_sync.hpos[1] ),
    .C(\u_vga_sync.hpos[2] ),
    .D(\u_vga_sync.hpos[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_116_));
 sky130_fd_sc_hd__nor2_2 _323_ (.A(_115_),
    .B(_116_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_117_));
 sky130_fd_sc_hd__nand4_2 _324_ (.A(\u_vga_sync.vpos[5] ),
    .B(\u_vga_sync.vpos[6] ),
    .C(\u_vga_sync.vpos[7] ),
    .D(\u_vga_sync.vpos[8] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_118_));
 sky130_fd_sc_hd__or2_2 _325_ (.A(\u_vga_sync.vpos[4] ),
    .B(\u_vga_sync.vpos[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_119_));
 sky130_fd_sc_hd__or4_2 _326_ (.A(_115_),
    .B(_116_),
    .C(_118_),
    .D(_119_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_120_));
 sky130_fd_sc_hd__or4_2 _327_ (.A(\u_vga_sync.vpos[0] ),
    .B(\u_vga_sync.vpos[1] ),
    .C(\u_vga_sync.vpos[2] ),
    .D(\u_vga_sync.vpos[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_121_));
 sky130_fd_sc_hd__nand2_2 _328_ (.A(\u_vga_sync.hpos[7] ),
    .B(\u_vga_sync.hpos[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_122_));
 sky130_fd_sc_hd__or4b_2 _329_ (.A(\u_vga_sync.hpos[6] ),
    .B(_122_),
    .C(\u_vga_sync.hpos[8] ),
    .D_N(net38),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_123_));
 sky130_fd_sc_hd__o32ai_2 _330_ (.A1(_120_),
    .A2(_121_),
    .A3(_123_),
    .B1(net38),
    .B2(_108_),
    ...
    .VPWR(VPWR),
    .Y(_124_));
 sky130_fd_sc_hd__and2_2 _331_ (.A(\u_spi_mem_ctrl.state[3] ),
    .B(net33),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_031_));
 sky130_fd_sc_hd__and2b_2 _332_ (.A_N(_124_),
    .B(_031_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_125_));
 sky130_fd_sc_hd__and4b_2 _333_ (.A_N(\u_spi_mem_ctrl.bit_count[1] ),
    .B(\u_spi_mem_ctrl.bit_count[0] ),
    .C(net31),
    .D(_110_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_126_));
 sky130_fd_sc_hd__nor2_2 _334_ (.A(_111_),
    .B(_114_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_127_));
 sky130_fd_sc_hd__a32o_2 _335_ (.A1(\u_spi_mem_ctrl.phase ),
    .A2(net33),
    .A3(_126_),
    .B1(_127_),
    .B2(net32),
    ...
    .VPWR(VPWR),
    .X(_128_));
 sky130_fd_sc_hd__or2_2 _336_ (.A(_125_),
    .B(_128_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_010_));
 sky130_fd_sc_hd__nand2b_2 _337_ (.A_N(net38),
    .B(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_129_));
 sky130_fd_sc_hd__or4_2 _338_ (.A(\u_vga_sync.vpos[4] ),
    .B(\u_vga_sync.vpos[5] ),
    .C(\u_vga_sync.vpos[6] ),
    .D(\u_vga_sync.vpos[7] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_130_));
 sky130_fd_sc_hd__o21ba_2 _339_ (.A1(_121_),
    .A2(_130_),
    .B1_N(\u_vga_sync.vpos[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_131_));
 sky130_fd_sc_hd__or2_2 _340_ (.A(\u_vga_sync.hpos[6] ),
    .B(\u_vga_sync.hpos[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_132_));
 sky130_fd_sc_hd__or4b_2 _341_ (.A(\u_vga_sync.hpos[8] ),
    .B(\u_vga_sync.hpos[9] ),
    .C(\u_vga_sync.vpos[9] ),
    .D_N(net38),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_133_));
 sky130_fd_sc_hd__or2_2 _342_ (.A(_132_),
    .B(_133_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_134_));
 sky130_fd_sc_hd__or4b_2 _343_ (.A(\u_vga_sync.vpos[8] ),
    .B(_131_),
    .C(_134_),
    .D_N(_117_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_135_));
 sky130_fd_sc_hd__nand2_2 _344_ (.A(_129_),
    .B(_135_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_136_));
 sky130_fd_sc_hd__a32o_2 _345_ (.A1(\u_spi_mem_ctrl.state[0] ),
    .A2(_129_),
    .A3(_135_),
    .B1(_124_),
    .B2(\u_spi_mem_ctrl.state[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_137_));
 sky130_fd_sc_hd__or2_2 _346_ (.A(_114_),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_009_));
 sky130_fd_sc_hd__a32o_2 _347_ (.A1(\u_spi_mem_ctrl.state[0] ),
    .A2(net33),
    .A3(_136_),
    .B1(_127_),
    .B2(net31),
    ...
    .VPWR(VPWR),
    .X(_011_));
 sky130_fd_sc_hd__mux2_1 _348_ (.A0(\spi_data_out[0] ),
    .A1(net49),
    .S(net39),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_000_));
 sky130_fd_sc_hd__mux2_1 _349_ (.A0(\spi_data_out[1] ),
    .A1(net62),
    .S(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_001_));
 sky130_fd_sc_hd__mux2_1 _350_ (.A0(\spi_data_out[2] ),
    .A1(net58),
    .S(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_002_));
 sky130_fd_sc_hd__mux2_1 _351_ (.A0(\spi_data_out[3] ),
    .A1(net60),
    .S(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_003_));
 sky130_fd_sc_hd__mux2_1 _352_ (.A0(\spi_data_out[4] ),
    .A1(net51),
    .S(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_004_));
 sky130_fd_sc_hd__mux2_1 _353_ (.A0(\spi_data_out[5] ),
    .A1(net54),
    .S(net39),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_005_));
 sky130_fd_sc_hd__mux2_1 _354_ (.A0(\spi_data_out[6] ),
    .A1(net73),
    .S(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_006_));
 sky130_fd_sc_hd__mux2_1 _355_ (.A0(\spi_data_out[7] ),
    .A1(net56),
    .S(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_007_));
 sky130_fd_sc_hd__and2b_2 _356_ (.A_N(net25),
    .B(net40),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_138_));
 sky130_fd_sc_hd__mux2_1 _357_ (.A0(net25),
    .A1(_138_),
    .S(\vga_addr[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_012_));
 sky130_fd_sc_hd__nand2_2 _358_ (.A(\vga_addr[1] ),
    .B(\vga_addr[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_139_));
 sky130_fd_sc_hd__and3_2 _359_ (.A(net25),
    .B(\vga_addr[1] ),
    .C(\vga_addr[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_140_));
 sky130_fd_sc_hd__or2_2 _360_ (.A(\vga_addr[1] ),
    .B(\vga_addr[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_141_));
 sky130_fd_sc_hd__a32o_2 _361_ (.A1(net25),
    .A2(_139_),
    .A3(_141_),
    .B1(net128),
    .B2(_138_),
    ...
    .VPWR(VPWR),
    .X(_013_));
 sky130_fd_sc_hd__or2_2 _362_ (.A(net26),
    .B(net1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_142_));
 sky130_fd_sc_hd__inv_2 _363_ (.A(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_143_));
 sky130_fd_sc_hd__nand2_2 _364_ (.A(\vga_addr[2] ),
    .B(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_144_));
 sky130_fd_sc_hd__mux2_1 _365_ (.A0(_144_),
    .A1(\vga_addr[2] ),
    .S(_140_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_145_));
 sky130_fd_sc_hd__inv_2 _366_ (.A(_145_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_014_));
 sky130_fd_sc_hd__and4_2 _367_ (.A(\vga_addr[1] ),
    .B(\vga_addr[0] ),
    .C(\vga_addr[2] ),
    .D(\vga_addr[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_146_));
 sky130_fd_sc_hd__inv_2 _368_ (.A(_146_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_147_));
 sky130_fd_sc_hd__a31o_2 _369_ (.A1(\vga_addr[1] ),
    .A2(\vga_addr[0] ),
    .A3(\vga_addr[2] ),
    .B1(\vga_addr[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_148_));
 sky130_fd_sc_hd__a32o_2 _370_ (.A1(net25),
    .A2(_147_),
    .A3(_148_),
    .B1(net86),
    .B2(_138_),
    ...
    .VPWR(VPWR),
    .X(_015_));
 sky130_fd_sc_hd__a22oi_2 _371_ (.A1(net133),
    .A2(net24),
    .B1(_146_),
    .B2(net25),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_149_));
 sky130_fd_sc_hd__and4_2 _372_ (.A(net25),
    .B(\vga_addr[2] ),
    .C(\vga_addr[3] ),
    .D(\vga_addr[4] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_150_));
 sky130_fd_sc_hd__and3_2 _373_ (.A(net25),
    .B(\vga_addr[4] ),
    .C(_146_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_151_));
 sky130_fd_sc_hd__nor2_2 _374_ (.A(_149_),
    .B(_151_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_016_));
 sky130_fd_sc_hd__a21oi_2 _375_ (.A1(net66),
    .A2(net24),
    .B1(_151_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_152_));
 sky130_fd_sc_hd__and3_2 _376_ (.A(\vga_addr[1] ),
    .B(\vga_addr[0] ),
    .C(\vga_addr[5] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_153_));
 sky130_fd_sc_hd__a21oi_2 _377_ (.A1(net66),
    .A2(_151_),
    .B1(_152_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_017_));
 sky130_fd_sc_hd__a22o_2 _378_ (.A1(\vga_addr[6] ),
    .A2(net24),
    .B1(_150_),
    .B2(_153_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_154_));
 sky130_fd_sc_hd__and4_2 _379_ (.A(\vga_addr[4] ),
    .B(\vga_addr[5] ),
    .C(\vga_addr[6] ),
    .D(_146_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_155_));
 sky130_fd_sc_hd__nand2_2 _380_ (.A(net25),
    .B(_155_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_156_));
 sky130_fd_sc_hd__and2_2 _381_ (.A(_154_),
    .B(_156_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_018_));
 sky130_fd_sc_hd__nand2_2 _382_ (.A(\vga_addr[7] ),
    .B(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_157_));
 sky130_fd_sc_hd__mux2_1 _383_ (.A0(\vga_addr[7] ),
    .A1(_157_),
    .S(_156_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_158_));
 sky130_fd_sc_hd__inv_2 _384_ (.A(_158_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_019_));
 sky130_fd_sc_hd__a32o_2 _385_ (.A1(net25),
    .A2(\vga_addr[7] ),
    .A3(_155_),
    .B1(net24),
    .B2(\vga_addr[8] ),
    ...
    .VPWR(VPWR),
    .X(_159_));
 sky130_fd_sc_hd__inv_2 _386_ (.A(_159_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_160_));
 sky130_fd_sc_hd__and4_2 _387_ (.A(net26),
    .B(\vga_addr[7] ),
    .C(\vga_addr[8] ),
    .D(_155_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_161_));
 sky130_fd_sc_hd__nor2_2 _388_ (.A(_160_),
    .B(_161_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_020_));
 sky130_fd_sc_hd__nand2_2 _389_ (.A(\vga_addr[9] ),
    .B(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_162_));
 sky130_fd_sc_hd__mux2_1 _390_ (.A0(_162_),
    .A1(\vga_addr[9] ),
    .S(_161_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_163_));
 sky130_fd_sc_hd__inv_2 _391_ (.A(_163_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_021_));
 sky130_fd_sc_hd__and4_2 _392_ (.A(\vga_addr[7] ),
    .B(\vga_addr[8] ),
    .C(\vga_addr[9] ),
    .D(_155_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_164_));
 sky130_fd_sc_hd__a22oi_2 _393_ (.A1(\vga_addr[10] ),
    .A2(net24),
    .B1(_161_),
    .B2(\vga_addr[9] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_165_));
 sky130_fd_sc_hd__and4_2 _394_ (.A(\vga_addr[7] ),
    .B(\vga_addr[8] ),
    .C(\vga_addr[9] ),
    .D(\vga_addr[10] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_166_));
 sky130_fd_sc_hd__and4_2 _395_ (.A(\vga_addr[6] ),
    .B(_150_),
    .C(_153_),
    .D(_166_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_167_));
 sky130_fd_sc_hd__or2_2 _396_ (.A(_165_),
    .B(_167_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_168_));
 sky130_fd_sc_hd__inv_2 _397_ (.A(_168_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_022_));
 sky130_fd_sc_hd__nand2_2 _398_ (.A(\vga_addr[11] ),
    .B(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_169_));
 sky130_fd_sc_hd__mux2_1 _399_ (.A0(_169_),
    .A1(\vga_addr[11] ),
    .S(_167_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _400_ (.A(_170_),
    ...
    .VPWR(VPWR),
    .Y(_023_));
 sky130_fd_sc_hd__and4_2 _401_ (.A(net26),
    .B(\vga_addr[10] ),
    .C(\vga_addr[11] ),
    .D(_164_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_171_));
 sky130_fd_sc_hd__a21oi_2 _402_ (.A1(net121),
    .A2(_142_),
    .B1(_171_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_172_));
 sky130_fd_sc_hd__and3_2 _403_ (.A(\vga_addr[11] ),
    .B(\vga_addr[12] ),
    .C(_167_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_173_));
 sky130_fd_sc_hd__nor2_2 _404_ (.A(_172_),
    .B(_173_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_024_));
 sky130_fd_sc_hd__a21oi_2 _405_ (.A1(net125),
    .A2(_142_),
    .B1(_173_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_174_));
 sky130_fd_sc_hd__and3_2 _406_ (.A(\vga_addr[12] ),
    .B(\vga_addr[13] ),
    .C(_171_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_175_));
 sky130_fd_sc_hd__nor2_2 _407_ (.A(_174_),
    .B(_175_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_025_));
 sky130_fd_sc_hd__and3_2 _408_ (.A(\vga_addr[13] ),
    .B(\vga_addr[14] ),
    .C(_173_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_176_));
 sky130_fd_sc_hd__nor2_2 _409_ (.A(_143_),
    .B(_176_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_177_));
 sky130_fd_sc_hd__o21a_2 _410_ (.A1(net85),
    .A2(_175_),
    .B1(_177_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_026_));
 sky130_fd_sc_hd__mux2_1 _411_ (.A0(_176_),
    .A1(_177_),
    .S(net82),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_027_));
 sky130_fd_sc_hd__nor2_2 _412_ (.A(\u_spi_mem_ctrl.state[3] ),
    .B(\u_spi_mem_ctrl.state[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_178_));
 sky130_fd_sc_hd__and3_2 _413_ (.A(\u_spi_mem_ctrl.phase ),
    .B(net33),
    .C(_178_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_028_));
 sky130_fd_sc_hd__nor2_2 _414_ (.A(net31),
    .B(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_179_));
 sky130_fd_sc_hd__or2_2 _415_ (.A(net31),
    .B(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_180_));
 sky130_fd_sc_hd__and2b_2 _416_ (.A_N(\u_spi_mem_ctrl.phase ),
    .B(net31),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_181_));
 sky130_fd_sc_hd__or2_2 _417_ (.A(\u_spi_mem_ctrl.phase ),
    .B(_179_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_182_));
 sky130_fd_sc_hd__a32o_2 _418_ (.A1(\u_spi_mem_ctrl.shift_out[23] ),
    .A2(_107_),
    .A3(_181_),
    .B1(_182_),
    .B2(spi_mosi),
    ...
    .VPWR(VPWR),
    .X(_183_));
 sky130_fd_sc_hd__and2_2 _419_ (.A(net33),
    .B(_183_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_029_));
 sky130_fd_sc_hd__o21bai_2 _420_ (.A1(_114_),
    .A2(net16),
    .B1_N(_125_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_184_));
 sky130_fd_sc_hd__o31a_2 _421_ (.A1(net80),
    .A2(\u_spi_mem_ctrl.state[3] ),
    .A3(\u_spi_mem_ctrl.state[0] ),
    .B1(_184_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_030_));
 sky130_fd_sc_hd__and2_2 _422_ (.A(_112_),
    .B(net33),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_185_));
 sky130_fd_sc_hd__a22o_2 _423_ (.A1(net10),
    .A2(_008_),
    .B1(_185_),
    .B2(net77),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_032_));
 sky130_fd_sc_hd__a22o_2 _424_ (.A1(\u_spi_mem_ctrl.shift_in[0] ),
    .A2(_008_),
    .B1(_185_),
    .B2(net71),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_033_));
 sky130_fd_sc_hd__a22o_2 _425_ (.A1(\u_spi_mem_ctrl.shift_in[1] ),
    .A2(_008_),
    .B1(_185_),
    .B2(net67),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_034_));
 sky130_fd_sc_hd__a22o_2 _426_ (.A1(\u_spi_mem_ctrl.shift_in[2] ),
    .A2(_008_),
    .B1(_185_),
    .B2(net69),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_035_));
 sky130_fd_sc_hd__a22o_2 _427_ (.A1(\u_spi_mem_ctrl.shift_in[3] ),
    .A2(_008_),
    .B1(_185_),
    .B2(net78),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_036_));
 sky130_fd_sc_hd__a22o_2 _428_ (.A1(net83),
    .A2(_008_),
    .B1(_185_),
    .B2(\spi_data_out[5] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_037_));
 sky130_fd_sc_hd__a22o_2 _429_ (.A1(\u_spi_mem_ctrl.shift_in[5] ),
    .A2(_008_),
    .B1(_185_),
    .B2(net75),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_038_));
 sky130_fd_sc_hd__a22o_2 _430_ (.A1(net64),
    .A2(_008_),
    .B1(_185_),
    .B2(\spi_data_out[7] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_039_));
 sky130_fd_sc_hd__a21bo_2 _431_ (.A1(net53),
    .A2(_178_),
    .B1_N(_184_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_040_));
 sky130_fd_sc_hd__or3b_2 _432_ (.A(\u_spi_mem_ctrl.state[0] ),
    .B(_180_),
    .C_N(\u_spi_mem_ctrl.phase ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_186_));
 sky130_fd_sc_hd__a21oi_2 _433_ (.A1(_182_),
    .A2(_186_),
    .B1(_114_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_041_));
 sky130_fd_sc_hd__nor2_2 _434_ (.A(net31),
    .B(\u_spi_mem_ctrl.state[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_187_));
 sky130_fd_sc_hd__a21o_2 _435_ (.A1(_109_),
    .A2(_187_),
    .B1(_181_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_2 _436_ (.A(net17),
    ...
    .VPWR(VPWR),
    .Y(_189_));
 sky130_fd_sc_hd__and2_2 _437_ (.A(net39),
    .B(_187_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_190_));
 sky130_fd_sc_hd__a211o_2 _438_ (.A1(\vga_addr[0] ),
    .A2(net20),
    .B1(net21),
    .C1(net17),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_191_));
 sky130_fd_sc_hd__o211a_2 _439_ (.A1(net92),
    .A2(net11),
    .B1(_191_),
    .C1(net36),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_042_));
 sky130_fd_sc_hd__a22o_2 _440_ (.A1(\u_spi_mem_ctrl.shift_out[0] ),
    .A2(net30),
    .B1(\vga_addr[1] ),
    .B2(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_192_));
 sky130_fd_sc_hd__or3_2 _441_ (.A(net17),
    .B(net21),
    .C(_192_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_193_));
 sky130_fd_sc_hd__o211a_2 _442_ (.A1(net94),
    .A2(net11),
    .B1(_193_),
    .C1(net34),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_043_));
 sky130_fd_sc_hd__a22o_2 _443_ (.A1(\u_spi_mem_ctrl.shift_out[1] ),
    .A2(net28),
    .B1(\vga_addr[2] ),
    .B2(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_194_));
 sky130_fd_sc_hd__or3_2 _444_ (.A(net17),
    .B(net21),
    .C(_194_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_195_));
 sky130_fd_sc_hd__o211a_2 _445_ (.A1(net95),
    .A2(net11),
    .B1(_195_),
    .C1(net34),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_044_));
 sky130_fd_sc_hd__a22o_2 _446_ (.A1(\u_spi_mem_ctrl.shift_out[2] ),
    .A2(net28),
    .B1(\vga_addr[3] ),
    .B2(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_196_));
 sky130_fd_sc_hd__or3_2 _447_ (.A(net17),
    .B(net22),
    .C(_196_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_197_));
 sky130_fd_sc_hd__o211a_2 _448_ (.A1(net93),
    .A2(net12),
    .B1(_197_),
    .C1(net34),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_045_));
 sky130_fd_sc_hd__a22o_2 _449_ (.A1(\u_spi_mem_ctrl.shift_out[3] ),
    .A2(net28),
    .B1(\vga_addr[4] ),
    .B2(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_198_));
 sky130_fd_sc_hd__or3_2 _450_ (.A(net17),
    .B(net22),
    .C(_198_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_199_));
 sky130_fd_sc_hd__o211a_2 _451_ (.A1(net91),
    .A2(net12),
    .B1(_199_),
    .C1(net34),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_046_));
 sky130_fd_sc_hd__a22o_2 _452_ (.A1(\u_spi_mem_ctrl.shift_out[4] ),
    .A2(net28),
    .B1(\vga_addr[5] ),
    .B2(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_200_));
 sky130_fd_sc_hd__or3_2 _453_ (.A(net17),
    .B(net22),
    .C(_200_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_201_));
 sky130_fd_sc_hd__o211a_2 _454_ (.A1(net106),
    .A2(net12),
    .B1(_201_),
    .C1(net34),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_047_));
 sky130_fd_sc_hd__a22o_2 _455_ (.A1(\u_spi_mem_ctrl.shift_out[5] ),
    .A2(net28),
    .B1(\vga_addr[6] ),
    .B2(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_202_));
 sky130_fd_sc_hd__or3_2 _456_ (.A(net17),
    .B(net22),
    .C(_202_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_203_));
 sky130_fd_sc_hd__o211a_2 _457_ (.A1(net112),
    .A2(net12),
    .B1(_203_),
    .C1(net34),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_048_));
 sky130_fd_sc_hd__a22o_2 _458_ (.A1(\u_spi_mem_ctrl.shift_out[6] ),
    .A2(net28),
    .B1(\vga_addr[7] ),
    .B2(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_204_));
 sky130_fd_sc_hd__or3_2 _459_ (.A(net18),
    .B(net22),
    .C(_204_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_205_));
 sky130_fd_sc_hd__o211a_2 _460_ (.A1(net98),
    .A2(net12),
    .B1(_205_),
    .C1(net34),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_049_));
 sky130_fd_sc_hd__a22o_2 _461_ (.A1(\u_spi_mem_ctrl.shift_out[7] ),
    .A2(net28),
    .B1(\vga_addr[8] ),
    .B2(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_206_));
 sky130_fd_sc_hd__or3_2 _462_ (.A(net18),
    .B(net22),
    .C(_206_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_207_));
 sky130_fd_sc_hd__o211a_2 _463_ (.A1(net105),
    .A2(net12),
    .B1(_207_),
    .C1(net34),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_050_));
 sky130_fd_sc_hd__a22o_2 _464_ (.A1(\u_spi_mem_ctrl.shift_out[8] ),
    .A2(net28),
    .B1(\vga_addr[9] ),
    .B2(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_208_));
 sky130_fd_sc_hd__or3_2 _465_ (.A(net18),
    .B(net23),
    .C(_208_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_209_));
 sky130_fd_sc_hd__o211a_2 _466_ (.A1(net107),
    .A2(net13),
    .B1(_209_),
    .C1(net34),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_051_));
 sky130_fd_sc_hd__a22o_2 _467_ (.A1(\u_spi_mem_ctrl.shift_out[9] ),
    .A2(net28),
    .B1(\vga_addr[10] ),
    .B2(_190_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_210_));
 sky130_fd_sc_hd__or3_2 _468_ (.A(net18),
    .B(net23),
    .C(_210_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_211_));
 sky130_fd_sc_hd__o211a_2 _469_ (.A1(net115),
    .A2(net13),
    .B1(_211_),
    .C1(net34),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_052_));
 sky130_fd_sc_hd__a22o_2 _470_ (.A1(\u_spi_mem_ctrl.shift_out[10] ),
    .A2(net28),
    .B1(\vga_addr[11] ),
    .B2(_190_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_212_));
 sky130_fd_sc_hd__or3_2 _471_ (.A(net18),
    .B(net23),
    .C(_212_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_213_));
 sky130_fd_sc_hd__o211a_2 _472_ (.A1(net113),
    .A2(net13),
    .B1(_213_),
    .C1(net35),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_053_));
 sky130_fd_sc_hd__mux2_1 _473_ (.A0(net6),
    .A1(\vga_addr[12] ),
    .S(net39),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_214_));
 sky130_fd_sc_hd__a22o_2 _474_ (.A1(\u_spi_mem_ctrl.shift_out[11] ),
    .A2(net29),
    .B1(_187_),
    .B2(_214_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_215_));
 sky130_fd_sc_hd__or3_2 _475_ (.A(net18),
    .B(net23),
    .C(_215_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_216_));
 sky130_fd_sc_hd__o211a_2 _476_ (.A1(net97),
    .A2(net13),
    .B1(_216_),
    .C1(net35),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_054_));
 sky130_fd_sc_hd__mux2_1 _477_ (.A0(net7),
    .A1(\vga_addr[13] ),
    .S(net39),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_217_));
 sky130_fd_sc_hd__a22o_2 _478_ (.A1(\u_spi_mem_ctrl.shift_out[12] ),
    .A2(net29),
    .B1(_187_),
    .B2(_217_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_218_));
 sky130_fd_sc_hd__or3_2 _479_ (.A(net18),
    .B(net23),
    .C(_218_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_219_));
 sky130_fd_sc_hd__o211a_2 _480_ (.A1(net108),
    .A2(net13),
    .B1(_219_),
    .C1(net35),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_055_));
 sky130_fd_sc_hd__mux2_1 _481_ (.A0(net8),
    .A1(\vga_addr[14] ),
    .S(net39),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_220_));
 sky130_fd_sc_hd__a22o_2 _482_ (.A1(\u_spi_mem_ctrl.shift_out[13] ),
    .A2(net29),
    .B1(_187_),
    .B2(_220_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_221_));
 sky130_fd_sc_hd__or3_2 _483_ (.A(net18),
    .B(net23),
    .C(_221_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_222_));
 sky130_fd_sc_hd__o211a_2 _484_ (.A1(net101),
    .A2(net13),
    .B1(_222_),
    .C1(net35),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_056_));
 sky130_fd_sc_hd__mux2_1 _485_ (.A0(net9),
    .A1(\vga_addr[15] ),
    .S(net39),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_223_));
 sky130_fd_sc_hd__a22o_2 _486_ (.A1(\u_spi_mem_ctrl.shift_out[14] ),
    .A2(net29),
    .B1(_187_),
    .B2(_223_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_224_));
 sky130_fd_sc_hd__or3_2 _487_ (.A(net18),
    .B(net23),
    .C(_224_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_225_));
 sky130_fd_sc_hd__o211a_2 _488_ (.A1(net100),
    .A2(net13),
    .B1(_225_),
    .C1(net35),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_057_));
 sky130_fd_sc_hd__a2111o_2 _489_ (.A1(\u_spi_mem_ctrl.shift_out[15] ),
    .A2(net29),
    .B1(net19),
    .C1(_181_),
    .D1(_187_),
    ...
    .VPWR(VPWR),
    .X(_226_));
 sky130_fd_sc_hd__o211a_2 _490_ (.A1(net110),
    .A2(net13),
    .B1(_226_),
    .C1(net36),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_058_));
 sky130_fd_sc_hd__a2111o_2 _491_ (.A1(\u_spi_mem_ctrl.shift_out[16] ),
    .A2(net30),
    .B1(net19),
    .C1(_181_),
    .D1(_187_),
    ...
    .VPWR(VPWR),
    .X(_227_));
 sky130_fd_sc_hd__o211a_2 _492_ (.A1(net104),
    .A2(net11),
    .B1(_227_),
    .C1(net36),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_059_));
 sky130_fd_sc_hd__a211o_2 _493_ (.A1(\u_spi_mem_ctrl.shift_out[17] ),
    .A2(net30),
    .B1(net17),
    .C1(net21),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_228_));
 sky130_fd_sc_hd__o211a_2 _494_ (.A1(net102),
    .A2(net11),
    .B1(_228_),
    .C1(net36),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_060_));
 sky130_fd_sc_hd__a211o_2 _495_ (.A1(\u_spi_mem_ctrl.shift_out[18] ),
    .A2(net30),
    .B1(net17),
    .C1(net21),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_229_));
 sky130_fd_sc_hd__o211a_2 _496_ (.A1(net99),
    .A2(net11),
    .B1(_229_),
    .C1(net36),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_061_));
 sky130_fd_sc_hd__a211o_2 _497_ (.A1(\u_spi_mem_ctrl.shift_out[19] ),
    .A2(net30),
    .B1(net19),
    .C1(net21),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_230_));
 sky130_fd_sc_hd__o211a_2 _498_ (.A1(net96),
    .A2(net11),
    .B1(_230_),
    .C1(net36),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_062_));
 sky130_fd_sc_hd__a211o_2 _499_ (.A1(\u_spi_mem_ctrl.shift_out[20] ),
    .A2(net30),
    .B1(net19),
    .C1(net21),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_231_));
 sky130_fd_sc_hd__o211a_2 _500_ (.A1(net109),
    .A2(net11),
    .B1(_231_),
    .C1(net36),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_063_));
 sky130_fd_sc_hd__a211o_2 _501_ (.A1(\u_spi_mem_ctrl.shift_out[21] ),
    .A2(net30),
    .B1(net19),
    .C1(net21),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_232_));
 sky130_fd_sc_hd__o211a_2 _502_ (.A1(net111),
    .A2(net11),
    .B1(_232_),
    .C1(net36),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_064_));
 sky130_fd_sc_hd__a211o_2 _503_ (.A1(\u_spi_mem_ctrl.shift_out[22] ),
    .A2(net30),
    .B1(net19),
    .C1(net21),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_233_));
 sky130_fd_sc_hd__o211a_2 _504_ (.A1(net117),
    .A2(net11),
    .B1(_233_),
    .C1(net36),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_065_));
 sky130_fd_sc_hd__nand2_2 _505_ (.A(_107_),
    .B(_178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_234_));
 sky130_fd_sc_hd__o21ai_2 _506_ (.A1(\u_spi_mem_ctrl.phase ),
    .A2(_107_),
    .B1(_234_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_235_));
 sky130_fd_sc_hd__nor2_2 _507_ (.A(net15),
    .B(_235_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_236_));
 sky130_fd_sc_hd__a211o_2 _508_ (.A1(net10),
    .A2(net32),
    .B1(net19),
    .C1(_235_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_237_));
 sky130_fd_sc_hd__o211a_2 _509_ (.A1(net123),
    .A2(_236_),
    .B1(_237_),
    .C1(net37),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_066_));
 sky130_fd_sc_hd__a211o_2 _510_ (.A1(\u_spi_mem_ctrl.shift_in[0] ),
    .A2(net32),
    .B1(net19),
    .C1(_235_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_238_));
 sky130_fd_sc_hd__o211a_2 _511_ (.A1(net124),
    .A2(_236_),
    .B1(_238_),
    .C1(net37),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_067_));
 sky130_fd_sc_hd__a211o_2 _512_ (.A1(\u_spi_mem_ctrl.shift_in[1] ),
    .A2(net32),
    .B1(net19),
    .C1(_235_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_239_));
 sky130_fd_sc_hd__o211a_2 _513_ (.A1(net119),
    .A2(_236_),
    .B1(_239_),
    .C1(net37),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_068_));
 sky130_fd_sc_hd__a211o_2 _514_ (.A1(\u_spi_mem_ctrl.shift_in[2] ),
    .A2(\u_spi_mem_ctrl.state[1] ),
    .B1(net16),
    .C1(_235_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_240_));
 sky130_fd_sc_hd__o211a_2 _515_ (.A1(net120),
    .A2(_236_),
    .B1(_240_),
    .C1(net37),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_069_));
 sky130_fd_sc_hd__a211o_2 _516_ (.A1(\u_spi_mem_ctrl.shift_in[3] ),
    .A2(\u_spi_mem_ctrl.state[1] ),
    .B1(net16),
    .C1(_235_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_241_));
 sky130_fd_sc_hd__o211a_2 _517_ (.A1(net83),
    .A2(_236_),
    .B1(_241_),
    .C1(net33),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_070_));
 sky130_fd_sc_hd__a211o_2 _518_ (.A1(\u_spi_mem_ctrl.shift_in[4] ),
    .A2(net32),
    .B1(net15),
    .C1(_235_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_242_));
 sky130_fd_sc_hd__o211a_2 _519_ (.A1(net114),
    .A2(_236_),
    .B1(_242_),
    .C1(net33),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_071_));
 sky130_fd_sc_hd__a211o_2 _520_ (.A1(\u_spi_mem_ctrl.shift_in[5] ),
    .A2(net32),
    .B1(net15),
    .C1(_235_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_243_));
 sky130_fd_sc_hd__o211a_2 _521_ (.A1(net64),
    .A2(_236_),
    .B1(_243_),
    .C1(net33),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_072_));
 sky130_fd_sc_hd__o211ai_2 _522_ (.A1(net31),
    .A2(_234_),
    .B1(_182_),
    .C1(_112_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_244_));
 sky130_fd_sc_hd__o31ai_2 _523_ (.A1(net15),
    .A2(_179_),
    .A3(net14),
    .B1(_106_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_245_));
 sky130_fd_sc_hd__o311a_2 _524_ (.A1(_106_),
    .A2(net15),
    .A3(_244_),
    .B1(_245_),
    .C1(net33),
    ...
    .VPWR(VPWR),
    .X(_073_));
 sky130_fd_sc_hd__o21ai_2 _525_ (.A1(net15),
    .A2(net14),
    .B1(net103),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_246_));
 sky130_fd_sc_hd__or2_2 _526_ (.A(\u_spi_mem_ctrl.bit_count[1] ),
    .B(\u_spi_mem_ctrl.bit_count[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_247_));
 sky130_fd_sc_hd__nand2_2 _527_ (.A(\u_spi_mem_ctrl.bit_count[1] ),
    .B(\u_spi_mem_ctrl.bit_count[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_248_));
 sky130_fd_sc_hd__a2111o_2 _528_ (.A1(_247_),
    .A2(_248_),
    .B1(net15),
    .C1(_179_),
    .D1(net14),
    ...
    .VPWR(VPWR),
    .X(_249_));
 sky130_fd_sc_hd__a21oi_2 _529_ (.A1(_246_),
    .A2(_249_),
    .B1(_114_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_074_));
 sky130_fd_sc_hd__or2_2 _530_ (.A(\u_spi_mem_ctrl.bit_count[2] ),
    .B(_247_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_250_));
 sky130_fd_sc_hd__nand2_2 _531_ (.A(\u_spi_mem_ctrl.bit_count[2] ),
    .B(_247_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_251_));
 sky130_fd_sc_hd__a2111o_2 _532_ (.A1(_250_),
    .A2(_251_),
    .B1(net15),
    .C1(_179_),
    .D1(net14),
    ...
    .VPWR(VPWR),
    .X(_252_));
 sky130_fd_sc_hd__o21ai_2 _533_ (.A1(net15),
    .A2(net14),
    .B1(net116),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_253_));
 sky130_fd_sc_hd__a21oi_2 _534_ (.A1(_252_),
    .A2(_253_),
    .B1(_114_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_075_));
 sky130_fd_sc_hd__o21ai_2 _535_ (.A1(\u_spi_mem_ctrl.bit_count[3] ),
    .A2(_250_),
    .B1(_180_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_254_));
 sky130_fd_sc_hd__inv_2 _536_ (.A(_254_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_255_));
 sky130_fd_sc_hd__or3_2 _537_ (.A(net15),
    .B(net14),
    .C(_255_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_256_));
 sky130_fd_sc_hd__nor2_2 _538_ (.A(\u_spi_mem_ctrl.state[3] ),
    .B(_126_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_257_));
 sky130_fd_sc_hd__or3_2 _539_ (.A(net16),
    .B(net14),
    .C(_257_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_258_));
 sky130_fd_sc_hd__o31ai_2 _540_ (.A1(net16),
    .A2(net14),
    .A3(_250_),
    .B1(net132),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_259_));
 sky130_fd_sc_hd__a31oi_2 _541_ (.A1(_256_),
    .A2(_258_),
    .A3(_259_),
    .B1(_114_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_076_));
 sky130_fd_sc_hd__o31ai_2 _542_ (.A1(net16),
    .A2(net14),
    .A3(_255_),
    .B1(net90),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_260_));
 sky130_fd_sc_hd__or3_2 _543_ (.A(\u_spi_mem_ctrl.bit_count[4] ),
    .B(\u_spi_mem_ctrl.bit_count[3] ),
    .C(_179_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_261_));
 sky130_fd_sc_hd__o22a_2 _544_ (.A1(\u_spi_mem_ctrl.state[3] ),
    .A2(_180_),
    .B1(_250_),
    .B2(_261_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_262_));
 sky130_fd_sc_hd__or3_2 _545_ (.A(net16),
    .B(net14),
    .C(_262_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_263_));
 sky130_fd_sc_hd__a21oi_2 _546_ (.A1(_260_),
    .A2(_263_),
    .B1(_114_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_077_));
 sky130_fd_sc_hd__and2b_2 _547_ (.A_N(net6),
    .B(net40),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_264_));
 sky130_fd_sc_hd__and4b_2 _548_ (.A_N(\u_vga_sync.vpos[2] ),
    .B(\u_vga_sync.vpos[3] ),
    .C(_264_),
    .D(\u_vga_sync.vpos[1] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_265_));
 sky130_fd_sc_hd__or3b_2 _549_ (.A(_118_),
    .B(_119_),
    .C_N(_265_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _550_ (.A(_266_),
    ...
    .VPWR(VPWR),
    .Y(_078_));
 sky130_fd_sc_hd__nand2_2 _551_ (.A(\u_vga_sync.vpos[2] ),
    .B(\u_vga_sync.vpos[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_267_));
 sky130_fd_sc_hd__or4_2 _552_ (.A(\u_vga_sync.vpos[0] ),
    .B(\u_vga_sync.vpos[1] ),
    .C(_130_),
    .D(_267_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_268_));
 sky130_fd_sc_hd__o31a_2 _553_ (.A1(\u_vga_sync.vpos[8] ),
    .A2(_131_),
    .A3(_268_),
    .B1(_264_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_269_));
 sky130_fd_sc_hd__and2b_2 _554_ (.A_N(\u_vga_sync.vpos[0] ),
    .B(_269_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_079_));
 sky130_fd_sc_hd__o21ai_2 _555_ (.A1(net88),
    .A2(\u_vga_sync.vpos[1] ),
    .B1(_264_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_270_));
 sky130_fd_sc_hd__a21oi_2 _556_ (.A1(net88),
    .A2(\u_vga_sync.vpos[1] ),
    .B1(_270_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_080_));
 sky130_fd_sc_hd__and3_2 _557_ (.A(\u_vga_sync.vpos[0] ),
    .B(\u_vga_sync.vpos[1] ),
    .C(\u_vga_sync.vpos[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_271_));
 sky130_fd_sc_hd__a21o_2 _558_ (.A1(\u_vga_sync.vpos[0] ),
    .A2(\u_vga_sync.vpos[1] ),
    .B1(\u_vga_sync.vpos[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_272_));
 sky130_fd_sc_hd__and3b_2 _559_ (.A_N(_271_),
    .B(_272_),
    .C(_269_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_081_));
 sky130_fd_sc_hd__and4_2 _560_ (.A(\u_vga_sync.vpos[0] ),
    .B(\u_vga_sync.vpos[1] ),
    .C(\u_vga_sync.vpos[2] ),
    .D(\u_vga_sync.vpos[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_273_));
 sky130_fd_sc_hd__or2_2 _561_ (.A(\u_vga_sync.vpos[3] ),
    .B(_271_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_274_));
 sky130_fd_sc_hd__and3b_2 _562_ (.A_N(_273_),
    .B(_274_),
    .C(_269_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_082_));
 sky130_fd_sc_hd__and2_2 _563_ (.A(\u_vga_sync.vpos[4] ),
    .B(_273_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_275_));
 sky130_fd_sc_hd__o21ai_2 _564_ (.A1(net126),
    .A2(_273_),
    .B1(_269_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_276_));
 sky130_fd_sc_hd__nor2_2 _565_ (.A(_275_),
    .B(_276_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_083_));
 sky130_fd_sc_hd__and3_2 _566_ (.A(\u_vga_sync.vpos[4] ),
    .B(\u_vga_sync.vpos[5] ),
    .C(_273_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_277_));
 sky130_fd_sc_hd__o21ai_2 _567_ (.A1(net122),
    .A2(_275_),
    .B1(_269_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_278_));
 sky130_fd_sc_hd__nor2_2 _568_ (.A(_277_),
    .B(_278_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_084_));
 sky130_fd_sc_hd__and2_2 _569_ (.A(\u_vga_sync.vpos[6] ),
    .B(_277_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_279_));
 sky130_fd_sc_hd__o21ai_2 _570_ (.A1(net127),
    .A2(_277_),
    .B1(_269_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_280_));
 sky130_fd_sc_hd__nor2_2 _571_ (.A(_279_),
    .B(_280_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_085_));
 sky130_fd_sc_hd__nand2_2 _572_ (.A(net134),
    .B(_279_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_281_));
 sky130_fd_sc_hd__o211a_2 _573_ (.A1(net134),
    .A2(_279_),
    .B1(_281_),
    .C1(_269_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_086_));
 sky130_fd_sc_hd__a31o_2 _574_ (.A1(\u_vga_sync.vpos[6] ),
    .A2(\u_vga_sync.vpos[7] ),
    .A3(_277_),
    .B1(\u_vga_sync.vpos[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_282_));
 sky130_fd_sc_hd__and3_2 _575_ (.A(\u_vga_sync.vpos[7] ),
    .B(\u_vga_sync.vpos[8] ),
    .C(_279_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_283_));
 sky130_fd_sc_hd__and3b_2 _576_ (.A_N(_283_),
    .B(_269_),
    .C(_282_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_087_));
 sky130_fd_sc_hd__a21boi_2 _577_ (.A1(net118),
    .A2(_283_),
    .B1_N(_269_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_284_));
 sky130_fd_sc_hd__o21a_2 _578_ (.A1(net118),
    .A2(_283_),
    .B1(_284_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_088_));
 sky130_fd_sc_hd__and3_2 _579_ (.A(\u_vga_sync.hpos[4] ),
    .B(\u_vga_sync.hpos[5] ),
    .C(\u_vga_sync.hpos[6] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_285_));
 sky130_fd_sc_hd__o2bb2a_2 _580_ (.A1_N(\u_vga_sync.hpos[7] ),
    .A2_N(_285_),
    .B1(_115_),
    .B2(\u_vga_sync.hpos[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_286_));
 sky130_fd_sc_hd__and4bb_2 _581_ (.A_N(\u_vga_sync.hpos[8] ),
    .B_N(_122_),
    .C(_264_),
    .D(_286_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_089_));
 sky130_fd_sc_hd__nand3_2 _582_ (.A(\u_vga_sync.hpos[0] ),
    .B(\u_vga_sync.hpos[1] ),
    .C(\u_vga_sync.hpos[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_287_));
 sky130_fd_sc_hd__and4_2 _583_ (.A(\u_vga_sync.hpos[0] ),
    .B(\u_vga_sync.hpos[1] ),
    .C(\u_vga_sync.hpos[2] ),
    .D(\u_vga_sync.hpos[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_288_));
 sky130_fd_sc_hd__nand2_2 _584_ (.A(\u_vga_sync.hpos[4] ),
    .B(_288_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_289_));
 sky130_fd_sc_hd__nand2_2 _585_ (.A(\u_vga_sync.hpos[8] ),
    .B(\u_vga_sync.hpos[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_290_));
 sky130_fd_sc_hd__o41a_2 _586_ (.A1(\u_vga_sync.hpos[5] ),
    .A2(_132_),
    .A3(_289_),
    .A4(_290_),
    .B1(_264_),
    ...
    .VPWR(VPWR),
    .X(_291_));
 sky130_fd_sc_hd__and2b_2 _587_ (.A_N(\u_vga_sync.hpos[0] ),
    .B(_291_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_090_));
 sky130_fd_sc_hd__a21boi_2 _588_ (.A1(\u_vga_sync.hpos[0] ),
    .A2(\u_vga_sync.hpos[1] ),
    .B1_N(_291_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_292_));
 sky130_fd_sc_hd__o21a_2 _589_ (.A1(\u_vga_sync.hpos[0] ),
    .A2(net130),
    .B1(_292_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_091_));
 sky130_fd_sc_hd__a21o_2 _590_ (.A1(\u_vga_sync.hpos[0] ),
    .A2(\u_vga_sync.hpos[1] ),
    .B1(\u_vga_sync.hpos[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_293_));
 sky130_fd_sc_hd__and3_2 _591_ (.A(_287_),
    .B(_291_),
    .C(_293_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_092_));
 sky130_fd_sc_hd__a31o_2 _592_ (.A1(\u_vga_sync.hpos[0] ),
    .A2(\u_vga_sync.hpos[1] ),
    .A3(\u_vga_sync.hpos[2] ),
    .B1(\u_vga_sync.hpos[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_294_));
 sky130_fd_sc_hd__and3b_2 _593_ (.A_N(_288_),
    .B(_294_),
    .C(_264_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_093_));
 sky130_fd_sc_hd__or2_2 _594_ (.A(\u_vga_sync.hpos[4] ),
    .B(_288_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_2 _595_ (.A(_264_),
    ...
    .VPWR(VPWR),
    .X(_094_));
 sky130_fd_sc_hd__and3_2 _596_ (.A(\u_vga_sync.hpos[4] ),
    .B(\u_vga_sync.hpos[5] ),
    .C(_288_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_296_));
 sky130_fd_sc_hd__a21o_2 _597_ (.A1(\u_vga_sync.hpos[4] ),
    .A2(_288_),
    .B1(\u_vga_sync.hpos[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_297_));
 sky130_fd_sc_hd__and3b_2 _598_ (.A_N(_296_),
    .B(_297_),
    .C(_291_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_095_));
 sky130_fd_sc_hd__and2_2 _599_ (.A(\u_vga_sync.hpos[6] ),
    .B(_296_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_298_));
 sky130_fd_sc_hd__o21ai_2 _600_ (.A1(net129),
    .A2(_296_),
    .B1(_291_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_299_));
 sky130_fd_sc_hd__nor2_2 _601_ (.A(_298_),
    .B(_299_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_096_));
 sky130_fd_sc_hd__or2_2 _602_ (.A(\u_vga_sync.hpos[7] ),
    .B(_298_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_300_));
 sky130_fd_sc_hd__and3_2 _603_ (.A(\u_vga_sync.hpos[6] ),
    .B(\u_vga_sync.hpos[7] ),
    .C(_296_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_301_));
 sky130_fd_sc_hd__nand2_2 _604_ (.A(\u_vga_sync.hpos[7] ),
    .B(_298_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_302_));
 sky130_fd_sc_hd__and3_2 _605_ (.A(_291_),
    .B(_300_),
    .C(_302_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_097_));
 sky130_fd_sc_hd__o21ai_2 _606_ (.A1(net87),
    .A2(_301_),
    .B1(_291_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_303_));
 sky130_fd_sc_hd__a21oi_2 _607_ (.A1(net87),
    .A2(_301_),
    .B1(_303_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_098_));
 sky130_fd_sc_hd__a21o_2 _608_ (.A1(\u_vga_sync.hpos[8] ),
    .A2(_301_),
    .B1(\u_vga_sync.hpos[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_304_));
 sky130_fd_sc_hd__o211a_2 _609_ (.A1(_290_),
    .A2(_302_),
    .B1(_304_),
    .C1(_291_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_099_));
 sky130_fd_sc_hd__mux2_1 _610_ (.A0(\B[0] ),
    .A1(\spi_data_out[0] ),
    .S(net27),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_305_));
 sky130_fd_sc_hd__and2_2 _611_ (.A(net40),
    .B(_305_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_100_));
 sky130_fd_sc_hd__mux2_1 _612_ (.A0(\B[1] ),
    .A1(\spi_data_out[1] ),
    .S(net27),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_306_));
 sky130_fd_sc_hd__and2_2 _613_ (.A(net40),
    .B(_306_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_101_));
 sky130_fd_sc_hd__mux2_1 _614_ (.A0(net54),
    .A1(\spi_data_out[2] ),
    .S(net26),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_307_));
 sky130_fd_sc_hd__and2_2 _615_ (.A(net40),
    .B(_307_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_102_));
 sky130_fd_sc_hd__mux2_1 _616_ (.A0(net135),
    .A1(\spi_data_out[3] ),
    .S(net27),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_308_));
 sky130_fd_sc_hd__and2_2 _617_ (.A(net40),
    .B(_308_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_103_));
 sky130_fd_sc_hd__mux2_1 _618_ (.A0(\R[0] ),
    .A1(\spi_data_out[4] ),
    .S(net27),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_309_));
 sky130_fd_sc_hd__and2_2 _619_ (.A(net40),
    .B(_309_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_104_));
 sky130_fd_sc_hd__mux2_1 _620_ (.A0(net136),
    .A1(\spi_data_out[5] ),
    .S(net26),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_310_));
 sky130_fd_sc_hd__and2_2 _621_ (.A(net40),
    .B(_310_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_105_));
 sky130_fd_sc_hd__dfxtp_2 _622_ (.CLK(clknet_4_3_0_clk_regs),
    .D(_009_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.state[0] ));
 sky130_fd_sc_hd__dfxtp_2 _623_ (.CLK(clknet_4_1_0_clk_regs),
    .D(_010_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.state[1] ));
 sky130_fd_sc_hd__dfxtp_2 _624_ (.CLK(clknet_4_1_0_clk_regs),
    .D(_011_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.state[2] ));
 sky130_fd_sc_hd__dfxtp_2 _625_ (.CLK(clknet_4_3_0_clk_regs),
    .D(_008_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.state[3] ));
 sky130_fd_sc_hd__dfxtp_2 _626_ (.CLK(clknet_4_13_0_clk_regs),
    .D(net50),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uo_out[0]));
 sky130_fd_sc_hd__dfxtp_2 _627_ (.CLK(clknet_4_12_0_clk_regs),
    .D(net63),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uo_out[1]));
 sky130_fd_sc_hd__dfxtp_2 _628_ (.CLK(clknet_4_13_0_clk_regs),
    .D(net59),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uo_out[2]));
 sky130_fd_sc_hd__dfxtp_2 _629_ (.CLK(clknet_4_7_0_clk_regs),
    .D(net61),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uo_out[3]));
 sky130_fd_sc_hd__dfxtp_2 _630_ (.CLK(clknet_4_7_0_clk_regs),
    .D(net52),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uo_out[4]));
 sky130_fd_sc_hd__dfxtp_2 _631_ (.CLK(clknet_4_13_0_clk_regs),
    .D(net55),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uo_out[5]));
 sky130_fd_sc_hd__dfxtp_2 _632_ (.CLK(clknet_4_7_0_clk_regs),
    .D(net74),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uo_out[6]));
 sky130_fd_sc_hd__dfxtp_2 _633_ (.CLK(clknet_4_7_0_clk_regs),
    .D(net57),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uo_out[7]));
 sky130_fd_sc_hd__dfxtp_2 _634_ (.CLK(clknet_4_8_0_clk_regs),
    .D(_012_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\vga_addr[0] ));
 sky130_fd_sc_hd__dfxtp_2 _635_ (.CLK(clknet_4_8_0_clk_regs),
    .D(_013_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\vga_addr[1] ));
 sky130_fd_sc_hd__dfxtp_2 _636_ (.CLK(clknet_4_10_0_clk_regs),
    .D(_014_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\vga_addr[2] ));
 sky130_fd_sc_hd__dfxtp_2 _637_ (.CLK(clknet_4_10_0_clk_regs),
    .D(_015_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\vga_addr[3] ));
 sky130_fd_sc_hd__dfxtp_2 _638_ (.CLK(clknet_4_10_0_clk_regs),
    .D(_016_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\vga_addr[4] ));
 sky130_fd_sc_hd__dfxtp_2 _639_ (.CLK(clknet_4_10_0_clk_regs),
    .D(_017_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\vga_addr[5] ));
 sky130_fd_sc_hd__dfxtp_2 _640_ (.CLK(clknet_4_10_0_clk_regs),
    .D(_018_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\vga_addr[6] ));
 sky130_fd_sc_hd__dfxtp_2 _641_ (.CLK(clknet_4_11_0_clk_regs),
    .D(_019_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\vga_addr[7] ));
 sky130_fd_sc_hd__dfxtp_2 _642_ (.CLK(clknet_4_11_0_clk_regs),
    .D(_020_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\vga_addr[8] ));
 sky130_fd_sc_hd__dfxtp_2 _643_ (.CLK(clknet_4_14_0_clk_regs),
    .D(_021_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\vga_addr[9] ));
 sky130_fd_sc_hd__dfxtp_2 _644_ (.CLK(clknet_4_14_0_clk_regs),
    .D(_022_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\vga_addr[10] ));
 sky130_fd_sc_hd__dfxtp_2 _645_ (.CLK(clknet_4_14_0_clk_regs),
    .D(_023_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\vga_addr[11] ));
 sky130_fd_sc_hd__dfxtp_2 _646_ (.CLK(clknet_4_15_0_clk_regs),
    .D(_024_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\vga_addr[12] ));
 sky130_fd_sc_hd__dfxtp_2 _647_ (.CLK(clknet_4_14_0_clk_regs),
    .D(_025_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\vga_addr[13] ));
 sky130_fd_sc_hd__dfxtp_2 _648_ (.CLK(clknet_4_15_0_clk_regs),
    .D(_026_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\vga_addr[14] ));
 sky130_fd_sc_hd__dfxtp_2 _649_ (.CLK(clknet_4_14_0_clk_regs),
    .D(_027_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\vga_addr[15] ));
 sky130_fd_sc_hd__dfxtp_2 _650_ (.CLK(clknet_4_5_0_clk_regs),
    .D(_028_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(spi_sck));
 sky130_fd_sc_hd__dfxtp_2 _651_ (.CLK(clknet_4_3_0_clk_regs),
    .D(_029_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(spi_mosi));
 sky130_fd_sc_hd__dfxtp_2 _652_ (.CLK(clknet_4_4_0_clk_regs),
    .D(net81),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(busy));
 sky130_fd_sc_hd__dfxtp_2 _653_ (.CLK(clknet_4_6_0_clk_regs),
    .D(_031_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.valid ));
 sky130_fd_sc_hd__dfxtp_2 _654_ (.CLK(clknet_4_12_0_clk_regs),
    .D(_032_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\spi_data_out[0] ));
 sky130_fd_sc_hd__dfxtp_2 _655_ (.CLK(clknet_4_12_0_clk_regs),
    .D(net72),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\spi_data_out[1] ));
 sky130_fd_sc_hd__dfxtp_2 _656_ (.CLK(clknet_4_12_0_clk_regs),
    .D(net68),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\spi_data_out[2] ));
 sky130_fd_sc_hd__dfxtp_2 _657_ (.CLK(clknet_4_6_0_clk_regs),
    .D(net70),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\spi_data_out[3] ));
 sky130_fd_sc_hd__dfxtp_2 _658_ (.CLK(clknet_4_7_0_clk_regs),
    .D(net79),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\spi_data_out[4] ));
 sky130_fd_sc_hd__dfxtp_2 _659_ (.CLK(clknet_4_5_0_clk_regs),
    .D(net84),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\spi_data_out[5] ));
 sky130_fd_sc_hd__dfxtp_2 _660_ (.CLK(clknet_4_5_0_clk_regs),
    .D(net76),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\spi_data_out[6] ));
 sky130_fd_sc_hd__dfxtp_2 _661_ (.CLK(clknet_4_5_0_clk_regs),
    .D(net65),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\spi_data_out[7] ));
 sky130_fd_sc_hd__dfxtp_2 _662_ (.CLK(clknet_4_4_0_clk_regs),
    .D(_040_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(spi_cs_n));
 sky130_fd_sc_hd__dfxtp_2 _663_ (.CLK(clknet_4_4_0_clk_regs),
    .D(_041_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.phase ));
 sky130_fd_sc_hd__dfxtp_2 _664_ (.CLK(clknet_4_9_0_clk_regs),
    .D(_042_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.shift_out[0] ));
 sky130_fd_sc_hd__dfxtp_2 _665_ (.CLK(clknet_4_9_0_clk_regs),
    .D(_043_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.shift_out[1] ));
 sky130_fd_sc_hd__dfxtp_2 _666_ (.CLK(clknet_4_8_0_clk_regs),
    .D(_044_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.shift_out[2] ));
 sky130_fd_sc_hd__dfxtp_2 _667_ (.CLK(clknet_4_10_0_clk_regs),
    .D(_045_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.shift_out[3] ));
 sky130_fd_sc_hd__dfxtp_2 _668_ (.CLK(clknet_4_11_0_clk_regs),
    .D(_046_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.shift_out[4] ));
 sky130_fd_sc_hd__dfxtp_2 _669_ (.CLK(clknet_4_10_0_clk_regs),
    .D(_047_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.shift_out[5] ));
 sky130_fd_sc_hd__dfxtp_2 _670_ (.CLK(clknet_4_11_0_clk_regs),
    .D(_048_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.shift_out[6] ));
 sky130_fd_sc_hd__dfxtp_2 _671_ (.CLK(clknet_4_9_0_clk_regs),
    .D(_049_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.shift_out[7] ));
 sky130_fd_sc_hd__dfxtp_2 _672_ (.CLK(clknet_4_11_0_clk_regs),
    .D(_050_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.shift_out[8] ));
 sky130_fd_sc_hd__dfxtp_2 _673_ (.CLK(clknet_4_14_0_clk_regs),
    .D(_051_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.shift_out[9] ));
 sky130_fd_sc_hd__dfxtp_2 _674_ (.CLK(clknet_4_15_0_clk_regs),
    .D(_052_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.shift_out[10] ));
 sky130_fd_sc_hd__dfxtp_2 _675_ (.CLK(clknet_4_14_0_clk_regs),
    .D(_053_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.shift_out[11] ));
 sky130_fd_sc_hd__dfxtp_2 _676_ (.CLK(clknet_4_15_0_clk_regs),
    .D(_054_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.shift_out[12] ));
 sky130_fd_sc_hd__dfxtp_2 _677_ (.CLK(clknet_4_15_0_clk_regs),
    .D(_055_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.shift_out[13] ));
 sky130_fd_sc_hd__dfxtp_2 _678_ (.CLK(clknet_4_15_0_clk_regs),
    .D(_056_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.shift_out[14] ));
 sky130_fd_sc_hd__dfxtp_2 _679_ (.CLK(clknet_4_13_0_clk_regs),
    .D(_057_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.shift_out[15] ));
 sky130_fd_sc_hd__dfxtp_2 _680_ (.CLK(clknet_4_11_0_clk_regs),
    .D(_058_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.shift_out[16] ));
 sky130_fd_sc_hd__dfxtp_2 _681_ (.CLK(clknet_4_12_0_clk_regs),
    .D(_059_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.shift_out[17] ));
 sky130_fd_sc_hd__dfxtp_2 _682_ (.CLK(clknet_4_9_0_clk_regs),
    .D(_060_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.shift_out[18] ));
 sky130_fd_sc_hd__dfxtp_2 _683_ (.CLK(clknet_4_9_0_clk_regs),
    .D(_061_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.shift_out[19] ));
 sky130_fd_sc_hd__dfxtp_2 _684_ (.CLK(clknet_4_9_0_clk_regs),
    .D(_062_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.shift_out[20] ));
 sky130_fd_sc_hd__dfxtp_2 _685_ (.CLK(clknet_4_9_0_clk_regs),
    .D(_063_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.shift_out[21] ));
 sky130_fd_sc_hd__dfxtp_2 _686_ (.CLK(clknet_4_3_0_clk_regs),
    .D(_064_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.shift_out[22] ));
 sky130_fd_sc_hd__dfxtp_2 _687_ (.CLK(clknet_4_6_0_clk_regs),
    .D(_065_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.shift_out[23] ));
 sky130_fd_sc_hd__dfxtp_2 _688_ (.CLK(clknet_4_6_0_clk_regs),
    .D(_066_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.shift_in[0] ));
 sky130_fd_sc_hd__dfxtp_2 _689_ (.CLK(clknet_4_6_0_clk_regs),
    .D(_067_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.shift_in[1] ));
 sky130_fd_sc_hd__dfxtp_2 _690_ (.CLK(clknet_4_6_0_clk_regs),
    .D(_068_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.shift_in[2] ));
 sky130_fd_sc_hd__dfxtp_2 _691_ (.CLK(clknet_4_5_0_clk_regs),
    .D(_069_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.shift_in[3] ));
 sky130_fd_sc_hd__dfxtp_2 _692_ (.CLK(clknet_4_5_0_clk_regs),
    .D(_070_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.shift_in[4] ));
 sky130_fd_sc_hd__dfxtp_2 _693_ (.CLK(clknet_4_4_0_clk_regs),
    .D(_071_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.shift_in[5] ));
 sky130_fd_sc_hd__dfxtp_2 _694_ (.CLK(clknet_4_4_0_clk_regs),
    .D(_072_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.shift_in[6] ));
 sky130_fd_sc_hd__dfxtp_2 _695_ (.CLK(clknet_4_1_0_clk_regs),
    .D(_073_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.bit_count[0] ));
 sky130_fd_sc_hd__dfxtp_2 _696_ (.CLK(clknet_4_1_0_clk_regs),
    .D(_074_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.bit_count[1] ));
 sky130_fd_sc_hd__dfxtp_2 _697_ (.CLK(clknet_4_1_0_clk_regs),
    .D(_075_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.bit_count[2] ));
 sky130_fd_sc_hd__dfxtp_2 _698_ (.CLK(clknet_4_4_0_clk_regs),
    .D(_076_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.bit_count[3] ));
 sky130_fd_sc_hd__dfxtp_2 _699_ (.CLK(clknet_4_4_0_clk_regs),
    .D(_077_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_spi_mem_ctrl.bit_count[4] ));
 sky130_fd_sc_hd__dfxtp_2 _700_ (.CLK(clknet_4_2_0_clk_regs),
    .D(_078_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_vga_sync.vsync ));
 sky130_fd_sc_hd__dfxtp_2 _701_ (.CLK(clknet_4_0_0_clk_regs),
    .D(_079_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_vga_sync.vpos[0] ));
 sky130_fd_sc_hd__dfxtp_2 _702_ (.CLK(clknet_4_1_0_clk_regs),
    .D(net89),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_vga_sync.vpos[1] ));
 sky130_fd_sc_hd__dfxtp_2 _703_ (.CLK(clknet_4_1_0_clk_regs),
    .D(_081_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_vga_sync.vpos[2] ));
 sky130_fd_sc_hd__dfxtp_2 _704_ (.CLK(clknet_4_0_0_clk_regs),
    .D(_082_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_vga_sync.vpos[3] ));
 sky130_fd_sc_hd__dfxtp_2 _705_ (.CLK(clknet_4_0_0_clk_regs),
    .D(_083_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_vga_sync.vpos[4] ));
 sky130_fd_sc_hd__dfxtp_2 _706_ (.CLK(clknet_4_0_0_clk_regs),
    .D(_084_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_vga_sync.vpos[5] ));
 sky130_fd_sc_hd__dfxtp_2 _707_ (.CLK(clknet_4_0_0_clk_regs),
    .D(_085_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_vga_sync.vpos[6] ));
 sky130_fd_sc_hd__dfxtp_2 _708_ (.CLK(clknet_4_0_0_clk_regs),
    .D(_086_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_vga_sync.vpos[7] ));
 sky130_fd_sc_hd__dfxtp_2 _709_ (.CLK(clknet_4_2_0_clk_regs),
    .D(_087_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_vga_sync.vpos[8] ));
 sky130_fd_sc_hd__dfxtp_2 _710_ (.CLK(clknet_4_0_0_clk_regs),
    .D(_088_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_vga_sync.vpos[9] ));
 sky130_fd_sc_hd__dfxtp_2 _711_ (.CLK(clknet_4_3_0_clk_regs),
    .D(_089_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(hsync));
 sky130_fd_sc_hd__dfxtp_2 _712_ (.CLK(clknet_4_2_0_clk_regs),
    .D(_090_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_vga_sync.hpos[0] ));
 sky130_fd_sc_hd__dfxtp_2 _713_ (.CLK(clknet_4_2_0_clk_regs),
    .D(net131),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_vga_sync.hpos[1] ));
 sky130_fd_sc_hd__dfxtp_2 _714_ (.CLK(clknet_4_2_0_clk_regs),
    .D(_092_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_vga_sync.hpos[2] ));
 sky130_fd_sc_hd__dfxtp_2 _715_ (.CLK(clknet_4_2_0_clk_regs),
    .D(_093_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_vga_sync.hpos[3] ));
 sky130_fd_sc_hd__dfxtp_2 _716_ (.CLK(clknet_4_8_0_clk_regs),
    .D(_094_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_vga_sync.hpos[4] ));
 sky130_fd_sc_hd__dfxtp_2 _717_ (.CLK(clknet_4_8_0_clk_regs),
    .D(_095_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_vga_sync.hpos[5] ));
 sky130_fd_sc_hd__dfxtp_2 _718_ (.CLK(clknet_4_8_0_clk_regs),
    .D(_096_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_vga_sync.hpos[6] ));
 sky130_fd_sc_hd__dfxtp_2 _719_ (.CLK(clknet_4_8_0_clk_regs),
    .D(_097_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_vga_sync.hpos[7] ));
 sky130_fd_sc_hd__dfxtp_2 _720_ (.CLK(clknet_4_3_0_clk_regs),
    .D(_098_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_vga_sync.hpos[8] ));
 sky130_fd_sc_hd__dfxtp_2 _721_ (.CLK(clknet_4_2_0_clk_regs),
    .D(_099_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\u_vga_sync.hpos[9] ));
 sky130_fd_sc_hd__dfxtp_2 _722_ (.CLK(clknet_4_12_0_clk_regs),
    .D(_100_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\B[0] ));
 sky130_fd_sc_hd__dfxtp_2 _723_ (.CLK(clknet_4_12_0_clk_regs),
    .D(_101_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\B[1] ));
 sky130_fd_sc_hd__dfxtp_2 _724_ (.CLK(clknet_4_13_0_clk_regs),
    .D(_102_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\G[0] ));
 sky130_fd_sc_hd__dfxtp_2 _725_ (.CLK(clknet_4_6_0_clk_regs),
    .D(_103_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\G[1] ));
 sky130_fd_sc_hd__dfxtp_2 _726_ (.CLK(clknet_4_7_0_clk_regs),
    .D(_104_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\R[0] ));
 sky130_fd_sc_hd__dfxtp_2 _727_ (.CLK(clknet_4_13_0_clk_regs),
    .D(_105_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\R[1] ));
 sky130_fd_sc_hd__buf_2 _737_ (.A(clknet_1_1__leaf_clk),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\u_spi_mem_ctrl.clk_shifter ));
 sky130_fd_sc_hd__buf_2 _738_ (.A(clknet_1_0__leaf_clk),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\u_spi_mem_ctrl.clk_spi ));
 sky130_fd_sc_hd__buf_2 _739_ (.A(spi_cs_n),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[0]));
 sky130_fd_sc_hd__buf_2 _740_ (.A(spi_sck),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[1]));
 sky130_fd_sc_hd__buf_2 _741_ (.A(spi_mosi),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[2]));
 sky130_fd_sc_hd__buf_2 _742_ (.A(\spi_data_out[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[4]));
 sky130_fd_sc_hd__buf_2 _743_ (.A(\spi_data_out[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[5]));
 sky130_fd_sc_hd__buf_2 _744_ (.A(net27),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[6]));
 sky130_fd_sc_hd__buf_2 _745_ (.A(busy),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 clkload2 (.A(clknet_4_7_0_clk_regs),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkbuf_4 clkload3 (.A(clknet_4_11_0_clk_regs),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkbuf_4 clkload4 (.A(clknet_4_13_0_clk_regs),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkbuf_4 clkload5 (.A(clknet_4_15_0_clk_regs),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout12 (.A(net13),
    ...
    .VPWR(VPWR),
    .X(net12));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout13 (.A(_189_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net13));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout14 (.A(_244_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout15 (.A(net16),
    ...
    .VPWR(VPWR),
    .X(net15));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout16 (.A(_137_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout18 (.A(net19),
    ...
    .VPWR(VPWR),
    .X(net18));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout19 (.A(_137_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net19));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout20 (.A(_190_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout22 (.A(net23),
    ...
    .VPWR(VPWR),
    .X(net22));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout23 (.A(_188_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net23));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout24 (.A(_142_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout26 (.A(net27),
    ...
    .VPWR(VPWR),
    .X(net26));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout27 (.A(\u_spi_mem_ctrl.valid ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout30 (.A(net31),
    ...
    .VPWR(VPWR),
    .X(net30));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout31 (.A(\u_spi_mem_ctrl.state[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net31));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout32 (.A(\u_spi_mem_ctrl.state[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout36 (.A(net37),
    ...
    .VPWR(VPWR),
    .X(net36));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout37 (.A(_113_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net37));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout38 (.A(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout40 (.A(net1),
    ...
    .VPWR(VPWR),
    .X(net40));
 sky130_fd_sc_hd__dlygate4sd3_1 hold100 (.A(\u_spi_mem_ctrl.shift_out[15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net100));
 sky130_fd_sc_hd__dlygate4sd3_1 hold101 (.A(\u_spi_mem_ctrl.shift_out[14] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net101));
 sky130_fd_sc_hd__dlygate4sd3_1 hold102 (.A(\u_spi_mem_ctrl.shift_out[18] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net102));
 sky130_fd_sc_hd__dlygate4sd3_1 hold103 (.A(\u_spi_mem_ctrl.bit_count[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net103));
 sky130_fd_sc_hd__dlygate4sd3_1 hold104 (.A(\u_spi_mem_ctrl.shift_out[17] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net104));
 sky130_fd_sc_hd__dlygate4sd3_1 hold105 (.A(\u_spi_mem_ctrl.shift_out[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net105));
 sky130_fd_sc_hd__dlygate4sd3_1 hold106 (.A(\u_spi_mem_ctrl.shift_out[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net106));
 sky130_fd_sc_hd__dlygate4sd3_1 hold107 (.A(\u_spi_mem_ctrl.shift_out[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net107));
 sky130_fd_sc_hd__dlygate4sd3_1 hold108 (.A(\u_spi_mem_ctrl.shift_out[13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net108));
 sky130_fd_sc_hd__dlygate4sd3_1 hold109 (.A(\u_spi_mem_ctrl.shift_out[21] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net109));
 sky130_fd_sc_hd__dlygate4sd3_1 hold110 (.A(\u_spi_mem_ctrl.shift_out[16] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net110));
 sky130_fd_sc_hd__dlygate4sd3_1 hold111 (.A(\u_spi_mem_ctrl.shift_out[22] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net111));
 sky130_fd_sc_hd__dlygate4sd3_1 hold112 (.A(\u_spi_mem_ctrl.shift_out[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net112));
 sky130_fd_sc_hd__dlygate4sd3_1 hold113 (.A(\u_spi_mem_ctrl.shift_out[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net113));
 sky130_fd_sc_hd__dlygate4sd3_1 hold114 (.A(\u_spi_mem_ctrl.shift_in[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net114));
 sky130_fd_sc_hd__dlygate4sd3_1 hold115 (.A(\u_spi_mem_ctrl.shift_out[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net115));
 sky130_fd_sc_hd__dlygate4sd3_1 hold116 (.A(\u_spi_mem_ctrl.bit_count[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net116));
 sky130_fd_sc_hd__dlygate4sd3_1 hold117 (.A(\u_spi_mem_ctrl.shift_out[23] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net117));
 sky130_fd_sc_hd__dlygate4sd3_1 hold118 (.A(\u_vga_sync.vpos[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net118));
 sky130_fd_sc_hd__dlygate4sd3_1 hold119 (.A(\u_spi_mem_ctrl.shift_in[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net119));
 sky130_fd_sc_hd__dlygate4sd3_1 hold120 (.A(\u_spi_mem_ctrl.shift_in[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net120));
 sky130_fd_sc_hd__dlygate4sd3_1 hold121 (.A(\vga_addr[12] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net121));
 sky130_fd_sc_hd__dlygate4sd3_1 hold122 (.A(\u_vga_sync.vpos[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net122));
 sky130_fd_sc_hd__dlygate4sd3_1 hold123 (.A(\u_spi_mem_ctrl.shift_in[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net123));
 sky130_fd_sc_hd__dlygate4sd3_1 hold124 (.A(\u_spi_mem_ctrl.shift_in[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net124));
 sky130_fd_sc_hd__dlygate4sd3_1 hold125 (.A(\vga_addr[13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net125));
 sky130_fd_sc_hd__dlygate4sd3_1 hold126 (.A(\u_vga_sync.vpos[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net126));
 sky130_fd_sc_hd__dlygate4sd3_1 hold127 (.A(\u_vga_sync.vpos[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net127));
 sky130_fd_sc_hd__dlygate4sd3_1 hold128 (.A(\vga_addr[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net128));
 sky130_fd_sc_hd__dlygate4sd3_1 hold129 (.A(\u_vga_sync.hpos[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net129));
 sky130_fd_sc_hd__dlygate4sd3_1 hold130 (.A(\u_vga_sync.hpos[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net130));
 sky130_fd_sc_hd__dlygate4sd3_1 hold131 (.A(_091_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net131));
 sky130_fd_sc_hd__dlygate4sd3_1 hold132 (.A(\u_spi_mem_ctrl.bit_count[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net132));
 sky130_fd_sc_hd__dlygate4sd3_1 hold133 (.A(\vga_addr[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net133));
 sky130_fd_sc_hd__dlygate4sd3_1 hold134 (.A(\u_vga_sync.vpos[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net134));
 sky130_fd_sc_hd__dlygate4sd3_1 hold135 (.A(\G[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net135));
 sky130_fd_sc_hd__dlygate4sd3_1 hold136 (.A(\R[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net136));
 sky130_fd_sc_hd__dlygate4sd3_1 hold49 (.A(\R[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net49));
 sky130_fd_sc_hd__dlygate4sd3_1 hold50 (.A(_000_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net50));
 sky130_fd_sc_hd__dlygate4sd3_1 hold51 (.A(\R[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net51));
 sky130_fd_sc_hd__dlygate4sd3_1 hold52 (.A(_004_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net52));
 sky130_fd_sc_hd__dlygate4sd3_1 hold53 (.A(spi_cs_n),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net53));
 sky130_fd_sc_hd__dlygate4sd3_1 hold54 (.A(\G[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net54));
 sky130_fd_sc_hd__dlygate4sd3_1 hold55 (.A(_005_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net55));
 sky130_fd_sc_hd__dlygate4sd3_1 hold56 (.A(hsync),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net56));
 sky130_fd_sc_hd__dlygate4sd3_1 hold57 (.A(_007_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net57));
 sky130_fd_sc_hd__dlygate4sd3_1 hold58 (.A(\B[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net58));
 sky130_fd_sc_hd__dlygate4sd3_1 hold59 (.A(_002_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net59));
 sky130_fd_sc_hd__dlygate4sd3_1 hold60 (.A(\u_vga_sync.vsync ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net60));
 sky130_fd_sc_hd__dlygate4sd3_1 hold61 (.A(_003_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net61));
 sky130_fd_sc_hd__dlygate4sd3_1 hold62 (.A(\G[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net62));
 sky130_fd_sc_hd__dlygate4sd3_1 hold63 (.A(_001_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net63));
 sky130_fd_sc_hd__dlygate4sd3_1 hold64 (.A(\u_spi_mem_ctrl.shift_in[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net64));
 sky130_fd_sc_hd__dlygate4sd3_1 hold65 (.A(_039_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net65));
 sky130_fd_sc_hd__dlygate4sd3_1 hold66 (.A(\vga_addr[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net66));
 sky130_fd_sc_hd__dlygate4sd3_1 hold67 (.A(\spi_data_out[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net67));
 sky130_fd_sc_hd__dlygate4sd3_1 hold68 (.A(_034_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net68));
 sky130_fd_sc_hd__dlygate4sd3_1 hold69 (.A(\spi_data_out[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net69));
 sky130_fd_sc_hd__dlygate4sd3_1 hold70 (.A(_035_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net70));
 sky130_fd_sc_hd__dlygate4sd3_1 hold71 (.A(\spi_data_out[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net71));
 sky130_fd_sc_hd__dlygate4sd3_1 hold72 (.A(_033_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net72));
 sky130_fd_sc_hd__dlygate4sd3_1 hold73 (.A(\B[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net73));
 sky130_fd_sc_hd__dlygate4sd3_1 hold74 (.A(_006_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net74));
 sky130_fd_sc_hd__dlygate4sd3_1 hold75 (.A(\spi_data_out[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold76 (.A(_038_),
    ...
    .VPWR(VPWR),
    .X(net76));
 sky130_fd_sc_hd__dlygate4sd3_1 hold77 (.A(\spi_data_out[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net77));
 sky130_fd_sc_hd__dlygate4sd3_1 hold78 (.A(\spi_data_out[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net78));
 sky130_fd_sc_hd__dlygate4sd3_1 hold79 (.A(_036_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net79));
 sky130_fd_sc_hd__dlygate4sd3_1 hold80 (.A(busy),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net80));
 sky130_fd_sc_hd__dlygate4sd3_1 hold81 (.A(_030_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net81));
 sky130_fd_sc_hd__dlygate4sd3_1 hold82 (.A(\vga_addr[15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net82));
 sky130_fd_sc_hd__dlygate4sd3_1 hold83 (.A(\u_spi_mem_ctrl.shift_in[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net83));
 sky130_fd_sc_hd__dlygate4sd3_1 hold84 (.A(_037_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net84));
 sky130_fd_sc_hd__dlygate4sd3_1 hold85 (.A(\vga_addr[14] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net85));
 sky130_fd_sc_hd__dlygate4sd3_1 hold86 (.A(\vga_addr[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net86));
 sky130_fd_sc_hd__dlygate4sd3_1 hold87 (.A(\u_vga_sync.hpos[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net87));
 sky130_fd_sc_hd__dlygate4sd3_1 hold88 (.A(\u_vga_sync.vpos[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net88));
 sky130_fd_sc_hd__dlygate4sd3_1 hold89 (.A(_080_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net89));
 sky130_fd_sc_hd__dlygate4sd3_1 hold90 (.A(\u_spi_mem_ctrl.bit_count[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net90));
 sky130_fd_sc_hd__dlygate4sd3_1 hold91 (.A(\u_spi_mem_ctrl.shift_out[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net91));
 sky130_fd_sc_hd__dlygate4sd3_1 hold92 (.A(\u_spi_mem_ctrl.shift_out[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net92));
 sky130_fd_sc_hd__dlygate4sd3_1 hold93 (.A(\u_spi_mem_ctrl.shift_out[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net93));
 sky130_fd_sc_hd__dlygate4sd3_1 hold94 (.A(\u_spi_mem_ctrl.shift_out[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net94));
 sky130_fd_sc_hd__dlygate4sd3_1 hold95 (.A(\u_spi_mem_ctrl.shift_out[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net95));
 sky130_fd_sc_hd__dlygate4sd3_1 hold96 (.A(\u_spi_mem_ctrl.shift_out[20] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net96));
 sky130_fd_sc_hd__dlygate4sd3_1 hold97 (.A(\u_spi_mem_ctrl.shift_out[12] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net97));
 sky130_fd_sc_hd__dlygate4sd3_1 hold98 (.A(\u_spi_mem_ctrl.shift_out[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net98));
 sky130_fd_sc_hd__dlygate4sd3_1 hold99 (.A(\u_spi_mem_ctrl.shift_out[19] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 input9 (.A(ui_in[7]),
    ...
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__conb_1 tt_um_enjimneering_spi_mem (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 tt_um_enjimneering_spi_mem_41 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net41));
 sky130_fd_sc_hd__conb_1 tt_um_enjimneering_spi_mem_42 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net42));
 sky130_fd_sc_hd__conb_1 tt_um_enjimneering_spi_mem_43 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net43));
 sky130_fd_sc_hd__conb_1 tt_um_enjimneering_spi_mem_44 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net44));
 sky130_fd_sc_hd__conb_1 tt_um_enjimneering_spi_mem_45 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net45));
 sky130_fd_sc_hd__conb_1 tt_um_enjimneering_spi_mem_46 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net46));
 sky130_fd_sc_hd__conb_1 tt_um_enjimneering_spi_mem_47 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net47));
 sky130_fd_sc_hd__conb_1 tt_um_enjimneering_spi_mem_48 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net48));
