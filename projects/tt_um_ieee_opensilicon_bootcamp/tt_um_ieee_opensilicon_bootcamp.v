module tt_um_ieee_opensilicon_bootcamp (clk,
    ena,
    rst_n,
    VPWR,
    VGND,
 ...
 wire _036_;
 wire correct;
 wire \game_inst.lfsr[0] ;
 wire \game_inst.lfsr[1] ;
 wire \game_inst.lfsr[2] ;
 wire \game_inst.lfsr[3] ;
 wire \game_inst.new_game_prev ;
 wire \game_inst.secret_number[0] ;
 wire \game_inst.secret_number[1] ;
 wire \game_inst.secret_number[2] ;
 wire \game_inst.secret_number[3] ;
 wire \game_inst.state ;
 wire \game_inst.verify_prev ;
 wire net1;
 wire net2;
 wire net3;
 wire net4;
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_137 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__xor2_2 _037_ (.A(\game_inst.lfsr[1] ),
    .B(net33),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_000_));
 sky130_fd_sc_hd__and2b_2 _038_ (.A_N(\game_inst.new_game_prev ),
    .B(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_011_));
 sky130_fd_sc_hd__nand2b_2 _039_ (.A_N(\game_inst.new_game_prev ),
    .B(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_012_));
 sky130_fd_sc_hd__or3b_2 _040_ (.A(\game_inst.verify_prev ),
    .B(\game_inst.state ),
    .C_N(net6),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_013_));
 sky130_fd_sc_hd__inv_2 _041_ (.A(_013_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_014_));
 sky130_fd_sc_hd__and2b_2 _042_ (.A_N(\game_inst.secret_number[1] ),
    .B(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_015_));
 sky130_fd_sc_hd__and2b_2 _043_ (.A_N(net5),
    .B(\game_inst.secret_number[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_016_));
 sky130_fd_sc_hd__and2b_2 _044_ (.A_N(\game_inst.secret_number[2] ),
    .B(net4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_017_));
 sky130_fd_sc_hd__and2b_2 _045_ (.A_N(\game_inst.secret_number[3] ),
    .B(net5),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_018_));
 sky130_fd_sc_hd__nor2_2 _046_ (.A(_017_),
    .B(_018_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_019_));
 sky130_fd_sc_hd__and2b_2 _047_ (.A_N(net3),
    .B(\game_inst.secret_number[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_020_));
 sky130_fd_sc_hd__and2b_2 _048_ (.A_N(net4),
    .B(\game_inst.secret_number[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_021_));
 sky130_fd_sc_hd__or4_2 _049_ (.A(_016_),
    .B(_017_),
    .C(_018_),
    .D(_021_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_022_));
 sky130_fd_sc_hd__xor2_2 _050_ (.A(\game_inst.secret_number[0] ),
    .B(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_023_));
 sky130_fd_sc_hd__or2_2 _051_ (.A(_015_),
    .B(_023_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_024_));
 sky130_fd_sc_hd__or3_2 _052_ (.A(_020_),
    .B(_022_),
    .C(_024_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_025_));
 sky130_fd_sc_hd__o31ai_2 _053_ (.A1(_020_),
    .A2(_022_),
    .A3(_024_),
    .B1(_014_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_026_));
 sky130_fd_sc_hd__nor2_2 _054_ (.A(net2),
    .B(_015_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_027_));
 sky130_fd_sc_hd__a211o_2 _055_ (.A1(\game_inst.secret_number[0] ),
    .A2(_027_),
    .B1(_021_),
    .C1(_020_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_028_));
 sky130_fd_sc_hd__a2111oi_2 _056_ (.A1(_019_),
    .A2(_028_),
    .B1(_026_),
    .C1(_011_),
    .D1(_016_),
    ...
    .VPWR(VPWR),
    .Y(_029_));
 sky130_fd_sc_hd__a31o_2 _057_ (.A1(uo_out[0]),
    .A2(_012_),
    .A3(_013_),
    .B1(_029_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_001_));
 sky130_fd_sc_hd__a211o_2 _058_ (.A1(_019_),
    .A2(_028_),
    .B1(_013_),
    .C1(_016_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_030_));
 sky130_fd_sc_hd__o211a_2 _059_ (.A1(uo_out[1]),
    .A2(_014_),
    .B1(_030_),
    .C1(_012_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_002_));
 sky130_fd_sc_hd__o211a_2 _060_ (.A1(net34),
    .A2(_014_),
    .B1(_026_),
    .C1(_012_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_003_));
 sky130_fd_sc_hd__nand2b_2 _061_ (.A_N(uo_out[5]),
    .B(uo_out[4]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_031_));
 sky130_fd_sc_hd__a21oi_2 _062_ (.A1(_025_),
    .A2(_031_),
    .B1(_013_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_032_));
 sky130_fd_sc_hd__o21a_2 _063_ (.A1(net31),
    .A2(_032_),
    .B1(_012_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_004_));
 sky130_fd_sc_hd__mux2_1 _064_ (.A0(net35),
    .A1(\game_inst.lfsr[0] ),
    .S(_011_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_005_));
 sky130_fd_sc_hd__mux2_1 _065_ (.A0(\game_inst.lfsr[1] ),
    .A1(\game_inst.secret_number[1] ),
    .S(_012_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_006_));
 sky130_fd_sc_hd__mux2_1 _066_ (.A0(\game_inst.secret_number[2] ),
    .A1(net29),
    .S(_011_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_007_));
 sky130_fd_sc_hd__mux2_1 _067_ (.A0(\game_inst.lfsr[3] ),
    .A1(net32),
    .S(_012_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_008_));
 sky130_fd_sc_hd__a21o_2 _068_ (.A1(_012_),
    .A2(net8),
    .B1(uo_out[4]),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_033_));
 sky130_fd_sc_hd__o21ai_2 _069_ (.A1(_011_),
    .A2(net8),
    .B1(uo_out[4]),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_034_));
 sky130_fd_sc_hd__nand2_2 _070_ (.A(_033_),
    .B(_034_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_009_));
 sky130_fd_sc_hd__o21ai_2 _071_ (.A1(uo_out[4]),
    .A2(net8),
    .B1(uo_out[5]),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_035_));
 sky130_fd_sc_hd__o31a_2 _072_ (.A1(uo_out[4]),
    .A2(uo_out[5]),
    .A3(net8),
    .B1(_012_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_036_));
 sky130_fd_sc_hd__nand2_2 _073_ (.A(_035_),
    .B(_036_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_010_));
 sky130_fd_sc_hd__dfrtp_2 _074_ (.CLK(clknet_1_0__leaf_clk),
    .D(_001_),
    .RESET_B(net9),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _075_ (.CLK(clknet_1_0__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(uo_out[1]));
 sky130_fd_sc_hd__dfrtp_2 _076_ (.CLK(clknet_1_0__leaf_clk),
    .D(_003_),
    .RESET_B(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(correct));
 sky130_fd_sc_hd__dfrtp_2 _077_ (.CLK(clknet_1_0__leaf_clk),
    .D(_004_),
    .RESET_B(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game_inst.state ));
 sky130_fd_sc_hd__dfrtp_2 _078_ (.CLK(clknet_1_1__leaf_clk),
    .D(_005_),
    .RESET_B(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\game_inst.secret_number[0] ));
 sky130_fd_sc_hd__dfstp_2 _079_ (.CLK(clknet_1_1__leaf_clk),
    .D(_006_),
    .SET_B(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\game_inst.secret_number[1] ));
 sky130_fd_sc_hd__dfstp_2 _080_ (.CLK(clknet_1_1__leaf_clk),
    .D(_007_),
    .SET_B(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\game_inst.secret_number[2] ));
 sky130_fd_sc_hd__dfrtp_2 _081_ (.CLK(clknet_1_1__leaf_clk),
    .D(_008_),
    .RESET_B(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\game_inst.secret_number[3] ));
 sky130_fd_sc_hd__dfstp_2 _082_ (.CLK(clknet_1_0__leaf_clk),
    .D(_009_),
    .SET_B(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[4]));
 sky130_fd_sc_hd__dfstp_2 _083_ (.CLK(clknet_1_0__leaf_clk),
    .D(_010_),
    .SET_B(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[5]));
 sky130_fd_sc_hd__dfrtp_2 _084_ (.CLK(clknet_1_1__leaf_clk),
    .D(net7),
    .RESET_B(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\game_inst.new_game_prev ));
 sky130_fd_sc_hd__dfstp_2 _085_ (.CLK(clknet_1_1__leaf_clk),
    .D(_000_),
    .SET_B(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\game_inst.lfsr[0] ));
 sky130_fd_sc_hd__dfstp_2 _086_ (.CLK(clknet_1_1__leaf_clk),
    .D(net28),
    .SET_B(net10),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _087_ (.CLK(clknet_1_0__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\game_inst.lfsr[2] ));
 sky130_fd_sc_hd__dfstp_2 _088_ (.CLK(clknet_1_1__leaf_clk),
    .D(net29),
    .SET_B(net10),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _089_ (.CLK(clknet_1_0__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\game_inst.verify_prev ));
 sky130_fd_sc_hd__buf_2 _108_ (.A(correct),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[2]));
 sky130_fd_sc_hd__buf_2 _109_ (.A(correct),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout9 (.A(net1),
    ...
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__dlygate4sd3_1 hold28 (.A(\game_inst.lfsr[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net28));
 sky130_fd_sc_hd__dlygate4sd3_1 hold29 (.A(\game_inst.lfsr[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net29));
 sky130_fd_sc_hd__dlygate4sd3_1 hold30 (.A(\game_inst.lfsr[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net30));
 sky130_fd_sc_hd__dlygate4sd3_1 hold31 (.A(\game_inst.state ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net31));
 sky130_fd_sc_hd__dlygate4sd3_1 hold32 (.A(\game_inst.secret_number[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net32));
 sky130_fd_sc_hd__dlygate4sd3_1 hold33 (.A(\game_inst.lfsr[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net33));
 sky130_fd_sc_hd__dlygate4sd3_1 hold34 (.A(correct),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net34));
 sky130_fd_sc_hd__dlygate4sd3_1 hold35 (.A(\game_inst.secret_number[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 input7 (.A(ui_in[5]),
    ...
    .VPWR(VPWR),
    .X(net7));
 sky130_fd_sc_hd__clkbuf_2 max_cap8 (.A(_026_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net8));
 sky130_fd_sc_hd__conb_1 tt_um_ieee_opensilicon_bootcamp (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 tt_um_ieee_opensilicon_bootcamp_11 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net11));
 sky130_fd_sc_hd__conb_1 tt_um_ieee_opensilicon_bootcamp_12 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net12));
 sky130_fd_sc_hd__conb_1 tt_um_ieee_opensilicon_bootcamp_13 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net13));
 sky130_fd_sc_hd__conb_1 tt_um_ieee_opensilicon_bootcamp_14 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net14));
 sky130_fd_sc_hd__conb_1 tt_um_ieee_opensilicon_bootcamp_15 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net15));
 sky130_fd_sc_hd__conb_1 tt_um_ieee_opensilicon_bootcamp_16 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net16));
 sky130_fd_sc_hd__conb_1 tt_um_ieee_opensilicon_bootcamp_17 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net17));
 sky130_fd_sc_hd__conb_1 tt_um_ieee_opensilicon_bootcamp_18 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net18));
 sky130_fd_sc_hd__conb_1 tt_um_ieee_opensilicon_bootcamp_19 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net19));
 sky130_fd_sc_hd__conb_1 tt_um_ieee_opensilicon_bootcamp_20 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net20));
 sky130_fd_sc_hd__conb_1 tt_um_ieee_opensilicon_bootcamp_21 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net21));
 sky130_fd_sc_hd__conb_1 tt_um_ieee_opensilicon_bootcamp_22 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net22));
 sky130_fd_sc_hd__conb_1 tt_um_ieee_opensilicon_bootcamp_23 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net23));
 sky130_fd_sc_hd__conb_1 tt_um_ieee_opensilicon_bootcamp_24 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net24));
 sky130_fd_sc_hd__conb_1 tt_um_ieee_opensilicon_bootcamp_25 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net25));
 sky130_fd_sc_hd__conb_1 tt_um_ieee_opensilicon_bootcamp_26 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net26));
 sky130_fd_sc_hd__conb_1 tt_um_ieee_opensilicon_bootcamp_27 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net27));
