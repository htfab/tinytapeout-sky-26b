module tt_um_chronoINAAL (clk,
 ...
 wire \uut.cent_un[2] ;
 wire \uut.cent_un[3] ;
 wire \uut.db_start.clean_pulse ;
 wire \uut.db_start.cnt[0] ;
 wire \uut.db_start.cnt[10] ;
 wire \uut.db_start.cnt[11] ;
 wire \uut.db_start.cnt[12] ;
 wire \uut.db_start.cnt[13] ;
 wire \uut.db_start.cnt[14] ;
 wire \uut.db_start.cnt[15] ;
 wire \uut.db_start.cnt[16] ;
 wire \uut.db_start.cnt[17] ;
 wire \uut.db_start.cnt[18] ;
 wire \uut.db_start.cnt[1] ;
 wire \uut.db_start.cnt[2] ;
 wire \uut.db_start.cnt[3] ;
 wire \uut.db_start.cnt[4] ;
 wire \uut.db_start.cnt[5] ;
 wire \uut.db_start.cnt[6] ;
 wire \uut.db_start.cnt[7] ;
 wire \uut.db_start.cnt[8] ;
 wire \uut.db_start.cnt[9] ;
 wire \uut.db_start.stable_prev ;
 wire \uut.db_start.stable_state ;
 wire \uut.db_start.sync_0 ;
 wire \uut.db_start.sync_1 ;
 wire \uut.display_sel[0] ;
 wire \uut.display_sel[1] ;
 wire \uut.prescaler_cnt[0] ;
 wire \uut.prescaler_cnt[10] ;
 wire \uut.prescaler_cnt[11] ;
 wire \uut.prescaler_cnt[12] ;
 wire \uut.prescaler_cnt[13] ;
 wire \uut.prescaler_cnt[14] ;
 wire \uut.prescaler_cnt[15] ;
 wire \uut.prescaler_cnt[16] ;
 wire \uut.prescaler_cnt[17] ;
 wire \uut.prescaler_cnt[18] ;
 wire \uut.prescaler_cnt[19] ;
 wire \uut.prescaler_cnt[1] ;
 wire \uut.prescaler_cnt[2] ;
 wire \uut.prescaler_cnt[3] ;
 wire \uut.prescaler_cnt[4] ;
 wire \uut.prescaler_cnt[5] ;
 wire \uut.prescaler_cnt[6] ;
 wire \uut.prescaler_cnt[7] ;
 wire \uut.prescaler_cnt[8] ;
 wire \uut.prescaler_cnt[9] ;
 wire \uut.refresh_cnt[0] ;
 wire \uut.refresh_cnt[10] ;
 wire \uut.refresh_cnt[11] ;
 wire \uut.refresh_cnt[12] ;
 wire \uut.refresh_cnt[13] ;
 wire \uut.refresh_cnt[14] ;
 wire \uut.refresh_cnt[15] ;
 wire \uut.refresh_cnt[1] ;
 wire \uut.refresh_cnt[2] ;
 wire \uut.refresh_cnt[3] ;
 wire \uut.refresh_cnt[4] ;
 wire \uut.refresh_cnt[5] ;
 wire \uut.refresh_cnt[6] ;
 wire \uut.refresh_cnt[7] ;
 wire \uut.refresh_cnt[8] ;
 wire \uut.refresh_cnt[9] ;
 wire \uut.running ;
 wire \uut.seg_dec[0] ;
 wire \uut.seg_dec[1] ;
 wire \uut.seg_dec[2] ;
 ...
 sky130_fd_sc_hd__inv_2 _237_ (.A(net46),
    ...
    .VPWR(VPWR),
    .Y(_040_));
 sky130_fd_sc_hd__inv_2 _238_ (.A(\uut.refresh_cnt[15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_076_));
 sky130_fd_sc_hd__inv_2 _239_ (.A(\uut.display_sel[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_077_));
 sky130_fd_sc_hd__inv_2 _240_ (.A(net45),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_000_));
 sky130_fd_sc_hd__inv_2 _241_ (.A(\uut.running ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_078_));
 sky130_fd_sc_hd__inv_2 _242_ (.A(\uut.cent_un[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_079_));
 sky130_fd_sc_hd__inv_2 _243_ (.A(\uut.cent_un[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_080_));
 sky130_fd_sc_hd__inv_2 _244_ (.A(\uut.cent_un[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_081_));
 sky130_fd_sc_hd__inv_2 _245_ (.A(\uut.cent_un[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_082_));
 sky130_fd_sc_hd__inv_2 _246_ (.A(net92),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_083_));
 sky130_fd_sc_hd__inv_2 _247_ (.A(\uut.seg_dec[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_084_));
 sky130_fd_sc_hd__xor2_2 _248_ (.A(net46),
    .B(net65),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_047_));
 sky130_fd_sc_hd__and3_2 _249_ (.A(\uut.refresh_cnt[0] ),
    .B(\uut.refresh_cnt[1] ),
    .C(\uut.refresh_cnt[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_085_));
 sky130_fd_sc_hd__a21oi_2 _250_ (.A1(\uut.refresh_cnt[0] ),
    .A2(\uut.refresh_cnt[1] ),
    .B1(net55),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_086_));
 sky130_fd_sc_hd__nor2_2 _251_ (.A(_085_),
    .B(net56),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_048_));
 sky130_fd_sc_hd__and4_2 _252_ (.A(\uut.refresh_cnt[0] ),
    .B(\uut.refresh_cnt[1] ),
    .C(\uut.refresh_cnt[2] ),
    .D(\uut.refresh_cnt[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_087_));
 sky130_fd_sc_hd__nor2_2 _253_ (.A(net51),
    .B(_085_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_088_));
 sky130_fd_sc_hd__nor2_2 _254_ (.A(_087_),
    .B(_088_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_049_));
 sky130_fd_sc_hd__xor2_2 _255_ (.A(net66),
    .B(_087_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_050_));
 sky130_fd_sc_hd__and2_2 _256_ (.A(\uut.refresh_cnt[4] ),
    .B(\uut.refresh_cnt[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_089_));
 sky130_fd_sc_hd__and2_2 _257_ (.A(_087_),
    .B(_089_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_090_));
 sky130_fd_sc_hd__a21oi_2 _258_ (.A1(\uut.refresh_cnt[4] ),
    .A2(_087_),
    .B1(net43),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_091_));
 sky130_fd_sc_hd__nor2_2 _259_ (.A(_090_),
    .B(net44),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_051_));
 sky130_fd_sc_hd__xor2_2 _260_ (.A(net52),
    .B(_090_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_052_));
 sky130_fd_sc_hd__and4_2 _261_ (.A(\uut.refresh_cnt[6] ),
    .B(\uut.refresh_cnt[7] ),
    .C(_087_),
    .D(_089_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_092_));
 sky130_fd_sc_hd__a31o_2 _262_ (.A1(\uut.refresh_cnt[6] ),
    .A2(_087_),
    .A3(_089_),
    .B1(\uut.refresh_cnt[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_093_));
 sky130_fd_sc_hd__and2b_2 _263_ (.A_N(_092_),
    .B(_093_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_053_));
 sky130_fd_sc_hd__xor2_2 _264_ (.A(net75),
    .B(_092_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_054_));
 sky130_fd_sc_hd__nand3_2 _265_ (.A(\uut.refresh_cnt[8] ),
    .B(\uut.refresh_cnt[9] ),
    .C(_092_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_094_));
 sky130_fd_sc_hd__a21o_2 _266_ (.A1(\uut.refresh_cnt[8] ),
    .A2(_092_),
    .B1(\uut.refresh_cnt[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_095_));
 sky130_fd_sc_hd__and2_2 _267_ (.A(_094_),
    .B(_095_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_055_));
 sky130_fd_sc_hd__xnor2_2 _268_ (.A(net54),
    .B(_094_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_041_));
 sky130_fd_sc_hd__and2_2 _269_ (.A(\uut.refresh_cnt[10] ),
    .B(\uut.refresh_cnt[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_096_));
 sky130_fd_sc_hd__and4_2 _270_ (.A(\uut.refresh_cnt[8] ),
    .B(\uut.refresh_cnt[9] ),
    .C(_092_),
    .D(_096_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_097_));
 sky130_fd_sc_hd__a41o_2 _271_ (.A1(\uut.refresh_cnt[8] ),
    .A2(\uut.refresh_cnt[9] ),
    .A3(\uut.refresh_cnt[10] ),
    .A4(_092_),
    .B1(\uut.refresh_cnt[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_098_));
 sky130_fd_sc_hd__and2b_2 _272_ (.A_N(_097_),
    .B(_098_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_042_));
 sky130_fd_sc_hd__xor2_2 _273_ (.A(net63),
    .B(_097_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_043_));
 sky130_fd_sc_hd__and3_2 _274_ (.A(\uut.refresh_cnt[12] ),
    .B(\uut.refresh_cnt[13] ),
    .C(_097_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_099_));
 sky130_fd_sc_hd__a21oi_2 _275_ (.A1(\uut.refresh_cnt[12] ),
    .A2(_097_),
    .B1(net41),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_100_));
 sky130_fd_sc_hd__nor2_2 _276_ (.A(_099_),
    .B(net42),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_044_));
 sky130_fd_sc_hd__nand2_2 _277_ (.A(\uut.refresh_cnt[14] ),
    .B(_099_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_101_));
 sky130_fd_sc_hd__or2_2 _278_ (.A(\uut.refresh_cnt[14] ),
    .B(_099_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_102_));
 sky130_fd_sc_hd__and2_2 _279_ (.A(_101_),
    .B(_102_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_045_));
 sky130_fd_sc_hd__xnor2_2 _280_ (.A(net88),
    .B(_101_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_046_));
 sky130_fd_sc_hd__nand2_2 _281_ (.A(\uut.display_sel[0] ),
    .B(_077_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(uio_out[1]));
 sky130_fd_sc_hd__and2b_2 _282_ (.A_N(\uut.display_sel[0] ),
    .B(\uut.display_sel[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_103_));
 sky130_fd_sc_hd__inv_2 _283_ (.A(_103_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(uio_out[2]));
 sky130_fd_sc_hd__and2b_2 _284_ (.A_N(\uut.db_start.stable_prev ),
    .B(net93),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_020_));
 sky130_fd_sc_hd__xor2_2 _285_ (.A(\uut.db_start.stable_state ),
    .B(\uut.db_start.sync_1 ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_104_));
 sky130_fd_sc_hd__inv_2 _286_ (.A(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_105_));
 sky130_fd_sc_hd__nor2_2 _287_ (.A(net72),
    .B(_105_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_021_));
 sky130_fd_sc_hd__o21ai_2 _288_ (.A1(\uut.db_start.cnt[1] ),
    .A2(\uut.db_start.cnt[0] ),
    .B1(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_106_));
 sky130_fd_sc_hd__a21oi_2 _289_ (.A1(net67),
    .A2(\uut.db_start.cnt[0] ),
    .B1(_106_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_031_));
 sky130_fd_sc_hd__a21oi_2 _290_ (.A1(\uut.db_start.cnt[1] ),
    .A2(\uut.db_start.cnt[0] ),
    .B1(net80),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_107_));
 sky130_fd_sc_hd__a31o_2 _291_ (.A1(\uut.db_start.cnt[1] ),
    .A2(\uut.db_start.cnt[0] ),
    .A3(\uut.db_start.cnt[2] ),
    .B1(_105_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_108_));
 sky130_fd_sc_hd__nor2_2 _292_ (.A(_107_),
    .B(_108_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_032_));
 sky130_fd_sc_hd__and4_2 _293_ (.A(\uut.db_start.cnt[1] ),
    .B(\uut.db_start.cnt[0] ),
    .C(\uut.db_start.cnt[2] ),
    .D(\uut.db_start.cnt[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_109_));
 sky130_fd_sc_hd__inv_2 _294_ (.A(_109_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_110_));
 sky130_fd_sc_hd__a31o_2 _295_ (.A1(\uut.db_start.cnt[1] ),
    .A2(\uut.db_start.cnt[0] ),
    .A3(\uut.db_start.cnt[2] ),
    .B1(\uut.db_start.cnt[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_111_));
 sky130_fd_sc_hd__and3_2 _296_ (.A(net7),
    .B(_110_),
    .C(_111_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_033_));
 sky130_fd_sc_hd__o21ai_2 _297_ (.A1(\uut.db_start.cnt[4] ),
    .A2(_109_),
    .B1(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_112_));
 sky130_fd_sc_hd__a21oi_2 _298_ (.A1(net49),
    .A2(_109_),
    .B1(_112_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_034_));
 sky130_fd_sc_hd__and4b_2 _299_ (.A_N(\uut.db_start.cnt[5] ),
    .B(\uut.db_start.cnt[4] ),
    .C(\uut.db_start.cnt[16] ),
    .D(\uut.db_start.cnt[17] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_113_));
 sky130_fd_sc_hd__or4b_2 _300_ (.A(\uut.db_start.cnt[7] ),
    .B(\uut.db_start.cnt[6] ),
    .C(\uut.db_start.cnt[9] ),
    .D_N(\uut.db_start.cnt[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_114_));
 sky130_fd_sc_hd__inv_2 _301_ (.A(_114_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_115_));
 sky130_fd_sc_hd__or4b_2 _302_ (.A(\uut.db_start.cnt[11] ),
    .B(\uut.db_start.cnt[10] ),
    .C(\uut.db_start.cnt[12] ),
    .D_N(\uut.db_start.cnt[13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_116_));
 sky130_fd_sc_hd__inv_2 _303_ (.A(_116_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_117_));
 sky130_fd_sc_hd__and4b_2 _304_ (.A_N(\uut.db_start.cnt[14] ),
    .B(\uut.db_start.cnt[15] ),
    .C(\uut.db_start.cnt[18] ),
    .D(_117_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_118_));
 sky130_fd_sc_hd__and4_2 _305_ (.A(_109_),
    .B(_113_),
    .C(_115_),
    .D(_118_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_119_));
 sky130_fd_sc_hd__nor2_2 _306_ (.A(_105_),
    .B(_119_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_120_));
 sky130_fd_sc_hd__and3_2 _307_ (.A(\uut.db_start.cnt[5] ),
    .B(\uut.db_start.cnt[4] ),
    .C(_109_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_121_));
 sky130_fd_sc_hd__a21o_2 _308_ (.A1(\uut.db_start.cnt[4] ),
    .A2(_109_),
    .B1(\uut.db_start.cnt[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_122_));
 sky130_fd_sc_hd__and3b_2 _309_ (.A_N(_121_),
    .B(_122_),
    .C(_120_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_035_));
 sky130_fd_sc_hd__and2_2 _310_ (.A(\uut.db_start.cnt[6] ),
    .B(_121_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_123_));
 sky130_fd_sc_hd__o21ai_2 _311_ (.A1(net82),
    .A2(_121_),
    .B1(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_124_));
 sky130_fd_sc_hd__nor2_2 _312_ (.A(_123_),
    .B(_124_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_036_));
 sky130_fd_sc_hd__and2_2 _313_ (.A(\uut.db_start.cnt[7] ),
    .B(\uut.db_start.cnt[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_125_));
 sky130_fd_sc_hd__and4_2 _314_ (.A(\uut.db_start.cnt[5] ),
    .B(\uut.db_start.cnt[4] ),
    .C(_109_),
    .D(_125_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_126_));
 sky130_fd_sc_hd__inv_2 _315_ (.A(_126_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_127_));
 sky130_fd_sc_hd__o211a_2 _316_ (.A1(net83),
    .A2(_123_),
    .B1(_127_),
    .C1(net7),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_037_));
 sky130_fd_sc_hd__nand2_2 _317_ (.A(\uut.db_start.cnt[8] ),
    .B(_126_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_128_));
 sky130_fd_sc_hd__o211a_2 _318_ (.A1(\uut.db_start.cnt[8] ),
    .A2(_126_),
    .B1(_128_),
    .C1(_120_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_038_));
 sky130_fd_sc_hd__and3_2 _319_ (.A(\uut.db_start.cnt[9] ),
    .B(\uut.db_start.cnt[8] ),
    .C(_126_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_129_));
 sky130_fd_sc_hd__a211oi_2 _320_ (.A1(_083_),
    .A2(_128_),
    .B1(_129_),
    .C1(_105_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_039_));
 sky130_fd_sc_hd__and2_2 _321_ (.A(\uut.db_start.cnt[10] ),
    .B(_129_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_130_));
 sky130_fd_sc_hd__o21ai_2 _322_ (.A1(net81),
    .A2(_129_),
    .B1(_104_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_131_));
 sky130_fd_sc_hd__nor2_2 _323_ (.A(_130_),
    .B(_131_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_022_));
 sky130_fd_sc_hd__and4_2 _324_ (.A(\uut.db_start.cnt[9] ),
    .B(\uut.db_start.cnt[8] ),
    .C(\uut.db_start.cnt[11] ),
    .D(\uut.db_start.cnt[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_132_));
 sky130_fd_sc_hd__and2_2 _325_ (.A(_126_),
    .B(_132_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_133_));
 sky130_fd_sc_hd__inv_2 _326_ (.A(_133_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_134_));
 sky130_fd_sc_hd__o211a_2 _327_ (.A1(net86),
    .A2(_130_),
    .B1(_134_),
    .C1(_104_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_023_));
 sky130_fd_sc_hd__o21ai_2 _328_ (.A1(\uut.db_start.cnt[12] ),
    .A2(_133_),
    .B1(_104_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_135_));
 sky130_fd_sc_hd__a21oi_2 _329_ (.A1(net74),
    .A2(_133_),
    .B1(_135_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_024_));
 sky130_fd_sc_hd__a31o_2 _330_ (.A1(\uut.db_start.cnt[12] ),
    .A2(_126_),
    .A3(_132_),
    .B1(\uut.db_start.cnt[13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_136_));
 sky130_fd_sc_hd__nand2_2 _331_ (.A(\uut.db_start.cnt[12] ),
    .B(\uut.db_start.cnt[13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_137_));
 sky130_fd_sc_hd__o211a_2 _332_ (.A1(_134_),
    .A2(_137_),
    .B1(_136_),
    .C1(_120_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_025_));
 sky130_fd_sc_hd__a31o_2 _333_ (.A1(\uut.db_start.cnt[12] ),
    .A2(\uut.db_start.cnt[13] ),
    .A3(_133_),
    .B1(\uut.db_start.cnt[14] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_138_));
 sky130_fd_sc_hd__and4_2 _334_ (.A(\uut.db_start.cnt[12] ),
    .B(\uut.db_start.cnt[13] ),
    .C(\uut.db_start.cnt[14] ),
    .D(_133_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_139_));
 sky130_fd_sc_hd__nand2_2 _335_ (.A(_104_),
    .B(_138_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_140_));
 sky130_fd_sc_hd__nor2_2 _336_ (.A(_139_),
    .B(_140_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_026_));
 sky130_fd_sc_hd__and4_2 _337_ (.A(\uut.db_start.cnt[12] ),
    .B(\uut.db_start.cnt[13] ),
    .C(\uut.db_start.cnt[14] ),
    .D(\uut.db_start.cnt[15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_141_));
 sky130_fd_sc_hd__and3_2 _338_ (.A(_126_),
    .B(_132_),
    .C(_141_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_142_));
 sky130_fd_sc_hd__inv_2 _339_ (.A(_142_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_143_));
 sky130_fd_sc_hd__o211a_2 _340_ (.A1(net85),
    .A2(_139_),
    .B1(_143_),
    .C1(_120_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_027_));
 sky130_fd_sc_hd__or2_2 _341_ (.A(\uut.db_start.cnt[16] ),
    .B(_142_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_144_));
 sky130_fd_sc_hd__and2_2 _342_ (.A(\uut.db_start.cnt[16] ),
    .B(_142_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_145_));
 sky130_fd_sc_hd__and3b_2 _343_ (.A_N(_145_),
    .B(_120_),
    .C(_144_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_028_));
 sky130_fd_sc_hd__nand3_2 _344_ (.A(\uut.db_start.cnt[16] ),
    .B(\uut.db_start.cnt[17] ),
    .C(_142_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_146_));
 sky130_fd_sc_hd__o211a_2 _345_ (.A1(net90),
    .A2(_145_),
    .B1(_146_),
    .C1(_120_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_029_));
 sky130_fd_sc_hd__xnor2_2 _346_ (.A(\uut.db_start.cnt[18] ),
    .B(_146_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_147_));
 sky130_fd_sc_hd__and2_2 _347_ (.A(_120_),
    .B(_147_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_030_));
 sky130_fd_sc_hd__xor2_2 _348_ (.A(net69),
    .B(net45),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_011_));
 sky130_fd_sc_hd__and3_2 _349_ (.A(\uut.prescaler_cnt[1] ),
    .B(\uut.prescaler_cnt[0] ),
    .C(\uut.prescaler_cnt[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_148_));
 sky130_fd_sc_hd__a21oi_2 _350_ (.A1(\uut.prescaler_cnt[1] ),
    .A2(\uut.prescaler_cnt[0] ),
    .B1(net57),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_149_));
 sky130_fd_sc_hd__nor2_2 _351_ (.A(_148_),
    .B(net58),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_012_));
 sky130_fd_sc_hd__and4_2 _352_ (.A(\uut.prescaler_cnt[1] ),
    .B(\uut.prescaler_cnt[0] ),
    .C(\uut.prescaler_cnt[3] ),
    .D(\uut.prescaler_cnt[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_150_));
 sky130_fd_sc_hd__nand2_2 _353_ (.A(\uut.prescaler_cnt[3] ),
    .B(_148_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_151_));
 sky130_fd_sc_hd__xor2_2 _354_ (.A(net62),
    .B(_148_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_013_));
 sky130_fd_sc_hd__xor2_2 _355_ (.A(net77),
    .B(_150_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_014_));
 sky130_fd_sc_hd__or4b_2 _356_ (.A(\uut.prescaler_cnt[7] ),
    .B(\uut.prescaler_cnt[6] ),
    .C(\uut.prescaler_cnt[9] ),
    .D_N(\uut.prescaler_cnt[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_152_));
 sky130_fd_sc_hd__nand2_2 _357_ (.A(\uut.prescaler_cnt[16] ),
    .B(\uut.prescaler_cnt[17] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_153_));
 sky130_fd_sc_hd__nand4b_2 _358_ (.A_N(\uut.prescaler_cnt[5] ),
    .B(\uut.prescaler_cnt[4] ),
    .C(\uut.prescaler_cnt[16] ),
    .D(\uut.prescaler_cnt[17] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_154_));
 sky130_fd_sc_hd__or4bb_2 _359_ (.A(\uut.prescaler_cnt[14] ),
    .B(\uut.prescaler_cnt[19] ),
    .C_N(\uut.prescaler_cnt[18] ),
    .D_N(\uut.prescaler_cnt[15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_155_));
 sky130_fd_sc_hd__or4b_2 _360_ (.A(\uut.prescaler_cnt[11] ),
    .B(\uut.prescaler_cnt[10] ),
    .C(\uut.prescaler_cnt[12] ),
    .D_N(\uut.prescaler_cnt[13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_156_));
 sky130_fd_sc_hd__or4_2 _361_ (.A(_152_),
    .B(_154_),
    .C(_155_),
    .D(_156_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_157_));
 sky130_fd_sc_hd__nor2_2 _362_ (.A(_151_),
    .B(_157_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_158_));
 sky130_fd_sc_hd__or2_2 _363_ (.A(_151_),
    .B(_157_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_159_));
 sky130_fd_sc_hd__a21oi_2 _364_ (.A1(\uut.prescaler_cnt[4] ),
    .A2(_150_),
    .B1(\uut.prescaler_cnt[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_160_));
 sky130_fd_sc_hd__and2_2 _365_ (.A(\uut.prescaler_cnt[5] ),
    .B(\uut.prescaler_cnt[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_161_));
 sky130_fd_sc_hd__and2_2 _366_ (.A(_150_),
    .B(_161_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_162_));
 sky130_fd_sc_hd__nor3_2 _367_ (.A(_158_),
    .B(_160_),
    .C(_162_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_015_));
 sky130_fd_sc_hd__xor2_2 _368_ (.A(net61),
    .B(_162_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_016_));
 sky130_fd_sc_hd__and4_2 _369_ (.A(\uut.prescaler_cnt[7] ),
    .B(\uut.prescaler_cnt[6] ),
    .C(_150_),
    .D(_161_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_163_));
 sky130_fd_sc_hd__a31o_2 _370_ (.A1(\uut.prescaler_cnt[6] ),
    .A2(_150_),
    .A3(_161_),
    .B1(\uut.prescaler_cnt[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_164_));
 sky130_fd_sc_hd__and2b_2 _371_ (.A_N(_163_),
    .B(_164_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_017_));
 sky130_fd_sc_hd__and2_2 _372_ (.A(\uut.prescaler_cnt[8] ),
    .B(_163_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_165_));
 sky130_fd_sc_hd__nor2_2 _373_ (.A(_158_),
    .B(_165_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_166_));
 sky130_fd_sc_hd__o21a_2 _374_ (.A1(net73),
    .A2(_163_),
    .B1(_166_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_018_));
 sky130_fd_sc_hd__nor2_2 _375_ (.A(net87),
    .B(_165_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_167_));
 sky130_fd_sc_hd__and3_2 _376_ (.A(\uut.prescaler_cnt[9] ),
    .B(\uut.prescaler_cnt[8] ),
    .C(_163_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_168_));
 sky130_fd_sc_hd__nor2_2 _377_ (.A(_167_),
    .B(_168_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_019_));
 sky130_fd_sc_hd__xor2_2 _378_ (.A(net70),
    .B(_168_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_001_));
 sky130_fd_sc_hd__and4_2 _379_ (.A(\uut.prescaler_cnt[9] ),
    .B(\uut.prescaler_cnt[8] ),
    .C(\uut.prescaler_cnt[11] ),
    .D(\uut.prescaler_cnt[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_169_));
 sky130_fd_sc_hd__nand2_2 _380_ (.A(_163_),
    .B(_169_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_170_));
 sky130_fd_sc_hd__a21oi_2 _381_ (.A1(\uut.prescaler_cnt[10] ),
    .A2(_168_),
    .B1(net47),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_171_));
 sky130_fd_sc_hd__a21oi_2 _382_ (.A1(_163_),
    .A2(_169_),
    .B1(net48),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_002_));
 sky130_fd_sc_hd__xnor2_2 _383_ (.A(net59),
    .B(_170_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_003_));
 sky130_fd_sc_hd__a31o_2 _384_ (.A1(\uut.prescaler_cnt[12] ),
    .A2(_163_),
    .A3(_169_),
    .B1(\uut.prescaler_cnt[13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_172_));
 sky130_fd_sc_hd__and4_2 _385_ (.A(\uut.prescaler_cnt[12] ),
    .B(\uut.prescaler_cnt[13] ),
    .C(_163_),
    .D(_169_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _386_ (.A(_173_),
    ...
    .VPWR(VPWR),
    .Y(_174_));
 sky130_fd_sc_hd__and3_2 _387_ (.A(_159_),
    .B(_172_),
    .C(_174_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_004_));
 sky130_fd_sc_hd__xor2_2 _388_ (.A(net64),
    .B(_173_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_005_));
 sky130_fd_sc_hd__a21o_2 _389_ (.A1(\uut.prescaler_cnt[14] ),
    .A2(_173_),
    .B1(\uut.prescaler_cnt[15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_175_));
 sky130_fd_sc_hd__and2_2 _390_ (.A(\uut.prescaler_cnt[14] ),
    .B(\uut.prescaler_cnt[15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_176_));
 sky130_fd_sc_hd__nand2_2 _391_ (.A(_173_),
    .B(_176_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_177_));
 sky130_fd_sc_hd__and3_2 _392_ (.A(_159_),
    .B(_175_),
    .C(_177_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_006_));
 sky130_fd_sc_hd__a21oi_2 _393_ (.A1(_173_),
    .A2(_176_),
    .B1(\uut.prescaler_cnt[16] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_178_));
 sky130_fd_sc_hd__and3_2 _394_ (.A(\uut.prescaler_cnt[16] ),
    .B(_173_),
    .C(_176_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_179_));
 sky130_fd_sc_hd__nor3_2 _395_ (.A(_158_),
    .B(_178_),
    .C(_179_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_007_));
 sky130_fd_sc_hd__and3b_2 _396_ (.A_N(_153_),
    .B(_173_),
    .C(_176_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_180_));
 sky130_fd_sc_hd__o221a_2 _397_ (.A1(_153_),
    .A2(_177_),
    .B1(_179_),
    .B2(\uut.prescaler_cnt[17] ),
    .C1(_159_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_008_));
 sky130_fd_sc_hd__or2_2 _398_ (.A(\uut.prescaler_cnt[18] ),
    .B(_180_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_181_));
 sky130_fd_sc_hd__nand2_2 _399_ (.A(\uut.prescaler_cnt[18] ),
    .B(_180_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_182_));
 sky130_fd_sc_hd__and3_2 _400_ (.A(_159_),
    .B(_181_),
    .C(_182_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_009_));
 sky130_fd_sc_hd__xnor2_2 _401_ (.A(net40),
    .B(_182_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_010_));
 sky130_fd_sc_hd__nand2_2 _402_ (.A(\uut.display_sel[0] ),
    .B(\uut.display_sel[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(uio_out[3]));
 sky130_fd_sc_hd__nor2_2 _403_ (.A(\uut.display_sel[0] ),
    .B(\uut.display_sel[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_183_));
 sky130_fd_sc_hd__inv_2 _404_ (.A(_183_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(uio_out[0]));
 sky130_fd_sc_hd__and3_2 _405_ (.A(\uut.display_sel[0] ),
    .B(_077_),
    .C(\uut.cent_dec[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_184_));
 sky130_fd_sc_hd__nand2_2 _406_ (.A(\uut.display_sel[1] ),
    .B(\uut.seg_dec[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_185_));
 sky130_fd_sc_hd__o2bb2a_2 _407_ (.A1_N(\uut.display_sel[0] ),
    .A2_N(_185_),
    .B1(uio_out[2]),
    .B2(\uut.seg_un[1] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_186_));
 sky130_fd_sc_hd__o22a_2 _408_ (.A1(\uut.cent_un[1] ),
    .A2(uio_out[0]),
    .B1(_184_),
    .B2(_186_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_187_));
 sky130_fd_sc_hd__and3_2 _409_ (.A(\uut.display_sel[0] ),
    .B(\uut.display_sel[1] ),
    .C(\uut.seg_dec[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_188_));
 sky130_fd_sc_hd__a221o_2 _410_ (.A1(_077_),
    .A2(\uut.cent_dec[0] ),
    .B1(\uut.seg_un[0] ),
    .B2(_103_),
    .C1(_183_),
    ...
    .VPWR(VPWR),
    .X(_189_));
 sky130_fd_sc_hd__o22a_2 _411_ (.A1(\uut.cent_un[0] ),
    .A2(uio_out[0]),
    .B1(_188_),
    .B2(_189_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_190_));
 sky130_fd_sc_hd__inv_2 _412_ (.A(_190_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_191_));
 sky130_fd_sc_hd__nor2_2 _413_ (.A(_187_),
    .B(_190_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_192_));
 sky130_fd_sc_hd__and3_2 _414_ (.A(\uut.display_sel[0] ),
    .B(\uut.display_sel[1] ),
    .C(\uut.seg_dec[3] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_193_));
 sky130_fd_sc_hd__a221o_2 _415_ (.A1(_077_),
    .A2(\uut.cent_dec[3] ),
    .B1(\uut.seg_un[3] ),
    .B2(_103_),
    .C1(_183_),
    ...
    .VPWR(VPWR),
    .X(_194_));
 sky130_fd_sc_hd__o22a_2 _416_ (.A1(\uut.cent_un[3] ),
    .A2(uio_out[0]),
    .B1(_193_),
    .B2(_194_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_195_));
 sky130_fd_sc_hd__nor2_2 _417_ (.A(_192_),
    .B(_195_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_2 _418_ (.A(_084_),
    ...
    .VPWR(VPWR),
    .Y(_197_));
 sky130_fd_sc_hd__a221o_2 _419_ (.A1(_077_),
    .A2(\uut.cent_dec[2] ),
    .B1(\uut.seg_un[2] ),
    .B2(_103_),
    .C1(_183_),
    ...
    .VPWR(VPWR),
    .X(_198_));
 sky130_fd_sc_hd__a2bb2o_2 _420_ (.A1_N(_198_),
    .A2_N(_197_),
    .B1(_183_),
    .B2(_081_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_199_));
 sky130_fd_sc_hd__and2b_2 _421_ (.A_N(_187_),
    .B(_199_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_200_));
 sky130_fd_sc_hd__xnor2_2 _422_ (.A(_196_),
    .B(_200_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net4));
 sky130_fd_sc_hd__and2b_2 _423_ (.A_N(_200_),
    .B(_195_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_201_));
 sky130_fd_sc_hd__nor2_2 _424_ (.A(_187_),
    .B(_199_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_202_));
 sky130_fd_sc_hd__a21o_2 _425_ (.A1(_187_),
    .A2(_190_),
    .B1(_199_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_203_));
 sky130_fd_sc_hd__o21bai_2 _426_ (.A1(_192_),
    .A2(_203_),
    .B1_N(_201_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(net3));
 sky130_fd_sc_hd__a31o_2 _427_ (.A1(_187_),
    .A2(_191_),
    .A3(_199_),
    .B1(_201_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(uo_out[2]));
 sky130_fd_sc_hd__a21oi_2 _428_ (.A1(_187_),
    .A2(_199_),
    .B1(_195_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_204_));
 sky130_fd_sc_hd__xnor2_2 _429_ (.A(_191_),
    .B(_202_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_205_));
 sky130_fd_sc_hd__a21o_2 _430_ (.A1(_204_),
    .A2(_205_),
    .B1(_201_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(uo_out[3]));
 sky130_fd_sc_hd__or3_2 _431_ (.A(_190_),
    .B(_201_),
    .C(_202_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(uo_out[4]));
 sky130_fd_sc_hd__a21o_2 _432_ (.A1(_196_),
    .A2(_203_),
    .B1(_201_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(uo_out[5]));
 sky130_fd_sc_hd__a21o_2 _433_ (.A1(_203_),
    .A2(_204_),
    .B1(_201_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(uo_out[6]));
 sky130_fd_sc_hd__xor2_2 _434_ (.A(\uut.display_sel[0] ),
    .B(net88),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_056_));
 sky130_fd_sc_hd__a21o_2 _435_ (.A1(\uut.display_sel[0] ),
    .A2(\uut.refresh_cnt[15] ),
    .B1(\uut.display_sel[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_206_));
 sky130_fd_sc_hd__o21a_2 _436_ (.A1(_076_),
    .A2(uio_out[3]),
    .B1(_206_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_057_));
 sky130_fd_sc_hd__a21oi_2 _437_ (.A1(\uut.running ),
    .A2(_158_),
    .B1(\uut.cent_un[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_207_));
 sky130_fd_sc_hd__or4_2 _438_ (.A(_078_),
    .B(_079_),
    .C(_151_),
    .D(_157_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_208_));
 sky130_fd_sc_hd__and2b_2 _439_ (.A_N(_207_),
    .B(_208_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_058_));
 sky130_fd_sc_hd__or2_2 _440_ (.A(_080_),
    .B(_208_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_209_));
 sky130_fd_sc_hd__nand2_2 _441_ (.A(_080_),
    .B(_208_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_210_));
 sky130_fd_sc_hd__nand2_2 _442_ (.A(_209_),
    .B(_210_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_211_));
 sky130_fd_sc_hd__or4_2 _443_ (.A(_079_),
    .B(\uut.cent_un[1] ),
    .C(\uut.cent_un[2] ),
    .D(_082_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_212_));
 sky130_fd_sc_hd__nor4_4 _444_ (.A(_078_),
    .B(_151_),
    .C(_157_),
    .D(_212_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_2 _445_ (.A(_211_),
    ...
    .VPWR(VPWR),
    .Y(_059_));
 sky130_fd_sc_hd__or3_2 _446_ (.A(_080_),
    .B(_081_),
    .C(_208_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_214_));
 sky130_fd_sc_hd__xnor2_2 _447_ (.A(net60),
    .B(_209_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_060_));
 sky130_fd_sc_hd__or4_2 _448_ (.A(_080_),
    .B(_081_),
    .C(_082_),
    .D(_208_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_215_));
 sky130_fd_sc_hd__a21bo_2 _449_ (.A1(_082_),
    .A2(_214_),
    .B1_N(_215_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_2 _450_ (.A(_213_),
    ...
    .VPWR(VPWR),
    .Y(_061_));
 sky130_fd_sc_hd__xor2_2 _451_ (.A(net84),
    .B(net5),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_062_));
 sky130_fd_sc_hd__a21oi_2 _452_ (.A1(\uut.cent_dec[0] ),
    .A2(net6),
    .B1(\uut.cent_dec[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_217_));
 sky130_fd_sc_hd__and4bb_2 _453_ (.A_N(\uut.cent_dec[1] ),
    .B_N(\uut.cent_dec[2] ),
    .C(\uut.cent_dec[3] ),
    .D(\uut.cent_dec[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_218_));
 sky130_fd_sc_hd__and3_2 _454_ (.A(\uut.cent_dec[0] ),
    .B(\uut.cent_dec[1] ),
    .C(net6),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_219_));
 sky130_fd_sc_hd__and2_2 _455_ (.A(net5),
    .B(_218_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_220_));
 sky130_fd_sc_hd__nor3_2 _456_ (.A(_217_),
    .B(_219_),
    .C(_220_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_063_));
 sky130_fd_sc_hd__and4_2 _457_ (.A(\uut.cent_dec[0] ),
    .B(\uut.cent_dec[1] ),
    .C(\uut.cent_dec[2] ),
    .D(net6),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_221_));
 sky130_fd_sc_hd__o21ba_2 _458_ (.A1(net78),
    .A2(_219_),
    .B1_N(_221_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_064_));
 sky130_fd_sc_hd__xnor2_2 _459_ (.A(net91),
    .B(_221_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_222_));
 sky130_fd_sc_hd__nor2_2 _460_ (.A(_220_),
    .B(_222_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_065_));
 sky130_fd_sc_hd__xor2_2 _461_ (.A(net71),
    .B(_220_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_066_));
 sky130_fd_sc_hd__a31o_2 _462_ (.A1(\uut.seg_un[0] ),
    .A2(net5),
    .A3(_218_),
    .B1(\uut.seg_un[1] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_223_));
 sky130_fd_sc_hd__and2_2 _463_ (.A(\uut.seg_un[0] ),
    .B(\uut.seg_un[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_224_));
 sky130_fd_sc_hd__and4bb_2 _464_ (.A_N(\uut.seg_un[1] ),
    .B_N(\uut.seg_un[2] ),
    .C(\uut.seg_un[3] ),
    .D(\uut.seg_un[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_225_));
 sky130_fd_sc_hd__nand2_2 _465_ (.A(_220_),
    .B(_224_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_226_));
 sky130_fd_sc_hd__nand3_2 _466_ (.A(net5),
    .B(_218_),
    .C(_225_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_227_));
 sky130_fd_sc_hd__and3_2 _467_ (.A(_223_),
    .B(_226_),
    .C(_227_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_067_));
 sky130_fd_sc_hd__xnor2_2 _468_ (.A(net79),
    .B(_226_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_068_));
 sky130_fd_sc_hd__a31o_2 _469_ (.A1(\uut.seg_un[2] ),
    .A2(_220_),
    .A3(_224_),
    .B1(\uut.seg_un[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_228_));
 sky130_fd_sc_hd__nand4_2 _470_ (.A(\uut.seg_un[2] ),
    .B(\uut.seg_un[3] ),
    .C(_220_),
    .D(_224_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_229_));
 sky130_fd_sc_hd__and3_2 _471_ (.A(_227_),
    .B(_228_),
    .C(_229_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_069_));
 sky130_fd_sc_hd__xnor2_2 _472_ (.A(net76),
    .B(_227_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_070_));
 sky130_fd_sc_hd__nand2_2 _473_ (.A(\uut.seg_dec[0] ),
    .B(\uut.seg_dec[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_230_));
 sky130_fd_sc_hd__or4b_2 _474_ (.A(\uut.seg_dec[1] ),
    .B(\uut.seg_dec[3] ),
    .C(_084_),
    .D_N(\uut.seg_dec[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_231_));
 sky130_fd_sc_hd__or2_2 _475_ (.A(\uut.seg_dec[0] ),
    .B(\uut.seg_dec[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_232_));
 sky130_fd_sc_hd__and3_2 _476_ (.A(_230_),
    .B(_231_),
    .C(_232_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_233_));
 sky130_fd_sc_hd__mux2_1 _477_ (.A0(_233_),
    .A1(\uut.seg_dec[1] ),
    .S(_227_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_071_));
 sky130_fd_sc_hd__o21ai_2 _478_ (.A1(_227_),
    .A2(_230_),
    .B1(_084_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_234_));
 sky130_fd_sc_hd__or2_2 _479_ (.A(_227_),
    .B(_231_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or3_2 _480_ (.A(_084_),
    ...
    .VPWR(VPWR),
    .X(_236_));
 sky130_fd_sc_hd__and3_2 _481_ (.A(_234_),
    .B(_235_),
    .C(_236_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_072_));
 sky130_fd_sc_hd__xnor2_2 _482_ (.A(net53),
    .B(_236_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_073_));
 sky130_fd_sc_hd__xor2_2 _483_ (.A(\uut.running ),
    .B(net38),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_074_));
 sky130_fd_sc_hd__mux2_1 _484_ (.A0(net37),
    .A1(net89),
    .S(_119_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_075_));
 sky130_fd_sc_hd__dfrtp_2 _485_ (.CLK(clknet_4_7_0_clk),
    .D(_056_),
    .RESET_B(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uut.display_sel[0] ));
 sky130_fd_sc_hd__dfrtp_2 _486_ (.CLK(clknet_4_7_0_clk),
    .D(_057_),
    .RESET_B(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uut.display_sel[1] ));
 sky130_fd_sc_hd__dfrtp_2 _487_ (.CLK(clknet_4_9_0_clk),
    .D(_058_),
    .RESET_B(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uut.cent_un[0] ));
 sky130_fd_sc_hd__dfrtp_2 _488_ (.CLK(clknet_4_13_0_clk),
    .D(_059_),
    .RESET_B(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uut.cent_un[1] ));
 sky130_fd_sc_hd__dfrtp_2 _489_ (.CLK(clknet_4_9_0_clk),
    .D(_060_),
    .RESET_B(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uut.cent_un[2] ));
 sky130_fd_sc_hd__dfrtp_2 _490_ (.CLK(clknet_4_13_0_clk),
    .D(_061_),
    .RESET_B(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uut.cent_un[3] ));
 sky130_fd_sc_hd__dfrtp_2 _491_ (.CLK(clknet_4_6_0_clk),
    .D(_062_),
    .RESET_B(net14),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uut.cent_dec[0] ));
 sky130_fd_sc_hd__dfrtp_2 _492_ (.CLK(clknet_4_3_0_clk),
    .D(_063_),
    .RESET_B(net14),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uut.cent_dec[1] ));
 sky130_fd_sc_hd__dfrtp_2 _493_ (.CLK(clknet_4_6_0_clk),
    .D(_064_),
    .RESET_B(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uut.cent_dec[2] ));
 sky130_fd_sc_hd__dfrtp_2 _494_ (.CLK(clknet_4_6_0_clk),
    .D(_065_),
    .RESET_B(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uut.cent_dec[3] ));
 sky130_fd_sc_hd__dfrtp_2 _495_ (.CLK(clknet_4_6_0_clk),
    .D(_066_),
    .RESET_B(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uut.seg_un[0] ));
 sky130_fd_sc_hd__dfrtp_2 _496_ (.CLK(clknet_4_7_0_clk),
    .D(_067_),
    .RESET_B(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uut.seg_un[1] ));
 sky130_fd_sc_hd__dfrtp_2 _497_ (.CLK(clknet_4_7_0_clk),
    .D(_068_),
    .RESET_B(net11),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uut.seg_un[2] ));
 sky130_fd_sc_hd__dfrtp_2 _498_ (.CLK(clknet_4_7_0_clk),
    .D(_069_),
    .RESET_B(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uut.seg_un[3] ));
 sky130_fd_sc_hd__dfrtp_2 _499_ (.CLK(clknet_4_5_0_clk),
    .D(_070_),
    .RESET_B(net11),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uut.seg_dec[0] ));
 sky130_fd_sc_hd__dfrtp_2 _500_ (.CLK(clknet_4_5_0_clk),
    .D(_071_),
    .RESET_B(net11),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uut.seg_dec[1] ));
 sky130_fd_sc_hd__dfrtp_2 _501_ (.CLK(clknet_4_5_0_clk),
    .D(_072_),
    .RESET_B(net11),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uut.seg_dec[2] ));
 sky130_fd_sc_hd__dfrtp_2 _502_ (.CLK(clknet_4_5_0_clk),
    .D(_073_),
    .RESET_B(net12),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uut.seg_dec[3] ));
 sky130_fd_sc_hd__dfrtp_2 _503_ (.CLK(clknet_4_11_0_clk),
    .D(net39),
    .RESET_B(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uut.running ));
 sky130_fd_sc_hd__dfrtp_2 _504_ (.CLK(clknet_4_12_0_clk),
    .D(_075_),
    .RESET_B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.db_start.stable_state ));
 sky130_fd_sc_hd__dfrtp_2 _505_ (.CLK(clknet_4_11_0_clk),
    .D(_020_),
    .RESET_B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.db_start.clean_pulse ));
 sky130_fd_sc_hd__dfrtp_2 _506_ (.CLK(clknet_4_15_0_clk),
    .D(net36),
    .RESET_B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.db_start.sync_1 ));
 sky130_fd_sc_hd__dfrtp_2 _507_ (.CLK(clknet_4_12_0_clk),
    .D(net37),
    .RESET_B(net17),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _508_ (.CLK(clknet_4_15_0_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.db_start.sync_0 ));
 sky130_fd_sc_hd__dfrtp_2 _509_ (.CLK(clknet_4_13_0_clk),
    .D(_021_),
    .RESET_B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.db_start.cnt[0] ));
 sky130_fd_sc_hd__dfrtp_2 _510_ (.CLK(clknet_4_13_0_clk),
    .D(net68),
    .RESET_B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.db_start.cnt[1] ));
 sky130_fd_sc_hd__dfrtp_2 _511_ (.CLK(clknet_4_13_0_clk),
    .D(_032_),
    .RESET_B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.db_start.cnt[2] ));
 sky130_fd_sc_hd__dfrtp_2 _512_ (.CLK(clknet_4_12_0_clk),
    .D(_033_),
    .RESET_B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.db_start.cnt[3] ));
 sky130_fd_sc_hd__dfrtp_2 _513_ (.CLK(clknet_4_15_0_clk),
    .D(net50),
    .RESET_B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.db_start.cnt[4] ));
 sky130_fd_sc_hd__dfrtp_2 _514_ (.CLK(clknet_4_15_0_clk),
    .D(_035_),
    .RESET_B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.db_start.cnt[5] ));
 sky130_fd_sc_hd__dfrtp_2 _515_ (.CLK(clknet_4_14_0_clk),
    .D(_036_),
    .RESET_B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.db_start.cnt[6] ));
 sky130_fd_sc_hd__dfrtp_2 _516_ (.CLK(clknet_4_14_0_clk),
    .D(_037_),
    .RESET_B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.db_start.cnt[7] ));
 sky130_fd_sc_hd__dfrtp_2 _517_ (.CLK(clknet_4_14_0_clk),
    .D(_038_),
    .RESET_B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.db_start.cnt[8] ));
 sky130_fd_sc_hd__dfrtp_2 _518_ (.CLK(clknet_4_14_0_clk),
    .D(_039_),
    .RESET_B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.db_start.cnt[9] ));
 sky130_fd_sc_hd__dfrtp_2 _519_ (.CLK(clknet_4_14_0_clk),
    .D(_022_),
    .RESET_B(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.db_start.cnt[10] ));
 sky130_fd_sc_hd__dfrtp_2 _520_ (.CLK(clknet_4_11_0_clk),
    .D(_023_),
    .RESET_B(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.db_start.cnt[11] ));
 sky130_fd_sc_hd__dfrtp_2 _521_ (.CLK(clknet_4_10_0_clk),
    .D(_024_),
    .RESET_B(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.db_start.cnt[12] ));
 sky130_fd_sc_hd__dfrtp_2 _522_ (.CLK(clknet_4_11_0_clk),
    .D(_025_),
    .RESET_B(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.db_start.cnt[13] ));
 sky130_fd_sc_hd__dfrtp_2 _523_ (.CLK(clknet_4_10_0_clk),
    .D(_026_),
    .RESET_B(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.db_start.cnt[14] ));
 sky130_fd_sc_hd__dfrtp_2 _524_ (.CLK(clknet_4_11_0_clk),
    .D(_027_),
    .RESET_B(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.db_start.cnt[15] ));
 sky130_fd_sc_hd__dfrtp_2 _525_ (.CLK(clknet_4_12_0_clk),
    .D(_028_),
    .RESET_B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.db_start.cnt[16] ));
 sky130_fd_sc_hd__dfrtp_2 _526_ (.CLK(clknet_4_12_0_clk),
    .D(_029_),
    .RESET_B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.db_start.cnt[17] ));
 sky130_fd_sc_hd__dfrtp_2 _527_ (.CLK(clknet_4_9_0_clk),
    .D(_030_),
    .RESET_B(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.db_start.cnt[18] ));
 sky130_fd_sc_hd__dfrtp_2 _528_ (.CLK(clknet_4_1_0_clk),
    .D(_000_),
    .RESET_B(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.prescaler_cnt[0] ));
 sky130_fd_sc_hd__dfrtp_2 _529_ (.CLK(clknet_4_1_0_clk),
    .D(_011_),
    .RESET_B(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.prescaler_cnt[1] ));
 sky130_fd_sc_hd__dfrtp_2 _530_ (.CLK(clknet_4_3_0_clk),
    .D(_012_),
    .RESET_B(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.prescaler_cnt[2] ));
 sky130_fd_sc_hd__dfrtp_2 _531_ (.CLK(clknet_4_3_0_clk),
    .D(_013_),
    .RESET_B(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.prescaler_cnt[3] ));
 sky130_fd_sc_hd__dfrtp_2 _532_ (.CLK(clknet_4_8_0_clk),
    .D(_014_),
    .RESET_B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.prescaler_cnt[4] ));
 sky130_fd_sc_hd__dfrtp_2 _533_ (.CLK(clknet_4_9_0_clk),
    .D(_015_),
    .RESET_B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.prescaler_cnt[5] ));
 sky130_fd_sc_hd__dfrtp_2 _534_ (.CLK(clknet_4_3_0_clk),
    .D(_016_),
    .RESET_B(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.prescaler_cnt[6] ));
 sky130_fd_sc_hd__dfrtp_2 _535_ (.CLK(clknet_4_3_0_clk),
    .D(_017_),
    .RESET_B(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.prescaler_cnt[7] ));
 sky130_fd_sc_hd__dfrtp_2 _536_ (.CLK(clknet_4_2_0_clk),
    .D(_018_),
    .RESET_B(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.prescaler_cnt[8] ));
 sky130_fd_sc_hd__dfrtp_2 _537_ (.CLK(clknet_4_2_0_clk),
    .D(_019_),
    .RESET_B(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.prescaler_cnt[9] ));
 sky130_fd_sc_hd__dfrtp_2 _538_ (.CLK(clknet_4_2_0_clk),
    .D(_001_),
    .RESET_B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.prescaler_cnt[10] ));
 sky130_fd_sc_hd__dfrtp_2 _539_ (.CLK(clknet_4_2_0_clk),
    .D(_002_),
    .RESET_B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.prescaler_cnt[11] ));
 sky130_fd_sc_hd__dfrtp_2 _540_ (.CLK(clknet_4_8_0_clk),
    .D(_003_),
    .RESET_B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.prescaler_cnt[12] ));
 sky130_fd_sc_hd__dfrtp_2 _541_ (.CLK(clknet_4_8_0_clk),
    .D(_004_),
    .RESET_B(net19),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _542_ (.CLK(clknet_4_10_0_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.prescaler_cnt[14] ));
 sky130_fd_sc_hd__dfrtp_2 _543_ (.CLK(clknet_4_8_0_clk),
    .D(_006_),
    .RESET_B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.prescaler_cnt[15] ));
 sky130_fd_sc_hd__dfrtp_2 _544_ (.CLK(clknet_4_8_0_clk),
    .D(_007_),
    .RESET_B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.prescaler_cnt[16] ));
 sky130_fd_sc_hd__dfrtp_2 _545_ (.CLK(clknet_4_9_0_clk),
    .D(_008_),
    .RESET_B(net19),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _547_ (.CLK(clknet_4_10_0_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.prescaler_cnt[19] ));
 sky130_fd_sc_hd__dfrtp_2 _548_ (.CLK(clknet_4_0_0_clk),
    .D(_040_),
    .RESET_B(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uut.refresh_cnt[0] ));
 sky130_fd_sc_hd__dfrtp_2 _549_ (.CLK(clknet_4_0_0_clk),
    .D(_047_),
    .RESET_B(net12),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uut.refresh_cnt[1] ));
 sky130_fd_sc_hd__dfrtp_2 _550_ (.CLK(clknet_4_2_0_clk),
    .D(_048_),
    .RESET_B(net12),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uut.refresh_cnt[2] ));
 sky130_fd_sc_hd__dfrtp_2 _551_ (.CLK(clknet_4_0_0_clk),
    .D(_049_),
    .RESET_B(net12),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uut.refresh_cnt[3] ));
 sky130_fd_sc_hd__dfrtp_2 _552_ (.CLK(clknet_4_0_0_clk),
    .D(_050_),
    .RESET_B(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uut.refresh_cnt[4] ));
 sky130_fd_sc_hd__dfrtp_2 _553_ (.CLK(clknet_4_0_0_clk),
    .D(_051_),
    .RESET_B(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uut.refresh_cnt[5] ));
 sky130_fd_sc_hd__dfrtp_2 _554_ (.CLK(clknet_4_1_0_clk),
    .D(_052_),
    .RESET_B(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uut.refresh_cnt[6] ));
 sky130_fd_sc_hd__dfrtp_2 _555_ (.CLK(clknet_4_1_0_clk),
    .D(_053_),
    .RESET_B(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uut.refresh_cnt[7] ));
 sky130_fd_sc_hd__dfrtp_2 _556_ (.CLK(clknet_4_1_0_clk),
    .D(_054_),
    .RESET_B(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uut.refresh_cnt[8] ));
 sky130_fd_sc_hd__dfrtp_2 _557_ (.CLK(clknet_4_5_0_clk),
    .D(_055_),
    .RESET_B(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uut.refresh_cnt[9] ));
 sky130_fd_sc_hd__dfrtp_2 _558_ (.CLK(clknet_4_6_0_clk),
    .D(_041_),
    .RESET_B(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.refresh_cnt[10] ));
 sky130_fd_sc_hd__dfrtp_2 _559_ (.CLK(clknet_4_4_0_clk),
    .D(_042_),
    .RESET_B(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.refresh_cnt[11] ));
 sky130_fd_sc_hd__dfrtp_2 _560_ (.CLK(clknet_4_4_0_clk),
    .D(_043_),
    .RESET_B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.refresh_cnt[12] ));
 sky130_fd_sc_hd__dfrtp_2 _561_ (.CLK(clknet_4_4_0_clk),
    .D(_044_),
    .RESET_B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.refresh_cnt[13] ));
 sky130_fd_sc_hd__dfrtp_2 _562_ (.CLK(clknet_4_4_0_clk),
    .D(_045_),
    .RESET_B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\uut.refresh_cnt[14] ));
 sky130_fd_sc_hd__dfrtp_2 _563_ (.CLK(clknet_4_4_0_clk),
    .D(_046_),
    .RESET_B(net11),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout10 (.A(net12),
    ...
    .VPWR(VPWR),
    .X(net10));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout12 (.A(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout13 (.A(net15),
    ...
    .VPWR(VPWR),
    .X(net13));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout15 (.A(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout22 (.A(net23),
    ...
    .VPWR(VPWR),
    .X(net22));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout23 (.A(net1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net23));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout8 (.A(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net8));
 sky130_fd_sc_hd__dlygate4sd3_1 hold36 (.A(\uut.db_start.sync_0 ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net36));
 sky130_fd_sc_hd__dlygate4sd3_1 hold37 (.A(\uut.db_start.stable_state ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net37));
 sky130_fd_sc_hd__dlygate4sd3_1 hold38 (.A(\uut.db_start.clean_pulse ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net38));
 sky130_fd_sc_hd__dlygate4sd3_1 hold39 (.A(_074_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net39));
 sky130_fd_sc_hd__dlygate4sd3_1 hold40 (.A(\uut.prescaler_cnt[19] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net40));
 sky130_fd_sc_hd__dlygate4sd3_1 hold41 (.A(\uut.refresh_cnt[13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net41));
 sky130_fd_sc_hd__dlygate4sd3_1 hold42 (.A(_100_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net42));
 sky130_fd_sc_hd__dlygate4sd3_1 hold43 (.A(\uut.refresh_cnt[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net43));
 sky130_fd_sc_hd__dlygate4sd3_1 hold44 (.A(_091_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net44));
 sky130_fd_sc_hd__dlygate4sd3_1 hold45 (.A(\uut.prescaler_cnt[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net45));
 sky130_fd_sc_hd__dlygate4sd3_1 hold46 (.A(\uut.refresh_cnt[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net46));
 sky130_fd_sc_hd__dlygate4sd3_1 hold47 (.A(\uut.prescaler_cnt[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net47));
 sky130_fd_sc_hd__dlygate4sd3_1 hold48 (.A(_171_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net48));
 sky130_fd_sc_hd__dlygate4sd3_1 hold49 (.A(\uut.db_start.cnt[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net49));
 sky130_fd_sc_hd__dlygate4sd3_1 hold50 (.A(_034_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net50));
 sky130_fd_sc_hd__dlygate4sd3_1 hold51 (.A(\uut.refresh_cnt[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net51));
 sky130_fd_sc_hd__dlygate4sd3_1 hold52 (.A(\uut.refresh_cnt[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net52));
 sky130_fd_sc_hd__dlygate4sd3_1 hold53 (.A(\uut.seg_dec[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net53));
 sky130_fd_sc_hd__dlygate4sd3_1 hold54 (.A(\uut.refresh_cnt[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net54));
 sky130_fd_sc_hd__dlygate4sd3_1 hold55 (.A(\uut.refresh_cnt[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net55));
 sky130_fd_sc_hd__dlygate4sd3_1 hold56 (.A(_086_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net56));
 sky130_fd_sc_hd__dlygate4sd3_1 hold57 (.A(\uut.prescaler_cnt[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net57));
 sky130_fd_sc_hd__dlygate4sd3_1 hold58 (.A(_149_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net58));
 sky130_fd_sc_hd__dlygate4sd3_1 hold59 (.A(\uut.prescaler_cnt[12] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net59));
 sky130_fd_sc_hd__dlygate4sd3_1 hold60 (.A(\uut.cent_un[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net60));
 sky130_fd_sc_hd__dlygate4sd3_1 hold61 (.A(\uut.prescaler_cnt[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net61));
 sky130_fd_sc_hd__dlygate4sd3_1 hold62 (.A(\uut.prescaler_cnt[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net62));
 sky130_fd_sc_hd__dlygate4sd3_1 hold63 (.A(\uut.refresh_cnt[12] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net63));
 sky130_fd_sc_hd__dlygate4sd3_1 hold64 (.A(\uut.prescaler_cnt[14] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net64));
 sky130_fd_sc_hd__dlygate4sd3_1 hold65 (.A(\uut.refresh_cnt[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net65));
 sky130_fd_sc_hd__dlygate4sd3_1 hold66 (.A(\uut.refresh_cnt[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net66));
 sky130_fd_sc_hd__dlygate4sd3_1 hold67 (.A(\uut.db_start.cnt[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net67));
 sky130_fd_sc_hd__dlygate4sd3_1 hold68 (.A(_031_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net68));
 sky130_fd_sc_hd__dlygate4sd3_1 hold69 (.A(\uut.prescaler_cnt[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net69));
 sky130_fd_sc_hd__dlygate4sd3_1 hold70 (.A(\uut.prescaler_cnt[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net70));
 sky130_fd_sc_hd__dlygate4sd3_1 hold71 (.A(\uut.seg_un[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net71));
 sky130_fd_sc_hd__dlygate4sd3_1 hold72 (.A(\uut.db_start.cnt[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net72));
 sky130_fd_sc_hd__dlygate4sd3_1 hold73 (.A(\uut.prescaler_cnt[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net73));
 sky130_fd_sc_hd__dlygate4sd3_1 hold74 (.A(\uut.db_start.cnt[12] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net74));
 sky130_fd_sc_hd__dlygate4sd3_1 hold75 (.A(\uut.refresh_cnt[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net75));
 sky130_fd_sc_hd__dlygate4sd3_1 hold76 (.A(\uut.seg_dec[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net76));
 sky130_fd_sc_hd__dlygate4sd3_1 hold77 (.A(\uut.prescaler_cnt[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net77));
 sky130_fd_sc_hd__dlygate4sd3_1 hold78 (.A(\uut.cent_dec[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net78));
 sky130_fd_sc_hd__dlygate4sd3_1 hold79 (.A(\uut.seg_un[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net79));
 sky130_fd_sc_hd__dlygate4sd3_1 hold80 (.A(\uut.db_start.cnt[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net80));
 sky130_fd_sc_hd__dlygate4sd3_1 hold81 (.A(\uut.db_start.cnt[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net81));
 sky130_fd_sc_hd__dlygate4sd3_1 hold82 (.A(\uut.db_start.cnt[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net82));
 sky130_fd_sc_hd__dlygate4sd3_1 hold83 (.A(\uut.db_start.cnt[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net83));
 sky130_fd_sc_hd__dlygate4sd3_1 hold84 (.A(\uut.cent_dec[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net84));
 sky130_fd_sc_hd__dlygate4sd3_1 hold85 (.A(\uut.db_start.cnt[15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net85));
 sky130_fd_sc_hd__dlygate4sd3_1 hold86 (.A(\uut.db_start.cnt[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net86));
 sky130_fd_sc_hd__dlygate4sd3_1 hold87 (.A(\uut.prescaler_cnt[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net87));
 sky130_fd_sc_hd__dlygate4sd3_1 hold88 (.A(\uut.refresh_cnt[15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net88));
 sky130_fd_sc_hd__dlygate4sd3_1 hold89 (.A(\uut.db_start.sync_1 ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net89));
 sky130_fd_sc_hd__dlygate4sd3_1 hold90 (.A(\uut.db_start.cnt[17] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net90));
 sky130_fd_sc_hd__dlygate4sd3_1 hold91 (.A(\uut.cent_dec[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net91));
 sky130_fd_sc_hd__dlygate4sd3_1 hold92 (.A(\uut.db_start.cnt[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net92));
 sky130_fd_sc_hd__dlygate4sd3_1 hold93 (.A(\uut.db_start.stable_state ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 load_slew19 (.A(net18),
    ...
    .VPWR(VPWR),
    .X(net19));
 sky130_fd_sc_hd__buf_2 load_slew21 (.A(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 load_slew9 (.A(net8),
    ...
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__clkbuf_2 max_cap6 (.A(_213_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net6));
 sky130_fd_sc_hd__buf_4 max_cap7 (.A(_104_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net7));
 sky130_fd_sc_hd__conb_1 tt_um_chronoINAAL (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 tt_um_chronoINAAL_24 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net24));
 sky130_fd_sc_hd__conb_1 tt_um_chronoINAAL_25 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net25));
 sky130_fd_sc_hd__conb_1 tt_um_chronoINAAL_26 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net26));
 sky130_fd_sc_hd__conb_1 tt_um_chronoINAAL_27 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net27));
 sky130_fd_sc_hd__conb_1 tt_um_chronoINAAL_28 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net28));
 sky130_fd_sc_hd__conb_1 tt_um_chronoINAAL_29 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net29));
 sky130_fd_sc_hd__conb_1 tt_um_chronoINAAL_30 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net30));
 sky130_fd_sc_hd__conb_1 tt_um_chronoINAAL_31 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net31));
 sky130_fd_sc_hd__conb_1 tt_um_chronoINAAL_32 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net32));
 sky130_fd_sc_hd__conb_1 tt_um_chronoINAAL_33 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net33));
 sky130_fd_sc_hd__conb_1 tt_um_chronoINAAL_34 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net34));
 sky130_fd_sc_hd__conb_1 tt_um_chronoINAAL_35 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net35));
